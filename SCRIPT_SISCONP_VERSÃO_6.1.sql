...
IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('ATENDIMENTO_GRUPO_PSICOLOGIA'))
	...
	(
	IdAtendGrupo INT IDENTITY(1,1) PRIMARY KEY NOT NULL, 
	StatusAtendGrupo VARCHAR(15) NULL,
	DataAtend DATETIME NULL,
	Atendente VARCHAR(200) NULL,	
	Observacao VARCHAR(MAX) NULL,
	UsuarioInsert VARCHAR(50) NULL,
	DataInsert VARCHAR(20) NULL,
	HorarioInsert VARCHAR(10) NULL,
...
IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('ITENS_ATENDIMENTO_GRUPO_PSICOLOGIA'))
	CREATE TABLE ITENS_ATENDIMENTO_GRUPO_PSICOLOGIA
	(
	IdItemAtendGrupo INT IDENTITY(1,1) PRIMARY KEY NOT NULL, 	
	DataItemAtend DATETIME NULL,
	IdAtendGrupo INT FOREIGN KEY REFERENCES ATENDIMENTO_GRUPO_PSICOLOGIA(IdAtendGrupo) NOT NULL,
	IdInternoCrc INT FOREIGN KEY REFERENCES PRONTUARIOSCRC(IdInternoCrc) NOT NULL,	
	TextoAtendimento VARCHAR(MAX) NULL,
	UsuarioInsert VARCHAR(50) NULL,
	DataInsert VARCHAR(20) NULL,
	HorarioInsert VARCHAR(10) NULL,
	UsuarioUp VARCHAR(50) NULL,
