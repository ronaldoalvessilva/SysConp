...
import static gestor.Visao.TelaRetornoRecaptura.jDataRetorno;
 ...
 * @author Ronaldo
 */
public class TelaPesqRegIntRecapturaPortaria extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    int flag;
    String caminho;
    String confirmacaoRetrono = "Não";
    public static int idItemRetornoRecaptura; // Código do item da tabela ITENSREGISTRO    
    String idInt;
    String dataRetorno;
     ...
     */
    public TelaPesqRegIntRecapturaPortaria() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jPesqNomeInterno, javax.swing.GroupLayout.DEFAULT_SIZE, 370, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jBtConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtConfirmarActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                ...
                idItemRetornoRecaptura = conecta.rs.getInt("IdItem");
    ...
    private void jTabelaPesqInternosPortariaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaPesqInternosPortariaMouseClicked
        ...
        if (flag == 1) {
            String nomeInterno = "" + jTabelaPesqInternosPortaria.getValueAt(jTabelaPesqInternosPortaria.getSelectedRow(), 1);
            jPesqNomeInterno.setText(nomeInterno);
            idInt = "" + jTabelaPesqInternosPortaria.getValueAt(jTabelaPesqInternosPortaria.getSelectedRow(), 0);
