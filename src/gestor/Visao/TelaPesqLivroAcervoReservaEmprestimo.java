...
import static gestor.Visao.TelaEmprestimoAcervo.jQtdReserva;
 ...
 * @author user
 */
public class TelaPesqLivroAcervoReservaEmprestimo extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqLivroAcervoReservaEmprestimo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Produtos Reservado {PE} :::...");
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM LIVROS_REVISTAS_JORNAIS "
                    ...
                    + "INNER JOIN ITENS_RESERVA_ACERVO "
                    + "ON LIVROS_REVISTAS_JORNAIS.IdLivro=ITENS_RESERVA_ACERVO.IdLivro "
                    + "WHERE TituloLivro LIKE'%" + jPesqDescricaoProdutos.getText() + "%'AND StatusLivro='" + statusProd + "'AND UtilizaReserva='" +  utilizaReserva  + "'");
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().isEmpty()) {
            ...
            try {
                ...
                jQtdReserva.setText(conecta.rs.getString("QtdItem"));
