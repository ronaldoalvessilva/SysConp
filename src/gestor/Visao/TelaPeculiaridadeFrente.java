 ...
 * @author ronaldo
 */
public class TelaPeculiaridadeFrente extends javax.swing.JDialog {
    ...
    public TelaPeculiaridadeFrente(TelaProntuarioCrc parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPeculiaridadeFrente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaPeculiaridadeFrente dialog = new TelaPeculiaridadeFrente(telaProntuarioCrc, true);
