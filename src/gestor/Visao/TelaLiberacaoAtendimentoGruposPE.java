...
import static gestor.Visao.TelaAtendimentoGrupoPE.jBtNovo;
import static gestor.Visao.TelaAtendimentoGrupoPE.jCodigoAtend;
import static gestor.Visao.TelaAtendimentoGrupoPE.jDataAtend;
import static gestor.Visao.TelaAtendimentoGrupoPE.jStatusAtend;
 ...
 */
public class TelaLiberacaoAtendimentoGruposPE extends javax.swing.JDialog {
    ...
    String nomeModuloTela = "PEDAGOGIA:Registro de Atendimento de Internos em Grupo";
    //
    int count = 0;
    int codigoDepto = 0;
    String statusMov;
     ...
     */
    public static TelaAtendimentoGrupoPE atendGPE;
    public static TelaAssinaBiometriaColaboradoresPSP_AG_PE assinaBio;

    public TelaLiberacaoAtendimentoGruposPE(TelaAtendimentoGrupoPE parent, boolean modal) {
        this.atendGPE = parent;
        this.setModal(modal);
        setLocationRelativeTo(atendGPE);
        initComponents();
    ...
    public void mostrarLiberador() {
        assinaBio = new TelaAssinaBiometriaColaboradoresPSP_AG_PE(this, true);
    ...
    private void initComponents() {
        ...
        jComboBoxTipoMovimentacao.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Atendimento em Grupo/PE", " " }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLiberacaoAtendimentoGruposPE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaLiberacaoAtendimentoGruposPE dialog = new TelaLiberacaoAtendimentoGruposPE(atendGPE, true);
    ...
    public void finalizarAtendimentoGrupo() {
        ...
        control.finalizarAtendimentoGrupoPE(objRegAtend);
        objLog();
        controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
