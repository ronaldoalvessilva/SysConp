 ...
 * @author user
 */
public class TelaPesqVisitasDiversasPortariaInterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqVisitasDiversasPortariaInterna() {
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                ...
                conecta.rs.first();
                jIdTransiente.setText(String.valueOf(conecta.rs.getInt("IdVisita")));
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jNomeVisita.getText().equals("")) {
            ...
            buscarVisitas("SELECT * FROM VISITASDIVERSAS WHERE NomeVisita LIKE'%" + jNomeVisita.getText() + "%'");
        }
