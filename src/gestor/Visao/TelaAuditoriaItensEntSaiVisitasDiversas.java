 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntSaiVisitasDiversas extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEntSaiVisitasDiversas() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Itens Visitas Diversas :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSVISITASDIVERSAS WHERE Idlanc='" + jIDlanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
