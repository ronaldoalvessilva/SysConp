...
import static gestor.Visao.TelaSaidaObjetosPertences.jDescricaoLocalPertences;
 ...
 * @author ronaldo
 */
public class TelaPesquisarLocalPertenceSaida extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisarLocalPertenceSaida() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (jTabelaLocalEstoquePertence.getColumnModel().getColumnCount() > 0) {
            jTabelaLocalEstoquePertence.getColumnModel().getColumn(0).setMinWidth(50);
            jTabelaLocalEstoquePertence.getColumnModel().getColumn(0).setMaxWidth(50);
            jTabelaLocalEstoquePertence.getColumnModel().getColumn(1).setMinWidth(380);
            jTabelaLocalEstoquePertence.getColumnModel().getColumn(1).setMaxWidth(380);
        }
    ...
    private void jBtConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtConfirmarActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM LOCALPERTENCES WHERE DescricaoLocal='" + jPesqDescricaoLocal.getText() + "'");
                conecta.rs.first();
    ...
    private void jBtPesqDescricaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoActionPerformed
        ...
        if (jPesqDescricaoLocal.getText().equals("")) {
            ...
            preencherTabelaLocal("SELECT * FROM LOCALPERTENCES WHERE DescricaoLocal LIKE'%" + jPesqDescricaoLocal.getText() + "%'AND StatusLocal='" + statusLocal + "'");
        }
    ...
    private void jCheckBoxTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaLocal("SELECT * FROM LOCALPERTENCES WHERE StatusLocal='" + statusLocal + "'");
        } else {
            limparTabela();
        }
    ...
    public void alinharCamposTabela() {
        ...
        //
        jTabelaLocalEstoquePertence.getColumnModel().getColumn(0).setCellRenderer(centralizado);
    }
}
