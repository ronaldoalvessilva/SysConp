...
import static gestor.Visao.TelaAtendimentoGrupoTO.pCODIGO_AVALIACAO_GRUPO;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_AGRU_TO extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_AGRU_TO() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AVALICAO_ATENDIMENTO_GRUPO_TO "
                    + "WHERE IdItemAvagTO='" + pCODIGO_AVALIACAO_GRUPO + "' "
