...
import static gestor.Visao.TelaAtendimentoGrupoSS.pCODIGO_AVALIACAO_GRUPO_AVGI;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_AIGRU_SS extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_AIGRU_SS() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_SS "
                    + "WHERE IdItemAvaiSS='" + pCODIGO_AVALIACAO_GRUPO_AVGI + "' "
                    + "AND IdAtGrupoPsiSS='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
