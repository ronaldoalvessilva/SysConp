 ...
 * @author Ronaldo
 */
public class TelaAuditoriaFichaLaborativa extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaFichaLaborativa() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Ficha Laborativa :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM FICHALABORATIVA WHERE IdLanc='" + jIDLanc.getText() + "'");
            conecta.rs.first();
