...
import static gestor.Visao.TelaCancelamentoVisitasInterno.jCelaInterno;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jCodigoRol;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jDataValidade;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jFotoInternoLista;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jIdInternoLista;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jNomeInterna;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jPavilhaoInterno;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaInternasBloqueio extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaInternasBloqueio() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Pesquisa de Internas para Lista  :::... ");
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTabelaNome("SELECT * FROM ITENS_LISTA_ROL "
                    ...
                    + "ON ITENS_LISTA_ROL.IdInternoCrc=ITENSLOCACAOINTERNO.IdInternoCrc "
                    + "INNER JOIN CELAS "
                    ...
                    + "AND ITENS_LISTA_ROL.StatusInterna='" + statusInterno + "' "
                    + "AND ITENS_LISTA_ROL.IdRol='" + jCodigoRol.getText()  + "' "
    ...
    private void jBtMatriculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtMatriculaActionPerformed
        ...
        if (jPesqMatricula.getText().equals("")) {
            ...
            buscarInternosMatricula("SELECT * FROM ITENS_LISTA_ROL "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ITENS_LISTA_ROL.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM ITENS_LISTA_ROL "
                        + "INNER JOIN PRONTUARIOSCRC "
                        + "ON ITENS_LISTA_ROL.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                        + "INNER JOIN DADOSPENAISINTERNOS "
                        + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
                ...
                conecta.rs.first();
                jIdInternoLista.setText(String.valueOf(conecta.rs.getInt("IdInternoCrc")));
    ...
    private void jCheckBox2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox2ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTodosInternos("SELECT * FROM ITENS_LISTA_ROL "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ITENS_LISTA_ROL.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
