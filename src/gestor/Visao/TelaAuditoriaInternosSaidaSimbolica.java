...
import static gestor.Visao.TelaSaidaSimbolica.idItemSS;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaInternosSaidaSimbolica extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaInternosSaidaSimbolica() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT IdRegSaida,IdItem, "
                    + "UsuarioInsert,DataInsert,HorarioInsert, "
                    + "UsuarioUp,DataUp,HorarioUp "
