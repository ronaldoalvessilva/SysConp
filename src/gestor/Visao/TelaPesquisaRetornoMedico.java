 ...
 * @author Ronaldo
 */
public class TelaPesquisaRetornoMedico extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaRetornoMedico() {
        initComponents();
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTabelaNome("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "INNER JOIN PAISES ON "
                    + "PRONTUARIOSCRC.IdPais=PAISES.IdPais "
                    + "INNER JOIN CIDADES "
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC WHERE PRONTUARIOSCRC.NomeInternoCrc='" + nomeInterno + "'AND PRONTUARIOSCRC.IdInternoCrc='" + idInt + "'");
                conecta.rs.first();
