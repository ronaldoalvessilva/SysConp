 ...
 * @author Ronaldo
 */
public class TelaAuditoriaTerapia extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Atendimento Terapia  :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATENDIMENTOTERAPIA WHERE IdLanc='" + jIdAtend.getText() + "'");
            conecta.rs.first();
