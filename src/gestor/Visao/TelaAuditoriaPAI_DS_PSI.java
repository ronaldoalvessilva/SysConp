 ...
 * @author Ronaldo
 */
public class TelaAuditoriaPAI_DS_PSI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaPAI_DS_PSI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM FICHA_CADASTRO_PAI_DS WHERE IdPai='" + jCodigoPAI.getText() + "'");
            conecta.rs.first();
