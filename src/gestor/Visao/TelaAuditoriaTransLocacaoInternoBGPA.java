...
import static gestor.Visao.TelaTransCelasBGPA.jIDTran;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaTransLocacaoInternoBGPA extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaTransLocacaoInternoBGPA() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM TRANSFERENCIALOCAL WHERE IdLanc='" + jIDTran.getText() + "'");
            conecta.rs.first();
