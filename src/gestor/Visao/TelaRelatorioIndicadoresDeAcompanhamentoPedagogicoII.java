 ...
 */
public class TelaRelatorioIndicadoresDeAcompanhamentoPedagogicoII extends javax.swing.JInternalFrame {
     ...
     */
    public TelaRelatorioIndicadoresDeAcompanhamentoPedagogicoII() {
        initComponents();
    }
        ...
        if (tipoServidor == null || tipoServidor.equals("")) {
            ...
            if (jDataInicial.getDate() == null) {
                ...
                try {
                    ...
                    String path = "reports/IndicadoresDeAcompanhamentoPedagogicoII.jasper";
                    conecta.executaSQL("SELECT DISTINCT "
                            ...
                            + "INNER JOIN ITENSMATRICULA I "
                            + "ON P.IdInternoCrc=I.IdInternoCrc "
                            + "INNER JOIN MATRICULAESCOLAR M "
                            + "ON I.IdMat=M.IdMat "
                            + "INNER JOIN TEMPOFORMATIVO T "
                            + "ON M.IdTempo=T.IdTempo "
                            + "LEFT JOIN EVOLUCAO_ADMISSAO_PEDAGOGIA E "
                            + "ON P.IdInternoCrc=E.IdInternoCrc "
                            + "LEFT JOIN RESENHA_REMICAO_INTERNO R "
                            + "ON P.IdInternoCrc=R.IdInternoCrc "
                            + "LEFT JOIN ACUMULADOR_REMICAO_INTERNO A "
                            + "ON P.IdInternoCrc=A.IdInternoCrc "
                            + "WHERE P.DataCadastCrc BETWEEN '" + dataInicial + "' "
                            + "AND '" + dataFinal + "' "
                            + "AND (P.SituacaoCrc='" + retornoUnid + "' "
                            + "OR P.SituacaoCrc='" + entradaUnid + "') "
                    ...
                    jv.setTitle("Relatório de Acompanhamento Pedagogico");
