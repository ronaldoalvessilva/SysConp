...
import static gestor.Visao.TelaEstornoRequisicaoMateriaisAC.jDescricaoProduto;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisAC.jCodProduto;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisAC.jCodigoBarras;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisAC.jLote;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisAC.jDataVctoLote;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisAC.jComboBoxUnidade;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisAC.jIdReq;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisAC.jQtdItem;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisAC.jValorUnitarioItem;
 ...
 * @author user
 */
public class TelaPesqProdutoEstornoRequisicaoMateriais extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoEstornoRequisicaoMateriais() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Produtos da Requisição {AC} :::...");
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "INNER JOIN ITENS_REQUISICAO_PRODUTOS_INTERNOS "
                    + "ON PRODUTOS_AC.IdProd=ITENS_REQUISICAO_PRODUTOS_INTERNOS.IdProd "
                    + "WHERE PRODUTOS_AC.DescricaoProd LIKE'%" + jPesqDescricaoProdutos.getText() + "%'AND PRODUTOS_AC.StatusProd='" + statusProd + "'AND Qtd!='" + 0 + "'AND EstornoProduto='" + estornoProduto + "'AND IdReq='" + jIdReq.getText() + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        }
    ...
    private void jCheckBoxPesqTodosProdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosProdItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "INNER JOIN ITENS_REQUISICAO_PRODUTOS_INTERNOS "
                    + "ON PRODUTOS_AC.IdProd=ITENS_REQUISICAO_PRODUTOS_INTERNOS.IdProd "
                    + "WHERE PRODUTOS_AC.StatusProd='" + statusProd + "'AND Qtd!='" + 0 + "'AND EstornoProduto='" + estornoProduto + "'AND IdReq='" + jIdReq.getText() + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        } else {
            limparTabela();
        }
