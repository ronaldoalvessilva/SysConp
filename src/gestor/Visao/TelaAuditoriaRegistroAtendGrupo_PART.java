 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_PART extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_PART() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_PSICOLOGIA "
                    + "WHERE IdItemPart='" + pCODIGO_ITEM_PARTICIPANTE + "' "
