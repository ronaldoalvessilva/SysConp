...
import static gestor.Visao.TelaControleDepositoPortaria.jBtAlterarInterno;
import static gestor.Visao.TelaControleDepositoPortaria.jBtBuscarInterno;
import static gestor.Visao.TelaControleDepositoPortaria.jBtCancelarInterno;
import static gestor.Visao.TelaControleDepositoPortaria.jBtExcluirInterno;
import static gestor.Visao.TelaControleDepositoPortaria.jIdLanc;
import static gestor.Visao.TelaControleDepositoPortaria.jBtSalvarInterno;
import static gestor.Visao.TelaControleDepositoPortaria.jDataDeposito;
import static gestor.Visao.TelaControleDepositoPortaria.jIdInterno;
import static gestor.Visao.TelaControleDepositoPortaria.jNomeInterno;
import static gestor.Visao.TelaControleDepositoPortaria.jValor;
 ...
 * @author user
 */
public class TelaPesqInternosDeposito extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternosDeposito() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa Internos Depósitos - {P1} :::...");
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM ITENSDEPOSITOPORTARIA INNER JOIN PRONTUARIOSCRC ON ITENSDEPOSITOPORTARIA.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc WHERE NomeInternoCrc='" + jPesqNomeInterno.getText() +  "' AND IdLanc='" + jIdLanc.getText() + "'");
                conecta.rs.first();
                // Tabela Funcionarios
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jPesqNomeInterno.getText().equals("")) {
            ...
            buscarInternos("SELECT * FROM ITENSDEPOSITOPORTARIA INNER JOIN PRONTUARIOSCRC ON ITENSDEPOSITOPORTARIA.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc WHERE NomeInternoCrc LIKE'" + jPesqNomeInterno.getText() + "%' AND IdLanc='" + jIdLanc.getText() + "'");
        }
...
//Preencher tabela com todos os VISITANTES
    public void buscarInternos(String sql) {
        ...
        String[] Colunas = new String[]{"ID", "  Nome Interno", " Valor R$", "Data Entrada"};
        conecta.abrirConexao();
        try {
