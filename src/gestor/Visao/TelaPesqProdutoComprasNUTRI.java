...
import static gestor.Visao.TelaEntradaProdutosNUTRI.jDescricaoProduto;
import static gestor.Visao.TelaEntradaProdutosNUTRI.jIdProd;
import static gestor.Visao.TelaEntradaProdutosNUTRI.jCodigoBarras;
import static gestor.Visao.TelaEntradaProdutosNUTRI.jLote;
import static gestor.Visao.TelaEntradaProdutosNUTRI.jReferencia;
import static gestor.Visao.TelaEntradaProdutosNUTRI.jUnidade;
 ...
 * @author user
 */
public class TelaPesqProdutoComprasNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoComprasNUTRI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabelaProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Descrição", "Local Armazenamento"
            }
        ));
    ...
    private void jCheckBoxPesqTodosProdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosProdItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {           
            this.preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "INNER JOIN LOTE_PRODUTOS_AC "
                    + "ON PRODUTOS_AC.IdProd=LOTE_PRODUTOS_AC.IdProd "
                    + "WHEREPRODUTOS_AC.StatusProd='" + statusProd + "'AND PRODUTOS_AC.Modulo='" + modulo + "'ORDER BY DescricaoProd");
        } else {
            limparTabela();
        }
