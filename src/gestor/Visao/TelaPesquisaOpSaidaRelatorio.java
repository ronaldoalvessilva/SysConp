 ...
 * @author Ronaldo
 */
public class TelaPesquisaOpSaidaRelatorio extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaOpSaidaRelatorio() {
        initComponents();
        jPesDescOp.setDocument(new LimiteDigitosAlfa(58));
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesDescOp.getText().equals("")) {
            ...
            preencherTabelaNome("SELECT * FROM OPERACAO WHERE DescricaoOp LIKE'%" + jPesDescOp.getText() + "%' "
                    + "AND TipoOp='" + tipo + "'");
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        TelaRelatorioSaidas.jPesqOperacao.setText(jPesDescOp.getText());
        dispose();
