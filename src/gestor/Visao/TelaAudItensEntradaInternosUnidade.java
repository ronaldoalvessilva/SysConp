...
import static gestor.Visao.TelaEntradaUnidadeInternoPortaria.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAudItensEntradaInternosUnidade extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAudItensEntradaInternosUnidade() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSENTRADAPORTARIA WHERE IdLanc='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
