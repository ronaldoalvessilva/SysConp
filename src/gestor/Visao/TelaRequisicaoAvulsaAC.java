...
import gestor.Controle.ControleItensRequisicaoMateriaisAvulso;
import gestor.Controle.ControleLogSistema;
import gestor.Controle.ControleRequisicaoMateririasAvulso;
...
import static gestor.Visao.TelaModuloAlmoxarifado.telaMovimentacaoRequisiacaoAvulsaItensAL;
 ...
 * @author Ronaldo
 */
public class TelaRequisicaoAvulsaAC extends javax.swing.JInternalFrame {
    ...
    ControleRequisicaoMateririasAvulso control = new ControleRequisicaoMateririasAvulso();
    ControleItensRequisicaoMateriaisAvulso controle = new ControleItensRequisicaoMateriaisAvulso();
    //    
    ...
    String nomeModuloTela = "Almoxarifado:Requisição Avulsa de Materiais Interno:Manutenção";
    String nomeModuloTela2 = "Almoxarifado:Requisição Avulsa de Materiais Interno:Itens";
    //
    int flag;
    int acao;
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Requisição Avulsa de Materiais :::...");
        setToolTipText("");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jStatusReq, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jIdLocal, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel5Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jBtFinalizar, jBtImprimirRequisicao});
                    ...
                    .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel12Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(jDepartamentoReqAutorizador, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap(21, Short.MAX_VALUE))
        );
                        ...
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel9Layout.createSequentialGroup()
                                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jComboBoxUnidade, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jCodigoBarrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCodigoBarrasActionPerformed
        ...
        conecta.executaSQL("SELECT * FROM PRODUTOS_AC "
                ...
                + "AND PRODUTOS_AC.StatusProd='" + statusProd + "'AND Modulo='" + modulo + "'");
        try {
            if (conecta.rs.first()) {
    ...
    private void jBtPesqProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqProdutoActionPerformed
        // TODO add your handling code here:
        TelaPesqProdutoRequisicaoAvulsaMateriais objPesqProdReqMat = new TelaPesqProdutoRequisicaoAvulsaMateriais();
    ...
    private void jCheckBoxTodosReqItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosReqItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarRequisicaoMateriais("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS "
                    + "INNER JOIN COLABORADOR "
                    + "ON REQUISICAO_AVULSA_PRODUTOS.IdFunc=COLABORADOR.IdFunc ");
        } else {
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS "
                        ...
                        + "WHERE REQUISICAO_AVULSA_PRODUTOS.IdReq='" + IdLanc + "'");
                conecta.rs.first();
            ...
            count = 0;
            preencherTabelaItens("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS "
                    + "INNER JOIN REQUISICAO_AVULSA_PRODUTOS "
                    + "ON ITENS_REQUISICAO_AVULSA_PRODUTOS.IdReq=REQUISICAO_AVULSA_PRODUTOS.IdReq "
                    + "INNER JOIN PRODUTOS_AC "
                    + "ON ITENS_REQUISICAO_AVULSA_PRODUTOS.IdProd=PRODUTOS_AC.IdProd "
                    + "WHERE ITENS_REQUISICAO_AVULSA_PRODUTOS.IdReq='" + jCodReq.getText() + "'");
        }
    ...
    private void jBtPesqLocalArmazenamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqLocalArmazenamentoActionPerformed
        // TODO add your handling code here:
        TelaPesqLocalArmazenamentoReqAvulsaAC objPesqLocalArm = new TelaPesqLocalArmazenamentoReqAvulsaAC();
    ...
    private void jBtPesqColaboradorRequisitanteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqColaboradorRequisitanteActionPerformed
        // TODO add your handling code here:
        TelaPesquisaColabordorRequisicaoAvulsa objFuncReq = new TelaPesquisaColabordorRequisicaoAvulsa();
    ...
    private void jBtPesqFuncAutorizadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqFuncAutorizadorActionPerformed
        // TODO add your handling code here:
        TelaPesquisaColabordorAutRequisicaoAvulsa objFuncReq = new TelaPesquisaColabordorAutRequisicaoAvulsa();
        TelaModuloAlmoxarifado.jPainelAlmoxarifado.add(objFuncReq);
        objFuncReq.show();
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS WHERE IdReq='" + jCodReq.getText() + "'");
            conecta.rs.first();
            jStatusReq.setText(conecta.rs.getString("StatusReq"));
        ...
        if (jCodReq.getText().equals("")) {
            ...
            try {
                ...
                conecta.executaSQL("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS "
                        ...
                        + "INNER JOIN DEPARTAMENTOS "
                        + "ON COLABORADOR.IdDepartamento=COLABORADOR.IdDepartamento "
                        + "WHERE REQUISICAO_AVULSA_PRODUTOS.IdReq='" + jCodReq.getText() + "'");
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        // TODO add your handling code here:
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoAL.equals("ADMINISTRADORES") || codigoUserAL == codUserAcessoAL && nomeTelaAL.equals(telaMovimentacaoRequisiacaoAvulsaManuAL) && codIncluirAL == 1) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoAL.equals("ADMINISTRADORES") || codigoUserAL == codUserAcessoAL && nomeTelaAL.equals(telaMovimentacaoRequisiacaoAvulsaManuAL) && codAlterarAL == 1) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoAL.equals("ADMINISTRADORES") || codigoUserAL == codUserAcessoAL && nomeTelaAL.equals(telaMovimentacaoRequisiacaoAvulsaManuAL) && codExcluirAL == 1) {
            objReqMatAvulso.setStatusReq(jStatusReq.getText());
            if (jStatusReq.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser modificado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoAL.equals("ADMINISTRADORES") || codigoUserAL == codUserAcessoAL && nomeTelaAL.equals(telaMovimentacaoRequisiacaoAvulsaManuAL) && codGravarAL == 1) {
            if (jDataReq.getDate() == null) {
                ...
                if (acao == 1) {
                    ...
                    //
                    control.incluirRequisicaoMaterialAvulso(objReqMatAvulso);
                    buscarCodigo();
                    //
                    objLog();
                ...
                if (acao == 2) {
                    ...
                    control.alterarRequisicaoMaterialAvulso(objReqMatAvulso);
                    objLog();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
                    Salvar();
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaRequisicaoAvulsaAC objAudiReqAvulsa = new TelaAuditoriaRequisicaoAvulsaAC();
        TelaModuloAlmoxarifado.jPainelAlmoxarifado.add(objAudiReqAvulsa);
        objAudiReqAvulsa.show();
    ...
    private void jBtNovoItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoItemActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaMovimentacaoRequisiacaoAvulsaItensAL);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoAL.equals("ADMINISTRADORES") || codigoUserAL == codUserAcessoAL && nomeTelaAL.equals(telaMovimentacaoRequisiacaoAvulsaItensAL) && codIncluirAL == 1) {
            objReqMatAvulso.setStatusReq(jStatusReq.getText());
            if (jStatusReq.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser modificado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtAlterarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarItemActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaMovimentacaoRequisiacaoAvulsaItensAL);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoAL.equals("ADMINISTRADORES") || codigoUserAL == codUserAcessoAL && nomeTelaAL.equals(telaMovimentacaoRequisiacaoAvulsaItensAL) && codAlterarAL == 1) {
            objReqMatAvulso.setStatusReq(jStatusReq.getText());
            if (jStatusReq.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser modificado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtExcluirItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirItemActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaMovimentacaoRequisiacaoAvulsaItensAL);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoAL.equals("ADMINISTRADORES") || codigoUserAL == codUserAcessoAL && nomeTelaAL.equals(telaMovimentacaoRequisiacaoAvulsaItensAL) && codExcluirAL == 1) {
            ...
            if (jStatusReq.getText().equals("FINALIZADO")) {
                ...
                if (resposta == JOptionPane.YES_OPTION) {
                    ...
                    try {
                        ...
                        Logger.getLogger(TelaRequisicaoAvulsaAC.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    private void jBtSalvarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarItemActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaMovimentacaoRequisiacaoAvulsaItensAL);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoAL.equals("ADMINISTRADORES") || codigoUserAL == codUserAcessoAL && nomeTelaAL.equals(telaMovimentacaoRequisiacaoAvulsaItensAL) && codGravarAL == 1) {
            DecimalFormat qtdReal = new DecimalFormat("###,##00.0");
            qtdReal.setCurrency(Currency.getInstance(new Locale("pt", "BR")));
            if (jCodProduto.getText().equals("")) {
                ...
                if (acao == 3) {
                    ...
                    if (saldoEstoque >= objItensReqMatInter.getQtdItem()) {
                        ...
                        controle.incluirRequisicaoAvulsaMaterial(objItensReqMatInter);
                        //
                        objLog2();
                        controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                        preencherTabelaItens("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS "
                ...
                if (acao == 4) {
                    ...
                    if (novoSaldoAtual >= objItensReqMatInter.getQtdItem()) {
                        ...
                        objItensReqMatInter.setIdItem(Integer.valueOf(idItem));
                        controle.alterarRequisicaoAvulsaMaterial(objItensReqMatInter); // ALTERAR QUANTIDADE NA TABELA ITENS_REQUISICAO_PRODUTOS_INTERNOS
                        //
                        objItensReqMatInter.setQtdItem(estoqueAtual);
    ...
    private void jBtAuditoriaItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaItemActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensRequiAvulsaAC objAudiItensReqAvulsaAC = new TelaAuditoriaItensRequiAvulsaAC();
        TelaModuloAlmoxarifado.jPainelAlmoxarifado.add(objAudiItensReqAvulsaAC);
        objAudiItensReqAvulsaAC.show();
    ...
    public void Finalizar() {
        ...
        if (rows == 0) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                control.finalizarRequisicaoMaterialAvulso(objReqMatAvulso);
    ...
    public void verificarItensRequisitados() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS WHERE IdReq='" + objReqMatAvulso.getIdReq() + "'");
            conecta.rs.first();
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                objReqMatAvulso.setIdReq(Integer.parseInt(jCodReq.getText()));
                control.excluirRequisicaoMaterialAvulso(objReqMatAvulso);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                Excluir();
