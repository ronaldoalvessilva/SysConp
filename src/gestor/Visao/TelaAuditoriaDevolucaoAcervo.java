 ...
 * @author Ronaldo
 */
public class TelaAuditoriaDevolucaoAcervo extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaDevolucaoAcervo() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        setTitle("...::: Auditoria Devolução de Acervos :::...");
        setToolTipText("");
