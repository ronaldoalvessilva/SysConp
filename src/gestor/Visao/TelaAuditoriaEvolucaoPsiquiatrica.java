 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEvolucaoPsiquiatrica extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEvolucaoPsiquiatrica() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Evolução Psiquiatrica :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM EVOLUCAO_PSIQUIATRICA WHERE IdLanc='" + jIdAdm.getText() + "'AND IdItem='" + jIdEvolucaoPsiquiatrica.getText() + "'");
            conecta.rs.first();
