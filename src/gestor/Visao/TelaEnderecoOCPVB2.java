...
import static gestor.Visao.TelaInformacoesInternoBCB2.jIdInternoBCB2;
 ...
 */
public class TelaEnderecoOCPVB2 extends javax.swing.JDialog {
     ...
     */
    public static TelaInformacoesInternoBCB2 ENDERbcb2;

    public TelaEnderecoOCPVB2(TelaInformacoesInternoBCB2 parent, boolean modal) {
        this.ENDERbcb2 = parent;
        this.setModal(modal);
        setLocationRelativeTo(ENDERbcb2);
        initComponents();
        pesquisarEndereco();
        corCampos();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaEnderecoOCPVB2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaEnderecoOCPVB2 dialog = new TelaEnderecoOCPVB2(ENDERbcb2, true);
    ...
    public void pesquisarEndereco() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                    + "WHERE IdInternoCrc='" + jIdInternoBCB2.getText() + "'");
            conecta.rs.first();
