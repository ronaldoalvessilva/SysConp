 ...
 * @author ronaldo
 */
public class TelaFotoHallFeminino extends javax.swing.JDialog {
     ...
     */
    public TelaFotoHallFeminino(TelaEntradaSaidaVisitasInternasInternos parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoHallFeminino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoHallFeminino dialog = new TelaFotoHallFeminino(telaentsaidvisitainterno, true);
