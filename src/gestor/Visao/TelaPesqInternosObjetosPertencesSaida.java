...
import gestor.Dao.*;
import static gestor.Visao.TelaSaidaObjetosPertences.jFotoInternosObjetos;
import static gestor.Visao.TelaSaidaObjetosPertences.jIdInternoCrcObjeto;
import static gestor.Visao.TelaSaidaObjetosPertences.jNomeInternoCrcObjeto;
 ...
 * @author user
 */
public class TelaPesqInternosObjetosPertencesSaida extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternosObjetosPertencesSaida() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa Internos Pertences - {SE} :::...");
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            jIdInternoCrcObjeto.setText(idFunc);//           
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC WHERE NomeInternoCrc='" + jPesqNomeInterno.getText() + "'");
                conecta.rs.first();
                jIdInternoCrcObjeto.setText(String.valueOf(conecta.rs.getInt("IdInternoCrc")));
                ...
                jFotoInternosObjetos.setIcon(v);
                jFotoInternosObjetos.setIcon(new ImageIcon(v.getImage().getScaledInstance(jFotoInternosObjetos.getWidth(), jFotoInternosObjetos.getHeight(), Image.SCALE_DEFAULT)));
                conecta.desconecta();
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jPesqNomeInterno.getText().equals("")) {
            ...
            buscarInternoVisitas("SELECT * FROM PRONTUARIOSCRC WHERE NomeInternoCrc LIKE'%" + jPesqNomeInterno.getText() + "%'AND SituacaoCrc='" + situacaoEnt + "'OR NomeInternoCrc LIKE'%" + jPesqNomeInterno.getText() + "%'AND SituacaoCrc='" + situacaoRet + "'");
        }
