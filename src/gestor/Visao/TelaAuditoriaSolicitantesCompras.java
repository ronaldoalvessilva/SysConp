 ...
 * @author Ronaldo
 */
public class TelaAuditoriaSolicitantesCompras extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaSolicitantesCompras() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Solicitantes Compras :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM SOLICITANTES_COMPRAS WHERE IdSoli='" + jCodigo.getText() + "'");
            conecta.rs.first();
