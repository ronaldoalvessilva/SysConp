 ...
 * @author Ronaldo
 */
public class TelaPesquisaRetornoInterno extends javax.swing.JInternalFrame {
    ...
    String dataCadastro;
    String dataEntrada;
    String situacaoCrc = "SAI";
    String situacaoEva = "EVA";
    

    /**
     * Creates new form TelaPesquisaEntradaInternos
     */
    public TelaPesquisaRetornoInterno() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(jPesqNome, javax.swing.GroupLayout.PREFERRED_SIZE, 236, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTabelaNome("SELECT * FROM MOVISR "
                    ...
                    + "WHERE NomeInternoCrc LIKE'" + jPesqNome.getText() + "%'AND SituacaoCrc LIKE'" + situacaoCrc + "%'OR NomeInternoCrc LIKE'" + jPesqNome.getText() + "%'AND SituacaoCrc LIKE'" + situacaoEva + "%'");
        }
    ...
    private void jCheckBox2ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox2ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            ...
            this.preencherTabelaNome("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "WHERE SituacaoCrc LIKE'" + situacaoCrc  + "%'");           
        } else {
            jTabelaInterno.setVisible(!true);
        }
