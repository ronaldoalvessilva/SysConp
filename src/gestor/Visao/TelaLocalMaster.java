 ...
 * @author user
 */
public class TelaLocalMaster extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "Farmacia:Local de Armazenamento:Manutenção";
    int acao, flag;
    String codLocal;
    int nivelLocalFar = 1;
    int nivelLocalEnf = 2;
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Local Armazenamento Master {FAR}:::...");
        ...
        if (jTabelaLocalArmazenamento.getColumnModel().getColumnCount() > 0) {
            jTabelaLocalArmazenamento.getColumnModel().getColumn(0).setMinWidth(60);
            jTabelaLocalArmazenamento.getColumnModel().getColumn(0).setMaxWidth(60);
            jTabelaLocalArmazenamento.getColumnModel().getColumn(1).setMinWidth(290);
            jTabelaLocalArmazenamento.getColumnModel().getColumn(1).setMaxWidth(290);
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Localização - Nivel I", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(0, 0, 255))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jDescricaoLocal, javax.swing.GroupLayout.DEFAULT_SIZE, 396, Short.MAX_VALUE)
                    .addComponent(jLabel3)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel1)
                            .addComponent(jIDLocal, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jComboBoxStatusLocal, javax.swing.GroupLayout.PREFERRED_SIZE, 322, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 220, Short.MAX_VALUE)
                .addContainerGap())
        );

        setBounds(300, 10, 469, 250);
    ...
    private void jCheckBoxTodosLocaisItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosLocaisItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            ...
            this.preencherTabelaLocal("SELECT * FROM LOCAL_ARMAZENAMENTO_AC WHERE NivelLocal='" + nivelLocalFar + "'AND Modulo='" + modulo + "'OR NivelLocal='" + nivelLocalEnf + "'AND Modulo='" + modulo + "'OR NivelLocal='" + nivelLocalFar + "'AND Modulo='" + modulo2 + "'OR NivelLocal='" + nivelLocalEnf + "'AND Modulo='" + modulo2 + "'");
        } else {
            limparTabelaLocal();;
        }
    ...
    public void verificarLocalArmazenamento() {
        ...
        try {
            ...
            Logger.getLogger(TelaLocalMaster.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void preencherTabelaLocal(String sql) {
        ...
        jTabelaLocalArmazenamento.getColumnModel().getColumn(0).setPreferredWidth(60);
        jTabelaLocalArmazenamento.getColumnModel().getColumn(0).setResizable(false);
        jTabelaLocalArmazenamento.getColumnModel().getColumn(1).setPreferredWidth(290);
        ...
        alinhaCamposTabelaLocal();
        conecta.desconecta();
    }

    public void alinhaCamposTabelaLocal() {
