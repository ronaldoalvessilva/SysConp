 ...
 * @author user
 */
public class TelaPesqInternoNovaEntradaCrc extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoNovaEntradaCrc() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa Entrada Interno - {P1/CRC} :::...");
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jNomeInternoCrc.getText().equals("")) {
            ...
            buscarInternos("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "ON PRONTUARIOSCRC.IdInternoCrc=ITENSNOVAENTRADA.IdInternoCrc "
                    + "WHERE NomeInternoCrc LIKE'%" + jNomeInternoCrc.getText() + "%' "
                    + "AND UtilizadoCrc='" + utilizadoCrc + "'");
        }
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {            
            this.buscarInternos("SELECT * FROM PRONTUARIOSCRC "
                    + "INNER JOIN ITENSNOVAENTRADA "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=ITENSNOVAENTRADA.IdInternoCrc "
                    + "WHERE UtilizadoCrc='" + utilizadoCrc + "'");
        } else {
           limparTabela();
        }
    ...
    public void buscarInternos(String sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdInternoCrc"), conecta.rs.getString("NomeInternoCrc"), dataEntrada});
