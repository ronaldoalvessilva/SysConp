...
import static gestor.Visao.TelaMedicamentos.jIdProduto;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaProdutosFAR extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaProdutosFAR() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PRODUTOS_AC WHERE IdProd='" + jIdProduto.getText() + "'");
            conecta.rs.first();
