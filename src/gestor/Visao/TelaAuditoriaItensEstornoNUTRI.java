...
import static gestor.Visao.TelaEstornoRequisicaoMateriaisNUTRI.jIdEst;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisNUTRI.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEstornoNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEstornoNUTRI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_ESTORNO_PRODUTOS_NUTRI WHERE IdEst='" + jIdEst.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
