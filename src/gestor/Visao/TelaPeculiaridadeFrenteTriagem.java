 ...
 * @author ronaldo
 */
public class TelaPeculiaridadeFrenteTriagem extends javax.swing.JDialog {
    ...
    public TelaPeculiaridadeFrenteTriagem(TelaProntuarioTriagem parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPeculiaridadeFrenteTriagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaPeculiaridadeFrenteTriagem dialog = new TelaPeculiaridadeFrenteTriagem(telaProntuarioTriagem, true);
