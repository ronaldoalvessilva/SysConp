...
public class TelaPerfilCarcerario extends javax.swing.JInternalFrame {
    ...
    private void jBtNovoPerfilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoPerfilActionPerformed
        ...
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaPerfilPopCarcerariaPerfilSS) && codIncluirSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
            objPerfilInter.setStatusPerfil(jStatusPerfil.getText());
            if (jStatusPerfil.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtAlterarPerfilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarPerfilActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaPerfilPopCarcerariaPerfilSS);
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaPerfilPopCarcerariaPerfilSS) && codAlterarSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
            objPerfilInter.setStatusPerfil(jStatusPerfil.getText());
            if (jStatusPerfil.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtExcluirPerfilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirPerfilActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaPerfilPopCarcerariaPerfilSS);
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaPerfilPopCarcerariaPerfilSS) && codExcluirSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
            objPerfilInter.setStatusPerfil(jStatusPerfil.getText());
            if (jStatusPerfil.getText().equals("FINALIZADO")) {
    ...
    private void jBtSalvarPerfilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarPerfilActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaPerfilPopCarcerariaPerfilSS);
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaPerfilPopCarcerariaPerfilSS) && codGravarSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
