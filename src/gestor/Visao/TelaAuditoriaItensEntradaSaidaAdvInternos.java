 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntradaSaidaAdvInternos extends javax.swing.JInternalFrame {
   ...
   ItensEntradaSaidaAdvInternos objItensEntSaiAdvInternos = new ItensEntradaSaidaAdvInternos();
     ...
     */
    public TelaAuditoriaItensEntradaSaidaAdvInternos() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSADVOGADOINTERNOS WHERE Idlanc='" + jIDlanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
