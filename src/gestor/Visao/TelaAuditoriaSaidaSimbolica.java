 ...
 * @author Ronaldo
 */
public class TelaAuditoriaSaidaSimbolica extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaSaidaSimbolica() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM SAIDA_SIMBOLICA_CRC WHERE IdRegSaida='" + jIdRegistro.getText() + "'");
            conecta.rs.first();
