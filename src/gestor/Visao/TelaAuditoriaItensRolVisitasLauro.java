...
import static gestor.Visao.TelaRolVisitas.idItem;
import static gestor.Visao.TelaRolVisitas.jIDRol;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRolVisitasLauro extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRolVisitasLauro() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSROL WHERE IdVisita='" + jIDVisita.getText() + "'AND IdItemRol='" + idItem + "'");
            conecta.rs.first();
