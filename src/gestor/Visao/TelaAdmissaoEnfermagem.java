...
public class TelaAdmissaoEnfermagem extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel41Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel41Layout.createSequentialGroup()
                ...
                .addGroup(jPanel41Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jComboBoxHIV, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel41Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel41Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel41Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jQualCirurgia, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel41Layout.createSequentialGroup()
        ...
        jPanel15Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jQuaisAlergias, jQuaisDoencas, jQuaisDrogas});
        ...
        ContinuacaoLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, ContinuacaoLayout.createSequentialGroup()
                ...
                .addGroup(ContinuacaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jPanel7, javax.swing.GroupLayout.PREFERRED_SIZE, 572, Short.MAX_VALUE)
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissaoEnfeIntManuENF) && codIncluir == 1) {
            acao = 1;
            bloquearCampos();
            Novo();
            corCampos();
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissaoEnfeIntManuENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissaoEnfeIntManuENF) && codAlterar == 1) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissaoEnfeIntManuENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissaoEnfeIntManuENF) && codExcluir == 1) {
            verificarEvolucao();
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissaoEnfeIntManuENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissaoEnfeIntManuENF) && codGravar == 1) {
    ...
    private void jBtNovaEvolucaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovaEvolucaoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissaoEnfeIntEvolENF) && codIncluir == 1) {
    ...
    private void jBtAlterarEvolucaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarEvolucaoActionPerformed
        buscarAcessoUsuario(telaAdmissaoEnfeIntEvolENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissaoEnfeIntEvolENF) && codAlterar == 1) {
            conecta.abrirConexao();
            try {
    ...
    private void jBtExcluirEvolucaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirEvolucaoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissaoEnfeIntEvolENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissaoEnfeIntEvolENF) && codExcluir == 1) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            conecta.abrirConexao();
    ...
    private void jBtSalvarEvolucaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarEvolucaoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissaoEnfeIntEvolENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissaoEnfeIntEvolENF) && codGravar == 1) {
    ...
    private void jBtNovoAFP1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoAFP1ActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP1ENF) && codIncluir == 1) {
            acao = 3;
            statusMov = "Incluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
    ...
    private void jBtAlterarAFP1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarAFP1ActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissãoEnfeIntAEFP1ENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP1ENF) && codAlterar == 1) {
            acao = 4;
            statusMov = "Alterou";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
    ...
    private void jBtExcluirAFP1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirAFP1ActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissãoEnfeIntAEFP1ENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP1ENF) && codExcluir == 1) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            bloquearCampos();
    ...
    private void jBtSalvarAFP1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarAFP1ActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissãoEnfeIntAEFP1ENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP1ENF) && codGravar == 1) {
            verificarAEFP1();
    ...
    private void jBtNovoAFP2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoAFP2ActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP2ENF) && codIncluir == 1) {
            acao = 7;
            statusMov = "Incluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
    ...
    private void jBtAlterarAFP2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarAFP2ActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissãoEnfeIntAEFP2ENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP2ENF) && codAlterar == 1) {
            acao = 8;
            statusMov = "Alterou";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
    ...
    private void jBtExcluirAFP2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirAFP2ActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissãoEnfeIntAEFP2ENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP2ENF) && codExcluir == 1) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            bloquearCampos();
    ...
    private void jBtSalvarAFP2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarAFP2ActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissãoEnfeIntAEFP2ENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP2ENF) && codGravar == 1) {
            verificarAEFP2();
    ...
    private void jBtNovoAFP3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoAFP3ActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP3ENF) && codIncluir == 1) {
            acao = 9;
            statusMov = "Incluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
    ...
    private void jBtAlterarAFP3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarAFP3ActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissãoEnfeIntAEFP3ENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP3ENF) && codAlterar == 1) {
            acao = 10;
            statusMov = "Alterou";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
    ...
    private void jBtExcluirAFP3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirAFP3ActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissãoEnfeIntAEFP3ENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP3ENF) && codExcluir == 1) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            bloquearCampos();
    ...
    private void jBtSalvarAFP3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarAFP3ActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissãoEnfeIntAEFP3ENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP3ENF) && codGravar == 1) {
            verificarAEFP3();
    ...
    private void jBtNovoAFP4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoAFP4ActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP4ENF) && codIncluir == 1) {
            acao = 11;
            statusMov = "Incluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
    ...
    private void jBtAlterarAFP4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarAFP4ActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissãoEnfeIntAEFP4ENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP4ENF) && codAlterar == 1) {
            acao = 12;
            statusMov = "Alterou";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
    ...
    private void jBtExcluirAFP4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirAFP4ActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissãoEnfeIntAEFP4ENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP4ENF) && codExcluir == 1) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            bloquearCampos();
    ...
    private void jBtSalvarAFP4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarAFP4ActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaAdmissãoEnfeIntAEFP4ENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaAdmissãoEnfeIntAEFP4ENF) && codGravar == 1) {
