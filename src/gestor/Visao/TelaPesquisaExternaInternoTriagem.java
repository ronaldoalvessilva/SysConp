...
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxEstadoCivil;
import static gestor.Visao.TelaProntuarioTriagem.jAlcunha;
import static gestor.Visao.TelaProntuarioTriagem.jAltura;
import static gestor.Visao.TelaProntuarioTriagem.jArtigo1;
import static gestor.Visao.TelaProntuarioTriagem.jArtigo2;
import static gestor.Visao.TelaProntuarioTriagem.jArtigo3;
import static gestor.Visao.TelaProntuarioTriagem.jBairro;
import static gestor.Visao.TelaProntuarioTriagem.jCPFInterno;
import static gestor.Visao.TelaProntuarioTriagem.jCalca;
import static gestor.Visao.TelaProntuarioTriagem.jCamisa;
import static gestor.Visao.TelaProntuarioTriagem.jCartaoSus;
import static gestor.Visao.TelaProntuarioTriagem.jCidade;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxBarba;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxBigode;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxBoca;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxCabelos;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxCompleicao;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxCutis;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxEdiondo;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxEscolaridade;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxLabios;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxNariz;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxOlhos;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxOrelha;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxParticipacao;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxPescoco;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxRegime;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxRosto;
import static gestor.Visao.TelaProntuarioTriagem.jComboBoxSexo;
import static gestor.Visao.TelaProntuarioTriagem.jDataCadastro;
import static gestor.Visao.TelaProntuarioTriagem.jDataCondenacao;
import static gestor.Visao.TelaProntuarioTriagem.jDataCrime;
import static gestor.Visao.TelaProntuarioTriagem.jDataEntrada;
import static gestor.Visao.TelaProntuarioTriagem.jDataNascimento;
import static gestor.Visao.TelaProntuarioTriagem.jDataNovaEntrada;
import static gestor.Visao.TelaProntuarioTriagem.jDataPrisao;
import static gestor.Visao.TelaProntuarioTriagem.jDataTerPena;
import static gestor.Visao.TelaProntuarioTriagem.jEndereco;
import static gestor.Visao.TelaProntuarioTriagem.jEstado;
import static gestor.Visao.TelaProntuarioTriagem.jIdentificador;
import static gestor.Visao.TelaProntuarioTriagem.jIdentificador1;
import static gestor.Visao.TelaProntuarioTriagem.jIdentificador2;
import static gestor.Visao.TelaProntuarioTriagem.jIdentificador3;
import static gestor.Visao.TelaProntuarioTriagem.jLabelFotoInterno;
...
import static gestor.Visao.TelaProntuarioTriagem.jPaiInterno;
import static gestor.Visao.TelaProntuarioTriagem.jParagrafo1;
import static gestor.Visao.TelaProntuarioTriagem.jParagrafo2;
import static gestor.Visao.TelaProntuarioTriagem.jParagrafo3;
import static gestor.Visao.TelaProntuarioTriagem.jParticularidade;
import static gestor.Visao.TelaProntuarioTriagem.jPena;
import static gestor.Visao.TelaProntuarioTriagem.jPerfil;
import static gestor.Visao.TelaProntuarioTriagem.jPeso;
import static gestor.Visao.TelaProntuarioTriagem.jProfissao;
import static gestor.Visao.TelaProntuarioTriagem.jRGInterno;
import static gestor.Visao.TelaProntuarioTriagem.jRegiaoCorpo;
import static gestor.Visao.TelaProntuarioTriagem.jRegiaoCorpo1;
import static gestor.Visao.TelaProntuarioTriagem.jRegiaoCorpo2;
import static gestor.Visao.TelaProntuarioTriagem.jReligiao;
import static gestor.Visao.TelaProntuarioTriagem.jSapato;
import static gestor.Visao.TelaProntuarioTriagem.jVaraCondenacao;
import static gestor.Visao.TelaProntuarioTriagem.caminhoFotoInternoTRIAGEM;
import static gestor.Visao.TelaProntuarioTriagem.jCNC;
 ...
 */
public class TelaPesquisaExternaInternoTriagem extends javax.swing.JDialog {
     ...
     */
    public static TelaProntuarioTriagem telaProntuarioIntTri;

    public TelaPesquisaExternaInternoTriagem(TelaProntuarioTriagem parent, boolean modal) {
        this.telaProntuarioIntTri = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaProntuarioIntTri);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPesquisaExternaInternoTriagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaPesquisaExternaInternoTriagem dialog = new TelaPesquisaExternaInternoTriagem(telaProntuarioIntTri, true);
