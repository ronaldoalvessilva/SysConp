 ...
 * @author Ronaldo
 */
public class TelaAudItensPagamentoKit extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();    
    /**
     * Creates new form TelaAuditoriaRolInternas
     */
    public TelaAudItensPagamentoKit() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_PAGAMENTO_KIT_INTERNOS "
                    + "WHERE IdPagto='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
