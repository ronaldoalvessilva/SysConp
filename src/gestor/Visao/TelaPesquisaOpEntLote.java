 ...
 * @author Ronaldo
 */
public class TelaPesquisaOpEntLote extends javax.swing.JInternalFrame {
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesDescOp.getText().isEmpty()) {
            ...
            TelaEntradasLote.jDescricaoOp.setText(jPesDescOp.getText());
            dispose();
        }
