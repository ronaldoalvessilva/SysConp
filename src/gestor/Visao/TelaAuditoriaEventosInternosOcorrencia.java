...
import static gestor.Visao.TelaRegimentoInternoDisciplinar.jCodigoOcorrencia;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEventosInternosOcorrencia extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEventosInternosOcorrencia() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM OCORRENCIA_AUTORES WHERE IdReg='" + jCodigoReg.getText() + "'AND IdOcr='" + jCodigoOcorrencia.getText() + "'");
            conecta.rs.first();
