...
import static gestor.Visao.TelaTiposExames.jCodigoExame;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaTiposExames extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaTiposExames() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Tipos de Exames :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM TIPOS_EXAMES_MEDICO WHERE IdExame='" + jCodigoExame.getText() + "'");
            conecta.rs.first();
