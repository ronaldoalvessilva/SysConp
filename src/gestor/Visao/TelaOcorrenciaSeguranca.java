...
import gestor.Controle.ControleOcorrenciaSeguranca;
...
import static gestor.Visao.TelaModuloSeguranca.telaLivroOcorrencias;
 ...
 * @author ronaldo
 */
public class TelaOcorrenciaSeguranca extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    OcorrenciaSeguranca objOcorr = new OcorrenciaSeguranca();
    ControleOcorrenciaSeguranca control = new ControleOcorrenciaSeguranca();
    ...
    String nomeModuloTela = "Segurança:Movimentação:Ocorrências Diárias:Manutenção";
    String horaMov;
    String dataModFinal;
    int count = 0;
     ...
     */
    public TelaOcorrenciaSeguranca() {
        initComponents();
        corCampos();
    ...
    private void initComponents() {
        ...
        if (jTabelaOcorrenciaPortaria.getColumnModel().getColumnCount() > 0) {
            jTabelaOcorrenciaPortaria.getColumnModel().getColumn(0).setMinWidth(50);
            jTabelaOcorrenciaPortaria.getColumnModel().getColumn(0).setMaxWidth(50);
            ...
            jTabelaOcorrenciaPortaria.getColumnModel().getColumn(2).setMinWidth(70);
            jTabelaOcorrenciaPortaria.getColumnModel().getColumn(2).setMaxWidth(70);
            jTabelaOcorrenciaPortaria.getColumnModel().getColumn(3).setMinWidth(370);
            jTabelaOcorrenciaPortaria.getColumnModel().getColumn(3).setMaxWidth(370);
        }
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (codigoUser == codUserAcesso && nomeTela.equals(telaLivroOcorrencias) && codIncluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        if (codigoUser == codUserAcesso && nomeTela.equals(telaLivroOcorrencias) && codAlterar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        if (codigoUser == codUserAcesso && nomeTela.equals(telaLivroOcorrencias) && codExcluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            objOcorr.setStatusLanc(jStatusOcorrencia.getText());
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        if (codigoUser == codUserAcesso && nomeTela.equals(telaLivroOcorrencias) && codGravar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        try {
            conecta.executaSQL("SELECT * FROM OCORRENCIASEGURANCA WHERE IdLanc='" + jIdOcorrencia.getText() + "'");
            conecta.rs.first();
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaOcorrenciaSeguranca objAudiOcorre = new TelaAuditoriaOcorrenciaSeguranca();
        TelaModuloSeguranca.jPainelSeguranca.add(objAudiOcorre);
        objAudiOcorre.show();
    ...
    private void jBtImpressaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtImpressaoActionPerformed
        ...
        try {
            conecta.abrirConexao();
            String path = "reports/ListagemOcorrenciaSeguranca.jasper";
            conecta.executaSQL("SELECT * FROM OCORRENCIASEGURANCA WHERE IdLanc='" + jIdOcorrencia.getText() + "'");
    ...
    private void jBtPesqCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoActionPerformed
        ...
        if (jCodigo.getText().equals(evt)) {
            ...
            pesquisarOcorrrencias("SELECT * FROM OCORRENCIASEGURANCA WHERE IdLanc='" + jCodigo.getText() + "'");
        }
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarOcorrrencias("SELECT * FROM OCORRENCIASEGURANCA");
        } else {
        ...
        if (jDataPesqInicial.getDate() == null) {
            ...
            if (jDataPesFinal.getDate() == null) {
                ...
                if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                    ...
                    pesquisarOcorrrencias("SELECT * FROM OCORRENCIASEGURANCA WHERE DataLanc BETWEEN'" + dataInicial + "'AND '" + dataFinal + "'");
                }
            }
        }
    ...
    private void jTabelaOcorrenciaPortariaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaOcorrenciaPortariaMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM OCORRENCIASEGURANCA WHERE IdLanc ='" + IdLanc + "'");
                conecta.rs.first();
    ...
    private void jBtPesqTituloOcorrrenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqTituloOcorrrenciaActionPerformed
        ...
        if (jPesqTituloOcorrencia.getText().equals("")) {
            ...
            pesquisarOcorrrencias("SELECT * FROM OCORRENCIASEGURANCA WHERE WHERE Titulo LIKE'" + jPesqTituloOcorrencia + "%'");
        }
    ...
    public void buscarID() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM OCORRENCIASEGURANCA");
            conecta.rs.last();
