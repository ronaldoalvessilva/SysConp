...
public class TelaOcorrenciaSeguranca extends javax.swing.JInternalFrame {
    ...
    //
    String caminhoPDF = "";
    String tituloOcorrencia = "OCORRÊNCIA_SEGURANÇA";
    String dataPDF = "";
    String horaPDF = "";
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Ocorrência Base II - {SEGURANÇA} :::...");
    ...
    private void jBtImpressaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtImpressaoActionPerformed
        ...
        try {
            conecta.abrirConexao();
            String path = "reports/GerenciaOperacional/ListagemOcorrenciaBaseSeguranca.jasper";
    ...
    private void jBtPesqTituloOcorrrenciaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtPesqTituloOcorrrenciaMouseClicked
        ...
        if (jPesqTituloOcorrencia.getText().equals("")) {
            ...
            pesquisarOcorrrencias("SELECT * FROM OCORRENCIASEGURANCA WHERE "
