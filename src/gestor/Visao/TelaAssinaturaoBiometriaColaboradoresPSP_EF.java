...
import static gestor.Visao.TelaRegistroInternosAtendimentoImpresso_EF.codigoLiberador;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpresso_EF.dataAssinatura;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpresso_EF.horaAssinatura;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpresso_EF.jBtSalvar;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpresso_EF.nomeLiberador;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpresso_EF.pDigitalCapturadaColaborador;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpresso_EF.pLiberacaoImpressa;
 ...
 * @author Ronaldo
 */
public class TelaAssinaturaoBiometriaColaboradoresPSP_EF extends javax.swing.JDialog {
    ...
    String nomeModuloTela2 = "EDUCAÇÃO FÍSICA:Liberação de Impressão de Atendimento:Biometria";
    String statusMov;
    String horaMov;
    String dataModFinal;
    int acao;
     ...
     */
    public static TelaRegistroInternosAtendimentoImpresso_EF assinaturaFuncPSP_EF;

    public TelaAssinaturaoBiometriaColaboradoresPSP_EF(TelaRegistroInternosAtendimentoImpresso_EF parent, boolean modal) {
        this.assinaturaFuncPSP_EF = parent;
        this.setModal(modal);
        setLocationRelativeTo(assinaturaFuncPSP_EF);
        initComponents();
        corCampos();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAssinaturaoBiometriaColaboradoresPSP_EF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAssinaturaoBiometriaColaboradoresPSP_EF dialog = new TelaAssinaturaoBiometriaColaboradoresPSP_EF(assinaturaFuncPSP_EF, true);
