 ...
 * @author Ronaldo
 */
public class TelaAuditoriaCancelamentoEvasao extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaCancelamentoEvasao() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Cancelamento Evasão de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT "
                    ...
                    + "WHERE IdCancelaEvasao='" + jIdLanc.getText() + "'");
            conecta.rs.first();
