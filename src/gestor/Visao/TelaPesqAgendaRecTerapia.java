...
import static gestor.Visao.TelaRecadosTerapiaOcupacional.jNomeDestinatario;
 ...
 * @author ronaldo
 */
public class TelaPesqAgendaRecTerapia extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqAgendaRecTerapia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (jTabelaUsuarios.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaUsuarios.getColumnModel().getColumn(2).setMinWidth(50);
            jTabelaUsuarios.getColumnModel().getColumn(2).setMaxWidth(50);
        }
