...
public class TelaModuloOdontologia extends javax.swing.JInternalFrame {
    ...
    // ASSINATURA  INTERNO
    public static String telaRegistroBiometriaODON = "Cadastro:Registro Interno para Atendimento - Odontologia:Manutenção";
