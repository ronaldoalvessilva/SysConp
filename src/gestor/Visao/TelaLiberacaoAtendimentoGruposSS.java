...
import static gestor.Visao.TelaAtendimentoGrupoSS.jBtAuditoria;
import static gestor.Visao.TelaAtendimentoGrupoSS.jBtNovo;
import static gestor.Visao.TelaAtendimentoGrupoSS.jCodigoAtend;
import static gestor.Visao.TelaAtendimentoGrupoSS.jDataAtend;
import static gestor.Visao.TelaAtendimentoGrupoSS.jStatusAtend;
...
public class TelaLiberacaoAtendimentoGruposSS extends javax.swing.JDialog {
     ...
     */
    public static TelaAtendimentoGrupoSS atendGPSI;
    public static TelaAssinaBiometriaColaboradoresPSP_AG_SS assinaBio;

    public TelaLiberacaoAtendimentoGruposSS(TelaAtendimentoGrupoSS parent, boolean modal) {
    ...
    public void mostrarLiberador() {
        assinaBio = new TelaAssinaBiometriaColaboradoresPSP_AG_SS(this, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLiberacaoAtendimentoGruposSS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaLiberacaoAtendimentoGruposSS dialog = new TelaLiberacaoAtendimentoGruposSS(atendGPSI, true);
