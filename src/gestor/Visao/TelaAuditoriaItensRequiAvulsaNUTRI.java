...
import static gestor.Visao.TelaRequisicaoAvulsaNUTRI.jCodReq;
import static gestor.Visao.TelaRequisicaoAvulsaNUTRI.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRequiAvulsaNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRequiAvulsaNUTRI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_NUTRI WHERE IdReq='" + jCodReq.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
