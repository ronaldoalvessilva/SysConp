...
import static gestor.Visao.TelaNaturezaEventoIndisciplinar.jIdNatureza;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaNaturezaEventos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaNaturezaEventos() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Natureza Eventos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM NATUREZAEVENTOS WHERE IdNatureza='" + jIdNatureza.getText() + "'");
            conecta.rs.first();
