...
import static gestor.Visao.TelaRetirarPenalidadeInterno.jIdLanc;
import static gestor.Visao.TelaRetirarPenalidadeInterno.idItemIntIso;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaInternosRetirarIso extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaInternosRetirarIso() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM INTERNOSISOLAMENTO WHERE IdLancRet='" + jIdLanc.getText() + "'AND IdIsola='" + idItemIntIso + "'");
            conecta.rs.first();
