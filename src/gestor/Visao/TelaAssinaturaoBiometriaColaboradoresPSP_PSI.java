...
import static gestor.Visao.TelaRegistroInternosAtendimentoImpressoPSI.codigoLiberador;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpressoPSI.dataAssinatura;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpressoPSI.horaAssinatura;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpressoPSI.jBtSalvar;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpressoPSI.nomeLiberador;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpressoPSI.pDigitalCapturadaColaborador;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpressoPSI.pLiberacaoImpressa;
 ...
 * @author Ronaldo
 */
public class TelaAssinaturaoBiometriaColaboradoresPSP_PSI extends javax.swing.JDialog {
    ...
    String nomeModuloTela2 = "PSICOLOGIA:Liberação de Impressão de Atendimento:Biometria";
    String statusMov;
    String horaMov;
    String dataModFinal;
    int acao;
     ...
     */
    public static TelaRegistroInternosAtendimentoImpressoPSI assinaturaFuncPSP_PSI;

    public TelaAssinaturaoBiometriaColaboradoresPSP_PSI(TelaRegistroInternosAtendimentoImpressoPSI parent, boolean modal) {
        this.assinaturaFuncPSP_PSI = parent;
        this.setModal(modal);
        setLocationRelativeTo(assinaturaFuncPSP_PSI);
        initComponents();
        corCampos();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAssinaturaoBiometriaColaboradoresPSP_PSI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAssinaturaoBiometriaColaboradoresPSP_PSI dialog = new TelaAssinaturaoBiometriaColaboradoresPSP_PSI(assinaturaFuncPSP_PSI, true);
