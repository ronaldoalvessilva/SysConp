...
import static gestor.Visao.TelaEmprestimoAcervo.jIdDoc;
import static gestor.Visao.TelaEmprestimoAcervo.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEmprestimoAcervo extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEmprestimoAcervo() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Itens Acervo :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_EMPRESTIMO_ACERVO WHERE IdEmprestimo='" + jIdDoc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
