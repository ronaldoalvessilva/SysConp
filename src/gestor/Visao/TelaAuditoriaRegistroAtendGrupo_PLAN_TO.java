...
import static gestor.Visao.TelaAtendimentoGrupoTO.jCodigoTema;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_PLAN_TO extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_PLAN_TO() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PLANEJAMENTO_ATENDIMENTO_GRUPO_TO "
                    + "WHERE IdItemPlanTO='" + jCodigoTema.getText() + "' "
