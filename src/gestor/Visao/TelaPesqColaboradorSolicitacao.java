...
import static gestor.Visao.TelaSolicitantesCompras.jCodigoDepto;
import static gestor.Visao.TelaSolicitantesCompras.jCodigoFunc;
import static gestor.Visao.TelaSolicitantesCompras.jNomeColaboradorSolicitante;
 ...
 * @author user
 */
public class TelaPesqColaboradorSolicitacao extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqColaboradorSolicitacao() {
        initComponents();
    }
        ...
        if (jNomeColaborador.getText().isEmpty()) {
            ...
            if (flag == 1) {
                ...
                try {
                    ...
                    conecta.rs.first();
                    jCodigoFunc.setText(String.valueOf(conecta.rs.getInt("IdFunc")));
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jNomeColaborador.getText().equals("")) {
            ...
            buscarFunc("SELECT * FROM COLABORADOR "
                    ...
                    + "INNER JOIN DEPARTAMENTOS "
                    + "ON COLABORADOR.IdDepartamento=DEPARTAMENTOS.IdDepartamento "
                    + "WHERE NomeFunc LIKE'%" + jNomeColaborador.getText() + "%' AND StatusFunc='" + statusFunc + "'AND DEPARTAMENTOS.IdDepartamento='" + jCodigoDepto.getText() + "'");
        }
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {           
            this.buscarFunc("SELECT * FROM COLABORADOR "
                    ...
                    + "INNER JOIN DEPARTAMENTOS "
                    + "ON COLABORADOR.IdDepartamento=DEPARTAMENTOS.IdDepartamento "
                    + "WHERE StatusFunc='" + statusFunc + "'AND DEPARTAMENTOS.IdDepartamento='" + jCodigoDepto.getText() + "'");
        } else {
            limparTabela();
        }
