...
import static gestor.Visao.TelaFormaPagamento.jCodigoPagto;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaFormaPagamento extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaFormaPagamento() {
        initComponents();
        auditoria();      
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Forma Pagamento :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM FORMA_PAGAMENTO WHERE IdForma='" + jCodigoPagto.getText() + "'");
            conecta.rs.first();
