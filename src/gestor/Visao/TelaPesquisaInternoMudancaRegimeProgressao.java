...
import static gestor.Visao.TelaMudancaRegimeProgressao.jIdInterno;
import static gestor.Visao.TelaMudancaRegimeProgressao.jNomeInternoRegime;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaInternoMudancaRegimeProgressao extends javax.swing.JInternalFrame {
    ...
    String situacaoRet = "RETORNO A UNIDDADE";
    public static String regimeAnterior; // Alterar os dados penais quando o regime do interno for provisório
    public static Date dataEntradaCrc, dataCrimeCrc, dataPrisaoCrc, dataCondenacaoCrc, terminoPenaCrc;
    public static int idUnid;
    public static String participacao, penaAnterior, artigo1, artigo2, artigo3, paragrafo1, paragrafo2, paragrafo3, crimeHediondo;
    String idInt;

    /**
     * Creates new form TelaPesquisaEntradaInternos
     */
    public TelaPesquisaInternoMudancaRegimeProgressao() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Pesquisa de Internos - Entrada :::...");
        ...
        if (jTabelaInterno.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaInterno.getColumnModel().getColumn(1).setMinWidth(400);
            jTabelaInterno.getColumnModel().getColumn(1).setMaxWidth(400);
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                ...
                dataEntradaCrc = conecta.rs.getDate("DataEntrada");
                idUnid = conecta.rs.getInt("IdUnid");
                dataCrimeCrc = conecta.rs.getDate("DataCrime");
                dataPrisaoCrc = conecta.rs.getDate("DataPrisao");
                dataCondenacaoCrc = conecta.rs.getDate("DataCondenacao");
                participacao = conecta.rs.getString("Participacao");
                regimeAnterior = conecta.rs.getString("Regime");
                penaAnterior = conecta.rs.getString("Pena");
                artigo1 = conecta.rs.getString("Artigo1");
                artigo2 = conecta.rs.getString("Artigo2");
                artigo3 = conecta.rs.getString("Artigo3");
                paragrafo1 = conecta.rs.getString("Paragrafo1");
                paragrafo2 = conecta.rs.getString("Paragrafo2");
                paragrafo3 = conecta.rs.getString("Paragrafo3");
                crimeHediondo = conecta.rs.getString("CrimeEdiondo");
                terminoPenaCrc = conecta.rs.getDate("TerminoPena");
                conecta.desconecta();
  ...
  // Método de pesquisa pela Descrição
    ...
    public void preencherTabelaNome(String sql) {
        ...
        jTabelaInterno.getColumnModel().getColumn(1).setPreferredWidth(400);
