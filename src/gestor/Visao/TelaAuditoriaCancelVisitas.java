 ...
 * @author Ronaldo
 */
public class TelaAuditoriaCancelVisitas extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaCancelVisitas() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM CANCELAMENTO_VISITAS_EXTERNA_INTERNA_ROL WHERE IdCan='" + jIdCan.getText() + "'");
            conecta.rs.first();
