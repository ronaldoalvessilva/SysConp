...
import static gestor.Visao.TelaTransportadora.jIdFornecedor;
import static gestor.Visao.TelaTransportadora.jIdVeiculo;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaVeiculosTransportador extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaVeiculosTransportador() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM VEICULOS_TRANSPORTADORA WHERE IdForn='" + jIdFornecedor.getText() + "'AND IdVeiculo='" + jIdVeiculo.getText() + "'");
            conecta.rs.first();
