 ...
 * @author Ronaldo
 */
public class TelaAuditoriaTipoKits extends javax.swing.JInternalFrame {
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM KITS_HIGIENE_INTERNO WHERE IdKit='" + jIdKit.getText() + "'");
            conecta.rs.first();
