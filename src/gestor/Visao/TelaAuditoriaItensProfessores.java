...
import static gestor.Visao.TelaProfessores.jIdProf;
import static gestor.Visao.TelaProfessores.IdItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensProfessores extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensProfessores() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM DISCIPLINASPROFESSOR WHERE IdDisc='" + jIdProf.getText() + "'AND IdItem='" + IdItem + "'");
            conecta.rs.first();
