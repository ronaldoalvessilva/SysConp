...
import static gestor.Visao.TelaAdmissaoEnfermagem.codigoAFP1;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAdmissaoEnfermeiraAEFP1 extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAdmissaoEnfermeiraAEFP1() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ADME_AFP1 WHERE IdLanc='" + jIdLanc.getText() + "' "
                    + "AND ADME_AFP1.IdAfp1='" + codigoAFP1 + "'");
            conecta.rs.first();
