 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEscalaTrabalhoFolga extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEscalaTrabalhoFolga() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ESCALA_TRABALHO_FOLGA_COLABORADOR WHERE IdEscala='" + pID_ESCALA + "'");
            conecta.rs.first();
