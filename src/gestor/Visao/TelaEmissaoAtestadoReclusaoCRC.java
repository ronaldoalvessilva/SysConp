...
import gestor.Controle.ControleEmissaoAtestadoReclusaoCRC;
...
import static gestor.Visao.TelaModuloCRC.emissaoAtestaRecCRC;
import static gestor.Visao.TelaModuloCRC.impressaoAtestado_CRC;
import static gestor.Visao.TelaModuloCRC.liberacaoAtestado_CRC;
 ...
 * @author ronal
 */
public class TelaEmissaoAtestadoReclusaoCRC extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    EmissaoAtestadoReclusao objEmissao = new EmissaoAtestadoReclusao();
    ControleEmissaoAtestadoReclusaoCRC control = new ControleEmissaoAtestadoReclusaoCRC();
    //
     ...
     */
    public static TelaTextoAtestadoReclusaoCRC textoAtestado;
    public static TelaAssinaturaoBiometriaColaboradoresAtestadoReclusaoCRC liberador;

    public TelaEmissaoAtestadoReclusaoCRC() {
        initComponents();
        corCampos();
    }

    public void mostrarTexto() {
        textoAtestado = new TelaTextoAtestadoReclusaoCRC(this, true);
        textoAtestado.setVisible(true);
    }

    public void mostrarLiberador() {
        liberador = new TelaAssinaturaoBiometriaColaboradoresAtestadoReclusaoCRC(this, true);
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setResizable(true);
        setTitle("...::: Emissao de Atestado de Reclusão - CRC :::...");
        ...
        jLabel17.setText("T.Solicitante:");

        jComboBoxSolicitante.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jComboBoxSolicitante.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione...", "Advogado", "Oficial de Justiça", "Visitas Diversas" }));
        jComboBoxSolicitante.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
                ...
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel13Layout.createSequentialGroup()
                        .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jNomeVisitaInterna)
                        ...
                        .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jBtPesqNomeVisitaInterna, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
        jPanel13Layout.setVerticalGroup(
            ...
            .addGroup(jPanel13Layout.createSequentialGroup()
                ...
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(jLabel17)
                    .addComponent(jComboBoxSolicitante, javax.swing.GroupLayout.PREFERRED_SIZE, 18, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jCheckBox1))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
        ...
        jLabel16.setText("Tipo Solicitante");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jStatusAtestado, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel4)
                    .addComponent(jComboBoxClassAtestado, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jBtValidar.setForeground(new java.awt.Color(102, 0, 102));
        jBtValidar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gestor/Imagens/061218140238_16.png"))); // NOI18N
        jBtValidar.setText("Validar");
        jBtValidar.setToolTipText("Verificar Validade do Atestado");
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jBtAtestado, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTabbedPane1.addTab("Movimentação", new javax.swing.ImageIcon(getClass().getResource("/gestor/Imagens/290718163923_16.png")), jPanel2); // NOI18N
        ...
        if (jTabelaProcesso.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaProcesso.getColumnModel().getColumn(3).setMinWidth(60);
            jTabelaProcesso.getColumnModel().getColumn(3).setMaxWidth(60);
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        count = 0;
        flag = 1;
        if (jComboBoxSolicitante.getSelectedItem().equals("Selecione...")) {
            JOptionPane.showMessageDialog(rootPane, "Informe o tipo de solicitante.");
        } else if (jComboBoxSolicitante.getSelectedItem().equals("Advogado")) {
            if (evt.getStateChange() == evt.SELECTED) {
                this.preencherTodosAtestados("SELECT * FROM EMISSAO_ATESTADO_RECLUSAO_CRC "
                        + "INNER JOIN PRONTUARIOSCRC "
                        + "ON EMISSAO_ATESTADO_RECLUSAO_CRC.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                        + "INNER JOIN ADVOGADOS "
                        + "ON EMISSAO_ATESTADO_RECLUSAO_CRC.IdVisita=ADVOGADOS.IdAdvogado");
    ...
    private void jBtPesqNomeVisitaInternaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeVisitaInternaActionPerformed
        ...
        if (jNomeVisitaInterna.getText().equals("")) {
            ...
            preencherTodosAtestados("SELECT * FROM EMISSAO_ATESTADO_RECLUSAO_CRC "
                    ...
                    + "INNER JOIN ADVOGADOS "
                    + "ON EMISSAO_ATESTADO_RECLUSAO_CRC.IdVisita=ADVOGADOS.IdAdvogado "
                    + "WHERE ADVOGADOS.NomeAdvogado LIKE'%" + jNomeVisitaInterna.getText() + "%'");
        } else if (jComboBoxSolicitante.getSelectedItem().equals("Oficial de Justiça")) {
            preencherTodosAtestados("SELECT * FROM EMISSAO_ATESTADO_RECLUSAO_CRC "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON EMISSAO_ATESTADO_RECLUSAO_CRC.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN OFICIAL_JUSTICA "
                    + "ON EMISSAO_ATESTADO_RECLUSAO_CRC.IdVisita=OFICIAL_JUSTICA.IdOficial "
                    + "WHERE OFICIAL_JUSTICA.NomeOficial LIKE'%" + jNomeVisitaInterna.getText() + "%'");
        } else if (jComboBoxSolicitante.getSelectedItem().equals("Visitas Diversas")) {
            preencherTodosAtestados("SELECT * FROM EMISSAO_ATESTADO_RECLUSAO_CRC "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON EMISSAO_ATESTADO_RECLUSAO_CRC.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN VISITASDIVERSAS "
                    + "ON EMISSAO_ATESTADO_RECLUSAO_CRC.IdVisita=VISITASDIVERSAS.IdVisita "
                    + "WHERE VISITASDIVERSAS.NomeVisita LIKE'%" + jNomeVisitaInterna.getText() + "%'");
        }
    ...
    private void jTabelaSolicitacaoAtestaReclusaoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaSolicitacaoAtestaReclusaoMouseClicked
        ...
        if (flag == 1) {
            ...
            try {
                ...
                jComboBoxTipoSolicitante.setSelectedItem(conecta.rs.getString("TipoSolicitante"));
                ...
                if (jComboBoxTipoSolicitante.getSelectedItem().equals("Advogado")) {
                    ...
                    jParentescoAtestado.setText(conecta.rs.getString("OabAdvogado"));
                    jNomeSolicitanteAtestado.setText(conecta.rs.getString("NomeAdvogado"));
                    ...
                    conecta.rs.first();
                    jIdVisitaAtestado.setText(conecta.rs.getString("IdVisita"));
                    jParentescoAtestado.setText(conecta.rs.getString("REGOficial"));
                    jNomeSolicitanteAtestado.setText(conecta.rs.getString("NomeOficial"));
                    ...
                    conecta.rs.first();
                    jIdVisitaAtestado.setText(conecta.rs.getString("IdVisita"));
                    jParentescoAtestado.setText(conecta.rs.getString("RgVisita"));
    ...
    private void jBtBuscarDadosVIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtBuscarDadosVIActionPerformed
        ...
        if (jComboBoxTipoSolicitante.getSelectedItem().equals("Selecione...")) {
            ...
            TelaPesqAdvogadoInternoAtestadoCRC objPesqAdAtestaRec = new TelaPesqAdvogadoInternoAtestadoCRC();
            TelaModuloCRC.jPainelCRC.add(objPesqAdAtestaRec);
            objPesqAdAtestaRec.show();
        } else if (jComboBoxTipoSolicitante.getSelectedItem().equals("Oficial de Justiça")) {
            limparCamposPesquisa();
            TelaPesqOficialInternoAtestadoCRC objPesqOfiAtestaRec = new TelaPesqOficialInternoAtestadoCRC();
            TelaModuloCRC.jPainelCRC.add(objPesqOfiAtestaRec);
            objPesqOfiAtestaRec.show();
        } else if (jComboBoxTipoSolicitante.getSelectedItem().equals("Visitas Diversas")) {
            limparCamposPesquisa();
            TelaPesqVisitasInternoSoliAtestadoCRC objPesqAtestaRec = new TelaPesqVisitasInternoSoliAtestadoCRC();
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(emissaoAtestaRecCRC) && codIncluirCRC == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES")) {
            acao = 1;
            limparCampos();
            bloquearBotoes();
            Novo();
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(emissaoAtestaRecCRC);
        if (codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(emissaoAtestaRecCRC) && codAlterarCRC == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES")) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(emissaoAtestaRecCRC);
        if (codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(emissaoAtestaRecCRC) && codExcluirCRC == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES")) {
            verificarValidadores();
            objEmissao.setStatusAtestado(jStatusAtestado.getText());
            if (jStatusAtestado.getText().equals("FINALIZADO")) {
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(emissaoAtestaRecCRC);
        if (codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(emissaoAtestaRecCRC) && codGravarCRC == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES")) {
            if (jComboBoxClassAtestado.getSelectedItem().equals("Selecione...")) {
                ...
                objEmissao.setTipoSolicitante((String) jComboBoxTipoSolicitante.getSelectedItem());
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaEmissaoAtestadoRecCRC objAudiEA = new TelaAuditoriaEmissaoAtestadoRecCRC();
    ...
    private void jBtLiberarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtLiberarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(liberacaoAtestado_CRC);
        if (codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(liberacaoAtestado_CRC) && codAbrirCRC == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES")) {
    ...
    private void jBtImpressaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtImpressaoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(impressaoAtestado_CRC);
        if (codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(impressaoAtestado_CRC) && codAbrirCRC == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES")) {
            verificarValidadores();
            if (jIdAtestado.getText().equals("")) {
                ...
                try {
                    ...
                    conecta.executaSQL("SELECT * FROM EMISSAO_ATESTADO_RECLUSAO_CRC "
                            ...
                            + "INNER JOIN ADVOGADOS "
                            + "ON EMISSAO_ATESTADO_RECLUSAO_CRC.IdVisita=ADVOGADOS.IdAdvogado "
                            + "WHERE EMISSAO_ATESTADO_RECLUSAO_CRC.IdAtestado='" + jIdAtestado.getText() + "'");
                    ...
                    jv.setTitle("Atestado de Reclusão Carcerária - Advogado");
                ...
                try {
                    conecta.abrirConexao();
                    String path = "reports/RelatorioAtestadoReclusaoCRC_OFJ.jasper";
                    conecta.executaSQL("SELECT * FROM EMISSAO_ATESTADO_RECLUSAO_CRC "
                            + "INNER JOIN PRONTUARIOSCRC "
                            + "ON EMISSAO_ATESTADO_RECLUSAO_CRC.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                            + "INNER JOIN DADOSPENAISINTERNOS "
                            + "ON DADOSPENAISINTERNOS.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                            + "INNER JOIN OFICIAL_JUSTIÇA "
                            + "ON EMISSAO_ATESTADO_RECLUSAO_CRC.IdVisita=OFICIAL_JUSTICA.IdOficial "
                            + "WHERE EMISSAO_ATESTADO_RECLUSAO_CRC.IdAtestado='" + jIdAtestado.getText() + "'");
                    HashMap parametros = new HashMap();
                    parametros.put("idRegistro", jIdAtestado.getText());
                    ...
                    JasperViewer jv = new JasperViewer(jpPrint, false); // Cria instancia para impressao
                    jv.setExtendedState(JasperViewer.MAXIMIZED_BOTH); // Maximizar o relatório
                    jv.setTitle("Atestado de Reclusão Carcerária - Oficial de Justiça");
                    jv.setVisible(true); // Chama o relatorio para ser visualizado             
                    jv.toFront(); // Traz o relatorio para frente da aplicação            
                    conecta.desconecta();
                } catch (JRException e) {
                ...
                try {
                    conecta.abrirConexao();
                    String path = "reports/RelatorioAtestadoReclusaoCRC_VID.jasper";
                    conecta.executaSQL("SELECT * FROM EMISSAO_ATESTADO_RECLUSAO_CRC "
                            + "INNER JOIN PRONTUARIOSCRC "
                            + "ON EMISSAO_ATESTADO_RECLUSAO_CRC.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                            + "INNER JOIN DADOSPENAISINTERNOS "
                    ...
                    JasperViewer jv = new JasperViewer(jpPrint, false); // Cria instancia para impressao
                    jv.setExtendedState(JasperViewer.MAXIMIZED_BOTH); // Maximizar o relatório
                    jv.setTitle("Atestado de Reclusão Carcerária - Visita Diversas");
                    jv.setVisible(true); // Chama o relatorio para ser visualizado             
                    jv.toFront(); // Traz o relatorio para frente da aplicação            
                    conecta.desconecta();
                } catch (JRException e) {
    ...
    private void jBtValidarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtValidarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(validadorAtestado_CRC);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(validadorAtestado_CRC) && codAbrirCRC == 1) {
            verificarValidadores();
            if (jIdAtestado.getText().equals("")) {
                JOptionPane.showMessageDialog(rootPane, "Não existe registro a ser impresso.");
            } else if (textoAtestadoReclusao.equals("")) {
                ...
                TelaValidadorAtestadoReclusaoCRC objValidador = new TelaValidadorAtestadoReclusaoCRC();
                TelaModuloCRC.jPainelCRC.add(objValidador);
                objValidador.show();
            }
        } else {
    ...
    public void preencherTodosAtestados(String sql) {
        ...
        try {
            ...
            do {
                ...
                if (jComboBoxSolicitante.getSelectedItem().equals("Advogado")) {
                    dados.add(new Object[]{conecta.rs.getInt("IdAtestado"), dataAtestado, conecta.rs.getString("NomeInternoCrc"), conecta.rs.getString("NomeAdvogado")});
                } else if (jComboBoxSolicitante.getSelectedItem().equals("Oficial de Justiça")) {
                    dados.add(new Object[]{conecta.rs.getInt("IdAtestado"), dataAtestado, conecta.rs.getString("NomeInternoCrc"), conecta.rs.getString("NomeOficial")});
                } else if (jComboBoxSolicitante.getSelectedItem().equals("Visitas Diversas")) {
    ...
    public void criptografiaMD5(String idRegistro, String dataRegistro, String idVisita, String idInterno, String nomeInterno) {
        ...
        try {
            ...
            Logger.getLogger(TelaEmissaoAtestadoReclusaoCRC.class.getName()).log(Level.SEVERE, null, ex);
