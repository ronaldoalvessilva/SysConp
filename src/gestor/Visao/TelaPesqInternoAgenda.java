...
import static gestor.Visao.TelaAgendaEscolta.FotoIngernoEscolta;
import static gestor.Visao.TelaAgendaEscolta.jIDInterno;
import static gestor.Visao.TelaAgendaEscolta.jNomeInterno;
 ...
 * @author Ronaldo
 */
public class TelaPesqInternoAgenda extends javax.swing.JInternalFrame {
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTodosInternos("SELECT * FROM PRONTUARIOSCRC "
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC WHERE IdInternoCrc='" + idInt + "'");
                conecta.rs.first();
