...
import static gestor.Visao.TelaRegistroLivroResenhaInterno.jIdRegistro;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRemicao extends javax.swing.JInternalFrame {
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM RESENHA_REMICAO_INTERNO "
                    + "WHERE IdResenha='" + jIdRegistro.getText() + "'");
            conecta.rs.first();
