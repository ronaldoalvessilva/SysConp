...
import static gestor.Visao.TelaVisitasDiversas.caminhoFotoVisitasDiversas;
import static gestor.Visao.TelaVisitasDiversas.FotoVisitaDiversas;
...
public class TelaWebCam extends javax.swing.JDialog {
    ...
    String localFotoVisitasDiversas = "";
     ...
     * @param modal
     */
    public static TelaVisitasDiversas telaVisitasDiversas;

    //TESTADO E FUNCIONANDO NO DIA 02/12/2016 - EM VITÓRIA DA CONQUISTA
    public TelaWebCam(TelaVisitasDiversas parent, boolean modal) {
        this.telaVisitasDiversas = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaVisitasDiversas);
        initComponents();
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        localFotoVD();
        if (localFotoVisitasDiversas == null || localFotoVisitasDiversas == "") {
            ...
            javax.swing.JFileChooser seletor = new javax.swing.JFileChooser(localFotoVisitasDiversas);
            FileNameExtensionFilter tipoExtensao = new FileNameExtensionFilter("Imagem de Foto", "jpg", "bmp", "gif", "png");
            seletor.setAcceptAllFileFilterUsed(false);
            seletor.setMultiSelectionEnabled(false);
            seletor.setFileFilter(tipoExtensao);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaWebCam dialog = new TelaWebCam(telaVisitasDiversas, true);
    ...
    public void localFotoVD() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM PARAMETROSCRC");
            conecta.rs.first();
            localFotoVisitasDiversas = conecta.rs.getString("LocalFotoVisitasDiversas");
        } catch (Exception e) {
        }
        conecta.desconecta();
    }
