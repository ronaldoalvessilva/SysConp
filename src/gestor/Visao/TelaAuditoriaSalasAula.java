...
import static gestor.Visao.TelaSalaAula.jIdSala;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaSalasAula extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Salas de Aula :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM SALAS WHERE IdSala='" + jIdSala.getText() + "'");
            conecta.rs.first();
