 ...
 */
public class TelaAuditoriaAcessoriosEPIs extends javax.swing.JDialog {
     ...
     */
    public static TelaAcessoriosArmasEPIs pTELA_ACESSORIOS_epis;

    public TelaAuditoriaAcessoriosEPIs(TelaAcessoriosArmasEPIs parent, boolean modal) {
        this.pTELA_ACESSORIOS_epis = parent;
        this.setModal(modal);
        setLocationRelativeTo(pTELA_ACESSORIOS_epis);
        initComponents();
        auditoria();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAuditoriaAcessoriosEPIs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAuditoriaAcessoriosEPIs dialog = new TelaAuditoriaAcessoriosEPIs(pTELA_ACESSORIOS_epis, true);
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ACESSORIOS_ARMA_EPIs WHERE IdArmaACE='" + jCodigoGrupo.getText() + "'");
            conecta.rs.first();
