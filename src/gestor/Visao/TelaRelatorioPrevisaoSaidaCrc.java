 ...
 * @author Ronaldo
 */
public class TelaRelatorioPrevisaoSaidaCrc extends javax.swing.JInternalFrame {
     ...
     */
    public TelaRelatorioPrevisaoSaidaCrc() {
        initComponents();
    }
                ...
                if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                    ...
                    try {
                        ...
                        conecta.executaSQL("SELECT * FROM ITENSPREVISAOSAIDA "
                                ...
                                + "WHERE DataPrevSaida BETWEEN'" + dataInicial + "'AND'" + dataFinal + "'ORDER BY DataPrevSaida,NomeInternoCrc");
                        ...
                        jv.setTitle("Relatório de Previsão de Saida de Internos por Período");
