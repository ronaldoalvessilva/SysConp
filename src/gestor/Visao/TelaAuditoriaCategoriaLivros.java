...
import static gestor.Visao.TelaCategoriaLivros.jIdCat;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaCategoriaLivros extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaCategoriaLivros() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Categoria Livros :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM CATEGORIA_LIVROS WHERE IdCat='" +jIdCat.getText() + "'");
            conecta.rs.first();
