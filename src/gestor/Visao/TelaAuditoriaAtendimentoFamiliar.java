 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAtendimentoFamiliar extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAtendimentoFamiliar() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATENDIMENTOFAMILIAR WHERE IdAtendf='" + jIDAtendf.getText() + "'");
            conecta.rs.first();
