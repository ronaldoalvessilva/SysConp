 ...
 * @author ronal
 */
public class TelaRegistroInternosAtendimentoImpresso extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "ENFERMARIA:Registro de Atendimento de Internos:Impressão";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
     ...
     */
    public static TelaAssinaturaoBiometriaColaboradoresPSP assinaLibera;

    public TelaRegistroInternosAtendimentoImpresso() {
        initComponents();
        corCampos();
        formatarCampos();
        pesquisarModulo();
    ...
    public void mostraLiberador() {
        assinaLibera = new TelaAssinaturaoBiometriaColaboradoresPSP(this, true);
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(jRegimeKitImp, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addComponent(jPavilhaoKitImp, javax.swing.GroupLayout.PREFERRED_SIZE, 420, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(jNomeDepartamento, javax.swing.GroupLayout.Alignment.LEADING)
        ...
        setBounds(300, 30, 701, 495);
    }// </editor-fold>//GEN-END:initComponents

    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:           
        buscarAcessoUsuario(telaRegistroAtenImpENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoENF.equals("ADMINISTRADORES") || codigoUserENF == codUserAcessoENF && nomeTelaENF.equals(telaRegistroAtenImpENF) && codGravarENF == 1) {
            verificarInternos();
            ...
            if (jIdInternoKitImp.getText().equals("") || jNomeInternoKitImp.getText().equals("")) {
                ...
                if (jIdInternoKitImp.getText().equals(codigoInterno) && atendido.equals("Não")) {
                    ...
                    if (pLiberacaoImpressa.equals("Sim")) {
                        ...
                        objRegAtend.setQtdAtend(qtdAtendimento);
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaRegistroAtenImpENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoENF.equals("ADMINISTRADORES") || codigoUserENF == codUserAcessoENF && nomeTelaENF.equals(telaRegistroAtenImpENF) && codIncluirENF == 1) {
    ...
    private void jBtLiberarAutorizacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtLiberarAutorizacaoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaRegistroLibAtenImpENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoENF.equals("ADMINISTRADORES") || codigoUserENF == codUserAcessoENF && nomeTelaENF.equals(telaRegistroLibAtenImpENF) && codAbrirENF == 1) {
            if (jIdInternoKitImp.getText().equals("") || jNomeInternoKitImp.getText().equals("")) {
    ...
    public void Novo() {
        ...
        jMotivo.setText("INTERNO NÃO CONSEGUIU ASSINAR ATRAVÉS DA SUA BIOMETRIA DEVIDO A DIGITAL GASTA.");
        //
        jMotivo.setEnabled(true);
        jComboBoxTipoMovimentacao.setEnabled(true);
