...
import gestor.Controle.ControleItensInventarioEstoqueNUTRI;
 ...
 * @author user
 */
public class TelaInventarioProdutosNUTRI extends javax.swing.JInternalFrame {
    ...
    ControleInventarioEstoqueNUTRI control = new ControleInventarioEstoqueNUTRI();
    ControleItensInventarioEstoqueNUTRI controle = new ControleItensInventarioEstoqueNUTRI();
    //
    ...
    String nomeModuloTela = "Nutrição:Inventário de Produtos:Manutenção";
    String nomeModuloTela2 = "Nutrição:Inventário de Produtos:Contagem Itens";
    String statusMov;
    String horaMov;
    String dataModFinal;
     ...
     */
    public TelaInventarioProdutosNUTRI() {
        initComponents();
        formatarCampos();
        corCampos();
        corCamposItens();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Inventário de Estoque {NUTRI} :::...");
                                ...
                                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel10Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(jValorCusto, javax.swing.GroupLayout.DEFAULT_SIZE, 79, Short.MAX_VALUE)
    ...
    private void jBtIDPesqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtIDPesqActionPerformed
        ...
        if (jIDPesq.getText().equals("")) {
            ...
            preencherTabelaInventario("SELECT * FROM INVENTARIO_NUTRI WHERE IdLanc='" + jIDPesq.getText() + "'");
        }
        ...
        if (jDataInicial.getDate() == null) {
            ...
            if (jDataFinal.getDate() == null) {
                ...
                if (jDataInicial.getDate().after(jDataFinal.getDate())) {
                    ...
                    preencherTabelaInventario("SELECT * FROM INVENTARIO_NUTRI WHERE DataLanc BETWEEN'" + dataInicial + "'AND '" + dataFinal + "'");
                }
            }
        }
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        ...
        if (jStatusLanc.getText().equals("EFETIVADO")) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM ITENS_INVENTARIO_NUTRI WHERE IdLanc='" + jIdLanc.getText() + "'");
                conecta.rs.first();
    ...
    private void jBtEfetivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEfetivarActionPerformed
        ...
        if (jStatusLanc.getText().equals("EFETIVADO")) {
            ...
            TelaEfetuarInventariosNUTRI objEfetuarInvNUTRI = new TelaEfetuarInventariosNUTRI();
            TelaModuloNutricao.jPainelNutricao.add(objEfetuarInvNUTRI);
            objEfetuarInvNUTRI.show();
        ...
        if (jStatusLanc.getText().equals("EFETIVADO")) {
            ...
            if (jStatusLanc.getText().equals("EFETUADO")) {
                ...
                if (resposta == JOptionPane.YES_OPTION) {
                    ...
                    controle.excluirItensInventarioNUTRI(objItensInventEstoque);
                    JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                    ExcluirItem();
                    preencherTabelaItensInventario("SELECT * FROM ITENS_INVENTARIO_NUTRI "
                            + "INNER JOIN PRODUTOS_AC "
                            + "ON ITENS_INVENTARIO_NUTRI.IdProd=PRODUTOS_AC.IdProd "
    ...
    private void jBtSalvarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarItemActionPerformed
        ...
        if (jDescricaoProduto.getText().equals("")) {
            ...
            try {
                ...
                Logger.getLogger(TelaInventarioProdutosNUTRI.class.getName()).log(Level.SEVERE, null, ex);
            }
            try {
            ...
            if (acao == 3) {
                ...
                controle.incluirItensInventarioNUTRI(objItensInventEstoque);
                preencherTabelaItensInventario("SELECT * FROM ITENS_INVENTARIO_NUTRI "
                        + "INNER JOIN PRODUTOS_AC "
                        + "ON ITENS_INVENTARIO_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                        + "WHERE IdLanc='" + jIdLanc.getText() + "'ORDER BY DescricaoProd");
            ...
            if (acao == 4) {
                ...
                objItensInventEstoque.setIdLanc(Integer.valueOf(jIdLanc.getText()));
                objItensInventEstoque.setIdItem(Integer.valueOf(idItem));
                controle.alterarItensInventarioNUTRI(objItensInventEstoque);
                preencherTabelaItensInventario("SELECT * FROM ITENS_INVENTARIO_NUTRI "
                        + "INNER JOIN PRODUTOS_AC "
                        + "ON ITENS_INVENTARIO_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                        + "WHERE IdLanc='" + jIdLanc.getText() + "'ORDER BY DescricaoProd");
    ...
    private void jBtPesqProdutoInveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqProdutoInveActionPerformed
        // TODO add your handling code here:
        TelaPesqProdutoInventarioNUTRI objPesqProdNUTRI = new TelaPesqProdutoInventarioNUTRI();
    ...
    private void jTabelaInventarioEstoqueMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaInventarioEstoqueMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM INVENTARIO_NUTRI "
                        + "INNER JOIN LOCAL_ARMAZENAMENTO_AC "
                        + "ON INVENTARIO_NUTRI.IdLocal=LOCAL_ARMAZENAMENTO_AC.IdLocal "
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM ITENS_INVENTARIO_NUTRI "
                        ...
                        + "INNER JOIN LOCAL_ARMAZENAMENTO_AC "
                        + "ON ITENS_INVENTARIO_NUTRI.IdLocal=LOCAL_ARMAZENAMENTO_AC.IdLocal "
                        + "WHERE IdLanc='" + jIdLanc.getText() + "'AND DescricaoProd='" + jDescricaoProduto.getText() + "'AND IdItem='" + idItem + "'");
                conecta.rs.first();
    ...
    private void jBtPesqLocalArmazenamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqLocalArmazenamentoActionPerformed
        // TODO add your handling code here:
        TelaPesqLocalArmazenamentoNUTRI objLocalArmaNUTRI = new TelaPesqLocalArmazenamentoNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objLocalArmaNUTRI);
        objLocalArmaNUTRI.show();;
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            ...
            this.preencherTabelaInventario("SELECT * FROM INVENTARIO_NUTRI "
                    + "INNER JOIN LOCAL_ARMAZENAMENTO_AC "
                    + "ON INVENTARIO_NUTRI.IdLocal=LOCAL_ARMAZENAMENTO_AC.IdLocal");
        } else {
        ...
        if (jIdLanc.getText().equals("")) {
            ...
            try {
                ...
                conecta.executaSQL("SELECT *,"
                        + "INVENTARIO_NUTRI.IdLanc AS INVENTARIO_NUTRI_IdLanc, "
                        + "INVENTARIO_NUTRI.IdLocal AS INVENTARIO_NUTRI_IdLocal, "
                        + "INVENTARIO_NUTRI.Responsavel AS INVENTARIO_NUTRI_Responsavel, "
                        + "INVENTARIO_NUTRI.DataInicio AS INVENTARIO_NUTRI_DataInicio, "
                        + "LOCAL_ARMAZENAMENTO_AC.DescricaoLocal AS "
                        + "LOCAL_ARMAZENAMENTO_AC_DescricaoLocal, "
                        + "ITENS_INVENTARIO_NUTRI.IdProd AS ITENS_INVENTARIO_NUTRI_IdProd, "
                        ...
                        + "ITENS_INVENTARIO_NUTRI.QtdItem AS ITENS_INVENTARIO_NUTRI_QtdItem, "
                        + "ITENS_INVENTARIO_NUTRI.ValorCusto AS ITENS_INVENTARIO_NUTRI_ValorCusto "
                        + "FROM INVENTARIO_NUTRI "
                        + "INNER JOIN LOCAL_ARMAZENAMENTO_AC "
                        + "ON INVENTARIO_NUTRI.IdLocal=LOCAL_ARMAZENAMENTO_AC.IdLocal "
                        + "INNER JOIN ITENS_INVENTARIO_NUTRI ITENS_INVENTARIO_NUTRI "
                        + "ON INVENTARIO_NUTRI.IdLanc=ITENS_INVENTARIO_NUTRI.IdLanc "
                        + "INNER JOIN PRODUTOS_AC "
                        + "ON ITENS_INVENTARIO_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                        + "WHERE ITENS_INVENTARIO_NUTRI.IdLanc='" + jIdLanc.getText() + "'ORDER BY PRODUTOS_AC.DescricaoProd");
    ...
    private void jBtAuditoriaInventarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaInventarioActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaInventarioNUTRI objAudiInvNUTRI = new TelaAuditoriaInventarioNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objAudiInvNUTRI);
        objAudiInvNUTRI.show();
    ...
    private void jBtAuditoriaItensActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaItensActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensInventarioNUTRI objAudiItensInvNUTRI = new TelaAuditoriaItensInventarioNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objAudiItensInvNUTRI);
        objAudiItensInvNUTRI.show();
    ...
    private void jCodigoBarraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCodigoBarraActionPerformed
        ...
        conecta.executaSQL("SELECT * FROM PRODUTOS_AC "
                ...
                + "WHERE PRODUTOS_AC.CodigoBarra LIKE'" + jCodigoBarra.getText() + "'AND PRODUTOS_AC.StatusProd='" + statusProd + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        try {
            if (conecta.rs.first()) {
    ...
    private void jBtBuscarProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtBuscarProdutoActionPerformed
        // TODO add your handling code here:
        TelaBuscarProdutosInventarioNUTRI objBuscarProdInvNUTRI = new TelaBuscarProdutosInventarioNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objBuscarProdInvNUTRI);
        objBuscarProdInvNUTRI.show();
    ...
    public void verificarTipoInventario() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM INVENTARIO_NUTRI WHERE TipoInventario='" + jComboBoxTipoInventario.getSelectedItem() + "'");
            conecta.rs.first();
