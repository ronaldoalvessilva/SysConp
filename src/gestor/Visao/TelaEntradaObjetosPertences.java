...
import gestor.Controle.ControlEntradaObjetos;
import gestor.Controle.ControleItensObjetos;
...
import static gestor.Visao.TelaModuloSeguranca.telaEntradaPertencesManutencao;
 ...
 * @author Ronaldo
 */
public class TelaEntradaObjetosPertences extends javax.swing.JInternalFrame {
    ...
    ControlEntradaObjetos control = new ControlEntradaObjetos();
    ControleItensObjetos controle = new ControleItensObjetos();
    ...
    String nomeModuloTela = "Segurança:Entrada de Objetos Internos:Manutenção";
    String nomeModuloTela2 = "Segurança:Entrada de Objetos Internos:Objetos";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
    ...
    int idItemMov; // Código do item da tabela ITENSOBJETOS
     ...
     */
    public TelaEntradaObjetosPertences() {
        initComponents();
        formatarCampos();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Entrada de Pertences Triagem/Segurança :::...");
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addComponent(jFotoInternosObjetos, javax.swing.GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE)
        );
        jPanel12Layout.setVerticalGroup(
            jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jFotoInternosObjetos, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jNomeInternoCrcObjeto, javax.swing.GroupLayout.PREFERRED_SIZE, 253, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jIdInternoCrcObjeto, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(0, 0, Short.MAX_VALUE))))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jStatusLanc, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jIdPertence, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jBtPesquisarObjetos, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(jLabel15, javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                            .addComponent(jDescricaoLocalPertences, javax.swing.GroupLayout.PREFERRED_SIZE, 318, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            .addComponent(jBtPesquisarLocal, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jLabel9)
                                .addComponent(jQuantidade, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addComponent(jDescricaoPertenceObjeto, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 350, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jPanel6, javax.swing.GroupLayout.PREFERRED_SIZE, 399, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 441, Short.MAX_VALUE)
        );

        setBounds(300, 20, 439, 470);
    ...
    private void jBtIdLancActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtIdLancActionPerformed
        ...
        if (jIDPesqLan.getText().equals("")) {
            ...
            preencherTabelaEntradaObjetos("SELECT * FROM ENTRADAOBJETOSPERTENCES "
                    ...
                    + "ON ENTRADAOBJETOSPERTENCES.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaEntradaObjetos("SELECT * FROM ENTRADAOBJETOSPERTENCES "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ENTRADAOBJETOSPERTENCES.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc ORDER BY NomeInternoCrc");
        } else {
    ...
    private void jBtNomeInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeInternoActionPerformed
        ...
        if (jPesqNomeInterno.getText().equals("")) {
            ...
            jTabelaEntradaObjetos.setVisible(true);
            preencherTabelaObjetoInterno("SELECT * FROM ENTRADAOBJETOSPERTENCES "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ENTRADAOBJETOSPERTENCES.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        buscarAcessoUsuarioTRI(telaEntradaPertencesManutencaoTRI);
        if (codigoUser == codUserAcesso && nomeTela.equals(telaEntradaPertencesManutencao) && codIncluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        ...
        buscarAcessoUsuario(telaEntradaPertencesManutencao);
        buscarAcessoUsuarioTRI(telaEntradaPertencesManutencaoTRI);
        if (codigoUser == codUserAcesso && nomeTela.equals(telaEntradaPertencesManutencao) && codExcluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            objEntraObj.setStatusLanc(jStatusLanc.getText());
            if (jStatusLanc.getText().equals("FINALIZADO")) {
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        try {
            conecta.executaSQL("SELECT * FROM ENTRADAOBJETOSPERTENCES "
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaEntradasPertencesSeguranca objAudEntPertSeg = new TelaAuditoriaEntradasPertencesSeguranca();
        if (TelaModuloSeguranca.jPainelSeguranca != null) {
            TelaModuloSeguranca.jPainelSeguranca.add(objAudEntPertSeg);
            objAudEntPertSeg.show();
        } else {
            TelaModuloTriagem.jPainelTriagem.add(objAudEntPertSeg);
            objAudEntPertSeg.show();
        }
    ...
    private void jBtPesquisarObjetosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarObjetosActionPerformed
        // TODO add your handling code here:
        TelaPesqItenPertence objPesqPertence = new TelaPesqItenPertence();
        if (TelaModuloSeguranca.jPainelSeguranca != null) {
            TelaModuloSeguranca.jPainelSeguranca.add(objPesqPertence);
            objPesqPertence.show();
        } else {
            TelaModuloTriagem.jPainelTriagem.add(objPesqPertence);
            objPesqPertence.show();
        }
    ...
    private void jBtNovoObjetoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoObjetoActionPerformed
        ...
        buscarAcessoUsuarioTRI(telaEntradaPertencesPertencesTRI);
    ...
    private void jTabelaObjetosInternosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaObjetosInternosMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM ITENSOBJETOS "
                        + "INNER JOIN PERTENCES "
                        + "ON ITENSOBJETOS.IdPertence=PERTENCES.IdPertence "
                        + "INNER JOIN LOCALPERTENCES "
                        + "ON ITENSOBJETOS.IdLocal=LOCALPERTENCES.IdLocal "
    ...
    private void jBtAuditoriaObjetoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaObjetoActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensPertencesSeg objAudItensPertSeg = new TelaAuditoriaItensPertencesSeg();
        if (TelaModuloSeguranca.jPainelSeguranca != null) {
            TelaModuloSeguranca.jPainelSeguranca.add(objAudItensPertSeg);
            objAudItensPertSeg.show();
        } else {
            TelaModuloTriagem.jPainelTriagem.add(objAudItensPertSeg);
            objAudItensPertSeg.show();
        }
    ...
    private void jTabelaEntradaObjetosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaEntradaObjetosMouseClicked
        ...
        if (flag == 1) {
            ...
            preencherTabelaItens("SELECT * FROM ITENSOBJETOS "
                    ...
                    + "INNER JOIN ENTRADAOBJETOSPERTENCES "
                    + "ON ITENSOBJETOS.IdEntrada=ENTRADAOBJETOSPERTENCES.IdEntrada "
                    + "WHERE ITENSOBJETOS.IdEntrada='" + IdLanc + "'");
            conecta.desconecta();
        }
    ...
    private void jBtPesquisarInternoCrcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarInternoCrcActionPerformed
        // TODO add your handling code here:
        TelaPesqInternosObjetosPertences objPesqInernos = new TelaPesqInternosObjetosPertences();
        if (TelaModuloSeguranca.jPainelSeguranca != null) {
            TelaModuloSeguranca.jPainelSeguranca.add(objPesqInernos);
            objPesqInernos.show();
        } else {
            TelaModuloTriagem.jPainelTriagem.add(objPesqInernos);
            objPesqInernos.show();
        }
    ...
    private void jBtPesquisarLocalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarLocalActionPerformed
        // TODO add your handling code here:
        TelaPesquisarLocalPertence objLocalPert = new TelaPesquisarLocalPertence();
        if (TelaModuloSeguranca.jPainelSeguranca != null) {
            TelaModuloSeguranca.jPainelSeguranca.add(objLocalPert);
            objLocalPert.show();
        } else {
            TelaModuloTriagem.jPainelTriagem.add(objLocalPert);
            objLocalPert.show();
        }
    ...
    public void Alterar() {
        jDataLanc.setEnabled(true);
        if (jIdLanc.getText().equals(idEntrada)) {
            jBtPesquisarInternoCrc.setEnabled(!true);
        } else {
            jBtPesquisarInternoCrc.setEnabled(true);
        }
    ...
    public void Finalizar() {
        ...
        int resposta = JOptionPane.showConfirmDialog(this, "Deseja realmente FINALIZAR o lançamento selecionado?", "Confirmação",
                JOptionPane.YES_NO_OPTION);
        if (resposta == JOptionPane.YES_OPTION) {
            objEntraObj.setStatusLanc(statusEntrada);
            objEntraObj.setIdLanc(Integer.parseInt(jIdLanc.getText()));
            control.finalizarEntradaObjetos(objEntraObj);
    ...
    public void verificarPertences() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENSOBJETOS WHERE IdEntrada='" + jIdLanc.getText() + "'");
            conecta.rs.first();
            idEntrada = conecta.rs.getString("IdEntrada");
        } catch (Exception e) {
        }
        conecta.desconecta();
    }
    ...
    public void verificarSaldoPertences() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ESTOQUEPERTENCES WHERE IdInternoCrc='" + jIdInternoCrcObjeto.getText() + "'AND IdPertence='" + jIdPertence.getText() + "'AND StatusMov='" + tipoMovimento + "'");
            conecta.rs.first();
    ...
    public void verificarItens() {
        ...
        try {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                objEntraObj.setIdLanc(Integer.parseInt(jIdLanc.getText()));
                control.excluirEntradaObjetos(objEntraObj);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                Excluir();
    ...
    public void preencherTabelaEntradaObjetos(String sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdEntrada"), dataBrasil, conecta.rs.getString("StatusLanc"), conecta.rs.getString("NomeInternoCrc")});
    ...
    public void alinharCamposTabelaEntradaObj() {
    ...
    public void preencherTabelaItens(String sql) {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Seq.", "Código", "Nome do Objeto", "Qtde.", "Data Entrada"};
        conecta.abrirConexao();
        try {
            conecta.executaSQL(sql);
            conecta.rs.first();
    ...
    public void limparTabelaObjetos() {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Seq.", "Código", "Nome do Objeto", "Qtde.", "Data Entrada"};
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaObjetosInternos.setModel(modelo);
