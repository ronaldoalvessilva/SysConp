...
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jCodigoTema;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_PLAN_EF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_PLAN_EF() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PLANEJAMENTO_ATENDIMENTO_GRUPO_EF "
                    + "WHERE IdItemPlanEF='" + jCodigoTema.getText() + "' "
