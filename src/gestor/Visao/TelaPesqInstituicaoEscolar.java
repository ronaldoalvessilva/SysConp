...
import static gestor.Visao.TelaProfessores.jNomeInstituicao;
 ...
 * @author Ronaldo
 */
public class TelaPesqInstituicaoEscolar extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInstituicaoEscolar() {
        initComponents();
    }
    ...
    private void jBtPesqDescricaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoActionPerformed
        ...
        if (jPesqDescricao.getText().equals("")) {
            ...
            jTabelaInstituicaoEscolar.setVisible(true);
