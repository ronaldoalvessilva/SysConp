 ...
 * @author ronal
 */
public class TelaRegistroInternosAtendimentoImpressoJURI extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "JURIDICO:Registro de Atendimento de Internos:Impressão";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
     ...
     */
    public static TelaAssinaturaoBiometriaColaboradoresPSP_JURI assinaLibera;
    ...
    public void mostraLiberador() {
        assinaLibera = new TelaAssinaturaoBiometriaColaboradoresPSP_JURI(this, true);
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaRegistroAtenImpJURI);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoJURI.equals("ADMINISTRADORES") || codigoUserJURI == codUserAcessoJURI && nomeTelaJURI.equals(telaRegistroAtenImpJURI) && codIncluirJURI == 1) {
    ...
    private void jBtLiberarAutorizacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtLiberarAutorizacaoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaRegistroLibAtenImpJURI);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoJURI.equals("ADMINISTRADORES") || codigoUserJURI == codUserAcessoJURI && nomeTelaJURI.equals(telaRegistroLibAtenImpJURI) && codAbrirJURI == 1) {
            if (jIdInternoKitImp.getText().equals("") || jNomeInternoKitImp.getText().equals("")) {
