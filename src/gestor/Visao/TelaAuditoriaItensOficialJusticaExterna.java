 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensOficialJusticaExterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensOficialJusticaExterna() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Oficial de Justiça :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_ENTRADAS_OFICIAL_JUSTICA WHERE Idlanc='" + jIDlanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
