...
import static gestor.Visao.TelaSolicitantesCompras.jCodigo;
import static gestor.Visao.TelaSolicitantesCompras.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensSolicitantesCompras extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensSolicitantesCompras() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_SOLICITANTES_COMPRAS WHERE IdSoli='" + jCodigo.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
