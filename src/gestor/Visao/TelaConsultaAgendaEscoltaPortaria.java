 ...
 * @author Ronaldo
 */
public class TelaConsultaAgendaEscoltaPortaria extends javax.swing.JInternalFrame {
     ...
     */
    public TelaConsultaAgendaEscoltaPortaria() {
        initComponents();
        corCampo();
        formatarCampos();
    }
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                            ...
                            .addComponent(jDataAgendamento, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel7)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        if (jTabelaAgendamento.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaAgendamento.getColumnModel().getColumn(1).setMinWidth(280);
            jTabelaAgendamento.getColumnModel().getColumn(1).setMaxWidth(280);
            jTabelaAgendamento.getColumnModel().getColumn(2).setMinWidth(70);
            jTabelaAgendamento.getColumnModel().getColumn(2).setMaxWidth(70);
            jTabelaAgendamento.getColumnModel().getColumn(3).setMinWidth(70);
            jTabelaAgendamento.getColumnModel().getColumn(3).setMaxWidth(70);
            jTabelaAgendamento.getColumnModel().getColumn(4).setMinWidth(250);
            jTabelaAgendamento.getColumnModel().getColumn(4).setMaxWidth(250);
        }
        ...
        jPanel9Layout.setVerticalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(jDataAgenda, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//            jBtCancelarAg.setEnabled(true);
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaTodos("SELECT * FROM AGENDAESCOLTA ");
        } else {
    ...
    public void preencherTabelaItens(String sql) {
        ...
        jTabelaAgendamento.getColumnModel().getColumn(1).setPreferredWidth(280);
    ...
    public void alinhaCamposTabelaItens() {
        ...
        jTabelaAgendamento.getColumnModel().getColumn(3).setCellRenderer(centralizado);
    }
