...
import static gestor.Visao.TelaRegistroObjetosProcedimentos.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaProcedimentoCelas extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaProcedimentoCelas() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Celas/Pavilhão/Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSPCIP WHERE IdProc='" + jIdLanc.getText() + "'AND IdItensPcip='" + idItem + "'");
            conecta.rs.first();
