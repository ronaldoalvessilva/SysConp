...
import static gestor.Visao.TelaCancelamentoVisitasInterno.jFotoVisita;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jDataCadaVisita;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jDataInicio;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jDataValiAntecedente;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jIDVisita;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jDataNascVisita;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jIDInterno;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jNomeVisita;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jParentescoVisita;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaVisitasRoCancel extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaVisitasRoCancel() {
        initComponents();
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTabelaVisitas("SELECT * FROM VISITASINTERNO "
                    ...
                    + "AND ITENSROL.IdInternoCrc='" + jIDInterno.getText()  + "'");
        }
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM VISITASINTERNO "
                        ...
                        + "AND VISITASINTERNO.IdVisita='" + idVistaInt + "'");
                conecta.rs.first();
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaVisitas("SELECT * FROM VISITASINTERNO "
                    + "INNER JOIN ITENSROL "
                    + "ON VISITASINTERNO.IdVisita=ITENSROL.IdVisita "
