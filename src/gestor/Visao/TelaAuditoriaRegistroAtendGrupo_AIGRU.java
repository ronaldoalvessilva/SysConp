...
import static gestor.Visao.TelaAtendimentoGrupoPSI.pCODIGO_AVALIACAO_GRUPO_AVGI;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_AIGRU extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_AIGRU() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_PSICOLOGIA "
                    + "WHERE IdItemAvai='" + pCODIGO_AVALIACAO_GRUPO_AVGI + "' "
                    + "AND IdAtGrupoPsi='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
