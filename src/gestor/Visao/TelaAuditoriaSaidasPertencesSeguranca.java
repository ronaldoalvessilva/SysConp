 ...
 * @author Ronaldo
 */
public class TelaAuditoriaSaidasPertencesSeguranca extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaSaidasPertencesSeguranca() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Saida de Pertences :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM SAIDAOBJETOSPERTENCES WHERE IdESaida='" + jIdLanc.getText() + "'");
            conecta.rs.first();
