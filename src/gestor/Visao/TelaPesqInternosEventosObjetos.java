...
import gestor.Dao.*;
import static gestor.Visao.TelaEventoDisciplinar.jIdInternoPertence;
import static gestor.Visao.TelaEventoDisciplinar.jIdLanc;
import static gestor.Visao.TelaEventoDisciplinar.jNomeInternoPertenceObjeto;
 ...
 * @author user
 */
public class TelaPesqInternosEventosObjetos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternosEventosObjetos() {
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            jIdInternoPertence.setText(idFunc);//           
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                        + "INNER JOIN AUTOREVENTOS "
                        + "ON PRONTUARIOSCRC.IdInternoCrc=AUTOREVENTOS.IdInternoCrc "
                        + "INNER JOIN CELAS "
                        + "ON AUTOREVENTOS.IdCela=CELAS.IdCela "
                        + "WHERE NomeInternoCrc='" + jPesqNomeInterno.getText() + "'");
                conecta.rs.first();
                jIdInternoPertence.setText(String.valueOf(conecta.rs.getInt("IdInternoCrc")));
                jNomeInternoPertenceObjeto.setText(conecta.rs.getString("NomeInternoCrc"));
                conecta.desconecta();
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jPesqNomeInterno.getText().equals("")) {
            ...
            buscarInternoVisitas("SELECT * FROM AUTOREVENTOS "
                    ...
                    + "WHERE NomeInternoCrc LIKE'%" + jPesqNomeInterno.getText() + "%'AND AUTOREVENTOS.IdLanc='" + jIdLanc.getText() + "'");
        }
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.buscarInternoVisitas("SELECT * FROM AUTOREVENTOS "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON AUTOREVENTOS.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN REGISTROEVENTOS "
                    + "ON AUTOREVENTOS.IdLanc=REGISTROEVENTOS.IdLanc "
