...
import static gestor.Visao.TelaAdvogadosExterna.jIDAd;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAdvogadosExterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAdvogadosExterna() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ADVOGADOS WHERE IdAdvogado='" + jIDAd.getText() + "'");
            conecta.rs.first();
