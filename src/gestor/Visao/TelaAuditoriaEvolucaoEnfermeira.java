 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEvolucaoEnfermeira extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEvolucaoEnfermeira() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Evolução Enfermeiros (as) :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM EVOLUCAOENFERMAGEM WHERE IdLanc='" + jIdLanc.getText() + "'AND IdItem='" + jIdEvolucao.getText() + "'");
            conecta.rs.first();
