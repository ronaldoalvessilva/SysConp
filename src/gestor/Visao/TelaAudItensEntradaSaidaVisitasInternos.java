 ...
 * @author Ronaldo
 */
public class TelaAudItensEntradaSaidaVisitasInternos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAudItensEntradaSaidaVisitasInternos() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSFAMILIAR WHERE IdLanc='" + jIDlanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
