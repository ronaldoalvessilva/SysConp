 ...
 * @author ronal
 */
public class TelaValidadorRevAtestadoReclusao extends javax.swing.JInternalFrame {
     ...
     */
    public TelaValidadorRevAtestadoReclusao() {
        initComponents();
    }
    ...
    public void pesquisarAtestado() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM REVALIDAR_ATESTADO_RECLUSAO "
                    ...
                    + "WHERE IdRevAtestado='" + jIdRegistro.getText() + "'");
            conecta.rs.first();
            jIdRegistro.setText(conecta.rs.getString("IdRevAtestado"));
            jDataRegistro.setDate(conecta.rs.getDate("DataRevAtestado"));
    ...
    public void criptografiaMD5(String idRegistro, String dataRegistro, String idVisita, String idInterno, String nomeInterno) {
        ...
        try {
            ...
            Logger.getLogger(TelaValidadorRevAtestadoReclusao.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void pesquisarDadosCriptografia() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM REVALIDAR_ATESTADO_RECLUSAO "
                    ...
                    + "WHERE IdRevAtestado='" + jIdRegistro.getText() + "'");
            conecta.rs.first();
            codigoRegistro = conecta.rs.getString("IdRevAtestado");
            dataRegistro = conecta.rs.getDate("DataRevAtestado");
