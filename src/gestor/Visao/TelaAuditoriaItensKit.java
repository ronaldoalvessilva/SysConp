...
import static gestor.Visao.TelaTiposKitsHigieneInternos.idItem;
import static gestor.Visao.TelaTiposKitsHigieneInternos.jIdKit;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensKit extends javax.swing.JInternalFrame {
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PRODUTOS_KITS_HIGIENE_INTERNO WHERE IdKit='" + jIdKit.getText() + "' "
                    + "AND IdItem='" + idItem + "'");
            conecta.rs.first();
