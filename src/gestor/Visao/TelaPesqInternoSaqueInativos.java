...
import static gestor.Visao.TelaSaqueBancarioInativos.jDataEntrada;
import static gestor.Visao.TelaSaqueBancarioInativos.jFotoInternoSaque;
import static gestor.Visao.TelaSaqueBancarioInativos.jIdInternoSaque;
import static gestor.Visao.TelaSaqueBancarioInativos.jNomeInternoSaque;
import static gestor.Visao.TelaSaqueBancarioInativos.jSituacao;
 ...
 * @author Ronaldo
 */
public class TelaPesqInternoSaqueInativos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoSaqueInativos() {
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                ...
                conecta.rs.first();
                jIdInternoSaque.setText(String.valueOf(conecta.rs.getInt("IdInternoCrc")));
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTodosInternos("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "INNER JOIN UNIDADE "
                    + "ON DADOSPENAISINTERNOS.IdUnid=UNIDADE.IdUnid "
                    + "WHERE PRONTUARIOSCRC.SituacaoCrc!='" + situacaoEntrada + "' "
                    + "AND PRONTUARIOSCRC.SituacaoCrc!='" + situacaoRetorno + "' ");
        } else {
            limparTabela();
        }
  ...
  // Método de pesquisa pela Descrição
    ...
    public void alinharCamposTabela() {
        ...
        jTabelaInterno.getColumnModel().getColumn(4).setCellRenderer(esquerda);
    }
}
