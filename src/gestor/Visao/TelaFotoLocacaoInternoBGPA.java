 ...
 * @author ronaldo
 */
public class TelaFotoLocacaoInternoBGPA extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaLocacaoInternoBGPA telaLocacaoInternoBGPA;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoLocacaoInternoBGPA(TelaLocacaoInternoBGPA parent, boolean modal) {
        this.telaLocacaoInternoBGPA = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaLocacaoInternoBGPA);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoLocacaoInternoBGPA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoLocacaoInternoBGPA dialog = new TelaFotoLocacaoInternoBGPA(telaLocacaoInternoBGPA, true);
