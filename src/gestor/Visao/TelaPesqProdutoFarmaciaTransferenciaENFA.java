...
import static gestor.Visao.TelaTransferenciaEstoqueFarmacia.jQtdItem;
import static gestor.Visao.TelaTransferenciaEstoqueFarmacia.jComboBoxUnidade;
import static gestor.Visao.TelaTransferenciaEstoqueFarmacia.jDescricaoProduto;
import static gestor.Visao.TelaTransferenciaEstoqueFarmacia.jIdProd;
import static gestor.Visao.TelaTransferenciaEstoqueFarmacia.jCodigoBarras;
import static gestor.Visao.TelaTransferenciaEstoqueFarmacia.jDataVencimento;
import static gestor.Visao.TelaTransferenciaEstoqueFarmacia.jLote;
import static gestor.Visao.TelaTransferenciaEstoqueFarmacia.jValorUN;
 ...
 * @author user
 */
public class TelaPesqProdutoFarmaciaTransferenciaENFA extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoFarmaciaTransferenciaENFA() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabelaProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Descrição Produto", "Dt. Vcto.", "Quant.", "Lote"
            }
        ));
        ...
        if (jTabelaProdutos.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaProdutos.getColumnModel().getColumn(2).setMinWidth(70);
            jTabelaProdutos.getColumnModel().getColumn(2).setMaxWidth(70);
            jTabelaProdutos.getColumnModel().getColumn(3).setMinWidth(80);
            jTabelaProdutos.getColumnModel().getColumn(3).setMaxWidth(80);
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM ITENS_SOLICITACAO_PRODUTOS_ENFERMARIA_ENFAR "
                    + "INNER JOIN PRODUTOS_AC "
                    + "ON ITENS_SOLICITACAO_PRODUTOS_ENFERMARIA_ENFAR.IdProd=PRODUTOS.IdProd "
                    + "INNER JOIN LOCAL_ARMAZENAMENTO_AC "
                    + "ON PRODUTOS_AC.IdLocal=LOCAL_ARMAZENAMENTO_AC.IdLocal "
                    + "INNER JOIN LOTE_PRODUTOS_AC "
                    + "ON ITENS_SOLICITACAO_PRODUTOS_ENFERMARIA_ENFAR.IdProd=LOTE_PRODUTOS_AC.IdProd "
                    + "WHERE PRODUTOS_AC.DescricaoProd LIKE'%" + jPesqDescricaoProdutos.getText() + "%'AND PRODUTOS_AC.StatusProd='" + statusProd + "'AND Qtd !='" + 0 + "'AND ReqAtend='" + atendido + "'AND PRODUTOS_AC.Modulo='" + modulo + "'AND Lote='" + idLote + "'");
        }
        ...
        if (jPesqDescricaoProdutos.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_PRODUTOS_ENFERMARIA_ENFAR "
                        ...
                        + "ON PRODUTOS_AC.IdLocal=LOCAL_ARMAZENAMENTO_AC.IdLocal "
                        + "INNER JOIN LOTE_PRODUTOS_AC "
                        + "ON ITENS_REQUISICAO_PRODUTOS_ENFERMARIA_ENFAR.IdProd=LOTE_PRODUTOS_AC.IdProd "
                        + "WHERE PRODUTOS_AC.DescricaoProd='" + jPesqDescricaoProdutos.getText() + "'AND PRODUTOS_AC.StatusProd='" + statusProd + "'AND PRODUTOS_AC.Modulo='" + modulo + "'AND Lote='" + idLote + "'");
                conecta.rs.first();
    ...
    private void jTabelaProdutosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaProdutosMouseClicked
        ...
        if (flag == 1) {
            ...
            idLote = "" + jTabelaProdutos.getValueAt(jTabelaProdutos.getSelectedRow(), 4);
        }
    ...
    private void jCheckBoxPesqTodosProdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosProdItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {            
            this.preencherTabelaProdutos("SELECT * FROM ITENS_REQUISICAO_PRODUTOS_ENFERMARIA_ENFAR "
                    + "INNER JOIN PRODUTOS_AC "
                    + "ON ITENS_REQUISICAO_PRODUTOS_ENFERMARIA_ENFAR.IdProd=PRODUTOS_AC.IdProd "
                    + "INNER JOIN LOCAL_ARMAZENAMENTO_AC "
                    + "ON PRODUTOS_AC.IdLocal=LOCAL_ARMAZENAMENTO_AC.IdLocal "
                    + "INNER JOIN LOTE_PRODUTOS_AC "
                    + "ON ITENS_REQUISICAO_PRODUTOS_ENFERMARIA_ENFAR.IdProd=LOTE_PRODUTOS_AC.IdProd "
                    + "WHERE PRODUTOS_AC.StatusProd='" + statusProd + "'AND LOTE_PRODUTOS_AC.Qtd !='" + 0 + "'AND ReqAtend='" + atendido + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        } else {
    ...
    public void preencherTabelaProdutos(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Descrição Produto", "Dt. Vcto", "Quant.", "Lote"};
        conecta.abrirConexao();
        ...
        try {
            ...
            do {
                ...
                if (dataVcto != null) {
                    String diav = dataVcto.substring(8, 10);
                    String mesv = dataVcto.substring(5, 7);
                    String anov = dataVcto.substring(0, 4);
                    dataVcto = diav + "/" + mesv + "/" + anov;
                }
                //
                ...
                qtdItemTab = vqtdItem;
                //
                dados.add(new Object[]{conecta.rs.getInt("IdProd"), conecta.rs.getString("DescricaoProd"), dataVcto, qtdItemTab, conecta.rs.getString("Lote")});
        ...
        jTabelaProdutos.getColumnModel().getColumn(2).setPreferredWidth(70);
        jTabelaProdutos.getColumnModel().getColumn(2).setResizable(false);
        jTabelaProdutos.getColumnModel().getColumn(3).setPreferredWidth(80);
