...
import static gestor.Visao.TelaEntradaSaidaOficialJusticaInternos.jBtBuscarInterno;
import static gestor.Visao.TelaEntradaSaidaOficialJusticaInternos.jBtCancelarInterno;
import static gestor.Visao.TelaEntradaSaidaOficialJusticaInternos.jBtExcluirInterno;
import static gestor.Visao.TelaEntradaSaidaOficialJusticaInternos.jBtNovoInterno;
import static gestor.Visao.TelaEntradaSaidaOficialJusticaInternos.jBtSalvarInterno;
import static gestor.Visao.TelaEntradaSaidaOficialJusticaInternos.jDataEntradaInterno;
import static gestor.Visao.TelaEntradaSaidaOficialJusticaInternos.jIDlanc;
 ...
 * @author user
 */
public class TelaBuscarInternosOficialJustica extends javax.swing.JInternalFrame {
     ...
     */
    public TelaBuscarInternosOficialJustica() {
        initComponents();
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jPesqNomeInterno.getText().equals("")) {
            ...
            buscarInternos("SELECT * FROM ITENS_ENTRADAS_OFICIAL_JUSTICA_INTERNOS "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ITENS_ENTRADAS_OFICIAL_JUSTICA_INTERNOS.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
...
//Preencher tabela com todos os VISITANTES
    ...
    public void limparTabela() {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Código", "Nome Interno", "Situação", "Data Entrada"};
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaPesqInternos.setModel(modelo);
