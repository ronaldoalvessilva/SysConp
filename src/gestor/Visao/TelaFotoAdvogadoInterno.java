 ...
 * @author ronaldo
 */
public class TelaFotoAdvogadoInterno extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaEntradaSaidaAdvogadosInternos telainternoadvogado;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoAdvogadoInterno(TelaEntradaSaidaAdvogadosInternos parent, boolean modal) {
        this.telainternoadvogado = parent;
        this.setModal(modal);
        setLocationRelativeTo(telainternoadvogado);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoAdvogadoInterno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoAdvogadoInterno dialog = new TelaFotoAdvogadoInterno(telainternoadvogado, true);
