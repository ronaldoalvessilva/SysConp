...
import static gestor.Visao.TelaEstornoRequisicaoMateriaisFAR.jDescricaoProduto;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisFAR.jCodProduto;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisFAR.jCodigoBarras;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisFAR.jLote;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisFAR.jDataVctoLote;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisFAR.jComboBoxUnidade;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisFAR.jIdDoc;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisFAR.jQtdItem;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisFAR.jValorUnitarioItem;
 ...
 * @author user
 */
public class TelaPesqProdutoEstornoTransferencias extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoEstornoTransferencias() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Produtos da Transferência {FAR} :::...");
        ...
        jTabelaProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item", "Código", "Descrição do Produto", "Data Validade", "Lote"
            }
        ));
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "ON PRODUTOS_AC.IdProd=ITENS_TRANSFERENCIA_PRODUTO_FAR.IdProd "
                    + "WHERE PRODUTOS_AC.DescricaoProd LIKE'%" + jPesqDescricaoProdutos.getText() + "%' "
                    + "AND PRODUTOS_AC.StatusProd='" + statusProd + "' "
                    + "AND LOTE_PRODUTOS_ENF.Qtd!='" + 0 + "' "
                    + "AND ITENS_TRANSFERENCIA_PRODUTO_FAR.EstornoProduto='" + estornoProduto + "' "
                    + "AND LOTE_PRODUTOS_ENF.IdLanc='" + jIdDoc.getText() + "' "
        ...
        if (jPesqDescricaoProdutos.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRODUTOS_AC "
                        ...
                        + "AND LOTE_PRODUTOS_ENF.Qtd!='" + 0 + "' "
                        + "AND LOTE_PRODUTOS_ENF.IdItem='" + idItemProd + "'");
                conecta.rs.first();
                idItemProd = conecta.rs.getString("IdItem");
...
//            idInt = "" + jTabelaProdutos.getValueAt(jTabelaProdutos.getSelectedRow(), 1);
            idItemProd = "" + jTabelaProdutos.getValueAt(jTabelaProdutos.getSelectedRow(), 0);
        }
    ...
    private void jCheckBoxPesqTodosProdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosProdItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "WHERE PRODUTOS_AC.StatusProd='" + statusProd + "' "
                    + "AND Qtd!='" + 0 + "' "
                    + "AND EstornoProduto='" + estornoProduto + "' "
                    + "AND ITENS_TRANSFERENCIA_PRODUTO_FAR.IdLanc='" + jIdDoc.getText() + "' "
                    + "AND PRODUTOS_AC.Modulo='" + modulo + "'");
        } else {
    ...
    public void preencherTabelaProdutos(String sql) {
        ...
        String[] Colunas = new String[]{"Item", "Código", "Descrição do Produto", "Data Validade", "Qtd.", "Lote"};
        conecta.abrirConexao();
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdItem"), conecta.rs.getInt("IdProd"), conecta.rs.getString("DescricaoProd"), dataValidade, qtdItemTab, conecta.rs.getString("Lote")});
        ...
        jTabelaProdutos.getColumnModel().getColumn(5).setPreferredWidth(80);
    ...
    public void limparTabelaProdutos() {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Item", "Código", "Descrição Produto", "Data Validade", "Qtd.", "Lote"};
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaProdutos.setModel(modelo);
        jTabelaProdutos.getColumnModel().getColumn(0).setPreferredWidth(50);
        jTabelaProdutos.getColumnModel().getColumn(0).setResizable(false);
    ...
    public void alinharCamposTelaProdutos() {
        ...
        jTabelaProdutos.getColumnModel().getColumn(5).setCellRenderer(direita);
    }
}
