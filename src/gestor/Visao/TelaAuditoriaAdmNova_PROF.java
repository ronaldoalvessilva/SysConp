...
import static gestor.Visao.TelaPortaEntradaTO.codigoHistoricoProf;
import java.sql.SQLException;
import static gestor.Visao.TelaPortaEntradaTO.jIdAtendNovo;

/**
 *
 * @author Socializa TI 02
 */
public class TelaAuditoriaAdmNova_PROF extends javax.swing.JDialog {
     ...
     */
    public static TelaPortaEntradaTO pPORTA_ENTRADA_TO_PROF;

    public TelaAuditoriaAdmNova_PROF(TelaPortaEntradaTO parent, boolean modal) {
        this.pPORTA_ENTRADA_TO_PROF = parent;
        this.setModal(modal);
        setLocationRelativeTo(pPORTA_ENTRADA_TO_PROF);
        initComponents();
        auditoria();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAuditoriaAdmNova_PROF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAuditoriaAdmNova_PROF dialog = new TelaAuditoriaAdmNova_PROF(pPORTA_ENTRADA_TO_PROF, true);
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM TO_HISTORICO_PROFISSIONAL_NOVO "
                    ...
                    + "AND TO_HISTORICO_PROFISSIONAL_NOVO.IdHistoricoLabPN='" + codigoHistoricoProf + "'");
            conecta.rs.first();
