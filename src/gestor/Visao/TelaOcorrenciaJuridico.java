...
import gestor.Controle.ControleOcorrenciaJuridico;
 ...
 * @author ronaldo
 */
public class TelaOcorrenciaJuridico extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    OcorrenciaJuridico objOcorr = new OcorrenciaJuridico();
    ControleOcorrenciaJuridico control = new ControleOcorrenciaJuridico();
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        try {
            conecta.executaSQL("SELECT * FROM OCORRENCIAS_JU WHERE IdLanc='" + jIdOcorrencia.getText() + "'");
            conecta.rs.first();
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaOcorrenciasJuridico objAudiOcorre = new TelaAuditoriaOcorrenciasJuridico();
        TelaModuloJuridico.jPainelJuridico.add(objAudiOcorre);
        objAudiOcorre.show();
    ...
    private void jBtImpressaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtImpressaoActionPerformed
        ...
        try {
            conecta.abrirConexao();
            String path = "reports/Juridico/ListagemOcorrencias_ju.jasper";
            conecta.executaSQL("SELECT * FROM OCORRENCIAS_JU WHERE IdLanc='" + jIdOcorrencia.getText() + "'");
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            ...
            this.pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_JU");
        } else {
            jTabelaOcorrenciaPortaria.setVisible(!true);
        }
    ...
    private void jTabelaOcorrenciaPortariaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaOcorrenciaPortariaMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM OCORRENCIAS_JU WHERE IdLanc ='" + IdLanc + "'");
                conecta.rs.first();
    ...
    public void Finalizar() {
        ...
        if (resposta == JOptionPane.YES_OPTION) {
            objOcorr.setStatusLanc(statusEntrada);
            objOcorr.setIdLanc(Integer.parseInt(jIdOcorrencia.getText()));
            control.finalizarOcorrenciaJuridico(objOcorr);
            objLog();
            controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
    ...
    public void buscarID() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM OCORRENCIAS_JU");
            conecta.rs.last();
