...
import static gestor.Visao.TelaEvolucaoTecEnfermagem.jIdLanc;
import static gestor.Visao.TelaEvolucaoTecEnfermagem.jIdEvolu;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEvolucaoTecEnfermagem extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEvolucaoTecEnfermagem() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Evolução Técnico em Enfermeiros (as) :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM EVOLUCAOTECENFERMAGEM WHERE IdLanc='" + jIdLanc.getText() + "'AND IdItem='" + jIdEvolu.getText() + "'");
            conecta.rs.first();
