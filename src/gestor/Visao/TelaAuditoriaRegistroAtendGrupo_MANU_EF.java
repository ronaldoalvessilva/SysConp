 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_MANU_EF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_MANU_EF() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATENDIMENTO_GRUPO_EF WHERE IdAtGrupoEF='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
