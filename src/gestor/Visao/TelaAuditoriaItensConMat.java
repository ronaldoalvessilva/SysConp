...
import static gestor.Visao.TelaMatriculaPedagogica.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensConMat extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensConMat() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSMATRICULA WHERE IdMat='" + jIdMat.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
