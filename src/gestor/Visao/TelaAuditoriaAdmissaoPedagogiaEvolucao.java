...
import static gestor.Visao.AdmissaoEvolucaoPedagogica.jCodigoEvolucao;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAdmissaoPedagogiaEvolucao extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAdmissaoPedagogiaEvolucao() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Evolução Pedagógica :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM EVOLUCAO_ADMISSAO_PEDAGOGIA WHERE IdEvolucao='" + jCodigoEvolucao.getText() + "'");
            conecta.rs.first();
