 ...
 * @author ronaldo
 */
public class TelaFotoHallMasculino extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaEntradaSaidaVisitasInternasInternos telaentsaidvisitainterno;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoHallMasculino(TelaEntradaSaidaVisitasInternasInternos parent, boolean modal) {
        this.telaentsaidvisitainterno = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaentsaidvisitainterno);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoHallMasculino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoHallMasculino dialog = new TelaFotoHallMasculino(telaentsaidvisitainterno, true);
