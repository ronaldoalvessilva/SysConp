...
import static gestor.Visao.TelaAtividadeRealizadas.jIdAtividade;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAtividadesRealizadasJuri extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAtividadesRealizadasJuri() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATIVIDADESJURIDICOS WHERE IdAtiv='" + jIdAtividade.getText() + "'");
            conecta.rs.first();
