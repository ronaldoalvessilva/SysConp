 ...
 * @author Ronaldo
 */
public class TelaPesquisaOpTransferencia extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    int flag;
    String tipo = "Transferências";
    String pSTATUS_transferencia = "Ativo";

    /**
     * Creates new form TelaPesquisaCidade
     */
    public TelaPesquisaOpTransferencia() {
        initComponents();
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesDescOp.getText().equals("")) {
            ...
            preencherTabelaNome("SELECT * FROM OPERACAO "
                    ...
                    + "AND TipoOp='" + tipo + "' "
                    + "AND StatusOp='" + pSTATUS_transferencia + "'");
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        TelaTransfInterno.jDescricaoOp.setText(jPesDescOp.getText());
        dispose();
