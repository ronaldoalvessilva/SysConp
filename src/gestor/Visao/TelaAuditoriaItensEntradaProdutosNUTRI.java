...
import static gestor.Visao.TelaEntradaProdutosNUTRI.jIdLanc;
import static gestor.Visao.TelaEntradaProdutosNUTRI.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntradaProdutosNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEntradaProdutosNUTRI() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Produtos Compras :::...");
        setToolTipText("");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_COMPRAS_MATERIAIS_NUTRI WHERE IdNfEntrada='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
