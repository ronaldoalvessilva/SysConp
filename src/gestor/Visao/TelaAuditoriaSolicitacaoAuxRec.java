 ...
 * @author Ronaldo
 */
public class TelaAuditoriaSolicitacaoAuxRec extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaSolicitacaoAuxRec() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM SOLICITACAO_ATESTADO_RECLUSAO WHERE CodRegAux='" + jCodRegAux.getText() + "'");
            conecta.rs.first();
