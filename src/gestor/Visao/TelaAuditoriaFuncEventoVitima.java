...
import static gestor.Visao.TelaEventoDisciplinar.idItemFuncVi;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaFuncEventoVitima extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaFuncEventoVitima() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM COLABORADORVITIMA WHERE IdLanc='" + jIdLanc.getText() + "'AND IdColaVit='" + idItemFuncVi + "'");
            conecta.rs.first();
