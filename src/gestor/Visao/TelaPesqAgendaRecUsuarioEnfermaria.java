...
import static gestor.Visao.TelaRecadosEnfermaria.jNomeDestinatario;
 ...
 * @author ronaldo
 */
public class TelaPesqAgendaRecUsuarioEnfermaria extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqAgendaRecUsuarioEnfermaria() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa de Usuários {ME} :::...");
        ...
        if (jTabelaUsuarios.getColumnModel().getColumnCount() > 0) {
            jTabelaUsuarios.getColumnModel().getColumn(0).setMinWidth(80);
            jTabelaUsuarios.getColumnModel().getColumn(0).setMaxWidth(80);
            jTabelaUsuarios.getColumnModel().getColumn(1).setMinWidth(320);
            jTabelaUsuarios.getColumnModel().getColumn(1).setMaxWidth(320);
    ...
    public void preencherTabelaUsuario(String sql) {
        ...
        jTabelaUsuarios.getColumnModel().getColumn(0).setPreferredWidth(80);
        jTabelaUsuarios.getColumnModel().getColumn(0).setResizable(false);
        jTabelaUsuarios.getColumnModel().getColumn(1).setPreferredWidth(320);
    ...
    public void limparTabelaUsuarios() {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Código", "Nome do Usuario", "Status"};
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaUsuarios.setModel(modelo);
