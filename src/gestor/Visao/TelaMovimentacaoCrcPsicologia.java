 ...
 * @author user
 */
public class TelaMovimentacaoCrcPsicologia extends javax.swing.JInternalFrame {
     ...
     */
    public TelaMovimentacaoCrcPsicologia() {
        initComponents();
    }
    ...
    private void jBtPesquisarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarInternoActionPerformed
        // Pesquisar Internos
        TelaPesquisaMovInternoPsicologia objTelaMovInt = new TelaPesquisaMovInternoPsicologia();
        TelaModuloPsicologia.jPainelPsicologia.add(objTelaMovInt);
        objTelaMovInt.show();
