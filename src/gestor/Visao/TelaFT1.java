 ...
 * @author ronal
 */
public class TelaFT1 extends javax.swing.JDialog {
     ...
     */
    public static TelaAdmissaoSecundariaEnfermagem tft;

    public TelaFT1(TelaAdmissaoSecundariaEnfermagem parent, boolean modal) {
        this.tft = parent;
        this.setModal(modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFT1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFT1 dialog = new TelaFT1(tft, true);
