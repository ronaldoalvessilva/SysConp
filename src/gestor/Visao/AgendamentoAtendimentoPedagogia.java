...
import static gestor.Visao.AdmissaoEvolucaoPedagogica.departamentoAgenda;
import static gestor.Visao.AdmissaoEvolucaoPedagogica.jIdInternoAdm;
import static gestor.Visao.AdmissaoEvolucaoPedagogica.jNomeInternoAdm;
 ...
 * @author ronaldo
 */
public class AgendamentoAtendimentoPedagogia extends javax.swing.JDialog {
     ...
     */
    public static AdmissaoEvolucaoPedagogica atendePED;

    public AgendamentoAtendimentoPedagogia(AdmissaoEvolucaoPedagogica parent, boolean modal) {
        this.atendePED = parent;
        this.setModal(modal);
        setLocationRelativeTo(atendePED);
        initComponents();
        corCampos();
        mostrarInterno();
    }
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        if (jDataAgendamento.getDate() == null) {
            ...
            objItens.setIdInternoCrc(Integer.valueOf(jIdInternoAdm.getText()));
            objItens.setNomeInternoAgenda(jNomeInternoAdm.getText());
            ...
            Salvar();
            preencherTabelaAgenda("SELECT * FROM ITENS_AGENDA_ATENDIMENTO_INTERNOS_PEDAGOGIA "
                    + "INNER JOIN AGENDA_ATENDIMENTO_INTERNOS_PEDAGOGIA "
                    + "ON ITENS_AGENDA_ATENDIMENTO_INTERNOS_PEDAGOGIA.IdReg=AGENDA_ATENDIMENTO_INTERNOS_PEDAGOGIA.IdReg "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ITENS_AGENDA_ATENDIMENTO_INTERNOS_PEDAGOGIA.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "WHERE ITENS_AGENDA_ATENDIMENTO_INTERNOS_PEDAGOGIA.IdReg='" + jIdRegistro.getText() + "'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgendamentoAtendimentoPedagogia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgendamentoAtendimentoPedagogia dialog = new AgendamentoAtendimentoPedagogia(atendePED, true);
    ...
    public void mostrarInterno() {
        jIdInternoCrcAg.setText(jIdInternoAdm.getText());
        jNomeInternoCrcAgenda.setText(jNomeInternoAdm.getText());
