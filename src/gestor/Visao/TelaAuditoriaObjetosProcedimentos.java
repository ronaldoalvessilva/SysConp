...
import static gestor.Visao.TelaObjetosProcedimento.jIdObjPro;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaObjetosProcedimentos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaObjetosProcedimentos() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM OBJETOSPROCEDIMENTOS WHERE IdObjeto='" + jIdObjPro.getText() + "'");
            conecta.rs.first();
