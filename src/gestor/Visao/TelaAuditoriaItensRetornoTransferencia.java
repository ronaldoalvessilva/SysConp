...
import static gestor.Visao.TelaRetornoPorTransferencia.jIDLanc;
import static gestor.Visao.TelaRetornoPorTransferencia.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRetornoTransferencia extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRetornoTransferencia() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSRETORNOTRANSFERENCIA WHERE IdRetorno='" + jIDLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
