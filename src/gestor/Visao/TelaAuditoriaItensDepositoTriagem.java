 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensDepositoTriagem extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensDepositoTriagem() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Depósito de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSDEPOSITOPORTARIA WHERE Idlanc='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
