...
import static gestor.Visao.TelaAgendamentoBeneficiosInterno.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensAgendabeneficios extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensAgendabeneficios() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_AGENDA_BENEFICIO_INTERNOS WHERE IdReg='" + jIdRegistro.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
