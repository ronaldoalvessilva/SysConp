 ...
 * @author user
 */
public class TelaMovHistoricoTecBaseSeguranca extends javax.swing.JInternalFrame {
     ...
     */
    public TelaMovHistoricoTecBaseSeguranca() {
        initComponents();
        corCampos();
    }
    ...
    private void jBtPesquisarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarInternoActionPerformed
        // Pesquisar Internos
        count = 0;
        TelaPesqMovIntTecnicoBaseSeguranca objMovIntTec = new TelaPesqMovIntTecnicoBaseSeguranca();
        TelaModuloBaseUm.jPainelBaseSegurancaPavilhao.add(objMovIntTec);
        objMovIntTec.show();
