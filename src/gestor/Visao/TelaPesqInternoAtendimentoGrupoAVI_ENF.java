...
import static gestor.Visao.TelaAtendimentoGrupoENF.jIdInternoAI;
import static gestor.Visao.TelaAtendimentoGrupoENF.jNomeInternoAVI;
import static gestor.Visao.TelaAtendimentoGrupoENF.jFotoInternoGrupo;
import static gestor.Visao.TelaAtendimentoGrupoENF.jCNCAI;
import static gestor.Visao.TelaAtendimentoGrupoENF.jCodigoAtend;
import static gestor.Visao.TelaAtendimentoGrupoENF.jNomeMaeInternoAVI;
import static gestor.Visao.TelaAtendimentoGrupoENF.jRegimeAVI;
 ...
 * @author Ronaldo
 */
public class TelaPesqInternoAtendimentoGrupoAVI_ENF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoAtendimentoGrupoAVI_ENF() {
        initComponents();
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTabelaNome("SSELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_ENFERMAGEM "
    ...
    private void jBtMatriculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtMatriculaActionPerformed
        ...
        if (jPesqMatricula.getText().equals("")) {
            ...
            buscarInternosMatricula("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_ENFERMAGEM "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_ENFERMAGEM.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTodosInternos("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_ENFERMAGEM "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_ENFERMAGEM.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
