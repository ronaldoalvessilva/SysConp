 ...
 */
public class TelaConsultaPavilhaoKit extends javax.swing.JDialog {
     ...
     */
    public static TelaMontagemPagamentoKitInterno motkit;

    public TelaConsultaPavilhaoKit(TelaMontagemPagamentoKitInterno parent, boolean modal) {
        this.motkit = parent;
        this.setModal(modal);
        setLocationRelativeTo(motkit);
        initComponents();
        pesquisarPavilhaoInterno();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Pavilhão", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(204, 0, 0))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaPavilhaoKit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaConsultaPavilhaoKit dialog = new TelaConsultaPavilhaoKit(motkit, true);
    ...
    public void pesquisarPavilhaoInterno() {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Código", "Descrição do Pavilhão"};
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT DISTINCT INTERNOS_PAVILHAO_KIT_LOTE.IdPav,PAVILHAO.DescricaoPav "
                    + "FROM PAVILHAO "
                    + "INNER JOIN INTERNOS_PAVILHAO_KIT_LOTE "
                    + "ON PAVILHAO.IdPav=INTERNOS_PAVILHAO_KIT_LOTE.IdPav "
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getString("IdPav"), conecta.rs.getString("DescricaoPav")});
