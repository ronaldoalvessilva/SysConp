...
import static gestor.Visao.TelaRegistroInternosAtendimentoImpressoPEDA.codigoLiberador;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpressoPEDA.dataAssinatura;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpressoPEDA.horaAssinatura;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpressoPEDA.jBtSalvar;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpressoPEDA.nomeLiberador;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpressoPEDA.pDigitalCapturadaColaborador;
import static gestor.Visao.TelaRegistroInternosAtendimentoImpressoPEDA.pLiberacaoImpressa;
 ...
 * @author Ronaldo
 */
public class TelaAssinaturaoBiometriaColaboradoresPSP_PEDA extends javax.swing.JDialog {
    ...
    String nomeModuloTela2 = "PEDAGOGIA:Liberação de Impressão de Atendimento:Biometria";
    String statusMov;
    String horaMov;
    String dataModFinal;
    int acao;
     ...
     */
    public static TelaRegistroInternosAtendimentoImpressoPEDA assinaturaFuncPSP_SS;

    public TelaAssinaturaoBiometriaColaboradoresPSP_PEDA(TelaRegistroInternosAtendimentoImpressoPEDA parent, boolean modal) {
        this.assinaturaFuncPSP_SS = parent;
        this.setModal(modal);
        setLocationRelativeTo(assinaturaFuncPSP_SS);
        initComponents();
        corCampos();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAssinaturaoBiometriaColaboradoresPSP_PEDA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAssinaturaoBiometriaColaboradoresPSP_PEDA dialog = new TelaAssinaturaoBiometriaColaboradoresPSP_PEDA(assinaturaFuncPSP_SS, true);
