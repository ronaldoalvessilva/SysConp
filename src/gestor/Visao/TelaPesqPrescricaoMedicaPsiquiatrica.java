...
import static gestor.Visao.TelaAprazamentoMedicacoes.tipoA;
 ...
 * @author user
 */
public class TelaPesqPrescricaoMedicaPsiquiatrica extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqPrescricaoMedicaPsiquiatrica() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabelaPrescricaoMedica.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Seq.", "Data", "Prescrição Médica/Psicologica"
            }
        ));
        ...
        if (jTabelaPrescricaoMedica.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaPrescricaoMedica.getColumnModel().getColumn(2).setMinWidth(300);
            jTabelaPrescricaoMedica.getColumnModel().getColumn(2).setMaxWidth(300);
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                ...
                conecta.rs.first();
                jIdCodigoPM.setText(String.valueOf(conecta.rs.getInt("IdItem")));
            ...
            if (jDataFinal.getDate() == null) {
                ...
                if (jDataInicial.getDate().after(jDataFinal.getDate())) {
                    ...
                    pesquisarData("SELECT * FROM PRESCRICAO_MEDICA_PSIQUIATRICA "
                            + "WHERE DataPres BETWEEN'" + dataInicial + "'AND '" + dataFinal + "'AND TipoP='" + tipoA + "'");
                }
            }
        }
    ...
    private void jBtPesqCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoActionPerformed
        ...
        if (jIdlanc.getText().equals("")) {
            ...
            pesquisarData("SELECT * FROM PRESCRICAO_MEDICA_PSIQUIATRICA WHERE IdItem='" + jIdlanc.getText() + "'AND TipoP='" + tipoA + "'");
        }
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarData("SELECT * FROM PRESCRICAO_MEDICA_PSIQUIATRICA WHERE TipoP='" + tipoA + "'");
        } else {
            limparTabela();
        }
...
//Preencher tabela com todos os INTERNOS
    public void pesquisarData(String sql) {
        ...
        String[] Colunas = new String[]{"Seq.", "Data", "Prescrição Médica/Psicologica"};
        conecta.abrirConexao();
        try {
        ...
        alinharCamposTabelaPrescricao();
        conecta.desconecta();
    }

    public void alinharCamposTabelaPrescricao() {
