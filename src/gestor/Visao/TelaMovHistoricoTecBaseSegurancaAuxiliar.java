 ...
 * @author user
 */
public class TelaMovHistoricoTecBaseSegurancaAuxiliar extends javax.swing.JInternalFrame {
     ...
     */
    public TelaMovHistoricoTecBaseSegurancaAuxiliar() {
        initComponents();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true), "Foto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(0, 0, 255))); // NOI18N
    ...
    private void jBtPesquisarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarInternoActionPerformed
        // Pesquisar Internos
        count = 0;
        TelaPesqMovIntTecnicoBaseSegurancaAuxiliar objMovIntTec = new TelaPesqMovIntTecnicoBaseSegurancaAuxiliar();
        TelaModuloBaseDois.jPainelBasePavilhaoAuxiliar.add(objMovIntTec);
        objMovIntTec.show();
