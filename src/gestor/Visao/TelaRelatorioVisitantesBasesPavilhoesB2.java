 ...
 * @author ronal
 */
public class TelaRelatorioVisitantesBasesPavilhoesB2 extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    /**
     * Creates new form TelaRelatorioVisitantesBasesPavilhoesB2
     */
    public static TelaAlertaBasesPavilhoesBaseDois alertaBaseB2;

    public TelaRelatorioVisitantesBasesPavilhoesB2(TelaAlertaBasesPavilhoesBaseDois parent, boolean modal) {
        this.alertaBaseB2 = parent;
        this.setModal(modal);
        setLocationRelativeTo(alertaBaseB2);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRelatorioVisitantesBasesPavilhoesB2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaRelatorioVisitantesBasesPavilhoesB2 dialog = new TelaRelatorioVisitantesBasesPavilhoesB2(alertaBaseB2, true);
    ...
    public void buscarPavilhao(String descricao, String descricao2) {
        ...
        try {
            ...
            Logger.getLogger(TelaRelatorioVisitantesBasesPavilhoesB2.class.getName()).log(Level.SEVERE, null, ex);
        }
        conecta.desconecta();
    }
}
