...
import static gestor.Visao.TelaTriagemTerapiaOcupacional.jIdTriagem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaTerapiaOcupacional extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaTerapiaOcupacional() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM TRIAGEM_OCUPACIONAL WHERE IdTriagem='" + jIdTriagem.getText() + "'");
            conecta.rs.first();
