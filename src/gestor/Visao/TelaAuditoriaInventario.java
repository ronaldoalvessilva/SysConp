 ...
 * @author Ronaldo
 */
public class TelaAuditoriaInventario extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaInventario() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM INVENTARIO WHERE IdLanc='" + jIdLanc.getText() + "'");
            conecta.rs.first();
