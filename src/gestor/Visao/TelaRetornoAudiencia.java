...
import gestor.Controle.ControleItensRetornoAuditoria;
import gestor.Controle.ControleLogSistema;
import gestor.Controle.ControleMovInternos;
import gestor.Controle.ControleRetornoAuditoria;
...
import static gestor.Visao.TelaModuloCRC.telaRetornoAudManuCRC;
import static gestor.Visao.TelaModuloPrincipal.jDataSistema;
import static gestor.Visao.TelaModuloPrincipal.jHoraSistema;
import static gestor.Visao.TelaModuloPrincipal.tipoServidor;
import static gestor.Visao.TelaPesqRegIntAudiencia.idItemRetornoAudiencia;
 ...
 * @author Ronaldo
 */
public class TelaRetornoAudiencia extends javax.swing.JInternalFrame {
    ...
    ControleRetornoAuditoria control = new ControleRetornoAuditoria();
    ControleItensRetornoAuditoria controle = new ControleItensRetornoAuditoria();
    ...
    String nomeModuloTela = "CRC:Movimentação:Retorno Audiência de Internos:Manutenção";
    String nomeModuloTela2 = "CRC:Movimentação:Retorno Audiência de Internos:Internos";
    String statusMov;
    String horaMov;
    String dataModFinal;
    int flag;
    ...
    String origemRetornoEspontaneo = "RETORNO AUDIENCIA";
    String caminho;
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Retorno de Audiência de Internos :::...");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jDescricaoOpe, javax.swing.GroupLayout.PREFERRED_SIZE, 333, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jBtAlterarlanc1, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel8Layout.createSequentialGroup()
                            .addComponent(jOrigem, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        .addComponent(jBtAudInternos, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(30, 30, 30)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addComponent(FotoInternoCrcRetEsp, javax.swing.GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE)
        );
            ...
            if (jDataPesqInicial.getDate() == null) {
                ...
                if (jDataPesFinal.getDate() == null) {
                    ...
                    if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                        ...
                        pesquisarLancCod("SELECT * FROM RETORNOAUDIENCIA "
                                + "INNER JOIN OPERACAO "
                                + "ON RETORNOAUDIENCIA.IdOp = OPERACAO.IdOp "
    ...
    private void jBtNomeInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeInternoActionPerformed
        ...
        if (jPesqNomeInterno.getText().equals("")) {
            ...
            pesquisarRecapturaInterno("SELECT * FROM  RETORNOAUDIENCIA "
                    + "INNER JOIN ITENSRETORNOAUDIENCIA "
                    + "ON RETORNOAUDIENCIA.IdRetorno=ITENSRETORNOAUDIENCIA.IdRetorno "
                    + "INNER JOIN OPERACAO "
                    + "ON RETORNOAUDIENCIA.IdOp=OPERACAO.IdOp "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ITENSRETORNOAUDIENCIA.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
    ...
    private void jTabelaRetornoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaRetornoMouseClicked
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM RETORNOAUDIENCIA "
                        + "INNER JOIN OPERACAO "
                        + "ON RETORNOAUDIENCIA.IdOp=OPERACAO.IdOp "
                ...
                conecta.desconecta();
                preencherTabelaItens("SELECT * FROM ITENSRETORNOAUDIENCIA "
                        + "INNER JOIN PRONTUARIOSCRC "
                        + "ON ITENSRETORNOAUDIENCIA.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                        + "WHERE IdRetorno='" + IdLanc + "'");
    ...
    private void jBtPesqOperacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqOperacaoActionPerformed
        // TODO add your handling code here:
        TelaPesquisaOpRetornoAudiencia objPesqOpRetAud = new TelaPesquisaOpRetornoAudiencia();
        TelaModuloCRC.jPainelCRC.add(objPesqOpRetAud);
        objPesqOpRetAud.show();
    ...
    private void jBtNovolanc1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovolanc1ActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaRetornoAudManuCRC) && codIncluirCRC == 1) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarlanc1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarlanc1ActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaRetornoAudManuCRC);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaRetornoAudManuCRC) && codAlterarCRC == 1) {
    ...
    private void jBtExcluirlanc1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirlanc1ActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaRetornoAudManuCRC);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaRetornoAudManuCRC) && codExcluirCRC == 1) {
            objRetEspontaneo.setStatusRet(jStatusRetorno.getText());
            if (jStatusRetorno.getText().equals("FINALIZADO")) {
    ...
    private void jBtSalvarlanc1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarlanc1ActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaRetornoAudManuCRC);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaRetornoAudManuCRC) && codGravarCRC == 1) {
            if (jDescricaoOpe.getText().equals("")) {
                ...
                if (jDataLancamento.getDate() == null) {
                    ...
                    try {
                        ...
                        preencherTabelaItens("SELECT * FROM ITENSRETORNOAUDIENCIA INNER JOIN PRONTUARIOSCRC ON ITENSRETORNOAUDIENCIA.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc WHERE IdRetorno='" + jIDLanc.getText() + "'");
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                        + "INNER JOIN ITENSRETORNOAUDIENCIA "
                        + "ON PRONTUARIOSCRC.IdInternoCrc=ITENSRETORNOAUDIENCIA.IdInternoCrc "
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaRetornoAudManuCRC) && codExcluirCRC == 1) {
            ...
            if (jStatusRetorno.getText().equals("FINALIZADO")) {
                ...
                if (resposta == JOptionPane.YES_OPTION) {
                    ...
                    controle.excluirItensRetornoAudiencia(objItensRetEsp);
                    objItensRetEsp.setIdRetorno(Integer.valueOf(jIDLanc.getText()));
                    controlMov.excluirMovRetornoAudiencia(objItensRetEsp);
                    ...
                    controle.confirmaUtilizacaoItensRetornoAudiencia(objItensRetEsp);
    ...
    private void jBtSalvarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarItemActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaRetornoAudManuCRC) && codGravarCRC == 1) {
            ...
            if (jNomeInterno.getText().equals("")) {
                ...
                objItensRetEsp.setHoraRetorno(jHorarioRetorno.getText());
                ...
                try {
                    if (acao == 3) {
                        ...
                        objItensRetEsp.setIdRegistro(idItemRetornoAudiencia); // Grava o iditem para impedir de alterar, informado ao usuário para excluir e lançar novamente
                        controle.incluirItensRetornoAudiencia(objItensRetEsp); // TABELA ITENSRETORNOAUDIENCIA
                        //
                        ...
                        controlMov.incluirMovRetornoAudiencia(objItensRetEsp);
                        //
                        objItensRetEsp.setConfirmaRetorno(confirmaRetorno);
                        objItensRetEsp.setIdItem(idItemRetornoAudiencia);
                        objItensRetEsp.setIdInternoCrc(Integer.valueOf(jIdInterno.getText()));
                        objItensRetEsp.setIdRetorno(Integer.valueOf(jIDLanc.getText()));
                        controle.alterarRegItensRetornoAudienciaPortaria(objItensRetEsp);
                        //
                        objItensRetEsp.setIdRetorno((Integer.parseInt(jIDLanc.getText())));
                    ...
                    if (acao == 4) {
                        ...
                        objProCrc.setIdInterno(Integer.parseInt(jIdInterno.getText()));
                        objItensRetEsp.setIdItem(Integer.valueOf(idItem));
                        controle.alterarItensRetornoAudiencia(objItensRetEsp);
                        objProCrc.setIdInterno(Integer.parseInt(jIdInterno.getText()));
                        mod.alterarSituacaoInterno(objProCrc);
                        objItensRetEsp.setIdRetorno((Integer.parseInt(jIDLanc.getText())));
                        controlMov.alterarMovRetornoAudiencia(objItensRetEsp);
                        objLog2();
                        controlLog.incluirLogSistema(objLogSys);
                        SalvarItem();
                        preencherTabelaItens("SELECT * FROM ITENSRETORNOAUDIENCIA "
    ...
    private void jBtPesqRegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqRegistroActionPerformed
        // TODO add your handling code here:
        TelaPesqRegIntAudiencia objRetEspoInternoP1 = new TelaPesqRegIntAudiencia();
    ...
    public void verificarItens() {
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENSRETORNOAUDIENCIA "
                    + "WHERE IdRetorno='" + jIDLanc.getText() + "'");
            conecta.rs.first();
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                objRetEspontaneo.setIdRetorno(Integer.parseInt(jIDLanc.getText()));
                control.excluirRetonoEspontaneo(objRetEspontaneo);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                Excluir();
