 ...
 * @author Ronaldo
 */
public class TelaAuditoriaDepositoInativos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaDepositoInativos() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM DEPOSITO_INATIVOS WHERE IdDepIna='" + jIdLanc.getText() + "'");
            conecta.rs.first();
