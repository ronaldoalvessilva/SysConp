...
import static gestor.Visao.TelaRequisicaoMateriaisInternosSEAC.jDescricaoProduto;
import static gestor.Visao.TelaRequisicaoMateriaisInternosSEAC.jCodProduto;
import static gestor.Visao.TelaRequisicaoMateriaisInternosSEAC.jCodigoBarras;
import static gestor.Visao.TelaRequisicaoMateriaisInternosSEAC.jLote;
import static gestor.Visao.TelaRequisicaoMateriaisInternosSEAC.jDataVctoLote;
import static gestor.Visao.TelaRequisicaoMateriaisInternosSEAC.jComboBoxUnidade;
import static gestor.Visao.TelaRequisicaoMateriaisInternosSEAC.jValorUnitarioItem;
 ...
 * @author user
 */
public class TelaPesqProdutoRequisicaoMateriaisSEAC extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoRequisicaoMateriaisSEAC() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Produtos {SEAC} :::...");
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "AND PRODUTOS_AC.StatusProd='" + statusProd + "'AND Qtd!='" + 0 + "' "
        ...
        if (jPesqDescricaoProdutos.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRODUTOS_AC "
                        ...
                        + "AND PRODUTOS_AC.StatusProd='" + statusProd + "'AND PRODUTOS_AC.IdProd='" + idInt + "'AND Qtd!='" + 0 + "'");
                conecta.rs.first();
