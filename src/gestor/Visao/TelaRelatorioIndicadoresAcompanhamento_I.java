 ...
 */
public class TelaRelatorioIndicadoresAcompanhamento_I extends javax.swing.JInternalFrame {
     ...
     */
    public TelaRelatorioIndicadoresAcompanhamento_I() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Relatório de Indicativo Acompanhamento de Saúde :::...");
            ...
            if (jDataInicial.getDate() == null) {
                ...
                try {
                    ...
                    conecta.executaSQL("SELECT "
                            ...
                            + "WHERE "
                            + "P.SituacaoCrc='" + entradaUnid + "' "
                            + "OR P.SituacaoCrc='" + retornoUnid + "' "
                            + "AND (A.DataUp BETWEEN'" + dataInicial + "' "
                            + "AND '" + dataFinal + "') "
                    ...
                    jv.setTitle("Relatório de Acompanhamento de Saúde");
