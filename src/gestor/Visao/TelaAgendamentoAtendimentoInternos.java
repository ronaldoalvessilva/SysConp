 ...
 * @author Ronaldo
 */
public class TelaAgendamentoAtendimentoInternos extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "Psicologia:Agendamento de Visitas de Internos:Manutenção";
    //    
    String statusMov;
    String horaMov;
    String dataModFinal;
    ...
    String departamento = "PSICOLOGIA";

    /**
     * Creates new form TelaAgendamentoAtendimentoInternos
     */
    public TelaAgendamentoAtendimentoInternos() {
        initComponents();
        formatarCampos();
        corCampos();
    }
    ...
    private void jBtPesquisarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarInternoActionPerformed
        // TODO add your handling code here:
        TelaPesqInternosAgendamentoAtendimento objPesIntAgenda = new TelaPesqInternosAgendamentoAtendimento();
        TelaModuloPsicologia.jPainelPsicologia.add(objPesIntAgenda);
    ...
    private void jBtPesqCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoActionPerformed
        ...
        if (jPesqCodigoRegistro.getText().equals("")) {
            ...
            preencherTabelaAgenda("SELECT * FROM AGENDA_ATENDIMENTO_INTERNOS "
                    ...
                    + "WHERE AGENDA_ATENDIMENTO_INTERNOS.IdReg='" + jPesqCodigoRegistro.getText() + "' "
    ...
    private void jCheckBoxTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaAgenda("SELECT * FROM AGENDA_ATENDIMENTO_INTERNOS "
                    + "INNER JOIN ITENS_AGENDA_ATENDIMENTO_INTERNOS "
                    + "ON AGENDA_ATENDIMENTO_INTERNOS.IdReg=ITENS_AGENDA_ATENDIMENTO_INTERNOS.IdReg "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ITENS_AGENDA_ATENDIMENTO_INTERNOS.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM AGENDA_ATENDIMENTO_INTERNOS "
                        ...
                        + "INNER JOIN PRONTUARIOSCRC "
                        + "ON ITENS_AGENDA_ATENDIMENTO_INTERNOS.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                        + "WHERE AGENDA_ATENDIMENTO_INTERNOS.IdReg='" + codigoRegistro + "'");
                conecta.rs.first();
