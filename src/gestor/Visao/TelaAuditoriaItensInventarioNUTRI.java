 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensInventarioNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensInventarioNUTRI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_INVENTARIO_NUTRI WHERE IdLanc='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
