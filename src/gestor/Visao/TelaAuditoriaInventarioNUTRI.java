 ...
 * @author Ronaldo
 */
public class TelaAuditoriaInventarioNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaInventarioNUTRI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM INVENTARIO_NUTRI WHERE IdLanc='" + jIdLanc.getText() + "'");
            conecta.rs.first();
