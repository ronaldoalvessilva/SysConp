...
import static gestor.Visao.TelaArmas.jQRCodeArma;
...
public class TelaQRCode_Arama extends javax.swing.JDialog {
    ...
    private void jBtCodificarTextoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtCodificarTextoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaArmasQRCode) && objCampos.getCodigoConsultar() == 1) {
            acao = 3;
    ...
    private void jBtGerarArquivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtGerarArquivoActionPerformed
        ...
        pPESQUISAR_acessos.pesquisarGrupoUsuario(objCampos);
        pPESQUISAR_acessos.pesquisarTelasAcesso(objCampos);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaArmasQRCode) && objCampos.getCodigoAlterar() == 1) {
    ...
    private void jBtExcluirQRCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirQRCodeActionPerformed
        ...
        pPESQUISAR_acessos.pesquisarGrupoUsuario(objCampos);
        pPESQUISAR_acessos.pesquisarTelasAcesso(objCampos);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaArmasQRCode) && objCampos.getCodigoExcluir() == 1) {
    ...
    private void jBtSalvarQRCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarQRCodeActionPerformed
        ...
        pPESQUISAR_acessos.pesquisarGrupoUsuario(objCampos);
        pPESQUISAR_acessos.pesquisarTelasAcesso(objCampos);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaArmasQRCode) && objCampos.getCodigoGravar() == 1) {
            if (jTextoQRCode.getText().equals("")) {
    ...
    public void limparCampos() {
        ...
        //
        jQRCode.setIcon(null);
        jQRCode.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gestor/Imagens/codigo-qr_256.png")));
    ...
    public void pBUSCAR_QRCode() {
        CONTROL.pBUSCAR_QRCode_codigo(objArma);
    }
    ...
    public void mMOSTRAR_QRCode() {
        ...
        if (imgBytes0 != null) {
            ...
            Image scaled0 = pic0.getImage().getScaledInstance(jQRCodeArma.getWidth(), jQRCodeArma.getHeight(), Image.SCALE_SMOOTH);
            ImageIcon icon0 = new ImageIcon(scaled0);
            jQRCodeArma.setIcon(icon0);
            jQRCodeArma.setEnabled(true);
        }
    }
    ...
    public void pPESQUISAR_dados() {
        try {
            for (Arma qq : CONTROL.pPESQUISAR_QRCode_read()) {
                qq.getIdArma();
                jTextoQRCode.setText(qq.getTextoQRCode());
                //
                byte[] imgBytes0 = ((byte[]) qq.getqRCodeArma());
                if (imgBytes0 != null) {
                    ImageIcon pic0 = null;
                    pic0 = new ImageIcon(imgBytes0);
            ...
            Logger.getLogger(TelaQRCode_Arama.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
