...
import static gestor.Visao.TelaOcorrenciaPortariaServicoSocial.idItemVisita;
import static gestor.Visao.TelaOcorrenciaPortariaServicoSocial.jCodigoOcorrencia;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaOcorrenciaVisitas extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaOcorrenciaVisitas() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Ocorrências Visitas:::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM OCORRENCIA_INDISCIPLINA_PORTARIA WHERE IdReg='" + jCodigoRegistro.getText() + "'AND IdOcr='" + jCodigoOcorrencia.getText()  + "'");
            conecta.rs.first();
