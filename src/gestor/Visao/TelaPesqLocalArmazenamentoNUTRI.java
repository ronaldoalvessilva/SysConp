...
import static gestor.Visao.TelaInventarioProdutosNUTRI.jIdLocal;
import static gestor.Visao.TelaInventarioProdutosNUTRI.jLocalArmazenamento;
 ...
 * @author user
 */
public class TelaPesqLocalArmazenamentoNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqLocalArmazenamentoNUTRI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Locais de Armazenamento {NUTRI} :::...");
        ...
        if (jTabelaLocaisArmazenamento.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaLocaisArmazenamento.getColumnModel().getColumn(1).setMaxWidth(3330);
        }
