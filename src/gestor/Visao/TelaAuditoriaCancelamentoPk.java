 ...
 * @author Ronaldo
 */
public class TelaAuditoriaCancelamentoPk extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaCancelamentoPk() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM CANCELAR_PAGAMENTO_KIT_HIGIENE WHERE IdRegistro='" + jIdRegistro.getText() + "'");
            conecta.rs.first();
