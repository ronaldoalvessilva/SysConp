...
import gestor.Controle.ControleOcorrenciasMedicas;
 ...
 * @author ronaldo
 */
public class TelaOcorrenciaMedica extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    OcorrenciasMedica objOcorr = new OcorrenciasMedica();
    ControleOcorrenciasMedicas control = new ControleOcorrenciasMedicas();
    ...
    String nomeModuloTela = "Departamento Médico:Movimentação:Ocorrências Diárias:Manutenção";
    String horaMov;
    String dataModFinal;
    int count = 0;
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Ocorrência Enfermaria :::...");
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaOcorrenciaDiaManuENF) && codIncluir == 1) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:     
        buscarAcessoUsuario(telaOcorrenciaDiaManuENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaOcorrenciaDiaManuENF) && codAlterar == 1) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaOcorrenciaDiaManuENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaOcorrenciaDiaManuENF) && codExcluir == 1) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            conecta.abrirConexao();
                ...
                if (jStatusOcorrencia.getText().equals("FINALIZADO")) {
                    ...
                    if (jStatusOcorrencia.getText().equals("FINALIZADO")) {
                        ...
                        if (resposta == JOptionPane.YES_OPTION) {
                            ...
                            control.excluirOcorrenciaMedica(objOcorr);
                            objLog();
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaOcorrenciaDiaManuENF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES") || codigoUser == codUserAcesso && nomeTela.equals(telaOcorrenciaDiaManuENF) && codGravar == 1) {
            if (jDataOcorrencia.getDate() == null) {
            ...
            } else if (jTituloOcorrencia.getText().equals("")) {
                ...
                if (acao == 1) {
                    control.incluirOcorrenciaMedica(objOcorr);
                    buscarID();
                    Salvar();
                    objLog();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                ...
                if (acao == 2) {
                    ...
                    control.alterarOcorrenciaMedica(objOcorr);
                    Salvar();
                    objLog();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaOcorrenciasEnfermaria objAudiOcorre = new TelaAuditoriaOcorrenciasEnfermaria();
        TelaModuloEnfermaria.jPainelMedico.add(objAudiOcorre);
        objAudiOcorre.show();
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_ME");
        } else {
        ...
        if (jDataPesqInicial.getDate() == null) {
            ...
            if (jDataPesFinal.getDate() == null) {
                ...
                if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                    ...
                    pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_ME WHERE DataLanc BETWEEN'" + dataInicial + "'AND '" + dataFinal + "'");
                }
            }
        }
    ...
    private void jBtPesqTituloOcorrrenciaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtPesqTituloOcorrrenciaMouseClicked
        ...
        if (jPesqTituloOcorrencia.getText().equals("")) {
            ...
            pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_ME WHERE WHERE Titulo LIKE'" + jPesqTituloOcorrencia + "%'");
        }
    ...
    private void jTabelaOcorrenciaPortariaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaOcorrenciaPortariaMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM OCORRENCIAS_ME WHERE IdLanc ='" + IdLanc + "'");
                conecta.rs.first();
    ...
    public void Finalizar() {
        ...
        if (resposta == JOptionPane.YES_OPTION) {
            objOcorr.setStatusLanc(statusEntrada);
            objOcorr.setIdLanc(Integer.parseInt(jIdOcorrencia.getText()));
            control.finalizarOcorrenciaMedica(objOcorr);
            objLog();
            controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
    ...
    public void buscarID() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM OCORRENCIAS_ME");
            conecta.rs.last();
