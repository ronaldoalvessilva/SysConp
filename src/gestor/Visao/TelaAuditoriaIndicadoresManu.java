 ...
 * @author Ronaldo
 */
public class TelaAuditoriaIndicadoresManu extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaIndicadoresManu() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM INDICADOR_ACOMPANHAMENTO_INTERNO WHERE IdIndAco='" + jIdPerfil.getText() + "'");
            conecta.rs.first();
