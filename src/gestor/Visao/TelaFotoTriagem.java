 ...
 * @author ronaldo
 */
public class TelaFotoTriagem extends javax.swing.JDialog {
     ...
     */
    public TelaFotoTriagem(TelaProntuarioTriagem parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoTriagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoTriagem dialog = new TelaFotoTriagem(telaprontuariotriagem, true);
