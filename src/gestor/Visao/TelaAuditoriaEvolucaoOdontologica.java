...
import static gestor.Visao.TelaAtendimentoOdontologico.jIDLanc;
import static gestor.Visao.TelaAtendimentoOdontologico.jIdEvolucao;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEvolucaoOdontologica extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEvolucaoOdontologica() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ODONTOPROCEDIMENTO WHERE IdLanc='" + jIDLanc.getText() + "'AND IdPro='" + jIdEvolucao.getText() + "'");
            conecta.rs.first();
