...
import gestor.Dao.*;
import static gestor.Visao.TelaEntradaSaidaVisitasInternos.jBtZoonFoto;
 ...
 * @author user
 */
public class TelaPesqInternosVisitasRol extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternosVisitasRol() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (jTabelaPesqInternosRol.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaPesqInternosRol.getColumnModel().getColumn(2).setMinWidth(370);
            jTabelaPesqInternosRol.getColumnModel().getColumn(2).setMaxWidth(370);
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        flag = 1;
        if (flag == 1) {
            nomeInterno = "" + jTabelaPesqInternosRol.getValueAt(jTabelaPesqInternosRol.getSelectedRow(), 2);
            jPesqNomeInterno.setText(nomeInterno);
            codigoInterno = "" + jTabelaPesqInternosRol.getValueAt(jTabelaPesqInternosRol.getSelectedRow(), 1);
...
//Preencher tabela com todos os COLABORADORES
    public void buscarInternoVisitas(String sql) {
        ...
        String[] Colunas = new String[]{"ID Rol", "Codigo", "Nome do Interno"};
        conecta.abrirConexao();
        try {
        ...
        jTabelaPesqInternosRol.getColumnModel().getColumn(1).setPreferredWidth(50);
        jTabelaPesqInternosRol.getColumnModel().getColumn(1).setResizable(false);
        jTabelaPesqInternosRol.getColumnModel().getColumn(2).setPreferredWidth(370);
