...
import static gestor.Visao.TelaPAI_NOVO_Psicologia.jCodigoPAI;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaPAI_ManuPSI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaPAI_ManuPSI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM FICHA_CADASTRO_PAI_PSICOSOCIAL WHERE IdPai='" + jCodigoPAI.getText() + "'");
            conecta.rs.first();
