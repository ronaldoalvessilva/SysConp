...
import static gestor.Visao.TelaAprovadorSolicitacaoCompras.jNomeDepartamento;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaColaboradorAprovador extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaColaboradorAprovador() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        TabelaColaborador.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome do Colaborador", "Nome Departamento"
            }
        ));
        ...
        if (TabelaColaborador.getColumnModel().getColumnCount() > 0) {
            TabelaColaborador.getColumnModel().getColumn(0).setMinWidth(50);
            TabelaColaborador.getColumnModel().getColumn(0).setMaxWidth(50);
            TabelaColaborador.getColumnModel().getColumn(1).setMinWidth(240);
            TabelaColaborador.getColumnModel().getColumn(1).setMaxWidth(240);
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesNomeColaborador.getText().equals("")) {
            ...
            TabelaColaborador.setVisible(true);
            preencherTabelaColaborador("SELECT * FROM COLABORADOR "
                    + "INNER JOIN DEPARTAMENTOS "
                    + "ON COLABORADOR.IdDepartamento=DEPARTAMENTOS.IdDepartamento "
                    + "WHERE NomeFunc LIKE'%" + jPesNomeColaborador.getText() + "%'");
        }
    ...
    public void preencherTabelaColaborador(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Nome do Colaborador", "Nome Departamento"};
        conecta.abrirConexao();
        try {
        ...
        TabelaColaborador.getColumnModel().getColumn(0).setPreferredWidth(50);
        TabelaColaborador.getColumnModel().getColumn(0).setResizable(false);
        TabelaColaborador.getColumnModel().getColumn(1).setPreferredWidth(240);
