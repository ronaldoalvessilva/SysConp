 ...
 * @author ronaldo
 */
public class TelaConsultaEvolucaoTerapiaOcupacional extends javax.swing.JDialog {
     ...
     */
    public static TelaConsultaProntuarioInternoCrc telaProntuarioUnicoTO;

    public TelaConsultaEvolucaoTerapiaOcupacional(TelaConsultaProntuarioInternoCrc parent, boolean modal) {
        this.telaProntuarioUnicoTO = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaProntuarioUnicoTO);
        initComponents();
        formatarCampos();
    ...
    private void initComponents() {
        ...
        setTitle("...::: Evolução Terapia Ocupacional :::...");
        ...
        jTabelaDatasEvolucaoPsicologica.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Data", "Evolução Terapia Ocupacional"
            }
        ));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true), "Evolução Terapia Ocupacional", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(0, 0, 255))); // NOI18N
    ...
    private void jCheckBoxTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarData("SELECT * FROM EVOLUCAOTERAPIA "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON EVOLUCAOTERAPIA.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "                   
                    + "WHERE EVOLUCAOTERAPIA.IdInternoCrc='" + jIdInternoConPSP.getText() + "'");
        } else {
        ...
        if (jDataInicial.getDate() == null) {
            ...
            if (jDataFinal.getDate() == null) {
                ...
                if (jDataInicial.getDate().after(jDataFinal.getDate())) {
                    ...
                    pesquisarData("SELECT * FROM EVOLUCAOTERAPIA "
                            + "INNER JOIN PRONTUARIOSCRC "
                            + "ON EVOLUCAOTERAPIA.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "                           
                            + "WHERE EVOLUCAOTERAPIA.DataEvol BETWEEN'" + dataInicial + "' "
                            + "AND '" + dataFinal + "'AND EVOLUCAOTERAPIA.IdInternoCrc='" + jIdInternoConPSP.getText() + "'");
                }
            }
        }
    ...
    private void jTabelaDatasEvolucaoPsicologicaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaDatasEvolucaoPsicologicaMouseClicked
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM EVOLUCAOTERAPIA WHERE IdEvo='" + codItem + "'AND IdInternoCrc='" + jIdInternoConPSP.getText() + "'");
                conecta.rs.first();
                jTextoEvolucaoPsiquiatrica.setText(conecta.rs.getString("Evolucao"));
                conecta.desconecta();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaEvolucaoTerapiaOcupacional.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaConsultaEvolucaoTerapiaOcupacional dialog = new TelaConsultaEvolucaoTerapiaOcupacional(telaProntuarioUnicoTO, true);
    ...
    public void pesquisarData(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Data", "Evolução Terapia Ocupacional"};
        conecta.abrirConexao();
        try {
            ...
            do {
                count = count + 1;
                dataMov = conecta.rs.getString("DataEvo");
                String dia = dataMov.substring(8, 10);
                String mes = dataMov.substring(5, 7);
                String ano = dataMov.substring(0, 4);
                dataMov = dia + "/" + mes + "/" + ano;
                jtotalRegistros.setText(Integer.toString(count)); // Converter inteiro em string para exibir na tela
                dados.add(new Object[]{conecta.rs.getInt("IdEvo"), dataMov, conecta.rs.getString("Evolucao")});
