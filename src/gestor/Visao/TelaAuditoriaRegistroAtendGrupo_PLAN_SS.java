...
import static gestor.Visao.TelaAtendimentoGrupoSS.jCodigoTema;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_PLAN_SS extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_PLAN_SS() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PLANEJAMENTO_ATENDIMENTO_GRUPO_SS "
                    + "WHERE IdItemPlanSS='" + jCodigoTema.getText() + "' "
