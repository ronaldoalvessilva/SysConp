...
import static gestor.Visao.TelaMudancaRegimeProgressao.jIdLanc;
import static gestor.Visao.TelaMudancaRegimeProgressao.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensProgressao extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensProgressao() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSPROGRESSAOREGIME WHERE IdLanc='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
