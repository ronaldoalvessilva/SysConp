...
import static gestor.Visao.TelaEstornoRequisicaoMateriaisAC.jIdEst;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisAC.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEstorno extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEstorno() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_ESTORNO_PRODUTOS_AC WHERE IdEst='" + jIdEst.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
