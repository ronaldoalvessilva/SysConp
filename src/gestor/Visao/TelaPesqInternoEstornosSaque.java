 ...
 * @author Ronaldo
 */
public class TelaPesqInternoEstornosSaque extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoEstornosSaque() {
        initComponents();
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTabelaNome("SELECT * FROM PRONTUARIOSCRC "
                    + "INNER JOIN SAQUE "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=SAQUE.IdInternoCrc "
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                ...
                jIdRegistro.setText(conecta.rs.getString("IdSaq"));
    ...
    public void preencherTabelaNome(String sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdInternoCrc"), conecta.rs.getString("NomeInternoCrc"), conecta.rs.getString("IdSaq"), valorDepositoTela, dataCadastro});
