...
import static gestor.Visao.TelaAtendimentoFamiliar.jIdEvolucao;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAtendimentoFamiliarEvolucao extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAtendimentoFamiliarEvolucao() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Atendimento de Familiar {SS} :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM EVOLUCAO_ATENDIMENTO_FAMILIA "
                    ...
                    + "AND IdEvolucaoFam='" + jIdEvolucao.getText() + "'");
            conecta.rs.first();
