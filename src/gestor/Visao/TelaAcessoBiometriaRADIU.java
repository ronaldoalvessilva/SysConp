...
import static gestor.Controle.ControleItensTransientes.count;
...
import static gestor.Visao.TelaAcessosPortariaInterna.jTabelaVisitasDiversas;
 ...
 * @author Ronaldo
 */
public class TelaAcessoBiometriaRADIU extends javax.swing.JDialog {
    ...
    String nomeModuloTela2 = "Portaria:Entrada/Saida RADIU:Biometria";
    String statusMov;
    String horaMov;
    String dataModFinal;
    int acao;
     ...
     */
    public static TelaAcessosPortariaInterna entradaSaidaBiometriaRADIU;

    public TelaAcessoBiometriaRADIU(TelaAcessosPortariaInterna parent, boolean modal) {
        this.entradaSaidaBiometriaRADIU = parent;
        this.setModal(modal);
        setLocationRelativeTo(entradaSaidaBiometriaRADIU);
        initComponents();
        corCampos();
    ...
    private void initComponents() {
        ...
        setTitle("...::: Controle de Acesso Colaborador Biometrico - RADIU :::...");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jDestino, javax.swing.GroupLayout.PREFERRED_SIZE, 612, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel5)
                    .addComponent(jLabel17)
                    .addComponent(jMotivo, javax.swing.GroupLayout.PREFERRED_SIZE, 486, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        jPanel5Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jDestino, jMotivo});
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        if (jIdColaborador.getText().equals("") || jNomeColaborador.getText().equals("")) {
            ...
            objItensTransi.setIdFunc(Integer.valueOf(jIdColaborador.getText()));
            objItensTransi.setNomeColaborador(jNomeColaborador.getText());
            objItensTransi.setDataEntrada(jDataEntrada.getDate());
            objItensTransi.setHoraEntrada(jHorarioEntrada.getText());
            objItensTransi.setDataSaida(jDataEntrada.getDate());
            objItensTransi.setHoraSaida(horarioSaidaBio);
            objItensTransi.setIdTrans(Integer.valueOf(jIdLanc.getText()));
            objItensTransi.setTipoOperacao(tipoOperacao);
            //
            ...
            if (jIdColaborador.getText().equals(codigoFuncGrava) && jIdLanc.getText().equals(codigoRegistroGrava) && jComboBoxTipoOperacao.getSelectedItem().equals("Entrada") && assinaturaSaida == null) {
                ...
                objItensTransi.setHoraEntrada(jHorarioEntrada.getText());
                objItensTransi.setHoraSaida(horarioSaidaBio);
                objItensTransi.setAssinaturaEntradaColaborador(pDigitalCapturada);
            ...
            if (!jIdColaborador.getText().equals(codigoFuncGrava) && jComboBoxTipoOperacao.getSelectedItem().equals("Saída") && assinaturaSaida == null) {
                JOptionPane.showMessageDialog(rootPane, "Esse colaborador não está dentro da unidade.");
            } else {
                if (jIdColaborador.getText().equals(codigoFuncGrava) && jIdLanc.getText().equals(codigoRegistroGrava) && jComboBoxTipoOperacao.getSelectedItem().equals("Saída") && assinaturaSaida == null) {
                    objItensTransi.setDataSaida(jDataEntrada.getDate());
                    objItensTransi.setHoraSaida(jHorarioEntrada.getText());
                    objItensTransi.setAssinaturaEntradaColaborador(pDigitalCapturada);
                    objItensTransi.setTipoTrans(tipoVisita);
                    //
                    statusMov = "Alterou";
                    ...
                    //
                    objItensTransi.setIdItens(codigoItem);
                    controle.alterarItensTransientesBiometria(objItensTransi);
                    objLog2();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    Salvar();
                    preencherTabelaItens("SELECT * FROM ITENS_TRANSIENTES_VISITAS_DIVERSAS "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAcessoBiometriaRADIU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAcessoBiometriaRADIU dialog = new TelaAcessoBiometriaRADIU(entradaSaidaBiometriaRADIU, true);
    ...
    private static Runnable LerDigital1 = new Runnable() {
        ...
        public void run() {
            try {
                ...
                //
                ControleItensTransientes digiControl = new ControleItensTransientes();
    ...
    public void verificarColaboradorCadastrado() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM ITENS_TRANSIENTES_VISITAS_DIVERSAS "
                    + "WHERE IdCodigo='" + jIdColaborador.getText() + "' "
                    + "AND IdTrans='" + jIdLanc.getText() + "' "
                    + "AND HoraEntrada!='" + phorarioEntrada + "' "
                    + "AND HoraSaida='" + phorarioSaida + "'");
            conecta.rs.first();
            codigoFuncGrava = conecta.rs.getString("IdCodigo");
            codigoRegistroGrava = conecta.rs.getString("IdTrans");
    ...
    public void verificarColaboradorCadastrado2() {
        ...
        try {
            ...
            conecta.rs.first();
            codigoFuncGrava = conecta.rs.getString("IdCodigo");
            codigoRegistroGrava = conecta.rs.getString("IdIrans");
            codigoItem = conecta.rs.getInt("IdItem");
            horarioEntrada = conecta.rs.getString("HorarioEntrada");
            horarioSaida = conecta.rs.getString("HorarioSaida");
        } catch (Exception e) {
    ...
    public void verificarInternoColaboradorSaida() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM ITENS_TRANSIENTES_VISITAS_DIVERSAS "
                    + "WHERE IdCodigo='" + jIdColaborador.getText() + "' "
                    + "AND IdTrans='" + jIdLanc.getText() + "' "
                    + "AND HoraEntrada!='" + horarioEntrada + "' "
                    + "AND HoraSaida='" + horarioSaida + "'");
            conecta.rs.first();
            codigoFuncGrava = conecta.rs.getString("IdCodigo");
            codigoRegistroGrava = conecta.rs.getString("IdTrans");
            codigoItem = conecta.rs.getInt("IdItem");
