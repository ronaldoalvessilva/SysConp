...
import static gestor.Visao.TelaAtendimentoGrupoPE.pCODIGO_AVALIACAO_GRUPO;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_AGRU_PE extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_AGRU_PE() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AVALICAO_ATENDIMENTO_GRUPO_PE "
                    + "WHERE IdItemAvagPE='" + pCODIGO_AVALIACAO_GRUPO + "' "
