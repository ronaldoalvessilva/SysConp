...
import static gestor.Visao.TelaPesquisaMovInternoCrcBaseSegurancaAuxiliar.idIntSeg;
 ...
 * @author user
 */
public class TelaMovimentacaoCrcBaseSegurancaAuxiliar extends javax.swing.JInternalFrame {
     ...
     */
    public TelaMovimentacaoCrcBaseSegurancaAuxiliar() {
        initComponents();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Historico de Movimentação de Internos {CRC}/{BASESEG} :::...");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true), "Foto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 0, 0))); // NOI18N
    ...
    private void jBtPesquisarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarInternoActionPerformed
        // Pesquisar Internos
        count = 0;
        TelaPesquisaMovInternoCrcBaseSegurancaAuxiliar objTelaMovIntAux = new TelaPesquisaMovInternoCrcBaseSegurancaAuxiliar();
        TelaModuloBaseDois.jPainelBasePavilhaoAuxiliar.add(objTelaMovIntAux);
        objTelaMovIntAux.show();
        ...
        if (jNomeInterno.getText().equals("")) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                        ...
                        + "AND PRONTUARIOSCRC.IdInternoCrc='" + idIntSeg + "'");
                conecta.rs.first();
