...
import static gestor.Visao.TelaObitoInternoExterna.jDocumentoSaida;
 ...
 * @author Ronaldo
 */
public class TelaPesqInternosObitoManualMedico extends javax.swing.JInternalFrame {
    ...
    String nomeInterno;
    String idInt;
    String pTIPO_SAIDA = "SAIDA PARA MEDICO";

    /**
     * Creates new form TelaPesqInternosEvadidosManual
     */
    public TelaPesqInternosObitoManualMedico() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Pesquisa de Internos Saída Médico {Óbito} :::..");
