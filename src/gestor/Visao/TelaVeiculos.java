...
public class TelaVeiculos extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "Portaria:Cadastro de Veiculos:Manutenção";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaVeculos objAudVeic = new TelaAuditoriaVeculos();
        TelaModuloPortarias.jPainelPortarias.add(objAudVeic);
        objAudVeic.show();
    ...
    private void jBtPlacaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPlacaActionPerformed
        ...
        if (jPlaca.getText().equals("")) {
            ...
            pesquisarTodosPertences("SELECT * FROM VEICULOS WHERE PlacaVeiculo LIKE'%" + jPlaca.getText() + "%'");
        }
...
//        try {
//            MaskFormatter placa = new MaskFormatter("UUU#U##");
