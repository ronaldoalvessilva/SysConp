 ...
 * @author user
 */
public class TelaMovHistoricoTecOdontologia extends javax.swing.JInternalFrame {
     ...
     */
    public TelaMovHistoricoTecOdontologia() {
        initComponents();
    }
    ...
    private void jBtPesquisarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarInternoActionPerformed
        // Pesquisar Internos
        TelaPesqMovIntTecnicoOdontologia objMovIntTecOdon = new TelaPesqMovIntTecnicoOdontologia();
        TelaModuloOdontologia.jPainelOdontologia.add(objMovIntTecOdon);
