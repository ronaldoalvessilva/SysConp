...
import static gestor.Visao.TelaAtendimentoGrupoTO.jIdInternoAI;
import static gestor.Visao.TelaAtendimentoGrupoTO.jNomeInternoAVI;
import static gestor.Visao.TelaAtendimentoGrupoTO.jFotoInternoGrupo;
import static gestor.Visao.TelaAtendimentoGrupoTO.jCNCAI;
import static gestor.Visao.TelaAtendimentoGrupoTO.jCodigoAtend;
import static gestor.Visao.TelaAtendimentoGrupoTO.jNomeMaeInternoAVI;
import static gestor.Visao.TelaAtendimentoGrupoTO.jRegimeAVI;
 ...
 * @author Ronaldo
 */
public class TelaPesqInternoAtendimentoGrupoAVI_TO extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoAtendimentoGrupoAVI_TO() {
        initComponents();
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTabelaNome("SSELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_TO "
    ...
    private void jBtMatriculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtMatriculaActionPerformed
        ...
        if (jPesqMatricula.getText().equals("")) {
            ...
            buscarInternosMatricula("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_TO "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_TO.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTodosInternos("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_TO "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_TO.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
