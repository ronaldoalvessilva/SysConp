...
import static gestor.Visao.TelaEventoDisciplinar.idItemIntVi;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEventosInternosVitima extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEventosInternosVitima() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM INTERNOSVITIMAS WHERE IdLanc='" + jIdLanc.getText() + "'AND IdIntVitima='" + idItemIntVi + "'");
            conecta.rs.first();
