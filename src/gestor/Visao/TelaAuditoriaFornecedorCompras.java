...
import static gestor.Visao.TelaFornecedorCOMPRAS.jIdFornecedor;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaFornecedorCompras extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaFornecedorCompras() {
        initComponents();
        auditoria();      
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM FORNECEDORES_AC WHERE IdForn='" + jIdFornecedor.getText() + "'");
            conecta.rs.first();
