...
public class TelaModuloCRC extends javax.swing.JInternalFrame {
    ...
    private TelaProrrogracaoSaidaTemporariaDomiciliar objProrroga = null;
    ...
    //INICIADO EM 05/04/2021
    private TelaCancelamentoEvasao objCancelaEvasao = null;
    // 
    ...
    public static String telaCancelamentoPrimeiraEntradaManu_CRC = "Movimentação:Cancelamento de Entrada 1ª VEZ:Manutenção";
    public static String telaCancelamentoPrimeiraEntradaInte_CRC = "Movimentação:Cancelamento de Entrada 1ª VEZ:Internos";
    ...
    //
    public static String telaCancelamentoEvasao_CRC = "Movimentação:Saída Simbólica:Manutenção";
    //
    ...
    private void initComponents() {
        ...
        jCancelamentoEvasao = new javax.swing.JMenuItem();
        ...
        jProrrogacaoSaidaTemporaria.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jProrrogacaoSaidaTemporariaActionPerformed(evt);
            }
        });
        jMenuMovimentacao.add(jProrrogacaoSaidaTemporaria);
        ...
        jMenu12.add(jCancelarRegistro_PRIMEIRA_VEZ);
        ...
        jMenu12.add(jCancelarRegistro_NOVA_ENTRADA);
        ...
        jCancelamentoEvasao.setText("Cancelamento de Evasão de Internos");
        jCancelamentoEvasao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCancelamentoEvasaoActionPerformed(evt);
            }
        });
        jMenu12.add(jCancelamentoEvasao);
        ...
        RelatoriosConfere.setText("Relatórios de Confere - GERÊNCIA OPERACIONAL");
...
//        gr.show();
    ...
    private void jProrrogacaoSaidaTemporariaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jProrrogacaoSaidaTemporariaActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaProrrogracaoSaidaTMPPDManu_CRC);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaProrrogracaoSaidaTMPPDManu_CRC) && codAbrirCRC == 1) {
            if (objProrroga == null || objProrroga.isClosed()) {
                objProrroga = new TelaProrrogracaoSaidaTemporariaDomiciliar();
                jPainelCRC.add(objProrroga);
                objProrroga.setVisible(true);
            } else {
                if (objProrroga.isVisible()) {
                    if (objProrroga.isIcon()) { // Se esta minimizado
                        try {
                            objProrroga.setIcon(false); // maximiniza
                        } catch (PropertyVetoException ex) {
                        }
                    } else {
                        objProrroga.toFront(); // traz para frente
                        objProrroga.pack();//volta frame 
                    }
                } else {
                    objProrroga = new TelaProrrogracaoSaidaTemporariaDomiciliar();
                    TelaModuloCRC.jPainelCRC.add(objProrroga);//adicona frame ao JDesktopPane  
                    objProrroga.setVisible(true);
                }
            }
            try {
                objProrroga.setSelected(true);
            } catch (java.beans.PropertyVetoException e) {
            }
        } else {
            JOptionPane.showMessageDialog(null, "Acesso não autorizado, solicite liberação ao administrador.");
        }
    }//GEN-LAST:event_jProrrogacaoSaidaTemporariaActionPerformed
    ...
    private void jCancelarRegistro_NOVA_ENTRADAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCancelarRegistro_NOVA_ENTRADAActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaCancelamentoPrimeiraEntradaManu_CRC) && codAbrirCRC == 1) {
            if (objCancel_NOVA_ENTRA == null || objCancel_NOVA_ENTRA.isClosed()) {
                ...
                jPainelCRC.add(objCancel_NOVA_ENTRA);
                ...
                if (objCancel_NOVA_ENTRA.isVisible()) {
                    ...
                    objCancel_NOVA_ENTRA = new TelaCancelRegistroPortaria_NOVA_ENTRADA();
                    TelaModuloCRC.jPainelCRC.add(objCancel_NOVA_ENTRA);//adicona frame ao JDesktopPane  
                    objCancel_NOVA_ENTRA.setVisible(true);
                }
            }
            try {
    ...
    private void jCancelarRegistro_RETORNOSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCancelarRegistro_RETORNOSActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaCancelamentoRetornosManu_CRC) && codAbrirCRC == 1) {
            if (objCancel_RETORNOS == null || objCancel_RETORNOS.isClosed()) {
                objCancel_RETORNOS = new TelaCancelRegistroPortaria_RETORNOS();
                jPainelCRC.add(objCancel_RETORNOS);
                ...
                if (objCancel_RETORNOS.isVisible()) {
                    ...
                    objCancel_RETORNOS = new TelaCancelRegistroPortaria_RETORNOS();
                    TelaModuloCRC.jPainelCRC.add(objCancel_RETORNOS);//adicona frame ao JDesktopPane  
                    objCancel_RETORNOS.setVisible(true);
                }
            }
            try {
    ...
    private void jCancelamentoEvasaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCancelamentoEvasaoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaCancelamentoEvasao_CRC);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaCancelamentoEvasao_CRC) && codAbrirCRC == 1) {
            if (objCancelaEvasao == null || objCancelaEvasao.isClosed()) {
                objCancelaEvasao = new TelaCancelamentoEvasao();
                jPainelCRC.add(objCancelaEvasao);
                objCancelaEvasao.setVisible(true);
            } else {
                if (objCancelaEvasao.isVisible()) {
                    if (objCancelaEvasao.isIcon()) { // Se esta minimizado
                        try {
                            objCancelaEvasao.setIcon(false); // maximiniza
                        } catch (PropertyVetoException ex) {
                        }
                    } else {
                        objCancelaEvasao.toFront(); // traz para frente
                        objCancelaEvasao.pack();//volta frame 
                    }
                } else {
                    objCancelaEvasao = new TelaCancelamentoEvasao();
                    TelaModuloCRC.jPainelCRC.add(objCancelaEvasao);//adicona frame ao JDesktopPane  
                    objCancelaEvasao.setVisible(true);
                }
            }
            try {
                objCancelaEvasao.setSelected(true);
            } catch (java.beans.PropertyVetoException e) {
            }
        } else {
            JOptionPane.showMessageDialog(null, "Acesso não autorizado, solicite liberação ao administrador.");
    ...
    private javax.swing.JMenuItem jCancelamentoEvasao;
...
// Calculadora do Windows
    ...
    public void pesquisarTelasAcessos() {
        ...
        if (!pNomeCPEI.equals(telaCancelamentoPrimeiraEntradaInte_CRC) || pNomeCPEI == null || pNomeCPEI.equals("")) {
            buscarCodigoModulo();
            objCadastroTela.setIdModulo(pCodModulo);
            objCadastroTela.setNomeTela(telaCancelamentoPrimeiraEntradaInte_CRC);
            controle.incluirTelaAcesso(objCadastroTela);
        }
        //CANCELAMENTO RETORNO
        if (!pNomeCPEM.equals(telaCancelamentoRetornosManu_CRC) || pNomeCPEM == null || pNomeCPEM.equals("")) {
            buscarCodigoModulo();
            objCadastroTela.setIdModulo(pCodModulo);
            objCadastroTela.setNomeTela(telaCancelamentoRetornosManu_CRC);
            controle.incluirTelaAcesso(objCadastroTela);
        }
        if (!pNomeCPEI.equals(telaCancelamentoRetornosInte_CRC) || pNomeCPEI == null || pNomeCPEI.equals("")) {
            buscarCodigoModulo();
            objCadastroTela.setIdModulo(pCodModulo);
        ...
        if (!pNomeCRI.equals(telaMudancaRegimeProIntCRC) || pNomeCRI == null || pNomeCRI.equals("")) {
            buscarCodigoModulo();
            objCadastroTela.setIdModulo(pCodModulo);
        ...
        if (!pNomePSTPM.equals(telaProrrogracaoSaidaTMPPDManu_CRC) || pNomePSTPM == null || pNomePSTPM.equals("")) {
            buscarCodigoModulo();
            objCadastroTela.setIdModulo(pCodModulo);
            objCadastroTela.setNomeTela(telaProrrogracaoSaidaTMPPDManu_CRC);
            controle.incluirTelaAcesso(objCadastroTela);
        }
        if (!pNomePSTPI.equals(telaProrrogracaoSaidaTMPPDInt_CRC) || pNomePSTPI == null || pNomePSTPI.equals("")) {
            buscarCodigoModulo();
            objCadastroTela.setIdModulo(pCodModulo);
        ...
        //CANCELAMENTO DE EVASÃO
        if (!pNomeCEI.equals(telaCancelamentoEvasao_CRC) || pNomeCEI == null || pNomeCEI.equals("")) {
            buscarCodigoModulo();
            objCadastroTela.setIdModulo(pCodModulo);
            objCadastroTela.setNomeTela(telaCancelamentoEvasao_CRC);
            controle.incluirTelaAcesso(objCadastroTela);
        }
    }
