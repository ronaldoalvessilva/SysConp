 ...
 * @author user
 */
public class TelaBuscarInternosListaPassagemAlbergados extends javax.swing.JInternalFrame {
    ...
    String caminho;
    String idInt;
    String regimePenal = "Aberto";

    /**
     * Creates new form TelaPesqColaborador
     */
    public TelaBuscarInternosListaPassagemAlbergados() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTabelaPesqInternos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome do Interno", "Situação", "Regime Penal"
            }
        ));
...
//Preencher tabela com todos os VISITANTES
    public void buscarInternos(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Nome do Interno", "Situação", "Regime Penal"};
        conecta.abrirConexao();
        try {
            conecta.executaSQL(sql);
            conecta.rs.first();
            do {
                dados.add(new Object[]{conecta.rs.getInt("IdInternoCrc"), conecta.rs.getString("NomeInternoCrc"), conecta.rs.getString("SituacaoCrc"), conecta.rs.getString("Regime")});
