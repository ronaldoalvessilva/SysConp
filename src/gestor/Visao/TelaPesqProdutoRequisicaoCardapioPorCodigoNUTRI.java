 ...
 * @author user
 */
public class TelaPesqProdutoRequisicaoCardapioPorCodigoNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoRequisicaoCardapioPorCodigoNUTRI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Produtos no Cardápio {NUTRI} :::...");
    ...
    private void jCheckBoxPesqTodosProdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosProdItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "ON PRODUTOS_AC.IdProd=LOTE_PRODUTOS_AC.IdProd "
                    + "WHERE PRODUTOS_NUTRI.StatusProd='" + statusProd + "'AND Qtd!='" + 0 + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        } else {
            limparTabela();
        }
