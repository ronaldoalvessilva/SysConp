...
import gestor.Controle.ControleEstornoRequisicaoFAR;
import gestor.Controle.ControleHistoricoMovimentacaoFAR;
import gestor.Controle.ControleItensEstornoMateriaisFAR;
 ...
 * @author Ronaldo
 */
public class TelaEstornoRequisicaoMateriaisFAR extends javax.swing.JInternalFrame {
    ...
    ControleEstornoRequisicaoFAR control = new ControleEstornoRequisicaoFAR();
    ControleItensEstornoMateriaisFAR controle = new ControleItensEstornoMateriaisFAR();
    //    
    ...
    String nomeModuloTela = "Farmácia:Estorno Transferência/Requisição de Materiais:Manutenção";
    String nomeModuloTela2 = "Farmácia:Estorno Transferência/Requisição de Materiais:Itens";
    //
    int flag;
    int acao;
    ...
    public static float qtdItemEstorno = 0; // SALDO PESQUISADO PARA COMPARAR COM O NOVO A ESTORNAR.
    int codProd;
    int codEstoque;
    float saldoEstoque;
    ...
    String nomeOperacao = "Estorno Transferência de Produtos Farmácia";
    String nomeOperacao1 = "Estorno Requisição Avulsa de Produtos";
    double qtdEstoque = 0;
     ...
     */
    public TelaEstornoRequisicaoMateriaisFAR() {
        initComponents();
        formatarCampos();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        jRadioBtTransferencias = new javax.swing.JRadioButton();
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Estorno de Transferência/Requisição de Materiais :::...");
        ...
        jStatusEst.setForeground(new java.awt.Color(153, 0, 153));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(jIdDoc, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        BGTipoEstorno.add(jRadioBtTransferencias);
        jRadioBtTransferencias.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jRadioBtTransferencias.setForeground(new java.awt.Color(0, 153, 0));
        jRadioBtTransferencias.setSelected(true);
        jRadioBtTransferencias.setText("Transferências");
        jRadioBtTransferencias.setEnabled(false);

        BGTipoEstorno.add(jRadioBtReqAvulsa);
        jRadioBtReqAvulsa.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jRadioBtReqAvulsa.setForeground(new java.awt.Color(255, 0, 0));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGap(90, 90, 90)
                .addComponent(jRadioBtTransferencias)
                .addGap(18, 18, 18)
    ...
    private void jCodigoBarrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCodigoBarrasActionPerformed
        ...
        conecta.executaSQL("SELECT * FROM PRODUTOS_AC "
                ...
                + "ON PRODUTOS.IdLocal=LOCAL_ARMAZENAMENTO_AC.IdLocal "
                + "INNER JOIN LOTE_PRODUTOS_AC "
                + "ON PRODUTOS_AC.IdProd=LOTE_PRODUTOS_AC.IdProd "
                + "WHERE PRODUTOS_AC.CodigoBarra='" + jCodigoBarras.getText() + "'AND PRODUTOS_AC.StatusProd='" + statusProd + "'PRODUTOS_AC.Modelo='" + modulo + "'");
        try {
            if (conecta.rs.first()) {
    ...
    private void jBtPesqProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqProdutoActionPerformed
        // TODO add your handling code here:  
        if (jRadioBtTransferencias.isSelected()) { // TABELA DE ITENS_TRANSFERENCIA_PRODUTOS_FAR
            TelaPesqProdutoEstornoTransferencias objPesqProdEstTrans = new TelaPesqProdutoEstornoTransferencias();
            TelaModuloFarmacia.jPainelFarmacia.add(objPesqProdEstTrans);
            objPesqProdEstTrans.show();
        } else if (jRadioBtReqAvulsa.isSelected()) {
            TelaPesqProdutoEstornoRequisicaoAvulsaMateriaisFAR objPesqEstProdMatAvulsoFAR = new TelaPesqProdutoEstornoRequisicaoAvulsaMateriaisFAR();
            TelaModuloFarmacia.jPainelFarmacia.add(objPesqEstProdMatAvulsoFAR);
            objPesqEstProdMatAvulsoFAR.show();
        }
...
//        // TODO add your handling code here:
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM ITENS_ESTORNO_PRODUTOS_FAR "
                        + "INNER JOIN PRODUTOS_AC "
                        + "ON ITENS_ESTORNO_PRODUTOS_FAR.IdProd=PRODUTOS_AC.IdProd "
                        + "INNER JOIN LOTE_PRODUTOS_AC "
                        + "ON PRODUTOS_AC.IdProd=LOTE_PRODUTOS_AC.IdProd "
                        + "WHERE ITENS_ESTORNO_PRODUTOS_FAR.IdEst='" + jIdEst.getText() + "'AND "
                        + "PRODUTOS_AC.DescricaoProd='" + jDescricaoProduto.getText() + "'AND ITENS_ESTORNO_PRODUTOS_FAR.IdItem='" + idItem + "'");
                conecta.rs.first();
    ...
    private void jBtPesqCodigoReqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoReqActionPerformed
        ...
        if (jIdEst.getText().equals("")) {
            ...
            pesquisarRequisicaoMateriais("SELECT * FROM ESTORNO_PRODUTOS_FAR "
    ...
    private void jCheckBoxTodosReqItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosReqItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            jTabelaRequisicoes.setVisible(true);
            this.pesquisarRequisicaoMateriais("SELECT * FROM ESTORNO_PRODUTOS_FAR ");
        } else {
    ...
    private void jTabelaRequisicoesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaRequisicoesMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM ESTORNO_PRODUTOS_FAR "
                        + "WHERE IdEst='" + IdLanc + "'");
                conecta.rs.first();
    ...
    private void jBtPesqRequisicaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqRequisicaoActionPerformed
        ...
        if (jRadioBtTransferencias.isSelected()) {
            TelaPesqRequisicaoMateriaisFAR objPesqReqMatFAR = new TelaPesqRequisicaoMateriaisFAR();
            TelaModuloFarmacia.jPainelFarmacia.add(objPesqReqMatFAR);
            objPesqReqMatFAR.show();
        } else if (jRadioBtReqAvulsa.isSelected()) {
            TelaPesqRequisicaoAvulsaMateriaisFAR objPeqReqAvulsaFAR = new TelaPesqRequisicaoAvulsaMateriaisFAR();
            TelaModuloFarmacia.jPainelFarmacia.add(objPeqReqAvulsaFAR);
            objPeqReqAvulsaFAR.show();
        }
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaEstornoRequisicaoAvulsa objAudiEstAvulsa = new TelaAuditoriaEstornoRequisicaoAvulsa();
        TelaModuloAlmoxarifado.jPainelAlmoxarifado.add(objAudiEstAvulsa);
        objAudiEstAvulsa.show();
    ...
    private void jBtAuditoriaItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaItemActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensEstorno objAudiItensEsto = new TelaAuditoriaItensEstorno();
        TelaModuloAlmoxarifado.jPainelAlmoxarifado.add(objAudiItensEsto);
        objAudiItensEsto.show();
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ESTORNO_PRODUTOS_FAR WHERE IdEst='" + jIdEst.getText() + "'");
            conecta.rs.first();
            jStatusEst.setText(conecta.rs.getString("StatusEst"));
            if (jStatusEst.getText().equals("FINALIZADO")) {
    ...
    private javax.swing.JRadioButton jRadioBtTransferencias;
    ...
    public void Novo() {
        ...
        jRadioBtTransferencias.setEnabled(true);
    ...
    public void Finalizar() {
        ...
        if (rows == 0) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                control.finalizarEstornoMaterialFAR(objEstoReq);
    ...
    public void buscarProdutoLoteEnfermaria() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM LOTE_PRODUTOS_ENF WHERE IdProd='" + jCodProduto.getText() + "'AND IdLanc='" + jIdDoc.getText() + "'AND Lote='" + jLote.getText() + "'");
            conecta.rs.first();
            qtdItemLote = conecta.rs.getFloat("Qtd");
        } catch (Exception e) {
        }
    }

    public void buscarProdutoLoteFarmacia() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM LOTE_PRODUTOS_AC WHERE IdProd='" + jCodProduto.getText() + "'AND IdLanc='" + jIdDoc.getText() + "'AND Lote='" + jLote.getText() + "'");
            conecta.rs.first();
            qtdItemLote = conecta.rs.getFloat("Qtd");
        } catch (Exception e) {
        }
    ...
    public void lancarHistorico() {
        ...
        for (int i = 0; i < jTabelaItensRequisicao.getRowCount(); i++) {
            ...
            objHistMovAC.setIdDoc(Integer.valueOf(jIdDoc.getText()));
            ...
            if (jRadioBtTransferencias.isSelected()) {
                ...
                objHistMovAC.setNomeOperacao(nomeOperacao1);
            }
            buscarQtdItemEstorno();
            ...
            controlHistAC.incluirHistoricoProdutoFAR(objHistMovAC); // SALVAR NA TABELA HISTORICO_MOVIMENTACAO_ESTOQUE_FAR
        }
    }
    ...
    public void buscarQtdItemEstorno() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENS_ESTORNO_PRODUTOS_FAR WHERE IdProd='" + objHistMovAC.getIdProd() + "'");
            conecta.rs.first();
    ...
    public void verificarItensRequisitados() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM ITENS_ESTORNO_PRODUTOS_FAR "
                    + "WHERE IdEst='" + objEstoReq.getIdEstorno() + "'");
            conecta.rs.first();
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                objEstoReq.setIdEstorno(Integer.parseInt(jIdEst.getText()));
                control.excluirEstornoMaterialFAR(objEstoReq);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                Excluir();
    ...
    public void buscarQuantidadeRequisitadaAvulsa() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR "
                    + "WHERE IdReq='" + jIdDoc.getText() + "' "
                    + "AND IdProd='" + jCodProduto.getText() + "'");
            conecta.rs.first();
            qtdItemEstorno = conecta.rs.getFloat("QtdItem");
        } catch (Exception e) {
        }
    ...
    public void buscarQuantidadeTransferidaEnfermaria() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENS_TRANSFERENCIA_PRODUTO_FAR "
                    + "WHERE IdLanc='" + jIdDoc.getText() + "' "
                    + "AND IdProd='" + jCodProduto.getText() + "'");
            conecta.rs.first();
            qtdItemEstorno = conecta.rs.getFloat("QtdItem");
        } catch (Exception e) {
    ...
    public void preencherTabelaItens(String sql) {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Item", "Código", "Descrição do Produto", "Qtd.", "Vl. Item"};
        conecta.abrirConexao();
        try {
            conecta.executaSQL(sql);
            conecta.rs.first();
        ...
        alinharCamposTelaProdutos();
        conecta.desconecta();
    }

    public void alinharCamposTelaProdutos() {
        DefaultTableCellRenderer esquerda = new DefaultTableCellRenderer();
        DefaultTableCellRenderer centralizado = new DefaultTableCellRenderer();
        DefaultTableCellRenderer direita = new DefaultTableCellRenderer();
        esquerda.setHorizontalAlignment(SwingConstants.LEFT);
        ...
        jTabelaItensRequisicao.getColumnModel().getColumn(3).setCellRenderer(centralizado);
