 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAtendimentoTecEnfermeira extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAtendimentoTecEnfermeira() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Atendimento Técnico Enfermagem :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATENDIMENTOTECENFERMAGEM WHERE IdLanc='" + jIdLanc.getText() + "'");
            conecta.rs.first();
