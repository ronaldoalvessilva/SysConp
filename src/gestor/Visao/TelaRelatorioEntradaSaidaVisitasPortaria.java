 ...
 * @author ronaldo
 */
public class TelaRelatorioEntradaSaidaVisitasPortaria extends javax.swing.JInternalFrame {
     ...
     */
    public TelaRelatorioEntradaSaidaVisitasPortaria() {
        initComponents();
        preencherComboDepto();
    }
                ...
                if (jPesDtPopInicial.getDate().after(jPesDtPopFinal.getDate())) {
                    ...
                    try {
                        ...
                        conecta.executaSQL("SELECT * FROM ITENSVISITASDIVERSAS "
                                ...
                                + "WHERE ITENSVISITASDIVERSAS.IdDepartamento='" + jCodigoDepto.getText() + "'AND DataEntrada>='" + dataInicial + "' AND DataEntrada<='" + dataFinal + "'ORDER BY ITENSVISITASDIVERSAS.DataEntrada");
                        HashMap parametros = new HashMap();
                        parametros.put("idDepartamento", codigoDepto);
