 ...
 * @author Ronaldo
 */
public class TelaAuditoriaPAI_Evolucao_PSI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaPAI_Evolucao_PSI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM EVOLUCAO_PAI_NOVO WHERE IdPai='" + jCodigoPAI.getText() + "'");
            conecta.rs.first();
