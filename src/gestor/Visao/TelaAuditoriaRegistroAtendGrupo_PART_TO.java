 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_PART_TO extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_PART_TO() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_TO "
                    + "WHERE IdItemPlanTO='" + pCODIGO_ITEM_PARTICIPANTE + "' "
