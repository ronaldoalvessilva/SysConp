...
import static gestor.Visao.TelaAtendimentoFamiliarJuridico.jIDAtendf;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAtendimentoFamiliarJuridico extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAtendimentoFamiliarJuridico() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Atendimento de Familiar {JU} :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATENDIMENTOFAMILIARJURIDICO WHERE IdAtendf='" + jIDAtendf.getText() + "'");
            conecta.rs.first();
