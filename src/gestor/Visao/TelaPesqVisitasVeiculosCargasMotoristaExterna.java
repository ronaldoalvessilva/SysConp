...
import gestor.Dao.*;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.FotoMotoristaCarga;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jIdMotorista;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jNomeMotorista;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jRGMotorista;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jCPFMotorista;
 ...
 * @author user
 */
public class TelaPesqVisitasVeiculosCargasMotoristaExterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqVisitasVeiculosCargasMotoristaExterna() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (jTabelaPesqVisitasDiversas.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaPesqVisitasDiversas.getColumnModel().getColumn(1).setMinWidth(380);
            jTabelaPesqVisitasDiversas.getColumnModel().getColumn(1).setMaxWidth(380);
        }
...
//Preencher tabela com todos os COLABORADORES
    public void buscarVisitas(String sql) {
        ...
        jTabelaPesqVisitasDiversas.getColumnModel().getColumn(1).setPreferredWidth(380);
