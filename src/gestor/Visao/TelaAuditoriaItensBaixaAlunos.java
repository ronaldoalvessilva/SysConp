...
import static gestor.Visao.TelaBaixaAlunos.jIdLanc;
import static gestor.Visao.TelaBaixaAlunos.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensBaixaAlunos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensBaixaAlunos() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSBAIXAINTERNOS WHERE IdLanc='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
