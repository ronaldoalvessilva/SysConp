...
import static gestor.Visao.TelaMovHistoricoTecMedico.jDataNascimento;
import static gestor.Visao.TelaMovHistoricoTecMedico.jDataPena;
import static gestor.Visao.TelaMovHistoricoTecMedico.jFotoInterno;
import static gestor.Visao.TelaMovHistoricoTecMedico.jIdInterno;
import static gestor.Visao.TelaMovHistoricoTecMedico.jMatriculaPenalInterno;
import static gestor.Visao.TelaMovHistoricoTecMedico.jNomeInterno;
import static gestor.Visao.TelaMovHistoricoTecMedico.jRegime;
import static gestor.Visao.TelaMovHistoricoTecMedico.jTabelaMovimentacaoMedico;
import static gestor.Visao.TelaMovHistoricoTecMedico.jUnidadePenal;
 ...
 * @author Ronaldo
 */
public class TelaPesqMovIntTecnicoMedico extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqMovIntTecnicoMedico() {
        initComponents();
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTabelaNome("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "WHERE NomeInternoCrc LIKE  '" + jPesqNome.getText() + "%' AND SituacaoCrc='" + situacaoEnt + "' OR NomeInternoCrc LIKE'" + jPesqNome.getText() + "%' AND SituacaoCrc='" + situacaoRet + "'");
        }
    ...
    private void jBtMatriculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtMatriculaActionPerformed
        ...
        if (jPesqMatricula.getText().equals("")) {
            ...
            buscarInternosMatricula("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "INNER JOIN UNIDADE "
                    + "ON DADOSPENAISINTERNOS.IdUnid=UNIDADE.IdUnid "
                    + "WHERE MatriculaCrc LIKE'" + jPesqMatricula.getText() + "%'AND SituacaoCrc='" + situacaoEnt + "' OR MatriculaCrc LIKE'" + jPesqMatricula.getText() + "'AND SituacaoCrc='" + situacaoRet + "'");
        }
  ...
  // Método de pesquisa pela Descrição
   ...
   public void preencherTabelaNome(String sql) {
    ...
    public void alinhaCamposTabelaInternos() {
    ...
    public void preencherTabelaItens(String sql) {
        ...
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaMovimentacaoMedico.setModel(modelo);
        jTabelaMovimentacaoMedico.getColumnModel().getColumn(0).setPreferredWidth(70);
        jTabelaMovimentacaoMedico.getColumnModel().getColumn(0).setResizable(false);
        jTabelaMovimentacaoMedico.getColumnModel().getColumn(1).setPreferredWidth(80);
        jTabelaMovimentacaoMedico.getColumnModel().getColumn(1).setResizable(false);
        jTabelaMovimentacaoMedico.getColumnModel().getColumn(2).setPreferredWidth(80);
        jTabelaMovimentacaoMedico.getColumnModel().getColumn(2).setResizable(false);
        jTabelaMovimentacaoMedico.getColumnModel().getColumn(3).setPreferredWidth(360);
        jTabelaMovimentacaoMedico.getColumnModel().getColumn(3).setResizable(false);
        jTabelaMovimentacaoMedico.getColumnModel().getColumn(4).setPreferredWidth(200);
        jTabelaMovimentacaoMedico.getColumnModel().getColumn(4).setResizable(false);
        jTabelaMovimentacaoMedico.getTableHeader().setReorderingAllowed(false);
        jTabelaMovimentacaoMedico.setAutoResizeMode(jTabelaMovimentacaoMedico.AUTO_RESIZE_OFF);
        jTabelaMovimentacaoMedico.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
    ...
    public void alinharCamposTabelaMovimentacao() {
        ...
        direita.setHorizontalAlignment(SwingConstants.RIGHT);
        //
        jTabelaMovimentacaoMedico.getColumnModel().getColumn(0).setCellRenderer(centralizado);
        jTabelaMovimentacaoMedico.getColumnModel().getColumn(1).setCellRenderer(centralizado);
        jTabelaMovimentacaoMedico.getColumnModel().getColumn(2).setCellRenderer(centralizado);
    }
}
