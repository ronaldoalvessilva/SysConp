 ...
 * @author ronaldo
 */
public class TelaFotoLocacaoInterno extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaLocacaoInterno telaLocacaoInterno;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoLocacaoInterno(TelaLocacaoInterno parent, boolean modal) {
        this.telaLocacaoInterno = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaLocacaoInterno);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoLocacaoInterno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoLocacaoInterno dialog = new TelaFotoLocacaoInterno(telaLocacaoInterno, true);
