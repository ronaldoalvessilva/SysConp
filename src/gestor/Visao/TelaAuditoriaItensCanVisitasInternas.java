...
import static gestor.Visao.TelaCancelamentoVisitasInterno.idItemInt;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensCanVisitasInternas extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensCanVisitasInternas() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_CANCELAMENTO_VISITAS_INTERNA_ROL WHERE IdCan='" + jIdCan.getText() + "'AND IdItemCanInt='" + idItemInt + "'");
            conecta.rs.first();
