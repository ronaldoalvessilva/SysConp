...
import static gestor.Visao.TelaLocalArmazenamentoNUTRI.jIDLocal;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaLocalArmazenamentoNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaLocalArmazenamentoNUTRI() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Local Armazenamento ::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM LOCAL_ARMAZENAMENTO_NUTRI WHERE IdLocal='" +jIDLocal.getText() + "'");
            conecta.rs.first();
