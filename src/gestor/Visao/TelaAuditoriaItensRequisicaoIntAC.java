...
import static gestor.Visao.TelaRequisicaoMateriaisInternosAC.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRequisicaoIntAC extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRequisicaoIntAC() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_PRODUTOS_INTERNOS WHERE IdReq='" + jCodReq.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
