...
import static gestor.Visao.TelaFichaJuridica.jBtZoonFotoInterno;
import static gestor.Visao.TelaFichaJuridica.jIdInternoFicha;
import static gestor.Visao.TelaFichaJuridica.jMatriculaPenal;
import static gestor.Visao.TelaFichaJuridica.jNomeInterno;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaInternoFichaJuridico extends javax.swing.JInternalFrame {
    ...
    String dataEntrada;
    String codInt;
    String entrada = "ENTRADA NA UNIDADE";
    String retorno = "RETORNO A UNIDADE";

    /**
     * Creates new form TelaPesquisaEntradaInternos
     */
    public TelaPesquisaInternoFichaJuridico() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 0, 0))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(jPesqNome, javax.swing.GroupLayout.PREFERRED_SIZE, 262, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                        + "INNER JOIN DADOSPENAISINTERNOS "
                        + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
                        + "WHERE PRONTUARIOSCRC.NomeInternoCrc='" + nomeInterno + "'AND PRONTUARIOSCRC.IdInternoCrc='" + codInt + "'");
                conecta.rs.first();
                jIdInternoFicha.setText(String.valueOf(conecta.rs.getInt("IdInternoCrc")));
    ...
    public void preencherTabelaNome(String sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getString("IdInternoCrc"), conecta.rs.getString("NomeInternoCrc"), dataEntrada});
