...
import static gestor.Visao.TelaRegistroObjetosProcedimentos.IdApoio;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaProcedimentoApoio extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaProcedimentoApoio() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Apoio/Procedimento :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM APOIOPROCEDIMENTO WHERE IdProc='" + jIdLanc.getText() + "'AND IdApoio='" + IdApoio + "'");
            conecta.rs.first();
