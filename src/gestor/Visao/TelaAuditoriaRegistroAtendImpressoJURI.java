...
import static gestor.Visao.TelaRegistroInternosAtendimentoImpressoJURI.jIdRegistro;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendImpressoJURI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendImpressoJURI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM REGISTRO_ATENDIMENTO_INTERNO_PSP WHERE IdRegistro='" + jIdRegistro.getText() + "'");
            conecta.rs.first();
