 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAtividadesRealizadasItensJu extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    /**
     * Creates new form TelaAuditoriaRolInternas
     */
    public TelaAuditoriaAtividadesRealizadasItensJu() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Atividades Realizadas :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSATENDIMENTOJURI WHERE IdItem='" + jIdAtiv.getText() + "'");
            conecta.rs.first();
