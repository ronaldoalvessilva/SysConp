...
import static gestor.Visao.TelaEntradaProdutos.jDescricaoProduto;
import static gestor.Visao.TelaEntradaProdutos.jIdProd;
import static gestor.Visao.TelaEntradaProdutos.jCodigoBarras;
import static gestor.Visao.TelaEntradaProdutos.jLote;
import static gestor.Visao.TelaEntradaProdutos.jReferencia;
import static gestor.Visao.TelaEntradaProdutos.jUnidade;
 ...
 * @author user
 */
public class TelaPesqProdutoComprasFAR extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoComprasFAR() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabelaProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Códigol", "Descrição Produto", "Lote", "Local de Armazenamento"
            }
        ));
        ...
        if (jTabelaProdutos.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaProdutos.getColumnModel().getColumn(3).setMinWidth(160);
            jTabelaProdutos.getColumnModel().getColumn(3).setMaxWidth(160);
        }
        ...
        if (jPesqDescricaoProdutos.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRODUTOS_AC "
                        ...
                        + "INNER JOIN LOTE_PRODUTOS_AC "
                        + "ON PRODUTOS_AC.IdProd=LOTE_PRODUTOS_AC.IdProd "
                        + "WHERE PRODUTOS_AC.DescricaoProd='" + jPesqDescricaoProdutos.getText() + "'AND PRODUTOS_AC.StatusProd='" + statusProd + "'AND PRODUTOS_AC.IdProd='" + idInt + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
                conecta.rs.first();
                ...
                // jLote.setText(conecta.rs.getString("Lote")); RETIRADO, POIS ESTAVA DANDO ENTRADA COM O MESMO LOTE
    ...
    public void preencherTabelaProdutos(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Descrição Produto", "Lote", "Local de Armazenamento"};
        conecta.abrirConexao();
        ...
        jTabelaProdutos.getColumnModel().getColumn(3).setPreferredWidth(160);
