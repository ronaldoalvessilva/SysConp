 ...
 * @author Ronaldo
 */
public class TelaPesquisaVistaDiversaslAtestadoRecluso extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaVistaDiversaslAtestadoRecluso() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabelaVisitasDiversas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome da Visita", "Registro", "Data Cadastro"
            }
        ));
        ...
        if (jTabelaVisitasDiversas.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaVisitasDiversas.getColumnModel().getColumn(1).setMinWidth(290);
            jTabelaVisitasDiversas.getColumnModel().getColumn(1).setMaxWidth(290);
            jTabelaVisitasDiversas.getColumnModel().getColumn(2).setMinWidth(140);
            jTabelaVisitasDiversas.getColumnModel().getColumn(2).setMaxWidth(140);
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            jTabelaVisitasDiversas.setVisible(true);
            preencherTabelaVisitas("SELECT * VISITASDIVERSAS "                    
    ...
    private void jTabelaVisitasDiversasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaVisitasDiversasMouseClicked
        ...
        if (flag == 1) {
            ...
            idVistaInt = "" + jTabelaVisitasDiversas.getValueAt(jTabelaVisitasDiversas.getSelectedRow(), 0);
        }
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaVisitas("SELECT * FROM VISITASDIVERSAS");
        } else {
            limparTabelaVisitas();
        }
  ...
  // Método de pesquisa pela Descrição
    ...
    public void preencherTabelaVisitas(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Nome da Visita", "Registro", "Data Cadastro"};
        conecta.abrirConexao();
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdVisita"), conecta.rs.getString("NomeVisita"), conecta.rs.getString("RgVisita"), dataCadastro});
        ...
        jTabelaVisitasDiversas.getColumnModel().getColumn(1).setPreferredWidth(290);
        jTabelaVisitasDiversas.getColumnModel().getColumn(1).setResizable(false);
        jTabelaVisitasDiversas.getColumnModel().getColumn(2).setPreferredWidth(140);
