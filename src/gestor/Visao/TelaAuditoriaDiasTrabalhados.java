 ...
 * @author Ronaldo
 */
public class TelaAuditoriaDiasTrabalhados extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaDiasTrabalhados() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Dias Trabalhados :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM FREQUENCIA_LABORATIVA_EXTERNA WHERE IdFreqLab='" + jIdFrequencia.getText() + "'");
            conecta.rs.first();
