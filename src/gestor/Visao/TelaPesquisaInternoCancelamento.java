...
import static gestor.Visao.TelaCancelamentoVisitasInterno.jCela;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jCodigoRol;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jFotoInterno;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jIDInterno;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jNomeInterno;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jMaeInterno;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jMatriculaPenal;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jRegimePenal;
import static gestor.Visao.TelaCancelamentoVisitasInterno.jPavilhao;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaInternoCancelamento extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaInternoCancelamento() {
        initComponents();
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTabelaNome("SELECT * FROM ROLVISITAS "
                    ...
                    + "ON ROLVISITAS.IdInternoCrc=ITENSLOCACAOINTERNO.IdInternoCrc "
                    + "INNER JOIN CELAS "
    ...
    private void jBtMatriculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtMatriculaActionPerformed
        ...
        if (jPesqMatricula.getText().equals("")) {
            ...
            buscarInternosMatricula("SELECT * FROM ROLVISITAS "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ROLVISITAS.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM ROLVISITAS "
                        ...
                        + "INNER JOIN PAVILHAO "
                        + "ON CELAS.IdPav=PAVILHAO.IdPav "                       
                        + "WHERE ROLVISITAS.IdInternoCrc='" + idInt + "'");
                conecta.rs.first();
                jCodigoRol.setText(conecta.rs.getString("IdRol"));
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTodosInternos("SELECT * FROM ROLVISITAS "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ROLVISITAS.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
