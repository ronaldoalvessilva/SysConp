...
import static gestor.Visao.TelaAtendimentoTerapiaOcupacional.codigoHistoricoProf;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaHistoricoProfissional extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();      
    /**
     * Creates new form TelaAuditoriaRolInternas
     */
    public TelaAuditoriaHistoricoProfissional() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Histórico Profissional :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM TO_HISTORICO_PROFISSIONAL WHERE IdHistoricoLab='" + codigoHistoricoProf + "'");
            conecta.rs.first();
