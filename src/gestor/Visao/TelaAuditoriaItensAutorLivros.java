...
import static gestor.Visao.TelaLivrosRevistasJornais.jIdLivro;
import static gestor.Visao.TelaLivrosRevistasJornais.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensAutorLivros extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensAutorLivros() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_AUTOR_LIVROS WHERE IdLivro='" + jIdLivro.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
