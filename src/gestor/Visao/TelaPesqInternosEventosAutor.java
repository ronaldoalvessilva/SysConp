...
import gestor.Dao.*;
import static gestor.Visao.TelaEventoDisciplinar.jFotoInternoAutor;
import static gestor.Visao.TelaEventoDisciplinar.jIdCela;
import static gestor.Visao.TelaEventoDisciplinar.jIdInternoAutor;
import static gestor.Visao.TelaEventoDisciplinar.jMatriculaPenalAutor;
 ...
 * @author user
 */
public class TelaPesqInternosEventosAutor extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternosEventosAutor() {
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            jIdInternoAutor.setText(idFunc);//           
            ...
            try {
                ...
                conecta.rs.first();
                jIdInternoAutor.setText(String.valueOf(conecta.rs.getInt("IdInternoCrc")));
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.buscarInternoVisitas("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "INNER JOIN CELAS "
                    + "ON ITENSLOCACAOINTERNO.IdCela=CELAS.IdCela "
                    + "WHERE CELAS.IdCela='" + jIdCela.getText() + "'");
        } else {
            limparTabela();
        }
