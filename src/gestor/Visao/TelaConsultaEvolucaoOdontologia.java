 ...
 * @author ronaldo
 */
public class TelaConsultaEvolucaoOdontologia extends javax.swing.JDialog {
     ...
     */
    public static TelaConsultaProntuarioInternoCrc telaProntuarioUnicoOD;

    public TelaConsultaEvolucaoOdontologia(TelaConsultaProntuarioInternoCrc parent, boolean modal) {
        this.telaProntuarioUnicoOD = parent;
        this.setModal(modal);
    ...
    private void initComponents() {
        ...
        setTitle("...::: Evoluções Odontologicas :::...");
        ...
        jTabelaDatasEvolucaoPsicologica.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Data", "Evolução Odontologia"
            }
        ));
        ...
        if (jDataInicial.getDate() == null) {
            ...
            if (jDataFinal.getDate() == null) {
                ...
                if (jDataInicial.getDate().after(jDataFinal.getDate())) {
                    ...
                    pesquisarData("SELECT * FROM ODONTOPROCEDIMENTO "
                            + "INNER JOIN PRONTUARIOSCRC "
                            + "ON ODONTOPROCEDIMENTO.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "                           
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaEvolucaoOdontologia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaConsultaEvolucaoOdontologia dialog = new TelaConsultaEvolucaoOdontologia(telaProntuarioUnicoOD, true);
    ...
    public void pesquisarData(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Data", "Evolução Odontologia"};
        conecta.abrirConexao();
        try {
            ...
            do {
                count = count + 1;
                dataMov = conecta.rs.getString("DataPro");
                String dia = dataMov.substring(8, 10);
                String mes = dataMov.substring(5, 7);
                String ano = dataMov.substring(0, 4);
                dataMov = dia + "/" + mes + "/" + ano;
                jtotalRegistros.setText(Integer.toString(count)); // Converter inteiro em string para exibir na tela
                dados.add(new Object[]{conecta.rs.getInt("IdPro"), dataMov, conecta.rs.getString("Procedimento")});
