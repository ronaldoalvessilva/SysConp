...
import static gestor.Visao.TelaAtendimentoGrupoPE.jIdInternoAI;
import static gestor.Visao.TelaAtendimentoGrupoPE.jNomeInternoAVI;
import static gestor.Visao.TelaAtendimentoGrupoPE.jFotoInternoGrupo;
import static gestor.Visao.TelaAtendimentoGrupoPE.jCNCAI;
import static gestor.Visao.TelaAtendimentoGrupoPE.jCodigoAtend;
import static gestor.Visao.TelaAtendimentoGrupoPE.jNomeMaeInternoAVI;
import static gestor.Visao.TelaAtendimentoGrupoPE.jRegimeAVI;
 ...
 * @author Ronaldo
 */
public class TelaPesqInternoAtendimentoGrupoAVI_PE extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoAtendimentoGrupoAVI_PE() {
        initComponents();
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTabelaNome("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_PE "
    ...
    private void jBtMatriculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtMatriculaActionPerformed
        ...
        if (jPesqMatricula.getText().equals("")) {
            ...
            buscarInternosMatricula("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_PE "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_PE.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTodosInternos("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_PE "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_PE.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
