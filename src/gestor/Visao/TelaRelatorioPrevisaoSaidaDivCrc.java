 ...
 * @author Ronaldo
 */
public class TelaRelatorioPrevisaoSaidaDivCrc extends javax.swing.JInternalFrame {
    ...
    String utilizacaoSaida = "Sim";

    /**
     * Creates new form TelaRelatorioPorIdade
     */
    public TelaRelatorioPrevisaoSaidaDivCrc() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Relatório Previsão de Saída de Internos Realizadas :::...");
            ...
            if (jDataPesFinal.getDate() == null) {
                ...
                if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                    ...
                    try {
                        ...
                        conecta.executaSQL("SELECT * FROM ITENSPREVISAOSAIDA INNER JOIN PRONTUARIOSCRC ON ITENSPREVISAOSAIDA.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc INNER JOIN DADOSPENAISINTERNOS ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc WHERE DataPrevSaida BETWEEN'" + dataInicial + "'AND'" + dataFinal + "'AND ConfirmaSaida='" + confirmaSaida + "'OR DataPrevSaida BETWEEN'" + dataInicial + "'AND'" + dataFinal + "'AND ConfirmaSaida='" + utilizacaoSaida + "'ORDER BY Beneficio,DataPrevSaida,NomeInternoCrc");
                        HashMap parametros = new HashMap();
                        parametros.put("dataInicial", dataInicial);
                        parametros.put("dataFinal", dataFinal);
                        parametros.put("confirmaSaida", confirmaSaida);
                        parametros.put("nomeUsuario", nameUser);
                        JRResultSetDataSource relatResul = new JRResultSetDataSource(conecta.rs); // Passa o resulSet Preenchido para o relatorio                                   
                        JasperPrint jpPrint = JasperFillManager.fillReport(path, parametros, relatResul); // indica o caminmhodo relatório
                        JasperViewer jv = new JasperViewer(jpPrint, false); // Cria instancia para impressao          
                        jv.setExtendedState(JasperViewer.MAXIMIZED_BOTH); // Maximizar o relatório
                        jv.setTitle("Relatório de Previsão de Saida de Internos por Período Não Realizadas");
