 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntradaSaidaVisitasRel extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();   
    /**
     * Creates new form TelaAuditoriaRolInternas
     */
    public TelaAuditoriaItensEntradaSaidaVisitasRel() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_ENTRADA_SAIDA_VISITAS_RELIGIOSA WHERE IdEntSaiVisita='" + jIDlanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
