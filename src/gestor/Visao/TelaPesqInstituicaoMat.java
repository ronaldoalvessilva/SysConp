...
import static gestor.Visao.TelaMatriculaPedagogica.jNomeInstituicao;
 ...
 * @author ronaldo
 */
public class TelaPesqInstituicaoMat extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Pesquisar Instituição :::...");
    ...
    private void jBtConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtConfirmarActionPerformed
        ...
        if (jPesqNomeInstituicao.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM INSTITUICAOESCOLAR WHERE NomeInstituicao LIKE'" + nomeInstituicao + "%'");
                conecta.rs.first();
    ...
    private void jBtPesqNomeInstituicaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeInstituicaoActionPerformed
        ...
        if (jPesqNomeInstituicao.getText().equals("")) {
            ...
            preencherTabelaInstituicao("SELECT * FROM INSTITUICAOESCOLAR WHERE NomeInstituicao LIKE'" + jPesqNomeInstituicao.getText() + "%'AND StatusInst='" + statusInst + "'");
        }
    ...
    private void jCheckBoxTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaInstituicao("SELECT * FROM INSTITUICAOESCOLAR WHERE StatusInst='" + statusInst + "'");
        } else {
            limparTabela();
        }
    ...
    public void preencherTabelaInstituicao(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Nome da Instituição"};
        conecta.abrirConexao();
        try {
