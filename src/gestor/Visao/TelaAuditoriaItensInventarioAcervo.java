...
import static gestor.Visao.TelaInventarioLivrosAcervo.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensInventarioAcervo extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensInventarioAcervo() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Itens Inventário :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_INVENTARIO_ACERVO WHERE IdLanc='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
