...
import gestor.Controle.ControleEmprestimoAcervo;
import gestor.Controle.ControleEstoqueAcervoEmprestimo;
import gestor.Controle.ControleItensEmprestimoAcervo;
import gestor.Controle.ControleLogSistema;
import gestor.Controle.ControleUtilizaReserva;
...
import static gestor.Visao.TelaModuloPedagogia.telaEmprestimosManu_PEDA;
import static gestor.Visao.TelaModuloPedagogia.telaEmprestimosProd_PEDA;
 ...
 * @author ronaldo
 */
public class TelaEmprestimoAcervo extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    EmprestimoAcervo objEmprestimoAcervo = new EmprestimoAcervo();
    ControleEmprestimoAcervo control = new ControleEmprestimoAcervo();
    ItensEmprestimoAcervo objItensEmprestimo = new ItensEmprestimoAcervo();
    ControleItensEmprestimoAcervo controle = new ControleItensEmprestimoAcervo();
    ...
    ControleUtilizaReserva controleUtil = new ControleUtilizaReserva();
    //
    ControleLogSistema controlLog = new ControleLogSistema();
    LogSistema objLogSys = new LogSistema();
    // Variáveis para gravar o log
    String nomeModuloTela = "Acervo:Emprestimo de Acervo:Manutenção";
    String nomeModuloTela2 = "Acervo:Emprestimo de Acervo:Produtos";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
    ...
    String caminho;
    String utilizaReserva = "Sim";
    String utilizaDevolucao = "Não";
    String tipoMov = "E"; // EMPRESTIMO DO ACERVO
    ...
    /**
     * Creates new form TelaEmprestimoAcervo
     */
    public TelaEmprestimoAcervo() {
        initComponents();
        formatarCampos();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        jQtdReserva = new javax.swing.JTextField();
        ...
        if (jTabelaReservaAcervo.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaReservaAcervo.getColumnModel().getColumn(4).setMinWidth(120);
            jTabelaReservaAcervo.getColumnModel().getColumn(4).setMaxWidth(120);
        }
        ...
        jIdReserva.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jIdReserva.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jIdReserva, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(7, 7, 7)
        ...
        jLabel9.setText("Qtd. Reservada");

        jQtdReserva.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jQtdReserva.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jQtdReserva.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jQtdReserva.setEnabled(false);
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(jQtdReserva, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBtPesqInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqInternoActionPerformed
        ...
        TelaPesquisarInternoEmprestimoAcervo objPesqInteEmprestimo = new TelaPesquisarInternoEmprestimoAcervo();
        TelaModuloPedagogia.jPainelPedagogia.add(objPesqInteEmprestimo);
        objPesqInteEmprestimo.show();
    ...
    private void jBtPesqIdDocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqIdDocActionPerformed
        ...
        if (jIdPesqDoc.getText().equals("")) {
            ...
            pesquisarEmprestimoAcervo("SELECT * FROM EMPRESTIMO_ACERVO "
            ...
            if (jDataPesFinal.getDate() == null) {
                ...
                if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                    ...
                    pesquisarEmprestimoAcervo("SELECT * FROM EMPRESTIMO_ACERVO "
                            ...
                            + "INNER JOIN PAVILHAO "
                            + "ON CELAS.IdPav=PAVILHAO.IdPav "
                            + "WHERE DataEmp BETWEEN'" + dataInicial + "'AND '" + dataFinal + "'");
                }
            }
        }
    ...
    private void jCheckBoxTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarEmprestimoAcervo("SELECT * FROM EMPRESTIMO_ACERVO "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON EMPRESTIMO_ACERVO.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN LOCALINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=LOCALINTERNOS.IdInternoCrc "
    ...
    private void jTabelaReservaAcervoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaReservaAcervoMouseClicked
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM EMPRESTIMO_ACERVO "
                        + "INNER JOIN PRONTUARIOSCRC "
                        + "ON EMPRESTIMO_ACERVO.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                        + "INNER JOIN LOCALINTERNOS "
                        + "ON PRONTUARIOSCRC.IdInternoCrc=LOCALINTERNOS.IdInternoCrc "
                        ...
                        + "INNER JOIN PAVILHAO "
                        + "ON CELAS.IdPav=PAVILHAO.IdPav "
                        + "WHERE IdEmprestimo='" + IdLanc + "'");
                conecta.rs.first();
                jIdDoc.setText(String.valueOf(conecta.rs.getInt("IdEmprestimo")));
                jStatusDoc.setText(conecta.rs.getString("StatusLanc"));
                jDataDoc.setDate(conecta.rs.getDate("DataEmp"));
            ...
            count = 0;
            preencherTabelaItens("SELECT * FROM ITENS_EMPRESTIMO_ACERVO "
                    + "INNER JOIN LIVROS_REVISTAS_JORNAIS "
                    + "ON ITENS_EMPRESTIMO_ACERVO.IdLivro=LIVROS_REVISTAS_JORNAIS.IdLivro "
                    ...
                    + "WHERE ITENS_EMPRESTIMO_ACERVO.IdEmprestimo='" + IdLanc + "'");
        }
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaEmprestimosManu_PEDA) && codIncluirPEDA == 1) {
            count = 0;
            acao = 1;
            Novo();
            corCampos();
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEmprestimosManu_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaEmprestimosManu_PEDA) && codAlterarPEDA == 1) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEmprestimosManu_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaEmprestimosManu_PEDA) && codExcluirPEDA == 1) {
            objEmprestimoAcervo.setStatusLanc(jStatusDoc.getText());
            if (jStatusDoc.getText().equals("FINALIZADO")) {
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEmprestimosManu_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaEmprestimosManu_PEDA) && codGravarPEDA == 1) {
            if (jDataDoc.getDate() == null) {
                ...
                if (acao == 1) {
                    objEmprestimoAcervo.setUsuarioInsert(nameUser);
                    objEmprestimoAcervo.setDataInsert(dataModFinal);
                    objEmprestimoAcervo.setHorarioInsert(horaMov);
                    //
                    control.incluirEmprestimoAcervo(objEmprestimoAcervo);
                    buscarCodigo();
                    objLog();
                ...
                if (acao == 2) {
                    objEmprestimoAcervo.setUsuarioUp(nameUser);
                    objEmprestimoAcervo.setDataUp(dataModFinal);
                    objEmprestimoAcervo.setHorarioUp(horaMov);
                    //
                    objEmprestimoAcervo.setIdEmprestimo(Integer.valueOf(jIdDoc.getText()));
                    control.alterarEmprestimoAcervo(objEmprestimoAcervo);
                    objLog();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    Salvar();
                    JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaEmprestimoAcervo objAudiEmp = new TelaAuditoriaEmprestimoAcervo();
        TelaModuloPedagogia.jPainelPedagogia.add(objAudiEmp);
        objAudiEmp.show();
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM EMPRESTIMO_ACERVO WHERE IdEmprestimo='" + jIdDoc.getText() + "'");
            conecta.rs.first();
            objEmprestimoAcervo.setStatusLanc(jStatusDoc.getText());
            if (jStatusDoc.getText().equals("FINALIZADO")) {
    ...
    private void jBtPesqProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqProdutoActionPerformed
        // TODO add your handling code here:
        if (jIdReserva.getText().equals("")) {
            TelaPesqLivroAcervoEmprestimo objPesLivroEmp = new TelaPesqLivroAcervoEmprestimo();
            TelaModuloPedagogia.jPainelPedagogia.add(objPesLivroEmp);
            objPesLivroEmp.show();
        } else {
            TelaPesqLivroAcervoReservaEmprestimo objPesqLivroReservaEmp = new TelaPesqLivroAcervoReservaEmprestimo();
            TelaModuloPedagogia.jPainelPedagogia.add(objPesqLivroReservaEmp);
            objPesqLivroReservaEmp.show();
        }
    ...
    private void jTabelaProdutosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaProdutosMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM ITENS_EMPRESTIMO_ACERVO "
                        + "INNER JOIN LIVROS_REVISTAS_JORNAIS "
                        + "ON ITENS_EMPRESTIMO_ACERVO.IdLivro=LIVROS_REVISTAS_JORNAIS.IdLivro "
                        + "INNER JOIN EMPRESTIMO_ACERVO "
                        + "ON ITENS_EMPRESTIMO_ACERVO.IdEmprestimo=EMPRESTIMO_ACERVO.IdEmprestimo "
                        + "INNER JOIN LOCAL_ACERVO "
                        + "ON LIVROS_REVISTAS_JORNAIS.IdLocal=LOCAL_ACERVO.IdLocal "
                        + "WHERE TituloLivro='" + jDescricaoProduto.getText() + "' AND ITENS_EMPRESTIMO_ACERVO.IdEmprestimo='" + jIdDoc.getText() + "'AND IdItem='" + idItem + "'");
                conecta.rs.first();
                ...
                jQtdReserva.setText(conecta.rs.getString("QtdReserva"));
    ...
    private void jBtNovoItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoItemActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEmprestimosProd_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaEmprestimosProd_PEDA) && codIncluirPEDA == 1) {
            objEmprestimoAcervo.setStatusLanc(jStatusDoc.getText());
            if (jStatusDoc.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtAlterarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarItemActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEmprestimosProd_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaEmprestimosProd_PEDA) && codAlterarPEDA == 1) {
            objEmprestimoAcervo.setStatusLanc(jStatusDoc.getText());
            if (jStatusDoc.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtExcluirItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirItemActionPerformed
        // TODO add your handling code here:   
        buscarAcessoUsuario(telaEmprestimosProd_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaEmprestimosProd_PEDA) && codExcluirPEDA == 1) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            objEmprestimoAcervo.setStatusLanc(jStatusDoc.getText());
            if (jStatusDoc.getText().equals("FINALIZADO")) {
                ...
                if (resposta == JOptionPane.YES_OPTION) {
                    //
                    codLivro = Integer.parseInt(jIdProduto.getText());
                    jQuantidade.setText("0");
                    // quantItem = Integer.parseInt(jQuantidade.getText());
                    // PEGA SALDO DO ESTOQUE PARA CALCULAR
                    pegarSaldoEstoque(codLivro);
                    objItensEmprestimo.setIdLivro(codLivro);
                    objItensEmprestimo.setIdEstoque(codEstoque);
                    objItensEmprestimo.setQtdReserva(Integer.valueOf(jQuantidade.getText()));
                    controleUtil.atualizaSaldoReservaAcervo(objItensEmprestimo);
                    //
                    objItensEmprestimo.setIdItem(Integer.valueOf(idItem));
                    controle.excluirProdutoEmprestimoAcervo(objItensEmprestimo);
                    //
                    objLog2();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    ...
                    preencherTabelaItens("SELECT * FROM ITENS_EMPRESTIMO_ACERVO "
                            ...
                            + "INNER JOIN LOCAL_ACERVO "
                            + "ON LIVROS_REVISTAS_JORNAIS.IdLocal=LOCAL_ACERVO.IdLocal "
                            + "WHERE ITENS_EMPRESTIMO_ACERVO.IdEmprestimo='" + jIdDoc.getText() + "'");
                }
            }
        } else {
            JOptionPane.showMessageDialog(null, "Acesso não autorizado, solicite liberação ao administrador.");
    ...
    private void jBtSalvarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarItemActionPerformed
        //        // TODO add your handling code here:
        buscarAcessoUsuario(telaEmprestimosProd_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaEmprestimosProd_PEDA) && codGravarPEDA == 1) {
            if (jIdProduto.getText().equals("")) {
                ...
                objItensEmprestimo.setIdEmprestimo(Integer.valueOf(jIdDoc.getText()));
                objItensEmprestimo.setTipoOperacao(statusTipoAcervo);
                objItensEmprestimo.setTituloLivro(jDescricaoProduto.getText());
                objItensEmprestimo.setQuantidade(Integer.valueOf(jQuantidade.getText()));
                objItensEmprestimo.setQtdReserva(Integer.valueOf(jQtdReserva.getText()));
                objItensEmprestimo.setSaldoEstoque(Float.valueOf(jSaldoAtual.getText()));
                objItensEmprestimo.setUtilizaReservaAcervo(utilizaReserva);
                objItensEmprestimo.setUtilizaDevolucaoAcervo(utilizaDevolucao);
                ...
                objItensEmprestimo.setTipoOperacao(statusTipoOperacao);
                if (acao == 3) {
                    objItensEmprestimo.setUsuarioInsert(nameUser);
                    objItensEmprestimo.setDataInsert(dataModFinal);
                    objItensEmprestimo.setHorarioInsert(horaMov);
                    //
                    codLivro = Integer.parseInt(jIdProduto.getText());
                    qtdSaidaReserva = Float.parseFloat(jQuantidade.getText());
                    // PEGA SALDO DO ESTOQUE PARA CALCULAR
                    pegarSaldoEstoque(codLivro);
                    resultSaldo = saldoEstoque - quantReservada;
                    if (qtdSaidaReserva <= resultSaldo) {
                        // INCLUIR O PRODUTO NA TABELA DE ITENS_RESERVA_ACERVO  
                        // objItensEmprestimo.setQuantidade((int) resultSaldo);
                        controle.incluirProdutoEmprestimoAcervo(objItensEmprestimo);
                        // ATUALIZAR A RESERVA DO ESTOQUE NA TABLEA ESTOQUE_ACERVO
                        objItensEmprestimo.setIdLivro(codLivro);
                        objItensEmprestimo.setIdEstoque(codEstoque);
                        controleUtil.atualizaSaldoReservaAcervo(objItensEmprestimo);
                        //
                        ...
                        JOptionPane.showMessageDialog(rootPane, "Quantidade do emprestimo solicitada é maior que o estoque atual.");
                    }
                }
                if (acao == 4) {
                    objItensEmprestimo.setUsuarioUp(nameUser);
                    objItensEmprestimo.setDataUp(dataModFinal);
                    objItensEmprestimo.setHorarioUp(horaMov);
                    //
                    codLivro = Integer.parseInt(jIdProduto.getText());
                    quantItem = Integer.parseInt(jQuantidade.getText());
                    // PEGA SALDO DO ESTOQUE PARA CALCULAR
                    pegarSaldoEstoque(codLivro);
                    if (qtdModifica != quantItem) {
                        //
                        objItensEmprestimo.setQuantidade(Integer.valueOf(jQuantidade.getText()));
                        objItensEmprestimo.setIdItem(Integer.valueOf(idItem));
                        controle.alterarProdutoEmprestimoAcervo(objItensEmprestimo);
                        // ATUALIZAR A RESERVA DO ESTOQUE NA TABLEA ESTOQUE_ACERVO
                        objItensEmprestimo.setIdLivro(codLivro);
                        objItensEmprestimo.setIdEstoque(codEstoque);
                        objItensEmprestimo.setQtdReserva(Integer.valueOf(jQuantidade.getText()));
    ...
    private void jBtAuditoriaItensActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaItensActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensEmprestimoAcervo objAudItensEmp = new TelaAuditoriaItensEmprestimoAcervo();
        TelaModuloPedagogia.jPainelPedagogia.add(objAudItensEmp);
        objAudItensEmp.show();
    ...
    private void jBtPesqReservaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqReservaActionPerformed
        // TODO add your handling code here:
        TelaPesquisarInternoEmprestimoAcervoReserva objPesqIntReserva = new TelaPesquisarInternoEmprestimoAcervoReserva();
        TelaModuloPedagogia.jPainelPedagogia.add(objPesqIntReserva);
        objPesqIntReserva.show();
    ...
    public static javax.swing.JTextField jIdReserva;
    ...
    public static javax.swing.JTextField jQtdReserva;
    ...
    public void corCampos() {
        ...
        jIdReserva.setBackground(Color.white);
        ...
        jQtdReserva.setBackground(Color.white);
    ...
    public void Finalizar() {
        ...
        if (resposta == JOptionPane.YES_OPTION) {
            ...
            //
            objEmprestimoAcervo.setStatusLanc(statusEntrada);
            objEmprestimoAcervo.setIdEmprestimo(Integer.parseInt(jIdDoc.getText()));
            control.finalizarEmprestimoAcervo(objEmprestimoAcervo);
    ...
    public void validarEstoque() {
        ...
        for (int i = 0; i < jTabelaProdutos.getRowCount(); i++) {
            ...
            // ATUALIZAR A TABELA DE ITENS_RESERVA_ACERVO, como utilizado a reserva.
            if (!jIdReserva.getText().equals("")) {
                objItensEmprestimo.setIdReserva(Integer.valueOf(jIdReserva.getText()));
                objItensEmprestimo.setUtilizaReservaAcervo(utilizaReserva);
                controleUtil.atualizaUtilizaReservaAcervo(objItensEmprestimo);
            }
        }
    }
    ...
    public void buscarCodigo() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM EMPRESTIMO_ACERVO");
            conecta.rs.last();
            jIdDoc.setText(conecta.rs.getString("IdEmprestimo"));
        } catch (Exception e) {
    ...
    public void verificarItens() {
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENS_EMPRESTIMO_ACERVO WHERE IdEmprestimo='" + jIdDoc.getText() + "'");
            conecta.rs.first();
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                objEmprestimoAcervo.setIdEmprestimo(Integer.parseInt(jIdDoc.getText()));
                control.excluirEmprestimoAcervo(objEmprestimoAcervo);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                Excluir();
    ...
    public void pesquisarEmprestimoAcervo(String sql) {
        ...
        try {
            ...
            do {
                ...
                dataDocumeto = conecta.rs.getString("DataEmp");
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdEmprestimo"), dataDocumeto, conecta.rs.getString("StatusLanc"), conecta.rs.getString("NomeInternoCrc"), conecta.rs.getString("Observacao")});
        ...
        alinharCamposTabelaReservaAcervo();
        conecta.desconecta();
    }
    ...
    public void preencherTabelaItens(String sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdItem"), conecta.rs.getInt("IdLivro"), conecta.rs.getString("TituloLivro"), conecta.rs.getInt("QtdItem"), conecta.rs.getString("PrazoEmp"), conecta.rs.getString("DescricaoLocal")});
            } while (conecta.rs.next());
        } catch (SQLException ex) {
        }
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
