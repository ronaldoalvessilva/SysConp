...
import static gestor.Visao.TelaAtendimentoGrupoENF.jCodigoTema;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_PLAN_ENF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_PLAN_ENF() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PLANEJAMENTO_ATENDIMENTO_GRUPO_ENFERMAGEM "
                    + "WHERE IdItemPlanEnf='" + jCodigoTema.getText() + "' "
