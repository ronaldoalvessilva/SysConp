...
import gestor.Controle.ControleOcorrenciasServicoSocial;
...
import static gestor.Visao.TelaModuloServicoSocial.telaOcorrenciasSS;
 ...
 * @author ronaldo
 */
public class TelaOcorrenciaServicoSocial extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    OcorrenciasPortaria objOcorr = new OcorrenciasPortaria();
    ControleOcorrenciasServicoSocial control = new ControleOcorrenciasServicoSocial();
    ...
    String nomeModuloTela = "Serviço Social:Movimentação:Ocorrências Diárias:Manutenção";
    String horaMov;
    String dataModFinal;
    int count = 0;
    //
    ...
    String nomeGrupo = "ADMINISTRADORES";
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Ocorrência Serviço Social :::...");
        ...
        setBounds(300, 10, 615, 595);
    }// </editor-fold>//GEN-END:initComponents

    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        // TODO add your handling code here:telaOcorrenciasSS
        buscarAcessoUsuario(telaOcorrenciasSS);
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaOcorrenciasSS) && codIncluirSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        ...
        buscarAcessoUsuario(telaOcorrenciasSS);
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaOcorrenciasSS) && codAlterarSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaOcorrenciasSS);
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaOcorrenciasSS) && codExcluirSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            objOcorr.setStatusLanc(jStatusOcorrencia.getText());
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaOcorrenciasSS);
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaOcorrenciasSS) && codGravarSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaOcorrenciasServicoSocial objAudiOcorSS = new TelaAuditoriaOcorrenciasServicoSocial();
        TelaModuloServicoSocial.jPainelServicoSocial.add(objAudiOcorSS);
        objAudiOcorSS.show();
    ...
    private void jBtImpressaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtImpressaoActionPerformed
        ...
        try {
            conecta.abrirConexao();
            String path = "reports/ServicoSocial/ListagemOcorrencias_ServicoSocial.jasper";
            conecta.executaSQL("SELECT * FROM OCORRENCIAS_SERVICO_SOCIAL "
                    + "WHERE IdLanc='" + jIdOcorrencia.getText() + "'");
    ...
    private void jBtPesqCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoActionPerformed
        ...
        usuariosGrupoAdministradores();
        count = 0;
        flag = 1;
        if (nomeUsuario.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
    ...
    private void jBtPesqTituloOcorrrenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqTituloOcorrrenciaActionPerformed
        ...
        if (nomeUsuario.equals("ADMINISTRADOR DO SISTEMA")) {
            if (jPesqTituloOcorrencia.getText().equals("")) {
                ...
                pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_SERVICO_SOCIAL "
                        + "WHERE Titulo LIKE'%" + jPesqTituloOcorrencia + "%'");
            }
        } else if (nomeGrupo.equals("ADMINISTRADORES")) {
            if (jPesqTituloOcorrencia.getText().equals("")) {
                JOptionPane.showMessageDialog(rootPane, "É necessário informar um nome ou parte do nome para pesquuisa.");
    ...
    public void usuariosGrupoAdministradores() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM GRUPOUSUARIOS "
                    + "INNER JOIN USUARIOS_GRUPOS "
                    + "ON GRUPOUSUARIOS.IdGrupo=USUARIOS_GRUPOS.IdGrupo "
                    + "INNER JOIN USUARIOS "
