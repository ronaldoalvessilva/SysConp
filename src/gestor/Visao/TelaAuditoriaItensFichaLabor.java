 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensFichaLabor extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensFichaLabor() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Itens Ficha :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSFICHALAB WHERE IdLanc='" + jIDLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
