...
import static gestor.Visao.TelaEntradaSaidaInternosAlbergadosPortaria.jIDlanc;
import static gestor.Visao.TelaEntradaSaidaInternosAlbergadosPortaria.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntSaiInternosAlbergados extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEntSaiInternosAlbergados() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_ENTRADA_SAIDA_ALBERGADOS WHERE IdLanc='" + jIDlanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
