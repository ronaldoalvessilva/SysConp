...
import static gestor.Visao.TelaConsultaLocalInternoSeguranca.jIdInterno;
 ...
 * @author ronaldo
 */
public class TelaFotoLocalInterno extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaConsultaLocalInternoSeguranca telaLocalInterno;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoLocalInterno(TelaConsultaLocalInternoSeguranca parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoLocalInterno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoLocalInterno dialog = new TelaFotoLocalInterno(telaLocalInterno, true);
