 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAgendamentoBeneficio extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAgendamentoBeneficio() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Agendamento Benefícios :::...");
        setToolTipText("");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AGENDA_BENEFICIO_INTERNOS WHERE IdReg='" + jIdRegistro.getText() + "'");
            conecta.rs.first();
