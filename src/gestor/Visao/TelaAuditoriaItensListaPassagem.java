 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensListaPassagem extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensListaPassagem() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSAGENDALABORATIVA WHERE IdAgenda='" + jIDAgenda.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
