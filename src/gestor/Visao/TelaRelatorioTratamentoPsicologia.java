 ...
 */
public class TelaRelatorioTratamentoPsicologia extends javax.swing.JInternalFrame {
     ...
     */
    public TelaRelatorioTratamentoPsicologia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Relatório de Tratamento Psicologia :::...");
        ...
        jLabel3.setText("Tipo Tratamento");

        jComboBoxTipoTratamento.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jComboBoxTipoTratamento.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione...", "Em Andamento", "Concluído" }));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel3)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jComboBoxTipoTratamento, javax.swing.GroupLayout.PREFERRED_SIZE, 18, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void jBtConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtConfirmarActionPerformed
        ...
        if (tipoServidor == null || tipoServidor.equals("")) {
            ...
            if (jDataInicial.getDate() == null) {
                ...
                JOptionPane.showMessageDialog(rootPane, "É necessário selecionar um tipo...");
            } else {
                try {
    ...
    private javax.swing.JComboBox<String> jComboBoxTipoTratamento;
