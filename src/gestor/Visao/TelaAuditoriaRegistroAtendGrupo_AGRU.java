...
import static gestor.Visao.TelaAtendimentoGrupoPSI.pCODIGO_AVALIACAO_GRUPO;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_AGRU extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_AGRU() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AVALICAO_ATENDIMENTO_GRUPO_PSICOLOGIA "
                    + "WHERE IdItemAvag='" + pCODIGO_AVALIACAO_GRUPO + "' "
