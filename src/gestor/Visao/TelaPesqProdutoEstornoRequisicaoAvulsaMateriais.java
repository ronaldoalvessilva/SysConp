 ...
 * @author user
 */
public class TelaPesqProdutoEstornoRequisicaoAvulsaMateriais extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoEstornoRequisicaoAvulsaMateriais() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Requisição Avulsa de Produtos {AC} :::...");
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "INNER JOIN ITENS_REQUISICAO_AVULSA_PRODUTOS "
                    + "ON PRODUTOS_AC.IdProd=ITENS_REQUISICAO_AVULSA_PRODUTOS.IdProd "
                    + "WHERE DescricaoProd LIKE'%" + jPesqDescricaoProdutos.getText() + "%'AND StatusProd='" + statusProd + "'AND Qtd!='" + 0 + "'AND EstornoProduto='" + estornoProduto + "'AND IdReq='" + jIdReq.getText() + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        }
