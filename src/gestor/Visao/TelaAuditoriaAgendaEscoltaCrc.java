 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAgendaEscoltaCrc extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAgendaEscoltaCrc() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Agenda Escolta de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AGENDAESCOLTA WHERE IdAgenda='" + jIDAgenda.getText() + "'");
            conecta.rs.first();
