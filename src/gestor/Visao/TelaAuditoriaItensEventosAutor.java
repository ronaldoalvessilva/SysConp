...
import static gestor.Visao.TelaEventoDisciplinar.idItemAutor;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEventosAutor extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEventosAutor() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AUTOREVENTOS WHERE IdLanc='" + jIdLanc.getText() + "'AND IdAutor='" + idItemAutor + "'");
            conecta.rs.first();
