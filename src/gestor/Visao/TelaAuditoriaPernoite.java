 ...
 * @author Ronaldo
 */
public class TelaAuditoriaPernoite extends javax.swing.JInternalFrame {
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PERNOITE_INTERNOS WHERE IdPer='" + jCodigoRegistro.getText() + "'");
            conecta.rs.first();
