...
import static gestor.Visao.TelaInstituicaoReligiosa.jCodigo;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaInstReligiosa extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaInstReligiosa() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Instituição Religiosa :::...");
        setToolTipText("");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM INSTITUICAO_RELIGIOSA WHERE IdCod='" + jCodigo.getText() + "'");
            conecta.rs.first();
