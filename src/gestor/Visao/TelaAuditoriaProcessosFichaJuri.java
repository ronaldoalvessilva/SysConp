...
import static gestor.Visao.TelaFichaJuridica.codProc;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaProcessosFichaJuri extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaProcessosFichaJuri() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PROCESSOS_JURIDICOS WHERE IdFicha='" + jIdFicha.getText() + "'AND IdProc='" + codProc + "'");
            conecta.rs.first();
