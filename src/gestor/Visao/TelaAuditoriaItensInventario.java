...
import static gestor.Visao.TelaInventarioProdutosMed.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensInventario extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensInventario() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSINVENTARIO WHERE IdLanc='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
