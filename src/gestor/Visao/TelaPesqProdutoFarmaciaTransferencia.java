...
import static gestor.Visao.TelaTransferenciaEstoqueFarmacia.idItemTrans;
 ...
 * @author user
 */
public class TelaPesqProdutoFarmaciaTransferencia extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoFarmaciaTransferencia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabelaProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item", "Código", "Descrição Produto", "Dt. Vcto.", "Quant.", "Lote"
            }
        ));
        ...
        if (jTabelaProdutos.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaProdutos.getColumnModel().getColumn(5).setMinWidth(80);
            jTabelaProdutos.getColumnModel().getColumn(5).setMaxWidth(80);
        }
        ...
        if (jPesqDescricaoProdutos.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRODUTOS_AC "
                        ...
                        + "AND PRODUTOS_AC.StatusProd='" + statusProd + "' "
                        + "AND LOTE_PRODUTOS_AC.Lote='" + idLote + "'");
                conecta.rs.first();
    ...
    private void jTabelaProdutosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaProdutosMouseClicked
        ...
        flag = 1;
        if (flag == 1) {
            idItemTrans  = "" + jTabelaProdutos.getValueAt(jTabelaProdutos.getSelectedRow(),0);
            String nomeProduto = "" + jTabelaProdutos.getValueAt(jTabelaProdutos.getSelectedRow(), 2);
            jPesqDescricaoProdutos.setText(nomeProduto);
            idLote = "" + jTabelaProdutos.getValueAt(jTabelaProdutos.getSelectedRow(), 5);
        }
    ...
    public void preencherTabelaProdutos(String sql) {
        ...
        String[] Colunas = new String[]{"Item", "Código", "Descrição Produto", "Dt. Vcto", "Quant.", "Lote"};
        conecta.abrirConexao();
        ...
        try {
            ...
            do {
                ...
                qtdItemTab = vqtdItem;
                //
                dados.add(new Object[]{conecta.rs.getInt("IdItem"),conecta.rs.getInt("IdProd"), conecta.rs.getString("DescricaoProd"), dataVcto, qtdItemTab, conecta.rs.getString("Lote")});
