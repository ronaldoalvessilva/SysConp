 ...
 * @author ronal
 */
public class TelaGravarProximoKitQuinzenalInd extends javax.swing.JDialog {
    ...
    public TelaGravarProximoKitQuinzenalInd(TelaProgramacaoKitsHigiene parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGravarProximoKitQuinzenalInd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaGravarProximoKitQuinzenalInd dialog = new TelaGravarProximoKitQuinzenalInd(gravarProximoKitQuinzenal, true);
            ...
            Thread t0 = new Thread() {
                public void run() {
                    ...
                    try {
                        ...
                        Logger.getLogger(TelaGravarProximoKitQuinzenalInd.class.getName()).log(Level.SEVERE, null, ex);
                    }
