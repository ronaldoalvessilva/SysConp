 ...
 * @author ronaldo
 */
public class TelaPeculiaridadeCostasTriagem extends javax.swing.JDialog {
     ...
     */
    public static TelaProntuarioTriagem telaProntuarioTriagem;

    public TelaPeculiaridadeCostasTriagem(TelaProntuarioTriagem parent, boolean modal) {
        this.telaProntuarioTriagem = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaProntuarioTriagem);
        initComponents();
        preencherTabelaPeculiaridadeCostas("SELECT * FROM PECULIARIDADE_COSTAS "
                ...
                + "WHERE PECULIARIDADE_COSTAS.IdInternoCrc='" + jIdInterno.getText() + "'");
        formatarCampos();
    }
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        if (jDataCadastro.getDate() == null) {
            ...
            objPecuCosta.setIdInternoCrc(Integer.valueOf(jIdInterno.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPeculiaridadeCostasTriagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaPeculiaridadeCostasTriagem dialog = new TelaPeculiaridadeCostasTriagem(telaProntuarioTriagem, true);
