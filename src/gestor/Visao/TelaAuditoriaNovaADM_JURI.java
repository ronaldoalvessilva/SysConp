...
import static gestor.Visao.TelaNovaAdmissaoJuridico.jIdADM_JURI;
 ...
 * @author ronal
 */
public class TelaAuditoriaNovaADM_JURI extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    /**
     * Creates new form TelaAuditoriaNovaADM_JURI
     */
    
    public static TelaNovaAdmissaoJuridico pNOVA_ADM;
    
    public TelaAuditoriaNovaADM_JURI(TelaNovaAdmissaoJuridico parent, boolean modal) {
        this.pNOVA_ADM = parent;
        this.setModal(modal);
        setLocationRelativeTo(pNOVA_ADM);
        initComponents();
        auditoria();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAuditoriaNovaADM_JURI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAuditoriaNovaADM_JURI dialog = new TelaAuditoriaNovaADM_JURI(pNOVA_ADM, true);
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ADMISSAO_JURIDICO_ADICIONAL WHERE IdADM_JURI='" + jIdADM_JURI.getText() + "'");
            conecta.rs.first();
