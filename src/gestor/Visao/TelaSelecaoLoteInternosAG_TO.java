...
import gestor.Controle.ControleListaInternosCelasAG_TO;
import gestor.Controle.ControleListaInternosGaleiraAG_TO;
import gestor.Controle.ControleListaInternosPavilhaoAG_II_TO;
import gestor.Controle.ControleListaInternosPavilhaoAG_TO;
...
import static gestor.Visao.TelaAtendimentoGrupoTO.jBtAuditoriaParticipantes;
...
import static gestor.Visao.TelaAtendimentoGrupoTO.jBtSalvarParticipantes;
import static gestor.Visao.TelaAtendimentoGrupoTO.jBtPesquisarPart;
...
import static gestor.Visao.TelaAtendimentoGrupoTO.jComboBoxPavilhaoGaleria;
...
import static gestor.Visao.TelaAtendimentoGrupoTO.jTabelaInternos;
import static gestor.Visao.TelaAtendimentoGrupoTO.jtotalRegistrosInternos;
import static gestor.Visao.TelaAtendimentoGrupoTO.pCODIGO_ITEM_PARTICIPANTE;
 ...
 */
public class TelaSelecaoLoteInternosAG_TO extends javax.swing.JDialog {
    ...
    ControleListaInternosCelasAG_TO listaPorCelas = new ControleListaInternosCelasAG_TO();
    ControleListaInternosGaleiraAG_TO listaPorGaleira = new ControleListaInternosGaleiraAG_TO();
    ControleListaInternosPavilhaoAG_TO listaPorPavilhao = new ControleListaInternosPavilhaoAG_TO();
    ControleListaInternosPavilhaoAG_II_TO listaPorPavilhao_B = new ControleListaInternosPavilhaoAG_II_TO();
     ...
     */
    public static TelaAtendimentoGrupoTO pATENDIMENTO_GRUPO;

    public TelaSelecaoLoteInternosAG_TO(TelaAtendimentoGrupoTO parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaSelecaoLoteInternosAG_TO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaSelecaoLoteInternosAG_TO dialog = new TelaSelecaoLoteInternosAG_TO(pATENDIMENTO_GRUPO, true);
            ...
            Thread t0 = new Thread() {
                public void run() {
                    ...
                    for (int i = 0; i < jTabelaInternosDestino.getRowCount(); i++) {//  
                        ...
                        //
                        control.incluirAGrupoTO(objAvalia);
