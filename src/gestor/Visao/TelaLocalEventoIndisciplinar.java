 ...
 * @author ronaldo
 */
public class TelaLocalEventoIndisciplinar extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    EventoIndisciplinar objLocal = new EventoIndisciplinar();
    ControleLocalEventos control = new ControleLocalEventos();
    //
     ...
     */
    public TelaLocalEventoIndisciplinar() {
        initComponents();
        corCampos();
        formatarCampos();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Local Evento Indisciplinar  :::...");
        setToolTipText("");
        ...
        if (jTabelaLocalPertences.getColumnModel().getColumnCount() > 0) {
            jTabelaLocalPertences.getColumnModel().getColumn(0).setMinWidth(70);
            jTabelaLocalPertences.getColumnModel().getColumn(0).setMaxWidth(70);
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jDescricaoLocal, javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jComboBoxStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jBtPesqDescricaoLocalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoLocalActionPerformed
        ...
        if (jPesqDescricaoLocal.getText().equals("")) {
            ...
            preencherTabelaLocalEstoque("SELECT * FROM LOCALEVENTOS WHERE DescricaoLocal LIKE'%" + jPesqDescricaoLocal.getText() + "%'");
        }
    ...
    private void jCheckBoxTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaLocalEstoque("SELECT * FROM LOCALEVENTOS ORDER BY DescricaoLocal");
        } else {
    ...
    private void jTabelaLocalPertencesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaLocalPertencesMouseClicked
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM LOCALEVENTOS WHERE Idlocal='" + idLocal + "'");
                conecta.rs.first();
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (codigoUser == codUserAcesso && nomeTela.equals(telaLocalEvento) && codIncluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaLocalEvento);
        if (codigoUser == codUserAcesso && nomeTela.equals(telaLocalEvento) && codAlterar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            statusMov = "Alterou";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            acao = 2;
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaLocalEvento);
        if (codigoUser == codUserAcesso && nomeTela.equals(telaLocalEvento) && codExcluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            verificarLocal();
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaLocalEvento);
        if (codigoUser == codUserAcesso && nomeTela.equals(telaLocalEvento) && codGravar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            if (jDescricaoLocal.getText().equals("")) {
                ...
                if (acao == 1) {
                    ...
                    control.incluirLocalEventos(objLocal);
                    buscarCodigo();
                    objLog();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                ...
                if (acao == 2) {
                    ...
                    control.alterarLocalEventos(objLocal);
                    objLog();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
                    Salvar();
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaLocalEventos objAudlocalEve = new TelaAuditoriaLocalEventos();
        TelaModuloSeguranca.jPainelSeguranca.add(objAudlocalEve);
        objAudlocalEve.show();
    ...
    public void buscarCodigo() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM LOCALEVENTOS");
            conecta.rs.last();
    ...
    public void preencherTabelaLocalEstoque(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Status", "Descrição do Local"};
        conecta.abrirConexao();
        try {
        ...
        jTabelaLocalPertences.getColumnModel().getColumn(0).setPreferredWidth(70);
