...
import static gestor.Visao.TelaFornecedorCOMPRASNUTRI.jIdFornecedor;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaFornecedorNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaFornecedorNUTRI() {
        initComponents();
        auditoria();               
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM FORNECEDORES_NUTRI WHERE IdForn='" + jIdFornecedor.getText() + "'");
            conecta.rs.first();
