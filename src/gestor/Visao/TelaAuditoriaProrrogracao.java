 ...
 * @author Ronaldo
 */
public class TelaAuditoriaProrrogracao extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaProrrogracao() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PRORROGAR_SAIDA_TEMPORARIA_PRISAO_DOMICILIAR WHERE IdProrroga='" + IdRegistro.getText() + "'");
            conecta.rs.first();
