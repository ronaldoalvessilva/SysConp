...
import static gestor.Visao.TelaModuloTerapiaOcupacional.telaRegistroIntAtendTO;
import static gestor.Visao.TelaModuloTerapiaOcupacional.telaRegistroIntAtendInciarLeitorTO;

/**
 *
 * @author ronal
 */
public class TelaRegistroInternosAtendimentoTO extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "TERAPIA:Registro de Atendimento de Internos:Biometria";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
     ...
     */
    public TelaRegistroInternosAtendimentoTO() {
        initComponents();
        corCampos();
        pesquisarModulo();
    }
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoTO.equals("ADMINISTRADORES") || codigoUserTO == codUserAcessoTO && nomeTelaTO.equals(telaRegistroIntAtendTO) && codGravarTO == 1) {
            verificarInternos();
    ...
    private void jBtIniciarLeitorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtIniciarLeitorActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaRegistroIntAtendInciarLeitorTO);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoTO.equals("ADMINISTRADORES") || codigoUserTO == codUserAcessoTO && nomeTelaTO.equals(telaRegistroIntAtendInciarLeitorTO) && codIncluirTO == 1) {
            Novo();
            // Instanciar a DLL
