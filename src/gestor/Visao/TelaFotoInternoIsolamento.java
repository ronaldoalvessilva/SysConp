...
import static gestor.Visao.TelaConsultaInternosIsolamento.jIdInterno;
 ...
 * @author ronaldo
 */
public class TelaFotoInternoIsolamento extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaConsultaInternosIsolamento telaconsultaIsolamento;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoInternoIsolamento(TelaConsultaInternosIsolamento parent, boolean modal) {
        this.telaconsultaIsolamento = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaconsultaIsolamento);
        initComponents();
        buscarFotoInterno();
    }
    ...
    private void initComponents() {
        ...
        setTitle("...::: Foto Interno Isolamento :::...");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoInternoIsolamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoInternoIsolamento dialog = new TelaFotoInternoIsolamento(telaconsultaIsolamento, true);
