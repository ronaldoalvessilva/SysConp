...
import static gestor.Visao.TelaSaidaObjetosPertences.jIdLanc;
import static gestor.Visao.TelaSaidaObjetosPertences.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensPertencesSegSaida extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensPertencesSegSaida() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Pertences de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSOBJETOSSAIDA WHERE IdSaida='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
