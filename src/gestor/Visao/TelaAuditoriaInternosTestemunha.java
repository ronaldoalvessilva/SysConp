...
import static gestor.Visao.TelaEventoDisciplinar.idItemIntTes;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaInternosTestemunha extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaInternosTestemunha() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM INTERNOTESTEMUNHA WHERE IdLanc='" + jIdLanc.getText() + "'AND IdIntTeste='" + idItemIntTes + "'");
            conecta.rs.first();
