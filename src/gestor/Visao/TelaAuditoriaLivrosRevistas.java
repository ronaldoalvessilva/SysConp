 ...
 * @author Ronaldo
 */
public class TelaAuditoriaLivrosRevistas extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaLivrosRevistas() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Livros Acervo :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM LIVROS_REVISTAS_JORNAIS WHERE IdLivro='" + jIdLivro.getText() + "'");
            conecta.rs.first();
