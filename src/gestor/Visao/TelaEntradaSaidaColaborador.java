 ...
 * @author user
 */
public class TelaEntradaSaidaColaborador extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "Portaria:Entrada/Saida de Colaborador:Manutenção";
    String nomeModuloTela2 = "Portaria:Entrada/Saida de Colaborador:Colaborador";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
     ...
     */
    public static TelaFotoColaborador telafotocolaborador;
    public static TelaAcessoBiometriaColaboradores biometriaFunc;

    public TelaEntradaSaidaColaborador() {
        super();
        initComponents();
        setResizable(false);
        corCampo();
    ...
    public void mostrarFotoColaborador() {
        telafotocolaborador = new TelaFotoColaborador(this, true);
        telafotocolaborador.setVisible(true);
    }

    public void mostrarBiometriacolaborador() {
        biometriaFunc = new TelaAcessoBiometriaColaboradores(this, true);
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("...::: Entrada/Saida de Colaboradores - {P1} :::...");
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jNomeFuncionario, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jBtSairFunc, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(jBtSalvarFunc, javax.swing.GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE)
                        ...
                        .addComponent(jBtBuscarFunc, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jBtBiometria, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jBtZoonColaborador, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
            .addGroup(jPanel12Layout.createSequentialGroup()
                .addGap(45, 45, 45)
        ...
        jPanel12Layout.setVerticalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jBtZoonColaborador)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jBtBiometria)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 11, Short.MAX_VALUE)
                .addComponent(jBtSairFunc)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jBtAuditoriaFunc, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaCOLManuP1) && codIncluirP1 == 1) {
            acao = 1;
            Novo();
            corCampo();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaCOLManuP1);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaCOLManuP1) && codAlterarP1 == 1) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaCOLManuP1);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaCOLManuP1) && codExcluirP1 == 1) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            objEntSaiFunc.setStatusLanc(jStatusEntCola.getText());
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaCOLManuP1);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaCOLManuP1) && codGravarP1 == 1) {
    ...
    private void jBtNovoFuncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoFuncActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaCOLcolP1);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaCOLcolP1) && codIncluirP1 == 1) {
            objEntSaiFunc.setStatusLanc(jStatusEntCola.getText());
            if (jStatusEntCola.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Essa entrada de colaboradores não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtAlterarFuncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarFuncActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaCOLcolP1);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaCOLcolP1) && codAlterarP1 == 1) {
    ...
    private void jBtExcluirFuncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirFuncActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaCOLcolP1);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaCOLcolP1) && codExcluirP1 == 1) {
            verificarBiometriaFunc();
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
    ...
    private void jBtSalvarFuncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarFuncActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaCOLcolP1);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaCOLcolP1) && codGravarP1 == 1) {
    ...
    private void jBtBuscarFuncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtBuscarFuncActionPerformed
        // TODO add your handling code here:
        TelaPesqItensColaborador objPesqItensCola = new TelaPesqItensColaborador();
        TelaModuloPortarias.jPainelPortarias.add(objPesqItensCola);
        objPesqItensCola.show();
    ...
    private void jBtPesqFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqFuncionarioActionPerformed
        ...
        TelaPesqColaborador objPesCola = new TelaPesqColaborador();
        TelaModuloPortarias.jPainelPortarias.add(objPesCola);
        objPesCola.show();
    ...
    private void jBtAuditoriaManuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaManuActionPerformed
        // TODO add your handling code here:
        TelaAudEntSaiColaborador objAudEntSaiFunc = new TelaAudEntSaiColaborador();
        TelaModuloPortarias.jPainelPortarias.add(objAudEntSaiFunc);
        objAudEntSaiFunc.show();
    ...
    private void jBtAuditoriaFuncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaFuncActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensEntSaiFunc objAudItensEntSaiFunc = new TelaAuditoriaItensEntSaiFunc();
        TelaModuloPortarias.jPainelPortarias.add(objAudItensEntSaiFunc);
        objAudItensEntSaiFunc.show();
    ...
    public void formatarCampos() {
        ...
        //RETIRADO, POIS ESTAVA DANDO CONFLITO COM A BIOMETRIA (04/08/2017)
//        try {
