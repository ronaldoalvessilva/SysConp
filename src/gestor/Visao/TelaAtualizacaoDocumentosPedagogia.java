 ...
 * @author Ronaldo
 */
public class TelaAtualizacaoDocumentosPedagogia extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "Pedagogia:Atualização Documentos Internos:Manutenção";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
     ...
     */
    public TelaAtualizacaoDocumentosPedagogia() {
        initComponents();
        formatarCampos();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Atualização de Documentos de Internos {PEDAGOGIA} :::...");
        ...
        jComboBoxEscolaridade.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecione", "Não Alfabetizado", "Alfabetizado", "Fundamental Completo", "Fundamental Incompleto", "1º Grau Completo", "1º Grau Incompleto", "2º Grau Completo", "2º Grau Incompleto", "Superior Completo", "Superior Incompleto", "Ensino Médio Incompleto", "Ensino Médio Completo" }));
    ...
    private void jBtPesquisaInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisaInternoActionPerformed
        //TODO add your handling code here:
        TelaPesquisaInternoAtualizarDocPeda objPesqIntPed = new TelaPesquisaInternoAtualizarDocPeda();
        TelaModuloPedagogia.jPainelPedagogia.add(objPesqIntPed);
        objPesqIntPed.show();
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        if (jComboBoxEscolaridade.getSelectedItem() == null || jComboBoxEscolaridade.getSelectedItem().equals("Selecione")) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Não é possível finalizar esse registro sem o preenchimento do CPF do interno.");
        } else if (jDataEmissao.getDate() == null) {
            JOptionPane.showMessageDialog(rootPane, "Não é possível finalizar esse registro sem o preenchimento da data de emissão do RG do interno.");
        } else if (jComboBoxEmissor.getSelectedItem() == null) {
            JOptionPane.showMessageDialog(rootPane, "Não é possível finalizar esse registro sem o preenchimento do emissor do RG do interno.");
        } else if (jOrgao.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Não é possível finalizar esse registro sem o preenchimento do órgão do RG do interno.");
        } else if (jRG.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Não é possível finalizar esse registro sem o preenchimento do RG do interno.");
        } else {
            if (jStatusDoc.getText().equals("FINALIZADO")) {
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaAtualizaDocPeda objAudiPed = new TelaAuditoriaAtualizaDocPeda();
        TelaModuloPedagogia.jPainelPedagogia.add(objAudiPed);
        objAudiPed.show();
