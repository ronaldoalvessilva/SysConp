...
import static gestor.Visao.TelaAtendimentoOdontologico.jIdPrescricao;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEvolucaoOdonto extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEvolucaoOdonto() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PRESCRICAO_ODONTOLOGIA WHERE IdLanc='" + jIDLanc.getText() + "'AND IdPre='" + jIdPrescricao.getText() + "'");
            conecta.rs.first();
