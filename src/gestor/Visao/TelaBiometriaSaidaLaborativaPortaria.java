...
import static gestor.Visao.TelaEntradaSaidaInternosPortaria.jIDlanc;
...
import static gestor.Visao.TelaEntradaSaidaInternosPortaria.jTabelaInternos;
 ...
 * @author ronaldo
 */
public class TelaBiometriaSaidaLaborativaPortaria extends javax.swing.JDialog {
     ...
     */
    public static TelaEntradaSaidaInternosPortaria saidaEntradaPortariaLaborativa;

    public TelaBiometriaSaidaLaborativaPortaria(TelaEntradaSaidaInternosPortaria parent, boolean modal) {
        this.saidaEntradaPortariaLaborativa = parent;
        this.setModal(modal);
        setLocationRelativeTo(saidaEntradaPortariaLaborativa);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBoxTipoMovimentacao.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Saída Laborativa", "Retorno de Saída Laborativa", " ", " " }));
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        if (jIdInternoKitBio.getText().equals("") || jNomeInternoKitBio.getText().equals("")) {
            ...
            if (jIdInternoKitBio.getText().equals(codigoInterno)
                    ...
                    && jComboBoxTipoMovimentacao.getSelectedItem().equals("Saída Laborativa")) {
                JOptionPane.showMessageDialog(rootPane, "Já foi lançado a saída laborativa desse interno.");
            } else {
                if (jComboBoxTipoMovimentacao.getSelectedItem().equals("Saída Laborativa")) {
                    statusMov = "Incluiu";
                    horaMov = jHoraSistema.getText();
                    dataModFinal = jDataSistema.getText();
                    objItenLabor.setDataSaida(jDataEntradaSaida.getDate());
                    objItenLabor.setHorarioSaida(jHorarioSaidaEntrada.getText());
                    objItenLabor.setAssinaturaDigital(pDigitalCapturada);
                    //
                    objItenLabor.setUsuarioInsert(nameUser);
                    objItenLabor.setDataInsert(dataModFinal);
                    objItenLabor.setHoraInsert(horaMov);
                    // PARA LOG DE REGISTROS
                    objItenLabor.setIdLanc(Integer.valueOf(jIDlanc.getText()));
                    objItenLabor.setIdInternoCrc(Integer.valueOf(jIdInternoKitBio.getText()));
                    objItenLabor.setNomeInterno(jNomeInternoKitBio.getText());
                    controleBio.saidaLaborativaInternoBio(objItenLabor);
                    //Inclusão do histórico do interno na empresa
                    objHistInterEmp.setIdInternoCrc(Integer.valueOf(jIdInternoKitBio.getText()));
                    objHistInterEmp.setNomeInterno(jNomeInternoKitBio.getText());
                    objHistInterEmp.setNomeEmpresa(jNomeEmpresa.getText());
                    //
                    objHistInterEmp.setDataSaida(jDataEntradaSaida.getDate());
                    objHistInterEmp.setHorarioSaida(jHorarioSaidaEntrada.getText());
                    objDatasHoras();
                    controlHist.saidaInterEmp(objHistInterEmp);
                    ...
                    Salvar();
                } else if (jComboBoxTipoMovimentacao.getSelectedItem().equals("Retorno de Saída Laborativa")) {
                    statusMov = "Alterou";
                    horaMov = jHoraSistema.getText();
                    dataModFinal = jDataSistema.getText();
                    ...
                    //
                    objItenLabor.setDataEntrada(jDataEntradaSaida.getDate());
                    objItenLabor.setHorarioEntrada(jHorarioSaidaEntrada.getText());
                    objItenLabor.setAssinaturaDigital(pDigitalCapturada);
                    //
                    objItenLabor.setIdLanc(Integer.valueOf(jIDlanc.getText()));
                    ...
                    objItenLabor.setIdInternoCrc(Integer.valueOf(jIdInternoKitBio.getText()));
                    objItenLabor.setNomeInterno(jNomeInternoKitBio.getText());
                    controleBio.retornoLaborativaInternoBio(objItenLabor);
                    //Alteração do histórico do interno na empresa
                    objHistInterEmp.setIdInternoCrc(Integer.valueOf(jIdInternoKitBio.getText()));
                    objHistInterEmp.setNomeInterno(jNomeInternoKitBio.getText());
                    objHistInterEmp.setNomeEmpresa(jNomeEmpresa.getText());
                    //                    
                    objHistInterEmp.setDataEntrada(jDataEntradaSaida.getDate());
                    objHistInterEmp.setHorarioEntrada(jHorarioSaidaEntrada.getText());
                    objDatasHoras();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBiometriaSaidaLaborativaPortaria.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBiometriaSaidaLaborativaPortaria dialog = new TelaBiometriaSaidaLaborativaPortaria(saidaEntradaPortariaLaborativa, true);
    ...
    private static Runnable LerDigital1 = new Runnable() {
        ...
        public void run() {
            try {
                ...
                //
                ControleSELaborativaPortariaBio digiControlSaida = new ControleSELaborativaPortariaBio();
