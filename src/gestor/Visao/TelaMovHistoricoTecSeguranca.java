 ...
 * @author user
 */
public class TelaMovHistoricoTecSeguranca extends javax.swing.JInternalFrame {
     ...
     */
    public TelaMovHistoricoTecSeguranca() {
        initComponents();
        corCampos();
    }
    ...
    private void jBtPesquisarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarInternoActionPerformed
        // Pesquisar Internos
        count = 0;
        TelaPesqMovIntTecnicoSeguranca objMovIntTec = new TelaPesqMovIntTecnicoSeguranca();
        TelaModuloSeguranca.jPainelSeguranca.add(objMovIntTec);
        objMovIntTec.show();
