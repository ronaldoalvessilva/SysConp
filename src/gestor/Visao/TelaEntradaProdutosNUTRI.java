...
import gestor.Controle.ControleAtualizaDadosUltimaCompraNUTRI;
import gestor.Controle.ControleAtualizaSaldoInventarioNUTRI;
import gestor.Controle.ControleEfetivaLoteNUTRI;
import gestor.Controle.ControleHistoricoCompraProdutoNUTRI;
import gestor.Controle.ControleHistoricoMovimentacaoNUTRI;
import gestor.Controle.ControleItensComprasNUTRI;
 ...
 * @author ronaldo
 */
public class TelaEntradaProdutosNUTRI extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    NotaFiscalCompra objNFEComprasv = new NotaFiscalCompra();
    ControleNFeComprasNUTRI control = new ControleNFeComprasNUTRI();
    ItensNfeCompras objItensCompras = new ItensNfeCompras();
    ControleItensComprasNUTRI controle = new ControleItensComprasNUTRI();
    ParcelasPagtoCompras objParCompras = new ParcelasPagtoCompras();
    ControleParcelasComprasNUTRI controlParCompras = new ControleParcelasComprasNUTRI();
    //
    ControleHistoricoCompraProdutoNUTRI controleHist = new ControleHistoricoCompraProdutoNUTRI();
    ...
    ControleAtualizaDadosUltimaCompraNUTRI controlAtualCompras = new ControleAtualizaDadosUltimaCompraNUTRI();
    HistoricoProdutoFornecedor objHistorForn = new HistoricoProdutoFornecedor();
    //
    ControleLogSistema controlLog = new ControleLogSistema();
    LogSistema objLogSys = new LogSistema();
    // Variáveis para gravar o log
    String nomeModuloTela = "Nutrição:Entrada Produtos:Dados NFE";
    String nomeModuloTela2 = "Nutrição:Entrada Produtos:Itens";
    String nomeModuloTela3 = "Nutrição:Entrada Produtos:Parcelas";
    //
    int flag;
    int acao;
     ...
     */
    public TelaEntradaProdutosNUTRI() {
        initComponents();
        corCampos();
        formatarCampos();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Nfe de Compra de Produtos {NUTRI} :::...");
        setToolTipText("");
        ...
        if (jTabelaItensNFeCompras.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaItensNFeCompras.getColumnModel().getColumn(3).setMaxWidth(0);
        ...
        jBtNovaParcela.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gestor/Imagens/7183_16x16.png"))); // NOI18N
    ...
    private void jBtPesqCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoActionPerformed
        ...
        if (jCodigoDoc.getText().equals("")) {
            ...
            pesquisarNFeCompras("SELECT * FROM NF_COMPRAS_NUTRI "
                    + "INNER JOIN FORNECEDORES_AC "
                    + "ON NF_COMPRAS_NUTRI.IdForn=FORNECEDORES_AC.IdForn "
    ...
    private void jCheckBoxTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {           
            this.pesquisarNFeCompras("SELECT * FROM NF_COMPRAS_NUTRI "
                    + "INNER JOIN FORNECEDORES_AC "
                    + "ON NF_COMPRAS_NUTRI.IdForn=FORNECEDORES_AC.IdForn");
        } else {
            jtotalRegistros.setText("");
           limparTabelaNFeCompras();
        }
    ...
    private void jTabelaNFeComprasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaNFeComprasMouseClicked
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM NF_COMPRAS_NUTRI "
                        + "INNER JOIN FORNECEDORES_AC "
                        + "ON NF_COMPRAS_NUTRI.IdForn=FORNECEDORES_AC.IdForn "
            ...
            count = 0;
            preencherTabelaItens("SELECT * FROM ITENS_COMPRAS_MATERIAIS_NUTRI "
                    + "INNER JOIN NF_COMPRAS_NUTRI "
                    + "ON ITENS_COMPRAS_MATERIAIS_NUTRI.IdNfEntrada=NF_COMPRAS_NUTRI.IdNfEntrada "
                    + "INNER JOIN PRODUTOS_AC "
                    + "ON ITENS_COMPRAS_MATERIAIS_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                    + "WHERE ITENS_COMPRAS_MATERIAIS_NUTRI.IdNfEntrada='" + jCodigoDoc.getText() + "'");
            preencherTabelaParcelas("SELECT * FROM PARCELAS_COMPRAS_NUTRI "
                    + "INNER JOIN NF_COMPRAS_NUTRI "
                    + "ON PARCELAS_COMPRAS_NUTRI.IdNfEntrada=NF_COMPRAS_NUTRI.IdNfEntrada "
                    + "INNER JOIN FORNECEDORES_AC "
                    + "ON PARCELAS_COMPRAS_NUTRI.IdForn=FORNECEDORES_AC.IdForn "
                    + "WHERE NF_COMPRAS_NUTRI.IdNfEntrada='" + jCodigoDoc.getText() + "'");
        }
    ...
    private void jBtPesDescricaoFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesDescricaoFornecedorActionPerformed
        // TODO add your handling code here:
        TelaPesqFornecedorNFeComprasNUTRI objPesqForNUTRI = new TelaPesqFornecedorNFeComprasNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objPesqForNUTRI);
        objPesqForNUTRI.show();
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        if (jNrNFe.getText().equals("")) {
            ...
            if (acao == 1) {
                ...
                control.incluirNFeComprasNUTRI(objNFEComprasv);
                buscarCodigoDoc();
                //
                objLog();
            ...
            if (acao == 2) {
                ...
                control.alterarNFeComprasNUTRI(objNFEComprasv);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                Salvar();
                JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaEntradasProdutosNUTRI objAudiProdNUTRI = new TelaAuditoriaEntradasProdutosNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objAudiProdNUTRI);
        objAudiProdNUTRI.show();
    ...
    private void jBtBuscarProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtBuscarProdutoActionPerformed
        // TODO add your handling code here:
        TelaPesqProdutoComprasNUTRI objPesqProdCompNUTRI = new TelaPesqProdutoComprasNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objPesqProdCompNUTRI);
        objPesqProdCompNUTRI.show();
    ...
    private void jTabelaItensNFeComprasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaItensNFeComprasMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM ITENS_COMPRAS_MATERIAIS_NUTRI "
                        + "INNER JOIN PRODUTOS_AC "
                        + "ON ITENS_COMPRAS_MATERIAIS_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                        + "WHERE ITENS_COMPRAS_MATERIAIS_NUTRI.IdNfEntrada='" + jIdLanc.getText() + "'AND "
    ...
    private void jBtExcluirItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirItemActionPerformed
        ...
        if (jStatusNFe.getText().equals("FINALIZADO")) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                controle.excluirItensComprasNUTRI(objItensCompras);
                //
                objHistCompra.setIdCompra(Integer.valueOf(jNrNFe.getText()));
                controleHist.excluirHistoricoComprasProdutoNUTRI(objHistCompra);
                //
                ...
                preencherTabelaItens("SELECT * FROM ITENS_COMPRAS_MATERIAIS_NUTRI "
                        ...
                        + "INNER JOIN PRODUTOS_AC "
                        + "ON ITENS_COMPRAS_MATERIAIS_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                        + "WHERE NF_COMPRAS_NUTRI.IdNfEntrada='" + jIdLanc.getText() + "'");
            }
        }
    ...
    private void jBtSalvarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarItemActionPerformed
        ...
        if (jIdProd.getText().equals("")) {
            ...
            if (acao == 3) {
                ...
                controle.incluirItensComprasNUTRI(objItensCompras);
                buscarItem();
                ...
                controleHist.incluirHistoricoComprasProdutoNUTRI(objHistCompra);
                ...
                controlAtualCompras.incluirDadosFornecedorNUTRI(objHistorForn);
                //
                objLog2();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                preencherTabelaItens("SELECT * FROM ITENS_COMPRAS_MATERIAIS_NUTRI "
            ...
            if (acao == 4) {
                ...
                objItensCompras.setIdItem(Integer.valueOf(idItem));
                controle.alterarItensComprasNUTRI(objItensCompras);
                // INCLUIR PRODUTO NA TABELA HISTORICO_COMPRA_AC
                objHistCompra.setIdCompra(Integer.valueOf(jIdLanc.getText()));
                ...
                controleHist.alterarHistoricoComprasProdutoNUTRI(objHistCompra);
                //
                objLog2();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                preencherTabelaItens("SELECT * FROM ITENS_COMPRAS_MATERIAIS_NUTRI "
    ...
    private void jBtAuditoriaItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaItemActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensEntradaProdutosNUTRI objAudiItensNUTRI = new TelaAuditoriaItensEntradaProdutosNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objAudiItensNUTRI);
        objAudiItensNUTRI.show();
    ...
    private void jTabelaParcelasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaParcelasMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM PARCELAS_COMPRAS_NUTRI "
                        + "INNER JOIN NF_COMPRAS_NUTRI "
                        + "ON PARCELAS_COMPRAS_NUTRI.IdNfEntrada=NF_COMPRAS_NUTRI.IdNfEntrada "
                        + "INNER JOIN FORNECEDORES_AC "
                        + "ON PARCELAS_COMPRAS_NUTRI.IdForn=FORNECEDORES_AC.IdForn "
                        + "WHERE PARCELAS_COMPRAS_NUTRI.IdParc='" + jCodParcela.getText() + "'");
                conecta.rs.first();
    ...
    private void jBtExcluirParcelaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirParcelaActionPerformed
        ...
        if (jStatusNFe.getText().equals("FINALIZADO")) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                controlParCompras.excluirParcelasComprasNUTRI(objParCompras);
                objLog3();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                preencherTabelaParcelas("SELECT * FROM PARCELAS_COMPRAS_NUTRI "
                        ...
                        + "INNER JOIN FORNECEDORES_AC "
                        + "ON PARCELAS_COMPRAS_NUTRI.IdForn=FORNECEDORES_AC.IdForn "
                        + "WHERE NF_COMPRAS_NUTRI.IdNfEntrada='" + objParCompras.getIdNfEntrada() + "'");
            }
            ExcluirParcela();
        }
    ...
    private void jBtSalvarParcelaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarParcelaActionPerformed
        ...
        if (jDataVctoParcela.getDate() == null) {
            ...
            if (acao == 5) {
                ...
                //               
                controlParCompras.incluirParcelasComprasNUTRI(objParCompras);
                buscarCodParcela();
                objLog3();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                preencherTabelaParcelas("SELECT * FROM PARCELAS_COMPRAS_NUTRI "
            ...
            if (acao == 6) {
                ...
                //
                objParCompras.setIdParc(Integer.valueOf(jCodParcela.getText()));
                controlParCompras.alterarParcelasComprasNUTRI(objParCompras);
                objLog3();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                preencherTabelaParcelas("SELECT * FROM PARCELAS_COMPRAS_NUTRI "
                        + "INNER JOIN NF_COMPRAS_NUTRI "
    ...
    private void jBtAuditoriaParcelaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaParcelaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensParcelasEntradaNUTRI objAudiParcEntraNUTRI = new TelaAuditoriaItensParcelasEntradaNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objAudiParcEntraNUTRI);
        objAudiParcEntraNUTRI.show();
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM NF_COMPRAS_NUTRI WHERE IdNfEntrada='" + jIdLanc.getText() + "'");
            conecta.rs.first();
            jStatusNFe.setText(conecta.rs.getString("StatusNf"));
            if (jStatusNFe.getText().equals("FINALIZADO")) {
    ...
    private void jBtPesqLocalArmazenamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqLocalArmazenamentoActionPerformed
        // TODO add your handling code here:
        TelaPesqLocalArmazenamentoNFeComprasNUTRI objPesqLocalArm = new TelaPesqLocalArmazenamentoNFeComprasNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objPesqLocalArm);
    ...
    public void Novo() {
        ...
        jBtFinalizar.setEnabled(!true);
        jBtAuditoria.setEnabled(!true);
        // Limpa a tabela dos itens (Produtos)/Parcelas
        limparTabelaItens();
        ...
        if (rows == 0) {
            ...
            for (int i = 0; i < jTabelaItensNFeCompras.getRowCount(); i++) {
                ...
                if (codProduto == objProdMed.getIdProd() && (numeroLote == null ? objProdMed.getLote() == null : numeroLote.equals(objProdMed.getLote())) || codProduto == objProdMed.getIdProd() && numeroLote.equals("")) { // Se existir altera
                    ...
                    controlLote.incluirNovoLoteProdutoNUTRI(objProdMed);
                ...
                controlHistMov.incluirHistoricoProdutoNUTRI(objHistMovAC); // INCLUI O NOVO REGISTRO NA TABELA HISTORICO_MOVIMENTACAO_ESTOQUE_AC                      
                ...
                objProdMed.setDataValidade(date);
                controlAtualCompras.alterarDadosComprasNUTRI(objProdMed);
            }
            Finalizar();
        }
    }
    ...
    public void Finalizar() {
        ...
        control.finalizarNFeComprasNUTRI(objNFEComprasv);
    ...
    public void verificarItens() {
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENS_COMPRAS_MATERIAIS_NUTRI WHERE IdNfEntrada='" + jIdLanc.getText() + "'");
            conecta.rs.first();
            ...
            if (jIdLanc.getText().equals(codEntrada)) {
                ...
                conecta.executaSQL("SELECT * FROM PARCELAS_COMPRAS_NUTRI WHERE IdNfEntrada='" + jIdLanc.getText() + "'");
                conecta.rs.first();
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                objNFEComprasv.setIdNfEntrada(Integer.parseInt(jIdLanc.getText()));
                control.excluirNFeComprasNUTRI(objNFEComprasv);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                Excluir();
    ...
    public void pesquisarNFeCompras(String sql) {
        ...
        alinharCamposTabelaNFeCompras();
        conecta.desconecta();
    }

    public void limparTabelaNFeCompras() {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Código", "Dt.Emissao", "Status NFE", "Dt.Entrada", "Fornecedor", "Valor NFE"};
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaNFeCompras.setModel(modelo);
    ...
    public void alinharCamposTabelaNFeCompras() {
        //
        ...
        jTabelaNFeCompras.getColumnModel().getColumn(5).setCellRenderer(esquerda);
    }
    ...
    public void alinhaCamposTabelaItens() {
        ...
        jTabelaItensNFeCompras.getColumnModel().getColumn(2).setCellRenderer(centralizado);
    ...
    public void alinharCamposTabelaParcelas() {
        //
        DefaultTableCellRenderer esquerda = new DefaultTableCellRenderer();
        DefaultTableCellRenderer centralizado = new DefaultTableCellRenderer();
        DefaultTableCellRenderer direita = new DefaultTableCellRenderer();
