 ...
 * @author Ronaldo
 */
public class TelaPesqRequisicaoAvulsaMateriaisAC extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqRequisicaoAvulsaMateriaisAC() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (jTabelaRequisicoes.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaRequisicoes.getColumnModel().getColumn(1).setMinWidth(70);
            jTabelaRequisicoes.getColumnModel().getColumn(1).setMaxWidth(70);
    ...
    private void jBtDescricaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtDescricaoActionPerformed
        ...
        if (jPesqNomeRequisitante.getText().equals("")) {
            ...
            preencherTabela("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS "
                    + "INNER JOIN COLABORADOR "
                    + "ON REQUISICAO_AVULSA_PRODUTOS.IdFunc=COLABORADOR.IdFunc "
                    + "WHERE NomeFunc LIKE'%" + jPesqNomeRequisitante.getText() + "%'AND "
                    + "REQUISICAO_AVULSA_PRODUTOS.StatusReq='" + statusReq + "'");
        }
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabela("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS "
                    + "INNER JOIN COLABORADOR "
                    + "ON REQUISICAO_AVULSA_PRODUTOS.IdFunc=COLABORADOR.IdFunc "
                    + "WHERE REQUISICAO_AVULSA_PRODUTOS.StatusReq='" + statusReq + "'");
        } else {
            limparTabela();
        }
