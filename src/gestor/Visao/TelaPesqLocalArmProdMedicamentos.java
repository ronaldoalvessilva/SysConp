...
import static gestor.Visao.TelaMedicamentos.jLocalMaster;
 ...
 * @author user
 */
public class TelaPesqLocalArmProdMedicamentos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqLocalArmProdMedicamentos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setResizable(true);
        setTitle("...::: Listagem de Armazenamento {FA} :::...");
    ...
    private void jBtPesqDescricaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoActionPerformed
        ...
        if (jPesqDescricaoLocal.getText().equals("")) {
            ...
            preencherTabelaLocais("SELECT * FROM LOCAL_ARMAZENAMENTO_AC WHERE DescricaoLocal LIKE'%" + jPesqDescricaoLocal.getText() + "%' AND StatusLocal='" + statusLocal + "'AND NivelLocal='" + nivelLocalFar + "'AND Modulo='" + modulo + "'");
        }
    ...
    private void jCheckBoxTodosLocaisItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosLocaisItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaLocais("SELECT * FROM LOCAL_ARMAZENAMENTO_AC WHERE StatusLocal='" + statusLocal + "'AND NivelLocal='" + nivelLocalFar + "'AND Modulo='" + modulo + "'");
        } else {
            limparTabelaLocais();
        }
    ...
    public void limparTabelaLocais() {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Código", "Descrição Local"};
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaLocais.setModel(modelo);
