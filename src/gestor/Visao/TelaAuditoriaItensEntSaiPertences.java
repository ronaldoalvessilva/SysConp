...
import static gestor.Visao.TelaEntradaSaidaPertences.idItem;
import static gestor.Visao.TelaEntradaSaidaPertences.jIDLanc;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntSaiPertences extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEntSaiPertences() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSPERTENCES WHERE IdLanc='" + jIDLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
