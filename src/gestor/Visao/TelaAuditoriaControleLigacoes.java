...
import static gestor.Visao.TelaControleLigacoesSS.jIDControle;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaControleLigacoes extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaControleLigacoes() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Controle Ligações {SS} :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM CONTROLIGA WHERE IdControl='" + jIDControle.getText() + "'");
            conecta.rs.first();
