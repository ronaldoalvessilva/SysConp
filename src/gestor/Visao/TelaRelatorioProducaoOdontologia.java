 ...
 */
public class TelaRelatorioProducaoOdontologia extends javax.swing.JInternalFrame {
     ...
     */
    public TelaRelatorioProducaoOdontologia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Relatório de Produtividade Odontologia :::...");
        ...
        if (tipoServidor == null || tipoServidor.equals("")) {
            ...
            if (jDataInicial.getDate() == null) {
                ...
                try {
                    ...
                    String path = "reports/RelatorioQuantitativoAtendimentoOdontologico.jasper";
                    conecta.executaSQL("SELECT * FROM ODONTOPROCEDIMENTO "
                            + "INNER JOIN PRONTUARIOSCRC "
                            + "ON ODONTOPROCEDIMENTO.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                            + "WHERE DataPro BETWEEN'" + dataInicial + "' "
                            + "AND '" + dataFinal + "' "
                            + "ORDER BY ODONTOPROCEDIMENTO.UsuarioInsert,ODONTOPROCEDIMENTO.DataPro");
                    ...
                    jv.setTitle("Relatório de Quantidade de Atendimento Odontologia por Período");
