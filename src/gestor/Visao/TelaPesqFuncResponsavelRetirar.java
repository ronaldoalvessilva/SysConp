...
import static gestor.Visao.TelaRetirarPenalidadeInterno.jResponsavelAutoriazacao;
 ...
 * @author Ronaldo
 */
public class TelaPesqFuncResponsavelRetirar extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqFuncResponsavelRetirar() {
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesNomeColaborador.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM COLABORADOR WHERE NomeFunc='" + jPesNomeColaborador.getText() + "'");
                conecta.rs.first();
