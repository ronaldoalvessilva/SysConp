...
import static gestor.Visao.TelaAtendimentoTerapiaOcupacional.codigoHistoricoEduca;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaHistoricoEducacional extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();      
    /**
     * Creates new form TelaAuditoriaRolInternas
     */
    public TelaAuditoriaHistoricoEducacional() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Histórico Educacional :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM TO_HISTORICO_EDUCACIONAL WHERE IdHistoricoEdu='" + codigoHistoricoEduca + "'");
            conecta.rs.first();
