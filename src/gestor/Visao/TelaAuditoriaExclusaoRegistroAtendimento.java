...
import static gestor.Visao.TelaCancelamentoAtendimentoPSP.jCodigoRegistro;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaExclusaoRegistroAtendimento extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaExclusaoRegistroAtendimento() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ELIMIAR_ASSINATURA_INTERNO_PSP "
                    + "WHERE IdCancel='" + jCodigoRegistro.getText() + "'");
            conecta.rs.first();
