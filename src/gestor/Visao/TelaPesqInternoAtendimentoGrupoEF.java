 ...
 * @author Ronaldo
 */
public class TelaPesqInternoAtendimentoGrupoEF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoAtendimentoGrupoEF() {
        initComponents();
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTabelaNome("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "AND PAVILHAO.DescricaoPav='" + jComboBoxPavilhaoGaleria.getSelectedItem() + "' "
