...
import static gestor.Visao.TelaEntradaObjetosPertences.jIdLanc;
import static gestor.Visao.TelaEntradaObjetosPertences.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensPertencesSeg extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensPertencesSeg() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSOBJETOS WHERE IdEntrada='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
