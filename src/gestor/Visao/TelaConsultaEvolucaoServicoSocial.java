 ...
 * @author ronaldo
 */
public class TelaConsultaEvolucaoServicoSocial extends javax.swing.JDialog {
    ...
    /**
     * Creates new form TelaConsultaPsicologia
     */
    public static TelaConsultaProntuarioInternoCrc telaPronturaioUnicoSS;

    public TelaConsultaEvolucaoServicoSocial(TelaConsultaProntuarioInternoCrc parent, boolean modal) {
        this.telaPronturaioUnicoSS = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaPronturaioUnicoSS);
        initComponents();
        formatarCampos();
    ...
    private void initComponents() {
        ...
        jNomeInternoServiçoSocial = new javax.swing.JTextField();
        ...
        setTitle("...::: Evolução Serviço Social :::...");
        ...
        jNomeInternoServiçoSocial.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jNomeInternoServiçoSocial.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        jNomeInternoServiçoSocial.setEnabled(false);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jNomeInternoServiçoSocial))
                .addGap(25, 25, 25))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jNomeInternoServiçoSocial, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTabelaDatasEvolucaoPsicologica.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Data", "Evolução Serviço Social"
            }
        ));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true), "Evolução Serviço Social", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(0, 0, 255))); // NOI18N
    ...
    private void jCheckBoxTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarData("SELECT * FROM EVOLUCAO_ATENDIMENTO_SOCIAL "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON EVOLUCAO_ATENDIMENTO_SOCIAL.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "                   
                    + "WHERE EVOLUCAO_ATENDIMENTO_SOCIAL.IdInternoCrc='" + jIdInternoConPSP.getText() + "'");
        } else {
        ...
        if (jDataInicial.getDate() == null) {
            ...
            if (jDataFinal.getDate() == null) {
                ...
                if (jDataInicial.getDate().after(jDataFinal.getDate())) {
                    ...
                    pesquisarData("SELECT * FROM EVOLUCAO_ATENDIMENTO_SOCIAL "
                            + "INNER JOIN PRONTUARIOSCRC "
                            + "ON EVOLUCAO_ATENDIMENTO_SOCIAL.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "                          
                            + "WHERE EVOLUCAO_ATENDIMENTO_SOCIAL.DataEvol BETWEEN'" + dataInicial + "' "
                            + "AND '" + dataFinal + "'AND EVOLUCAO_ATENDIMENTO_SOCIAL.IdInternoCrc='" + jIdInternoConPSP.getText() + "'");
                }
            }
        }
    ...
    private void jTabelaDatasEvolucaoPsicologicaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaDatasEvolucaoPsicologicaMouseClicked
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM EVOLUCAO_ATENDIMENTO_SOCIAL WHERE IdItem='" + codItem + "'AND IdInternoCrc='" + jIdInternoConPSP.getText() + "'");
                conecta.rs.first();
                jTextoEvolucaoPsiquiatrica.setText(conecta.rs.getString("TextoEvolucao"));
                conecta.desconecta();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaEvolucaoServicoSocial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaConsultaEvolucaoServicoSocial dialog = new TelaConsultaEvolucaoServicoSocial(telaPronturaioUnicoSS, true);
    ...
    private javax.swing.JTextField jNomeInternoServiçoSocial;
    ...
    public void pesquisarData(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Data", "Evolução Serviço Social"};
        conecta.abrirConexao();
        try {
