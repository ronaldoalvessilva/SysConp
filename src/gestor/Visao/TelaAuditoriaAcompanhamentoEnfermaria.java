...
import static gestor.Visao.TelaTPC.codigoEnf;
 ...
 * @author ronal
 */
public class TelaAuditoriaAcompanhamentoEnfermaria extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    /**
     * Creates new form TelaAuditoriaAcompanhamentoEnfermaria
     */
    public static TelaTPC tPC;

    public TelaAuditoriaAcompanhamentoEnfermaria(TelaTPC parent, boolean modal) {
        this.tPC = parent;
        this.setModal(modal);
        setLocationRelativeTo(tPC);
        initComponents();
        auditoria();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAuditoriaAcompanhamentoEnfermaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAuditoriaAcompanhamentoEnfermaria dialog = new TelaAuditoriaAcompanhamentoEnfermaria(tPC, true);
