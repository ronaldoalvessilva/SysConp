 ...
 * @author user
 */
public class TelaPesqDeptoAdvogados extends javax.swing.JInternalFrame {
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if(jNomeDepartamento.getText().equals("")){
            ...
            jTabelaPesqDepartamento.setVisible(true);
            buscarVisitas("SELECT * FROM DEPARTAMENTOS WHERE NomeDepartamento LIKE'%" + jNomeDepartamento.getText()+ "%'");
        }            
...
//Preencher tabela com todos os COLABORADORES
    public void buscarVisitas(String sql) {
        ArrayList dados = new ArrayList();
            String[] Colunas = new String[]{"ID", "    Nome do Departamento"};
        conecta.abrirConexao();
        try {
