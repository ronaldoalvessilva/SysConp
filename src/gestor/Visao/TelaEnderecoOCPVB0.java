...
import static gestor.Visao.TelaInformacoesInternoBCB0.jIdInternoBCB0;
 ...
 */
public class TelaEnderecoOCPVB0 extends javax.swing.JDialog {
     ...
     */
    public static TelaInformacoesInternoBCB0 ENDERbcb0;

    public TelaEnderecoOCPVB0(TelaInformacoesInternoBCB0 parent, boolean modal) {
        this.ENDERbcb0 = parent;
        this.setModal(modal);
        setLocationRelativeTo(ENDERbcb0);
        initComponents();
        pesquisarEndereco();
        corCampos();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaEnderecoOCPVB0.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaEnderecoOCPVB0 dialog = new TelaEnderecoOCPVB0(ENDERbcb0, true);
    ...
    public void pesquisarEndereco() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                    + "WHERE IdInternoCrc='" + jIdInternoBCB0.getText() + "'");
            conecta.rs.first();
