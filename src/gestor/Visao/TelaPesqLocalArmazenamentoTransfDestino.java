...
import static gestor.Visao.TelaTransferenciaEstoqueFarmacia.jIdLocalDestino;
import static gestor.Visao.TelaTransferenciaEstoqueFarmacia.jDescricaoLocalDestino;
 ...
 * @author user
 */
public class TelaPesqLocalArmazenamentoTransfDestino extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqLocalArmazenamentoTransfDestino() {
        initComponents();
    }
    ...
    private void jBtPesqDescricaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoActionPerformed
        ...
        if (jPesqDescricaoLocal.getText().equals("")) {
            ...
            jTabelaLocais.setVisible(true);
            preencherTabelaLocais("SELECT * FROM LOCAL_ARMAZENAMENTO_AC WHERE DescricaoLocal LIKE'%" + jPesqDescricaoLocal.getText() + "%' AND StatusLocal='" + statusLocal + "'AND NivelLocal='" + nivelLocalEnf + "'AND Modulo='" + modulo + "'");
        }
    ...
    private void jCheckBoxTodosLocaisItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosLocaisItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            jTabelaLocais.setVisible(true);
            this.preencherTabelaLocais("SELECT * FROM LOCAL_ARMAZENAMENTO_AC WHERE StatusLocal='" + statusLocal + "'AND NivelLocal='" + nivelLocalEnf + "'AND Modulo='" + modulo + "'");
        } else {
            jTabelaLocais.setVisible(!true);
        }
