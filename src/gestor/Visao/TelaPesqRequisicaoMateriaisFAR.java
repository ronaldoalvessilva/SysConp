 ...
 * @author Ronaldo
 */
public class TelaPesqRequisicaoMateriaisFAR extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqRequisicaoMateriaisFAR() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa Transferência de Produtos :::...");
        ...
        if (jPesqNomeRequisitante.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM TRANSFERENCIA_PRODUTO_FAR "
                        ...
                        + "AND TRANSFERENCIA_PRODUTO_FAR.IdLanc='" + codigoLanc + "'");
                conecta.rs.first();
                jIdDoc.setText(conecta.rs.getString("IdLanc"));
                jDataReq.setDate(conecta.rs.getDate("DataLanc"));
    ...
    private void jBtDescricaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtDescricaoActionPerformed
        ...
        if (jPesqNomeRequisitante.getText().equals("")) {
            ...
            preencherTabela("SELECT * FROM TRANSFERENCIA_PRODUTO_FAR "
                    + "INNER JOIN COLABORADOR "
                    + "ON TRANSFERENCIA_PRODUTO_FAR.IdFunc=COLABORADOR.IdFunc "
                    + "WHERE NomeFunc LIKE'%" + jPesqNomeRequisitante.getText() + "%'AND "
                    + "TRANSFERENCIA_PRODUTO_FAR.StatusLanc='" + statusReq + "'");
        }
...
//            String idFunc = "" + jTabelaRequisicao.getValueAt(jTabelaRequisicao.getSelectedRow(), 0);
            codigoLanc = "" + jTabelaRequisicao.getValueAt(jTabelaRequisicao.getSelectedRow(), 0);
        }
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabela("SELECT * FROM TRANSFERENCIA_PRODUTO_FAR "
                    + "INNER JOIN COLABORADOR "
                    + "ON TRANSFERENCIA_PRODUTO_FAR.IdFunc=COLABORADOR.IdFunc "
                    + "WHERE TRANSFERENCIA_PRODUTO_FAR.StatusLanc='" + statusReq + "'");
        } else {
    ...
    public void preencherTabela(String sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdLanc"), dataEntrada, conecta.rs.getString("NomeFunc")});
