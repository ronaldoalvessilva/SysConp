...
import static gestor.Visao.TelaMovimentacaoCrcBaseSeguranca.jDataNascimento;
import static gestor.Visao.TelaMovimentacaoCrcBaseSeguranca.jDataPena;
import static gestor.Visao.TelaMovimentacaoCrcBaseSeguranca.jFotoInterno;
import static gestor.Visao.TelaMovimentacaoCrcBaseSeguranca.jIdInterno;
import static gestor.Visao.TelaMovimentacaoCrcBaseSeguranca.jMatriculaPenalInterno;
import static gestor.Visao.TelaMovimentacaoCrcBaseSeguranca.jNomeInterno;
import static gestor.Visao.TelaMovimentacaoCrcBaseSeguranca.jRegime;
import static gestor.Visao.TelaMovimentacaoCrcBaseSeguranca.jTabelaMovimentacao;
import static gestor.Visao.TelaMovimentacaoCrcBaseSeguranca.jUnidadePenal;
import static gestor.Visao.TelaMovimentacaoCrcBaseSeguranca.jtotalRegistros;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaMovInternoCrcBaseSeguranca extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaMovInternoCrcBaseSeguranca() {
        initComponents();
    }
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jPesqMatricula, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jTabelaInternoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaInternoMouseClicked
        ...
        if (flag == 1) {
            ...
            idIntSeg = "" + jTabelaInterno.getValueAt(jTabelaInterno.getSelectedRow(), 0);
        }
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                        ...
                        + "INNER JOIN UNIDADE "
                        + "ON DADOSPENAISINTERNOS.IdUnid=UNIDADE.IdUnid "
                        + "WHERE PRONTUARIOSCRC.NomeInternoCrc='" + nomeInterno + "'AND PRONTUARIOSCRC.IdInternoCrc='" + idIntSeg + "'");
                conecta.rs.first();
