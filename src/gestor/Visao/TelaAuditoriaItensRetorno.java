...
import static gestor.Visao.TelaRetornoInterno.idItem;
import static gestor.Visao.TelaRetornoInterno.jIDLanc;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRetorno extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRetorno() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSRETORNO WHERE IdRetorno='" + jIDLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
