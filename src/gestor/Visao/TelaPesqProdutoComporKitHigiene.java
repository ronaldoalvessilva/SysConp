 ...
 * @author user
 */
public class TelaPesqProdutoComporKitHigiene extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoComporKitHigiene() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Produtos {AC} - COMPOR KIT :::...");
        ...
        if (jTabelaProdutos.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaProdutos.getColumnModel().getColumn(1).setMinWidth(350);
            jTabelaProdutos.getColumnModel().getColumn(1).setMaxWidth(350);
    ...
    public void preencherTabelaProdutos(String sql) {
        ...
        jTabelaProdutos.getColumnModel().getColumn(1).setPreferredWidth(350);
