...
import static gestor.Visao.TelaRegimentoInternoDisciplinar.idItemAutor;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegimeDisciplinarInternos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegimeDisciplinarInternos() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AUTORES_REGIMENTO_DISCIPLINAR WHERE IdReg='" + jCodigoReg.getText() + "'AND IdAutor='" + idItemAutor + "'");
            conecta.rs.first();
