 ...
 * @author user
 */
public class TelaPesqProdutoEstornoRequisicaoAvulsaMateriaisFAR extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoEstornoRequisicaoAvulsaMateriaisFAR() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Requisição Avulsa de Produtos {FAR} :::...");
        ...
        if (jTabelaProdutos.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaProdutos.getColumnModel().getColumn(1).setMinWidth(280);
            jTabelaProdutos.getColumnModel().getColumn(1).setMaxWidth(280);
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "INNER JOIN ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR "
                    + "ON PRODUTOS_AC.IdProd=ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR.IdProd "
                    + "WHERE PRODUTOS_AC.DescricaoProd LIKE'%" + jPesqDescricaoProdutos.getText() + "%'AND PRODUTOS_AC.StatusProd='" + statusProd + "'AND Qtd!='" + 0 + "'AND EstornoProduto='" + estornoProduto + "'AND IdReq='" + jIdDoc.getText() + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        }
        ...
        if (jPesqDescricaoProdutos.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRODUTOS_AC "
                        ...
                        + "INNER JOIN ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR "
                        + "ON PRODUTOS_AC.IdProd=ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR.IdProd "
                        + "WHERE PRODUTOS_AC.DescricaoProd='" + jPesqDescricaoProdutos.getText() + "'AND PRODUTOS_AC.StatusProd='" + statusProd + "'AND PRODUTOS_AC.IdProd='" + idInt + "'AND Qtd!='" + 0 + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
                conecta.rs.first();
    ...
    private void jCheckBoxPesqTodosProdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosProdItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            ...
            this.preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "INNER JOIN ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR "
                    + "ON PRODUTOS_AC.IdProd=ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR.IdProd "
                    + "WHERE PRODUTOS_AC.StatusProd='" + statusProd + "'AND Qtd!='" + 0 + "'AND EstornoProduto='" + estornoProduto + "'AND IdReq='" + jIdDoc.getText() + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        } else {
    ...
    public void preencherTabelaProdutos(String sql) {
        ...
        jTabelaProdutos.getColumnModel().getColumn(1).setPreferredWidth(280);
