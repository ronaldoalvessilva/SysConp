...
import static gestor.Visao.TelaLocalEstoqueAcervo.jIdLocal;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaLocalAcervos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaLocalAcervos() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Locais Acervos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM LOCAL_ACERVO WHERE IdLocal='" + jIdLocal.getText() + "'");
            conecta.rs.first();
