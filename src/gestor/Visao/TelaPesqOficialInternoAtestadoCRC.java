...
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jCncAtestado;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jDatEntradaAtestado;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jIdVisitaAtestado;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jMaeInternoAtestado;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jNomeInternoAtestado;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jNomeSolicitanteAtestado;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jParentescoAtestado;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jRegimePenalAux;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.codigoSoliAtestado;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jAnos;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jComboBoxAlinea;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jComboBoxArtigo;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jComboBoxInciso;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jComboBoxParagrafo;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jComboBoxRegimeProcesso;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jComboBoxSentenca;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jComboBoxSituacaoPresoProcesso;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jComboBoxTipoSentencaCondenatoria;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jDataDocumentoPrisao;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jDataInicioProcesso;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jDataTerminoProcesso;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jDescricaoAmparoLegal;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jDescricaoNaturezaPrisao;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jDias;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jDocumentoPrisao;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jHoraDocumento;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jIdAmparo;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jIdInternoAtestado;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jIdNatp;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jMeses;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jNumeroInquerito;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jNumeroProcesso;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jObservacaoProcesso;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jOrigemDocumentoPrisao;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jTabelaAmparoLegal;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jTabelaDocumentosProcesso;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jTabelaProcesso;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.jTotalDias;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.codIncPen;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.codProdDoc;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.codigoFichaJuridica;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.codigoInterno;
import static gestor.Visao.TelaEmissaoAtestadoReclusaoCRC.codProc;
 ...
 * @author Ronaldo
 */
public class TelaPesqOficialInternoAtestadoCRC extends javax.swing.JInternalFrame {
    ...
    String finalidade = "Oficial de Justiça";

    /**
     * Creates new form TelaPesquisaEntradaInternos
     */
    public TelaPesqOficialInternoAtestadoCRC() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabelaOficial = new javax.swing.JTable();
        ...
        jTabelaOficial.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jTabelaOficial.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Registro", "Código", "Nome do Oficial de Justiça", "Código", "Nome do Interno"
            }
        ));
        jTabelaOficial.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTabelaOficialMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTabelaOficial);
        if (jTabelaOficial.getColumnModel().getColumnCount() > 0) {
            jTabelaOficial.getColumnModel().getColumn(0).setMinWidth(60);
            jTabelaOficial.getColumnModel().getColumn(0).setMaxWidth(60);
            jTabelaOficial.getColumnModel().getColumn(1).setMinWidth(60);
            jTabelaOficial.getColumnModel().getColumn(1).setMaxWidth(60);
            jTabelaOficial.getColumnModel().getColumn(2).setMinWidth(320);
            jTabelaOficial.getColumnModel().getColumn(2).setMaxWidth(320);
            jTabelaOficial.getColumnModel().getColumn(3).setMinWidth(60);
            jTabelaOficial.getColumnModel().getColumn(3).setMaxWidth(60);
            jTabelaOficial.getColumnModel().getColumn(4).setMinWidth(320);
            jTabelaOficial.getColumnModel().getColumn(4).setMaxWidth(320);
        }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            pesquisarVisitasRol("SELECT * FROM SOLICITACAO_ATESTADO_RECLUSAO_CRC "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON SOLICITACAO_ATESTADO_RECLUSAO_CRC.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN OFICIAL_JUSTICA "
                    + "ON OFICIAL_JUSTICA.IdOficial=SOLICITACAO_ATESTADO_RECLUSAO_CRC.IdVisita "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
                    + "WHERE OFICIAL_JUSTICA.NomeOficial LIKE'%" + jPesqNome.getText() + "%' "
                    + "AND SOLICITACAO_ATESTADO_RECLUSAO_CRC.UtilizadoCrc='" + utilizacao + "' "
                    + "AND SOLICITACAO_ATESTADO_RECLUSAO_CRC.Finalidade='" + finalidade + "'");
        }
    }//GEN-LAST:event_jBtNomeActionPerformed

    private void jTabelaOficialMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaOficialMouseClicked
        // TODO add your handling code here:
        flag = 1;
        if (flag == 1 && evt.getClickCount() == 1) {
            nomeVisita = "" + jTabelaOficial.getValueAt(jTabelaOficial.getSelectedRow(), 2);
            jPesqNome.setText(nomeVisita);
            idInt = "" + jTabelaOficial.getValueAt(jTabelaOficial.getSelectedRow(), 1);
        }
    }//GEN-LAST:event_jTabelaOficialMouseClicked
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM SOLICITACAO_ATESTADO_RECLUSAO_CRC "
                        ...
                        + "INNER JOIN DADOSPENAISINTERNOS "
                        + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
                        + "WHERE OFICIAL_JUSTICA.NomeOficial='" + nomeVisita + "' "
                        + "AND OFICIAL_JUSTICA.IdOficial='" + idInt + "' ");
                conecta.rs.first();
                codigoSoliAtestado = conecta.rs.getInt("CodRegAux");
                jIdVisitaAtestado.setText(String.valueOf(conecta.rs.getInt("IdOficial")));
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarVisitasRol("SELECT * FROM SOLICITACAO_ATESTADO_RECLUSAO_CRC "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON SOLICITACAO_ATESTADO_RECLUSAO_CRC.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN OFICIAL_JUSTICA "
                    + "ON OFICIAL_JUSTICA.IdOficial=SOLICITACAO_ATESTADO_RECLUSAO_CRC.IdVisita "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
                    + "WHERE SOLICITACAO_ATESTADO_RECLUSAO_CRC.UtilizadoCrc='" + utilizacao + "' "
                    + "AND SOLICITACAO_ATESTADO_RECLUSAO_CRC.Finalidade='" + finalidade + "'");
        } else {
            limparTabela();
        }
    ...
    private javax.swing.JTable jTabelaOficial;
    // End of variables declaration//GEN-END:variables
  // Método de pesquisa pela Descrição

    public void pesquisarVisitasRol(String sql) {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Registro", "Código", "Nome do Oficial de Justiça", "Código", "Nome do Interno"};
        conecta.abrirConexao();
        try {
            conecta.executaSQL(sql);
            conecta.rs.first();
            do {
                dados.add(new Object[]{conecta.rs.getInt("CodRegAux"), conecta.rs.getInt("IdOficial"), conecta.rs.getString("NomeOficial"), conecta.rs.getInt("IdInternoCrc"), conecta.rs.getString("NomeInternoCrc")});
            } while (conecta.rs.next());
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(rootPane, "Dados não encontrado, use o botão TODOS \nPara pesquisar TODOS OS REGISTROS");
        }
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaOficial.setModel(modelo);
        jTabelaOficial.getColumnModel().getColumn(0).setPreferredWidth(60);
        jTabelaOficial.getColumnModel().getColumn(0).setResizable(false);
        jTabelaOficial.getColumnModel().getColumn(1).setPreferredWidth(60);
        jTabelaOficial.getColumnModel().getColumn(1).setResizable(false);
        jTabelaOficial.getColumnModel().getColumn(2).setPreferredWidth(320);
        jTabelaOficial.getColumnModel().getColumn(2).setResizable(false);
        jTabelaOficial.getColumnModel().getColumn(3).setPreferredWidth(60);
        jTabelaOficial.getColumnModel().getColumn(3).setResizable(false);
        jTabelaOficial.getColumnModel().getColumn(4).setPreferredWidth(320);
        jTabelaOficial.getColumnModel().getColumn(4).setResizable(false);
        jTabelaOficial.getTableHeader().setReorderingAllowed(false);
        jTabelaOficial.setAutoResizeMode(jTabelaOficial.AUTO_RESIZE_OFF);
        jTabelaOficial.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        alinharCamposTabela();
        conecta.desconecta();
    }
    ...
    public void alinharCamposTabela() {
        ...
        //
        jTabelaOficial.getColumnModel().getColumn(0).setCellRenderer(centralizado);
        jTabelaOficial.getColumnModel().getColumn(1).setCellRenderer(centralizado);
        jTabelaOficial.getColumnModel().getColumn(3).setCellRenderer(centralizado);
    }
