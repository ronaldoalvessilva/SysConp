...
import static gestor.Visao.TelaRevalidacaoAtestadoReclusao.codigoLiberador;
import static gestor.Visao.TelaRevalidacaoAtestadoReclusao.dataAssinatura;
import static gestor.Visao.TelaRevalidacaoAtestadoReclusao.horaAssinatura;
import static gestor.Visao.TelaRevalidacaoAtestadoReclusao.jBtSalvar;
import static gestor.Visao.TelaRevalidacaoAtestadoReclusao.nomeLiberador;
import static gestor.Visao.TelaRevalidacaoAtestadoReclusao.pDigitalCapturadaColaborador;
import static gestor.Visao.TelaRevalidacaoAtestadoReclusao.pLiberacaoImpressa;
import static gestor.Visao.TelaRevalidacaoAtestadoReclusao.dataLiberacao;
import static gestor.Visao.TelaRevalidacaoAtestadoReclusao.codigoValidador;
import static gestor.Visao.TelaRevalidacaoAtestadoReclusao.jComboBoxClassAtestado;
 ...
 * @author Ronaldo
 */
public class TelaAssinaturaoBiometriaColaboradoresRevalidaAtestadoReclusao extends javax.swing.JDialog {
     ...
     */
    public static TelaRevalidacaoAtestadoReclusao assinaturaFuncRevaAtestaRec;

    public TelaAssinaturaoBiometriaColaboradoresRevalidaAtestadoReclusao(TelaRevalidacaoAtestadoReclusao parent, boolean modal) {
        this.assinaturaFuncRevaAtestaRec = parent;
        this.setModal(modal);
        setLocationRelativeTo(assinaturaFuncRevaAtestaRec);
        initComponents();
        corCampos();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAssinaturaoBiometriaColaboradoresRevalidaAtestadoReclusao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAssinaturaoBiometriaColaboradoresRevalidaAtestadoReclusao dialog = new TelaAssinaturaoBiometriaColaboradoresRevalidaAtestadoReclusao(assinaturaFuncRevaAtestaRec, true);
    ...
    public void criptografarDadosColaboradorSimetrico(String codigo, String nomeColaborador) {
       ...
       // CRIPTOGRAFIA SIMETRICA: AES,RC2,RC4,RC5, IDEA, Blowfish
        try {
            ...
            Logger.getLogger(TelaAssinaturaoBiometriaColaboradoresRevalidaAtestadoReclusao.class.getName()).log(Level.SEVERE, null, ex);
