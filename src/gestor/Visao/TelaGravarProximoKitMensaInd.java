 ...
 * @author ronal
 */
public class TelaGravarProximoKitMensaInd extends javax.swing.JDialog {
    ...
    public TelaGravarProximoKitMensaInd(TelaProgramacaoKitsHigiene parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGravarProximoKitMensaInd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaGravarProximoKitMensaInd dialog = new TelaGravarProximoKitMensaInd(gravarProximoKitQuinzenal, true);
    ...
    public void buscarCodigoRegistroInternoKitCompleto() {
        ...
        try {
            conecta.executaSQL("SELECT IdKitMensal FROM KITS_MENSAL_INTERNOS");
            conecta.rs.last();
