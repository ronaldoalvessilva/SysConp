 ...
 * @author Ronaldo
 */
public class TelaRelatorioDepositosTriagem extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String origemDeposito = "T"; // Origem do do depósito nda portaria (P)
    String dataInicial, dataFinal;

    /**
     * Creates new form TelaRelatorioDepositosPortaria
     */
    public TelaRelatorioDepositosTriagem() {
        initComponents();
    }
