 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntSaiFuncExterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEntSaiFuncExterna() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Colaboradores :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSENTRADASFUNC WHERE Idlanc='" + jIDlanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
