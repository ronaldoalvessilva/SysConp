...
import static gestor.Visao.TelaModuloServicoSocial.telaHistAvaEmprego;
 ...
 * @author ronaldo
 */
public class TelaHistoricoAvaliacaoEmprego extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    HistoricoAvaliacaoSocial objHistAva = new HistoricoAvaliacaoSocial();
    ControleHistoricoAvaliacaoEmprego control = new ControleHistoricoAvaliacaoEmprego();
    ...
    String nomeModuloTela = "Serviço Social:Histórico Avaliação Emprego:Manutenção";
    String horaMov;
    String dataModFinal;
    int count = 0;
     ...
     */
    public TelaHistoricoAvaliacaoEmprego() {
        initComponents();
        corCampos();
    ...
    private void initComponents() {
        ...
        jTabelaHistoricoAvaliacaoEmprego = new javax.swing.JTable();
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Histórico de Avaliação Emprego :::...");
        setToolTipText("");
        ...
        jTabelaHistoricoAvaliacaoEmprego.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jTabelaHistoricoAvaliacaoEmprego.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null}
            },
            new String [] {
        ...
        jTabelaHistoricoAvaliacaoEmprego.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTabelaHistoricoAvaliacaoEmpregoMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTabelaHistoricoAvaliacaoEmprego);
        if (jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumnCount() > 0) {
            jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(0).setMinWidth(70);
            jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(0).setMaxWidth(70);
            jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(1).setMinWidth(70);
            jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(1).setMaxWidth(70);
            jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(2).setMinWidth(70);
            jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(2).setMaxWidth(70);
            jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(3).setMinWidth(380);
            jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(3).setMaxWidth(380);
        }
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (codigoUser == codUserAcesso && nomeTela.equals(telaHistAvaEmprego) && codIncluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        if (codigoUser == codUserAcesso && nomeTela.equals(telaHistAvaEmprego) && codAlterar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        if (codigoUser == codUserAcesso && nomeTela.equals(telaHistAvaEmprego) && codExcluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            objHistAva.setStatusLanc(jStatusOcorrencia.getText());
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        if (codigoUser == codUserAcesso && nomeTela.equals(telaHistAvaEmprego) && codGravar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaHistoricoAvaliacaoEmp objAudiAvaSSEmp = new TelaAuditoriaHistoricoAvaliacaoEmp();
        TelaModuloServicoSocial.jPainelServicoSocial.add(objAudiAvaSSEmp);
        objAudiAvaSSEmp.show();
    ...
    private void jBtPesqCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoActionPerformed
        ...
        if (jCodigo.getText().equals("")) {
            ...
            pesquisarOcorrrencias("SELECT * FROM HISTORICO_VISITA_EMPREGO_SERVICO_SOCIAL "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON HISTORICO_VISITA_EMPREGO_SERVICO_SOCIAL.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarOcorrrencias("SELECT * FROM HISTORICO_VISITA_EMPREGO_SERVICO_SOCIAL "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON HISTORICO_VISITA_EMPREGO_SERVICO_SOCIAL.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc");
        } else {
    ...
    private void jTabelaHistoricoAvaliacaoEmpregoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaHistoricoAvaliacaoEmpregoMouseClicked
        // TODO add your handling code here:
        flag = 1;
        if (flag == 1) {
            String IdLanc = "" + jTabelaHistoricoAvaliacaoEmprego.getValueAt(jTabelaHistoricoAvaliacaoEmprego.getSelectedRow(), 0);
            ...
            try {
                conecta.executaSQL("SELECT * FROM HISTORICO_VISITA_EMPREGO_SERVICO_SOCIAL "
                        ...
                        + "WHERE HISTORICO_VISITA_EMPREGO_SERVICO_SOCIAL.IdLanc ='" + IdLanc + "'");
                conecta.rs.first();
    ...
    }//GEN-LAST:event_jTabelaHistoricoAvaliacaoEmpregoMouseClicked
    ...
    private void jBtPesquisarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarInternoActionPerformed
        // TODO add your handling code here:
        TelaPesquisaInternoHistoricoAvalicaoEmprego objPesqInternoEmp = new TelaPesquisaInternoHistoricoAvalicaoEmprego();
        TelaModuloServicoSocial.jPainelServicoSocial.add(objPesqInternoEmp);
        objPesqInternoEmp.show();
    ...
    private javax.swing.JTable jTabelaHistoricoAvaliacaoEmprego;
    ...
    public void pesquisarOcorrrencias(String sql) {
        ...
        jTabelaHistoricoAvaliacaoEmprego.setModel(modelo);
        jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(0).setPreferredWidth(70);
        jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(0).setResizable(false);
        jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(1).setPreferredWidth(70);
        jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(1).setResizable(false);
        jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(2).setPreferredWidth(70);
        jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(2).setResizable(false);
        jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(3).setPreferredWidth(380);
        jTabelaHistoricoAvaliacaoEmprego.getColumnModel().getColumn(3).setResizable(false);
        jTabelaHistoricoAvaliacaoEmprego.getTableHeader().setReorderingAllowed(false);
        jTabelaHistoricoAvaliacaoEmprego.setAutoResizeMode(jTabelaHistoricoAvaliacaoEmprego.AUTO_RESIZE_OFF);
        jTabelaHistoricoAvaliacaoEmprego.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        alinharCamposTabela();
        conecta.desconecta();
    }
