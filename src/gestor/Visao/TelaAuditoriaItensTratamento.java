...
import static gestor.Visao.TelaAvaliacaoMedicaPsiquiatrica.jIdAvaliacao;
import static gestor.Visao.TelaAvaliacaoMedicaPsiquiatrica.jIdRegistro;
import static gestor.Visao.TelaSolicitacaoExamesMedicoPsiquiatrico.jCodigoSolExame;
import static gestor.Visao.TelaSolicitacaoExamesMedicoPsiquiatrico.jIdItemExame;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensTratamento extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensTratamento() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Tratamento de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_TRATAMENTOS_INTERNOS WHERE IdAvalia='" + jIdAvaliacao.getText() + "'AND IdItemTrat='" + jIdRegistro.getText()  + "'");
            conecta.rs.first();
