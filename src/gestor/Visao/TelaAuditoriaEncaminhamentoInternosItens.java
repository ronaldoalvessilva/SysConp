...
import static gestor.Visao.TelaEncaminhamentoInternosCirurgiasEspecialistas.jIdEnca;
import static gestor.Visao.TelaEncaminhamentoInternosCirurgiasEspecialistas.jIdEncaminha;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEncaminhamentoInternosItens extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEncaminhamentoInternosItens() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Encaminhamento Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_ENCAMINHAMENTO_CIRURGIAS_ESPECIALISTAS WHERE IdEnca='" + jIdEncaminha.getText() + "'AND IdItemEnca='" + jIdEnca.getText()  + "'");
            conecta.rs.first();
