...
import static gestor.Visao.TelaSolicitacaoExamesMedicoPsiquiatrico.jDescricaoExameSolicitado;
 ...
 * @author Ronaldo
 */
public class TelaPesqTipoExamePsiMedico extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqTipoExamePsiMedico() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa de Tipo Exame :::...");
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM TIPOS_EXAMES_MEDICO WHERE DescricaoExame='" + nomeExame + "'");
                conecta.rs.first();
    ...
    private void jBtPesqDescricaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoActionPerformed
        ...
        if (jPesqDescricao.getText().equals("")) {
            ...
            preencherTabelaInstituicao("SELECT * FROM TIPOS_EXAMES_MEDICO WHERE DescricaoExame LIKE'%" + jPesqDescricao.getText() + "%'AND StatusExame='" + statusUnid + "'");
        }
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaInstituicao("SELECT * FROM TIPOS_EXAMES_MEDICO WHERE StatusExame='" + statusUnid + "'");
        } else {
            limparTabela();
        }
...
// Método de pesquisa pela Descrição
    public void preencherTabelaInstituicao(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Nome do Exame"};
        conecta.abrirConexao();
        conecta.executaSQL(sql);
        try {
            conecta.rs.first();
            do {
                dados.add(new Object[]{conecta.rs.getInt("IdExame"), conecta.rs.getString("DescricaoExame")});
