 ...
 * @author Ronaldo
 */
public class TelaAuditoriaVisitasOcorrencia extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaVisitasOcorrencia() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Visitas Ocorrências :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM VISITAS_OCORRENCIA_PORTARIA WHERE IdReg='" + jCodigoRegistro.getText() + "'AND IdItem='" + idItemVisita  + "'");
            conecta.rs.first();
