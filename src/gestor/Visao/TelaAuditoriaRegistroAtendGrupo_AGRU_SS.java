...
import static gestor.Visao.TelaAtendimentoGrupoSS.pCODIGO_AVALIACAO_GRUPO;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_AGRU_SS extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_AGRU_SS() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AVALICAO_ATENDIMENTO_GRUPO_SS "
                    + "WHERE IdItemAvagSS='" + pCODIGO_AVALIACAO_GRUPO + "' "
