 ...
 * @author Ronaldo
 */
public class TelaAuditoriaPAI_DEME_PSI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaPAI_DEME_PSI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM FICHA_CADASTRO_PAI_DEME WHERE IdPai='" + jCodigoPAI.getText() + "'");
            conecta.rs.first();
