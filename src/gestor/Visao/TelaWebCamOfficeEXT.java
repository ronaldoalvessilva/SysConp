...
import static gestor.Visao.TelaOficialJusticaExterna.caminhoFotoOfficeEXT;
import static gestor.Visao.TelaOficialJusticaExterna.FotoOficialJusticaExt;
 ...
 * @author Ronaldo
 */
public class TelaWebCamOfficeEXT extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String localFotoOficial = "";
     ...
     * @param modal
     */
    public static TelaOficialJusticaExterna telaVisitasOffEXT;

    //TESTADO E FUNCIONANDO NO DIA 02/12/2016 - EM VITÓRIA DA CONQUISTA
    public TelaWebCamOfficeEXT(TelaOficialJusticaExterna parent, boolean modal) {
        this.telaVisitasOffEXT = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaVisitasOffEXT);
        initComponents();
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        localFotoOficial();
        if (localFotoOficial == null || localFotoOficial == "") {
            ...
            javax.swing.JFileChooser seletor = new javax.swing.JFileChooser(localFotoOficial);
            FileNameExtensionFilter tipoExtensao = new FileNameExtensionFilter("Imagem de Foto", "jpg", "bmp", "gif", "png");
            seletor.setAcceptAllFileFilterUsed(false);
            seletor.setMultiSelectionEnabled(false);
            seletor.setFileFilter(tipoExtensao);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaWebCamOfficeEXT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaWebCamOfficeEXT dialog = new TelaWebCamOfficeEXT(telaVisitasOffEXT, true);
    ...
    public void localFotoOficial() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM PARAMETROSCRC");
            conecta.rs.first();
            localFotoOficial = conecta.rs.getString("LocalFotosOficialJustica");
        } catch (Exception e) {
        }
        conecta.desconecta();
    }
