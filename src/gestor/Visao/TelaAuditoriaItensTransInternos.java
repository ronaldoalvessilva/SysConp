...
import static gestor.Visao.TelaTransfInterno.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensTransInternos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensTransInternos() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSTRANSFERENCIA WHERE IdTransf='" + jIDlanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
