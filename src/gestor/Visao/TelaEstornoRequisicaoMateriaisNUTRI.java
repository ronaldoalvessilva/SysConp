...
import gestor.Controle.ControleEstornoRequisicaoNUTRI;
import gestor.Controle.ControleHistoricoMovimentacaoNUTRI;
import gestor.Controle.ControleItensEstornoMateriaisNUTRI;
 ...
 * @author Ronaldo
 */
public class TelaEstornoRequisicaoMateriaisNUTRI extends javax.swing.JInternalFrame {
    ...
    ControleEstornoRequisicaoNUTRI control = new ControleEstornoRequisicaoNUTRI();
    ControleItensEstornoMateriaisNUTRI controle = new ControleItensEstornoMateriaisNUTRI();
    //    
    ...
    String nomeModuloTela = "Nutrição:Estorno Requisição de Materiais Interno:Manutenção";
    String nomeModuloTela2 = "Nutrição:Estorno Requisição de Materiais Interno:Itens";
    //
    int flag;
    int acao;
    ...
    String nomeOperacao = "Estorno Requisição Avulsa de Materiais";
    double qtdEstoque = 0;
     ...
     */
    public TelaEstornoRequisicaoMateriaisNUTRI() {
        initComponents();
        formatarCampos();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        jTabelaEstornoRequisicoes = new javax.swing.JTable();
        ...
        jRadioBtReqInternos = new javax.swing.JRadioButton();
        ...
        jTabelaItensEstornoRequisicao = new javax.swing.JTable();
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Estorno de Requisição de Materiais :::...");
        ...
        jTabelaEstornoRequisicoes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTabelaEstornoRequisicoesMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(jTabelaEstornoRequisicoes);
        if (jTabelaEstornoRequisicoes.getColumnModel().getColumnCount() > 0) {
            jTabelaEstornoRequisicoes.getColumnModel().getColumn(0).setMinWidth(70);
            jTabelaEstornoRequisicoes.getColumnModel().getColumn(0).setMaxWidth(70);
            jTabelaEstornoRequisicoes.getColumnModel().getColumn(1).setMinWidth(80);
            jTabelaEstornoRequisicoes.getColumnModel().getColumn(1).setMaxWidth(80);
            jTabelaEstornoRequisicoes.getColumnModel().getColumn(2).setMinWidth(80);
            jTabelaEstornoRequisicoes.getColumnModel().getColumn(2).setMaxWidth(80);
            jTabelaEstornoRequisicoes.getColumnModel().getColumn(3).setMinWidth(380);
            jTabelaEstornoRequisicoes.getColumnModel().getColumn(3).setMaxWidth(380);
        }
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados da Requisição", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 0, 0))); // NOI18N
        ...
        BGTipoEstorno.add(jRadioBtReqInternos);
        jRadioBtReqInternos.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jRadioBtReqInternos.setSelected(true);
        jRadioBtReqInternos.setText("Requisição de Internos");
        jRadioBtReqInternos.setEnabled(false);
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGap(64, 64, 64)
                .addComponent(jRadioBtReqInternos)
                .addGap(18, 18, 18)
        ...
        jTabelaItensEstornoRequisicao.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTabelaItensEstornoRequisicaoMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(jTabelaItensEstornoRequisicao);
        if (jTabelaItensEstornoRequisicao.getColumnModel().getColumnCount() > 0) {
            jTabelaItensEstornoRequisicao.getColumnModel().getColumn(0).setMinWidth(40);
            jTabelaItensEstornoRequisicao.getColumnModel().getColumn(0).setMaxWidth(40);
            jTabelaItensEstornoRequisicao.getColumnModel().getColumn(1).setMinWidth(50);
            jTabelaItensEstornoRequisicao.getColumnModel().getColumn(1).setMaxWidth(50);
            jTabelaItensEstornoRequisicao.getColumnModel().getColumn(2).setMinWidth(300);
            jTabelaItensEstornoRequisicao.getColumnModel().getColumn(2).setMaxWidth(300);
            jTabelaItensEstornoRequisicao.getColumnModel().getColumn(3).setMinWidth(50);
            jTabelaItensEstornoRequisicao.getColumnModel().getColumn(3).setMaxWidth(50);
            jTabelaItensEstornoRequisicao.getColumnModel().getColumn(4).setMinWidth(50);
            jTabelaItensEstornoRequisicao.getColumnModel().getColumn(4).setMaxWidth(50);
        }
    ...
    private void jCodigoBarrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCodigoBarrasActionPerformed
        ...
        conecta.executaSQL("SELECT * FROM PRODUTOS_AC "
                ...
                + "WHERE PRODUTOS_AC.CodigoBarra='" + jCodigoBarras.getText() + "'AND PRODUTOS_AC.StatusProd='" + statusProd + "'PRODUTOS_AC.Modulo='" + modulo + "'");
        try {
            if (conecta.rs.first()) {
    ...
    private void jBtPesqProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqProdutoActionPerformed
        // TODO add your handling code here:  
        if (jRadioBtReqInternos.isSelected()) {
            TelaPesqProdutoEstornoRequisicaoMateriaisNUTRI objPesqProdEstReqMatNUTRI = new TelaPesqProdutoEstornoRequisicaoMateriaisNUTRI();
            TelaModuloNutricao.jPainelNutricao.add(objPesqProdEstReqMatNUTRI);
            objPesqProdEstReqMatNUTRI.show();
        } else if (jRadioBtReqAvulsa.isSelected()) {
            TelaPesqProdutoEstornoRequisicaoAvulsaMateriaisNUTRI objPesqEstProdMatAvulsoNUTRI = new TelaPesqProdutoEstornoRequisicaoAvulsaMateriaisNUTRI();
            TelaModuloNutricao.jPainelNutricao.add(objPesqEstProdMatAvulsoNUTRI);
            objPesqEstProdMatAvulsoNUTRI.show();
        }

    }//GEN-LAST:event_jBtPesqProdutoActionPerformed

    private void jTabelaItensEstornoRequisicaoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaItensEstornoRequisicaoMouseClicked
//        // TODO add your handling code here:
        if (flag == 1) {
            String idProduto = "" + jTabelaItensEstornoRequisicao.getValueAt(jTabelaItensEstornoRequisicao.getSelectedRow(), 1);
            jCodProduto.setText(idProduto);
            String nomeProduto = "" + jTabelaItensEstornoRequisicao.getValueAt(jTabelaItensEstornoRequisicao.getSelectedRow(), 2);
            jDescricaoProduto.setText(nomeProduto);
            idItem = "" + jTabelaItensEstornoRequisicao.getValueAt(jTabelaItensEstornoRequisicao.getSelectedRow(), 0);
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM ITENS_ESTORNO_PRODUTOS_NUTRI "
                        + "INNER JOIN PRODUTOS_AC "
                        + "ON ITENS_ESTORNO_PRODUTOS_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                        + "INNER JOIN LOTE_PRODUTOS_AC "
                        + "ON PRODUTOS_AC.IdProd=LOTE_PRODUTOS_AC.IdProd "
                        + "WHERE ITENS_ESTORNO_PRODUTOS_NUTRI.IdEst='" + jIdEst.getText() + "'AND "
                        + "PRODUTOS_AC.DescricaoProd='" + jDescricaoProduto.getText() + "'AND ITENS_ESTORNO_PRODUTOS_NUTRI.IdItem='" + idItem + "'");
                conecta.rs.first();
    ...
    }//GEN-LAST:event_jTabelaItensEstornoRequisicaoMouseClicked
    ...
    private void jBtPesqCodigoReqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoReqActionPerformed
        ...
        if (jIdEst.getText().equals("")) {
            ...
            pesquisarEstornoRequisicaoMateriais("SELECT * FROM ESTORNO_PRODUTOS_NUTRI "
        ...
        if (jDataPesqInicial.getDate() == null) {
            ...
            if (jDataPesFinal.getDate() == null) {
                ...
                if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                    ...
                    pesquisarEstornoRequisicaoMateriais("SELECT * FROM ESTORNO_PRODUTOS_NUTRI "
                            + "WHERE DataEst BETWEEN'" + dataInicial + "'AND '" + dataFinal + "'");
                }
            }
        }
    ...
    private void jCheckBoxTodosReqItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosReqItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarEstornoRequisicaoMateriais("SELECT * FROM ESTORNO_PRODUTOS_NUTRI ");
        } else {
    ...
    private void jTabelaEstornoRequisicoesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaEstornoRequisicoesMouseClicked
        // TODO add your handling code here:
        flag = 1;
        if (flag == 1) {
            String IdLanc = "" + jTabelaEstornoRequisicoes.getValueAt(jTabelaEstornoRequisicoes.getSelectedRow(), 0);
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM ESTORNO_PRODUTOS_NUTRI "
                        + "WHERE IdEst='" + IdLanc + "'");
                conecta.rs.first();
            ...
            count = 0;
            preencherTabelaItens("SELECT * FROM ITENS_ESTORNO_PRODUTOS_NUTRI "
                    + "INNER JOIN ESTORNO_PRODUTOS_NUTRI "
                    + "ON ITENS_ESTORNO_PRODUTOS_NUTRI.IdEst=ESTORNO_PRODUTOS_NUTRI.IdEst "
                    + "INNER JOIN PRODUTOS_AC "
                    + "ON ITENS_ESTORNO_PRODUTOS_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                    + "WHERE ITENS_ESTORNO_PRODUTOS_NUTRI.IdEst='" + jIdEst.getText() + "'");
        }
    }//GEN-LAST:event_jTabelaEstornoRequisicoesMouseClicked
    ...
    private void jBtPesqRequisicaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqRequisicaoActionPerformed
        // TODO add your handling code here:
        if (jRadioBtReqInternos.isSelected()) {
            TelaPesqRequisicaoMateriaisNUTRI objPesqReqInternoNUTRI = new TelaPesqRequisicaoMateriaisNUTRI();
            TelaModuloNutricao.jPainelNutricao.add(objPesqReqInternoNUTRI);
            objPesqReqInternoNUTRI.show();
        } else if (jRadioBtReqAvulsa.isSelected()) {
            TelaPesqRequisicaoAvulsaMateriaisNUTRI objPeqReqAvulsaNUTRI = new TelaPesqRequisicaoAvulsaMateriaisNUTRI();
            TelaModuloNutricao.jPainelNutricao.add(objPeqReqAvulsaNUTRI);
            objPeqReqAvulsaNUTRI.show();
        }
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        if (jDataEst.getDate() == null) {
            ...
            if (acao == 1) {
                ...
                //
                control.incluirEstornoMaterialNUTRI(objEstoReq);
                buscarCodigo();
                //
                objLog();
            ...
            if (acao == 2) {
                ...
                control.alterarEstornoMaterialNUTRI(objEstoReq);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
                Salvar();
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaEstornoRequisicaoAvulsaNUTRI objAudiEstAvulsaNUTRI = new TelaAuditoriaEstornoRequisicaoAvulsaNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objAudiEstAvulsaNUTRI);
        objAudiEstAvulsaNUTRI.show();
    ...
    private void jBtExcluirItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirItemActionPerformed
        ...
        if (jStatusEst.getText().equals("FINALIZADO")) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                controle.excluirEstornoMaterialInternosNUTRI(objItensReqMatInter);
                ...
                controle.alterarEstoqueMateraisNUTRI(objItensReqMatInter); // TABELA DE LOTE_PRODUTOS_AC  
                //
    ...
    private void jBtSalvarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarItemActionPerformed
        ...
        if (jCodProduto.getText().equals("")) {
            ...
            if (jRadioBtReqInternos.isSelected()) {
                buscarQuantidadeRequisitadaInternos();
            } else if (jRadioBtReqAvulsa.isSelected()) {
            ...
            if (acao == 3) {
                ...
                if (qtdItemEstorno >= objItensReqMatInter.getQtdItem()) {
                    ...
                    controle.incluirEstornoMaterialInternosNUTRI(objItensReqMatInter);
                    ...
                    if (jRadioBtReqInternos.isSelected()) {
                        ...
                        controle.modificarRequisicaoMaterialInternosNUTRI(objItensReqMatInter);
                    } else if (jRadioBtReqAvulsa.isSelected()) {
                        objItensReqMatInter.setIdProd(Integer.valueOf(jCodProduto.getText()));
                        objItensReqMatInter.setIdReq(Integer.valueOf(jIdReq.getText()));
                        objItensReqMatInter.setEstornoProduto(estornoProduto);
                        controle.modificarRequisicaoMaterialAvulsoNUTRI(objItensReqMatInter);
                    }
                    //
                    objLog2();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
            ...
            if (acao == 4) {
                ...
                if (novoSaldoAtual >= objItensReqMatInter.getQtdItem()) {
                    ...
                    objItensReqMatInter.setIdItem(Integer.valueOf(idItem));
                    controle.alterarEstoqueMateraisNUTRI(objItensReqMatInter); // ALTERAR QUANTIDADE NA TABELA ITENS_REQUISICAO_PRODUTOS_INTERNOS
                    //
                    objItensReqMatInter.setQtdItem(estoqueAtual);
    ...
    private void jBtAuditoriaItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaItemActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensEstornoNUTRI objAudiItensEstoNUTRI = new TelaAuditoriaItensEstornoNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objAudiItensEstoNUTRI);
        objAudiItensEstoNUTRI.show();
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ESTORNO_PRODUTOS_NUTRI WHERE IdEst='" + jIdEst.getText() + "'");
            conecta.rs.first();
            jStatusEst.setText(conecta.rs.getString("StatusEst"));
            if (jStatusEst.getText().equals("FINALIZADO")) {
    ...
    private javax.swing.JRadioButton jRadioBtReqInternos;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JScrollPane jScrollPane2;
    private javax.swing.JScrollPane jScrollPane3;
    private javax.swing.JTextField jStatusEst;
    private javax.swing.JTabbedPane jTabbedPane1;
    private javax.swing.JTable jTabelaEstornoRequisicoes;
    private javax.swing.JTable jTabelaItensEstornoRequisicao;
    ...
    public void Novo() {
        ...
        jRadioBtReqInternos.setEnabled(true);
    ...
    public void Finalizar() {
        ...
        Integer rows = jTabelaItensEstornoRequisicao.getModel().getRowCount();
        if (rows == 0) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                control.finalizarEstornoMaterialNUTRI(objEstoReq);
    ...
    public void lancarHistorico() {
        ...
        for (int i = 0; i < jTabelaItensEstornoRequisicao.getRowCount(); i++) {
            // LANÇAR HISTÓRICO DA SAIDA DA REQUISIÇÃO.
            objHistMovAC.setIdProd((int) jTabelaItensEstornoRequisicao.getValueAt(i, 1));
            ...
            try {
                objHistMovAC.setQtdItem(valorRealMoed.parse((String) jTabelaItensEstornoRequisicao.getValueAt(i, 3)).floatValue());
            } catch (ParseException ex) {
            }
    ...
    public void verificarItensRequisitados() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENS_ESTORNO_PRODUTOS_NUTRI WHERE IdEst='" + objEstoReq.getIdEstorno() + "'");
            conecta.rs.first();
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                objEstoReq.setIdEstorno(Integer.parseInt(jIdEst.getText()));
                control.excluirEstornoMaterialNUTRI(objEstoReq);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                Excluir();
    ...
    public void buscarQuantidadeRequisitadaAvulsa() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_NUTRI WHERE IdReq='" + jIdReq.getText() + "'AND IdProd='" + objItensReqMatInter.getIdProd() + "'");
            conecta.rs.first();
    ...
    public void buscarQuantidadeRequisitadaInternos() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI WHERE IdReq='" + jIdReq.getText() + "'AND IdProd='" + objItensReqMatInter.getIdProd() + "'");
            conecta.rs.first();
            qtdItemEstorno = conecta.rs.getFloat("QtdItem");
        } catch (Exception e) {
        }
    ...
    public void pesquisarEstornoRequisicaoMateriais(String sql) {
        ...
        jTabelaEstornoRequisicoes.setModel(modelo);
        jTabelaEstornoRequisicoes.getColumnModel().getColumn(0).setPreferredWidth(70);
        jTabelaEstornoRequisicoes.getColumnModel().getColumn(0).setResizable(false);
        jTabelaEstornoRequisicoes.getColumnModel().getColumn(1).setPreferredWidth(80);
        jTabelaEstornoRequisicoes.getColumnModel().getColumn(1).setResizable(false);
        jTabelaEstornoRequisicoes.getColumnModel().getColumn(2).setPreferredWidth(80);
        jTabelaEstornoRequisicoes.getColumnModel().getColumn(2).setResizable(false);
        jTabelaEstornoRequisicoes.getColumnModel().getColumn(3).setPreferredWidth(380);
        jTabelaEstornoRequisicoes.getColumnModel().getColumn(3).setResizable(false);
        jTabelaEstornoRequisicoes.getTableHeader().setReorderingAllowed(false);
        jTabelaEstornoRequisicoes.setAutoResizeMode(jTabelaEstornoRequisicoes.AUTO_RESIZE_OFF);
        jTabelaEstornoRequisicoes.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        alinharCamposEstornoRequisicao();
        conecta.desconecta();
    }
    ...
    public void alinharCamposEstornoRequisicao() {
        ...
        //
        jTabelaEstornoRequisicoes.getColumnModel().getColumn(0).setCellRenderer(centralizado);
        jTabelaEstornoRequisicoes.getColumnModel().getColumn(1).setCellRenderer(centralizado);
        jTabelaEstornoRequisicoes.getColumnModel().getColumn(2).setCellRenderer(centralizado);
    }
    ...
    public void preencherTabelaItens(String sql) {
        ...
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaItensEstornoRequisicao.setModel(modelo);
        jTabelaItensEstornoRequisicao.getColumnModel().getColumn(0).setPreferredWidth(40);
        jTabelaItensEstornoRequisicao.getColumnModel().getColumn(0).setResizable(false);
        jTabelaItensEstornoRequisicao.getColumnModel().getColumn(1).setPreferredWidth(50);
        jTabelaItensEstornoRequisicao.getColumnModel().getColumn(1).setResizable(false);
        jTabelaItensEstornoRequisicao.getColumnModel().getColumn(2).setPreferredWidth(300);
        jTabelaItensEstornoRequisicao.getColumnModel().getColumn(2).setResizable(false);
        jTabelaItensEstornoRequisicao.getColumnModel().getColumn(3).setPreferredWidth(50);
        jTabelaItensEstornoRequisicao.getColumnModel().getColumn(3).setResizable(false);
        jTabelaItensEstornoRequisicao.getColumnModel().getColumn(4).setPreferredWidth(50);
        jTabelaItensEstornoRequisicao.getColumnModel().getColumn(4).setResizable(false);
        jTabelaItensEstornoRequisicao.getTableHeader().setReorderingAllowed(false);
        jTabelaItensEstornoRequisicao.setAutoResizeMode(jTabelaItensEstornoRequisicao.AUTO_RESIZE_OFF);
        jTabelaItensEstornoRequisicao.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        alinharCamposItensEstorno();
        conecta.desconecta();
    }

    public void limparTabelaItensEstorno() {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Item", "Código", "Descrição Produto", "Qtd.", "Vl. Item"};
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaItensEstornoRequisicao.setModel(modelo);
    ...
    public void alinharCamposItensEstorno() {
        DefaultTableCellRenderer esquerda = new DefaultTableCellRenderer();
        DefaultTableCellRenderer centralizado = new DefaultTableCellRenderer();
        DefaultTableCellRenderer direita = new DefaultTableCellRenderer();
        //
        ...
        direita.setHorizontalAlignment(SwingConstants.RIGHT);
        //
        jTabelaItensEstornoRequisicao.getColumnModel().getColumn(0).setCellRenderer(centralizado);
        jTabelaItensEstornoRequisicao.getColumnModel().getColumn(1).setCellRenderer(centralizado);
        jTabelaItensEstornoRequisicao.getColumnModel().getColumn(3).setCellRenderer(esquerda);
        jTabelaItensEstornoRequisicao.getColumnModel().getColumn(4).setCellRenderer(esquerda);
    }
