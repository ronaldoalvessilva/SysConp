...
import static gestor.Visao.TelaRequisicaoMateriaisNUTRI.jIdLocal;
 ...
 * @author user
 */
public class TelaPesqLocalArmazenamentoRequisicaoNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqLocalArmazenamentoRequisicaoNUTRI() {
        initComponents();
    }
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoLocal.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM LOCAL_ARMAZENAMENTO_NUTRI WHERE DescricaoLocal LIKE'%" + jPesqDescricaoLocal.getText() + "%'");
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqDescricaoLocal.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM LOCAL_ARMAZENAMENTO_NUTRI WHERE DescricaoLocal='" + jPesqDescricaoLocal.getText() + "'");
                conecta.rs.first();
...
//                jLocalArmazenamento.setText(conecta.rs.getString("DescricaoLocal"));
    ...
    private void jCheckBoxPesqTodosProdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosProdItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            jTabelaLocaisArmazenamento.setVisible(true);
            this.preencherTabelaProdutos("SELECT * FROM LOCAL_ARMAZENAMENTO_NUTRI");
        } else {
            jTabelaLocaisArmazenamento.setVisible(!true);
        }
