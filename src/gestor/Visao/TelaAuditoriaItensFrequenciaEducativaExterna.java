...
import static gestor.Visao.TelaFrequenciaMensalInternosEducacao.idItem;
import static gestor.Visao.TelaFrequenciaMensalInternosEducacao.jIdFrequencia;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensFrequenciaEducativaExterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensFrequenciaEducativaExterna() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_FREQUENCIA_PEDAGOGIA_EXTERNA WHERE IdFreqLab='" + jIdFrequencia.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
