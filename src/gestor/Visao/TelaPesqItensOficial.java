...
import static gestor.Visao.TelaEntradaSaidaOficialJustica.jBtAlterarOficialJustica;
import static gestor.Visao.TelaEntradaSaidaOficialJustica.jBtCancelarOficialJustica;
import static gestor.Visao.TelaEntradaSaidaOficialJustica.jBtExcluirOficialJustica;
import static gestor.Visao.TelaEntradaSaidaOficialJustica.jBtNovoOficialJustica;
import static gestor.Visao.TelaEntradaSaidaOficialJustica.jBtSalvarOficialJustica;
import static gestor.Visao.TelaEntradaSaidaOficialJustica.jDataEntrada;
import static gestor.Visao.TelaEntradaSaidaOficialJustica.jDataSaida;
import static gestor.Visao.TelaEntradaSaidaOficialJustica.jHorarioEntrada;
import static gestor.Visao.TelaEntradaSaidaOficialJustica.jHorarioSaida;
...
import static gestor.Visao.TelaEntradaSaidaOficialJustica.jIDlanc;
import static gestor.Visao.TelaEntradaSaidaOficialJustica.jDepartamento;
import static gestor.Visao.TelaEntradaSaidaOficialJustica.idItem;
import static gestor.Visao.TelaEntradaSaidaOficialJustica.jBtZoonAdvogadoDepartamento;
import static gestor.Visao.TelaEntradaSaidaOficialJustica.jMotivo;
 ...
 * @author user
 */
public class TelaPesqItensOficial extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa Oficial Justiça - {P1} :::...");
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM ITENS_ENTRADAS_OFICIAL_JUSTICA "
                        ...
                        + "WHERE NomeOficial='" + jPesqNomeAdvogado.getText() + "' "
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jPesqNomeAdvogado.getText().equals("")) {
            ...
            buscarAdvogados("SELECT * FROM ITENS_ENTRADAS_OFICIAL_JUSTICA "
                    + "INNER JOIN OFICIAL_JUSTICA "
                    + "ON ITENS_ENTRADAS_OFICIAL_JUSTICA.IdOficial=OFICIAL_JUSTICA.IdOficial "
                    + "INNER JOIN DEPARTAMENTOS "
                    + "ON ITENS_ENTRADAS_OFICIAL_JUSTICA.IdDepartamento=DEPARTAMENTOS.IdDepartamento "
...
//Preencher tabela com todos os VISITANTES
    public void buscarAdvogados(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Nome do Oficial de Justiça", "Data Entrada", "Horário", "Data Saída", "Horário"};
        conecta.abrirConexao();
        try {
