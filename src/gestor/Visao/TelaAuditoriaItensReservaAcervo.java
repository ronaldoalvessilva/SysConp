...
import static gestor.Visao.TelaReservaAcervo.jIdDoc;
import static gestor.Visao.TelaReservaAcervo.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensReservaAcervo extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensReservaAcervo() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_RESERVA_ACERVO WHERE IdReserva='" + jIdDoc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
