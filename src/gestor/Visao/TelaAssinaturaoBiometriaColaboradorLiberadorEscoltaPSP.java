...
import gestor.Controle.ControleListaLiberadorBASE_PSP;
...
import static gestor.Visao.TelaEscoltaInternoPSP.jComboBoxStatus;
import static gestor.Visao.TelaEscoltaInternoPSP.jDataRetorno;
import static gestor.Visao.TelaEscoltaInternoPSP.jFotoInternoEscolta;
import static gestor.Visao.TelaEscoltaInternoPSP.jHoraRetorno;
import static gestor.Visao.TelaEscoltaInternoPSP.nomeLiberador;
import static gestor.Visao.TelaEscoltaInternoPSP.pDigitalCapturadaColaboradorLiberador;
 ...
 * @author Ronaldo
 */
public class TelaAssinaturaoBiometriaColaboradorLiberadorEscoltaPSP extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    EscoltaInternosPSP objItensFunc = new EscoltaInternosPSP();
    ControleEscoltaInternosPSP controle = new ControleEscoltaInternosPSP();
    ControleListaLiberadorBASE_PSP control = new ControleListaLiberadorBASE_PSP();
    //
    ControleLogSistema controlLog = new ControleLogSistema();
    LogSistema objLogSys = new LogSistema();
    // Variáveis para gravar o log
    String nomeModuloTela2 = "Base:Escolta de Interno para PSP:Biometria";
    String statusMov;
    String horaMov;
    String dataModFinal;
    int acao;
    ...
    int codigoItem = 0;
    //
    String pSTATUS_DOCUMENTO = "Ativo";
    String pSTATUS_LIBERADOR = "";
    String pSTATUS_ATIVO = "";
    String pSTATUS_LIBERADOR_ATIVO = "";
    String pNOME_LIBERADOR = "";
    //
    String dataInicial;
    //
    int pCODIGO_INTERNO;
     ...
     */
    public static TelaEscoltaInternoPSP assinaturaFuncPSP;

    public TelaAssinaturaoBiometriaColaboradorLiberadorEscoltaPSP(TelaEscoltaInternoPSP parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jDataLiberacao1 = new com.toedter.calendar.JDateChooser();
        jLabel15 = new javax.swing.JLabel();
        jHorarioLiberacao1 = new javax.swing.JFormattedTextField();
        ...
        setTitle("...::: Liberador Interno para PSP - Base :::...");
        ...
        jNomeMae.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        ...
        jComboBoxNomeInterno.setEnabled(false);
        jComboBoxNomeInterno.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jComboBoxNomeInternoItemStateChanged(evt);
            }
        });
        ...
        jLabel12.setText("Data Liberação:");

        jDataLiberacao1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jDataLiberacao1.setEnabled(false);

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel15.setText("Horário:");

        jHorarioLiberacao1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jHorarioLiberacao1.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jHorarioLiberacao1.setEnabled(false);
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jDataLiberacao1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 41, Short.MAX_VALUE)
                .addComponent(jLabel15)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jHorarioLiberacao1, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(jHorarioLiberacao1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel12)
                    .addComponent(jDataLiberacao1, javax.swing.GroupLayout.PREFERRED_SIZE, 19, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel15))
                .addContainerGap())
        );

        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true), "Foto Interno", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(204, 0, 0))); // NOI18N
        ...
        jPanel8Layout.setVerticalGroup(
            jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jFotoInterno, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE)
        );
        ...
        jTabbedPane1.addTab("Interno", jPanel4);
        ...
        jHorarioLiberacao.setEnabled(false);
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true), "Foto Colaborador", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(0, 102, 0))); // NOI18N
        ...
        jPanel3Layout.setVerticalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jFotoColaborador, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE)
        );
        ...
        jPanel5Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jBtCancelarLeitura, jBtIniciarLeitor});
        ...
        jPanel5Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jBtCancelarLeitura, jBtIniciarLeitor});

        jTabbedPane1.addTab("Liberador", jPanel5);
        ...
        jPanel9Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jBtConfirmar, jBtSair});
        ...
        jPanel9Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jBtConfirmar, jBtSair});
    ...
    private void jBtConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtConfirmarActionPerformed
        ...
        if (!pSTATUS_ATIVO.equals("") || pSTATUS_ATIVO != null) {
            if (pSTATUS_ATIVO.equals("Inativo")) {
                JOptionPane.showMessageDialog(rootPane, "Não existe documento Ativo.");
            } else if (pSTATUS_ATIVO.equals("Ativo")
                    && pSTATUS_LIBERADOR_ATIVO.equals("Ativo")
                    && pNOME_LIBERADOR.equals(nameUser)) {
                ...
                objItensFunc.setHoraSaida(jHoraSaidaEscolta.getText());
                codigoLiberador = objItensFunc.getIdFunc();
                nomeLiberador = objItensFunc.getNomeColaborador();
                pDigitalCapturadaColaboradorLiberador = pDigitalCapturada;
                SimpleDateFormat formatoAmerica = new SimpleDateFormat("dd/MM/yyyy");
                dataInicial = formatoAmerica.format(jDataLiberacao.getDate().getTime());
                dataAssinatura = dataInicial;
                horaAssinatura = objItensFunc.getHoraSaida();
                jIdInternoCrc.setText(jIdInterno.getText());
                jNomeInternoCrc.setText((String) jComboBoxNomeInterno.getSelectedItem().toString());
                if (jComboBoxStatus.getSelectedItem().equals("Saída")) {
                    jDataSaida.setDate(jDataLiberacao.getDate());
                    jHoraSaidaEscolta.setText(jHorarioLiberacao.getText());
                } else if (jComboBoxStatus.getSelectedItem().equals("Retorno")) {
                    jDataRetorno.setDate(jDataLiberacao.getDate());
                    jHoraRetorno.setText(jHorarioLiberacao.getText());
                }
                ...
                JOptionPane.showMessageDialog(rootPane, "Colaborador não tem perfil de liberador.");
            }
        } else {
            JOptionPane.showMessageDialog(rootPane, "Não existe registro definido para o liberador.");
        }
    ...
    private void jComboBoxNomeInternoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBoxNomeInternoItemStateChanged
        // TODO add your handling code here:
        if (evt.getStateChange() == evt.SELECTED) {
            buscarInterno();
        }
    }//GEN-LAST:event_jComboBoxNomeInternoItemStateChanged
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAssinaturaoBiometriaColaboradorLiberadorEscoltaPSP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAssinaturaoBiometriaColaboradorLiberadorEscoltaPSP dialog = new TelaAssinaturaoBiometriaColaboradorLiberadorEscoltaPSP(assinaturaFuncPSP, true);
    ...
    private com.toedter.calendar.JDateChooser jDataLiberacao1;
    ...
    private javax.swing.JFormattedTextField jHorarioLiberacao1;
    ...
    public void listarInternos() {
        try {
            for (ProntuarioCrc p : control.read()) {
                jComboBoxNomeInterno.addItem(p);
                jIdInterno.setText(String.valueOf(p.getIdInterno()));
                jNomeMae.setText(p.getMaeInterno());
                jRegime.setText(p.getRegime());
                jCNC.setText(p.getCnc());
                pCAMINHO_FOTO_INTERNO = p.getFotoInterno();
            }
        } catch (Exception ex) {
    ...
    public void buscarInterno() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "AND NomeInternoCrc='" + jComboBoxNomeInterno.getSelectedItem() + "' "
    ...
    public void Novo() {
        ...
        jDataLiberacao1.setCalendar(Calendar.getInstance());
        jHorarioLiberacao1.setText(jHoraSistema.getText());
        jComboBoxNomeInterno.setEnabled(true);
        //
    ...
    public void verificarColaboradorLiberador() {
        ...
        try {
            conecta.executaSQL("SELECT "
                    + "LIBERADOR_ESCOLTA_INTERNO_PSP.StatusLibera, "
                    + "ITENS_LIBERADOR_ESCOLTA_INTERNO_PSP.IdFunc, "
                    + "ITENS_LIBERADOR_ESCOLTA_INTERNO_PSP.StatusFunc, "
                    + "COLABORADOR.NomeFunc "
                    + "FROM LIBERADOR_ESCOLTA_INTERNO_PSP "
                    + "INNER JOIN PAVILHAO "
                    + "ON LIBERADOR_ESCOLTA_INTERNO_PSP.IdPav=PAVILHAO.IdPav "
                    + "INNER JOIN ITENS_LIBERADOR_ESCOLTA_INTERNO_PSP "
                    + "ON LIBERADOR_ESCOLTA_INTERNO_PSP.IdLibe=ITENS_LIBERADOR_ESCOLTA_INTERNO_PSP.IdLibe "
                    + "INNER JOIN COLABORADOR "
                    + "ON ITENS_LIBERADOR_ESCOLTA_INTERNO_PSP.IdFunc=COLABORADOR.IdFunc "
                    + "WHERE LIBERADOR_ESCOLTA_INTERNO_PSP.StatusLibera='" + pSTATUS_DOCUMENTO + "' "
                    + "AND ITENS_LIBERADOR_ESCOLTA_INTERNO_PSP.IdFunc='" + jIdColaborador.getText() + "'");
            conecta.rs.first();
            pSTATUS_ATIVO = conecta.rs.getString("StatusLibera");
            pSTATUS_LIBERADOR_ATIVO = conecta.rs.getString("StatusFunc");
            pNOME_LIBERADOR = conecta.rs.getString("NomeFunc");            
