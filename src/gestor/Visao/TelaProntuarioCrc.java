...
public final class TelaProntuarioCrc extends javax.swing.JInternalFrame {
    ...
    public static String pRESPOSTA_CRC_update = "";
    ...
    String pCONFIRMA_entrada = "Sim"; // Confirma a utilização do registro do interno iniciado na portaria.
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(jPanel4Layout.createSequentialGroup()
                                                .addComponent(jRGInterno, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(2, 2, 2)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGap(2, 2, 2)
                                .addComponent(jCNC, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
//                jBtExcluirRegistro.setEnabled(true);
    ...
    public void VERIFICAR_parametro() {
        CONTROLE_DADOS_civil.pPARAMETRO_maioridade(objParCrc);
        CALCULAR_idade();
    }
...
//        jRGInterno.setFormatterFactory(new DefaultFormatterFactory(rg));
    ...
    public void BEANS_PERSISTENCIA_interno() {
        if (ValidaCPF.isCPF(jCPFInterno.getText()) == true) {
            ...
            if (acao == 1) {
                ...
                if (pRESPOSTA_gravacao.equals("Sim")
                    ...
                    objProCrc.setNomeInterno(jNomeInterno.getText());
                    objProCrc.setConfirmaEntrada(pCONFIRMA_entrada);
                ...
                if (pRESPOSTA_gravacao.equals("Sim")
                        && pRESPOSTA_DADOS_fisicos.equals("Sim")
                        && pRESPOSTA_DADOS_penais.equals("Sim")
                        && pRESPOSTA_CRC_update.equals("Não")) {
                    Salvar();
                ...
                if (pRESPOSTA_gravacao.equals("Sim") //GRAVOU NA TABELA PRONTUARIOSCRC
    ...
    public void verificarInternoBancoDados(int codigoInterno, int codDocumento) {
        ...
        try {
            conecta.executaSQL("SELECT "
                    + "IdInternoCrc, "
                    + "IdChek "
                    + "FROM LISTA_DOCUMENTOS_INTERNO_CRC "
