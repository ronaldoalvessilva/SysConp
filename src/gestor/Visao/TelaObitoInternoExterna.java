...
import gestor.Controle.ControleMovInternosObito;
import gestor.Controle.ControleObitoInterno;
...
import static gestor.Visao.TelaModuloCRC.telaLancarObitoManuCRC;
 ...
 * @author ronaldo
 */
public class TelaObitoInternoExterna extends javax.swing.JInternalFrame {
    ...
    ControleObitoInterno control = new ControleObitoInterno();
    ControleMovInternosObito controlMov = new ControleMovInternosObito();
    ...
    String nomeModuloTela = "CRC:Internos com Óbito:Manutenção";
    String statusMov;
    String horaMov;
    String dataModFinal;
    int flag;
    ...
    int tipoObito, idInternoRol;
    String horarioEntrada = "00:00";
    int count;
    String pObito = "ÓBITO"; // ÓBITO NA SAÍDA PARA AUDIÊNCIA
    String observacaoRol = "";

    /**
     * Creates new form TelaEvadidosIndividual
     */
    public TelaObitoInternoExterna() {
        initComponents();
        corCampos();
        formatarCampos();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Óbito de Internos - S. Temp./Lab./Estudo/Médica/Audiência :::...");
        ...
        jPanel9.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tipo de Óbito", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 0, 0))); // NOI18N
        ...
        jRBtSaidaTemporaria.setText("S. Temp.");
        ...
        jRBtSaidaLaborativa.setText("S. Lab.");
        ...
        jRBtSaidaEstudos.setText("S. Educa.");
        ...
        buttonGroupEvasao.add(jRBtSaidaAudiencia);
        jRBtSaidaAudiencia.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jRBtSaidaAudiencia.setForeground(new java.awt.Color(102, 0, 0));
        jRBtSaidaAudiencia.setText("S. Audiência");
        jRBtSaidaAudiencia.setToolTipText("Saída Audiência");
        jRBtSaidaAudiencia.setEnabled(false);
        jRBtSaidaAudiencia.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jRBtSaidaAudienciaMouseClicked(evt);
            }
        });
        ...
        setBounds(350, 80, 483, 482);
    }// </editor-fold>//GEN-END:initComponents

    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaLancarObitoManuCRC);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaLancarObitoManuCRC) && codGravarCRC == 1) {
            if (jOperacao.getText().equals("")) {
                ...
                if (acao == 1) {
                    ...
                    control.incluirObitoInterno(objEvadidoInd); // inclui na tabela OBITOS_INTERNOS_EXTERNO.   
                    buscarId();
                    objLog();
                ...
                if (acao == 2) {
                    ...
                    // ATUALIZA TABELA OBITOS_INTERNOS_EXTERNO.                     
                    objEvadidoInd.setIdInternoCrc(Integer.valueOf(jIdInternoEvadido.getText()));
                    objEvadidoInd.setIdLanc(Integer.valueOf(jIdLanc.getText()));
                    control.alterarObitoInterno(objEvadidoInd);
                    objLog();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    Salvar();
                    JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaObitoManual objAudObito = new TelaAuditoriaObitoManual();
        TelaModuloCRC.jPainelCRC.add(objAudObito);
        objAudObito.show();
    ...
    private void jBtPesquisarInternosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarInternosActionPerformed
        // TODO add your handling code here:
        if (jRBtSaidaTemporaria.isSelected()) {
            TelaPesqInternosObitoManual objPesqIntMan = new TelaPesqInternosObitoManual();
            TelaModuloCRC.jPainelCRC.add(objPesqIntMan);
            objPesqIntMan.show();
        } else if (jRBtSaidaLaborativa.isSelected()) {
            TelaPesqInternosObitoLaborativa objPesqIntEvaLab = new TelaPesqInternosObitoLaborativa();
            TelaModuloCRC.jPainelCRC.add(objPesqIntEvaLab);
            objPesqIntEvaLab.show();
        } else if (jRBtSaidaEstudos.isSelected()) {
            TelaPesqInternosObitoEducacao objPesqIntEvaEdu = new TelaPesqInternosObitoEducacao();
            TelaModuloCRC.jPainelCRC.add(objPesqIntEvaEdu);
            objPesqIntEvaEdu.show();
        } else if (jRBtSaidaMedico.isSelected()) {
            TelaPesqInternosObitoManualMedico objPesqIntEvaMedico = new TelaPesqInternosObitoManualMedico();
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaLancarObitoManuCRC);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaLancarObitoManuCRC) && codIncluirCRC == 1) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaLancarObitoManuCRC);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaLancarObitoManuCRC) && codAlterarCRC == 1) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaLancarObitoManuCRC);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaLancarObitoManuCRC) && codExcluirCRC == 1) {
            ...
            if (jStatusLanc.getText().equals("FINALIZADO")) {
                ...
                if (resposta == JOptionPane.YES_OPTION) {
                    ...
                    control.excluirObitoInterno(objEvadidoInd); // EXCLUIR REGISTRO DE INTERNO EVADIDO             
                    Excluir();
                }
            }
        } else {
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            ...
            this.preencherTabelaEvadidoPrincipal("SELECT * FROM OBITOS_INTERNOS_EXTERNO "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON OBITOS_INTERNOS_EXTERNO.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
    ...
    private void jBtPesquisaCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisaCodigoActionPerformed
        ...
        if (jCodigo.getText().equals("")) {
            ...
            jTabelaIntEvadidosPrincipal.setVisible(true);
            preencherTabelaEvadidoPrincipal("SELECT * FROM OBITOS_INTERNOS_EXTERNO "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON OBITOS_INTERNOS_EXTERNO.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
    ...
    private void jTabelaIntEvadidosPrincipalMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaIntEvadidosPrincipalMouseClicked
        ...
        if (flag == 1) {
            ...
            try {
                ...
                tipoObito = conecta.rs.getInt("TipoObito");
                if (tipoObito == 0) {
                    ...
                    jRBtSaidaAudiencia.setSelected(true);
                }
    ...
    private void jRBtSaidaTemporariaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jRBtSaidaTemporariaMouseClicked
        ...
        if (acao == 1 && jRBtSaidaTemporaria.isSelected() && jIdLanc.getText().equals("") || acao == 2 && jRBtSaidaTemporaria.isSelected() && jIdLanc.getText().equals("")) {
            jOperacao.setText("ÓBITO - SAIDA TEMPORARIA");
    ...
    private void jRBtSaidaLaborativaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jRBtSaidaLaborativaMouseClicked
        ...
        if (acao == 1 && jRBtSaidaLaborativa.isSelected() && jIdLanc.getText().equals("") || acao == 2 && jRBtSaidaLaborativa.isSelected() && jIdLanc.getText().equals("")) {
            jOperacao.setText("ÓBITO - SAIDA LABORATIVA");
            jIdInternoEvadido.setText("");
            jNomeInternoEvadido.setText("");
            jIdSaida.setText("");
            jDataSaida.setDate(null);
    ...
    private void jRBtSaidaEstudosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jRBtSaidaEstudosMouseClicked
        ...
        if (acao == 1 && jRBtSaidaEstudos.isSelected() && jIdLanc.getText().equals("") || acao == 2 && jRBtSaidaEstudos.isSelected() && jIdLanc.getText().equals("")) {
            jOperacao.setText("ÓBITO - SAIDA ESTUDOS");
            jIdInternoEvadido.setText("");
            jNomeInternoEvadido.setText("");
            jIdSaida.setText("");
            jDataSaida.setDate(null);
    ...
    private void jRBtSaidaMedicoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jRBtSaidaMedicoMouseClicked
        ...
        if (acao == 1 && jRBtSaidaMedico.isSelected() && jIdLanc.getText().equals("") || acao == 2 && jRBtSaidaMedico.isSelected() && jIdLanc.getText().equals("")) {
            jOperacao.setText("ÓBITO - SAIDA MÉDICO");
            jIdInternoEvadido.setText("");
            jNomeInternoEvadido.setText("");
            jIdSaida.setText("");
            jDataSaida.setDate(null);
    ...
    private void jRBtSaidaAudienciaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jRBtSaidaAudienciaMouseClicked
        // TODO add your handling code here:
        if (acao == 1 && jRBtSaidaAudiencia.isSelected() && jIdLanc.getText().equals("") || acao == 2 && jRBtSaidaAudiencia.isSelected() && jIdLanc.getText().equals("")) {
            jOperacao.setText("ÓBITO - SAIDA AUDIÊNCIA");
            jIdInternoEvadido.setText("");
            jNomeInternoEvadido.setText("");
            jIdSaida.setText("");
            jDataSaida.setDate(null);
...
//        jDocumentoSaida.setDocument(new LimiteDigitosNum(14));
    ...
    public void Novo() {
        ...
        jNomeInternoEvadido.setText("");
        //
        buttonGroupEvasao.clearSelection();
        //
    ...
    public void Finalizar() {
        ...
        JOptionPane.showMessageDialog(rootPane, "Se esse óbito de internos for finalizado, você não poderá mais excluir ou alterar. Será também\n"
        ...
        if (resposta == JOptionPane.YES_OPTION) {
            ...
            objEvadidoInd.setIdInternoCrc(Integer.valueOf(jIdInternoEvadido.getText()));
            control.finalizarObitoInterno(objEvadidoInd);
            jStatusLanc.setText(statusEntrada);
            // EXCLUIR O INTERNO DA CELA NO MOMENTO DA SAIDA DA EVASÃO.             
    ...
    public void finalizarEvasao() {
        ...
        objEvadidoInd.setIdInternoCrc(Integer.valueOf(jIdInternoEvadido.getText()));
        objEvadidoInd.setObservacao(jObservacao.getText());
        // SE FOR EVASÃO DE SAIDA TEMPORARIA
        if (tipoObito == 0) {
            ...
            control.alterarObitoInternoSaidaTmp(objItemSaida); // tabela ITENSSAIDA quando evadidos. TESTADO EM 06/06/2015 FUNCIONANDO                                                      
        } else if (tipoObito == 1) {
            ...
            // ATUALIZA TABELA DE (ITENSLABORINTERNO), QUANDO INTERNO ESTÁ EVADIDO.
    ...
    public void preencherTabelaEvadidoPrincipal(String sql) {
        ...
        String[] Colunas = new String[]{"Doc.", "Data Óbito", "Status", "Nome do Interno"};
        conecta.abrirConexao();
        try {
