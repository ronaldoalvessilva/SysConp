...
import static gestor.Visao.TelaEntradaSaidaVisitasInternos.jBtAlterarVisita;
import static gestor.Visao.TelaEntradaSaidaVisitasInternos.jBtCancelarVisita;
import static gestor.Visao.TelaEntradaSaidaVisitasInternos.jBtExcluirVisita;
import static gestor.Visao.TelaEntradaSaidaVisitasInternos.jBtNovaVisita;
import static gestor.Visao.TelaEntradaSaidaVisitasInternos.jBtSalvarVisita;
import static gestor.Visao.TelaEntradaSaidaVisitasInternos.jBtBuscarInterno;
import static gestor.Visao.TelaEntradaSaidaVisitasInternos.jDataEntrada;
import static gestor.Visao.TelaEntradaSaidaVisitasInternos.jDataSaida;
import static gestor.Visao.TelaEntradaSaidaVisitasInternos.jHorarioEntrada;
import static gestor.Visao.TelaEntradaSaidaVisitasInternos.jHorarioSaida;
import static gestor.Visao.TelaEntradaSaidaVisitasInternos.jIDlanc;
import static gestor.Visao.TelaEntradaSaidaVisitasInternos.idItem;
import static gestor.Visao.TelaEntradaSaidaVisitasInternos.idItemVisita;
 ...
 * @author user
 */
public class TelaPesqItensBuscarInternos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqItensBuscarInternos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa Visitas de Internos - {P1} :::...");

        jTabbedPane1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Listagem de Visitas de Internos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(0, 0, 255)));
        ...
        if (jTabelaPesqInternos.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaPesqInternos.getColumnModel().getColumn(3).setMinWidth(70);
            jTabelaPesqInternos.getColumnModel().getColumn(3).setMaxWidth(70);
            jTabelaPesqInternos.getColumnModel().getColumn(4).setMinWidth(80);
            jTabelaPesqInternos.getColumnModel().getColumn(4).setMaxWidth(80);
            jTabelaPesqInternos.getColumnModel().getColumn(5).setMinWidth(70);
            jTabelaPesqInternos.getColumnModel().getColumn(5).setMaxWidth(70);
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            idVisita = "" + jTabelaPesqInternos.getValueAt(jTabelaPesqInternos.getSelectedRow(), 0);
            horarioEntrada = "" + jTabelaPesqInternos.getValueAt(jTabelaPesqInternos.getSelectedRow(), 3);
            //
            ...
            try {
                conecta.executaSQL("SELECT * FROM ITENSFAMILIAR "
                        ...
                        + "WHERE VISITASINTERNO.NomeVisita='" + jPesqNomeInterno.getText() + "' "
                ...
                idItemVisita = conecta.rs.getString("IdItem");
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jPesqNomeInterno.getText().equals("")) {
            ...
            buscarInternos("SELECT * FROM ITENSFAMILIAR "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ITENSFAMILIAR.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN VISITASINTERNO "
                    + "ON ITENSFAMILIAR.IdVisita=VISITASINTERNO.IdVisita "
                    + "WHERE VISITASINTERNO.NomeVisita LIKE'%" + jPesqNomeInterno.getText() + "%' "
...
//Preencher tabela com todos os VISITANTES
    ...
    public void alinharTabelaVisitas() {
        ...
        jTabelaPesqInternos.getColumnModel().getColumn(3).setCellRenderer(centralizado);
        jTabelaPesqInternos.getColumnModel().getColumn(4).setCellRenderer(centralizado);
        jTabelaPesqInternos.getColumnModel().getColumn(5).setCellRenderer(centralizado);
    }
}
