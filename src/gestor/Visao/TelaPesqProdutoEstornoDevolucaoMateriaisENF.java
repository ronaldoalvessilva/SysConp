 ...
 * @author user
 */
public class TelaPesqProdutoEstornoDevolucaoMateriaisENF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoEstornoDevolucaoMateriaisENF() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Produtos Devolvidos Farmácia {ENF} :::...");
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "INNER JOIN ITENS_DEVOLUCAO_PRODUTOS_ENFERMARIA_ENFAR "
                    + "ON PRODUTOS_AC.IdProd=ITENS_DEVOLUCAO_PRODUTOS_ENFERMARIA_ENFAR.IdProd "
                    + "WHERE PRODUTOS_AC.DescricaoProd LIKE'%" + jPesqDescricaoProdutos.getText() + "%'AND PRODUTOS_AC.StatusProd='" + statusProd + "'AND Qtd!='" + 0 + "'AND EstornoProduto='" + estornoProduto + "'AND IdDevo='" + jIdReq.getText() + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        }
    ...
    private void jCheckBoxPesqTodosProdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosProdItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {            
            this.preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "INNER JOIN ITENS_DEVOLUCAO_PRODUTOS_ENFERMARIA_ENFAR "
                    + "ON PRODUTOS_AC.IdProd=ITENS_DEVOLUCAO_PRODUTOS_ENFERMARIA_ENFAR.IdProd "
                    + "WHERE PRODUTOS_AC.StatusProd='" + statusProd + "'AND Qtd!='" + 0 + "'AND EstornoProduto='" + estornoProduto + "'AND IdDevo='" + jIdReq.getText() + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        } else {
