 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_MANU_ENF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_MANU_ENF() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATENDIMENTO_GRUPO_ENFERMAGEM WHERE IdAtGrupoPsiEnf='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
