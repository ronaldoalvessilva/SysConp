 ...
 * @author ronaldo
 */
public class TelaFotoColaborador extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaEntradaSaidaColaborador telaentradasaidacoladorador;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoColaborador(TelaEntradaSaidaColaborador parent, boolean modal) {
        this.telaentradasaidacoladorador = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaentradasaidacoladorador);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoColaborador dialog = new TelaFotoColaborador(telaentradasaidacoladorador, true);
