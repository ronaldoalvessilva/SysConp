...
import gestor.Controle.ControleOcorrenciasEducacaoFisica;
...
import static gestor.Visao.TelaModuloEducacaoFisica.telaOcorrenciaManu_EF;
 ...
 * @author ronaldo
 */
public class TelaOcorrenciaEducacaoFisica extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    OcorrenciasPortaria objOcorr = new OcorrenciasPortaria();
    ControleOcorrenciasEducacaoFisica control = new ControleOcorrenciasEducacaoFisica();
    ...
    String nomeModuloTela = "Educação Física:Movimentação:Ocorrências Diárias:Manutenção";
    String horaMov;
    String dataModFinal;
    int count = 0;
    ...
    //
    String caminhoPDF = "";
    String tituloOcorrencia = "OCORRÊNCIA_EDUCACAO_FISICA";
    String dataPDF = "";
    String horaPDF = "";
     ...
     */
    public TelaOcorrenciaEducacaoFisica() {
        initComponents();
        corCampos();
        formatarCampos();
    }
    ...
    private void initComponents() {
        ...
        setBounds(300, 10, 634, 572);
    }// </editor-fold>//GEN-END:initComponents

    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaOcorrenciaManu_EF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaOcorrenciaManu_EF) && codIncluirEF == 1) {
            acao = 1;
            Novo();
            loadFont();
            corCampos();
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaOcorrenciaManu_EF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaOcorrenciaManu_EF) && codAlterarEF == 1) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaOcorrenciaManu_EF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoP1 && nomeTelaEF.equals(telaOcorrenciaManu_EF) && codExcluirEF == 1) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            objOcorr.setStatusLanc(jStatusOcorrencia.getText());
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaOcorrenciaManu_EF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaOcorrenciaManu_EF) && codGravarEF == 1) {
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        try {
            conecta.executaSQL("SELECT * FROM OCORRENCIAS_EF "
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaOcorrencias_EF objAudiOcorre = new TelaAuditoriaOcorrencias_EF();
        TelaModuloEducacaoFisica.jPainelEducacaoFisica.add(objAudiOcorre);
        objAudiOcorre.show();
    ...
    private void jBtImpressaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtImpressaoActionPerformed
        ...
        try {
            conecta.abrirConexao();
            String path = "reports/EducacaoFisica/ListagemOcorrencias_EF.jasper";
            conecta.executaSQL("SELECT * FROM OCORRENCIAS_EF WHERE IdLanc='" + jIdOcorrencia.getText() + "'");
    ...
    private void jBtPesqCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoActionPerformed
        ...
        if (jCodigo.getText().equals("")) {
            ...
            pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_EF "
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_EF");
        } else {
    ...
    private void jBtPesqTituloOcorrrenciaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtPesqTituloOcorrrenciaMouseClicked
        ...
        if (jPesqTituloOcorrencia.getText().equals("")) {
            ...
            pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_EF WHERE WHERE Titulo "
