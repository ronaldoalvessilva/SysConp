 ...
 * @author ronaldo
 */
public class TelaDepositoBancario extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    DepositoInterno objDeposito = new DepositoInterno();
    ControleDeposito control = new ControleDeposito();
    ...
    String nomeModuloTela = "Controle Valores:DepositoValores:Manutenção";
    String statusMov;
    String horaMov;
    String dataModFinal;
     ...
     */
    public static TelaDescontoAcrescimoValorDeposito descAcreDeposito;

    public TelaDepositoBancario() {
        initComponents();
        corCampos();
        formatarCampos();
    }
    ...
    public void mostrarDesconto() {
        descAcreDeposito = new TelaDescontoAcrescimoValorDeposito(this, true);
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Depósito de Valores R$ {FIN} :::...");
        ...
        jBtBuscarDeposito.setForeground(new java.awt.Color(153, 0, 102));
        ...
        jBtDesconto.setForeground(new java.awt.Color(204, 0, 0));
        ...
        jValorDescontoAcrescimo.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        jValorDescontoAcrescimo.setEnabled(false);
        jValorDescontoAcrescimo.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jValorDescontoAcrescimo, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jBtDesconto, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jObservacao)
                    .addComponent(jDepositante, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 394, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18))
        );
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(jPanel3, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 497, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (codigoUser == codUserAcesso && nomeTela.equals(telaDepositoAtivo) && codIncluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        if (codigoUser == codUserAcesso && nomeTela.equals(telaDepositoAtivo) && codAlterar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            verificarLiberacao();
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        if (codigoUser == codUserAcesso && nomeTela.equals(telaDepositoAtivo) && codExcluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        if (codigoUser == codUserAcesso && nomeTela.equals(telaDepositoAtivo) && codGravar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
                    ...
                    if (jDepositante.getText().equals("")) {
                        ...
                        if (acao == 1) {
                            ...
                            if (nameUser.equals("ADMINISTRADOR DO SISTEMA")) {
                                ...
                                if (jSituacao.getText().equals("ENTRADA NA UNIDADE")
                                        || jSituacao.getText().equals("RETORNO A UNIDADE")) {
                                    // log de usuario
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaDeposito("SELECT * FROM DEPOSITO "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON DEPOSITO.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc");
        } else {
    ...
    private void jBtPesqInternoDepFinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqInternoDepFinActionPerformed
        // TODO add your handling code here:
        TelaPesqInternoDeposito objPesqInterDepo = new TelaPesqInternoDeposito();
        TelaModuloFinanceiro.jPainelFinanceiro.add(objPesqInterDepo);
        objPesqInterDepo.show();
    ...
    private void jTabelaDepositoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaDepositoMouseClicked
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM DEPOSITO "
                        + "INNER JOIN PRONTUARIOSCRC "
                        + "ON DEPOSITO.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                        + "INNER JOIN DADOSPENAISINTERNOS "
                        + "ON DEPOSITO.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
                        + "WHERE IdLanc='" + jIdPesqDep.getText() + "'");
                conecta.rs.first();
            ...
            try {
                ...
                if (valorDescontoAcrescimo != 0) {
                    DecimalFormat vdesc = new DecimalFormat("#,###0.00");
                    String vlDesconto = vdesc.format(valorDescontoAcrescimo);
    ...
    private void jBtBuscarDepositoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtBuscarDepositoActionPerformed
        // TODO add your handling code here:
        TelaPesqDepositoPortaria objDepositoPort = new TelaPesqDepositoPortaria();
        TelaModuloFinanceiro.jPainelFinanceiro.add(objDepositoPort);
        objDepositoPort.show();
    }//GEN-LAST:event_jBtBuscarDepositoActionPerformed

    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaDeposito objAudDepoInt = new TelaAuditoriaDeposito();
