...
import static gestor.Visao.TelaAtendimentoGrupoENF.pCODIGO_AVALIACAO_GRUPO;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_AGRU_ENF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_AGRU_ENF() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AVALICAO_ATENDIMENTO_GRUPO_ENFERMAGEM "
                    + "WHERE IdItemAvagEnf='" + pCODIGO_AVALIACAO_GRUPO + "' "
