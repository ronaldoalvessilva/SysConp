...
import gestor.Dao.*;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.idItem;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jBtNovoItem;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jBtAlterarItem;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jBtCancelarItem;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jBtExcluirItem;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jBtSalvarItem;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jCPFAjudante;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jDataEntrada;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jDataSaida;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jDestino;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jHorarioEntrada;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jHorarioSaida;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jIdLanc;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jIdAjudante;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jNomeAjudante;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jOrigem;
import static gestor.Visao.TelaEntradaSaidaVeiculosCargasExterna.jRGAjudante;
 ...
 * @author user
 */
public class TelaPesqItensVeiculosCargasExterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqItensVeiculosCargasExterna() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa de Veiculos de Terceiros - {P1 Externa} :::...");
    ...
    private void jBtPesqNomeVisitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeVisitaActionPerformed
        ...
        if (jPesqNomeVisita.getText().equals("")) {
            ...
            buscarVisitasVeiculos("SELECT * FROM ITENSVEICULOCARGA "
                    + "INNER JOIN VISITASDIVERSAS "
                    + "ON ITENSVEICULOCARGA.IdVisita=VISITASDIVERSAS.IdVisita "
                    + "WHERE NomeVisita LIKE'" + jPesqNomeVisita.getText() + "%' "
                    + "AND IdLanc='" + jIdLanc.getText() + "'");
