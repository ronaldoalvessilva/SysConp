...
import static gestor.Visao.TelaTransCelasBGPA.FotoInternoTransLoca;
import static gestor.Visao.TelaTransCelasBGPA.codCelaAnt;
import static gestor.Visao.TelaTransCelasBGPA.jBtZoom;
import static gestor.Visao.TelaTransCelasBGPA.jDescricaoCelaOrigem;
import static gestor.Visao.TelaTransCelasBGPA.jIdInterno;
import static gestor.Visao.TelaTransCelasBGPA.jNomeInterno;
import static gestor.Visao.TelaTransCelasBGPA.jPavilhaoOrigem;
 ...
 * @author user
 */
public class TelaPesqInternoTransfLocacaoBGPA extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoTransfLocacaoBGPA() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Internos {SE} :::...");
        ...
        if (jTabelaLocacao.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaLocacao.getColumnModel().getColumn(2).setMinWidth(120);
            jTabelaLocacao.getColumnModel().getColumn(2).setMaxWidth(120);
    ...
    private void jBtPesqNomeInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeInternoActionPerformed
        ...
        if (jPesqNomeInterno.getText().equals("")) {
            ...
            preencherTabelaInternos("SELECT * FROM ITENSLOCACAOINTERNO "
                    ...
                    + "AND PAVILHAO.NivelPav='" + nivel + "' AND CELAS.NivelCel='" + nivel + "'");
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            idInt = "" + jTabelaLocacao.getValueAt(jTabelaLocacao.getSelectedRow(), 0);
            ...
            try {
                ...
                conecta.rs.first();
                idLoca = conecta.rs.getString("IdLoca");
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaInternos("SELECT * FROM ITENSLOCACAOINTERNO "
                    ...
                    + "INNER JOIN PAVILHAO "
                    + "ON CELAS.IdPav=PAVILHAO.IdPav "
                    + "WHERE PAVILHAO.NivelPav='" + nivel + "' "
                    + "AND CELAS.NivelCel='" + nivel + "' ORDER BY PRONTUARIOSCRC.NomeInternoCrc");
        } else {
            limparTabela();
        }
