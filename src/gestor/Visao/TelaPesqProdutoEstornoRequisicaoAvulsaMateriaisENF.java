...
import static gestor.Visao.TelaEstornoRequisicaoMateriaisENF.jDescricaoProduto;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisENF.jCodProduto;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisENF.jCodigoBarras;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisENF.jLote;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisENF.jDataVctoLote;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisENF.jComboBoxUnidade;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisENF.jIdReq;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisENF.jQtdItem;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisENF.jValorUnitarioItem;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisENF.qtdDoses;
 ...
 * @author user
 */
public class TelaPesqProdutoEstornoRequisicaoAvulsaMateriaisENF extends javax.swing.JInternalFrame {
    ...
    // A VARIAVEL STATIC "qtdDoses" DA TELA DE ESTORNO SÓ É POSSÍVEL SE NÃO EXISTIR APRAZAMENTO PARA O PRODUTO
    String modulo = "F";

    /**
     * Creates new form TelaPesqProdutoFarmacia
     */
    public TelaPesqProdutoEstornoRequisicaoAvulsaMateriaisENF() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Requisição Avulsa de Produtos {ENF} :::...");
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "WHERE PRODUTOS_AC.DescricaoProd LIKE'%" + jPesqDescricaoProdutos.getText() + "%'AND PRODUTOS_AC.StatusProd='" + statusProd + "'AND Qtd!='" + 0 + "'AND EstornoProduto='" + estornoProduto + "'AND IdReq='" + jIdReq.getText() + "'AND QtdDosesAT='" + qtdDoses + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        }
    ...
    private void jCheckBoxPesqTodosProdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosProdItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {         
            this.preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "INNER JOIN ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF "
                    + "ON PRODUTOS_AC.IdProd=ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF.IdProd "
                    + "WHERE PRODUTOS_AC.StatusProd='" + statusProd + "'AND Qtd!='" + 0 + "' "
                    + "AND ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF.EstornoProduto='" + estornoProduto + "' "
                    + "AND ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF.IdReq='" + jIdReq.getText() + "' "
                    + "AND ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF.QtdDosesAT='" + qtdDoses + "' "
