 ...
 * @author Ronaldo
 */
public class TelaPesqRequisicaoMateriaisNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqRequisicaoMateriaisNUTRI() {
        initComponents();
    }
    ...
    private void jBtDescricaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtDescricaoActionPerformed
        ...
        if (jPesqNomeRequisitante.getText().equals("")) {
            ...
            preencherTabela("SELECT * FROM REQUISICAO_PRODUTOS_INTERNOS_NUTRI "
                    + "INNER JOIN COLABORADOR "
                    + "ON REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdFunc=COLABORADOR.IdFunc "
                    + "WHERE NomeFunc LIKE'%" + jPesqNomeRequisitante.getText() + "%'AND "
                    + "REQUISICAO_PRODUTOS_INTERNOS_NUTRI.StatusReq='" + statusReq + "'");
        }
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabela("SELECT * FROM REQUISICAO_PRODUTOS_INTERNOS "
                    + "INNER JOIN COLABORADOR "
                    + "ON REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdFunc=COLABORADOR.IdFunc "
                    + "WHERE REQUISICAO_PRODUTOS_INTERNOS_NUTRI.StatusReq='" + statusReq + "'");
        } else {
            limparTabela();
        }
