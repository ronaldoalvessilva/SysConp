...
import static gestor.Visao.TelaProdutosNUTRI.jIdProduto;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaProdutosNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaProdutosNUTRI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PRODUTOS_NUTRI WHERE IdProd='" + jIdProduto.getText() + "'");
            conecta.rs.first();
