 ...
 */
public class TelaInformacoesInternoBC3 extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaInformacoesInternoBC3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaInformacoesInternoBC3 dialog = new TelaInformacoesInternoBC3(baraCrime, true);
    ...
    public void pesquisarInterno() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "WHERE PRONTUARIOSCRC.IdInternoCrc='" + pINTERNO_L1D + "' "
            ...
            if (caminhoBC3 != null) {
                javax.swing.ImageIcon i = new javax.swing.ImageIcon(caminhoBC3);
                jFotoL14.setIcon(i);
            ...
            Logger.getLogger(TelaInformacoesInternoBC3.class.getName()).log(Level.SEVERE, null, ex);
        }
        conecta.desconecta();
    }
}
