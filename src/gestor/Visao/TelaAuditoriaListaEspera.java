 ...
 * @author Ronaldo
 */
public class TelaAuditoriaListaEspera extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaListaEspera() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Lista Espera de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM LISTAESPERA WHERE IdLanc='" + jIDLanc.getText() + "'");
            conecta.rs.first();
