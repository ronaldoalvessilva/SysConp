...
import static gestor.Visao.TelaDisciplina.jIdDisciplina;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaDisciplina extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaDisciplina() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Disciplinas :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM DISCIPLINAS WHERE IdDisc='" + jIdDisciplina.getText() + "'");
            conecta.rs.first();
