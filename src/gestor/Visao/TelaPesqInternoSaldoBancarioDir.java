...
import static gestor.Visao.TelaConsultaSaldoFinDir.jBtPesqData;
import static gestor.Visao.TelaConsultaSaldoFinDir.jDataEntradaInternoFin;
import static gestor.Visao.TelaConsultaSaldoFinDir.jDataNascInternoFin;
import static gestor.Visao.TelaConsultaSaldoFinDir.jFotoInternoFinanceiro;
import static gestor.Visao.TelaConsultaSaldoFinDir.jIdInternoFinDir;
import static gestor.Visao.TelaConsultaSaldoFinDir.jNomeInternoFin;
import static gestor.Visao.TelaConsultaSaldoFinDir.jSituacao;
import static gestor.Visao.TelaConsultaSaldoFinDir.jTabelaDepositoDir;
import static gestor.Visao.TelaConsultaSaldoFinDir.jTabelaSaqueDir;
import static gestor.Visao.TelaConsultaSaldoFinDir.jlSaldoAtual;
import static gestor.Visao.TelaConsultaSaldoFinDir.jlTotalCredito;
import static gestor.Visao.TelaConsultaSaldoFinDir.jlTotalDebito;
 ...
 * @author Ronaldo
 */
public class TelaPesqInternoSaldoBancarioDir extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoSaldoBancarioDir() {
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            preencherTabelaDeposito("SELECT * FROM DEPOSITO "
                    ...
                    + "WHERE DEPOSITO.IdInternoCrc='" + jIdInternoFinDir.getText() + "'AND ValorDeposito='" + valorTotalDebito + "'");
            preencherTabelaSaque("SELECT * FROM SAQUE "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON SAQUE.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "WHERE SAQUE.IdInternoCrc='" + jIdInternoFinDir.getText() + "'AND ValorSaque='" + valorTotalCredito + "'");
            dispose();
        }
