...
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.jDescricaoProduto;
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.jCodProduto;
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.jCodigoBarras;
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.jLote;
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.jDataVctoLote;
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.jComboBoxUnidade;
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.jValorUnitarioItem;
 ...
 * @author user
 */
public class TelaPesqProdutoDevolucaoENFAR extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoDevolucaoENFAR() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Produtos {ENFAR} :::...");
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "ON PRODUTOS_AC.IdProd=LOTE_PRODUTOS_FNF.IdProd "
