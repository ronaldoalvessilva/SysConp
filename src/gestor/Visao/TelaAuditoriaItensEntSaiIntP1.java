 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntSaiIntP1 extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEntSaiIntP1() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSLABORINTERNO WHERE IdLanc='" + jIDlanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
