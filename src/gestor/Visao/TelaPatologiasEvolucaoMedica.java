 ...
 * @author Ronaldo
 */
public class TelaPatologiasEvolucaoMedica extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    PatologiaEvolucaoPsiquiatrica objPatEvol = new PatologiaEvolucaoPsiquiatrica();
    ControlePatologiaEvolucaoMedica control = new ControlePatologiaEvolucaoMedica();
    //
    ControleLogSistema controlLog = new ControleLogSistema();
    LogSistema objLogSys = new LogSistema();
    //
    String nomeModuloTela = "Enfermagem:Anamnese Médica de Internos:Patologias";
    String statusMov;
    String horaMov;
    String dataModFinal;
    int flag;
    ...
    public TelaPatologiasEvolucaoMedica(TelaAdmissaoMedica parent, boolean modal) {
        this.telaAdmissaoMedica = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaAdmissaoMedica);
        initComponents();
        corCampos();
        jNomeInternoEvolucaoMedica.setText(jNomeCompletoInternoEvolucaoMedica.getText());

        preencherTabelaPatologiasPsiquiatricas("SELECT * FROM PATOLOGIA_EVOLUCAO_MEDICA "
                + "INNER JOIN DOENCAS "
                + "ON PATOLOGIA_EVOLUCAO_MEDICA.IdDoenca=DOENCAS.IdDoenca "
                + "INNER JOIN EVOLUCAOMEDICA "
                + "ON PATOLOGIA_EVOLUCAO_MEDICA.IdItem=EVOLUCAOMEDICA.IdItem "
                + "WHERE PATOLOGIA_EVOLUCAO_MEDICA.IdInternoCrc='" + jIdInternoAdm.getText() + "' "
                + "AND PATOLOGIA_EVOLUCAO_MEDICA.IdItem='" + jIdEvolucaoMedica.getText() + "'");
    }
    ...
    private void initComponents() {
        ...
        jNomeInternoEvolucaoMedica = new javax.swing.JTextField();
        ...
        jNomeInternoEvolucaoMedica.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jNomeInternoEvolucaoMedica.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        jNomeInternoEvolucaoMedica.setEnabled(false);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jNomeInternoEvolucaoMedica)
                    .addGroup(jPanel2Layout.createSequentialGroup()
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel4)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jNomeInternoEvolucaoMedica, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        if (jDataReg.getDate() == null) {
            ...
            objPatEvol.setIdItem(Integer.valueOf(jIdEvolucaoMedica.getText()));
    ...
    private void jTabelaRegiaoPatologiasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaRegiaoPatologiasMouseClicked
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PATOLOGIA_EVOLUCAO_MEDICA "
                        + "INNER JOIN DOENCAS "
                        + "ON PATOLOGIA_EVOLUCAO_MEDICA.IdDoenca=DOENCAS.IdDoenca "
                        + "INNER JOIN EVOLUCAOMEDICA "
                        + "ON PATOLOGIA_EVOLUCAO_MEDICA.IdItem=EVOLUCAOMEDICA.IdItem "
                        + "WHERE PATOLOGIA_EVOLUCAO_MEDICA.IdPatMed='" + IdLanc + "'");
                conecta.rs.first();
                jCodigoEvolucaoPat.setText(String.valueOf(conecta.rs.getInt("IdPatMed")));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPatologiasEvolucaoMedica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaPatologiasEvolucaoMedica dialog = new TelaPatologiasEvolucaoMedica(telaAdmissaoMedica, true);
    ...
    private javax.swing.JTextField jNomeInternoEvolucaoMedica;
    ...
    public void corCampos() {
        jNomeInternoEvolucaoMedica.setBackground(Color.white);
    ...
    public void preencherTabelaPatologiasPsiquiatricas(String sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdPatMed"), dataCadastro, conecta.rs.getString("IdDoenca"), conecta.rs.getString("Descricao"), conecta.rs.getString("Cid")});
            } while (conecta.rs.next());
        } catch (SQLException ex) {
        }
