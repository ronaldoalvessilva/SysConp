...
import static gestor.Visao.TelaAtendimentoGrupoENF.pCODIGO_AVALIACAO_GRUPO_AVGI;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_AIGRU_ENF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_AIGRU_ENF() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_ENFERMAGEM "
                    + "WHERE IdItemAvaiEnf='" + pCODIGO_AVALIACAO_GRUPO_AVGI + "' "
                    + "AND IdAtGrupoEnf='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
