 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntSaiVeicuUnidadeExterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEntSaiVeicuUnidadeExterna() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Entrada/Saida Itens Veiculos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSVEICULOSUNIDADE WHERE IdLanc='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
