 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntSaiTransientes extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEntSaiTransientes() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_TRANSIENTES_VISITAS_DIVERSAS WHERE IdTrans='" + jIdLanc.getText() + "'AND IdItem='" + idItemTran + "'");
            conecta.rs.first();
