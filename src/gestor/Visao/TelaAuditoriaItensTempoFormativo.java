...
import static gestor.Visao.TelaTempoFormativo.jIdLanc;
import static gestor.Visao.TelaTempoFormativo.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensTempoFormativo extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensTempoFormativo() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Disciplina Tempo Formativo :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSTFDISCIPLINA WHERE IdTempo='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
