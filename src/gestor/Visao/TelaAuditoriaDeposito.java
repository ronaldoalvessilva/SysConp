 ...
 * @author Ronaldo
 */
public class TelaAuditoriaDeposito extends javax.swing.JInternalFrame {
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM DEPOSITO WHERE IdLanc='" + jIdLanc.getText() + "'");
            conecta.rs.first();
