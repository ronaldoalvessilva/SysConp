 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEscalaTrabalho extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEscalaTrabalho() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ESCALA_TRABALHO WHERE IdRegistro='" + jIdRegistro.getText() + "'");
            conecta.rs.first();
