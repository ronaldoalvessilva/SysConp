...
import static gestor.Visao.TelaCompraLivros.jIdDoc;
import static gestor.Visao.TelaCompraLivros.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensCompraAcervo extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensCompraAcervo() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Itens Compra :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_COMPRA_ACERVO WHERE IdCompra='" + jIdDoc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
