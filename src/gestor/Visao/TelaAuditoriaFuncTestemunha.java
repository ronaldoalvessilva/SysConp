...
import static gestor.Visao.TelaEventoDisciplinar.idItemFuncTes;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaFuncTestemunha extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaFuncTestemunha() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Colaborador Testemunha :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM COLABORADORTESTEMUNHA WHERE IdLanc='" + jIdLanc.getText() + "'AND IdColaVit='" + idItemFuncTes + "'");
            conecta.rs.first();
