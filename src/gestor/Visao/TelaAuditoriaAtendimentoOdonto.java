 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAtendimentoOdonto extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAtendimentoOdonto() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Admissão de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATENDIMENTODONTO WHERE IdLanc='" + jIDLanc.getText() + "'");
            conecta.rs.first();
