 ...
 */
public class TelaRelatorioInternosCursoCursando extends javax.swing.JInternalFrame {
     ...
     */
    public TelaRelatorioInternosCursoCursando() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Relatório de Internos Realizando Curso :::...");
                ...
                if (jDataFinal.getDate() == null) {
                    ...
                    if (jDataInicial.getDate().after(jDataFinal.getDate())) {
                        ...
                        try {
                            ...
                            String path = "reports/TerapiaOcupacional/RelatorioInternosPassaramCurso.jasper";
