 ...
 */
public class TelaRelatorioProducaoEducacaoFisica extends javax.swing.JInternalFrame {
     ...
     */
    public TelaRelatorioProducaoEducacaoFisica() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Relatório de Produtividade Educação Física :::...");
        ...
        if (tipoServidor == null || tipoServidor.equals("")) {
            ...
            if (jDataInicial.getDate() == null) {
                ...
                try {
                    ...
                    String path = "reports/EducacaoFisica/QuantitativoAtendimentoEducacaoFisica/RelatorioQuantitativoAtendimentoEducacaoFisica.jasper/";
                     conecta.executaSQL("SELECT TOP 1 * FROM ADMISSAO_EDUCACAO_FISICA AS A "
                            + "INNER JOIN PRONTUARIOSCRC AS B "
                            + "ON A.IdInternoCrc=B.IdInternoCrc "
                            + "WHERE A.DataRegistroEF BETWEEN'" + dataInicial + "' "
                            + "AND '" + dataFinal + "' "
                            + "ORDER BY A.DataRegistroEF, A.UsuarioInsert");
                    ...
                    jv.setTitle("Relatório Quantitativo de Atendimento de Educação Física por Período");
