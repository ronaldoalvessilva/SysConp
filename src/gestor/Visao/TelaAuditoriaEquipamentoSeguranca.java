 ...
 */
public class TelaAuditoriaEquipamentoSeguranca extends javax.swing.JDialog {
     ...
     */
    public static TelaEquipamentosEPI pTELA_EQUIPAMENTO_epi;

    public TelaAuditoriaEquipamentoSeguranca(TelaEquipamentosEPI parent, boolean modal) {
        this.pTELA_EQUIPAMENTO_epi = parent;
        this.setModal(modal);
        setLocationRelativeTo(pTELA_EQUIPAMENTO_epi);
        initComponents();
        auditoria();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAuditoriaEquipamentoSeguranca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAuditoriaEquipamentoSeguranca dialog = new TelaAuditoriaEquipamentoSeguranca(pTELA_EQUIPAMENTO_epi, true);
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM EQUIPAMENTOS_SEGURANCA_EPI WHERE IdEquipamento='" + jCodigoEquipamento.getText() + "'");
            conecta.rs.first();
