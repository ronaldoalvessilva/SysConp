...
import Utilitarios.JTableRenderer;
 ...
 * @author Ronaldo
 */
public final class TelaFornecedorCOMPRAS extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    Fornecedor objForn = new Fornecedor();
    ControleFornecedoresCOMPRAS control = new ControleFornecedoresCOMPRAS();
    //
    ControleLogSistema controlLog = new ControleLogSistema();
    LogSistema objLogSys = new LogSistema();
    // Variáveis para gravar o log
    String nomeModuloTela = "Compras:Fornecedor:Manutenção";
    //
    String statusMov;
    String horaMov;
    String dataModFinal;
    ...
    private void initComponents() {
        ...
        jComboBoxDepartamento.setForeground(new java.awt.Color(102, 0, 51));
        jComboBoxDepartamento.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "", "Nutrição", "Acervo", "Farmácia", "Almoxarifado" }));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jNomeFantasia, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jLabel9)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jComboBoxDepartamento, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(jRazao))
                .addContainerGap())
        );
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Pessoa Jurídica", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(0, 153, 0))); // NOI18N
        ...
        jPanel9.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Contato", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(0, 0, 255))); // NOI18N
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jCep, javax.swing.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)))
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jCepCob, javax.swing.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)))
        ...
        if (jTabelaHistoricoProdutos.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaHistoricoProdutos.getColumnModel().getColumn(2).setMinWidth(60);
            jTabelaHistoricoProdutos.getColumnModel().getColumn(2).setMaxWidth(60);
            ...
            jTabelaHistoricoProdutos.getColumnModel().getColumn(5).setMinWidth(120);
            jTabelaHistoricoProdutos.getColumnModel().getColumn(5).setMaxWidth(120);
        }
        ...
        if (jComboBoxClass.getSelectedItem() == null) {
            ...
            if (jComboBoxStatus.getSelectedItem() == null) {
                ...
                if (jRazao.getText().equals("")) {
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Informe para qual setor é o fornecedor.");
                } else {
                    ...
                    objForn.setDepartamento((String) jComboBoxDepartamento.getSelectedItem());
                    if (jComboBoxDepartamento.getSelectedItem().equals("Almoxarifado")) {
                        modulo = "A";
                    ...
                    if (acao == 1) {
                        ...
                        //
                        control.incluirFornecedorCOMPRAS(objForn);
                        buscarId();
                        Salvar();
                        objLog();
                    ...
                    if (acao == 2) {
                        ...
                        control.alterarFornecedorCOMPRAS(objForn);
                        Salvar();
                        objLog();
                        controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                        JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
    ...
    private void jBtPesqNomeFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeFornecedorActionPerformed
        ...
        if (jPesqNomeFornecedor.getText().equals("")) {
            ...
            preencherTabelaFornecedor("SELECT * FROM FORNECEDORES_AC WHERE RazaoSocial LIKE'" + jPesqNomeFornecedor.getText() + "%'");
        }
    ...
    private void jCheckBoxTodosFornItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosFornItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaFornecedor("SELECT * FROM FORNECEDORES_AC");
        } else {
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaFornecedorCompras objAudiFornComp = new TelaAuditoriaFornecedorCompras();
        TelaModuloCompras.jPainelCompras.add(objAudiFornComp);
        objAudiFornComp.show();
    ...
    private void jBtPesqDescricaoProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdutoActionPerformed
        // TODO add your handling code here:
        count = 0;
        if (jPesqProdutosCompras.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Informe o nome do fornecedor a ser pesquisado.");
        } else if (jComboBoxDepartamento.getSelectedItem().equals("Almoxarifado")) {
    ...
    public void corCampos() {
        ...
        jNomeContato.setBackground(Color.white);
    ...
    public void buscarId() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM FORNECEDORES_COMPRAS");
            conecta.rs.last();
            jIdFornecedor.setText(String.valueOf(conecta.rs.getInt("IdForn")));
    ...
    // Ainda não está pronto, falta o arquivo de histório de compras. 29-09-2014 (17//11/2015) NÃO FOI TESTADO
    public void verificarFornecedor() {
        statusMov = "Excluiu";
        horaMov = jHoraSistema.getText();
        dataModFinal = jDataSistema.getText();
        verificarFornecedorAlmoxarifado();
        verificarFornecedorAcervo();
        verificarFornecedorNutricao();
        verificarfornecedorFarmacia();
        if (jIdFornecedor.getText() == null ? codFornecedor == null : jIdFornecedor.getText().equals(codFornecedor)) {
            JOptionPane.showMessageDialog(rootPane, "Não é possível excluir esse FORNECEDOR, o mesmo está sendo utilizado por outro registro.");
        } else if (jIdFornecedor.getText() == null ? codFornecedorAcervo == null : jIdFornecedor.getText().equals(codFornecedorAcervo)) {
            JOptionPane.showMessageDialog(rootPane, "Não é possível excluir esse FORNECEDOR, o mesmo está sendo utilizado por outro registro.");
        } else if (jIdFornecedor.getText() == null ? codFornecedorNutricao == null : jIdFornecedor.getText().equals(codFornecedorNutricao)) {
            JOptionPane.showMessageDialog(rootPane, "Não é possível excluir esse FORNECEDOR, o mesmo está sendo utilizado por outro registro.");
        } else if (jIdFornecedor.getText() == null ? codFornecedorFarmacia == null : jIdFornecedor.getText().equals(codFornecedorFarmacia)) {
            JOptionPane.showMessageDialog(rootPane, "Não é possível excluir esse FORNECEDOR, o mesmo está sendo utilizado por outro registro.");
        } else {
            int resposta = JOptionPane.showConfirmDialog(this, "Deseja realmente excluir registro selecionado?", "Confirmação",
                    JOptionPane.YES_NO_OPTION);
            if (resposta == JOptionPane.YES_OPTION) {
                control.excluirFornecedorCOMPRAS(objForn);
//                if (jComboBoxDepartamento.getSelectedItem().equals("Nutrição")) {
//                    control.excluirFornecedorNUTRICAO(objForn);
//                } else if (jComboBoxDepartamento.getSelectedItem().equals("Acervo")) {
//                    control.excluirFornecedorACERVO(objForn);
//                } else if (jComboBoxDepartamento.getSelectedItem().equals("Farmácia")) {
//                    control.excluirFornecedorFARMACIA(objForn);
//                } else if (jComboBoxDepartamento.getSelectedItem().equals("Almoxarifado")) {
//                    control.excluirFornecedorALMOXARIFADOCENTRAL(objForn);
//                }
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
    ...
    public void verificarFornecedorAlmoxarifado() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM PRODUTOS_AC WHERE IdForn='" + jIdFornecedor.getText() + "'");
            conecta.rs.first();
    ...
    public void verificarFornecedorAcervo() {
        try {
            conecta.executaSQL("SELECT * FROM LIVROS_REVISTAS_JORNAIS WHERE IdForn='" + jIdFornecedor.getText() + "'");
            conecta.rs.first();
            codFornecedorAcervo = conecta.rs.getString("IdForn");
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(rootPane, "Não foi possível selecionar o arquivo.\nERRO: " + ex);
        }
        conecta.desconecta();
    ...
    public void verificarfornecedorFarmacia() {
        try {
            conecta.executaSQL("SELECT * FROM PRODUTOS WHERE IdForn='" + jIdFornecedor.getText() + "'");
            conecta.rs.first();
            codFornecedorFarmacia = conecta.rs.getString("IdForn");
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(rootPane, "Não foi possível selecionar o arquivo.\nERRO: " + ex);
        }
        conecta.desconecta();
    ...
    public void verificarFornecedorNutricao() {
        try {
            conecta.executaSQL("SELECT * FROM PRODUTOS_NUTRI WHERE IdForn='" + jIdFornecedor.getText() + "'");
            conecta.rs.first();
            codFornecedorNutricao = conecta.rs.getString("IdForn");
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(rootPane, "Não foi possível selecionar o arquivo.\nERRO: " + ex);
        }
        conecta.desconecta();
