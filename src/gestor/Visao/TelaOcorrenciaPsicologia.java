...
import gestor.Controle.ControleOcorrenciaPsicologia;
...
import static gestor.Visao.TelaModuloPsicologia.telaMovimetacaoOcrPSI;
 ...
 * @author ronaldo
 */
public class TelaOcorrenciaPsicologia extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    OcorrenciaPsicologia objOcorr = new OcorrenciaPsicologia();
    ControleOcorrenciaPsicologia control = new ControleOcorrenciaPsicologia();
    ...
    String nomeModuloTela = "Psicologia:Movimentação:Ocorrências Diárias:Manutenção";
    String horaMov;
    String dataModFinal;
     ...
     */
    public TelaOcorrenciaPsicologia() {
        initComponents();
        corCampos();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Ocorrência Psicologia :::...");
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPSI.equals("ADMINISTRADORES") || codigoUserPSI == codUserAcessoPSI && nomeTelaPSI.equals(telaMovimetacaoOcrPSI) && codExcluirPSI == 1) {
            ...
            if (jStatusOcorrencia.getText().equals("FINALIZADO")) {
                ...
                if (resposta == JOptionPane.YES_OPTION) {
                    ...
                    control.excluirOcorrenciaPsi(objOcorr);
                    objLog();
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPSI.equals("ADMINISTRADORES") || codigoUserPSI == codUserAcessoPSI && nomeTelaPSI.equals(telaMovimetacaoOcrPSI) && codGravarPSI == 1) {
            if (jDataOcorrencia.getDate() == null) {
                ...
                if (jTituloOcorrencia.getText().equals("")) {
                    ...
                    if (acao == 1) {
                        control.incluirOcorrenciaPsi(objOcorr);
                        buscarID();
                        Salvar();
                        objLog();
                        controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    ...
                    if (acao == 2) {
                        ...
                        control.alterarOcorrenciaPsi(objOcorr);
                        Salvar();
                        objLog();
                        controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                        JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaOcorrenciasPsicologia objAudiOcorre = new TelaAuditoriaOcorrenciasPsicologia();
        TelaModuloPsicologia.jPainelPsicologia.add(objAudiOcorre);
        objAudiOcorre.show();
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            ...
            this.pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_PSI");
        } else {
            jTabelaOcorrenciaPortaria.setVisible(!true);
        }
        ...
        if (jDataPesqInicial.getDate() == null) {
            ...
            if (jDataPesFinal.getDate() == null) {
                ...
                if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                    ...
                    jTabelaOcorrenciaPortaria.setVisible(true);
                    pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_PSI WHERE DataLanc BETWEEN'" + dataInicial + "'AND '" + dataFinal + "'");
                }
            }
        }
    ...
    private void jBtPesqTituloOcorrrenciaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtPesqTituloOcorrrenciaMouseClicked
        ...
        if (jPesqTituloOcorrencia.getText().equals("")) {
            ...
            jTabelaOcorrenciaPortaria.setVisible(true);
            pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_PSI WHERE WHERE Titulo LIKE'" + jPesqTituloOcorrencia + "%'");
        }
    ...
    private void jTabelaOcorrenciaPortariaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaOcorrenciaPortariaMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM OCORRENCIAS_PSI WHERE IdLanc ='" + IdLanc + "'");
                conecta.rs.first();
    ...
    public void Finalizar() {
        ...
        if (resposta == JOptionPane.YES_OPTION) {
            objOcorr.setStatusLanc(statusEntrada);
            objOcorr.setIdLanc(Integer.parseInt(jIdOcorrencia.getText()));
            control.finalizarOcorrenciaPsi(objOcorr);
            objLog();
            controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
    ...
    public void buscarID() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM OCORRENCIAS_PSI");
            conecta.rs.last();
