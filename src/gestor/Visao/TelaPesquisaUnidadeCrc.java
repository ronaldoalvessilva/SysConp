...
import static gestor.Visao.TelaProntuarioCrc.jComboBoxUnid;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaUnidadeCrc extends javax.swing.JInternalFrame {
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        jComboBoxUnid.setText(jPesNomeUnidade.getText());
        dispose();
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabela("SELECT * FROM UNIDADE ORDER BY DescricaoUnid");
        } else {
            limparTabela();
        }
