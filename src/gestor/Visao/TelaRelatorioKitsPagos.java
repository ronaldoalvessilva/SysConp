 ...
 */
public class TelaRelatorioKitsPagos extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form TelaRelatorioKitsPagos
     */
    public TelaRelatorioKitsPagos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jRBt_INICIAL = new javax.swing.JRadioButton();
        jBtConfirmar = new javax.swing.JButton();
        jBtSair = new javax.swing.JButton();

        setClosable(true);
        setTitle("...::: Relatórios de Kits Pagos :::...");
        ...
        grupoBotoes.add(jRBt_QUINZENAL);
        ...
        grupoBotoes.add(jRBt_DECENDIAL);
        ...
        grupoBotoes.add(jRBt_SEMESTRAL);
        ...
        grupoBotoes.add(jRBt_ANUAL);
        jRBt_ANUAL.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jRBt_ANUAL.setText("Anual");

        grupoBotoes.add(jRBt_INICIAL);
        jRBt_INICIAL.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jRBt_INICIAL.setSelected(true);
        jRBt_INICIAL.setText("Inicial");
        ...
        setBounds(300, 60, 291, 298);
    }// </editor-fold>//GEN-END:initComponents

    private void jBtConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtConfirmarActionPerformed
        // TODO add your handling code here:
        if (jRBt_INICIAL.isSelected() == true) {
                            ...
                            Thread t = new Thread() { //Teste tela aguarde
                                public void run() { //Teste tela aguarde
                                    try {
                                        ...
                                        String path = "reports/Almoxarifado/RelatorioPagamentoKitInicial.jasper";
                                        conecta.executaSQL("SELECT DISTINCT "
                                                ...
                                                + "ON c.IdPav=q.IdPav "
                                                + "WHERE CONVERT(DATE, d.DataPagto) BETWEEN'" + dataInicial + "' "
                                                + "AND'" + dataFinal + "' "
                                                + "AND p.SituacaoCrc='" + pENTRADA_unidade + "' "
                                                + "OR CONVERT(DATE, d.DataPagto) BETWEEN'" + dataInicial + "' "
                                                + "AND'" + dataFinal + "' "
                                                + "AND p.SituacaoCrc='" + pRETORNO_unidade + "' "
                                        ...
                                        parametros.put("pSITUACAO_entrada", pENTRADA_unidade);
                                        parametros.put("pSITUACAO_retorno", pRETORNO_unidade);
                                        JRResultSetDataSource relatResul = new JRResultSetDataSource(conecta.rs); // Passa o resulSet Preenchido para o relatorio
                                        JasperPrint jpPrint = JasperFillManager.fillReport(path, parametros, relatResul); // indica o caminmhodo relatório
                                        JasperViewer jv = new JasperViewer(jpPrint, false); // Cria instancia para impressao
                                        jv.setExtendedState(JasperViewer.MAXIMIZED_BOTH); // Maximizar o relatório
                                        jv.setTitle("Relatório de Pagamento de Kit Inicial");
        ...
        } else if (jRBt_DECENDIAL.isSelected() == true) {
            if (tipoServidor == null || tipoServidor.equals("")) {
                JOptionPane.showMessageDialog(rootPane, "É necessário definir o parâmtero para o sistema operacional utilizado no servidor, (UBUNTU-LINUX ou WINDOWS SERVER).");
            } else if (tipoServidor.equals("Servidor Linux (Ubuntu)/MS-SQL Server")) {
                if (jDataPesqInicial.getDate() == null) {
                        ...
                        if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                            ...
                            Thread t = new Thread() { //Teste tela aguarde
                                public void run() { //Teste tela aguarde
                                    try {
                                        conecta.abrirConexao();
                                        String path = "reports/Almoxarifado/RelatorioPagamentoKitDecendial.jasper";
                                        conecta.executaSQL("SELECT DISTINCT "
                                                + "d.DataPagto, "
                                                + "d.IdInternoCrc, "
                                                + "p.NomeInternoCrc, "
                                                ...
                                                + "q.IdPav, "
                                                + "q.DescricaoPav "
                                                + "FROM KITS_DECENDIAL_INTERNOS AS d "
                                                + "INNER JOIN PRONTUARIOSCRC AS p "
                                                + "ON d.IdInternoCrc=p.IdInternoCrc "
                                                + "INNER JOIN ITENSLOCACAOINTERNO AS l "
                                                + "ON d.IdInternoCrc=l.IdInternoCrc "
                                        ...
                                        JasperViewer jv = new JasperViewer(jpPrint, false); // Cria instancia para impressao
                                        jv.setExtendedState(JasperViewer.MAXIMIZED_BOTH); // Maximizar o relatório
                                        jv.setTitle("Relatório de Pagamento de Kit Decendial");
                                        jv.setVisible(true); // Chama o relatorio para ser visualizado
                                        jv.toFront(); // Traz o relatorio para frente da aplicação
                                        carregando.dispose(); //Teste tela aguarde
                                        conecta.desconecta();
                        ...
                        if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                            ...
                            Thread t = new Thread() { //Teste tela aguarde
                                public void run() { //Teste tela aguarde
                                    ...
                                    try {
                                        conecta.abrirConexao();
                                        String path = "reports/Almoxarifado/RelatorioPagamentoKitQuinzenal.jasper";
                                        conecta.executaSQL("SELECT DISTINCT "
                                                + "d.DataPagto, "
                                                + "d.IdInternoCrc, "
                                                + "p.NomeInternoCrc, "
                                                ...
                                                + "q.IdPav, "
                                                + "q.DescricaoPav "
                                                + "FROM KITS_QUINZENAL_INTERNOS AS d "
                                                + "INNER JOIN PRONTUARIOSCRC AS p "
                                                + "ON d.IdInternoCrc=p.IdInternoCrc "
                                                + "INNER JOIN ITENSLOCACAOINTERNO AS l "
                                                + "ON d.IdInternoCrc=l.IdInternoCrc "
                                        ...
                                        JasperViewer jv = new JasperViewer(jpPrint, false); // Cria instancia para impressao
                                        jv.setExtendedState(JasperViewer.MAXIMIZED_BOTH); // Maximizar o relatório
                                        jv.setTitle("Relatório de Pagamento de Kit Quinzenal");
                                        jv.setVisible(true); // Chama o relatorio para ser visualizado
                                        jv.toFront(); // Traz o relatorio para frente da aplicação
                                        carregando.dispose(); //Teste tela aguarde
                                        conecta.desconecta();
                        ...
                        if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                            ...
                            Thread t = new Thread() { //Teste tela aguarde
                                public void run() { //Teste tela aguarde
                                    try {
                                        conecta.abrirConexao();
                                        String path = "reports/Almoxarifado/RelatorioPagamentoKitMensal.jasper";
                                        conecta.executaSQL("SELECT DISTINCT "
                                                + "d.DataPagto, "
                                                + "d.IdInternoCrc, "
                                                + "p.NomeInternoCrc, "
                                                ...
                                                + "q.IdPav, "
                                                + "q.DescricaoPav "
                                                + "FROM KITS_MENSAL_INTERNOS AS d "
                                                + "INNER JOIN PRONTUARIOSCRC AS p "
                                                + "ON d.IdInternoCrc=p.IdInternoCrc "
                                                + "INNER JOIN ITENSLOCACAOINTERNO AS l "
                                                + "ON d.IdInternoCrc=l.IdInternoCrc "
                                        ...
                                        JasperViewer jv = new JasperViewer(jpPrint, false); // Cria instancia para impressao
                                        jv.setExtendedState(JasperViewer.MAXIMIZED_BOTH); // Maximizar o relatório
                                        jv.setTitle("Relatório de Pagamento de Kit Mensal");
                                        jv.setVisible(true); // Chama o relatorio para ser visualizado
                                        jv.toFront(); // Traz o relatorio para frente da aplicação
                                        carregando.dispose(); //Teste tela aguarde
                                        conecta.desconecta();
                        ...
                        if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                            ...
                            Thread t = new Thread() { //Teste tela aguarde
                                public void run() { //Teste tela aguarde
                                    try {
                                        conecta.abrirConexao();
                                        String path = "reports/Almoxarifado/RelatorioPagamentoKitSemestral.jasper";
                                        conecta.executaSQL("SELECT DISTINCT "
                                                + "d.DataPagto, "
                                                + "d.IdInternoCrc, "
                                                + "p.NomeInternoCrc, "
                                                ...
                                                + "q.IdPav, "
                                                + "q.DescricaoPav "
                                                + "FROM KITS_SEMESTRAL_INTERNOS AS d "
                                                + "INNER JOIN PRONTUARIOSCRC AS p "
                                                + "ON d.IdInternoCrc=p.IdInternoCrc "
                                                + "INNER JOIN ITENSLOCACAOINTERNO AS l "
                                                + "ON d.IdInternoCrc=l.IdInternoCrc "
                                        ...
                                        JasperViewer jv = new JasperViewer(jpPrint, false); // Cria instancia para impressao
                                        jv.setExtendedState(JasperViewer.MAXIMIZED_BOTH); // Maximizar o relatório
                                        jv.setTitle("Relatório de Pagamento de Kit Semestral");
                                        jv.setVisible(true); // Chama o relatorio para ser visualizado
                                        jv.toFront(); // Traz o relatorio para frente da aplicação
                                        carregando.dispose(); //Teste tela aguarde
                                        conecta.desconecta();
                        ...
                        if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                            ...
                            Thread t = new Thread() { //Teste tela aguarde
                                public void run() { //Teste tela aguarde
                                    try {
                                        conecta.abrirConexao();
                                        String path = "reports/Almoxarifado/RelatorioPagamentoKitAnual.jasper";
                                        conecta.executaSQL("SELECT DISTINCT "
                                                + "d.DataPagto, "
                                                + "d.IdInternoCrc, "
                                                + "p.NomeInternoCrc, "
                                        ...
                                        JasperViewer jv = new JasperViewer(jpPrint, false); // Cria instancia para impressao
                                        jv.setExtendedState(JasperViewer.MAXIMIZED_BOTH); // Maximizar o relatório
                                        jv.setTitle("Relatório de Pagamento de Kit Anual");
                                        jv.setVisible(true); // Chama o relatorio para ser visualizado
                                        jv.toFront(); // Traz o relatorio para frente da aplicação
                                        carregando.dispose(); //Teste tela aguarde
                                        conecta.desconecta();
    ...
    private javax.swing.JRadioButton jRBt_INICIAL;
