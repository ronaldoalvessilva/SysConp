...
import gestor.Controle.ControleEstornoRequisicaoAC;
import gestor.Controle.ControleHistoricoMovimentacaoAC;
import gestor.Controle.ControleItensEstornoMateriaisAC;
...
import static gestor.Visao.TelaModuloAlmoxarifado.telaMovimentacaoEstornoItensAL;
import static gestor.Visao.TelaModuloAlmoxarifado.telaMovimentacaoEstornoManuAL;
 ...
 * @author Ronaldo
 */
public class TelaEstornoRequisicaoMateriaisAC extends javax.swing.JInternalFrame {
    ...
    ControleEstornoRequisicaoAC control = new ControleEstornoRequisicaoAC();
    ControleItensEstornoMateriaisAC controle = new ControleItensEstornoMateriaisAC();
    //    
    ...
    String nomeModuloTela = "Almoxarifado:Estorno Requisição de Materiais Interno:Manutenção";
    String nomeModuloTela2 = "Almoxarifado:Estorno Requisição de Materiais Interno:Itens";
    //
    int flag;
    int acao;
     ...
     */
    public TelaEstornoRequisicaoMateriaisAC() {
        initComponents();
        formatarCampos();
        corCampos();
    }
    ...
    private void jBtPesqProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqProdutoActionPerformed
        ...
        if (jRadioBtReqInternos.isSelected()) {
            TelaPesqProdutoEstornoRequisicaoMateriais objPesqProdEstReqMat = new TelaPesqProdutoEstornoRequisicaoMateriais();
            TelaModuloAlmoxarifado.jPainelAlmoxarifado.add(objPesqProdEstReqMat);
            objPesqProdEstReqMat.show();
        } else if (jRadioBtReqAvulsa.isSelected()) {
            TelaPesqProdutoEstornoRequisicaoAvulsaMateriais objPesqEstProdMatAvulso = new TelaPesqProdutoEstornoRequisicaoAvulsaMateriais();
            TelaModuloAlmoxarifado.jPainelAlmoxarifado.add(objPesqEstProdMatAvulso);
            objPesqEstProdMatAvulso.show();
        }
...
//        // TODO add your handling code here:
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM ITENS_ESTORNO_PRODUTOS_AC "
                        + "INNER JOIN PRODUTOS_AC "
                        + "ON ITENS_ESTORNO_PRODUTOS_AC.IdProd=PRODUTOS_AC.IdProd "
                        + "INNER JOIN LOTE_PRODUTOS_AC "
                        + "ON PRODUTOS_AC.IdProd=LOTE_PRODUTOS_AC.IdProd "
                        + "WHERE ITENS_ESTORNO_PRODUTOS_AC.IdEst='" + jIdEst.getText() + "' "
                        + "AND PRODUTOS_AC.DescricaoProd='" + jDescricaoProduto.getText() + "' "
                        + "AND ITENS_ESTORNO_PRODUTOS_AC.IdItem='" + idItem + "'");
                conecta.rs.first();
    ...
    private void jBtPesqCodigoReqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoReqActionPerformed
        ...
        if (jIdEst.getText().equals("")) {
            ...
            pesquisarRequisicaoMateriais("SELECT * FROM ESTORNO_PRODUTOS_AC "
    ...
    private void jCheckBoxTodosReqItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosReqItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarRequisicaoMateriais("SELECT * FROM ESTORNO_PRODUTOS_AC ");
        } else {
    ...
    private void jTabelaRequisicoesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaRequisicoesMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM ESTORNO_PRODUTOS_AC "
                        + "WHERE IdEst='" + IdLanc + "'");
                conecta.rs.first();
            ...
            count = 0;
            preencherTabelaItens("SELECT * FROM ITENS_ESTORNO_PRODUTOS_AC "
                    + "INNER JOIN ESTORNO_PRODUTOS_AC "
                    + "ON ITENS_ESTORNO_PRODUTOS_AC.IdEst=ESTORNO_PRODUTOS_AC.IdEst "
                    + "INNER JOIN PRODUTOS_AC "
                    + "ON ITENS_ESTORNO_PRODUTOS_AC.IdProd=PRODUTOS_AC.IdProd "
                    + "WHERE ITENS_ESTORNO_PRODUTOS_AC.IdEst='" + jIdEst.getText() + "'");
        }
    ...
    private void jBtPesqRequisicaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqRequisicaoActionPerformed
        // TODO add your handling code here:
        if (jRadioBtReqInternos.isSelected()) {
            TelaPesqRequisicaoMateriaisAC objPesqReqInterno = new TelaPesqRequisicaoMateriaisAC();
            TelaModuloAlmoxarifado.jPainelAlmoxarifado.add(objPesqReqInterno);
            objPesqReqInterno.show();
        } else if (jRadioBtReqAvulsa.isSelected()) {
            TelaPesqRequisicaoAvulsaMateriaisAC objPeqReqAvulsa = new TelaPesqRequisicaoAvulsaMateriaisAC();
            TelaModuloAlmoxarifado.jPainelAlmoxarifado.add(objPeqReqAvulsa);
            objPeqReqAvulsa.show();
        }
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoAL.equals("ADMINISTRADORES") || codigoUserAL == codUserAcessoAL && nomeTelaAL.equals(telaMovimentacaoEstornoManuAL) && codGravarAL == 1) {
            if (jDataEst.getDate() == null) {
                ...
                if (acao == 1) {
                    ...
                    //
                    control.incluirEstornoMaterial(objEstoReq);
                    buscarCodigo();
                    //
                    objLog();
                ...
                if (acao == 2) {
                    ...
                    control.alterarEstornoMaterial(objEstoReq);
                    objLog();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
                    Salvar();
    ...
    private void jBtNovoItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoItemActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaMovimentacaoEstornoItensAL);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoAL.equals("ADMINISTRADORES") || codigoUserAL == codUserAcessoAL && nomeTelaAL.equals(telaMovimentacaoEstornoItensAL) && codIncluirAL == 1) {
            objEstoReq.setStatusEstorno(jStatusEst.getText());
            if (jStatusEst.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser modificado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtAlterarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarItemActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaMovimentacaoEstornoItensAL);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoAL.equals("ADMINISTRADORES") || codigoUserAL == codUserAcessoAL && nomeTelaAL.equals(telaMovimentacaoEstornoItensAL) && codAlterarAL == 1) {
            objEstoReq.setStatusEstorno(jStatusEst.getText());
            if (jStatusEst.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser modificado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtExcluirItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirItemActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaMovimentacaoEstornoItensAL);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoAL.equals("ADMINISTRADORES") || codigoUserAL == codUserAcessoAL && nomeTelaAL.equals(telaMovimentacaoEstornoItensAL) && codExcluirAL == 1) {
            objEstoReq.setStatusEstorno(jStatusEst.getText());
            if (jStatusEst.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser modificado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtSalvarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarItemActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaMovimentacaoEstornoItensAL);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoAL.equals("ADMINISTRADORES") || codigoUserAL == codUserAcessoAL && nomeTelaAL.equals(telaMovimentacaoEstornoItensAL) && codGravarAL == 1) {
            estornoProduto = "Sim";
                ...
                if (acao == 3) {
                    ...
                    if (qtdItemEstorno >= objItensReqMatInter.getQtdItem()) {
                        ...
                        if (jRadioBtReqInternos.isSelected()) {
                            ...
                            controle.modificarRequisicaoMaterialInternos(objItensReqMatInter);
                        } else if (jRadioBtReqAvulsa.isSelected()) {
                            objItensReqMatInter.setIdProd(Integer.valueOf(jCodProduto.getText()));
                            objItensReqMatInter.setIdReq(Integer.valueOf(jIdReq.getText()));
                            objItensReqMatInter.setEstornoProduto(estornoProduto);
                            controle.modificarRequisicaoMaterialAvulso(objItensReqMatInter);
                        }
                        //
                        objLog2();
                        controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
    ...
    public void Finalizar() {
        ...
        if (rows == 0) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                control.finalizarEstornoMaterial(objEstoReq);
    ...
    public void verificarItensRequisitados() {
        ...
        try {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                objEstoReq.setIdEstorno(Integer.parseInt(jIdEst.getText()));
                control.excluirEstornoMaterial(objEstoReq);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                Excluir();
    ...
    public void buscarQuantidadeRequisitadaAvulsa() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS "
                    + "WHERE IdReq='" + jIdReq.getText() + "' "
                    + "AND IdProd='" + objItensReqMatInter.getIdProd() + "'");
            conecta.rs.first();
    ...
    public void limparTabelaEstorno() {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Código", "Dt.Req.", "Status Req.", "Observação"};
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaRequisicoes.setModel(modelo);
