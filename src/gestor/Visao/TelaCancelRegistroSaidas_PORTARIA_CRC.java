...
import gestor.Controle.ControleItensEntradaPortaria_SAIDAS;
import gestor.Controle.ControleItensRegistroCanceladoCrc_SAIDAS;
import gestor.Controle.ControleRegCancelado_SAIDAS;
...
import static gestor.Visao.TelaModuloCRC.nomeModuloCRC;
import static gestor.Visao.TelaModuloCRC.nomeTelaCRC;
import static gestor.Visao.TelaModuloCRC.telaCancelamentoSaidaInte_CRC;
import static gestor.Visao.TelaModuloCRC.telaCancelamentoSaidaManu_CRC;
import static gestor.Visao.TelaModuloPortarias.nomeModuloP1;
 ...
 * @author ronaldo
 */
public class TelaCancelRegistroSaidas_PORTARIA_CRC extends javax.swing.JInternalFrame {
    ...
    ControleRegCancelado_SAIDAS control = new ControleRegCancelado_SAIDAS();
    ControleItensRegistroCanceladoCrc_SAIDAS controle = new ControleItensRegistroCanceladoCrc_SAIDAS();
    // Classe de origem do registro
    ItensEntradaInternosPortaria objItensEntIntPort = new ItensEntradaInternosPortaria();
    //TABELA DE ALERTA NA PORTARIA CRC
    ControleItensEntradaPortaria_SAIDAS controleReg = new ControleItensEntradaPortaria_SAIDAS();
    ...
    String nomeModuloTela = "CRC:Cancelamento de Registro de Saída de Internos:Manutenção";
    String nomeModuloTela2 = "CRC:Cancelamento de Registro de Saída de Internos:Internos";
    String statusMov;
    String horaMov;
    String dataModFinal;
    ...
    public static int pCODIGO_SAIDA_crc = 0;
    int pID_ITEM = 0;
    //
    ...
    //
    public static String pSETOR_CANCELAMENTO_CRC = "CRC";
    public static String pSETOR_CANCELAMENTO_PORTARIA = "PORTARIA";
    //
    int pCODIGO_MOV_item = 0;
    String pCONFIRMA_SAIDA_PORTARIA = "Não";
    ...
    String pTIPO_SAIDA_FUGA = "FUGA DA UNIDADE";
    ...
    //CÓDIGO DO INTERNO PARA GRAVAR A OBSERVAÇÃO NA TABELA (REGOBSERVACOES)
    String pCODIGO_OBSERVACAO_interno = "";
    String pOBSERVACAO_interno = "";

    /**
     * Creates new form TelaCancelRegistroPortaria
     */
    public TelaCancelRegistroSaidas_PORTARIA_CRC() {
        initComponents();
        corCampos();
        formatarCampos();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("....::: Cancelamento Registro SAÍDAS de Internos na Portaria/CRC :::...");

        jTabbedPane1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N

        jPanel9.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Pesquisas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(204, 0, 0))); // NOI18N
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true), "Dados Interno Registrado", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(204, 0, 0))); // NOI18N
        ...
        jBtBuscarRegistroInterno.setForeground(new java.awt.Color(204, 0, 0));
        ...
        jLabel14.setText("Tipo de Saída");

        jComboBoxTipoSaida.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jComboBoxTipoSaida.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione...", "Saída Temporaria", "Saída Transferência", "Saída Prisão Domiciliar - COVID-19", "Saída Prisão Domiciliar", "Saída Alvará", "Saída Progressão Regime", "Saída Regressão de Regime", "Saída Livramento Condicional", "Outras Saídas", "Fuga da Unidade", "Óbito", " " }));
        ...
        jComboBoxSetor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione...", "CRC", "Portaria Interna" }));
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jComboBoxTipoSaida, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGap(2, 2, 2)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(jComboBoxSetor, javax.swing.GroupLayout.PREFERRED_SIZE, 18, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBtPesqCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoActionPerformed
        ...
        if (jCodigoPesq.getText().equals("")) {
            ...
            preencherTabelaPesqRegCan("SELECT IdRegCancelSA,DataLanc, "
                    + "StatusLanc,Motivo "
                    + "FROM REGISTRO_CANCELADO_SAIDAS "
                    + "WHERE IdRegCancelSA='" + jCodigoPesq.getText() + "'");
        }
    ...
    private void jBtPesqNomeInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeInternoActionPerformed
        ...
        if (jNomeInternoPesq.getText().equals("")) {
            ...
            preencherTabelaPesqRegCanNome("SELECT IdRegCancelSA,DataLanc, "
                    + "StatusLanc,Motivo,PRONTUARIOSCRC.NomeInternoCrc "
                    + "FROM REGISTRO_CANCELADO_SAIDAS "
                    + "INNER JOIN ITENS_REGISTRO_CANCELADO_SAIDAS "
                    + "ON REGISTRO_CANCELADO_SAIDAS.IdRegCancelSA=ITENS_REGISTRO_CANCELADO_SAIDAS.IdRegCancelSA "
                    + "INNER JOIN PRONTUARIOSCRC.IdInternoCrc=ITENS_REGISTRO_CANCELADO_SAIDAS.IdInternoCrc "
    ...
    private void jCheckBoxTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaPesqRegCan("SELECT * FROM REGISTRO_CANCELADO_SAIDAS");
        } else {
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaCancelamentoSaidaManu_CRC) && codIncluirCRC == 1) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaCancelamentoSaidaManu_CRC);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaCancelamentoSaidaManu_CRC) && codAlterarCRC == 1) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaCancelamentoSaidaManu_CRC);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaCancelamentoSaidaManu_CRC) && codExcluirCRC == 1) {
            objRecCancel.setStatusLanc(jStatusLanc.getText());
            if (jStatusLanc.getText().equals("FINALIZADO")) {
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaCancelamentoSaidaManu_CRC);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaCancelamentoSaidaManu_CRC) && codGravarCRC == 1) {
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        ...
        if (TelaModuloCRC.jPainelCRC != null) {
            TelaAuditoriaCancelReg_SAIDAS objAudCancelReg = new TelaAuditoriaCancelReg_SAIDAS();
    ...
    private void jBtImpressaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtImpressaoActionPerformed
        ...
        try {
            ...
            conecta.executaSQL("SELECT IdRegCancelSA,DataLanc, "
                    + "StatusLanc,Motivo "
                    + "FROM REGISTRO_CANCELADO_SAIDAS "
    ...
    private void jBtNovoInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoInternoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaCancelamentoSaidaInte_CRC) && codIncluirCRC == 1) {
            objRecCancel.setStatusLanc(jStatusLanc.getText());
            if (jStatusLanc.getText().equals("FINALIZADO")) {
    ...
    private void jBtAlterarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarInternoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaCancelamentoSaidaInte_CRC);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaCancelamentoSaidaInte_CRC) && codAlterarCRC == 1) {
    ...
    private void jBtExcluirInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirInternoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaCancelamentoSaidaInte_CRC);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoCRC.equals("ADMINISTRADORES") || codigoUserCRC == codUserAcessoCRC && nomeTelaCRC.equals(telaCancelamentoSaidaInte_CRC) && codExcluirCRC == 1) {
            objRecCancel.setStatusLanc(jStatusLanc.getText());
            if (jStatusLanc.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro de internos não poderá ser excluído, o mesmo encontra-se FINALIZADO");
            } else {
                    ...
                    if (resposta == JOptionPane.YES_OPTION) {
                        ...
                        if (jComboBoxSetor.getSelectedItem().equals("Portaria Interna") && pUTILIZADO_portaria.equals("Sim")) {
                            if (jComboBoxTipoSaida.getSelectedItem().equals("Saída Temporaria")) {
                                ...
                                //VERIFICAR SE JÁ EXISTE ALGUMA OBSERVAÇÃO PARA O INTERNO
                                VERIFICAR_observacao();
                                if (jIdInternoReg.getText().equals(pCODIGO_OBSERVACAO_interno)) {
                                    //ALTERAR A OBSERVAÇÃO NO PRONTUÁRIO DO INTERNO CASO EXISTA ALGUMA
                                    objItensEntIntPort.setIdInternoCrc(Integer.valueOf(jIdInternoReg.getText()));
                                    objItensEntIntPort.setObservacaoInterno(pOBSERVACAO_interno + jMotivo.getText());
                                    controleReg.alterar_OBSERVACAO_CANCELADO(objItensEntIntPort);
                                } else {
                            ...
                            if (jComboBoxTipoSaida.getSelectedItem().equals("Saída Temporaria")) {
                                ...
                                objItensEntIntPort.setIdItem_MOVIMENTO(pCODIGO_MOV_item);
                                controleReg.incluir_MOVIMENTO_CANCELAMENTOSaida_CRC_PROTARIA(objItensEntIntPort);
                            } else if (jComboBoxTipoSaida.getSelectedItem().equals("Fuga da Uniadde")) {
                                //UPDATE NA TABELA ITENSSAIDA COMO "Registro Cancelado CRC" PARA NÃO EXCLUIR MAIS
                                objItensEntIntPort.setIdInternoCrc(Integer.valueOf(jIdInternoReg.getText()));
                                objItensEntIntPort.setIdEntraSaida(pCODIGO_ENTRADA_SAIDA);
                                objItensEntIntPort.setIdRetorno(pCODIGO_SAIDA_crc);
    ...
    private void jBtAuditoriaInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaInternoActionPerformed
        // TODO add your handling code here:
        if (TelaModuloCRC.jPainelCRC != null) {
            TelaAuditoriaItensRegCancel_SAIDAS objAudItensCancel = new TelaAuditoriaItensRegCancel_SAIDAS();
    ...
    private void jTabelaSaidaInternosCRCPortariaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaSaidaInternosCRCPortariaMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT ITENS_REGISTRO_CANCELADO_SAIDAS.IdItemSA,ITENS_REGISTRO_CANCELADO_SAIDAS.IdRegCancelSA, "
                        + "ITENS_REGISTRO_CANCELADO_SAIDAS.IdInternoCrc,PRONTUARIOSCRC.NomeInternoCrc, "
                        + "ITENS_REGISTRO_CANCELADO_SAIDAS.DataSaida,ITENS_REGISTRO_CANCELADO_SAIDAS.HoraSaida, "
                        + "ITENS_REGISTRO_CANCELADO_SAIDAS.NrDocumento,ITENS_REGISTRO_CANCELADO_SAIDAS.TipoSaidaCrcPortaria, "
                        + "ITENS_REGISTRO_CANCELADO_SAIDAS.SetorSaidaCrcPortaria "
                        + "FROM ITENS_REGISTRO_CANCELADO_SAIDAS "
                        + "INNER JOIN PRONTUARIOSCRC "
                        + "ON ITENS_REGISTRO_CANCELADO_SAIDAS.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc  "
                        + "WHERE ITENS_REGISTRO_CANCELADO_SAIDAS.IdInternoCrc='" + jIdInternoReg.getText() + "'"
                        + "AND ITENS_REGISTRO_CANCELADO_SAIDAS.IdItemSA='" + idItem + "'");
                conecta.rs.first();
                pID_ITEM = conecta.rs.getInt("IdItemSA");
    ...
    private void jTabelaPesqusaInternoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaPesqusaInternoMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM REGISTRO_CANCELADO_SAIDAS "
                        + "WHERE IdRegCancelSA ='" + IdLanc + "'");
                conecta.rs.first();
                jIdLanc.setText(String.valueOf(conecta.rs.getInt("IdRegCancelSA")));
                jStatusLanc.setText(conecta.rs.getString("StatusLanc"));
    ...
    private void jBtBuscarRegistroInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtBuscarRegistroInternoActionPerformed
        ...
        if (jComboBoxTipoSaida.getSelectedItem().equals("Selecione...")) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Selecione o setor.");
        } else if (nomeModuloCRC != null && pSETOR_CANCELAMENTO_CRC.equals(nomeModuloCRC) && jComboBoxSetor.getSelectedItem().equals("CRC")) {
            TelaPesqRegInternoPortaria_SAIDAS objPesqRegInternoPor = new TelaPesqRegInternoPortaria_SAIDAS();
            TelaModuloCRC.jPainelCRC.add(objPesqRegInternoPor);
            objPesqRegInternoPor.show();
        } else if (nomeModuloCRC != null && pSETOR_CANCELAMENTO_CRC.equals(nomeModuloCRC) && jComboBoxSetor.getSelectedItem().equals("Portaria Interna")) {
            TelaPesqRegInternoPortaria_SAIDAS objPesqRegInternoPor = new TelaPesqRegInternoPortaria_SAIDAS();
            TelaModuloCRC.jPainelCRC.add(objPesqRegInternoPor);
            objPesqRegInternoPor.show();
        } else if (nomeModuloP1 != null && pSETOR_CANCELAMENTO_PORTARIA.equals(nomeModuloP1) && jComboBoxSetor.getSelectedItem().equals("Portaria Interna")) {
            TelaPesqRegInternoPortaria_SAIDAS objPesqRegInternoPor = new TelaPesqRegInternoPortaria_SAIDAS();
            TelaModuloPortarias.jPainelPortarias.add(objPesqRegInternoPor);
            objPesqRegInternoPor.show();
        } else if (nomeModuloP1 != null && jComboBoxSetor.getSelectedItem().equals("CRC")) {
            JOptionPane.showMessageDialog(rootPane, "Usuários do setor de Portaria não cancela registros do CRC. Caso precise realizar um cancelamento do setor do CRC,\nsolicite ao usuário responsável do setor para cancelar.");
        }
    ...
    public void buscarCodigo() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT IdRegCancelSA "
                    + "FROM REGISTRO_CANCELADO_SAIDAS");
            conecta.rs.last();
            jIdLanc.setText(conecta.rs.getString("IdRegCancelSA"));
        } catch (Exception e) {
        }
        conecta.desconecta();
    }
    ...
    public void VERIFICAR_observacao() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT IdInternoCrc,Observacao "
                    + "FROM REGOBSERVACOES "
                    + "WHERE IdInternoCrc='" + jIdInternoReg.getText() + "'");
            conecta.rs.first();
            pCODIGO_OBSERVACAO_interno = conecta.rs.getString("IdInternoCrc");
            pOBSERVACAO_interno = conecta.rs.getString("Observacao");
        } catch (Exception e) {
        }
        conecta.desconecta();
    }

    public void pBUSCAR_item() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT IdItemSA "
                    + "FROM ITENS_REGISTRO_CANCELADO_SAIDAS");
            conecta.rs.last();
            pCODIGO_MOV_item = conecta.rs.getInt("IdItemSA");
        } catch (Exception e) {
        }
        conecta.desconecta();
    }

    public void pVERIFICAR_UTILIZA_registro() {
        if (jComboBoxTipoSaida.getSelectedItem().equals("Saída Temporaria")) {
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT IdInternoCrc,SaidaConfirmada, "
                        ...
                        + "AND DestinoSaida='" + pTIPO_SAIDA_TEMPORARIA + "'");
                conecta.rs.first();
            ...
            try {
                conecta.executaSQL("SELECT IdInternoCrc,SaidaConfirmada, "
                        ...
                        + "WHERE IdInternoCrc='" + jIdInternoReg.getText() + "' "
                        + "AND IdSaida='" + pCODIGO_SAIDA_crc + "' "
                        + "AND DestinoSaida='" + pTIPO_SAIDA_TRANSFERENCIA + "'");
                conecta.rs.first();
                pUTILIZADO_portaria = conecta.rs.getString("SaidaConfirmada");
                pCODIGO_ITENSCRCPORTARIA_item = conecta.rs.getInt("IdSaida");
            } catch (Exception e) {
            ...
            try {
                conecta.executaSQL("SELECT IdInternoCrc,SaidaConfirmada, "
                        ...
                        + "WHERE IdInternoCrc='" + jIdInternoReg.getText() + "' "
                        + "AND IdSaida='" + pCODIGO_SAIDA_crc + "' "
                        + "AND DestinoSaida='" + pTIPO_SAIDA_PRISAO_DOMICILIAR_COVID + "'");
                conecta.rs.first();
                pUTILIZADO_portaria = conecta.rs.getString("SaidaConfirmada");
                pCODIGO_ITENSCRCPORTARIA_item = conecta.rs.getInt("IdSaida");
            } catch (Exception e) {
            ...
            try {
                conecta.executaSQL("SELECT IdInternoCrc,SaidaConfirmada, "
                        ...
                        + "WHERE IdInternoCrc='" + jIdInternoReg.getText() + "' "
                        + "AND IdSaida='" + pCODIGO_SAIDA_crc + "' "
                        + "AND DestinoSaida='" + pTIPO_SAIDA_PRISAO_DOMICILIAR + "'");
                conecta.rs.first();
                pUTILIZADO_portaria = conecta.rs.getString("SaidaConfirmada");
                pCODIGO_ITENSCRCPORTARIA_item = conecta.rs.getInt("IdSaida");
            } catch (Exception e) {
            ...
            try {
                conecta.executaSQL("SELECT IdInternoCrc,SaidaConfirmada, "
                        ...
                        + "WHERE IdInternoCrc='" + jIdInternoReg.getText() + "' "
                        + "AND IdSaida='" + pCODIGO_SAIDA_crc + "' "
                        + "AND DestinoSaida='" + pTIPO_SAIDA_ALVARA + "'");
                conecta.rs.first();
                pUTILIZADO_portaria = conecta.rs.getString("SaidaConfirmada");
                pCODIGO_ITENSCRCPORTARIA_item = conecta.rs.getInt("IdSaida");
            } catch (Exception e) {
            ...
            try {
                conecta.executaSQL("SELECT IdInternoCrc,SaidaConfirmada, "
                        ...
                        + "WHERE IdInternoCrc='" + jIdInternoReg.getText() + "' "
                        + "AND IdSaida='" + pCODIGO_SAIDA_crc + "' "
                        + "AND DestinoSaida='" + pTIPO_SAIDA_PROGRESSAO + "'");
                conecta.rs.first();
                pUTILIZADO_portaria = conecta.rs.getString("SaidaConfirmada");
                pCODIGO_ITENSCRCPORTARIA_item = conecta.rs.getInt("IdSaida");
            } catch (Exception e) {
            ...
            try {
                conecta.executaSQL("SELECT IdInternoCrc,SaidaConfirmada, "
                        ...
                        + "WHERE IdInternoCrc='" + jIdInternoReg.getText() + "' "
                        + "AND IdSaida='" + pCODIGO_SAIDA_crc + "' "
                        + "AND DestinoSaida='" + pTIPO_SAIDA_REGRESSAO + "'");
                conecta.rs.first();
                pUTILIZADO_portaria = conecta.rs.getString("SaidaConfirmada");
                pCODIGO_ITENSCRCPORTARIA_item = conecta.rs.getInt("IdSaida");
            } catch (Exception e) {
            ...
            try {
                conecta.executaSQL("SELECT IdInternoCrc,SaidaConfirmada, "
                        ...
                        + "WHERE IdInternoCrc='" + jIdInternoReg.getText() + "' "
                        + "AND IdSaida='" + pCODIGO_SAIDA_crc + "' "
                        + "AND DestinoSaida='" + pTIPO_SAIDA_LIVRAMENTO + "'");
                conecta.rs.first();
                pUTILIZADO_portaria = conecta.rs.getString("SaidaConfirmada");
                pCODIGO_ITENSCRCPORTARIA_item = conecta.rs.getInt("IdSaida");
            } catch (Exception e) {
    ...
    public void verificarItens() {
        ...
        try {
            conecta.executaSQL("SELECT IdRegCancelSA "
                    ...
                    + "WHERE IdRegCancelSA='" + jIdLanc.getText() + "'");
            conecta.rs.first();
            codCancel = conecta.rs.getString("IdRegCancelSA");
    ...
    public void preencherTabelaPesqRegCan(String sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdRegCancelSA"), datalanc, conecta.rs.getString("StatusLanc"), conecta.rs.getString("Motivo")});
    ...
    public void preencherTabelaPesqRegCanNome(String sql) {
        ...
        try {
            ...
            do {
                ...
                datalanc = dia + "/" + mes + "/" + ano;
                jtotalRegistros.setText(Integer.toString(count)); // Converter inteiro em string para exibir na tela
                dados.add(new Object[]{conecta.rs.getInt("IdRegCancelSA"), datalanc, conecta.rs.getString("StatusLanc"), conecta.rs.getString("NomeInternoCrc"), conecta.rs.getString("Motivo")});
            } while (conecta.rs.next());
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(rootPane, "Não existem dados a serem EXIBIDOS !!!");
        }
    ...
    public void preencherTabelaEntradasPortaria(String sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdItemSA"), conecta.rs.getInt("IdInternoCrc"), conecta.rs.getString("NomeInternoCrc"), dataSaida, conecta.rs.getString("HoraSaida"), conecta.rs.getString("NrDocumento")});
            } while (conecta.rs.next());
        } catch (SQLException ex) {
        }
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
