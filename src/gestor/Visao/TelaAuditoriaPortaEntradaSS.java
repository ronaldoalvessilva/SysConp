...
import static gestor.Visao.TelaPortaEntradaServicoSocial.jIDNovoAtend;
 ...
 */
public class TelaAuditoriaPortaEntradaSS extends javax.swing.JDialog {
    ConexaoBancoDados conecta = new ConexaoBancoDados();

    /**
     * Creates new form TelaAuditoriaPortaEntradaSS
     */
    
    public static TelaPortaEntradaServicoSocial pAUDITORIA_PORTA_ENTRADA_SS;
    
    public TelaAuditoriaPortaEntradaSS(TelaPortaEntradaServicoSocial parent, boolean modal) {
        this.pAUDITORIA_PORTA_ENTRADA_SS = parent;
        this.setModal(modal);
        setLocationRelativeTo(pAUDITORIA_PORTA_ENTRADA_SS);
        initComponents();
        auditoria();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAuditoriaPortaEntradaSS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAuditoriaPortaEntradaSS dialog = new TelaAuditoriaPortaEntradaSS(pAUDITORIA_PORTA_ENTRADA_SS, true);
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PORTA_ENTRADA_SERVICO_SOCIAL WHERE IdAtendSS='" + jIDNovoAtend.getText() + "'");
            conecta.rs.first();
