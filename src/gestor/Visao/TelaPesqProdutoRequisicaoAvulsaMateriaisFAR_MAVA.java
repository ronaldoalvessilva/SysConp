...
import static gestor.Visao.TelaRequisicaoAvulsaFAR.jDescricaoProduto;
import static gestor.Visao.TelaRequisicaoAvulsaFAR.jCodProduto;
import static gestor.Visao.TelaRequisicaoAvulsaFAR.jCodigoBarras;
import static gestor.Visao.TelaRequisicaoAvulsaFAR.jLote;
import static gestor.Visao.TelaRequisicaoAvulsaFAR.jDataVctoLote;
import static gestor.Visao.TelaRequisicaoAvulsaFAR.jComboBoxUnidade;
import static gestor.Visao.TelaRequisicaoAvulsaFAR.jValorUnitarioItem;
 ...
 * @author user
 */
public class TelaPesqProdutoRequisicaoAvulsaMateriaisFAR_MAVA extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoRequisicaoAvulsaMateriaisFAR_MAVA() {
        initComponents();
    }
        ...
        if (jPesqDescricaoProdutos.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRODUTOS_AC "
                        ...
                        + "AND Qtd!='" + 0 + "' "
                        + "AND PRODUTOS_AC.Modulo='" + modulo + "' "
                        + "AND LOTE_PRODUTOS_AC.DataVenc<'" + jDataSistema.getText()  + "'");
                conecta.rs.first();
