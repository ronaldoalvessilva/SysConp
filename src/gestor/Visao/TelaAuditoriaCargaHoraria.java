...
import static gestor.Visao.TelaCargaHoraria.jIdCarga;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaCargaHoraria extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaCargaHoraria() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Carga Horária :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM CARGAHORARIA WHERE IdCarga='" + jIdCarga.getText() + "'");
            conecta.rs.first();
