 ...
 * @author user
 */
public class TelaCelasBGPA extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "BPA:Cadastro Pavilhão:Manutenção";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
    ...
    private void jBtPesqPavActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqPavActionPerformed
        // TODO add your handling code here:
        TelaPesqPavilhaoBGPA objPavBGPA = new TelaPesqPavilhaoBGPA();
        TelaModuloBaseDois.jPainelBasePavilhaoAuxiliar.add(objPavBGPA);
        objPavBGPA.show();
