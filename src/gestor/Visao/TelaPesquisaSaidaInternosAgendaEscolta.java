...
import static gestor.Visao.TelaSaidaInterno.FotoInternoCrcSaida;
...
import static gestor.Visao.TelaSaidaInterno.codItemAgenda;
import static gestor.Visao.TelaSaidaInterno.jDataSaida;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaSaidaInternosAgendaEscolta extends javax.swing.JInternalFrame {
    ...
    String dataCadastro;
    String dataEntrada;
    String situacaoCrc = "ENTRADA NA UNIDADE";
     ...
     */
    public TelaPesquisaSaidaInternosAgendaEscolta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (jTabelaInterno.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaInterno.getColumnModel().getColumn(4).setMinWidth(60);
            jTabelaInterno.getColumnModel().getColumn(4).setMaxWidth(60);
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTabelaNome("SELECT * FROM ITENSAGENDA "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ITENSAGENDA.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "WHERE PRONTUARIOSCRC.NomeInternoCrc LIKE'%" + jPesqNome.getText() + "%' "
                    + "AND PRONTUARIOSCRC.SituacaoCrc='" + situacaoCrc + "' AND ITENSAGENDA.UtilizaAgenda='" + utilizaAgenda + "'"
                    + "OR PRONTUARIOSCRC.NomeInternoCrc LIKE'%" + jPesqNome.getText() + "%' "
                    + "AND PRONTUARIOSCRC.SituacaoCrc='" + situacaoRet + "' AND ITENSAGENDA.UtilizaAgenda='" + utilizaAgenda + "'");
        }
    ...
    private void jBtMatriculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtMatriculaActionPerformed
        ...
        if (jPesqMatricula.getText().equals("")) {
            ...
            buscarInternosMatricula("SELECT * FROM ITENSAGENDA "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ITENSAGENDA.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                        ...
                        + "ON PRONTUARIOSCRC.IdInternoCrc=ITENSAGENDA.IdInternoCrc "
                        + "WHERE PRONTUARIOSCRC.NomeInternoCrc='" + nomeInterno + "' "
                        + "AND ITENSAGENDA.IdItem='" + idInt + "'");
//                        + "AND PRONTUARIOSCRC.IdInternoCrc='" + idInt + "'");
                ...
                jNrDocumento.setText(conecta.rs.getString("OficioAgenda"));
                jProcedencia.setText(conecta.rs.getString("DescricaoUnid"));
                jDataSaida.setDate(conecta.rs.getDate("DataAgenda"));
                // Capturando foto
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTodosInternos("SELECT * FROM ITENSAGENDA "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ITENSAGENDA.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "WHERE ITENSAGENDA.UtilizaAgenda='" + utilizaAgenda + "' "
                    + "AND PRONTUARIOSCRC.SituacaoCrc='" + situacaoCrc + "' "
                    + "OR ITENSAGENDA.UtilizaAgenda='" + utilizaAgenda + "' "
  ...
  // Método de pesquisa pela Descrição
    ...
    public void preencherTabelaNome(String sql) {
        ...
        String[] Colunas = new String[]{"Item", "Código", "Nome do Interno", "Data Agenda", "Horário", "Local de Destino"};
        conecta.abrirConexao();
        ...
        jTabelaInterno.getColumnModel().getColumn(4).setPreferredWidth(60);
