 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEntradaSaidaInternosAlbergados extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEntradaSaidaInternosAlbergados() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Entrada/Saida de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ENTRADA_SAIDA_ALBERGADOS WHERE IdLanc='" + jIDlanc.getText() + "'");
            conecta.rs.first();
