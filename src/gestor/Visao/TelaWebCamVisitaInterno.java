...
import static gestor.Visao.TelaVisitaSocial.jLabelFoto;
 ...
 * @author Ronaldo
 */
public class TelaWebCamVisitaInterno extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String localFotoVisitasIterno = "";
     ...
     * @param modal
     */
    public static TelaVisitaSocial telaVisitasInternos;

    //TESTADO E FUNCIONANDO NO DIA 02/12/2016 - EM VITÓRIA DA CONQUISTA
    public TelaWebCamVisitaInterno(TelaVisitaSocial parent, boolean modal) {
        this.telaVisitasInternos = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaVisitasInternos);
        initComponents();
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        localFotoVisitasInternos();
        if (localFotoVisitasIterno == null || localFotoVisitasIterno == "") {
            ...
            javax.swing.JFileChooser seletor = new javax.swing.JFileChooser(localFotoVisitasIterno);
            FileNameExtensionFilter tipoExtensao = new FileNameExtensionFilter("Imagem de Foto", "jpg", "bmp", "gif", "png");
            seletor.setAcceptAllFileFilterUsed(false);
            seletor.setMultiSelectionEnabled(false);
            seletor.setFileFilter(tipoExtensao);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaWebCamVisitaInterno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaWebCamVisitaInterno dialog = new TelaWebCamVisitaInterno(telaVisitasInternos, true);
    ...
    public void localFotoVisitasInternos() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM PARAMETROSCRC");
            conecta.rs.first();
            localFotoVisitasIterno = conecta.rs.getString("LocalFotosVisitasInternos");
        } catch (Exception e) {
        }
        conecta.desconecta();
    }
