...
import static gestor.Visao.TelaEntradaSaidaEmpresaLabor.jBtAlterarInterno;
import static gestor.Visao.TelaEntradaSaidaEmpresaLabor.jBtExcluirInterno;
import static gestor.Visao.TelaEntradaSaidaEmpresaLabor.jBtSalvarInterno;
import static gestor.Visao.TelaEntradaSaidaEmpresaLabor.jBtCancelarInterno;
import static gestor.Visao.TelaEntradaSaidaEmpresaLabor.jBtBuscarRegistro;
import static gestor.Visao.TelaEntradaSaidaEmpresaLabor.jDataInicio;
import static gestor.Visao.TelaEntradaSaidaEmpresaLabor.jDataTermino;
import static gestor.Visao.TelaEntradaSaidaEmpresaLabor.jIDLanc;
...
import static gestor.Visao.TelaEntradaSaidaEmpresaLabor.idItem;
 ...
 * @author user
 */
public class TelaBtBuscarInternoAtividadeLabor extends javax.swing.JInternalFrame {
     ...
     */
    public TelaBtBuscarInternoAtividadeLabor() {
        initComponents();
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                ...
                conecta.rs.first();
                jIdInternoFichaLabor.setText(conecta.rs.getString("IdInternoCrc")); //Coluna 0
                jNomeInternoFichaLabor.setText(conecta.rs.getString("NomeInternoCrc")); // Coluna 1  
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jPesqNomeInterno.getText().equals("")) {
            ...
            buscarInternos("SELECT * FROM ITENSFICHALAB "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ITENSFICHALAB.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            jTabelaPesqInternos.setVisible(true);
            this.buscarInternos("SELECT * FROM ITENSFICHALAB "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ITENSFICHALAB.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
