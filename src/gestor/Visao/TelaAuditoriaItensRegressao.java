...
import static gestor.Visao.TelaMudancaRegimeRegressao.jIdLanc;
import static gestor.Visao.TelaMudancaRegimeRegressao.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRegressao extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRegressao() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSREGRESSAOREGIME WHERE IdLanc='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
