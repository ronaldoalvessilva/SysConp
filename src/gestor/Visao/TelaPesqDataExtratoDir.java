 ...
 * @author ronaldo
 */
public class TelaPesqDataExtratoDir extends javax.swing.JInternalFrame {
        ...
        if (jDataPesqInicial.getDate() == null) {
            ...
            if (jDataPesFinal.getDate() == null) {
                ...
                if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                    ...
                    jTabelaDepositoDir.setEnabled(!true);
                    jTabelaSaqueDir.setEnabled(!true);
                    preencherTabelaDeposito("SELECT * FROM DEPOSITO INNER "
                            + "JOIN PRONTUARIOSCRC "
