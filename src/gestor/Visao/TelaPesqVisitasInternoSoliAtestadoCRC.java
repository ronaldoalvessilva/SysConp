 ...
 * @author Ronaldo
 */
public class TelaPesqVisitasInternoSoliAtestadoCRC extends javax.swing.JInternalFrame {
    ...
    String finalidade = "Visitas Diversas";

    /**
     * Creates new form TelaPesquisaEntradaInternos
     */
    public TelaPesqVisitasInternoSoliAtestadoCRC() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Pesquisa de Visitantes :::...");
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            pesquisarVisitasRol("SELECT * FROM SOLICITACAO_ATESTADO_RECLUSAO_CRC "
                    ...
                    + "ON VISITASDIVERSAS.IdVisita=SOLICITACAO_ATESTADO_RECLUSAO_CRC.IdVisita "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
                    + "WHERE VISITASDIVERSAS.NomeVisita LIKE'%" + jPesqNome.getText() + "%' "
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM SOLICITACAO_ATESTADO_RECLUSAO_CRC "
                        ...
                        + "INNER JOIN DADOSPENAISINTERNOS "
                        + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
                        + "WHERE VISITASDIVERSAS.NomeVisita='" + nomeVisita + "' "
                        + "AND VISITASDIVERSAS.IdVisita='" + idInt + "' ");
                conecta.rs.first();
