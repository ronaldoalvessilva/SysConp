 ...
 * @author Ronaldo
 */
public class TelaAuditoriaOcorrenciaVisitasPortaria extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaOcorrenciaVisitasPortaria() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Registro Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM REGISTRO_INDISCIPLINA_PORTARIA WHERE IdReg='" + jCodigoRegistro.getText() + "'");
            conecta.rs.first();
