...
import static gestor.Visao.TelaHistoricoDoencasFamiliar.jIdHistorico;
import static gestor.Visao.TelaHistoricoDoencasFamiliar.jIdRegistro;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensHistoricoDoencasFamiliar extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensHistoricoDoencasFamiliar() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Histórico Doenças Familiar :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_HISTORICO_DOENCA_FAMILIA WHERE IdHist='" + jIdHistorico.getText() + "'AND ItensIdHist='" + jIdRegistro.getText()  + "'");
            conecta.rs.first();
