...
import static gestor.Visao.TelaAtendimentoGrupoTO.pCODIGO_AVALIACAO_GRUPO_AVGI;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_AIGRU_TO extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_AIGRU_TO() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_TO "
                    + "WHERE IdItemAvaiTO='" + pCODIGO_AVALIACAO_GRUPO_AVGI + "' "
                    + "AND IdAtGrupoTO='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
