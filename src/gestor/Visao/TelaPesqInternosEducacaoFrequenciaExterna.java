...
import gestor.Dao.*;
import static gestor.Visao.TelaFrequenciaMensalInternosEducacao.jNomeEmpresa;
import static gestor.Visao.TelaFrequenciaMensalInternosEducacao.jIdInternoCrcFreq;
import static gestor.Visao.TelaFrequenciaMensalInternosEducacao.jNomeInternoFreqTerapia;
 ...
 * @author user
 */
public class TelaPesqInternosEducacaoFrequenciaExterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternosEducacaoFrequenciaExterna() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa Agendamento Internos - {PE} :::...");
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                        + "INNER JOIN INTERNOS_SAIDA_EDUCACIONAL "
                        + "ON PRONTUARIOSCRC.IdInternoCrc=INTERNOS_SAIDA_EDUCACIONAL.IdInternoCrc "
                        ...
                        + "WHERE INSTITUICAOESCOLAR.NomeInstituicao='" + jNomeEmpresa.getText() + "'AND INSTITUICAOESCOLAR.StatusInst='" + statusEmp + "' "
                        + "AND PRONTUARIOSCRC.NomeInternoCrc='" + jPesqNomeInterno.getText() + "'AND PRONTUARIOSCRC.IdInternoCrc='" + idInterno + "' ");
                conecta.rs.first();
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jPesqNomeInterno.getText().equals("")) {
            ...
            buscarInternoAgendados("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "AND INSTITUICAOESCOLAR.NomeInstituicao='" + jNomeEmpresa.getText() + "' "
                    + "AND TipoAcesso='" + tipoAcesso + "' "
                    + "AND PRONTUARIOSCRC.SituacaoCrc='" +  situacaoEnt  + "' "
                    + "OR PRONTUARIOSCRC.NomeInternoCrc LIKE'%" + jPesqNomeInterno.getText() + "%' "
                    + "AND INSTITUICAOESCOLAR.NomeInstituicao='" + jNomeEmpresa.getText() + "' "
                    + "AND TipoAcesso='" + tipoAcesso + "' "
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {            
            this.buscarInternoAgendados("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "INNER JOIN INSTITUICAOESCOLAR "
                    + "ON ASSISTENCIA_EDUCACAO_EXTERNA.IdCod=INSTITUICAOESCOLAR.IdCod "
                    + "WHERE INSTITUICAOESCOLAR.NomeInstituicao='" + jNomeEmpresa.getText() + "' "
                    + "AND INTERNOS_SAIDA_EDUCACIONAL.TipoAcesso='" + tipoAcesso + "' "
                    + "AND PRONTUARIOSCRC.SituacaoCrc='" +  situacaoEnt  + "' "
                    + "OR INSTITUICAOESCOLAR.NomeInstituicao='" + jNomeEmpresa.getText() + "' "
                    + "AND INTERNOS_SAIDA_EDUCACIONAL.TipoAcesso='" + tipoAcesso + "' "
                    + "AND PRONTUARIOSCRC.SituacaoCrc='" +  situacaoRet  + "'");
        } else {
...
//Preencher tabela com todos os COLABORADORES
    public void buscarInternoAgendados(String sql) {
        ...
        try {
            ...
            conecta.rs.first();
            do {
                dados.add(new Object[]{conecta.rs.getString("IdInternoCrc"), conecta.rs.getString("NomeInternoCrc")});
