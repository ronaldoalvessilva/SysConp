...
import static gestor.Visao.TelaAutoresLivros.jIdAutor;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAutoresLivros extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAutoresLivros() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AUTORES_LIVROS WHERE IdAutor='" + jIdAutor.getText() + "'");
            conecta.rs.first();
