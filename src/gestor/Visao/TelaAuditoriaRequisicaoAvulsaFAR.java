 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRequisicaoAvulsaFAR extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRequisicaoAvulsaFAR() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS_FAR WHERE IdReq='" + jCodReq.getText() + "'");
            conecta.rs.first();
