 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRolVisitas extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRolVisitas() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Rol de Visitas :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ROLVISITAS WHERE IdRol='" + jIDRol.getText() + "'");
            conecta.rs.first();
