 ...
 * @author ronaldo
 */
public class TelaFotoCrcListaPassagem extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaListaEsperaTO telaListaEsperaCrc;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoCrcListaPassagem(TelaListaEsperaTO parent, boolean modal) {
        this.telaListaEsperaCrc = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaListaEsperaCrc);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoCrcListaPassagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoCrcListaPassagem dialog = new TelaFotoCrcListaPassagem(telaListaEsperaCrc, true);
