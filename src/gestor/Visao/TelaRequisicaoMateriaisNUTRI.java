...
import gestor.Controle.ControleItensRequisicaoMateriaisInternosNUTRI;
import gestor.Controle.ControleLogSistema;
import gestor.Controle.ControleRequisicaoMateririasInternosNUTRI;
 ...
 * @author Ronaldo
 */
public class TelaRequisicaoMateriaisNUTRI extends javax.swing.JInternalFrame {
    ...
    ControleRequisicaoMateririasInternosNUTRI control = new ControleRequisicaoMateririasInternosNUTRI();
    ControleItensRequisicaoMateriaisInternosNUTRI controle = new ControleItensRequisicaoMateriaisInternosNUTRI();
    //    
    ...
    String nomeModuloTela = "Nutrição:Requisição de Materiais:Manutenção";
    String nomeModuloTela2 = "Nutrição:Requisição de Materiais:Itens";
    //
    int flag;
    int acao;
     ...
     */
    public TelaRequisicaoMateriaisNUTRI() {
        initComponents();
        formatarCampos();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        if (jTabelaRequisicoes.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaRequisicoes.getColumnModel().getColumn(3).setMinWidth(320);
            jTabelaRequisicoes.getColumnModel().getColumn(3).setMaxWidth(320);
        }
    ...
    private void jBtPesqCodigoReqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoReqActionPerformed
        ...
        if (jCodReq.getText().equals("")) {
            ...
            pesquisarRequisicaoMateriais("SELECT * FROM REQUISICAO_PRODUTOS_INTERNOS_NUTRI "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN COLABORADOR "
                    + "ON REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdFunc=COLABORADOR.IdFunc "
    ...
    private void jCheckBoxTodosReqItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosReqItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            jTabelaRequisicoes.setVisible(true);
            this.pesquisarRequisicaoMateriais("SELECT * FROM REQUISICAO_PRODUTOS_INTERNOS_NUTRI "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN COLABORADOR "
                    + "ON REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdFunc=COLABORADOR.IdFunc ");
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM REQUISICAO_PRODUTOS_INTERNOS_NUTRI "
                        ...
                        + "WHERE REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdReq='" + IdLanc + "'");
                conecta.rs.first();
            ...
            count = 0;
            preencherTabelaItens("SELECT * FROM ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI "
                    + "INNER JOIN REQUISICAO_PRODUTOS_INTERNOS_NUTRI "
                    + "ON ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdReq=REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdReq "
                    + "INNER JOIN PRODUTOS_AC"
                    + "ON ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                    + "WHERE ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdReq='" + jCodigoReq.getText() + "'");
        }
    ...
    private void jBtPesqInternosRequisicaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqInternosRequisicaoActionPerformed
        // TODO add your handling code here:
        TelaPesqInternoRequisicaoMatNUTRI objPesqInternoReqNUTRI = new TelaPesqInternoRequisicaoMatNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objPesqInternoReqNUTRI);
        objPesqInternoReqNUTRI.show();
    ...
    private void jBtPesqColaboradorReqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqColaboradorReqActionPerformed
        // TODO add your handling code here:
        TelaPesquisaColabordorRequisicaoNUTRI objFuncReqNUTRI = new TelaPesquisaColabordorRequisicaoNUTRI();
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM REQUISICAO_PRODUTOS_INTERNOS_NUTRI WHERE IdReq='" + jCodReq.getText() + "'");
            conecta.rs.first();
            jStatusReq.setText(conecta.rs.getString("StatusReq"));
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        if (jDataReq.getDate() == null) {
            ...
            if (acao == 1) {
                ...
                //
                control.incluirRequisicaoMaterialInternosNUTRI(objReqMatInter);
                buscarCodigo();
                //
                objLog();
            ...
            if (acao == 2) {
                ...
                control.alterarRequisicaoMaterialInternosNUTRI(objReqMatInter);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
                Salvar();
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaRequisicaoIntNUTRI objAudiReqIntNUTRI = new TelaAuditoriaRequisicaoIntNUTRI();
    ...
    private void jBtPesqProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqProdutoActionPerformed
        // TODO add your handling code here:       
        TelaPesqProdutoRequisicaoNUTRI objPesqProdutoReqNUTRI = new TelaPesqProdutoRequisicaoNUTRI();
    ...
    private void jTabelaItensRequisicaoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaItensRequisicaoMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI "
                        + "INNER JOIN PRODUTOS_AC "
                        + "ON ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                        + "INNER JOIN LOTE_PRODUTOS_AC "
                        + "ON PRODUTOS_AC.IdProd=LOTE_PRODUTOS_AC.IdProd "
                        + "WHERE ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdReq='" + jCodReq.getText() + "'AND "
                        + "PRODUTOS_AC.DescricaoProd='" + jDescricaoProduto.getText() + "'AND ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdItem='" + idItem + "'");
                conecta.rs.first();
...
//                controle.alterarUtilizacaoMaterais(objItensReqMatInter);
                ...
                controle.excluirRequisicaoMaterialInternosNUTRI(objItensReqMatInter);
                //
                ...
                preencherTabelaItens("SELECT * FROM ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI "
                        ...
                        + "INNER JOIN PRODUTOS_AC "
                        + "ON ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                        + "WHERE ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdReq='" + jCodReq.getText() + "'");
            }
        }
        ...
        if (jCodProduto.getText().equals("")) {
            ...
            if (acao == 3) {
                ...
                if (saldoEstoque >= objItensReqMatInter.getQtdItem()) {
                    ...
                    controle.incluirRequisicaoMaterialInternosNUTRI(objItensReqMatInter);
                    //
//                    objItensReqMatInter.setIdProd(Integer.valueOf(jCodProduto.getText()));
//                    objItensReqMatInter.setIdReq(Integer.valueOf(jIdRequiscaoUsuario.getText()));
//                    objItensReqMatInter.setAtendReq(atendReq);
//                    controle.alterarUtilizacaoMateraisNUTRI(objItensReqMatInter);
                    //
                    objLog2();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    preencherTabelaItens("SELECT * FROM ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI "
            ...
            if (acao == 4) {
                ...
                if (novoSaldoAtual >= objItensReqMatInter.getQtdItem()) {
                    ...
                    objItensReqMatInter.setIdItem(Integer.valueOf(idItem));
                    controle.alterarRequisicaoMaterialInternosNUTRI(objItensReqMatInter); // ALTERAR QUANTIDADE NA TABELA ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI
                    //
                    objItensReqMatInter.setQtdItem(estoqueAtual);
    ...
    private void jBtAuditoriaItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaItemActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensRequisicaoIntNUTRI objAudItensReqIntNUTRI = new TelaAuditoriaItensRequisicaoIntNUTRI();
    ...
    private void jBtPesqLocalArmazenamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqLocalArmazenamentoActionPerformed
        // TODO add your handling code here:
        TelaPesqLocalArmazenamentoRequisicaoNUTRI objPesqLocalArmNUTRI = new TelaPesqLocalArmazenamentoRequisicaoNUTRI();
        ...
        if (jCodReq.getText().equals("")) {
            ...
            try {
                ...
                conecta.executaSQL("SELECT * FROM REQUISICAO_PRODUTOS_INTERNOS_NUTRI "
                        ...
                        + "INNER JOIN DEPARTAMENTOS "
                        + "ON COLABORADOR.IdDepartamento=COLABORADOR.IdDepartamento "
                        + "WHERE REQUISICAO_PRODUTOS_INTERNOS_NUTRI.IdReq='" + jCodReq.getText() + "'");
    ...
    public void Finalizar() {
        ...
        if (rows == 0) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                control.finalizarRequisicaoMaterialInternosNUTRI(objReqMatInter);
    ...
    public void verificarItensRequisitados() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI WHERE IdReq='" + objReqMatInter.getIdReq() + "'");
            conecta.rs.first();
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                objReqMatInter.setIdReq(Integer.parseInt(jCodReq.getText()));
                control.excluirRequisicaoMaterialInternosNUTRI(objReqMatInter);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                Excluir();
