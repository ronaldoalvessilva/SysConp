...
import static gestor.Visao.TelaTarefasEducativas.jIdTarefa;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaTarefasEdu extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaTarefasEdu() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Tarefas Educacionais :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM TAREFASDIVERSAS WHERE IdTarefa='" + jIdTarefa.getText() + "'");
            conecta.rs.first();
