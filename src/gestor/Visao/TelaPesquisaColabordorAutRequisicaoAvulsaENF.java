...
import static gestor.Visao.TelaRequisicaoAvulsaMedicamentosENF.jMatriculaAutorizadorReq;
import static gestor.Visao.TelaRequisicaoAvulsaMedicamentosENF.jDepartamentoReqAutorizador;
import static gestor.Visao.TelaRequisicaoAvulsaMedicamentosENF.jIdFuncAutorizador;
import static gestor.Visao.TelaRequisicaoAvulsaMedicamentosENF.jNomeFuncionarioAutorizador;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaColabordorAutRequisicaoAvulsaENF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaColabordorAutRequisicaoAvulsaENF() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (jTabelaColabrador.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaColabrador.getColumnModel().getColumn(2).setMinWidth(240);
            jTabelaColabrador.getColumnModel().getColumn(2).setMaxWidth(240);
            jTabelaColabrador.getColumnModel().getColumn(3).setMinWidth(240);
            jTabelaColabrador.getColumnModel().getColumn(3).setMaxWidth(240);
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesNomeColaborador.getText().isEmpty()) {
            ...
            try {
                ...
                conecta.rs.first();
                jIdFuncAutorizador.setText(conecta.rs.getString("IdFunc"));
                jNomeFuncionarioAutorizador.setText(conecta.rs.getString("NomeFunc"));
                jMatriculaAutorizadorReq.setText(conecta.rs.getString("MatriculaFunc"));
                // Capturando foto                          
                jDepartamentoReqAutorizador.setText(conecta.rs.getString("NomeDepartamento"));
    ...
    public void preencherTabela() {
        ...
        jTabelaColabrador.getColumnModel().getColumn(2).setPreferredWidth(240);
        jTabelaColabrador.getColumnModel().getColumn(2).setResizable(false);
        jTabelaColabrador.getColumnModel().getColumn(3).setPreferredWidth(240);
