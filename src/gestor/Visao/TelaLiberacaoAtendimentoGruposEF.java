...
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jBtAuditoria;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jBtNovo;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jCodigoAtend;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jDataAtend;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jStatusAtend;
 ...
 */
public class TelaLiberacaoAtendimentoGruposEF extends javax.swing.JDialog {
    ...
    String nomeModuloTela = "EDUCAÇÃO FÍSICA:Registro de Atendimento de Internos em Grupo";
    //
    int count = 0;
    int codigoDepto = 0;
    String statusMov;
     ...
     */
    public static TelaAtendimentoGrupoEducacaoFisica atendGPSI;
    public static TelaAssinaBiometriaColaboradoresPSP_AG_EF assinaBio;

    public TelaLiberacaoAtendimentoGruposEF(TelaAtendimentoGrupoEducacaoFisica parent, boolean modal) {
    ...
    public void mostrarLiberador() {
        assinaBio = new TelaAssinaBiometriaColaboradoresPSP_AG_EF(this, true);
    ...
    private void initComponents() {
        ...
        jComboBoxTipoMovimentacao.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Atendimento em Grupo/EF", " " }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLiberacaoAtendimentoGruposEF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaLiberacaoAtendimentoGruposEF dialog = new TelaLiberacaoAtendimentoGruposEF(atendGPSI, true);
    ...
    public void Novo() {
        ...
        jComboBoxTipoMovimentacao.setSelectedItem("Atendimento em Grupo/EF");
                ...
                public void run() {
                    ...
                    for (int i = 0; i < jTabelaInternosLiberados.getRowCount(); i++) {
                        ...
                        if (pQUANTIDADE_REGISTRO == count) {
                            ...
                            control.finalizarAtendimentoGrupoEF(objRegAtend);
                            controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
