...
import static gestor.Visao.TelaPerfilCarcerarioPsicologia.jIdPerfil;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaPerfilCarcerarioPsicologia extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaPerfilCarcerarioPsicologia() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PERFIL_CARCERARIO_INTERNO WHERE IdPerfil='" + jIdPerfil.getText() + "'");
            conecta.rs.first();
