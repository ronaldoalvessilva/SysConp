...
import static gestor.Visao.TelaFornecedorAcervo.jIdFornecedor;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaFornecedorAcervo extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaFornecedorAcervo() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM FORNECEDORES_ACERVO WHERE IdForn='" + jIdFornecedor.getText() + "'");
            conecta.rs.first();
