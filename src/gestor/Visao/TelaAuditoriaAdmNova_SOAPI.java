...
import static gestor.Visao.TelaPortaEntradaTO.codigoAvaliacaoI;
 ...
 */
public class TelaAuditoriaAdmNova_SOAPI extends javax.swing.JDialog {
     ...
     */
    public static TelaPortaEntradaTO pPORTA_ENTRADA_TO_SOAPI;

    public TelaAuditoriaAdmNova_SOAPI(TelaPortaEntradaTO parent, boolean modal) {
        this.pPORTA_ENTRADA_TO_SOAPI = parent;
        this.setModal(modal);
        setLocationRelativeTo(pPORTA_ENTRADA_TO_SOAPI);
        initComponents();
        auditoria();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAuditoriaAdmNova_SOAPI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAuditoriaAdmNova_SOAPI dialog = new TelaAuditoriaAdmNova_SOAPI(pPORTA_ENTRADA_TO_SOAPI, true);
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AVALIACAO_TO_I "
                    ...
                    + "AND AVALIACAO_TO_I.IdAvaliaTOI='" + codigoAvaliacaoI + "'");
            conecta.rs.first();
