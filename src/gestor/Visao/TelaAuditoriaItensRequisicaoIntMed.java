...
import static gestor.Visao.TelaRequisicaoMedicamentosInternos.jCodReq;
import static gestor.Visao.TelaRequisicaoMedicamentosInternos.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRequisicaoIntMed extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRequisicaoIntMed() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_PRODUTOS_INTERNOS_ENF WHERE IdReq='" + jCodReq.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
