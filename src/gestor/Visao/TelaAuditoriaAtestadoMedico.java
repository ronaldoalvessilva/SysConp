...
import static gestor.Visao.TelaAdmissaoMedica.jIdAtestado;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAtestadoMedico extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAtestadoMedico() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Atestado Médico :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATESTADO_MEDICO_PSIQUIATRICO WHERE IdLanc='" + jIdAdm.getText() + "'AND IdItem='" + jIdAtestado.getText() + "'");
            conecta.rs.first();
