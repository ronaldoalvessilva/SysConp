 ...
 * @author user
 */
public class TelaPesqInternosEducacaoFrequenciaInterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternosEducacaoFrequenciaInterna() {
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            idInterno = "" + jTabelaPesqInternosEmpresaLab.getValueAt(jTabelaPesqInternosEmpresaLab.getSelectedRow(), 0);
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                        ...
                        + "WHERE PRONTUARIOSCRC.NomeInternoCrc='" + jPesqNomeInterno.getText() + "'AND ITENSMATRICULA.IdInternoCrc='" + idInterno + "'");
                conecta.rs.first();
