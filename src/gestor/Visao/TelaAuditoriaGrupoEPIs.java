 ...
 */
public class TelaAuditoriaGrupoEPIs extends javax.swing.JDialog {
     ...
     */
    public static TelaGrupoEPIs pTELA_GRUPO_epis;

    public TelaAuditoriaGrupoEPIs(TelaGrupoEPIs parent, boolean modal) {
        this.pTELA_GRUPO_epis = parent;
        this.setModal(modal);
        setLocationRelativeTo(pTELA_GRUPO_epis);
        initComponents();
        auditoria();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAuditoriaGrupoEPIs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAuditoriaGrupoEPIs dialog = new TelaAuditoriaGrupoEPIs(pTELA_GRUPO_epis, true);
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM GRUPO_EPIs WHERE IdGrupoEPI='" + jCodigoGrupo.getText() + "'");
            conecta.rs.first();
