...
import gestor.Controle.ControleFornecedoresNUTRI;
 ...
 * @author Ronaldo
 */
public final class TelaFornecedorCOMPRASNUTRI extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    Fornecedor objForn = new Fornecedor();
    ControleFornecedoresNUTRI control = new ControleFornecedoresNUTRI();
    ControleFornecedoresCOMPRAS controle = new ControleFornecedoresCOMPRAS();
    //
    ControleLogSistema controlLog = new ControleLogSistema();
    LogSistema objLogSys = new LogSistema();
    // Variáveis para gravar o log
    String nomeModuloTela = "Nutrição:Fornecedor:Manutenção";
    //
    String statusMov;
    String horaMov;
    String dataModFinal;
     ...
     */
    public TelaFornecedorCOMPRASNUTRI() {
        initComponents();
        formatarCampos();
        corCampos();
    }
                ...
                if (jRazaoSocial.getText().equals("")) {
                    ...
                    if (acao == 1) {
                        ...
                        if (jRazaoSocial.getText().trim().equals(nomeFornecedor)) {
                            ...
                            control.incluirFornecedorNUTRI(objForn);
                            buscarId();
                        }
                        Salvar();
                        objLog();
                    ...
                    if (acao == 2) {
                        ...
                        control.alterarFornecedorNUTRI(objForn);
                        Salvar();
                        objLog();
                        controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                        JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:        
        TelaAuditoriaFornecedorNUTRI objAudiFornNUTRI = new TelaAuditoriaFornecedorNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objAudiFornNUTRI);
        objAudiFornNUTRI.show();
    ...
    private void jCheckBoxPesqTodosFornItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosFornItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED && !jIdFornecedor.getText().equals("")) {
            this.preencherTabelaHistoricoProdutos("SELECT * FROM HISTORICO_COMPRA_NUTRI "
                    + "INNER JOIN PRODUTOS_AC "
                    + "ON HISTORICO_COMPRA_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                    + "INNER JOIN NF_COMPRAS_NUTRI "
                    + "ON HISTORICO_COMPRA_NUTRI.IdNfEntrada=NF_COMPRAS_NUTRI.IdNfEntrada "
                    + "INNER JOIN FORNECEDORES_AC "
                    + "ON NF_COMPRAS_NUTRI.IdForn=FORNECEDORES_AC.IdForn "
                    + "WHERE FORNECEDORES_AC.IdForn='" + jIdFornecedor.getText() + "'AND FORNECEDORES_AC.Modulo='" + modulo + "'");
        } else {
            jtotalRegistros.setText("");
            limparTabelaFornecedor();
        }
    ...
    private void jBtPesqDescricaoProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdutoActionPerformed
        ...
        if (jPesqProdutosCompras.getText().equals("") && !jIdFornecedor.getText().equals("")) {
            ...
            preencherTabelaHistoricoProdutos("SELECT * FROM HISTORICO_COMPRA_NUTRI "
                    + "INNER JOIN PRODUTOS_AC "
                    + "ON HISTORICO_COMPRA_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                    + "INNER JOIN NF_COMPRAS_NUTRI "
                    + "ON HISTORICO_COMPRA_NUTRI.IdNfEntrada=NF_COMPRAS_NUTRI.IdNfEntrada "
                    ...
                    + "WHERE PRODUTOS_AC.DescricaoProd LIKE'%" + jPesqProdutosCompras.getText() + "%'AND FORNECEDORES_AC.IdForn='" + jIdFornecedor.getText() + "'AND FORNECEDORES_AC.Modulo='" + modulo + "'");
        }
...
// VERIFICAR SE O FORNECEDOR JÁ FOI CADASTRADO NA TABELA DE FORNECEDOR_AC
    ...
    public void verificarFornecedor() {
        ...
        if (jIdFornecedor.getText() == null ? codFornecedor == null : jIdFornecedor.getText().equals(codFornecedor)) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                objForn.setIdForn(Integer.valueOf(jIdFornecedor.getText()));
                control.excluirFornecedorNUTRI(objForn);                
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
