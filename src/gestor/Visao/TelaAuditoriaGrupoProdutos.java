...
import static gestor.Visao.TelaGrupoProdutos.jIdGrupo;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaGrupoProdutos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaGrupoProdutos() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM GRUPO_PRODUTOS_AC WHERE IdGrupo='" + jIdGrupo.getText() + "'");
            conecta.rs.first();
