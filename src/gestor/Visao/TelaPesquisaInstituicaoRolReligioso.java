...
import gestor.Dao.*;
import static gestor.Visao.TelaRolVisitasReligiosas.jIDInstituicaoReligiosa;
import static gestor.Visao.TelaRolVisitasReligiosas.jNomeInstituicaoReligiosa;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaInstituicaoRolReligioso extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaInstituicaoRolReligioso() {
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                ...
                conecta.rs.first();
                jIDInstituicaoReligiosa.setText(String.valueOf(conecta.rs.getInt("IdCod")));
