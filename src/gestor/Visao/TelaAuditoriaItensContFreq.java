...
import static gestor.Visao.TelaControleFrequencia.jIdFreq;
import static gestor.Visao.TelaControleFrequencia.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensContFreq extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensContFreq() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSFREQUENCIA WHERE IdFreq='" + jIdFreq.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
