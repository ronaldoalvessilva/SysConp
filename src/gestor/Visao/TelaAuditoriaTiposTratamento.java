...
import static gestor.Visao.TelaTiposTratamentos.jIdTipoTrata;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaTiposTratamento extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaTiposTratamento() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Tipos de Tratamentos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM TIPOS_TRATAMENTOS WHERE IdTipo='" + jIdTipoTrata.getText() + "'");
            conecta.rs.first();
