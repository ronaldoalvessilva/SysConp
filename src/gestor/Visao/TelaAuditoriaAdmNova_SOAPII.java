...
import static gestor.Visao.TelaPortaEntradaTO.codigoAvaliacaoII;
 ...
 */
public class TelaAuditoriaAdmNova_SOAPII extends javax.swing.JDialog {
     ...
     */
    public static TelaPortaEntradaTO pPORTA_ENTRADA_TO_SOAPII;

    public TelaAuditoriaAdmNova_SOAPII(TelaPortaEntradaTO parent, boolean modal) {
        this.pPORTA_ENTRADA_TO_SOAPII = parent;
        this.setModal(modal);
        setLocationRelativeTo(pPORTA_ENTRADA_TO_SOAPII);
        initComponents();
        auditoria();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAuditoriaAdmNova_SOAPII.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAuditoriaAdmNova_SOAPII dialog = new TelaAuditoriaAdmNova_SOAPII(pPORTA_ENTRADA_TO_SOAPII, true);
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AVALIACAO_TO_II "
                    ...
                    + "AND AVALIACAO_TO_II.IdAvaliaTOII='" + codigoAvaliacaoII + "'");
            conecta.rs.first();
