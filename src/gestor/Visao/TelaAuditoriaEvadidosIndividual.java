 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEvadidosIndividual extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEvadidosIndividual() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Evasão de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM EVADIDOSIND WHERE IdLanc='" + jIdLancEvasao.getText() + "'");
            conecta.rs.first();
