...
import static gestor.Visao.TelaMovHistoricoTecPsicologia.jDataNascimento;
import static gestor.Visao.TelaMovHistoricoTecPsicologia.jDataPena;
import static gestor.Visao.TelaMovHistoricoTecPsicologia.jFotoInterno;
import static gestor.Visao.TelaMovHistoricoTecPsicologia.jIdInterno;
import static gestor.Visao.TelaMovHistoricoTecPsicologia.jMatriculaPenalInterno;
import static gestor.Visao.TelaMovHistoricoTecPsicologia.jNomeInterno;
import static gestor.Visao.TelaMovHistoricoTecPsicologia.jRegime;
import static gestor.Visao.TelaMovHistoricoTecPsicologia.jTabelaMovimentacao;
import static gestor.Visao.TelaMovHistoricoTecPsicologia.jUnidadePenal;
 ...
 * @author Ronaldo
 */
public class TelaPesqMovIntTecnicoPsicologia extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqMovIntTecnicoPsicologia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Pesquisa de Internos {PSI} :::...");
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC INNER JOIN DADOSPENAISINTERNOS ON PRONTUARIOSCRC.IdInternoCrc = DADOSPENAISINTERNOS.IdInternoCrc INNER JOIN UNIDADE ON DADOSPENAISINTERNOS.IdUnid = UNIDADE.IdUnid WHERE NomeInternoCrc LIKE  '" + nomeInterno + "%'");
                conecta.rs.first();
