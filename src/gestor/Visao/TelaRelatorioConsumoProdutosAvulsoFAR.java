 ...
 * @author Ronaldo
 */
public class TelaRelatorioConsumoProdutosAvulsoFAR extends javax.swing.JInternalFrame {
     ...
     */
    public TelaRelatorioConsumoProdutosAvulsoFAR() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Relatório Consumo Produtos Avulso :::...");
            ...
            if (jDataPesFinal.getDate() == null) {
                ...
                if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                    ...
                    try {
                        ...
                        String path = "reports/RelatorioConsumoProdutosAvulsoFAR.jasper";
                        conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR "
                                ...
                                + "WHERE DataReq BETWEEN'" + dataInicial + "'AND'" + dataFinal + "'AND PRODUTOS_AC.Modulo='" + modulo + "' ORDER BY PRODUTOS_AC.DescricaoProd");
                        ...
                        jv.setTitle("Relatório de Consumo de Produtos Avulso por Período");
