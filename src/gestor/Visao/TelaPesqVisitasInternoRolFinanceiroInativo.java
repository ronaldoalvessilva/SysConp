...
import static gestor.Visao.TelaSaqueBancarioInativos.jFotoVisitaInterno;
 ...
 * @author Ronaldo
 */
public class TelaPesqVisitasInternoRolFinanceiroInativo extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqVisitasInternoRolFinanceiroInativo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jBtNome, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            pesquisarVisitasRol("SELECT * FROM ITENSROL "
                    ...
                    + "WHERE NomeVisita LIKE'%" + jPesqNome.getText() + "%' AND IdRol='" + idRol + "'");
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM VISITASINTERNO WHERE NomeVisita='" + nomeVisita + "' AND IdVisita='" + idInt + "'");
                conecta.rs.first();
                // jIDVisita.setText(String.valueOf(conecta.rs.getInt("IdVisita")));
                jNomeFavorecido.setText(conecta.rs.getString("NomeVisita"));
                // Capturando foto
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarVisitasRol("SELECT * FROM VISITASINTERNO");
        } else {
            limparTabela();
        }
