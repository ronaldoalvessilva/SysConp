...
import static gestor.Visao.TelaVisitaSocial.caminhoVisitasInternos;
 ...
 * @author ronaldo
 */
public class TelaBiometriaCadastroVisitantes extends javax.swing.JDialog {
     ...
     */
    public static TelaVisitaSocial visitaSocial;

    public TelaBiometriaCadastroVisitantes(TelaVisitaSocial parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBiometriaCadastroVisitantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBiometriaCadastroVisitantes dialog = new TelaBiometriaCadastroVisitantes(visitaSocial, true);
    ...
    public void buscarDigital() {
        conecta.abrirConexao();
        VisitaInterno retorno = null;
        try {
            conecta.executaSQL("SELECT * FROM VISITASINTERNO");
            conecta.rs.first();
            retorno = new VisitaInterno();
            retorno.setBiometriaDedo1(conecta.rs.getBytes("BiometriaDedo1"));
            retorno.setBiometriaDedo2(conecta.rs.getBytes("BiometriaDedo2"));
            retorno.setBiometriaDedo3(conecta.rs.getBytes("BiometriaDedo3"));
            retorno.setBiometriaDedo4(conecta.rs.getBytes("BiometriaDedo4"));
        } catch (Exception e) {
        }
        retorno = retorno;
        conecta.desconecta();
