...
import static gestor.Visao.TelaOcorrenciaPortariaServicoSocial.jFotoVisita;
import static gestor.Visao.TelaOcorrenciaPortariaServicoSocial.jCodigoVisita;
import static gestor.Visao.TelaOcorrenciaPortariaServicoSocial.jGrauParentescoVisita;
import static gestor.Visao.TelaOcorrenciaPortariaServicoSocial.jNomeVisita;
import static gestor.Visao.TelaOcorrenciaPortariaServicoSocial.jStatusVisitaRol;
 ...
 * @author Ronaldo
 */
public class TelaPesqInternasVisitasRolOcorrencia extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternasVisitasRolOcorrencia() {
        initComponents();
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            pesquisarVisitasRol("SELECT * FROM ITENS_LISTA_ROL "
                    ...
                    + "AND ROLVISITAS.IdInternoCrc='" + jCodigoInternoCrc.getText() + "' "
                    + "AND ITENS_LISTA_ROL.StatusInterna='" + statusVisita + "'");
        }
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                        ...
                        + "WHERE PRONTUARIOSCRC.NomeInternoCrc='" + nomeVisita + "' "
                        + "AND PRONTUARIOSCRC.IdInternoCrc='" + idInt + "' ");
                conecta.rs.first();
                jCodigoVisita.setText(String.valueOf(conecta.rs.getInt("IdInternoCrc")));
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarVisitasRol("SELECT * FROM ITENS_LISTA_ROL "
                    ...
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ITENS_LISTA_ROL.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "WHERE ROLVISITAS.IdInternoCrc='" + jCodigoInternoCrc.getText() + "' "
                    + "AND ITENS_LISTA_ROL.StatusInterna='" + statusVisita + "'");
        } else {
            limparTabela();
        }
