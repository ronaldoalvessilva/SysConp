...
import static gestor.Visao.TelaDevolucaoAcervo.jIdDoc;
import static gestor.Visao.TelaDevolucaoAcervo.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensDevolucaoAcervo extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensDevolucaoAcervo() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Itens Devolução Acervo :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_DEVOLUCAO_ACERVO WHERE IdDevolucao='" + jIdDoc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
