...
import static gestor.Visao.TelaModuloPsicologia.telaRegistroAtendimentoBioPSI;
 ...
 * @author ronal
 */
public class TelaRegistroInternosAtendimentoPSI extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "PSICOLOGIA:Registro de Atendimento de Internos:Biometria";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
     ...
     */
    public TelaRegistroInternosAtendimentoPSI() {
        initComponents();
        corCampos();
        pesquisarModulo();
    }
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPSI.equals("ADMINISTRADORES") || codigoUserPSI == codUserAcessoPSI && nomeTelaPSI.equals(telaRegistroAtendimentoBioPSI) && codGravarPSI == 1) {
            verificarInternos();
