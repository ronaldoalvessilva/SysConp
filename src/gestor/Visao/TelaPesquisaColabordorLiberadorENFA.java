...
import static gestor.Visao.TelaSolicitacaoProdutosENFAR.jDepartamentoFuncLib;
import static gestor.Visao.TelaSolicitacaoProdutosENFAR.jIdFuncLib;
import static gestor.Visao.TelaSolicitacaoProdutosENFAR.jNomeFuncLib;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaColabordorLiberadorENFA extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaColabordorLiberadorENFA() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Pesquisar Colaborador", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 0, 0))); // NOI18N
        ...
        jTabelaColabrador.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome Colaborador", "Departamento"
            }
        ));
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesNomeColaborador.getText().equals("")) {
            ...
            preencherTabela("SELECT * FROM APROVADOR_REQUISICAO_MEDICAMENTOS_ENFAR "
                    + "INNER JOIN DEPARTAMENTOS "
                    + "ON APROVADOR_REQUISICAO_MEDICAMENTOS_ENFAR.IdDepartamento=DEPARTAMENTOS.IdDepartamento "
                    + "WHERE NomeAprovador LIKE'%" + jPesNomeColaborador.getText() + "%'AND StatusAprova='" + statusFunc + "'");
        }
        ...
        if (jPesNomeColaborador.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM APROVADOR_REQUISICAO_MEDICAMENTOS_ENFAR "
                        + "INNER JOIN DEPARTAMENTOS "
                        + "ON APROVADOR_REQUISICAO_MEDICAMENTOS_ENFAR.IdDepartamento=DEPARTAMENTOS.IdDepartamento "
                        + "WHERE NomeAprovador='" + jPesNomeColaborador.getText() + "'");
                conecta.rs.first();
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabela("SELECT * FROM APROVADOR_REQUISICAO_MEDICAMENTOS_ENFAR "
                    + "INNER JOIN DEPARTAMENTOS "
                    + "ON APROVADOR_REQUISICAO_MEDICAMENTOS_ENFAR.IdDepartamento=DEPARTAMENTOS.IdDepartamento "
