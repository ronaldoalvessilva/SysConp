 ...
 * @author Ronaldo
 */
public class TelaAuditoriaOcorrenciaVisitasInternas extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaOcorrenciaVisitasInternas() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM OCORRENCIA_INDISCIPLINA_PORTARIA_INTERNOS WHERE IdReg='" + jCodigoRegistro.getText() + "'AND IdOcr='" + jCodigoOcorrencia.getText()  + "'");
            conecta.rs.first();
