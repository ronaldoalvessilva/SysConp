 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_PART_EF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_PART_EF() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_EF "
                    + "WHERE IdItemPartEF='" + pCODIGO_ITEM_PARTICIPANTE + "' "
