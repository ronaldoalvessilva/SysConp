 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEmissaoRevAtestadoRec extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEmissaoRevAtestadoRec() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM REVALIDAR_ATESTADO_RECLUSAO WHERE IdRevAtestado='" + jIdAtestado.getText() + "'");
            conecta.rs.first();
