 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAtendimentoSocial extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAtendimentoSocial() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Atendimento de Internos {SS} :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATENDIMENTOSOCIAL WHERE IdAtend='" + jIdADM_Principal.getText() + "'");
            conecta.rs.first();
