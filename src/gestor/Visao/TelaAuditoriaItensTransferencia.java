...
import static gestor.Visao.TelaTransferenciaEstoqueFarmacia.jIdLanc;
import static gestor.Visao.TelaTransferenciaEstoqueFarmacia.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensTransferencia extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensTransferencia() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Itens Transferência :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_TRANSFERENCIA_PRODUTO_FAR WHERE IdLanc='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
