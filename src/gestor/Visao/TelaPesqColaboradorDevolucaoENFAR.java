...
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.jIdFunc;
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.jColaboradorResponsavel;
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.jDescricaoDepartamento;
 ...
 * @author user
 */
public class TelaPesqColaboradorDevolucaoENFAR extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqColaboradorDevolucaoENFAR() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa Colaborador - ENFAR :::...");
        ...
        if (jTabelaPesqFunc.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaPesqFunc.getColumnModel().getColumn(1).setMinWidth(220);
            jTabelaPesqFunc.getColumnModel().getColumn(1).setMaxWidth(220);
            jTabelaPesqFunc.getColumnModel().getColumn(2).setMinWidth(180);
            jTabelaPesqFunc.getColumnModel().getColumn(2).setMaxWidth(180);
...
//Preencher tabela com todos os COLABORADORES
    public void buscarFunc(String sql) {
        ...
        jTabelaPesqFunc.getColumnModel().getColumn(1).setPreferredWidth(220);
        jTabelaPesqFunc.getColumnModel().getColumn(1).setResizable(false);
        jTabelaPesqFunc.getColumnModel().getColumn(2).setPreferredWidth(180);
