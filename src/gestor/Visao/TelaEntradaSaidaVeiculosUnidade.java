 ...
 * @author user
 */
public class TelaEntradaSaidaVeiculosUnidade extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "Portaria:Entrada/Saida Veiculos Unidade:Manutenção";
    String nomeModuloTela2 = "Portaria:Entrada/Saida Veiculos Unidade:Veiculos";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
     ...
     */
    public TelaEntradaSaidaVeiculosUnidade() {
        initComponents();
        formatarCampo();
        corCampo();
    }
    ...
    private void initComponents() {
        ...
        jPanel15.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Pesquisas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(0, 0, 255))); // NOI18N
        ...
        jTabelaVeiculos.setAutoCreateRowSorter(true);
        ...
        jPanel14Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jBtAlterar, jBtAuditoriaManu, jBtCancelar, jBtExcluir, jBtFinalizar, jBtNovo, jBtSalvar});
        ...
        if (jDataPesqInicial.getDate() == null) {
            ...
            if (jDataPesqFinal.getDate() == null) {
                ...
                if (jDataPesqInicial.getDate().after(jDataPesqFinal.getDate())) {
                    ...
                    preencherTodasEntSai("SELECT * FROM ENTRADAVEICULOSUNIDADE WHERE DataLanc BETWEEN'" + dataInicial + "'AND'" + dataFinal + "'");
                }
            }
        }
    ...
    private void jBtBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtBuscarActionPerformed
        // TODO add your handling code here:
        TelaPesqItensVeiculosUnidade objPesVeiUni = new TelaPesqItensVeiculosUnidade();
        TelaModuloPortarias.jPainelPortarias.add(objPesVeiUni);
        objPesVeiUni.show();
    ...
    private void jBtAuditoriaManuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaManuActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaEntSaiVeicuUnidade objAudEntSaiVeicUnid = new TelaAuditoriaEntSaiVeicuUnidade();
        TelaModuloPortarias.jPainelPortarias.add(objAudEntSaiVeicUnid);
        objAudEntSaiVeicUnid.show();
    ...
    private void jBtAuditoriaVeiculosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaVeiculosActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensEntSaiVeicuUnidade objAudEntSaiItensVeicuUni = new TelaAuditoriaItensEntSaiVeicuUnidade();
        TelaModuloPortarias.jPainelPortarias.add(objAudEntSaiItensVeicuUni);
        objAudEntSaiItensVeicuUni.show();
    ...
    private void jBtPesqColaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqColaActionPerformed
        // TODO add your handling code here:
        TelaPesqColaboradorVeiculoUnidade objPesqColaVeicUni = new TelaPesqColaboradorVeiculoUnidade();
        TelaModuloPortarias.jPainelPortarias.add(objPesqColaVeicUni);
        objPesqColaVeicUni.show();
    ...
    private void jBtPesqVeiculoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqVeiculoActionPerformed
        // TODO add your handling code here:
        TelaPesqVeiculosUnidade objPesqVeicUni = new TelaPesqVeiculosUnidade();
        TelaModuloPortarias.jPainelPortarias.add(objPesqVeicUni);
        objPesqVeicUni.show();
    ...
    public void verificarHoraEntrada() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENSVEICULOSUNIDADE WHERE HorarioSaida='" + verHorarioSaida + "' AND Idlanc='" + jIdLanc.getText() + "' "
                    + "OR HorarioEntrada='" + verHorarioEntrada + "'AND Idlanc='" + jIdLanc.getText() + "' "
                    + "OR KmInicial='" + verKmInicial + "'AND Idlanc='" + jIdLanc.getText() + "' "
                    + "OR KmFinal='" + verKmFinal + "'AND Idlanc='" + jIdLanc.getText() + "'");
            conecta.rs.first();
