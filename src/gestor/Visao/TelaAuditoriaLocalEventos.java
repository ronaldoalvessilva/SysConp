...
import static gestor.Visao.TelaLocalEventoIndisciplinar.jIdLocal;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaLocalEventos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaLocalEventos() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM LOCALEVENTOS WHERE IdLocal='" + jIdLocal.getText() + "'");
            conecta.rs.first();
