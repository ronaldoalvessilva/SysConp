...
import static gestor.Visao.TelaRequisicaoAvulsaAC.jIdLocal;
 ...
 * @author user
 */
public class TelaPesqLocalArmazenamentoReqAvulsaAC extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqLocalArmazenamentoReqAvulsaAC() {
        initComponents();
    }
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoLocal.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM LOCAL_ARMAZENAMENTO_AC WHERE DescricaoLocal LIKE'%" + jPesqDescricaoLocal.getText() + "%'AND Modulo='" + modelo + "'");
        }
    ...
    private void jCheckBoxPesqTodosProdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosProdItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {            
            this.preencherTabelaProdutos("SELECT * FROM LOCAL_ARMAZENAMENTO_AC WHERE Modulo='" + modelo + "'");
        } else {
            limparTabela();
        }
