...
import gestor.Dao.*;
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidadeExterna.idItem;
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidadeExterna.jBtAlterarItem;
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidadeExterna.jBtCancelarItem;
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidadeExterna.jBtExcluirItem;
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidadeExterna.jBtNovoItem;
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidadeExterna.jBtSalvarItem;
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidadeExterna.jDataEntrada;
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidadeExterna.jDataSaida;
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidadeExterna.jDestino;
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidadeExterna.jHorarioEntrada;
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidadeExterna.jHorarioSaida;
...
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidadeExterna.jIdLanc;
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidadeExterna.jIdVeiculo;
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidadeExterna.jKmFinal;
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidadeExterna.jKmInicial;
 ...
 * @author user
 */
public class TelaPesqItensVeiculosUnidadeExterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqItensVeiculosUnidadeExterna() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa de Veiculos da Unidade - {P1 Externa} :::...");

        jTabbedPane1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Listagem de Veiculos da Unidade", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(0, 0, 255)));
    ...
    private void jBtPesqPlacaVeiculoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqPlacaVeiculoActionPerformed
        ...
        if (jPlacaVeiculo.getText().equals("")) {
            ...
            buscarVisitasVeiculos("SELECT * FROM ITENSVEICULOSUNIDADE "
                    ...
                    + "INNER JOIN VEICULOS "
                    + "ON ITENSVEICULOSUNIDADE.IdVeiculo=VEICULOS.IdVeiculo "
                    + "WHERE PlacaVeiculo LIKE'" + jPlacaVeiculo.getText() + "%' "
                    + "AND IdLanc='" + jIdLanc.getText() + "'");
        }
...
//Preencher tabela com todos os VISITANTES
    public void buscarVisitasVeiculos(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Nome do Colaborador", "Data Entrada", "Horário", "Data Saída", "Horário"};
        conecta.abrirConexao();
        try {
    ...
    public void alinharCamposTabelaItens() {
        ...
        jTabelaPesqAdvogado.getColumnModel().getColumn(6).setCellRenderer(centralizado);
        jTabelaPesqAdvogado.getColumnModel().getColumn(7).setCellRenderer(centralizado);
    }
}
