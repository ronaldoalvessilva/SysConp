 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntSaiVeicTerceiros extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEntSaiVeicTerceiros() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSVEICULOSTERCEIRO WHERE IdLanc='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
