...
import static gestor.Visao.TelaRolVisitasReligiosas.idItem;
import static gestor.Visao.TelaRolVisitasReligiosas.jIDRol;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRolVisitasReligiosa extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRolVisitasReligiosa() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Internos Rol  :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_ROL_VISITAS_RELIGIOSA "
                    + "WHERE IdVisitaRel='" + jIDVisita.getText() + "' "
                    + "AND IdItemRol='" + idItem + "'");
            conecta.rs.first();
