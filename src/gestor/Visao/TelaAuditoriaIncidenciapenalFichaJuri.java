...
import static gestor.Visao.TelaFichaJuridica.codIncPen;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaIncidenciapenalFichaJuri extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaIncidenciapenalFichaJuri() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Incidência Penal :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM INCIDENCIA_PENAL WHERE IdFicha='" + jIdFicha.getText() + "'AND IdInc='" + codIncPen + "'");
            conecta.rs.first();
