...
import static gestor.Visao.TelaProdutosNUTRI.jLocalMaster;
 ...
 * @author user
 */
public class TelaPesqLocalArmProdutoNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqLocalArmProdutoNUTRI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabelaLocais = new javax.swing.JTable();

        setClosable(true);
        setIconifiable(true);
        setResizable(true);
        setTitle("...::: Listagem de Armazenamento {NUTRI} :::...");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jPesqDescricaoLocal, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTabelaLocais.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jTabelaLocais.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null}
            },
            new String [] {
                "Código", "Descrição Local"
            }
        ));
        jTabelaLocais.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTabelaLocaisMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTabelaLocais);
        if (jTabelaLocais.getColumnModel().getColumnCount() > 0) {
            jTabelaLocais.getColumnModel().getColumn(0).setMinWidth(80);
            jTabelaLocais.getColumnModel().getColumn(0).setMaxWidth(80);
            jTabelaLocais.getColumnModel().getColumn(1).setMinWidth(380);
            jTabelaLocais.getColumnModel().getColumn(1).setMaxWidth(380);
        }
    ...
    private void jBtPesqDescricaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoActionPerformed
        ...
        if (jPesqDescricaoLocal.getText().equals("")) {
            ...
            preencherTabelaLocais("SELECT * FROM LOCAL_ARMAZENAMENTO_AC WHERE DescricaoLocal LIKE'%" + jPesqDescricaoLocal.getText() + "%'AND Modulo='" + modulo + "'");
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        flag = 1;
        if (flag == 1) {
            String nomeLocal = "" + jTabelaLocais.getValueAt(jTabelaLocais.getSelectedRow(), 1);
    ...
    private void jTabelaLocaisMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaLocaisMouseClicked
        // TODO add your handling code here:
        if (flag == 1) {
            String nomeLocal = "" + jTabelaLocais.getValueAt(jTabelaLocais.getSelectedRow(), 1);
            jPesqDescricaoLocal.setText(nomeLocal);
        }
    }//GEN-LAST:event_jTabelaLocaisMouseClicked
    ...
    private void jCheckBoxTodosLocaisItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosLocaisItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaLocais("SELECT * FROM LOCAL_ARMAZENAMENTO_AC WHERE Modulo='" + modulo + "'");
        } else {
            limparTabela();
        }
    ...
    private javax.swing.JTable jTabelaLocais;
    // End of variables declaration//GEN-END:variables

    public void preencherTabelaLocais(String sql) {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Código", "Descrição Local"};
        conecta.abrirConexao();
        try {
        ...
        jTabelaLocais.setModel(modelo);
        jTabelaLocais.getColumnModel().getColumn(0).setPreferredWidth(80);
        jTabelaLocais.getColumnModel().getColumn(0).setResizable(false);
        jTabelaLocais.getColumnModel().getColumn(1).setPreferredWidth(380);
        jTabelaLocais.getColumnModel().getColumn(1).setResizable(false);
        jTabelaLocais.getTableHeader().setReorderingAllowed(false);
        jTabelaLocais.setAutoResizeMode(jTabelaLocais.AUTO_RESIZE_OFF);
        jTabelaLocais.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        alinharCamposTabela();
        conecta.desconecta();
    }
    ...
    public void limparTabela() {
        ...
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaLocais.setModel(modelo);
        jTabelaLocais.getColumnModel().getColumn(0).setPreferredWidth(50);
        jTabelaLocais.getColumnModel().getColumn(0).setResizable(false);
        jTabelaLocais.getColumnModel().getColumn(1).setPreferredWidth(380);
        jTabelaLocais.getColumnModel().getColumn(1).setResizable(false);
        jTabelaLocais.getTableHeader().setReorderingAllowed(false);
    ...
    public void alinharCamposTabela() {
        ...
        //
        jTabelaLocais.getColumnModel().getColumn(0).setCellRenderer(centralizado);
    }
}
