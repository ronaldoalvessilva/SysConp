...
import static gestor.Visao.TelaIndicadoresAcompanhamento.codigoPSI;
import static gestor.Visao.TelaIndicadoresAcompanhamento.jIdPerfil;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaIndicadoresPSI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaIndicadoresPSI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM INDICADOR_ACOMPANHAMENTO_INTERNO_PSI "
                    + "WHERE IdPsi='" + codigoPSI + "' "
                    + "AND IdIndAco='" + jIdPerfil.getText() + "'");
            conecta.rs.first();
