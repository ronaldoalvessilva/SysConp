 ...
 * @author Ronaldo
 */
public class TelaPesquisaEntraInterLote extends javax.swing.JInternalFrame {
    ...
    String dataCadastro;
    String dataEntrada;
    String situacaoCrc = ""; // Ainda não foi feito a entrada
    String situacaoTra = "TRANSF"; // Transferencia
    String idInt;

    /**
     * Creates new form TelaPesquisaEntradaInternos
     */
    public TelaPesquisaEntraInterLote() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabelaInterno.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome do Interno", "Matriculoa Penal", "Data Entrada", "Data Cadastro"
            }
        ));
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTodosInternos("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "INNER JOIN UNIDADE "
                    + "ON DADOSPENAISINTERNOS.IdUnid=UNIDADE.IdUnid "
                    + "WHERE SituacaoCrc='" + situacaoCrc + "'ORDER BY NomeInternoCrc");
        } else {
            limparTabela();
        }
