...
import static gestor.Visao.TelaAdmissaoEnfermagem.codigoAFP3;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAdmissaoEnfermeiraAEFP3 extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAdmissaoEnfermeiraAEFP3() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        ...
        try {            
            conecta.executaSQL("SELECT * FROM ADME_AFP3 WHERE IdLanc='" + jIdLanc.getText() + "' "
                    + "AND ADME_AFP3.IdAfp3='" + codigoAFP3 + "'");
            conecta.rs.first();
