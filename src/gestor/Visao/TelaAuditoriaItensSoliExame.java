 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensSoliExame extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensSoliExame() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Entrada de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_SOLICITACAO_EXAMES_MEDICO_PSIQUIATRICO WHERE IdSolExame='" + jCodigoSolExame.getText() + "'AND IdItemExame='" + jIdItemExame.getText()  + "'");
            conecta.rs.first();
