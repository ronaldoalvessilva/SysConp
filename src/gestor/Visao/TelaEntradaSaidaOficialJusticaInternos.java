 ...
 * @author user
 */
public class TelaEntradaSaidaOficialJusticaInternos extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    EntradaSaidaOficialJusticaInternos objEntSaiOFInternos = new EntradaSaidaOficialJusticaInternos();
    ControleEntSaiOFInternos control = new ControleEntSaiOFInternos();
    //
    ItensEntradaSaidaOJInternos objItensEntSaiOJInternos = new ItensEntradaSaidaOJInternos();
    ControleItensEntSaiOficialJusticaInternos controle = new ControleItensEntSaiOficialJusticaInternos();
    //
    ...
    String nomeModuloTela = "Portaria:Entrada/Saida de Oficial de Justiça/Internos:Manutenção";
    String nomeModuloTela2 = "Portaria:Entrada/Saida de Oficial de Justiça/Internos:Internos";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
     ...
     */
    public static TelaFotoOficialJustica telaFotoOficialJustica;
    public static TelaFotoOficialJusticaInterno telaInternoOficalJus;

    public TelaEntradaSaidaOficialJusticaInternos() {
        super();
        initComponents();
        setResizable(false);
        formatarCampos();
    ...
    public void mostrarFotoOficialJustica() {
        telaFotoOficialJustica = new TelaFotoOficialJustica(this, true);
        telaFotoOficialJustica.setVisible(true);
    }

    public void mostrarFotoInternoAdv() {
        telaInternoOficalJus = new TelaFotoOficialJusticaInterno(this, true);
        telaInternoOficalJus.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jIDOficialJustica = new javax.swing.JTextField();
        ...
        jBtZoonFotoOficialJustica = new javax.swing.JButton();
        jPanel4 = new javax.swing.JPanel();
        jLabel10 = new javax.swing.JLabel();
        jPanel6 = new javax.swing.JPanel();
        jFotoInternoOficialJustica = new javax.swing.JLabel();

        setClosable(true);
        setDefaultCloseOperation(javax.swing.WindowConstants.HIDE_ON_CLOSE);
        setIconifiable(true);
        setTitle("...::: Entrada e Saida Oficial Justiça Visitas Internos {P1} :::...");
        ...
        jIDOficialJustica.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jIDOficialJustica.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jIDOficialJustica.setEnabled(false);
        ...
        jLabel4.setText("Nome do Oficial de Justiça");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Foto O. Justiça", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(0, 0, 255))); // NOI18N

        javax.swing.GroupLayout jPanel3Layout = new javax.swing.GroupLayout(jPanel3);
        jPanel3.setLayout(jPanel3Layout);
        jPanel3Layout.setHorizontalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jFotoOficialJustica, javax.swing.GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE)
        );
        jPanel3Layout.setVerticalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jFotoOficialJustica, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );

        jBtZoonFotoOficialJustica.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gestor/Imagens/11985_16x16.png"))); // NOI18N
        jBtZoonFotoOficialJustica.setToolTipText("Ampliar Foto Advogado");
        jBtZoonFotoOficialJustica.setEnabled(false);
        jBtZoonFotoOficialJustica.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBtZoonFotoOficialJusticaActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jIDOficialJustica, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel4)
                            .addGroup(jPanel12Layout.createSequentialGroup()
                                .addComponent(jNomeOficialJustica)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel12Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jBtZoonFotoOficialJustica))
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                            .addComponent(jIDOficialJustica, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTabbedPane2.addTab("Dados do Oficial de Justiça", jPanel12);

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(""));

        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gestor/Imagens/accessories-editor-text-icone-8886-96.png"))); // NOI18N
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addComponent(jFotoInternoOficialJustica, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        jPanel6Layout.setVerticalGroup(
            jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jFotoInternoOficialJustica, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
            ...
            if (jDataPesqInicial.getDate() == null) {
                ...
                if (jDataPesqFinal.getDate() == null) {
                    ...
                    if (jDataPesqInicial.getDate().after(jDataPesqFinal.getDate())) {
                        ...
                        preencherTodasEntSai("SELECT * FROM ENTRADAS_OFICIAL_JUSTICA_INTERNOS "
                                + "INNER JOIN OFICIAL_JUSTICA "
                                + "ON ENTRADAS_OFICIAL_JUSTICA_INTERNOS.IdOficial=OFICIAL_JUSTICA.IdOficial "
    ...
    private void jTabelaEntradaSaidaAdvogadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaEntradaSaidaAdvogadosMouseClicked
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM ENTRADAS_OFICIAL_JUSTICA_INTERNOS "
                        + "INNER JOIN OFICIAL_JUSTICA "
                        + "ON ENTRADAS_OFICIAL_JUSTICA_INTERNOS.IdOficial=OFICIAL_JUSTICA.IdOficial "
                        + "WHERE IdLanc='" + IdLanc + "'");
                conecta.rs.first();
                ...
                // Capturando foto
                caminhoAdv = conecta.rs.getString("FotoOficial");
                if (caminhoAdv != null) {
            ...
            preencherTabelaItens("SELECT * FROM ITENS_ENTRADAS_OFICIAL_JUSTICA_INTERNOS "
                    + "INNER JOIN OFICIAL_JUSTICA "
                    + "ON ITENS_ENTRADAS_OFICIAL_JUSTICA_INTERNOS.IdOficial=OFICIAL_JUSTICA.IdOficial "
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaOFJManuP1) && codIncluirP1 == 1) {
            acao = 1;
            Novo();
            corCampo();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaOFJManuP1);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaOFJManuP1) && codAlterarP1 == 1) {
            objEntSaiOFInternos.setStatusLanc(jStatusEntCola.getText());
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaOFJManuP1);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaOFJManuP1) && codExcluirP1 == 1) {
            objEntSaiOFInternos.setStatusLanc(jStatusEntCola.getText());
            if (jStatusEntCola.getText().equals("FINALIZADO")) {
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaOFJManuP1);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaOFJManuP1) && codGravarP1 == 1) {
                    ...
                    if (jHorarioEntrada.getText().equals("")) {
                        ...
                        if (jDataSaida.getDate() == null) {
                            ...
                            if (jHorarioSaida.getText().equals("")) {
                                ...
                                objEntSaiOFInternos.setDataLanc(jDatalancamento.getDate());
                                objEntSaiOFInternos.setObsLanc(jObservacao.getText());
                                objEntSaiOFInternos.setStatusLanc(statusEnt);
                                objEntSaiOFInternos.setDataEntrada(jDataEntrada.getDate());
                                objEntSaiOFInternos.setHorarioEntrada(jHorarioEntrada.getText());
                                objEntSaiOFInternos.setDataSaida(jDataSaida.getDate());
                                objEntSaiOFInternos.setHorarioSaida(jHorarioSaida.getText());
                                if (acao == 1) {
                                    objEntSaiOFInternos.setUsuarioInsert(nameUser);
                                    objEntSaiOFInternos.setDataInsert(dataModFinal);
                                    objEntSaiOFInternos.setHoraInsert(horaMov);
                                    //
                                    objEntSaiOFInternos.setIdOficialJustica(Integer.valueOf(jIDOficialJustica.getText()));
                                    objEntSaiOFInternos.setNomeOficialJustica(jNomeOficialJustica.getText());
                                    control.incluirEntSaiOficialJustica(objEntSaiOFInternos);
                                    buscarID();
                                    objLog();
                                ...
                                if (acao == 2) {
                                    objEntSaiOFInternos.setUsuarioUp(nameUser);
                                    objEntSaiOFInternos.setDataUp(dataModFinal);
                                    objEntSaiOFInternos.setHoraUp(horaMov);
                                    objEntSaiOFInternos.setIdLanc(Integer.valueOf(jIDlanc.getText()));
                                    objEntSaiOFInternos.setIdOficialJustica(Integer.valueOf(jIDOficialJustica.getText()));
                                    objEntSaiOFInternos.setNomeOficialJustica(jNomeOficialJustica.getText());
                                    control.alterarEntSaiOficialJustica(objEntSaiOFInternos);
                                    verificarInternos();
                                    objLog();
                                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                                    JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        if (jHorarioSaida.getText().equals(horaSaidaEncontrado) && jIDlanc.getText().equals(codigoRegistro) || jHorarioEntrada.getText().equals(horaEntradaEncontrada) && jIDlanc.getText().equals(codigoRegistro)) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM ENTRADAS_OFICIAL_JUSTICA_INTERNOS WHERE IdLanc='" + jIDlanc.getText() + "'");
                conecta.rs.first();
                jStatusEntCola.setText(conecta.rs.getString("StatusLanc"));
                if (jStatusEntCola.getText().equals("FINALIZADO")) {
    ...
    private void jBtPesqAdvogadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqAdvogadoActionPerformed
        // TODO add your handling code here:        
        TelaPesqOficialJusticaInternos objPesqOFJ = new TelaPesqOficialJusticaInternos();
        TelaModuloPortarias.jPainelPortarias.add(objPesqOFJ);
        objPesqOFJ.show();
    ...
    private void jBtPesqInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqInternoActionPerformed
        // TODO add your handling code here:
        TelaPesqInternosOficialJusticaEntSai objInternosAdvogados = new TelaPesqInternosOficialJusticaEntSai();
    ...
    private void jBtNovoInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoInternoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaOFJInteP1);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaOFJInteP1) && codIncluirP1 == 1) {
            objEntSaiOFInternos.setStatusLanc(jStatusEntCola.getText());
            if (jStatusEntCola.getText().equals("FINALIZADO")) {
    ...
    private void jBtAlterarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarInternoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaOFJInteP1);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaOFJInteP1) && codAlterarP1 == 1) {
            objEntSaiOFInternos.setStatusLanc(jStatusEntCola.getText());
            if (jStatusEntCola.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Essa entrada de interno não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtExcluirInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirInternoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaOFJInteP1);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaOFJInteP1) && codExcluirP1 == 1) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            objEntSaiOFInternos.setStatusLanc(jStatusEntCola.getText());
            if (jStatusEntCola.getText().equals("FINALIZADO")) {
                ...
                if (resposta == JOptionPane.YES_OPTION) {
                    ...
                    objVisitasOFInt.setIdInternoCrc(Integer.valueOf(jIdInterno.getText()));
                    controleOFJ.excluirOficialJusticaInterno(objVisitasOFInt);
                    //
                    objLog2();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
    ...
    private void jBtSalvarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarInternoActionPerformed
        // TODO add your handling code here:      
        buscarAcessoUsuario(telaEntradaSaidaOFJInteP1);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1.equals("ADMINISTRADORES") || codigoUserP1 == codUserAcessoP1 && nomeTelaP1.equals(telaEntradaSaidaOFJInteP1) && codGravarP1 == 1) {
            if (jNomeInterno.getText().equals("")) {
                ...
                objItensEntSaiOJInternos.setIdlanc(Integer.valueOf(jIDlanc.getText()));
                if (acao == 3) {
                    // Para o log do registro
                    objItensEntSaiOJInternos.setUsuarioInsert(nameUser);
                    objItensEntSaiOJInternos.setDataInsert(dataModFinal);
                    objItensEntSaiOJInternos.setHoraInsert(horaMov);
                    //
                    objItensEntSaiOJInternos.setIdlanc(Integer.valueOf(jIDlanc.getText()));
                    objItensEntSaiOJInternos.setIdOficial(Integer.valueOf(jIDOficialJustica.getText()));
                    objItensEntSaiOJInternos.setIdInternoCrc(Integer.valueOf(jIdInterno.getText()));
                ...
                if (acao == 4) {
                    objItensEntSaiOJInternos.setUsuarioUp(nameUser);
                    objItensEntSaiOJInternos.setDataUp(dataModFinal);
                    objItensEntSaiOJInternos.setHoraUp(horaMov);
                    //
                    objItensEntSaiOJInternos.setIdlanc(Integer.valueOf(jIDlanc.getText()));
                    objItensEntSaiOJInternos.setIdOficial(Integer.valueOf(jIDOficialJustica.getText()));
                    objItensEntSaiOJInternos.setIdItem(Integer.valueOf(idItem));
    ...
    private void jBtBuscarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtBuscarInternoActionPerformed
        // TODO add your handling code here:
        TelaBuscarInternosOficialJustica objBuscarInternos = new TelaBuscarInternosOficialJustica();
    ...
    private void jBtNomeAdvogadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeAdvogadoActionPerformed
        ...
        if (jPesquisaNomeAdvogado.getText().equals("")) {
            ...
            pesquisarEntSaiAdvInterno("SELECT * FROM ENTRADAS_OFICIAL_JUSTICA_INTERNOS "
                    + "INNER JOIN OFICIAL_JUSTICA "
                    + "ON ENTRADAS_OFICIAL_JUSTICA_INTERNOS.IdOficial=OFICIAL_JUSTICA.IdOficial "
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTodasEntSai("SELECT * FROM ENTRADAS_OFICIAL_JUSTICA_INTERNOS "
                    + "INNER JOIN OFICIAL_JUSTICA "
                    + "ON ENTRADAS_OFICIAL_JUSTICA_INTERNOS.IdOficial=OFICIAL_JUSTICA.IdOficial "
                    + "ORDER BY DataLanc");
        } else {
    ...
    private void jBtAuditoriaManuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaManuActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaEntSaiOficialJusInternos objAudEntSaiAdvInt = new TelaAuditoriaEntSaiOficialJusInternos();
    ...
    private void jBtAuditoriaInternosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaInternosActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensEntradaSaidaOFInternos objAudEntSaiItensInt = new TelaAuditoriaItensEntradaSaidaOFInternos();
    ...
    private void jBtZoonFotoOficialJusticaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtZoonFotoOficialJusticaActionPerformed
        // TODO add your handling code here:
        if (jIDOficialJustica.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Pesquise primeiro o Advogado para poder ampliar a foto.");
        } else {
            mostrarFotoOficialJustica();
        }
    }//GEN-LAST:event_jBtZoonFotoOficialJusticaActionPerformed
    ...
    public static javax.swing.JButton jBtZoonFotoOficialJustica;
    ...
    public static javax.swing.JTextField jIDOficialJustica;
    ...
    public void verificarInternos() {
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM VISITAS_OFICIAL_JUSTICA WHERE IdLanc='" + jIDlanc.getText() + "'");
            conecta.rs.first();
            idEntAd = conecta.rs.getString("IdLanc");
            if (jIDlanc.getText().equals(idEntAd)) {
                objHorarioAdvogadosInternos();
                objItensEntSaiOJInternos.setIdlanc(Integer.valueOf(jIDlanc.getText()));
                controleOFJ.alterarHorarioOficialJusticaInterno(objVisitasOFInt);
            } else {
    ...
    public void objHorarioAdvogadosInternos() {
        objVisitasOFInt.setIdLanc(Integer.valueOf(jIDlanc.getText()));
        objVisitasOFInt.setIdOficial(Integer.valueOf(jIDOficialJustica.getText()));
        objVisitasOFInt.setDataEntrada(jDataEntrada.getDate());
        objVisitasOFInt.setHorarioEntrada(jHorarioEntrada.getText());
        objVisitasOFInt.setDataSaida(jDataSaida.getDate());
        objVisitasOFInt.setHorarioSaida(jHorarioSaida.getText());
    }
    ...
    public void corCampo() {
        ...
        //
        jIDOficialJustica.setBackground(Color.white);
    ...
    public void Finalizar() {
        ...
        int resposta = JOptionPane.showConfirmDialog(this, "Deseja realmente finalizar assim mesmo o lançamento selecionado?", "Confirmação",
                JOptionPane.YES_NO_OPTION);
        if (resposta == JOptionPane.YES_OPTION) {
            objEntSaiOFInternos.setStatusLanc(statusLanc);
            objEntSaiOFInternos.setIdLanc(Integer.parseInt(jIDlanc.getText()));
            control.finalizarEntSaiOficialJustica(objEntSaiOFInternos);
    ...
    public void verificarHoraEntrada() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ENTRADAS_OFICIAL_JUSTICA_INTERNOS WHERE HorarioSaida='" + verHorarioSaida + "'AND Idlanc='" + jIDlanc.getText() + "'OR HorarioEntrada='" + verHorarioEntrada + "'AND Idlanc='" + jIDlanc.getText() + "'");
            conecta.rs.first();
    ...
    public void verificarItens() {
        ...
        try {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                objEntSaiOFInternos.setIdLanc(Integer.parseInt(jIDlanc.getText()));
                control.excluirEntSaiOficialJustica(objEntSaiOFInternos);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                Excluir();
