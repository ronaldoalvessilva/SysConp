...
import static gestor.Visao.TelaRequisicaoMateriaisNUTRI.jDescricaoProduto;
import static gestor.Visao.TelaRequisicaoMateriaisNUTRI.jCodProduto;
import static gestor.Visao.TelaRequisicaoMateriaisNUTRI.jCodigoBarras;
import static gestor.Visao.TelaRequisicaoMateriaisNUTRI.jLote;
import static gestor.Visao.TelaRequisicaoMateriaisNUTRI.jDataVctoLote;
import static gestor.Visao.TelaRequisicaoMateriaisNUTRI.jComboBoxUnidade;
import static gestor.Visao.TelaRequisicaoMateriaisNUTRI.jValorUnitarioItem;
 ...
 * @author user
 */
public class TelaPesqProdutoRequisicaoNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoRequisicaoNUTRI() {
        initComponents();
    }
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM PRODUTOS_NUTRI "
                    ...
                    + "WHERE DescricaoProd LIKE'%" + jPesqDescricaoProdutos.getText() + "%'AND StatusProd='" + statusProd + "'AND Qtd!='" + 0 + "'");
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRODUTOS_NUTRI "
                        + "INNER JOIN LOCAL_ARMAZENAMENTO_NUTRI "
                        + "ON PRODUTOS_NUTRI.IdLocal=LOCAL_ARMAZENAMENTO_NUTRI.IdLocal "
                        + "INNER JOIN LOTE_PRODUTOS_NUTRI "
                        + "ON PRODUTOS_NUTRI.IdProd=LOTE_PRODUTOS_NUTRI.IdProd "
                        + "WHERE PRODUTOS_NUTRI.DescricaoProd='" + jPesqDescricaoProdutos.getText() + "'AND PRODUTOS_NUTRI.StatusProd='" + statusProd + "'AND PRODUTOS_NUTRI.IdProd='" + idInt + "'AND Qtd!='" + 0 + "'");
                conecta.rs.first();
    ...
    private void jCheckBoxPesqTodosProdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosProdItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaProdutos("SELECT * FROM PRODUTOS_NUTRI "
    ...
    public void alinharCamposTabela() {
        ...
        jTabelaProdutos.getColumnModel().getColumn(3).setCellRenderer(esquerda);
        jTabelaProdutos.getColumnModel().getColumn(4).setCellRenderer(esquerda);
        jTabelaProdutos.getColumnModel().getColumn(5).setCellRenderer(centralizado);
        jTabelaProdutos.getColumnModel().getColumn(6).setCellRenderer(esquerda);
    }
}
