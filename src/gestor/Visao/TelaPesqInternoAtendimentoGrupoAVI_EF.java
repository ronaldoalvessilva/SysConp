...
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jIdInternoAI;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jNomeInternoAVI;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jFotoInternoGrupo;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jCNCAI;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jCodigoAtend;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jNomeMaeInternoAVI;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jRegimeAVI;
 ...
 * @author Ronaldo
 */
public class TelaPesqInternoAtendimentoGrupoAVI_EF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoAtendimentoGrupoAVI_EF() {
        initComponents();
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTabelaNome("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_EF "
    ...
    private void jBtMatriculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtMatriculaActionPerformed
        ...
        if (jPesqMatricula.getText().equals("")) {
            ...
            buscarInternosMatricula("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_EF "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTodosInternos("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_EF "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
