 ...
 * @author Ronaldo
 */
public class TelaAudItensEntradaSaidaVisitasInternosInternas extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAudItensEntradaSaidaVisitasInternosInternas() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Visitas Internas :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_VISITA_INTERNA WHERE IdLanc='" + jIDlanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
