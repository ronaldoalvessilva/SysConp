...
import gestor.Controle.ControleProdutosNUTRI;
import gestor.Controle.ControleSaldoProdutoNUTRI;
 ...
 * @author user
 */
public class TelaProdutosNUTRI extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    ProdutoMedicamento objProdMed = new ProdutoMedicamento();
    ControleProdutosNUTRI control = new ControleProdutosNUTRI();
    ControleSaldoProdutoNUTRI controlEst = new ControleSaldoProdutoNUTRI();
    ControleEfetivaLoteNUTRI controleLote = new ControleEfetivaLoteNUTRI();
    ...
    String nomeModuloTela = "Nutrição:Cadastro de Produtos:Manutenção";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
    ...
    double fatorCoccao = 0;
    String modulo = "N";

    /**
     * Creates new form TelaMedicamentos
     */
    public TelaProdutosNUTRI() {
        initComponents();
        formatarCampos();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Cadastro de Produtos {NUTRI} :::...");
        ...
        jComboBoxUnidProduto.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "UN", "Caixa", "Pacote", "Ml", "Kg", "Litro", "Peça", "Amp", "Kit", "PR", "Gr", "Lata", "Copo" }));
        ...
        jPesoBruto.setToolTipText("Peso Bruto por Porção");
        ...
        jFatorCoccao.setToolTipText("Fator de Cocção");
        ...
        jLabel8.setText("P.L.P");

        jPesoLiquido.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jPesoLiquido.setToolTipText("Peso Liquido por Porção");
        ...
        jFatorCorrecao.setToolTipText("Fator de Correção");
                    ...
                    .addGroup(jPanel21Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel21Layout.createSequentialGroup()
                                ...
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addComponent(jComboBoxUnidProduto, 0, 90, Short.MAX_VALUE)))
                        ...
                        .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel21Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jReferencia, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jPesoLiquido, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jLabel7, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(jFatorCorrecao, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jLabel13)
                                    .addComponent(jFatorCoccao, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                .addContainerGap(16, Short.MAX_VALUE))
        );

        jPanel21Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jIdFor, jIdGrupo, jIdProduto});

        jPanel21Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jPesoBruto, jPesoLiquido});
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        ...
        if (jIdProduto.getText().equals(codProdutoLote)) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                control.excluirProdutoNUTRI(objProdMed);
                controlEst.excluirEstoqueProdutoNUTRI(objProdMed);
                controlHistMov.excluirHistoricoProdutoNUTRI(objHistMovAC);
                objLog();
        ...
        if (jComboBoxStatusProduto.getSelectedItem() == null) {
            ...
            if (acao == 1) {
                ...
                if (jDescricaoProduto.getText().trim().equals(nomeProdutoAC)) {
                    ...
                    control.incluirProdutoNUTRI(objProdMed);
                    buscarID();
                    objProdMed.setIdProd(Integer.valueOf(jIdProduto.getText()));
                    objProdMed.setIdLocal(codLocal);
                    controlEst.incluirEstoqueProdutoNUTRI(objProdMed);
                    ...
                    controleLote.incluirLoteProdutoNUTRI(objProdMed);
            ...
            if (acao == 2) {
                ...
                objProdMed.setNomeLocal(jLocalMaster.getText());
                objProdMed.setIdProd(Integer.valueOf(jIdProduto.getText()));
                control.alterarProdutoNUTRI(objProdMed);
                controlEst.alterarEstoqueProdutoNUTRI(objProdMed);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                Salvar();
                JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
    ...
    private void jBtPesqLocalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqLocalActionPerformed
        // TODO add your handling code here:
        TelaPesqLocalArmProdutoNUTRI objPesqLocalProdNUTRI = new TelaPesqLocalArmProdutoNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objPesqLocalProdNUTRI);
        objPesqLocalProdNUTRI.show();
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRODUTOS_AC "
                        ...
                        + "WHERE PRODUTOS_AC.DescricaoProd='" + jPesqDescricaoProd.getText() + "'AND PRODUTOS_AC.IdProd='" + idProd + "'");
                conecta.rs.first();
                ...
                DecimalFormat pb = new DecimalFormat("###,###0.000");
                String vlpesoBruto = pb.format(pesoBruto);
                jPesoBruto.setText(vlpesoBruto);
                //
                pesoLiquido = conecta.rs.getFloat("PesoLiquido");
                DecimalFormat pl = new DecimalFormat("###,###0.000");
                String vlpesoLiquido = pl.format(pesoLiquido);
                jPesoLiquido.setText(vlpesoLiquido);
                //
                fatorCorrecao = conecta.rs.getFloat("FatorCorrecao");
                DecimalFormat fc = new DecimalFormat(",###0.00");
                String vlfatorCorrecao = fc.format(fatorCorrecao);
                jFatorCorrecao.setText(vlfatorCorrecao);
                //
                fatorCoccao = conecta.rs.getFloat("FatorCoccao");
                DecimalFormat fcc = new DecimalFormat(",###0.00");
                String vlfatorCoccao = fcc.format(fatorCoccao);
                jFatorCoccao.setText(vlfatorCoccao);
                //
                // Capturando foto
    ...
    private void jBtPesqGrupoMedicamentosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqGrupoMedicamentosActionPerformed
        // TODO add your handling code here:
        TelaPesqGrupoProdutoNUTRI objPesqProdNUTRI = new TelaPesqGrupoProdutoNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objPesqProdNUTRI);
        objPesqProdNUTRI.show();
    ...
    private void jBtPesqFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqFornecedorActionPerformed
        // TODO add your handling code here:
        TelaPesqFornecedorNUTRI objFornNUTRI = new TelaPesqFornecedorNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objFornNUTRI);
        objFornNUTRI.show();
    ...
    private void jBtPesqFornecedorProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqFornecedorProdutoActionPerformed
        ...
        if (jPesqDescricaoFornecedor.getText().equals("") && !jDescricaoProduto.getText().equals("")) {
            ...
            preencherTabelaHistoricoFornecedor("SELECT * FROM HISTORICO_PRODUTOS_FORNECEDOR_NUTRI "
                    + "INNER JOIN FORNECEDORES_AC "
                    + "ON HISTORICO_PRODUTOS_FORNECEDOR_NUTRI.IdForn=FORNECEDORES_AC.IdForn "
                    + "INNER JOIN ITENS_COMPRAS_MATERIAIS_NUTRI "
                    + "ON HISTORICO_PRODUTOS_FORNECEDOR_NUTRI.IdItem=ITENS_COMPRAS_MATERIAIS_NUTRI.IdItem "
                    + "INNER JOIN PRODUTOS_AC "
                    + "ON ITENS_COMPRAS_MATERIAIS_NUTRI.IdProd=PRODUTOS_NUTRI.IdProd  "
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaProdutosNUTRI objAudProdNUTRI = new TelaAuditoriaProdutosNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objAudProdNUTRI);
        objAudProdNUTRI.show();
    ...
    private javax.swing.JTextField jFatorCoccao;
    private javax.swing.JTextField jFatorCorrecao;
    ...
    public void formatarCampos() {
        ...
        jPesoBruto.setDocument(new LimiteDigitosNum(7));
        jPesoLiquido.setDocument(new LimiteDigitosNum(7));
        jFatorCoccao.setDocument(new LimiteDigitosNum(5));
    ...
    public void verificarProdutoLote() {
        ...
        try {
            ...
            Logger.getLogger(TelaProdutosNUTRI.class.getName()).log(Level.SEVERE, null, ex);
        }
        conecta.desconecta();
    }
    ...
    public void preencherTabelaLotes(String sql) {
        ...
        //
        alinhaColunasTabelaLotes();
        conecta.desconecta();
    }

    public void alinhaColunasTabelaLotes() {
        //
        DefaultTableCellRenderer esquerda = new DefaultTableCellRenderer();
        DefaultTableCellRenderer centralizado = new DefaultTableCellRenderer();
        DefaultTableCellRenderer direita = new DefaultTableCellRenderer();
        ...
        jTabelaLote.getColumnModel().getColumn(1).setCellRenderer(centralizado);
    ...
    public void preencherTabelaHistoricoFornecedor(String sql) {
        ...
        //
        alinhaColunasTabelaHistoricoFornecedor();
        conecta.desconecta();
    }

    public void alinhaColunasTabelaHistoricoFornecedor() {
        //
        DefaultTableCellRenderer esquerda = new DefaultTableCellRenderer();
        DefaultTableCellRenderer centralizado = new DefaultTableCellRenderer();
        DefaultTableCellRenderer direita = new DefaultTableCellRenderer();
