...
import static gestor.Visao.TelaRegistroRetornoInternoPortaria.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRegistroRetorno extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRegistroRetorno() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSREGISTRO WHERE IdRetorno='" + jIDLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
