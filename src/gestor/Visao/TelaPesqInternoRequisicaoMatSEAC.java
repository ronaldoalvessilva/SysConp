...
import static gestor.Visao.TelaRequisicaoMateriaisInternosSEAC.jCodInterno;
import static gestor.Visao.TelaRequisicaoMateriaisInternosSEAC.jMatriculaPenal;
import static gestor.Visao.TelaRequisicaoMateriaisInternosSEAC.jNomeInternoReq;
import static gestor.Visao.TelaRequisicaoMateriaisInternosSEAC.jPavilhaoReq;
import static gestor.Visao.TelaRequisicaoMateriaisInternosSEAC.jCelaReq;
import static gestor.Visao.TelaRequisicaoMateriaisInternosSEAC.jFotoInternoReq;
 ...
 * @author user
 */
public class TelaPesqInternoRequisicaoMatSEAC extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoRequisicaoMatSEAC() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Internos {SEAC} :::...");
        ...
        if (jTabelaLocacao.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaLocacao.getColumnModel().getColumn(2).setMinWidth(70);
            jTabelaLocacao.getColumnModel().getColumn(2).setMaxWidth(70);
    ...
    public void preencherTabelaInternos(String sql) {
        ...
        jTabelaLocacao.getColumnModel().getColumn(2).setPreferredWidth(70);
