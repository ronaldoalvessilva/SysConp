 ...
 * @author Ronaldo
 */
public class TelaAuditoriaPrescricaMedica extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaPrescricaMedica() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Prescrição Médico :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PRESCRICAO_MEDICA_PSIQUIATRICA WHERE IdLanc='" + jIdAdm.getText() + "'AND IdItem='" + jIdPrescricaoMedica.getText() + "'");
            conecta.rs.first();
