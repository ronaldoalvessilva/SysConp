...
import static gestor.Visao.TelaSolicitacaoProdutosENFAR.jDepartamentoFuncSol;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaColabordorSolicitanteENFA extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaColabordorSolicitanteENFA() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (jTabelaColabrador.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaColabrador.getColumnModel().getColumn(1).setMinWidth(280);
            jTabelaColabrador.getColumnModel().getColumn(1).setMaxWidth(280);
            jTabelaColabrador.getColumnModel().getColumn(2).setMinWidth(220);
            jTabelaColabrador.getColumnModel().getColumn(2).setMaxWidth(220);
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesNomeColaborador.getText().equals("")) {
            ...
            preencherTabela("SELECT * FROM SOLICITANTE_REQUISICAO_MEDICAMENTOS_ENFAR "
                    + "INNER JOIN DEPARTAMENTOS "
                    + "ON SOLICITANTE_REQUISICAO_MEDICAMENTOS_ENFAR.IdDepartamento=DEPARTAMENTOS.IdDepartamento "
                    + "WHERE NomeSolicitante LIKE'%" + jPesNomeColaborador.getText() + "%'AND StatusSolici='" + statusFunc + "'");
        }
        ...
        if (jPesNomeColaborador.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM SOLICITANTE_REQUISICAO_MEDICAMENTOS_ENFAR "
                        + "INNER JOIN DEPARTAMENTOS "
                        + "ON SOLICITANTE_REQUISICAO_MEDICAMENTOS_ENFAR.IdDepartamento=DEPARTAMENTOS.IdDepartamento "
                        + "WHERE NomeSolicitante='" + jPesNomeColaborador.getText() + "'");
                conecta.rs.first();
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {            
            this.preencherTabela("SELECT * FROM SOLICITANTE_REQUISICAO_MEDICAMENTOS_ENFAR "
                    + "INNER JOIN DEPARTAMENTOS "
                    + "ON SOLICITANTE_REQUISICAO_MEDICAMENTOS_ENFAR.IdDepartamento=DEPARTAMENTOS.IdDepartamento "
                    + "WHERE StatusSolici='" + statusFunc + "'");
        } else {
            limparTabelaColaborador();
        }
    ...
    public void preencherTabela(String sql) {
        ...
        try {
            ...
            conecta.rs.first();
            do {
                dados.add(new Object[]{conecta.rs.getInt("IdFuncSolici"), conecta.rs.getString("NomeSolicitante"), conecta.rs.getString("NomeDepartamento"), conecta.rs.getString("Cargo")});
        ...
        jTabelaColabrador.getColumnModel().getColumn(1).setPreferredWidth(280);
        jTabelaColabrador.getColumnModel().getColumn(1).setResizable(false);
        jTabelaColabrador.getColumnModel().getColumn(2).setPreferredWidth(220);
        ...
        alinhaCamposTabelaColaborador();
        conecta.desconecta();
    }

    public void alinhaCamposTabelaColaborador() {
    ...
    public void limparTabelaColaborador() {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Código", "Nome Colaborador", "Departamento", "Cargo "};
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaColabrador.setModel(modelo);
