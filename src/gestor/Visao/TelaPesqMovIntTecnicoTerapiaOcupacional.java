...
import static gestor.Visao.TelaMovHistoricoTecTerapiaOcupacional.jDataNascimento;
import static gestor.Visao.TelaMovHistoricoTecTerapiaOcupacional.jDataPena;
import static gestor.Visao.TelaMovHistoricoTecTerapiaOcupacional.jFotoInterno;
import static gestor.Visao.TelaMovHistoricoTecTerapiaOcupacional.jIdInterno;
import static gestor.Visao.TelaMovHistoricoTecTerapiaOcupacional.jMatriculaPenalInterno;
import static gestor.Visao.TelaMovHistoricoTecTerapiaOcupacional.jNomeInterno;
import static gestor.Visao.TelaMovHistoricoTecTerapiaOcupacional.jRegime;
import static gestor.Visao.TelaMovHistoricoTecTerapiaOcupacional.jTabelaMovimentacao;
import static gestor.Visao.TelaMovHistoricoTecTerapiaOcupacional.jUnidadePenal;
 ...
 * @author Ronaldo
 */
public class TelaPesqMovIntTecnicoTerapiaOcupacional extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqMovIntTecnicoTerapiaOcupacional() {
        initComponents();
    }
    ...
    private void jBtMatriculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtMatriculaActionPerformed
        ...
        if (jPesqMatricula.getText().equals("")) {
            ...
            buscarInternosMatricula("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "AND SituacaoCrc='" + situacaoEnt + "' "
                    + "OR MatriculaCrc LIKE'" + jPesqMatricula.getText() + "'AND SituacaoCrc='" + situacaoRet + "'");
        }
