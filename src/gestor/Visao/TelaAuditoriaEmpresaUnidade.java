...
import static gestor.Visao.TelaEmpresa.jIdEmpresa;
import static gestor.Visao.TelaEmpresa.jIdUnidade;
...
public class TelaAuditoriaEmpresaUnidade extends javax.swing.JInternalFrame {
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM UNIDADE_PENAL_EMPRESA WHERE IdUnidEmp='" + jIdUnidade.getText() + "'AND IdEmpresa='" + jIdEmpresa.getText() + "'");
            conecta.rs.first();
