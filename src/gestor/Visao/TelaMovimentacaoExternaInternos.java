 ...
 * @author user
 */
public class TelaMovimentacaoExternaInternos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaMovimentacaoExternaInternos() {
        initComponents();
        corCampos();
    }
    ...
    private void jBtPesquisarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarInternoActionPerformed
        // Pesquisar Internos
        TelaPesquisaMovExternaInterno objTelaMovInt = new TelaPesquisaMovExternaInterno();
        TelaModuloEnfermaria.jPainelMedico.add(objTelaMovInt);
        objTelaMovInt.show();
        ...
        if (jNomeInterno.getText().equals("")) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                        ...
                        + "WHERE PRONTUARIOSCRC.NomeInternoCrc='" + jNomeInterno.getText() + "'AND PRONTUARIOSCRC.IdInternoCrc='" + idInt + "'");
                conecta.rs.first();
