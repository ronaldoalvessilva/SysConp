...
import gestor.Dao.*;
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidade.jFotoVeiculoUnidade;
...
import static gestor.Visao.TelaEntradaSaidaVeiculosUnidade.jPlacaVeiculo;
 ...
 * @author user
 */
public class TelaPesqVeiculosUnidade extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqVeiculosUnidade() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jBtPlacaVeiculo, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jTabelaPesqVeiculos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Modelo de Veiculo", "Placa"
            }
        ));
    ...
    private void jTabelaPesqVeiculosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaPesqVeiculosMouseClicked
        ...
        if (flag == 1 && evt.getClickCount() == 1) {
            ...
            jPesqModeloVeiculo.setText(modeloVeiculo);
            //
            idVeiculo = "" + jTabelaPesqVeiculos.getValueAt(jTabelaPesqVeiculos.getSelectedRow(), 0);
        }
