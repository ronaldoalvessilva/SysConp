...
import static gestor.Visao.TelaCalendarioVacinasInternos.jCodRegistro;
import static gestor.Visao.TelaCalendarioVacinasInternos.jRegistroVacina;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensVacina extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensVacina() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Itens Vacina :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_CARTILHA_VACINAS_INTERNOS WHERE IdCart='" + jCodRegistro.getText() + "'AND IdItemCart='" + jRegistroVacina.getText()   + "'");
            conecta.rs.first();
