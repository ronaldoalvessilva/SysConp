 ...
 * @author Ronaldo
 */
public class TelaPesquisaCargoFunc extends javax.swing.JInternalFrame {
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesNomeCargo.getText().equals("")) {
            ...
            preencherTabela("SELECT * FROM CARGOS WHERE NomeCargo LIKE'" + jPesNomeCargo.getText() + "%'AND StatusCargo='" + statusCargo + "'");
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        TelaFuncionarios.jNomeCargo.setText(jPesNomeCargo.getText());
        dispose();
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {            
            this.preencherTabela("SELECT * FROM CARGOS WHERE StatusCargo='" + statusCargo + "'ORDER BY NomeCargo");
        } else {
           limparCampos();
        }
    ...
    public void preencherTabela(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Nome do Cargo"};
