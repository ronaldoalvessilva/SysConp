...
public class TelaAdmissaoMedica extends javax.swing.JInternalFrame {
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        buscarAcessoUsuario();
        if (codigoUser == codUserAcesso && nomeTela.equals(telaAcessoProntuarioMedicoENF) && codIncluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        if (codigoUser == codUserAcesso && nomeTela.equals(telaAcessoProntuarioMedicoENF) && codAlterar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        if (codigoUser == codUserAcesso && nomeTela.equals(telaAcessoProntuarioMedicoENF) && codExcluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            atendido = "Não";
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:  
        if (codigoUser == codUserAcesso && nomeTela.equals(telaAcessoProntuarioMedicoENF) && codGravar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            verificarEvolucaoPsiquiatrica(); // VERIFICAR SE EXISTE EVOLUÇÃO PSICOLOGICA ANTES DE EXCLUIR
            verificarEvolucaoMedica(); // VERIFICAR SE EXISTE EVOLUÇÃO MÉDICA ANTES DE EXCLUIR
            verificarPrescricaoMedica(); // VERIFICAR SE EXISTE PRESCRIÇÃO MÉDICA/PSICOLOGICA ANTES DE EXCLUIR
            verificarAtestadoMedico(); // VERIFICAR SE EXISTE ATESTADO
    ...
    private void jBtNovaEvolPsiquiatricaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovaEvolPsiquiatricaActionPerformed
        ...
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela2) && codIncluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
    ...
    private void jBtAlterarEvolPsiquiatricaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarEvolPsiquiatricaActionPerformed
        // TODO add your handling code here: 
        buscarAcessoUsuarioPsiquiatra();
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela2) && codAlterar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            conecta.abrirConexao();
            try {
    ...
    private void jBtExcluirEvolPsiquiatricaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirEvolPsiquiatricaActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuarioPsiquiatra();
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela2) && codExcluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            conecta.abrirConexao();
    ...
    private void jBtSalvarEvolPsiquiatricaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarEvolPsiquiatricaActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuarioPsiquiatra();
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela2) && codGravar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
    ...
    private void jBtNovaEvolucaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovaEvolucaoActionPerformed
        ...
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela3) && codIncluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            if (atendido.equals("Sim") && jIdAdm.getText().equals(codigoAtend) && jIdInternoAdm.getText().equals(codigoInternoAtend)) {
                JOptionPane.showMessageDialog(rootPane, "É necessário fazer o registro do interno para ser atendido.");
            } else {
                acao = 5;
    ...
    private void jBtAlterarEvolucaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarEvolucaoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuarioMedicoClinico();
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela3) && codAlterar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            conecta.abrirConexao();
            try {
    ...
    private void jBtExcluirEvolucaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirEvolucaoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuarioMedicoClinico();
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela3) && codExcluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            conecta.abrirConexao();
    ...
    private void jBtSalvarEvolucaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarEvolucaoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuarioMedicoClinico();
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela3) && codGravar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
    ...
    private void jBtNovaPrescicaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovaPrescicaoActionPerformed
        ...
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela4) && codIncluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            acao = 7;
            NovaPrescricao();
            statusMov = "Incluiu";
            horaMov = jHoraSistema.getText();
    ...
    private void jBtAlterarPrescicaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarPrescicaoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuarioPrescricao();
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela4) && codAlterar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            conecta.abrirConexao();
            try {
    ...
    private void jBtExcluirPrescicaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirPrescicaoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuarioPrescricao();
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela4) && codExcluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            conecta.abrirConexao();
    ...
    private void jBtSalvarPrescicaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarPrescicaoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuarioPrescricao();
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela4) && codGravar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
    ...
    private void jBtNovoAtestadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoAtestadoActionPerformed
        ...
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela5) && codIncluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            statusMov = "Incluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            acao = 9;
    ...
    private void jBtAlterarAtestadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarAtestadoActionPerformed
        // TODO add your handling code here: 
        buscarAcessoUsuarioAtestado();
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela5) && codAlterar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            conecta.abrirConexao();
            try {
    ...
    private void jBtExcluirAtestadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirAtestadoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuarioAtestado();
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela5) && codExcluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            conecta.abrirConexao();
    ...
    private void jBtSalvarAtestadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarAtestadoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuarioAtestado();
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela5) && codGravar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
    ...
    private void jBtNovaDietaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovaDietaActionPerformed
        ...
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela6) && codIncluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            statusMov = "Incluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            acao = 11;
    ...
    private void jBtAlterarDietaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarDietaActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuarioDieta();
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela6) && codAlterar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            conecta.abrirConexao();
            try {
    ...
    private void jBtExcluirDietaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirDietaActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuarioDieta();
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela6) && codExcluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            conecta.abrirConexao();
    ...
    private void jBtSalvarDietaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarDietaActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuarioDieta();
        if (codigoUser == codUserAcesso && nomeTela.equals(nomeModuloTela6) && codGravar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
