...
import static gestor.Visao.TelaNovaEntradaPortariaCrc.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensNovaEntrada extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensNovaEntrada() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSNOVAENTRADA WHERE IdEntrada='" + jIdlanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
