 ...
 * @author Ronaldo
 */
public class TelaAuditoriaProfessores extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaProfessores() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Professores :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PROFESSORES WHERE IdProf='" + jIdProf.getText() + "'");
            conecta.rs.first();
