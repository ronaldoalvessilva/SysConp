...
import static gestor.Visao.TelaRequisicaoAvulsaAC.jCodReq;
import static gestor.Visao.TelaRequisicaoAvulsaAC.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRequiAvulsaAC extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRequiAvulsaAC() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS WHERE IdReq='" + jCodReq.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
