...
import static gestor.Visao.TelaConsultaLocalInternoBaseSeguranca.jIdInterno;
 ...
 * @author ronaldo
 */
public class TelaFotoLocalBaseInterno extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaConsultaLocalInternoBaseSeguranca telaLocalInterno;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoLocalBaseInterno(TelaConsultaLocalInternoBaseSeguranca parent, boolean modal) {
        this.telaLocalInterno = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaLocalInterno);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoLocalBaseInterno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoLocalBaseInterno dialog = new TelaFotoLocalBaseInterno(telaLocalInterno, true);
