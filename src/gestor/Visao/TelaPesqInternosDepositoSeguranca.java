...
import gestor.Dao.*;
import static gestor.Visao.TelaControleDepositoSeguranca.jFotoInternoDeposito;
 ...
 * @author user
 */
public class TelaPesqInternosDepositoSeguranca extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternosDepositoSeguranca() {
        initComponents();
    ...
    private void initComponents() {
        ...
        if (jTabelaPesqInternosRol.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaPesqInternosRol.getColumnModel().getColumn(1).setMinWidth(330);
            jTabelaPesqInternosRol.getColumnModel().getColumn(1).setMaxWidth(330);
        }
