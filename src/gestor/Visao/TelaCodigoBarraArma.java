...
import static gestor.Visao.TelaArmas.caminho;
import static gestor.Visao.TelaArmas.jCodigoBarraArma;
 ...
 */
public class TelaCodigoBarraArma extends javax.swing.JDialog {
     ...
     */
    public static TelaArmas pTELA_armas;

    public TelaCodigoBarraArma(TelaArmas parent, boolean modal) {
        this.pTELA_armas = parent;
        this.setModal(modal);
        setLocationRelativeTo(pTELA_armas);
        initComponents();
        corCampos();
        pBUSCAR_DADOS_banco();
    }
    ...
    private void jBtGerarCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtGerarCodigoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaArmasCODIGO_barras) && objCampos.getCodigoIncluir() == 1) {
            acao = 1;
            Novo();
            statusMov = "Inclui";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            pGERAR_CODIGO_barra(jSerieArma.getText());
        } else {
    ...
    private void jBtAlterarCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarCodigoActionPerformed
        ...
        pPESQUISAR_acessos.pesquisarGrupoUsuario(objCampos);
        pPESQUISAR_acessos.pesquisarTelasAcesso(objCampos);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaArmasCODIGO_barras) && objCampos.getCodigoAlterar() == 1) {
            acao = 2;
            pBUSCAR_dados();
            Alterar();
            statusMov = "Alterou";
    ...
    private void jBtExcluirCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirCodigoActionPerformed
        ...
        pPESQUISAR_acessos.pesquisarGrupoUsuario(objCampos);
        pPESQUISAR_acessos.pesquisarTelasAcesso(objCampos);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaArmasCODIGO_barras) && objCampos.getCodigoExcluir() == 1) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                CONTROL.excluirCODIGO_barra(objArma);
                objLog();
    ...
    private void jBtSalvarCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarCodigoActionPerformed
        ...
        pPESQUISAR_acessos.pesquisarGrupoUsuario(objCampos);
        pPESQUISAR_acessos.pesquisarTelasAcesso(objCampos);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaArmasCODIGO_barras) && objCampos.getCodigoGravar() == 1) {
            if (jCODIGO_barras.getText().equals("")) {
                ...
                if (acao == 2) {
                    objArma.setIdArma(Integer.valueOf(jIdArma.getText()));
                    CONTROL.alterarCODIGO_barra(objArma);
                    objLog();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    Salvar();
                    if (pRESPOSTA_codigo.equals("Sim")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCodigoBarraArma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaCodigoBarraArma dialog = new TelaCodigoBarraArma(pTELA_armas, true);
    ...
    public void pBUSCAR_dados() {
        jCODIGO_barras.setText(jIdArma.getText());
        jNUMERO_serie.setText(jSerieArma.getText());
        jDESCRICAO_arma.setText(jDescricaoArma.getText());
    }
    ...
    public void pBUSCAR_codigo() {
        CONTROL.pBUSCAR_CODIGO_barra(objArma);
    }

    public void pBUSCAR_DADOS_banco() {
        try {
            for (Arma cc : CONTROL.pPESQUISAR_CODIGO_barras_read()) {
                jCODIGO_barras.setText(String.valueOf(cc.getIdArma()));
                jNUMERO_serie.setText(cc.getSerieArma());
    ...
    public void pGERAR_CODIGO_barra(String value) {
        ...
        try {
            ...
            //
            ImageIcon imagemicon1 = new ImageIcon(new ImageIcon(caminho).getImage().getScaledInstance(jCodigoBarraArma.getWidth(), jCodigoBarraArma.getHeight(), Image.SCALE_SMOOTH));
            jCodigoBarraArma.setIcon(imagemicon1);
            try {
