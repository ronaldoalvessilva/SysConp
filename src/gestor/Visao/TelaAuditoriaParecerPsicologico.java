...
import static gestor.Visao.TelaAdmissaoPsicologica.jCodigoParecer;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaParecerPsicologico extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaParecerPsicologico() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Parecer Psicologico de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PARECER_PSI WHERE IdLanc='" + jIdLanc.getText() + "'AND IdParecer='" + jCodigoParecer.getText() + "'");
            conecta.rs.first();
