...
import static gestor.Visao.TelaSaidaInterno.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensSaidasInternos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensSaidasInternos() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSSAIDA WHERE IdSaida='" + jIDlanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
