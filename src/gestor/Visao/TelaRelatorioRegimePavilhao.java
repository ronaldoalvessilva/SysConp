 ...
 * @author ronaldo
 */
public class TelaRelatorioRegimePavilhao extends javax.swing.JInternalFrame {
     ...
     */
    public TelaRelatorioRegimePavilhao() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBoxRegimePenal = new javax.swing.JComboBox();
        ...
        jCombBoxDescricaoPavilhao.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecione..." }));
        ...
        jLabel2.setText("Regime Penal:");

        jComboBoxRegimePenal.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jComboBoxRegimePenal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecione...", "Fechado", "Semi-Aberto", "Provisório", "Aberto" }));
        jComboBoxRegimePenal.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jComboBoxRegimePenal, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(20, 20, 20))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel2)
                    .addComponent(jComboBoxRegimePenal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        setBounds(350, 100, 445, 192);
    }// </editor-fold>//GEN-END:initComponents

    private void jBtConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtConfirmarActionPerformed
        // TODO add your handling code here:
        if (jCombBoxDescricaoPavilhao.getSelectedItem() == null || jCombBoxDescricaoPavilhao.getSelectedItem().equals("Selecione...")) {
            JOptionPane.showMessageDialog(rootPane, "Informe o nome do pavilhão para listar o confere.");
        } else if (jComboBoxRegimePenal.getSelectedItem() == null || jComboBoxRegimePenal.getSelectedItem().equals("Selecione...")) {
            JOptionPane.showMessageDialog(rootPane, "Informe o regime do interno.");
        } else {
            try {
                ...
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                        ...
                        + "WHERE DADOSPENAISINTERNOS.Regime='" + jComboBoxRegimePenal.getSelectedItem() + "' "
                        + "AND PAVILHAO.DescricaoPav='" + jCombBoxDescricaoPavilhao.getSelectedItem() + "' "
                        + "AND PRONTUARIOSCRC.SituacaoCrc='" + situacaoEnt + "' "
                        + "OR DADOSPENAISINTERNOS.Regime='" + jComboBoxRegimePenal.getSelectedItem() + "' "
                        + "AND PAVILHAO.DescricaoPav='" + jCombBoxDescricaoPavilhao.getSelectedItem() + "' "
                ...
                jv.setTitle("Listagem de Internos Por Regime Penal e Pavilhão");
    ...
    private javax.swing.JComboBox jComboBoxRegimePenal;
