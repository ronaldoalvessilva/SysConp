 ...
 * @author Ronaldo
 */
public class TelaAuditoriaInventarioAcervo extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaInventarioAcervo() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Inventários :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM INVENTARIO_LIVROS WHERE IdLanc='" + jIdLanc.getText() + "'");
            conecta.rs.first();
