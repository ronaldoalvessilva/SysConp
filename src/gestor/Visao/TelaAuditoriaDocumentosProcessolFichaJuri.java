...
import static gestor.Visao.TelaFichaJuridica.codProdDoc;
import static gestor.Visao.TelaFichaJuridica.jIdFicha;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaDocumentosProcessolFichaJuri extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaDocumentosProcessolFichaJuri() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Documentos Processo :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM DOCUMENTOS_PROCESSO WHERE IdFicha='" + jIdFicha.getText() + "'AND IdDocPro='" + codProdDoc + "'");
            conecta.rs.first();
