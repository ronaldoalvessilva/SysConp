...
import static gestor.Visao.TelaSolicitacaoComprasMateriaisNUTRI.jIdSol;
import static gestor.Visao.TelaSolicitacaoComprasMateriaisNUTRI.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensSolicitacaoNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensSolicitacaoNUTRI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_SOLICITACAO_PRODUTOS_NUTRI WHERE IdSol='" + jIdSol.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
