 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_PART_SS extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_PART_SS() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_SS "
                    + "WHERE IdItemPartSS='" + pCODIGO_ITEM_PARTICIPANTE + "' "
                    + "AND IdAtGrupoSS='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
