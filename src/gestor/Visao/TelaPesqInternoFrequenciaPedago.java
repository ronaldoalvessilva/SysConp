...
import static gestor.Visao.TelaControleFrequencia.jIdInternoCrc;
import static gestor.Visao.TelaControleFrequencia.jIdMatricula;
import static gestor.Visao.TelaControleFrequencia.jNomeInternoCrc;
 ...
 * @author Ronaldo
 */
public class TelaPesqInternoFrequenciaPedago extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoFrequenciaPedago() {
        initComponents();
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTodosInternos("SELECT * FROM ITENSMATRICULA "
                    ...
                    + "WHERE NomeInternoCrc LIKE'" + jPesqNome.getText() + "%'AND IdMat='" + jIdMatricula.getText() + "'AND Bloqueio='" + bloqueio + "'");
        }
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {            
            this.preencherTodosInternos("SELECT * FROM ITENSMATRICULA "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ITENSMATRICULA.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc WHERE IdMat='" + jIdMatricula.getText() + "'AND Bloqueio='" + bloqueio + "'");
        } else {
            limparTabela();
        }
