 ...
 * @author Ronaldo
 */
public class TelaPesqAdvogadoInternoAtestadoCRC extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqAdvogadoInternoAtestadoCRC() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Pesquisa de Advogados :::...");
        ...
        jTabelaAdvogados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Registro", "Código", "Nome do Advogado", "Código", "Nome do Interno"
            }
        ));
        ...
        if (jTabelaAdvogados.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaAdvogados.getColumnModel().getColumn(1).setMinWidth(60);
            jTabelaAdvogados.getColumnModel().getColumn(1).setMaxWidth(60);
            jTabelaAdvogados.getColumnModel().getColumn(2).setMinWidth(320);
            jTabelaAdvogados.getColumnModel().getColumn(2).setMaxWidth(320);
            jTabelaAdvogados.getColumnModel().getColumn(3).setMinWidth(60);
            jTabelaAdvogados.getColumnModel().getColumn(3).setMaxWidth(60);
            jTabelaAdvogados.getColumnModel().getColumn(4).setMinWidth(320);
            jTabelaAdvogados.getColumnModel().getColumn(4).setMaxWidth(320);
        }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            pesquisarVisitasRol("SELECT * FROM SOLICITACAO_ATESTADO_RECLUSAO_CRC "
                    ...
                    + "ON ADVOGADOS.IdAdvogado=SOLICITACAO_ATESTADO_RECLUSAO_CRC.IdVisita "
    ...
    private void jTabelaAdvogadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaAdvogadosMouseClicked
        ...
        if (flag == 1 && evt.getClickCount() == 1) {
            nomeVisita = "" + jTabelaAdvogados.getValueAt(jTabelaAdvogados.getSelectedRow(), 2);
            jPesqNome.setText(nomeVisita);
            idInt = "" + jTabelaAdvogados.getValueAt(jTabelaAdvogados.getSelectedRow(), 1);
        }
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM SOLICITACAO_ATESTADO_RECLUSAO_CRC "
                        ...
                        + "INNER JOIN DADOSPENAISINTERNOS "
                        + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
                        + "WHERE ADVOGADOS.NomeAdvogado='" + nomeVisita + "' "
                        + "AND ADVOGADOS.IdAdvogado='" + idInt + "' ");
                conecta.rs.first();
                codigoSoliAtestado = conecta.rs.getInt("CodRegAux");
                jIdVisitaAtestado.setText(String.valueOf(conecta.rs.getInt("IdAdvogado")));
  ...
  // Método de pesquisa pela Descrição
    ...
    public void pesquisarVisitasRol(String sql) {
        ...
        String[] Colunas = new String[]{"Registro", "Código", "Nome do Advogado", "Código", "Nome do Interno"};
        conecta.abrirConexao();
        try {
            conecta.executaSQL(sql);
            conecta.rs.first();
            do {
                dados.add(new Object[]{conecta.rs.getInt("CodRegAux"), conecta.rs.getInt("IdVisita"), conecta.rs.getString("NomeAdvogado"), conecta.rs.getInt("IdInternoCrc"), conecta.rs.getString("NomeInternoCrc")});
        ...
        jTabelaAdvogados.getColumnModel().getColumn(1).setPreferredWidth(60);
        jTabelaAdvogados.getColumnModel().getColumn(1).setResizable(false);
        jTabelaAdvogados.getColumnModel().getColumn(2).setPreferredWidth(320);
        jTabelaAdvogados.getColumnModel().getColumn(2).setResizable(false);
        jTabelaAdvogados.getColumnModel().getColumn(3).setPreferredWidth(60);
        jTabelaAdvogados.getColumnModel().getColumn(3).setResizable(false);
        jTabelaAdvogados.getColumnModel().getColumn(4).setPreferredWidth(320);
