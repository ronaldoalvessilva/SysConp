 ...
 * @author ronaldo
 */
public class TelaFotoLocacaoInternoBGP extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaLocacaoInternoBGP telaLocacaoInternoBGP;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoLocacaoInternoBGP(TelaLocacaoInternoBGP parent, boolean modal) {
        this.telaLocacaoInternoBGP = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaLocacaoInternoBGP);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoLocacaoInternoBGP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoLocacaoInternoBGP dialog = new TelaFotoLocacaoInternoBGP(telaLocacaoInternoBGP, true);
