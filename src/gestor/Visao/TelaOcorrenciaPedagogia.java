...
import gestor.Controle.ControleOcorrrenciaPedagogia;
 ...
 * @author ronaldo
 */
public class TelaOcorrenciaPedagogia extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    OcorrenciasPedagogia objOcorr = new OcorrenciasPedagogia();
    ControleOcorrrenciaPedagogia control = new ControleOcorrrenciaPedagogia();
    ...
    String nomeModuloTela = "Pedagogia:Movimentação:Ocorrências Diárias:Manutenção";
    String horaMov;
    String dataModFinal;
     ...
     */
    public TelaOcorrenciaPedagogia() {
        initComponents();
        corCampos();
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaLivroOcorrenciaManu_PEDA) && codIncluirPEDA == 1) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaLivroOcorrenciaManu_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaLivroOcorrenciaManu_PEDA) && codAlterarPEDA == 1) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaLivroOcorrenciaManu_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaLivroOcorrenciaManu_PEDA) && codExcluirPEDA == 1) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            objOcorr.setStatusLanc(jStatusOcorrencia.getText());
            if (jStatusOcorrencia.getText().equals("FINALIZADO")) {
                ...
                if (resposta == JOptionPane.YES_OPTION) {
                    ...
                    control.excluirOcorrenciaPedagogia(objOcorr);
                    objLog();
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaLivroOcorrenciaManu_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaLivroOcorrenciaManu_PEDA) && codGravarPEDA == 1) {
            if (jDataOcorrencia.getDate() == null) {
                ...
                if (jTituloOcorrencia.getText().equals("")) {
                    ...
                    if (acao == 1) {
                        control.incluirOcorrenciaPedagogia(objOcorr);
                        buscarID();
                        Salvar();
                        objLog();
                        controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    ...
                    if (acao == 2) {
                        ...
                        control.alterarOcorrenciaPedagogia(objOcorr);
                        Salvar();
                        objLog();
                        controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                        JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        try {
            conecta.executaSQL("SELECT * FROM OCORRENCIAS_PE WHERE IdLanc='" + jIdOcorrencia.getText() + "'");
            conecta.rs.first();
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            ...
            this.pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_PE");
        } else {
            jTabelaOcorrenciaPortaria.setVisible(!true);
        }
    ...
    private void jBtPesqTituloOcorrrenciaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtPesqTituloOcorrrenciaMouseClicked
        ...
        if (jPesqTituloOcorrencia.getText().equals("")) {
            ...
            jTabelaOcorrenciaPortaria.setVisible(true);
            pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_PE WHERE WHERE Titulo LIKE'" + jPesqTituloOcorrencia + "%'");
        }
    ...
    private void jTabelaOcorrenciaPortariaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaOcorrenciaPortariaMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM OCORRENCIAS_PE WHERE IdLanc ='" + IdLanc + "'");
                conecta.rs.first();
    ...
    public void Finalizar() {
        ...
        if (resposta == JOptionPane.YES_OPTION) {
            objOcorr.setStatusLanc(statusEntrada);
            objOcorr.setIdLanc(Integer.parseInt(jIdOcorrencia.getText()));
            control.finalizarOcorrenciaPedagogia(objOcorr);
            objLog();
            controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
    ...
    public void buscarID() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM OCORRENCIAS_PE");
            conecta.rs.last();
