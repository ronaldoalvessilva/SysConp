...
import static gestor.Visao.TelaRegistroObjetosProcedimentos.jDescricaoCela;
import static gestor.Visao.TelaRegistroObjetosProcedimentos.jIdCela;
import static gestor.Visao.TelaRegistroObjetosProcedimentos.jIdPav;
import static gestor.Visao.TelaRegistroObjetosProcedimentos.jTabelaInternos;
 ...
 * @author Ronaldo
 */
public class TelaPesqCelasProcedimento extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqCelasProcedimento() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (jTabelaCelas.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaCelas.getColumnModel().getColumn(1).setMaxWidth(140);
    ...
    private void jBtPesqDescricaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoActionPerformed
        ...
        if (jPesqDescricao.getText().equals("")) {
            ...
            preencherTabelaCelas("SELECT * FROM CELAS "
                    + "INNER JOIN PAVILHAO "
                    + "ON CELAS.IdPav=PAVILHAO.Idpav "
                    + "WHERE EndCelaPav LIKE'%" + jPesqDescricao.getText() + "%'AND PAVILHAO.IdPav='" + jIdPav.getText() + "'");
        }
