...
import static gestor.Visao.TelaAtividadesMensalUnidade.jChave;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAtividadesUnidade extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAtividadesUnidade() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATIVIDADES_UNIDADE WHERE IdAtividade='" + jChave.getText() + "'");
            conecta.rs.first();
