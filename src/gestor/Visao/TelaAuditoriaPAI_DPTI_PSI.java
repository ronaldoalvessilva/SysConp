 ...
 * @author Ronaldo
 */
public class TelaAuditoriaPAI_DPTI_PSI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaPAI_DPTI_PSI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM FICHA_CADASTRO_PAI_DPTL WHERE IdPai='" + jCodigoPAI.getText() + "'");
            conecta.rs.first();
