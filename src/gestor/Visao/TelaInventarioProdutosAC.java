...
import gestor.Controle.ControleItensInventarioEstoqueAC;
 ...
 * @author user
 */
public class TelaInventarioProdutosAC extends javax.swing.JInternalFrame {
    ...
    ControleInventarioEstoqueAC control = new ControleInventarioEstoqueAC();
    ControleItensInventarioEstoqueAC controle = new ControleItensInventarioEstoqueAC();
    //
    ...
    String nomeModuloTela = "Almoxarifado:Inventário de Produtos:Manutenção";
    String nomeModuloTela2 = "Almoxarifado:Inventário de Produtos:Contagem itens";
    String statusMov;
    String horaMov;
    String dataModFinal;
     ...
     */
    public TelaInventarioProdutosAC() {
        initComponents();
        formatarCampos();
        corCampos();
        corCamposItens();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Inventário de Estoque {AC} :::...");
    ...
    private void jBtIDPesqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtIDPesqActionPerformed
        ...
        if (jIDPesq.getText().equals("")) {
            ...
            preencherTabelaInventario("SELECT * FROM INVENTARIO_AC WHERE IdLanc='" + jIDPesq.getText() + "'");
        }
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM ITENS_INVENTARIO_AC "
                        ...
                        + "ON ITENS_INVENTARIO_AC.IdProd=PRODUTOS_AC.IdProd "
                        + "INNER JOIN LOCAL_ARMAZENAMENTO_AC "
                        + "ON ITENS_INVENTARIO_AC.IdLocal=LOCAL_ARMAZENAMENTO_AC.IdLocal "
    ...
    public void verificarTipoInventario() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM INVENTARIO_AC WHERE TipoInventario='" + jComboBoxTipoInventario.getSelectedItem() + "'");
            conecta.rs.first();
    ...
    public void verificarItemCadastrado() {
        ...
        try {
            ...
            codigoInventario = conecta.rs.getString("IdLanc");
        } catch (Exception e) {
        }
        conecta.desconecta();
    }
