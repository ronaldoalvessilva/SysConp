...
import static gestor.Visao.TelaRetornoMedico.jIDLanc;
import static gestor.Visao.TelaRetornoMedico.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRetornoMedico extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRetornoMedico() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSRETORNOMEDICO WHERE IdRetorno='" + jIDLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
