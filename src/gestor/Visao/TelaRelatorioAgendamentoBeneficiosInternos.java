 ...
 * @author Ronaldo
 */
public class TelaRelatorioAgendamentoBeneficiosInternos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaRelatorioAgendamentoBeneficiosInternos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Relatório Agendamento Benefícios :::...");
                ...
                if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                    ...
                    try {
                            ...
                            conecta.executaSQL("SELECT * FROM AGENDA_BENEFICIO_INTERNOS INNER "
                                    ...
                                    + "WHERE DataAg BETWEEN'" + dataInicial + "'AND'" + dataFinal + "' "
                                    + "ORDER BY AGENDA_BENEFICIO_INTERNOS.DataAg,PRONTUARIOSCRC.NomeInternoCrc");
