 ...
 * @author Ronaldo
 */
public class TelaPesquisaColabordorPortariaInterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaColabordorPortariaInterna() {
        initComponents();
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesNomeColaborador.getText().equals("")) {
            ...
            preencherTabela("SELECT * FROM COLABORADOR "
                    ...
                    + "WHERE COLABORADOR.NomeFunc LIKE'%" + jPesNomeColaborador.getText() + "%' "
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesNomeColaborador.getText().isEmpty()) {
            ...
            try {
                ...
                conecta.rs.first();
                jIdTransiente.setText(conecta.rs.getString("IdFunc"));
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabela("SELECT * FROM COLABORADOR "
                    ...
                    + "INNER JOIN CARGOS "
                    + "ON COLABORADOR.IdCargo=CARGOS.IdCargo "
                    + "WHERE COLABORADOR.StatusFunc='" + statusFunc + "'");
        } else {
