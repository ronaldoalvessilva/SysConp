...
import static gestor.Visao.TelaLocalEstoquePertences.jIdLocal;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaLocalPertences extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaLocalPertences() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Locais Pertences :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM LOCALPERTENCES WHERE IdLocal='" + jIdLocal.getText() + "'");
            conecta.rs.first();
