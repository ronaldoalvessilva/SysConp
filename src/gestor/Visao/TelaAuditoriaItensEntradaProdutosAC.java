...
import static gestor.Visao.TelaEntradaProdutosAC.jIdLanc;
import static gestor.Visao.TelaEntradaProdutosAC.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntradaProdutosAC extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEntradaProdutosAC() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_COMPRAS_MATERIAIS WHERE IdNfEntrada='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
