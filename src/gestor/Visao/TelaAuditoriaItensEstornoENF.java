...
import static gestor.Visao.TelaEstornoRequisicaoMateriaisENF.jIdEst;
import static gestor.Visao.TelaEstornoRequisicaoMateriaisENF.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEstornoENF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEstornoENF() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Itens Estorno :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF WHERE IdEst='" + jIdEst.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
