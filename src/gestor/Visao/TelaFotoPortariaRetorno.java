 ...
 * @author ronaldo
 */
public class TelaFotoPortariaRetorno extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaRegistroRetornoInternoPortaria telaretorno;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoPortariaRetorno(TelaRegistroRetornoInternoPortaria parent, boolean modal) {
        this.telaretorno = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaretorno);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoPortariaRetorno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoPortariaRetorno dialog = new TelaFotoPortariaRetorno(telaretorno, true);
