 ...
 * @author Ronaldo
 */
public class TelaAuditoriaTransferenciaColaboradores extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaTransferenciaColaboradores() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Entrada/Saida de Colaboradores :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ENTRADAS_SAIDAS_COLABORADORES WHERE IdRegRegistro='" + jIdRegistro.getText() + "'");
            conecta.rs.first();
