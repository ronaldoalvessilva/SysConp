 ...
 * @author Ronaldo
 */
public class TelaAuditoriaSolicitacaoComprasNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaSolicitacaoComprasNUTRI() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Solicitação Compras :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM SOLICITACAO_PRODUTOS_NUTRI WHERE IdSol='" + jIdSol.getText() + "'");
            conecta.rs.first();
