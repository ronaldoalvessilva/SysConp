 ...
 */
public class TelaTratamentoPsicologico_NOVO extends javax.swing.JDialog {
     ...
     */
    public static TelaNovaAdmissaoPSI pADM_NOVA_PSI;

    public TelaTratamentoPsicologico_NOVO(TelaNovaAdmissaoPSI parent, boolean modal) {
        this.pADM_NOVA_PSI = parent;
        this.setModal(modal);
        setLocationRelativeTo(pADM_NOVA_PSI);
        initComponents();
        formataCampos();
        corCampos();
        preencherTabelaTratamentos("SELECT * FROM TRATAMENTO_PSICOLOGICO WHERE IdInternoCrc='" + jIdInternoNovo.getText() + "'");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTratamentoPsicologico_NOVO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaTratamentoPsicologico_NOVO dialog = new TelaTratamentoPsicologico_NOVO(pADM_NOVA_PSI, true);
    ...
    public void popularComboBox() {
        ...
        try {
            ...
            Logger.getLogger(TelaTratamentoPsicologico_NOVO.class.getName()).log(Level.SEVERE, null, ex);
        }
//        TipoTratamentoPsicologico tipo = (TipoTratamentoPsicologico) jComboBoxTipoAtendimento.getSelectedItem();
//        tipo.getIdTipo();
//        tipo.getDescricaoTipo();
...
//        objTrata.setIdTipo(tipo.getIdTipo());
    ...
    public void Novo() {
        ...
        jBtCancelar.setEnabled(true);
        //
        jIdInternoTrata.setText(jIdInternoNovo.getText());
