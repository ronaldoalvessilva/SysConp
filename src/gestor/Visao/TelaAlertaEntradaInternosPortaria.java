 ...
 * @author Ronaldo
 */
public class TelaAlertaEntradaInternosPortaria extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAlertaEntradaInternosPortaria() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Alerta de Entrada de Internos na Portaria :::...");
        ...
        jTabelaEntradaInternosPortaria.setForeground(new java.awt.Color(255, 0, 0));
    ...
    public void preencherTabelaEntradasPortaria() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM ITENSENTRADAPORTARIA WHERE ConfirmaEntrada='" + confirmadoEntrada +"'");
            conecta.rs.first();
            do {               
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdItem"), conecta.rs.getString("NomeInternoCrc"), dataEntrada, conecta.rs.getString("HoraEntrada"), conecta.rs.getString("OficioInternos")});
