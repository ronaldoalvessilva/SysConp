...
import static gestor.Visao.TelaPortaEntradaTO.jIdADM_Principal;
 ...
 */
public class TelaAuditoriaAdmNovaTO extends javax.swing.JDialog {
     ...
     */
    public static TelaPortaEntradaTO pPORTA_ENTRADA_TO_MANU;

    public TelaAuditoriaAdmNovaTO(TelaPortaEntradaTO parent, boolean modal) {
        this.pPORTA_ENTRADA_TO_MANU = parent;
        this.setModal(modal);
        setLocationRelativeTo(pPORTA_ENTRADA_TO_MANU);
        initComponents();
        auditoria();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAuditoriaAdmNovaTO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAuditoriaAdmNovaTO dialog = new TelaAuditoriaAdmNovaTO(pPORTA_ENTRADA_TO_MANU, true);
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ADMISSAO_TERAPIA_PE "
                    + "WHERE ADMISSAO_TERAPIA_PE.IdATN='" + jIdAtendNovo.getText() + "' ");
            conecta.rs.first();
