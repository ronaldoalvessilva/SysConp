...
import static gestor.Visao.TelaAtendimentoGrupoPE.idItem;
 ...
 * @author user
 */
public class TelaLocalizarParticipantes_PE extends javax.swing.JInternalFrame {
     ...
     */
    public TelaLocalizarParticipantes_PE() {
        initComponents();
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_PE "
                        ...
                        + "AND PARTICIPANTES_ATENDIMENTO_GRUPO_PE.IdAtGrupoPE='" + jCodigoAtend.getText() + "'");
                conecta.rs.first();
                // Tabela Funcionarios
                ...
                //
                idItem = conecta.rs.getString("IdItemPartPE");
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jNomeInternoCrc.getText().equals("")) {
            ...
            buscarInternos("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_PE "
                    + "INNER JOIN PRONTUARIOSCRC "
...
//Preencher tabela com todos os INTERNOS
    public void buscarInternos(String sql) {
        ...
        try {
            ...
            conecta.rs.first();
            do {
                dados.add(new Object[]{conecta.rs.getInt("IdItemPartPE"), conecta.rs.getString("NomeInternoCrc"), conecta.rs.getString("MatriculaCrc"), conecta.rs.getString("Regime")});
