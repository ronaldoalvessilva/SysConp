 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_MANU_SS extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_MANU_SS() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATENDIMENTO_GRUPO_SS WHERE IdAtGrupoSS='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
