...
import static gestor.Visao.TelaRegistroSaidaInternosPortaria.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRegistroSaidasInternos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRegistroSaidasInternos() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Internas {P1}:::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSREGSAIDA WHERE IdSaida='" + jIDlanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
