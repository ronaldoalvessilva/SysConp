 ...
 * @author ronaldo
 */
public class TelaFotoCrcConsulta extends javax.swing.JDialog {
     ...
     */
    public TelaFotoCrcConsulta(TelaConsultaProntuarioInternoCrc parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoCrcConsulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoCrcConsulta dialog = new TelaFotoCrcConsulta(telaprontuariocrc, true);
