 ...
 * @author user
 */
public class TelaVisitaSocialReligiosa extends javax.swing.JInternalFrame {
     ...
     */
    public TelaVisitaSocialReligiosa() {
        initComponents();
        formatarCampos();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        jPanel8Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jBtAlterar, jBtExcluir, jBtSair, jBtSalvar});
        ...
        setBounds(250, 20, 534, 510);
    }// </editor-fold>//GEN-END:initComponents

    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaVisitantesRelSS);
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaVisitantesRelSS) && codIncluirSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaVisitantesRelSS);
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaVisitantesRelSS) && codAlterarSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
            acao = 2;
            Alterar();
            corCampos();
            statusMov = "Alterou";
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:  
        buscarAcessoUsuario(telaVisitantesRelSS);
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaVisitantesRelSS) && codExcluirSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
            JOptionPane.showMessageDialog(rootPane, "Sendo construido.");
            buscarVisistaRol();
        } else {
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaVisitantesRelSS);
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaVisitantesRelSS) && codGravarSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
            if (jNomeVisita.getText().equals("")) {
                ...
                objVisita.setParentescoVisita(jReligiao.getText());
                ...
                try {
                    conecta.executaSQL("SELECT * FROM VISITAS_RELIGIOSA_INTERNOS "
                            + "WHERE NomeVisitaRel='" + jNomeVisita.getText() + "'");
                    conecta.rs.first();
                    nomeVisitaInterno = conecta.rs.getString("NomeVisitaRel");
    ...
    private void jBTPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBTPesqNomeActionPerformed
        ...
        if (jPesqNomeVisita.getText().equals("")) {
            ...
            preencherVisitasNome("SELECT * FROM VISITAS_RELIGIOSA_INTERNOS "
                    + "WHERE NomeVisitaRel LIKE'%" + jPesqNomeVisita.getText() + "%'");
        }
    ...
    private void jTabelaVisitasReligiosasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaVisitasReligiosasMouseClicked
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM VISITAS_RELIGIOSA_INTERNOS "
                        + "WHERE NomeVisitaRel='" + nomeVisita + "' "
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaVisitasSocialReligiosa objAudVisitaSocialRel = new TelaAuditoriaVisitasSocialReligiosa();
        TelaModuloServicoSocial.jPainelServicoSocial.add(objAudVisitaSocialRel);
        objAudVisitaSocialRel.show();
