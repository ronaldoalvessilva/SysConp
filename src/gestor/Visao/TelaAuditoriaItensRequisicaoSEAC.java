...
import static gestor.Visao.TelaRequisicaoMateriaisInternosSEAC.idItem;
import static gestor.Visao.TelaRequisicaoMateriaisInternosSEAC.jCodReq;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRequisicaoSEAC extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRequisicaoSEAC() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Itens Materiais Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_PRODUTOS_INTERNOS_SEAC WHERE IdReq='" + jCodReq.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
