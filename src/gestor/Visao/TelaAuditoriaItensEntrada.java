 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntrada extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEntrada() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSENTRADA WHERE IdEntrada='" + jIDLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
