...
import static gestor.Visao.TelaCursosDiversosTerapiaOcupacional.jIdLanc;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaCursosTO extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Cursos Diversos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM CURSOS WHERE IdCurso='" + jIdLanc.getText() + "'");
            conecta.rs.first();
