...
//    String dataDiaAtual;
    ...
    private void jBtNovoVisitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoVisitaActionPerformed
        ...
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaRolVisitantesRelVisitaSS) && codIncluirSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
            verificarDiasRol();
            objRol.setStatusRol(jStatusRol.getText());
            if (jStatusRol.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse Rol de Visitas não poderá ser alterado, o mesmo encontra-se FINALIZADO");
    ...
    private void jBtAlterarVisitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarVisitaActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaRolVisitantesRelVisitaSS);
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaRolVisitantesRelVisitaSS) && codAlterarSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
            verificarDiasRol();
            objRol.setStatusRol(jStatusRol.getText());
            if (jStatusRol.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse Rol de Visitas não poderá ser alterado, o mesmo encontra-se FINALIZADO");
    ...
    private void jBtExcluirVisitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirVisitaActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaRolVisitantesRelVisitaSS);
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaRolVisitantesRelVisitaSS) && codExcluirSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            objRol.setStatusRol(jStatusRol.getText());
    ...
    private void jBtSalvarVisitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarVisitaActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaRolVisitantesRelVisitaSS);
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaRolVisitantesRelVisitaSS) && codGravarSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
