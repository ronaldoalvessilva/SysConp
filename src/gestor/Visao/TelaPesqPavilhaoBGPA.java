...
import static gestor.Visao.TelaCelasBGPA.jPavilhao;
 ...
 * @author Ronaldo
 */
public class TelaPesqPavilhaoBGPA extends javax.swing.JInternalFrame {
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqNomePavilhao.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PAVILHAO WHERE DescricaoPav LIKE'" + jPesqNomePavilhao.getText() + "%'");
                conecta.rs.first();
    ...
    private void jBtDescricaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtDescricaoActionPerformed
        ...
        if (jPesqNomePavilhao.getText().equals("")) {
            ...
            preencherTabela("SELECT * FROM PAVILHAO "
                    ...
                    + "AND StatusPav='" + statusPavilhao + "'AND NivelPav='" + nivelPav + "'");
        }
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabela("SELECT * FROM PAVILHAO WHERE StatusPav='" + statusPavilhao + "'AND NivelPav='" + nivelPav + "'");
        } else {
            limparTabela();
        }
