 ...
 * @author user
 */
public class TelaPesqProdutoAprazamentoMedicamentos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoAprazamentoMedicamentos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Produtos {ENF} :::...");
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "AND ITENS_REQUISICAO_PRODUTOS_INTERNOS_ENF.IdReq='" + jIdReq.getText() + "' "
                    + "AND ITENS_REQUISICAO_PRODUTOS_INTERNOS_ENF.EstornoProduto='" + estornoProduto + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        }
        ...
        if (jPesqDescricaoProdutos.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRODUTOS_AC "
                        ...
                        + "INNER JOIN ITENS_REQUISICAO_PRODUTOS_INTERNOS_ENF "
                        + "ON PRODUTOS_AC.IdProd=ITENS_REQUISICAO_PRODUTOS_INTERNOS_ENF.IdProd "
                        + "WHERE PRODUTOS_AC.DescricaoProd='" + jPesqDescricaoProdutos.getText() + "'AND ITENS_REQUISICAO_PRODUTOS_INTERNOS_ENF.IdReq='" + idReq + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
                conecta.rs.first();
    ...
    private void jCheckBoxPesqTodosProdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosProdItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "INNER JOIN ITENS_REQUISICAO_PRODUTOS_INTERNOS_ENF "
                    + "ON PRODUTOS_AC.IdProd=ITENS_REQUISICAO_PRODUTOS_INTERNOS_ENF.IdProd "
                    + "WHERE ITENS_REQUISICAO_PRODUTOS_INTERNOS_ENF.IdReq='" + jIdReq.getText() + "' "
                    + "AND ITENS_REQUISICAO_PRODUTOS_INTERNOS_ENF.EstornoProduto='" + estornoProduto + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        } else {
            limparTabela();
        }
