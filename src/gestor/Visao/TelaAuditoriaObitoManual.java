...
import static gestor.Visao.TelaObitoInternoExterna.jIdLanc;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaObitoManual extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaObitoManual() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Óbito de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM OBITOS_INTERNOS_EXTERNO WHERE IdLanc='" + jIdLanc.getText() + "'");
            conecta.rs.first();
