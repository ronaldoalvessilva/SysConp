...
import static gestor.Visao.TelaEstornoDepositoSaqueAtivosInativos.jValorEstorno;
 ...
 * @author Ronaldo
 */
public class TelaPesqInternoEstorno extends javax.swing.JInternalFrame {
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTabelaNome("SELECT * FROM PRONTUARIOSCRC "
                    + "INNER JOIN DEPOSITO "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DEPOSITO.IdInternoCrc "
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                ...
                jIdRegistro.setText(conecta.rs.getString("IdLanc"));
                valorEstorno = conecta.rs.getFloat("ValorDeposito");
                DecimalFormat vde = new DecimalFormat("#,###0.00");
                String vlEstorno = vde.format(valorDeposito);
                jValorEstorno.setText(vlEstorno);
                //
    ...
    public void preencherTabelaNome(String sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdInternoCrc"), conecta.rs.getString("NomeInternoCrc"), conecta.rs.getString("IdLanc"), valorDepositoTela, dataCadastro});
