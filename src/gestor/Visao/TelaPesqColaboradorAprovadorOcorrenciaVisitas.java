...
import static gestor.Visao.TelaAprovadoresOcorrenciaVisitasInternosSeguranca.jCodigoColaborador;
import static gestor.Visao.TelaAprovadoresOcorrenciaVisitasInternosSeguranca.jNomeAprovador;
import static gestor.Visao.TelaAprovadoresOcorrenciaVisitasInternosSeguranca.jNomeGrupo;
 ...
 * @author user
 */
public class TelaPesqColaboradorAprovadorOcorrenciaVisitas extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqColaboradorAprovadorOcorrenciaVisitas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (jTabelaPesqFunc.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaPesqFunc.getColumnModel().getColumn(1).setMinWidth(350);
            jTabelaPesqFunc.getColumnModel().getColumn(1).setMaxWidth(350);
