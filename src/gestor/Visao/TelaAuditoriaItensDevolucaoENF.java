...
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.jIdDevo;
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensDevolucaoENF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensDevolucaoENF() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Itens Devolução :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_DEVOLUCAO_PRODUTOS_ENFERMARIA_ENFAR WHERE IdDevo='" + jIdDevo.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
