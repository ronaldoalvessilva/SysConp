...
import gestor.Controle.ControleFaltasIndisciplinarFO1;
import gestor.Controle.ControleLogSistema;
import gestor.Dao.ConexaoBancoDados;
import gestor.Modelo.FaltasIndisciplinarFO1;
import gestor.Modelo.LogSistema;
import static gestor.Visao.TelaEventoDisciplinar.jIdInternoAutor;
import static gestor.Visao.TelaEventoDisciplinar.jIdLanc;
import static gestor.Visao.TelaEventoDisciplinar.jNomeInternoAutor;
 ...
 * @author ronaldo
 */
public class TelaFaltasIndisciplinarFO1 extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    FaltasIndisciplinarFO1 objFaltas = new FaltasIndisciplinarFO1();
    ControleFaltasIndisciplinarFO1 control = new ControleFaltasIndisciplinarFO1();
    //
     ...
     */
    public static TelaEventoDisciplinar eventoDisciplinar;

    public TelaFaltasIndisciplinarFO1(TelaEventoDisciplinar parent, boolean modal) {
        eventoDisciplinar = parent;
        this.setModal(modal);
        setLocationRelativeTo(eventoDisciplinar);
        initComponents();
        buscarRegstro();
    }
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        ...
        if (resposta == JOptionPane.YES_OPTION) {
            objFaltas.setIdFaltaFO1(codigoFaltaFO1);
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        objFaltas.setIdLanc(Integer.valueOf(jIdLanc.getText()));
        objFaltas.setIdInternoCrc(Integer.valueOf(jIdInternoAutor.getText()));
        objFaltas.setNomeInternoCrc(jNomeInternoAutor.getText());
        if (acao == 1) {
            if (jIdLanc.getText().equals(codigoRegistro)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFaltasIndisciplinarFO1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFaltasIndisciplinarFO1 dialog = new TelaFaltasIndisciplinarFO1(eventoDisciplinar, true);
        ...
        if (codigoFaltaFO1 != 0) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM FALTAS_INDISCIPLINAR_INDIVIDUAL_INTERNOS "
                        ...
                        + "AND IdInternoCrc='" + jIdInternoAutor.getText() + "'");
                conecta.rs.first();
                codigoFaltaFO1 = conecta.rs.getInt("IdFaltaFO1");
    ...
    public void buscarRegstro() {
        ...
        conecta.desconecta();
        if (codigoFaltaFO1 != 0 && jStatusLanc.getText().equals("ABERTO")) {
            jBtNovo.setEnabled(true);
            jBtAlterar.setEnabled(true);
            jBtExcluir.setEnabled(true);
            jBtSalvar.setEnabled(!true);
        } else if (codigoFaltaFO1 != 0 && jStatusLanc.getText().equals("FINALIZADO")) {
            jBtNovo.setEnabled(!true);
            jBtAlterar.setEnabled(!true);
            jBtExcluir.setEnabled(!true);
            jBtSalvar.setEnabled(!true);
    ...
    public void objLog() {
        ...
        objLogSys.setIdLancMov(codigoFaltaFO1);
