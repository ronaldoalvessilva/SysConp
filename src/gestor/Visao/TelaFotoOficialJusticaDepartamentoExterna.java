 ...
 * @author ronaldo
 */
public class TelaFotoOficialJusticaDepartamentoExterna extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaEntradaSaidaOficialJusticaExterna telaEntradaOficialDeptoExt;
     ...
     * @param modal
     */
    public TelaFotoOficialJusticaDepartamentoExterna(TelaEntradaSaidaOficialJusticaExterna parent, boolean modal) {
        this.telaEntradaOficialDeptoExt = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaEntradaOficialDeptoExt);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoOficialJusticaDepartamentoExterna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoOficialJusticaDepartamentoExterna dialog = new TelaFotoOficialJusticaDepartamentoExterna(telaEntradaOficialDeptoExt, true);
