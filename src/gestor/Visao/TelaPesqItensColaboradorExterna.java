...
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.jBtAlterarFunc;
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.jBtCancelarFunc;
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.jBtExcluirFunc;
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.jBtNovoFunc;
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.jBtSalvarFunc;
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.jCargoFunc;
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.jDataEntrada;
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.jDataSaida;
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.jHorarioEntrada;
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.jHorarioSaida;
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.jIDFunc;
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.jIDlanc;
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.jNomeFuncionario;
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.jSetorFunc;
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.idItem;
import static gestor.Visao.TelaEntradaSaidaColaboradorExterna.jFotoColaborador;
 ...
 * @author user
 */
public class TelaPesqItensColaboradorExterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqItensColaboradorExterna() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jNomeColaborador, javax.swing.GroupLayout.PREFERRED_SIZE, 451, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        if (jTabelaPesqFunc.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaPesqFunc.getColumnModel().getColumn(4).setMinWidth(80);
            jTabelaPesqFunc.getColumnModel().getColumn(4).setMaxWidth(80);
            jTabelaPesqFunc.getColumnModel().getColumn(5).setMinWidth(70);
            jTabelaPesqFunc.getColumnModel().getColumn(5).setMaxWidth(70);
            jTabelaPesqFunc.getColumnModel().getColumn(6).setMinWidth(80);
            jTabelaPesqFunc.getColumnModel().getColumn(6).setMaxWidth(80);
            jTabelaPesqFunc.getColumnModel().getColumn(7).setMinWidth(70);
            jTabelaPesqFunc.getColumnModel().getColumn(7).setMaxWidth(70);
        }
...
//Preencher tabela com todos os COLABORADORES
    ...
    public void alinhaCamposTabelaItens() {
        ...
        jTabelaPesqFunc.getColumnModel().getColumn(2).setCellRenderer(centralizado);
        jTabelaPesqFunc.getColumnModel().getColumn(3).setCellRenderer(centralizado);
        jTabelaPesqFunc.getColumnModel().getColumn(4).setCellRenderer(centralizado);
        jTabelaPesqFunc.getColumnModel().getColumn(5).setCellRenderer(centralizado);
    }
