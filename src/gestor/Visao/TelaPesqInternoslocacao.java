...
import gestor.Dao.*;
import static gestor.Visao.TelaLocacaoInterno.idItem;
import static gestor.Visao.TelaLocacaoInterno.jBtNovoInterno;
import static gestor.Visao.TelaLocacaoInterno.jIDLocacao;
import static gestor.Visao.TelaLocacaoInterno.jBtAlterarInterno;
import static gestor.Visao.TelaLocacaoInterno.jBtBuscarInterno;
import static gestor.Visao.TelaLocacaoInterno.jBtCancelarInterno;
import static gestor.Visao.TelaLocacaoInterno.jBtExcluirInterno;
import static gestor.Visao.TelaLocacaoInterno.jBtSalvarInterno;
 ...
 * @author user
 */
public class TelaPesqInternoslocacao extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoslocacao() {
        initComponents();
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC INNER JOIN ITENSLOCACAOINTERNO ON PRONTUARIOSCRC.IdInternoCrc=ITENSLOCACAOINTERNO.IdInternoCrc INNER JOIN CELAS ON ITENSLOCACAOINTERNO.IdCela=CELAS.IdCela WHERE NomeInternoCrc='" + jPesqNomeInterno.getText() + "' AND IdLoca='" + jIDLocacao.getText() + "'");
                conecta.rs.first();
                // Tabela Funcionarios
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jPesqNomeInterno.getText().equals("")) {
            ...
            buscarInternos("SELECT * FROM PRONTUARIOSCRC INNER JOIN ITENSLOCACAOINTERNO ON PRONTUARIOSCRC.IdInternoCrc=ITENSLOCACAOINTERNO.IdInternoCrc INNER JOIN CELAS ON ITENSLOCACAOINTERNO.IdCela=CELAS.IdCela WHERE NomeInternoCrc LIKE'" + jPesqNomeInterno.getText() + "%' AND IdLoca='" + jIDLocacao.getText() + "'");
        }
...
//Preencher tabela com todos os INTERNOS
    public void buscarInternos(String sql) {
        ...
        String[] Colunas = new String[]{"ID", "    Nome Interno", " Cela"};
        conecta.abrirConexao();
        try {
            conecta.executaSQL(sql);
            conecta.rs.first();            
            do {
                dados.add(new Object[]{conecta.rs.getInt("IdInternoCrc"), conecta.rs.getString("NomeInternoCrc"), conecta.rs.getString("EndCelaPav")});
        ...
        jTabelaPesqInternos.getColumnModel().getColumn(1).setPreferredWidth(280);
