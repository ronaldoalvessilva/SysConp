 ...
 * @author ronaldo
 */
public class TelaFotoCrc extends javax.swing.JDialog {
     ...
     */
    public TelaFotoCrc(TelaProntuarioCrc parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoCrc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoCrc dialog = new TelaFotoCrc(telaprontuariocrc, true);
