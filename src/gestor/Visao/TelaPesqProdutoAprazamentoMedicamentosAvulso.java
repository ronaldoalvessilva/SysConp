 ...
 * @author user
 */
public class TelaPesqProdutoAprazamentoMedicamentosAvulso extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoAprazamentoMedicamentosAvulso() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Produtos  Requisição Avulsa {ENF} :::...");
        ...
        jTabelaProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Req.", "Código", "Descrição Produto", "Quant."
            }
        ));
        ...
        if (jTabelaProdutos.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaProdutos.getColumnModel().getColumn(2).setMinWidth(340);
            jTabelaProdutos.getColumnModel().getColumn(2).setMaxWidth(340);
            jTabelaProdutos.getColumnModel().getColumn(3).setMinWidth(60);
            jTabelaProdutos.getColumnModel().getColumn(3).setMaxWidth(60);
        }
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "AND ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF.IdReq='" + jIdReq.getText() + "' "
                    + "AND ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF.EstornoProduto='" + estornoProduto + "'AND PRODUTOS_AC.Modulo='" + modulo + "'AND ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF.TipoReq='" + tipoRequisicao + "'");
        }
        ...
        if (jPesqDescricaoProdutos.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRODUTOS_AC "
                        ...
                        + "INNER JOIN ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF "
                        + "ON PRODUTOS_AC.IdProd=ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF.IdProd "
                        + "WHERE PRODUTOS_AC.DescricaoProd='" + jPesqDescricaoProdutos.getText() + "'AND ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF.IdReq='" + idReq + "'AND ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF.TipoReq='" + tipoRequisicao + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
                conecta.rs.first();
                idReq = conecta.rs.getString("IdReq");
    ...
    private void jTabelaProdutosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaProdutosMouseClicked
        ...
        if (flag == 1) {
            ...
            idInt = "" + jTabelaProdutos.getValueAt(jTabelaProdutos.getSelectedRow(), 1);
            idReq = "" + jTabelaProdutos.getValueAt(jTabelaProdutos.getSelectedRow(), 0);
        }
    ...
    private void jCheckBoxPesqTodosProdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosProdItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "ON PRODUTOS_AC.IdProd=ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF.IdProd "
                    + "AND ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF.IdReq='" + jIdReq.getText() + "' "
                    + "WHERE ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF.EstornoProduto='" + estornoProduto + "'AND ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF.TipoReq='" + tipoRequisicao + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        } else {
            limparTabela();
        }
    ...
    public void preencherTabelaProdutos(String sql) {
        ...
        String[] Colunas = new String[]{"ID Req.", "Código", "Descrição Produto", "Quant."};
        conecta.abrirConexao();
        conecta.executaSQL(sql);
        try {
            conecta.rs.first();
            do {
                dados.add(new Object[]{conecta.rs.getInt("IdReq"), conecta.rs.getInt("IdProd"), conecta.rs.getString("DescricaoProd"), conecta.rs.getInt("QtdItem")});
        ...
        jTabelaProdutos.getColumnModel().getColumn(2).setPreferredWidth(340);
        jTabelaProdutos.getColumnModel().getColumn(2).setResizable(false);
        jTabelaProdutos.getColumnModel().getColumn(3).setPreferredWidth(60);
