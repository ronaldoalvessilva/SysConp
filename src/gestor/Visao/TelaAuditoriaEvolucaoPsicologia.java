 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEvolucaoPsicologia extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEvolucaoPsicologia() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Evolução Psicologia Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM EVOLUCAOPSICOLOGICA WHERE IdLanc='" + jIdLanc.getText() + "'AND IdEvolucao='" + jIdEvolucao.getText() + "'");
            conecta.rs.first();
