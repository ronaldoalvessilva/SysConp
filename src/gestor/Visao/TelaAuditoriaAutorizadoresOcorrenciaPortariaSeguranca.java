...
import static gestor.Visao.TelaAprovadoresOcorrenciaVisitasInternosSeguranca.jCodigo;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAutorizadoresOcorrenciaPortariaSeguranca extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAutorizadoresOcorrenciaPortariaSeguranca() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Aprovadores Ocorrência :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM APROVADORES_OCORRENCIA_PORTARIA WHERE IdAprova='" + jCodigo.getText() + "'");
            conecta.rs.first();
