...
import static gestor.Visao.TelaFrequenciaMensalInternosTO.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensFrequenciaLaborativaExterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensFrequenciaLaborativaExterna() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_FREQUENCIA_LABORATIVA_EXTERNA WHERE IdFreqLab='" + jIdFrequencia.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
