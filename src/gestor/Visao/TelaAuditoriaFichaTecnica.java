 ...
 * @author Ronaldo
 */
public class TelaAuditoriaFichaTecnica extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaFichaTecnica() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Ficha Técnica :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM FICHA_TECNICA_NUTRI WHERE IdFicha='" + jIdFicha.getText() + "'");
            conecta.rs.first();
