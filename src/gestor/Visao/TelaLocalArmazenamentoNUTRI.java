...
import gestor.Controle.ControleLocalArmazenamentoNUTRI;
 ...
 * @author user
 */
public class TelaLocalArmazenamentoNUTRI extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    LocalArmazenamento objLocalMaster = new LocalArmazenamento();
    ControleLocalArmazenamentoNUTRI control = new ControleLocalArmazenamentoNUTRI();
    //
    ControleLogSistema controlLog = new ControleLogSistema();
    LogSistema objLogSys = new LogSistema();
    // Variáveis para gravar o log
    String nomeModuloTela = "Nutrição:Local de Armazenamento:Manutenção";
    int acao, flag;
    String codLocal;
    int nivelLocalFar = 1;
    int nivelLocalEnf = 2;
     ...
     */
    public TelaLocalArmazenamentoNUTRI() {
        initComponents();
        formatarCampos();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Local Armazenamento {NUTRI} :::...");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addComponent(jPesqDescricaoLocal, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        if (jTabelaLocalArmazenamento.getColumnModel().getColumnCount() > 0) {
            jTabelaLocalArmazenamento.getColumnModel().getColumn(0).setMinWidth(50);
            jTabelaLocalArmazenamento.getColumnModel().getColumn(0).setMaxWidth(50);
            ...
            jTabelaLocalArmazenamento.getColumnModel().getColumn(2).setMinWidth(80);
            jTabelaLocalArmazenamento.getColumnModel().getColumn(2).setMaxWidth(80);
        }
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Localização", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(0, 0, 255))); // NOI18N
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jIDLocal, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jLabel1))
                            .addGap(81, 81, 81)
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jLabel2)
                                .addComponent(jComboBoxStatusLocal, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addComponent(jDescricaoLocal, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 318, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        // FALTA DEFINIR TAREFAS DE EXCLUSÃO DE LOCAIS
        verificarProduto();
        ...
        if (jComboBoxStatusLocal.getSelectedItem() == null) {
            ...
            if (jDescricaoLocal.getText().equals("")) {
                ...
                if (acao == 1) {
                    ...
                    control.incluirLocalMasterNUTRI(objLocalMaster);
                    buscarID();
                    objLog();
                ...
                if (acao == 2) {
                    ...
                    control.alterarLocalMasterNUTRI(objLocalMaster);
                    objLog();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
                    Salvar();
    ...
    private void jBtPesqDescicaoLocalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescicaoLocalActionPerformed
        ...
        if (jPesqDescricaoLocal.getText().equals("")) {
            ...
            preencherTabelaLocal("SELECT * FROM LOCAL_ARMAZENAMENTO_AC WHERE DescricaoLocal LIKE'%" + jPesqDescricaoLocal.getText() + "%'AND Modulo='" + modulo + "'");
        }
    ...
    private void jCheckBoxTodosLocaisItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosLocaisItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaLocal("SELECT * FROM LOCAL_ARMAZENAMENTO_AC WHERE Modulo='" + modulo + "'");
        } else {
            limparTabela();
        }
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaLocalArmazenamentoNUTRI objAudiNUTRI = new TelaAuditoriaLocalArmazenamentoNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objAudiNUTRI);
        objAudiNUTRI.show();
    ...
    public void verificarLocalArmazenamento() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM LOCAL_ARMAZENAMENTO_AC WHERE IdLocal='" + jIDLocal.getText() + "'");
            conecta.rs.first();
            nivelLocal = conecta.rs.getString("NivelLocal");
        } catch (SQLException ex) {
            Logger.getLogger(TelaLocalArmazenamentoNUTRI.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void preencherTabelaLocal(String sql) {
        ...
        jTabelaLocalArmazenamento.getColumnModel().getColumn(0).setPreferredWidth(50);
        ...
        jTabelaLocalArmazenamento.getColumnModel().getColumn(2).setPreferredWidth(80);
    ...
    public void verificarProduto() {
        ...
        if (jIDLocal.getText() == null ? codLocal == null : jIDLocal.getText().equals(codLocal)) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                objLocalMaster.setIdLocal(Integer.valueOf(jIDLocal.getText()));
                control.excluirLocalMasterNUTRI(objLocalMaster);
