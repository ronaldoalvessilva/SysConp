 ...
 * @author Ronaldo
 */
public class TelaAuditoriaTransportadora extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaTransportadora() {
        initComponents();
        auditoria();      
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Transportadora :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM TRANSPORTADORA WHERE IdForn='" + jIdFornecedor.getText() + "'");
            conecta.rs.first();
