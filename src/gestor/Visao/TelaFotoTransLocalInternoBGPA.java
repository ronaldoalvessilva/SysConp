 ...
 * @author ronaldo
 */
public class TelaFotoTransLocalInternoBGPA extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaTransCelasBGPA telaTransLocalInternoBGPA;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoTransLocalInternoBGPA(TelaTransCelasBGPA parent, boolean modal) {
        this.telaTransLocalInternoBGPA = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaTransLocalInternoBGPA);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoTransLocalInternoBGPA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoTransLocalInternoBGPA dialog = new TelaFotoTransLocalInternoBGPA(telaTransLocalInternoBGPA, true);
