...
import static gestor.Visao.TelaRequisicaoAvulsaFAR.jCodReq;
import static gestor.Visao.TelaRequisicaoAvulsaFAR.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRequiAvulsaFAR extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRequiAvulsaFAR() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR WHERE IdReq='" + jCodReq.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
