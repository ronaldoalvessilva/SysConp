...
import static gestor.Visao.TelaInventarioProdutosMed.jLocalArmazenamento;
 ...
 * @author user
 */
public class TelaPesqLocalArmazenamento extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqLocalArmazenamento() {
        initComponents();
    }
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoLocal.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM LOCAL_ARMAZENAMENTO_AC WHERE DescricaoLocal LIKE'%" + jPesqDescricaoLocal.getText() + "%'AND LOCAL_ARMAZENAMENTO.Modulo='" + modulo + "'");
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqDescricaoLocal.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM LOCAL_ARMAZENAMENTO_AC WHERE LOCAL_ARMAZENAMENTO_AC.DescricaoLocal='" + jPesqDescricaoLocal.getText() + "'AND LOCAL_ARMAZENAMENTO_AC.Modulo='" + modulo + "'");
                conecta.rs.first();
