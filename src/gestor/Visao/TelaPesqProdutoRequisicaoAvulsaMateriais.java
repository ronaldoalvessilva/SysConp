...
import static gestor.Visao.TelaRequisicaoAvulsaAC.jDescricaoProduto;
import static gestor.Visao.TelaRequisicaoAvulsaAC.jCodProduto;
import static gestor.Visao.TelaRequisicaoAvulsaAC.jCodigoBarras;
import static gestor.Visao.TelaRequisicaoAvulsaAC.jLote;
import static gestor.Visao.TelaRequisicaoAvulsaAC.jDataVctoLote;
import static gestor.Visao.TelaRequisicaoAvulsaAC.jComboBoxUnidade;
import static gestor.Visao.TelaRequisicaoAvulsaAC.jValorUnitarioItem;
 ...
 * @author user
 */
public class TelaPesqProdutoRequisicaoAvulsaMateriais extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoRequisicaoAvulsaMateriais() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jBtPesqDescricaoProd1 = new javax.swing.JButton();
        ...
        jBtPesqDescricaoProd1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gestor/Imagens/Lupas_1338_05.gif"))); // NOI18N
        jBtPesqDescricaoProd1.setContentAreaFilled(false);
        jBtPesqDescricaoProd1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBtPesqDescricaoProd1ActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jBtPesqDescricaoProd1, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jBtPesqDescricaoProd1))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "AND StatusProd='" + statusProd + "'AND Qtd!='" + 0 + "' "
    ...
    private void jTabelaProdutosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaProdutosMouseClicked
        ...
        if (flag == 1) {
            ...
            loteProduto = "" + jTabelaProdutos.getValueAt(jTabelaProdutos.getSelectedRow(), 4);
        }
    ...
    private void jCheckBoxPesqTodosProdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosProdItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "INNER JOIN LOTE_PRODUTOS_AC "
                    + "ON PRODUTOS_AC.IdProd=LOTE_PRODUTOS_AC.IdProd "
                    + "WHERE PRODUTOS_AC.StatusProd='" + statusProd + "'AND Qtd!='" + 0 + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        } else {
            limparTabela();
        }
    }//GEN-LAST:event_jCheckBoxPesqTodosProdItemStateChanged

    private void jBtPesqDescricaoProd1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProd1ActionPerformed
        // TODO add your handling code here:
        flag = 1;
    ...
    private javax.swing.JButton jBtPesqDescricaoProd1;
