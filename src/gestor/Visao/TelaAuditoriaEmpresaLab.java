...
import static gestor.Visao.TelaEmpresasLaborativas.jIDEmp;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEmpresaLab extends javax.swing.JInternalFrame {
   ...
   EmpresaLab objEmpLab = new EmpresaLab();
     ...
     */
    public TelaAuditoriaEmpresaLab() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Empresa Laborativa :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM EMPRESALAB WHERE IdEmp='" + jIDEmp.getText() + "'");
            conecta.rs.first();
