 ...
 * @author ronaldo
 */
public class TelaFotoTransLocalInterno extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaTransCelas telaTransLocalInterno;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoTransLocalInterno(TelaTransCelas parent, boolean modal) {
        this.telaTransLocalInterno = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaTransLocalInterno);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoTransLocalInterno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoTransLocalInterno dialog = new TelaFotoTransLocalInterno(telaTransLocalInterno, true);
