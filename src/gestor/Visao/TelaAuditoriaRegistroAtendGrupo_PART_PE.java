 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_PART_PE extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_PART_PE() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_PE "
                    + "WHERE IdItemPartPE='" + pCODIGO_ITEM_PARTICIPANTE + "' "
