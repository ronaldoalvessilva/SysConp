 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensAdvogadosExterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensAdvogadosExterna() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSADVOGADO WHERE Idlanc='" + jIDlanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
