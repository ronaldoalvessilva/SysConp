...
import static gestor.Visao.TelaRequisicaoAvulsaMedicamentosENF.jCodReq;
import static gestor.Visao.TelaRequisicaoAvulsaMedicamentosENF.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRequiAvulsaENF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRequiAvulsaENF() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Itens Requisição :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_ENF WHERE IdReq='" + jCodReq.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
