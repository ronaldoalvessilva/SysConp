...
import gestor.Controle.ControleListaInternosPavilhaoAG_ENF;
...
import static gestor.Visao.TelaAtendimentoGrupoENF.jBtAuditoriaParticipantes;
...
import static gestor.Visao.TelaAtendimentoGrupoENF.jBtSalvarParticipantes;
import static gestor.Visao.TelaAtendimentoGrupoENF.jBtPesquisarPart;
...
import static gestor.Visao.TelaAtendimentoGrupoENF.jComboBoxNivelPavilhao;
import static gestor.Visao.TelaAtendimentoGrupoENF.jComboBoxPavilhaoGaleria;
...
import static gestor.Visao.TelaAtendimentoGrupoENF.jTabelaInternos;
import static gestor.Visao.TelaAtendimentoGrupoENF.jtotalRegistrosInternos;
import static gestor.Visao.TelaAtendimentoGrupoENF.pCODIGO_ITEM_PARTICIPANTE;
 ...
 */
public class TelaSelecaoLoteInternosAG_ENF extends javax.swing.JDialog {
    ...
    ControleListaInternosPavilhaoAG_II_ENF listaPorPavilhao_B = new ControleListaInternosPavilhaoAG_II_ENF();
     ...
     */
    public static TelaAtendimentoGrupoENF pATENDIMENTO_GRUPO;

    public TelaSelecaoLoteInternosAG_ENF(TelaAtendimentoGrupoENF parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaSelecaoLoteInternosAG_ENF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaSelecaoLoteInternosAG_ENF dialog = new TelaSelecaoLoteInternosAG_ENF(pATENDIMENTO_GRUPO, true);
