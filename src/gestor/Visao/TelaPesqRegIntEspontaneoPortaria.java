...
import static gestor.Visao.TelaRetornoEspontaneo.FotoInternoCrcRetEsp;
import static gestor.Visao.TelaRetornoEspontaneo.jDataRetorno;
import static gestor.Visao.TelaRetornoEspontaneo.jIdInterno;
import static gestor.Visao.TelaRetornoEspontaneo.jNomeInterno;
 ...
 * @author Ronaldo
 */
public class TelaPesqRegIntEspontaneoPortaria extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    int flag;
    String caminho;
    String confirmacaoRetrono = "Não";
    public static int idItemRetornoEspontaneo; // Código do item da tabela ITENSREGISTRO    
    String dataRetorno;

    /**
     * Creates new form TelaPesqRegistroInternoPortaria
     */
    public TelaPesqRegIntEspontaneoPortaria() {
        initComponents();
    }
    ...
    private void jBtConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtConfirmarActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                ...
                idItemRetornoEspontaneo = conecta.rs.getInt("IdItem");
