...
import static gestor.Visao.TelaAdmissaoEnfermagem.codigoAFP4;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAdmissaoEnfermeiraAEFP4 extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAdmissaoEnfermeiraAEFP4() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Admissão Enfermeira a Internos :::...");
    ...
    public void auditoria() {
        ...
        try {            
            conecta.executaSQL("SELECT * FROM ADME_AFP4 WHERE IdLanc='" + jIdLanc.getText() + "' "
                    + "AND ADME_AFP4.IdAfp4='" + codigoAFP4 + "'");
            conecta.rs.first();
