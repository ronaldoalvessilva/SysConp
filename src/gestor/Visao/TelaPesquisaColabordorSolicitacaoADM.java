...
import static gestor.Visao.TelaSolicitacaoComprasMateriaisGerencia.jMatriculaFuncSol;
import static gestor.Visao.TelaSolicitacaoComprasMateriaisGerencia.jDepartamentoFuncSol;
import static gestor.Visao.TelaSolicitacaoComprasMateriaisGerencia.jIdFuncSol;
import static gestor.Visao.TelaSolicitacaoComprasMateriaisGerencia.jNomeFuncSol;
import static gestor.Visao.TelaSolicitacaoComprasMateriaisGerencia.codigoDepto;
import static gestor.Visao.TelaSolicitacaoComprasMateriaisGerencia.tipoValor;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaColabordorSolicitacaoADM extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaColabordorSolicitacaoADM() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Pesquisar Colaborador", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, new java.awt.Color(51, 51, 255)));
        ...
        jTabelaColabrador.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item", "Código", "Nome do Colaborador", "Departamento"
            }
        ));
        ...
        if (jTabelaColabrador.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaColabrador.getColumnModel().getColumn(1).setMinWidth(50);
            jTabelaColabrador.getColumnModel().getColumn(1).setMaxWidth(50);
            jTabelaColabrador.getColumnModel().getColumn(2).setMinWidth(280);
            jTabelaColabrador.getColumnModel().getColumn(2).setMaxWidth(280);
            jTabelaColabrador.getColumnModel().getColumn(3).setMinWidth(200);
            jTabelaColabrador.getColumnModel().getColumn(3).setMaxWidth(200);
        }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesNomeColaborador.getText().equals("")) {
            ...
            preencherTabela("SELECT * FROM COLABORADOR "
                    + "INNER JOIN ITENS_SOLICITANTES_COMPRAS "
                    + "ON COLABORADOR.IdFunc=ITENS_SOLICITANTES_COMPRAS.IdFunc "
                    + "INNER JOIN DEPARTAMENTOS "
                    + "ON COLABORADOR.IdDepartamento=DEPARTAMENTOS.IdDepartamento "
                    + "INNER JOIN SOLICITANTES_COMPRAS "
                    + "ON ITENS_SOLICITANTES_COMPRAS.IdSoli=SOLICITANTES_COMPRAS.IdSoli "
                    + "WHERE NomeFunc LIKE'%" + jPesNomeColaborador.getText() + "%'AND StatusFunc='" + statusFunc + "'AND COLABORADOR.NomeFunc='" +  nameUser   + "'");
        }
    ...
    private void jTabelaColabradorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaColabradorMouseClicked
        ...
        flag = 1;
        if (flag == 1) {
            String nomeColaborador = "" + jTabelaColabrador.getValueAt(jTabelaColabrador.getSelectedRow(), 2);
            jPesNomeColaborador.setText(nomeColaborador);
            //
            idItem = "" + jTabelaColabrador.getValueAt(jTabelaColabrador.getSelectedRow(), 0);
        }
        ...
        if (jPesNomeColaborador.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM COLABORADOR "
                        ...
                        + "INNER JOIN SOLICITANTES_COMPRAS "
                        + "ON ITENS_SOLICITANTES_COMPRAS.IdSoli=SOLICITANTES_COMPRAS.IdSoli "
                        + "WHERE NomeFunc='" + jPesNomeColaborador.getText() + "'AND IdItem='" + idItem + "'");
                conecta.rs.first();
                ...
                tipoValor = conecta.rs.getInt("TipoValor");// 0 - INDIVIDUAL, 1 - GRUPO
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabela("SELECT * FROM COLABORADOR "
                    ...
                    + "INNER JOIN SOLICITANTES_COMPRAS "
                    + "ON ITENS_SOLICITANTES_COMPRAS.IdSoli=SOLICITANTES_COMPRAS.IdSoli "
                    + "WHERE StatusFunc='" + statusFunc + "'AND COLABORADOR.NomeFunc='" +  nameUser   + "'");
        } else {
            limparTabelaColaboradores();
        }
    ...
    public void preencherTabela(String sql) {
        ...
        String[] Colunas = new String[]{"Item", "Código", "Nome do Colaborador", "Departamento"};
        conecta.abrirConexao();
        try {
            conecta.executaSQL(sql);
            conecta.rs.first();
            do {
                dados.add(new Object[]{conecta.rs.getInt("IdItem"), conecta.rs.getInt("IdFunc"), conecta.rs.getString("NomeFunc"), conecta.rs.getString("NomeDepartamento")});
            } while (conecta.rs.next());
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(rootPane, "Dados não encontrado, provavelmente você não é um solicitante.");
        }
        ...
        jTabelaColabrador.getColumnModel().getColumn(1).setPreferredWidth(50);
        jTabelaColabrador.getColumnModel().getColumn(1).setResizable(false);
        jTabelaColabrador.getColumnModel().getColumn(2).setPreferredWidth(280);
        jTabelaColabrador.getColumnModel().getColumn(2).setResizable(false);
        jTabelaColabrador.getColumnModel().getColumn(3).setPreferredWidth(200);
    ...
    public void limparTabelaColaboradores() {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Item", "Código", "Nome do Colaborador", "Departamento"};
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaColabrador.setModel(modelo);
