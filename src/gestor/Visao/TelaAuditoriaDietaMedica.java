...
import static gestor.Visao.TelaAdmissaoMedica.jIdDieta;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaDietaMedica extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaDietaMedica() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Dieta Médico :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM DIETA_MEDICA_PSIQUIATRICA WHERE IdLanc='" + jIdAdm.getText() + "'AND IdItem='" + jIdDieta.getText() + "'");
            conecta.rs.first();
