...
import static gestor.Visao.TelaPesquisaMovInternoCrcBaseSeguranca.idIntSeg;
 ...
 * @author user
 */
public class TelaMovimentacaoCrcBaseSeguranca extends javax.swing.JInternalFrame {
     ...
     */
    public TelaMovimentacaoCrcBaseSeguranca() {
        initComponents();
        corCampos();
    }
    ...
    private void jBtPesquisarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarInternoActionPerformed
        // Pesquisar Internos
        count = 0;
        TelaPesquisaMovInternoCrcBaseSeguranca objTelaMovInt = new TelaPesquisaMovInternoCrcBaseSeguranca();
        TelaModuloBaseUm.jPainelBaseSegurancaPavilhao.add(objTelaMovInt);
        objTelaMovInt.show();
