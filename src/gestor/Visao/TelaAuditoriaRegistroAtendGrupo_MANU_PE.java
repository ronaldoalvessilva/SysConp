 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_MANU_PE extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_MANU_PE() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATENDIMENTO_GRUPO_PE WHERE IdAtGrupoPE='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
