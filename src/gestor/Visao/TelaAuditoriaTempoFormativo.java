 ...
 * @author Ronaldo
 */
public class TelaAuditoriaTempoFormativo extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaTempoFormativo() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Tempo Formativo :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM TEMPOFORMATIVO WHERE IdTempo='" + jIdLanc.getText() + "'");
            conecta.rs.first();
