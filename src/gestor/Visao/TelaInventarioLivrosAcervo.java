...
import gestor.Controle.ControleInventarioAcervoLivro;
import gestor.Controle.ControleItensInventarioAcervo;
...
import static gestor.Visao.TelaModuloPedagogia.telaInventarioCont_PEDA;
import static gestor.Visao.TelaModuloPedagogia.telaInventarioEfe_PEDA;
 ...
 * @author user
 */
public class TelaInventarioLivrosAcervo extends javax.swing.JInternalFrame {
    ...
    ControleInventarioAcervoLivro control = new ControleInventarioAcervoLivro();
    ControleItensInventarioAcervo controle = new ControleItensInventarioAcervo();
    //
    ...
    String nomeModuloTela = "Pedagogia:Inventário de Livros:Manutenção";
    String nomeModuloTela2 = "Pedagogia:Inventário de Livros:Contagem itens";
    String statusMov;
    String horaMov;
    String dataModFinal;
     ...
     */
    public TelaInventarioLivrosAcervo() {
        initComponents();
        formatarCampos();
        corCampos();
        corCamposItens();
    ...
    private void initComponents() {
        ...
        if (jTabelaItensProdutoInvent.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaItensProdutoInvent.getColumnModel().getColumn(5).setMinWidth(60);
            jTabelaItensProdutoInvent.getColumnModel().getColumn(5).setMaxWidth(60);
        }
        ...
        jPanel10Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jCodigoBarra, jComboBoxUnidProduto, jQtd});
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaInventarioManu_PEDA) && codIncluirPEDA == 1) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaInventarioManu_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaInventarioManu_PEDA) && codAlterarPEDA == 1) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaInventarioManu_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaInventarioManu_PEDA) && codExcluirPEDA == 1) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            objInventEstoque.setStatusLanc(jStatusLanc.getText());
            if (jStatusLanc.getText().equals("EFETIVADO")) {
                ...
                try {
                    conecta.executaSQL("SELECT * FROM ITENS_INVENTARIO_ACERVO WHERE IdLanc='" + jIdLanc.getText() + "'");
                    conecta.rs.first();
                    ...
                    if (resposta == JOptionPane.YES_OPTION) {
                        ...
                        control.excluirInventarioAcervo(objInventEstoque);
                        objLog();
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaInventarioManu_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaInventarioManu_PEDA) && codGravarPEDA == 1) {
            ...
            if (jDataInicio.getDate() == null) {
                ...
                if (acao == 1) {
                    if (jComboBoxTipoInventario.getSelectedItem().equals(tipoInventario) && jIdLocal.getText().equals(codLocal)) {
                        ...
                        control.incluirInventarioAcervo(objInventEstoque);
                        buscarIDIvt();
                        objLog();
                        controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                ...
                if (acao == 2) {
                    ...
                    control.alterarInventarioAcervo(objInventEstoque);
                    objLog();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
                    Salvar();
    ...
    private void jBtEfetivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEfetivarActionPerformed
        // TODO add your handling code here: 
        buscarAcessoUsuario(telaInventarioEfe_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaInventarioEfe_PEDA) && codAbrirPEDA == 1) {
            objInventEstoque.setStatusLanc(jStatusLanc.getText());
            if (jStatusLanc.getText().equals("EFETIVADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse inventário encontra-se EFETIVADO");
            } else {
                TelaEfetuarInventariosAcervo objEfetuarInv = new TelaEfetuarInventariosAcervo();
                TelaModuloPedagogia.jPainelPedagogia.add(objEfetuarInv);
                objEfetuarInv.show();
    ...
    private void jBtNovoItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoItemActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaInventarioCont_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaInventarioCont_PEDA) && codIncluirPEDA == 1) {
            objInventEstoque.setStatusLanc(jStatusLanc.getText());
            if (jStatusLanc.getText().equals("EFETIVADO")) {
    ...
    private void jBtAlterarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarItemActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaInventarioCont_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaInventarioCont_PEDA) && codAlterarPEDA == 1) {
            objInventEstoque.setStatusLanc(jStatusLanc.getText());
            if (jStatusLanc.getText().equals("EFETIVADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse inventário não poderá ser modificado, o mesmo encontra-se EFETIVADO");
            } else {
    ...
    private void jBtExcluirItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirItemActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaInventarioCont_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaInventarioCont_PEDA) && codExcluirPEDA == 1) {
            objInventEstoque.setStatusLanc(jStatusLanc.getText());
            if (jStatusLanc.getText().equals("EFETIVADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse inventário não poderá ser modificado, o mesmo encontra-se EFETIVADO");
            } else {
                ...
                if (jStatusLanc.getText().equals("EFETUADO")) {
                    ...
                    if (resposta == JOptionPane.YES_OPTION) {
                        ...
                        controle.excluirItensInventarioAcervo(objItensInventEstoque);
                        JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                        ExcluirItem();
                        preencherTabelaItensInventario("SELECT * FROM ITENS_INVENTARIO_ACERVO "
                                + "INNER JOIN LIVROS_REVISTAS_JORNAIS "
                                + "ON ITENS_INVENTARIO_ACERVO.IdLivro=LIVROS_REVISTAS_JORNAIS.IdLivro "
    ...
    private void jBtSalvarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarItemActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaInventarioCont_PEDA);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoPEDA.equals("ADMINISTRADORES") || codigoUserPEDA == codUserAcessoPEDA && nomeTelaPEDA.equals(telaInventarioCont_PEDA) && codGravarPEDA == 1) {
            ...
            if (jDescricaoProduto.getText().equals("")) {
                ...
                try {
                    ...
                    Logger.getLogger(TelaInventarioLivrosAcervo.class.getName()).log(Level.SEVERE, null, ex);
                }
                try {
                ...
                objItensInventEstoque.setUnidade((String) jComboBoxUnidProduto.getSelectedItem());
                ...
                if (acao == 3) {
                    ...
                    controle.incluirItensInventarioAcervo(objItensInventEstoque);
                    preencherTabelaItensInventario("SELECT * FROM ITENS_INVENTARIO_ACERVO "
                            + "INNER JOIN LIVROS_REVISTAS_JORNAIS "
                            + "ON ITENS_INVENTARIO_ACERVO.IdLivro=LIVROS_REVISTAS_JORNAIS.IdLivro "
                            + "WHERE IdLanc='" + jIdLanc.getText() + "'");
                ...
                if (acao == 4) {
                    ...
                    objItensInventEstoque.setIdLanc(Integer.valueOf(jIdLanc.getText()));
                    objItensInventEstoque.setIdItem(Integer.valueOf(idItem));
                    controle.alterarItensInventarioAcervo(objItensInventEstoque);
                    preencherTabelaItensInventario("SELECT * FROM ITENS_INVENTARIO_ACERVO "
                            + "INNER JOIN LIVROS_REVISTAS_JORNAIS "
                            + "ON ITENS_INVENTARIO_ACERVO.IdLivro=LIVROS_REVISTAS_JORNAIS.IdLivro "
                            + "WHERE IdLanc='" + jIdLanc.getText() + "'");
    ...
    private void jBtPesqProdutoInveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqProdutoInveActionPerformed
        // TODO add your handling code here:
        TelaPesqLivroAcervo objPesqProdFar = new TelaPesqLivroAcervo();
        TelaModuloPedagogia.jPainelPedagogia.add(objPesqProdFar);
        objPesqProdFar.show();
    ...
    private void jTabelaInventarioEstoqueMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaInventarioEstoqueMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM INVENTARIO_LIVROS "
                        + "INNER JOIN LOCAL_ACERVO "
                        + "ON INVENTARIO_LIVROS.IdLocal=LOCAL_ACERVO.IdLocal "
                        + "WHERE IdLanc='" + jIdLanc.getText() + "'");
                conecta.rs.first();
    ...
    private void jTabelaItensProdutoInventMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaItensProdutoInventMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM ITENS_INVENTARIO_ACERVO "
                        + "INNER JOIN LIVROS_REVISTAS_JORNAIS "
                        + "ON ITENS_INVENTARIO_ACERVO.IdLivro=LIVROS_REVISTAS_JORNAIS.IdLivro "
                        + "INNER JOIN LOCAL_ACERVO "
                        + "ON ITENS_INVENTARIO_ACERVO.IdLocal=LOCAL_ACERVO.IdLocal "
                        + "WHERE IdLanc='" + jIdLanc.getText() + "'AND TituloLivro='" + jDescricaoProduto.getText() + "'AND IdItem='" + idItem + "'");
                conecta.rs.first();
                jIdProduto.setText(conecta.rs.getString("IdLivro"));
                ...
                jComboBoxUnidProduto.setSelectedItem(conecta.rs.getString("Unidade"));
                //
                ...
                DecimalFormat vc = new DecimalFormat(",###.00");
    ...
    private void jBtPesqLocalArmazenamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqLocalArmazenamentoActionPerformed
        // TODO add your handling code here:
        TelaPesqLocalArmazenamentoAcervo objLocalArma = new TelaPesqLocalArmazenamentoAcervo();
        TelaModuloPedagogia.jPainelPedagogia.add(objLocalArma);
        objLocalArma.show();;
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            jTabelaInventarioEstoque.setVisible(true);
            this.preencherTabelaInventario("SELECT * FROM INVENTARIO_LIVROS "
                    + "INNER JOIN LOCAL_ACERVO "
                    + "ON INVENTARIO_LIVROS.IdLocal=LOCAL_ACERVO.IdLocal");
        } else {
        ...
        if (jIdLanc.getText().equals("")) {
            ...
            try {
                ...
                conecta.executaSQL("SELECT *,"
                        ...
                        + "FROM INVENTARIO_LIVROS "
                        + "INNER JOIN LOCAL_ACERVO "
                        + "ON INVENTARIO_LIVROS.IdLocal=LOCAL_ACERVO.IdLocal "
                        + "INNER JOIN ITENS_INVENTARIO_ACERVO ITENS_INVENTARIO_ACERVO "
                        + "ON INVENTARIO_LIVROS.IdLanc=ITENS_INVENTARIO_ACERVO.IdLanc "
                        + "INNER JOIN LIVROS_REVISTAS_JORNAIS "
                        + "ON ITENS_INVENTARIO_ACERVO.IdLivro=LIVROS_REVISTAS_JORNAIS.IdLivro "
                        + "WHERE ITENS_INVENTARIO_ACERVO.IdLanc='" + jIdLanc.getText() + "'");
                ...
                jv.setTitle("Listagem para Contagem de Estoque Acervo");
    ...
    private void jBtResultadoInventarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtResultadoInventarioActionPerformed
        ...
        if (jIdLanc.getText().equals("")) {
            ...
            try {
                ...
                JasperViewer jv = new JasperViewer(jpPrint, false); // Cria instancia para impressao          
                jv.setExtendedState(JasperViewer.MAXIMIZED_BOTH); // Maximizar o relatório
                jv.setTitle("Listagem de Inventário de Estoque Acervo - Efetivado");
                jv.setVisible(true); // Chama o relatorio para ser visualizado                                    
                jv.toFront(); // Traz o relatorio para frente da aplicação            
                conecta.desconecta();
            } catch (JRException e) {
    ...
    private void jBtAuditoriaInventarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaInventarioActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaInventarioAcervo objAudiInv = new TelaAuditoriaInventarioAcervo();
        TelaModuloPedagogia.jPainelPedagogia.add(objAudiInv);
        objAudiInv.show();
    ...
    private void jBtAuditoriaItensActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaItensActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensInventarioAcervo objAudiItensInv = new TelaAuditoriaItensInventarioAcervo();
        TelaModuloPedagogia.jPainelPedagogia.add(objAudiItensInv);
...
//                jValorCusto.setText(conecta.rs.getString("ValorCompra"));
    ...
    public static javax.swing.JButton jBtEfetivar;
    ...
    public void verificarTipoInventario() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM INVENTARIO_LIVROS WHERE TipoInventario='" + jComboBoxTipoInventario.getSelectedItem() + "'");
            conecta.rs.first();
            tipoInventario = conecta.rs.getString("TipoInventario");
            codLocal = conecta.rs.getString("IdLocal");
        } catch (SQLException ex) {
            //JOptionPane.showMessageDialog(rootPane, "Não foi possível encontrar informações do inventário.\nERRO: " + ex);
        }
        conecta.desconecta();
    }
    ...
    public void alinharCamposTabelaInventario() {
    ...
    public void preencherTabelaItensInventario(String sql) {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Item", "Código", "Código Barras", "Descrição", " UN", "Qtde."};
        conecta.abrirConexao();
        try {
            conecta.executaSQL(sql);
            conecta.rs.first();
...
//                String vqtdItem = vi.format(qtdItem);
//                qtdItemTab = vqtdItem;
                dados.add(new Object[]{conecta.rs.getString("IdItem"), conecta.rs.getInt("IdLivro"), conecta.rs.getString("CodigoBarra"), conecta.rs.getString("TituloLivro"), conecta.rs.getString("Unidade"), conecta.rs.getInt("QtdItem")});
            } while (conecta.rs.next());
        } catch (SQLException ex) {
        }
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        ...
        jTabelaItensProdutoInvent.getColumnModel().getColumn(5).setPreferredWidth(60);
        ...
        alinharCamposTabelaItensInventario();
        conecta.desconecta();
    }
    ...
    public void alinharCamposTabelaItensInventario() {
        DefaultTableCellRenderer esquerda = new DefaultTableCellRenderer();
        DefaultTableCellRenderer centralizado = new DefaultTableCellRenderer();
        DefaultTableCellRenderer direita = new DefaultTableCellRenderer();
        esquerda.setHorizontalAlignment(SwingConstants.LEFT);
