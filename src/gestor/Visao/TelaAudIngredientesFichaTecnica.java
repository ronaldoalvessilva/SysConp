...
import static gestor.Visao.TelaFichaTecnica.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAudIngredientesFichaTecnica extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAudIngredientesFichaTecnica() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Ingredientes :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM INGREDIENTES_FICHA_TECNICA_NUTRI WHERE IdFicha='" + jIdFicha.getText() + "'AND Item='" + idItem + "'");
            conecta.rs.first();
