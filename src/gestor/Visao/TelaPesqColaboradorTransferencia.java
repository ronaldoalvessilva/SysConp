 ...
 * @author user
 */
public class TelaPesqColaboradorTransferencia extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqColaboradorTransferencia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa Colaborador - {FAR} :::...");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jPesqNomeColaborador, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        flag = 1;
        if (jPesqNomeColaborador.getText().isEmpty()) {
            ...
            if (flag == 1) {
                ...
                jPesqNomeColaborador.setText(nomeFuncionario);
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jPesqNomeColaborador.getText().equals("")) {
            ...
            jPesqNomeColaborador.requestFocus();
        } else {
            ...
            buscarFunc("SELECT * FROM COLABORADOR "
                    ...
                    + "INNER JOIN DEPARTAMENTOS "
                    + "ON COLABORADOR.IdDepartamento=DEPARTAMENTOS.IdDepartamento "
                    + "WHERE NomeFunc LIKE'%" + jPesqNomeColaborador.getText() + "%' AND StatusFunc='" + statusFunc + "'");
        }
...
//Preencher tabela com todos os COLABORADORES
    public void buscarFunc(String sql) {
        ...
        String[] Colunas = new String[]{"ID", "Nome Colaborador", "Cargo", "Departamento"};
        conecta.abrirConexao();
        try {
