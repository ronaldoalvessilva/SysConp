...
import static gestor.Visao.TelaVisitasDiversasExterna.caminhoFotoVisitaExt;
import static gestor.Visao.TelaVisitasDiversasExterna.FotoVisitaDiversas;
 ...
 * @author Ronaldo
 */
public class TelaWebCamVisitaInternoPortExt extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String localFotoVisitasInternoEX = "";
     ...
     * @param modal
     */
    public static TelaVisitasDiversasExterna telaVisitasEXT;

    //TESTADO E FUNCIONANDO NO DIA 02/12/2016 - EM VITÓRIA DA CONQUISTA
    public TelaWebCamVisitaInternoPortExt(TelaVisitasDiversasExterna parent, boolean modal) {
        this.telaVisitasEXT = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaVisitasEXT);
        initComponents();
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        localFotoVisitasInternoEXT();
        if (localFotoVisitasInternoEX == null || localFotoVisitasInternoEX == "") {
            ...
            javax.swing.JFileChooser seletor = new javax.swing.JFileChooser(localFotoVisitasInternoEX);
            FileNameExtensionFilter tipoExtensao = new FileNameExtensionFilter("Imagem de Foto", "jpg", "bmp", "gif", "png");
            seletor.setAcceptAllFileFilterUsed(false);
            seletor.setMultiSelectionEnabled(false);
            seletor.setFileFilter(tipoExtensao);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaWebCamVisitaInternoPortExt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaWebCamVisitaInternoPortExt dialog = new TelaWebCamVisitaInternoPortExt(telaVisitasEXT, true);
    ...
    public void localFotoVisitasInternoEXT() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM PARAMETROSCRC");
            conecta.rs.first();
            localFotoVisitasInternoEX = conecta.rs.getString("LocalFotosVisitasInternos");
        } catch (Exception e) {
        }
        conecta.desconecta();
    }
