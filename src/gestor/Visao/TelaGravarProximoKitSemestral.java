 ...
 * @author ronal
 */
public class TelaGravarProximoKitSemestral extends javax.swing.JDialog {
    ...
    public TelaGravarProximoKitSemestral(TelaPrevisaoKitHigiene parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGravarProximoKitSemestral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaGravarProximoKitSemestral dialog = new TelaGravarProximoKitSemestral(gravarProximoKitQuinzenal, true);
            ...
            Thread t0 = new Thread() {
                public void run() {
                    ...
                    try {
                        ...
                        Logger.getLogger(TelaGravarProximoKitSemestral.class.getName()).log(Level.SEVERE, null, ex);
                    }
...
//                        jProgressBar1.setValue((i + 1));
    ...
    public void verificarInternoBancoDados(int codigoReg, int codInternoCrc) {
        ...
        try {
            conecta.executaSQL("SELECT * FROM KITS_SEMESTRAL_INTERNOS "
                    + "WHERE IdKitSemestral='" + codigoReg + "' "
