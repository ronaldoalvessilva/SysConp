...
import static gestor.Visao.TelaEntradaProdutos.jIdLanc;
import static gestor.Visao.TelaEntradaProdutos.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntradaProdutosFAR extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEntradaProdutosFAR() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_COMPRAS_MATERIAIS_FAR WHERE IdNfEntrada='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
