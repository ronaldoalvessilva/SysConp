 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntSaiIntEduca extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEntSaiIntEduca() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM INTERNOS_ENTRADA_SAIDA_EDUCACAO WHERE IdLanc='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
