...
import static gestor.Visao.TelaEventoDisciplinar.idItemHist;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaHistoricoEventos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaHistoricoEventos() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Históricos Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM HISTORICOAUTOR WHERE IdLanc='" + jIdLanc.getText() + "'AND IdHist='" + idItemHist + "'");
            conecta.rs.first();
