...
import static gestor.Visao.TelaAprovadoresOcorrenciaVisitasInternosServicoSocial.jNomeGrupo;
import static gestor.Visao.TelaAprovadoresOcorrenciaVisitasInternosServicoSocial.jCodigoColaborador;
import static gestor.Visao.TelaAprovadoresOcorrenciaVisitasInternosServicoSocial.jNomeAprovador;
 ...
 * @author user
 */
public class TelaPesqColaboradorOcorrenciaVisitaSocial extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqColaboradorOcorrenciaVisitaSocial() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa Colaborador - ADM :::...");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jNomeColaborador, javax.swing.GroupLayout.PREFERRED_SIZE, 324, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTabelaPesqFunc.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome do Colaborador", "Grupo do Usuário"
            }
        ));
        ...
        if (jTabelaPesqFunc.getColumnModel().getColumnCount() > 0) {
            jTabelaPesqFunc.getColumnModel().getColumn(0).setMinWidth(60);
            jTabelaPesqFunc.getColumnModel().getColumn(0).setMaxWidth(60);
            jTabelaPesqFunc.getColumnModel().getColumn(1).setMinWidth(200);
            jTabelaPesqFunc.getColumnModel().getColumn(1).setMaxWidth(200);
            jTabelaPesqFunc.getColumnModel().getColumn(2).setMinWidth(350);
            jTabelaPesqFunc.getColumnModel().getColumn(2).setMaxWidth(350);
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jNomeColaborador.getText().isEmpty()) {
            ...
            if (flag == 1) {
                ...
                jCodigoColaborador.setText(idFunc);
...
//                            + "ON COLABORADOR.IdDepartamento=DEPARTAMENTOS.IdDepartamento "
                            + "WHERE NomeUsuario='" + nomeFuncionario + "'AND StatusUsuario='" + statusFunc + "'");
                    conecta.rs.first();
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jNomeColaborador.getText().equals("")) {
           ...
           buscarFunc("SELECT * FROM USUARIOS "
                    + "INNER JOIN GRUPOUSUARIOS "
                    + "ON USUARIOS.IdGrupo=GRUPOUSUARIOS.IdGrupo "
                    + "WHERE NomeUsuario LIKE'%" + jNomeColaborador.getText() + "%' AND StatusUsuario='" + statusFunc + "'");
        }
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {           
            this.buscarFunc("SELECT * FROM USUARIOS "
                    + "INNER JOIN GRUPOUSUARIOS "
                    + "ON USUARIOS.IdGrupo=GRUPOUSUARIOS.IdGrupo "
                    + "WHERE StatusUsuario='" + statusFunc + "'");
        } else {
            limparTabela();
        }
...
//Preencher tabela com todos os COLABORADORES
    public void buscarFunc(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Nome do Usuário", "Grupo do Usuário"};
        conecta.abrirConexao();
        try {
        ...
        jTabelaPesqFunc.getColumnModel().getColumn(0).setPreferredWidth(60);
        jTabelaPesqFunc.getColumnModel().getColumn(0).setResizable(false);
        jTabelaPesqFunc.getColumnModel().getColumn(1).setPreferredWidth(350);
    ...
    public void limparTabela() {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Código", "Nome do Colaborador", "Grupo do Usuário"};
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaPesqFunc.setModel(modelo);
        jTabelaPesqFunc.getColumnModel().getColumn(0).setPreferredWidth(60);
        jTabelaPesqFunc.getColumnModel().getColumn(0).setResizable(false);
