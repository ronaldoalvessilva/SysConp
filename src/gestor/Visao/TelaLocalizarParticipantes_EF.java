...
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jFotoInternoGrupo;
...
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.idItem;
 ...
 * @author user
 */
public class TelaLocalizarParticipantes_EF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaLocalizarParticipantes_EF() {
        initComponents();
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_EF "
                        ...
                        + "AND PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF='" + jCodigoAtend.getText() + "'");
                conecta.rs.first();
                // Tabela Funcionarios
                ...
                //
                idItem = conecta.rs.getString("IdItemPartEF");
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jNomeInternoCrc.getText().equals("")) {
            ...
            buscarInternos("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_EF "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN ITENSLOCACAOINTERNO "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=ITENSLOCACAOINTERNO.IdInternoCrc "
...
//Preencher tabela com todos os INTERNOS
    public void buscarInternos(String sql) {
        ...
        try {
            ...
            conecta.rs.first();
            do {
                dados.add(new Object[]{conecta.rs.getInt("IdItemPartEF"), conecta.rs.getString("NomeInternoCrc"), conecta.rs.getString("MatriculaCrc"), conecta.rs.getString("Regime")});
