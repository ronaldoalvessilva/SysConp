 ...
 * @author Ronaldo
 */
public class TelaConsultaEstoqueNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaConsultaEstoqueNUTRI() {
        initComponents();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        jTabelaConsultaEstoque.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Descrição Produto", "Status", "Código Barras"
            }
        ));
    ...
    private void jCheckBoxtTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxtTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaConsultaEstoque("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "ON PRODUTOS_AC.IdLocal=LOCAL_ARMAZENAMENTO_AC.IdLocal "
                    + "INNER JOIN GRUPO_PRODUTOS_AC "
                    + "ON PRODUTOS_AC.IdGrupo=GRUPO_PRODUTOS_AC.IdGrupo WHERE PRODUTOS_AC.Modulo='" + modulo + "' ORDER BY DescricaoProd");
        } else {
    ...
    private void jBtPesqCodigoBarrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoBarrasActionPerformed
        ...
        if (jPesqCodigoBarras.getText().equals("")) {
            ...
            preencherTabelaConsultaEstoque("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "INNER JOIN GRUPO_PRODUTOS_AC "
                    + "ON PRODUTOS_AC.IdGrupo=GRUPO_PRODUTOS_AC.IdGrupo "
                    + "INNER JOIN HISTORICO_MOVIMENTACAO_ESTOQUE_NUTRI "
                    + "ON PRODUTOS_AC.IdProd=HISTORICO_MOVIMENTACAO_ESTOQUE_NUTRI.IdProd "
    ...
    private void jBtPesqReferenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqReferenciaActionPerformed
        ...
        if (jPesqReferencia.getText().equals("")) {
            ...
            preencherTabelaConsultaEstoque("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "INNER JOIN HISTORICO_MOVIMENTACAO_ESTOQUE_NUTRI "
                    + "ON PRODUTOS_AC.IdProd=HISTORICO_MOVIMENTACAO_ESTOQUE_NUTRI.IdProd "
                    + "WHERE PRODUTOS_AC.ReferenciaProd='" + jPesqReferencia.getText() + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        }
    ...
    private void jTabelaConsultaEstoqueMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaConsultaEstoqueMouseClicked
        ...
        if (flag == 1) {
            ...
            count = 0;
            preencherTabelaHistorico("SELECT * FROM HISTORICO_MOVIMENTACAO_ESTOQUE_NUTRI "
                    + "INNER JOIN PRODUTOS_AC "
                    + "ON HISTORICO_MOVIMENTACAO_ESTOQUE_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                    + "WHERE PRODUTOS_AC.IdProd='" + idLanc + "'ORDER BY DataMov");
        }
    ...
    public void preencherTabelaConsultaEstoque(String sql) {
        ...
        alinharCamposTabelaConsultaProdutos();
        conecta.desconecta();
    }

    public void alinharCamposTabelaConsultaProdutos() {
