...
import static gestor.Visao.TelaEntradaProdutos.jDescricaoFornecedor;
 ...
 * @author user
 */
public class TelaPesqFornecedorNFe extends javax.swing.JInternalFrame {
    ...
    private void jBtPesqDescricaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoActionPerformed
        ...
        if (jPesqNomeFornecedor.getText().equals("")) {
            ...
            preencherTabelaLocais("SELECT * FROM FORNECEDORES WHERE RazaoSocial LIKE'" + jPesqNomeFornecedor.getText() + "%' AND StatusFor='" + statusLocal + "'");
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM FORNECEDORES WHERE RazaoSocial='" + jPesqNomeFornecedor.getText() + "'");
                conecta.rs.first();
    ...
    private void jCheckBoxTodosLocaisItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosLocaisItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            jTabelaFornecedores.setVisible(true);
            this.preencherTabelaLocais("SELECT * FROM FORNECEDORES WHERE StatusFor='" + statusLocal + "'");
        } else {
            jTabelaFornecedores.setVisible(!true);
        }
