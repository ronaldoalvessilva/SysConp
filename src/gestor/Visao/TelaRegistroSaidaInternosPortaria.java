...
public class TelaRegistroSaidaInternosPortaria extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jStatusSaida, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jBtImpressao.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        ...
        jPanel7Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jBtAlterarlanc, jBtAudiSaida, jBtCancelarlanc, jBtExcluirlanc, jBtFinalizar, jBtImpressao, jBtNovolanc, jBtSalvarlanc});
        ...
        jBtPesInterno.setToolTipText("Buscar");
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addComponent(FotoInternoCrcSaida, javax.swing.GroupLayout.DEFAULT_SIZE, 92, Short.MAX_VALUE)
        );
        jPanel9Layout.setVerticalGroup(
            jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(FotoInternoCrcSaida, javax.swing.GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE)
        );
                            ...
                            .addGroup(jPanel10Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel10Layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(jLabelEvadido, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addComponent(jNomeInterno, javax.swing.GroupLayout.PREFERRED_SIZE, 288, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel10Layout.createSequentialGroup()
                                .addComponent(jLabel7)
                                .addGap(34, 34, 34)
                                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel10Layout.createSequentialGroup()
                                        .addComponent(jHorarioSaida, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
        ...
        jPanel10Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jBtPesInterno, jBtZoon});
        ...
        jPanel10Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jBtPesInterno, jBtZoon});
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Botões", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(51, 0, 255))); // NOI18N
        ...
        jPanel6Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jBtAlterarItem, jBtCancelarItem, jBtExcluirItem, jBtNovoItem, jBtSairItens, jBtSalvarItem});
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jPanel10, javax.swing.GroupLayout.PREFERRED_SIZE, 489, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBtIdLancActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtIdLancActionPerformed
        // TODO add your handling code here:
        count = 0;
        pesquisarLancCod("SELECT * FROM REGSAIDACRC WHERE IdSaida='" + jIDPesqLan.getText() + "'");
    ...
    private void jTabelaSaidaInternoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaSaidaInternoMouseClicked
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM REGSAIDACRC WHERE IdSaida='" + IdLanc + "'");
                conecta.rs.first();
                                                    ...
                                                    if (certidaoNascInterno.equals("Sim")) {
                                                        ...
                                                        if (certidaoCasaInterno.equals("Sim")) {
                                                            ...
                                                            if (valorTotal != 0) {
                                                                ...
                                                                objItemSaida.setNomeDestino(jDestinoInterno.getText());
                                                                objItemSaida.setHorarioSaida(jHorarioSaida.getText());
                                                                //
                                                                ...
                                                                if (acao == 3) {
                                                                    ...
                                                                    if (!jIDInterno.getText().equals(idInternoSaida) && !jIDlanc.getText().equals(idLancSaida)) {
                                                                        ...
                                                                        if (!jDestinoInterno.getText().equals(saidaAudiencia) && !jDestinoInterno.getText().equals(saidaMedico) && !jDestinoInterno.getText().equals(saidaOutras) && !jDestinoInterno.getText().equals(saidaTemporaria)) {
                                                                            // RETIRAR DA POPULAÇÃO, MODIFICADO EM 11/07/2016
                                                                            objProCrc.setIdInterno(Integer.valueOf(jIDInterno.getText()));
                                                                            objProCrc.setSituacao(jDestinoInterno.getText());
                                                                        ...
                                                                        if (jDestinoInterno.getText().equals(saidaTemporaria)) {
                                                                            objProCrc.setIdInterno(Integer.valueOf(jIDInterno.getText()));
                                                                            objProCrc.setSituacao(jDestinoInterno.getText());
                                                                            mod.alterarSituacaoInterno(objProCrc);
                                                                        }
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM REGSAIDACRC WHERE IdSaida='" + jIDlanc.getText() + "'");
            conecta.rs.first();
            jStatusSaida.setText(conecta.rs.getString("StatusSai"));
            if (jStatusSaida.getText().equals("FINALIZADO")) {
...
// Pesquisa de Lançamento por Código (ID)
    ...
    public void verificarItens() {
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENSREGSAIDA WHERE IdSaida='" + jIDlanc.getText() + "'");
            conecta.rs.first();
    ...
    public void verificarDocumentos() {
        ...
        conecta.desconecta();
        if (jDestinoInterno.getText().equals("SAIDA TEMPORARIA") && docSaidaTmp.equals("Sim")
                || jDestinoInterno.getText().equals("SAIDA AUDIENCIA") && docAudiencia.equals("Sim")
                || jDestinoInterno.getText().equals("LIVRAMENTO CONDICIONAL") && docLivraPro.equals("Sim")
                || jDestinoInterno.getText().equals("PROGRESSAO DE REGIME") && docPro.equals("Sim")
                || jDestinoInterno.getText().equals("TRANSFERENCIA") && docTransferencia.equals("Sim")
                || jDestinoInterno.getText().equals("SAIDA ALVARA") && docAlvara.equals("Sim")) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM DOCINTERNOS WHERE IdInternoCrc='" + jIDInterno.getText() + "'");
                conecta.rs.first();
    ...
    public void verificarValores() {
        ...
        conecta.desconecta();
        if (jDestinoInterno.getText().equals("SAIDA TEMPORARIA") && valSaidaTmp.equals("Sim")
                || jDestinoInterno.getText().equals("SAIDA AUDIENCIA") && valAudiencia.equals("Sim")
                || jDestinoInterno.getText().equals("LIVRAMENTO CONDICIONAL") && valLivraPro.equals("Sim")
                || jDestinoInterno.getText().equals("PROGRESSAO DE REGIME") && valPro.equals("Sim")
                || jDestinoInterno.getText().equals("TRANSFERENCIA") && valTransferencia.equals("Sim")
                || jDestinoInterno.getText().equals("SAIDA ALVARA") && valAlvara.equals("Sim")) {
            // Verifica o CRÉDITO do interno para deduzir do debito. Se o valor for zero permite sair
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM SALDOVALORES WHERE IdInternoCrc='" + jIDInterno.getText() + "'AND StatusMov='" + campoCredito + "'");
                conecta.rs.first();
                do {
            ...
            try {
                conecta.executaSQL("SELECT * FROM SALDOVALORES WHERE IdInternoCrc='" + jIDInterno.getText() + "'AND StatusMov='" + campoDebito + "'");
                conecta.rs.first();
                do {
