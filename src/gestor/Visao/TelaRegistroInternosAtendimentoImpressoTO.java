...
import static gestor.Visao.TelaModuloTerapiaOcupacional.telaRegistroAtenImpTO;
import static gestor.Visao.TelaModuloTerapiaOcupacional.telaRegistroLibAtenImpTO;
 ...
 * @author ronal
 */
public class TelaRegistroInternosAtendimentoImpressoTO extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "TERAPIA OCUPACIONAL:Registro de Atendimento de Internos:Impressão";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
     ...
     */
    public static TelaAssinaturaoBiometriaColaboradoresTO assinaLiberaTO;
    ...
    public void mostraLiberador() {
        assinaLiberaTO = new TelaAssinaturaoBiometriaColaboradoresTO(this, true);
        assinaLiberaTO.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jComboBoxTipoMovimentacao.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecione...", "Admissão Terapia", "Evolução Terapia", "Triagem Terapia", " ", " " }));
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoTO.equals("ADMINISTRADORES") || codigoUserTO == codUserAcessoTO && nomeTelaTO.equals(telaRegistroAtenImpTO) && codGravarTO == 1) {
            verificarInternos();
            ...
            if (jIdInternoKitImp.getText().equals("") || jNomeInternoKitImp.getText().equals("")) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Informe o motivo da impressão do documento.");
            } else {
    ...
    private void jBtPesquisaInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisaInternoActionPerformed
        // TODO add your handling code here:        
        TelaPesqInternoRegistroImpressoTO objPesqIntImp = new TelaPesqInternoRegistroImpressoTO();
        TelaModuloTerapiaOcupacional.jPainelTerapia.add(objPesqIntImp);
        objPesqIntImp.show();
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaRegistroAtenImpTO);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoTO.equals("ADMINISTRADORES") || codigoUserTO == codUserAcessoTO && nomeTelaTO.equals(telaRegistroAtenImpTO) && codIncluirTO == 1) {
    ...
    private void jBtLiberarAutorizacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtLiberarAutorizacaoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaRegistroLibAtenImpTO);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoTO.equals("ADMINISTRADORES") || codigoUserTO == codUserAcessoTO && nomeTelaTO.equals(telaRegistroLibAtenImpTO) && codAbrirTO == 1) {
            if (jIdInternoKitImp.getText().equals("") || jNomeInternoKitImp.getText().equals("")) {
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        ...
        if (jIdRegistro.getText().equals("")) {
            ...
            TelaAuditoriaRegistroAtendImpressoTO objAudLibera = new TelaAuditoriaRegistroAtendImpressoTO();
            TelaModuloTerapiaOcupacional.jPainelTerapia.add(objAudLibera);
            objAudLibera.show();
        }
