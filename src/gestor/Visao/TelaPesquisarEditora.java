...
import static gestor.Visao.TelaLivrosRevistasJornais.jEditora;
 ...
 * @author ronaldo
 */
public class TelaPesquisarEditora extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisar Editora/Instituição :::...");
    ...
    private void jBtConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtConfirmarActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM EDITORAS_INSTITUICAO WHERE RazaoSocial='" + jPesqDescricaoLocal.getText() + "'");
                conecta.rs.first();
    ...
    private void jBtPesqDescricaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoActionPerformed
        ...
        if (jPesqDescricaoLocal.getText().equals("")) {
            ...
            preencherTabelaLocal("SELECT * FROM EDITORAS_INSTITUICAO WHERE RazaoSocial LIKE'%" + jPesqDescricaoLocal.getText() + "%'AND StatusFor='" + statusLocal + "'");
        }
    ...
    private void jCheckBoxTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            jTabelaLocalEstoquePertence.setVisible(true);
            this.preencherTabelaLocal("SELECT * FROM EDITORAS_INSTITUICAO WHERE StatusFor='" + statusLocal + "'");
        } else {
            jTabelaLocalEstoquePertence.setVisible(!true);
        }
    ...
    public void preencherTabelaLocal(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "    Descrição da Editora/Instituição"};
        conecta.abrirConexao();
        try {
