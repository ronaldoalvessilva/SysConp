...
import static gestor.Visao.TelaModuloSeguranca.telaTransferenciaPavilhaoCela;
import static gestor.Visao.TelaPesqInternoTransfLocacao.idLoca;
 ...
 * @author Ronaldo
 */
public class TelaTransCelas extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "Segurança:Transferência de Internos:Manutenção";
    String nomeModuloTela2 = "Segurança:Transferência de Internos:Internos";
    String statusMov;
    String horaMov;
    String dataModFinal;
    int flag;
     ...
     */
    public static TelaFotoTransLocalInterno telafotoTransInternocrc;

    public TelaTransCelas() {
        initComponents();
        corCampos();
    }

    public void mostraTelaFotoInternoTransLocacao() {
        telafotoTransInternocrc = new TelaFotoTransLocalInterno(this, true);
        telafotoTransInternocrc.setVisible(true);
    }
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (codigoUser == codUserAcesso && nomeTela.equals(telaTransferenciaPavilhaoCela) && codIncluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here
        buscarAcessoUsuario(telaTransferenciaPavilhaoCela);
        if (codigoUser == codUserAcesso && nomeTela.equals(telaTransferenciaPavilhaoCela) && codAlterar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
    ...
    private void jBtPesqInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqInternoActionPerformed
        // TODO add your handling code here:
        TelaPesqInternoTransfLocacao objPesqTtranInt = new TelaPesqInternoTransfLocacao();
        TelaModuloSeguranca.jPainelSeguranca.add(objPesqTtranInt);
        objPesqTtranInt.show();
    ...
    private void jBtPesqCelaDestinoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCelaDestinoActionPerformed
        // TODO add your handling code here:
        TelaPesqCelasTransInterno objPesqCelas = new TelaPesqCelasTransInterno();
        TelaModuloSeguranca.jPainelSeguranca.add(objPesqCelas);
        objPesqCelas.show();
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaTransLocacaoInternos objTransLocalIterno = new TelaAuditoriaTransLocacaoInternos();
        TelaModuloSeguranca.jPainelSeguranca.add(objTransLocalIterno);
        objTransLocalIterno.show();
