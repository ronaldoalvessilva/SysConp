...
public class TelaModuloBaseUm extends javax.swing.JInternalFrame {
    ...
    public void buscarCodigoModulo() {
     ...
     public void PESQUISAR_LIBERACAO_implementacao() {
        PESQUISAR_IMPLEMENTA_BASE1_001(telaEntregaMaterialUsoB1);
        PESQUISAR_IMPLEMENTA_BASE1_002(telaEscoltaInternoPSP_B1);
    }
    ...
    public void PESQUISAR_IMPLEMENTA_BASE1_001(String pNOME_tela) {
        ...
        if (objParCrc.getHabilitarImp() != null && objParCrc.getHabilitarImp().equals("Não") && !nameUser.equals("ADMINISTRADOR DO SISTEMA")) {
            jEntregaMaterialUsoPessoal.setVisible(!true);
