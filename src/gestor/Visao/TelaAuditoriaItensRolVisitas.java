 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRolVisitas extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRolVisitas() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_LISTA_ROL WHERE IdRol='" + jIDRol.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
