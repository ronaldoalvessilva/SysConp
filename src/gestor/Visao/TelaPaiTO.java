 ...
 * @author ronaldo
 */
public class TelaPaiTO extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "Terapia Ocupacional:P.A.I.:Manutenção";
    String nomeModuloTela1 = "Terapia Ocupacional:P.A.I.:S.S.1";
    String nomeModuloTela2 = "Terapia Ocupacional:P.A.I.:S.S.2 - Familiar";
    String nomeModuloTela3 = "Terapia Ocupacional:P.A.I.:S.S.2 - Visitas";
    String nomeModuloTela4 = "Terapia Ocupacional:P.A.I.:S.S.2 - Visitas Intimas";
    String nomeModuloTela5 = "Terapia Ocupacional:P.A.I.:TO/Ped.";
    String nomeModuloTela6 = "Terapia Ocupacional:P.A.I.:PSI.";
    String nomeModuloTela7 = "Terapia Ocupacional:P.A.I.:P.M.";
    String nomeModuloTela8 = "Terapia Ocupacional:P.A.I.:EAPI";
    String nomeModuloTela9 = "Terapia Ocupacional:P.A.I.:SS3";
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: P.A.I. - Programa de Assistência Individualizada {TERAPIA OCUPACIONAL} ::::...");
    ...
    private void jBtPesquisarInternoPAIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarInternoPAIActionPerformed
        // TODO add your handling code here:
        TelaPesqInternoPAITerapiaOcupacional objPesqInternoPAI = new TelaPesqInternoPAITerapiaOcupacional();
        TelaModuloTerapiaOcupacional.jPainelTerapia.add(objPesqInternoPAI);
    ...
    private void jBtPesqVisitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqVisitaActionPerformed
        // TODO add your handling code here:
        TelaPesquisaVisitasPAITerapiaOcupacional objPesqVisita = new TelaPesquisaVisitasPAITerapiaOcupacional();
        TelaModuloTerapiaOcupacional.jPainelTerapia.add(objPesqVisita);
        objPesqVisita.show();
    ...
    private void jBtPesqVisitaIntimaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqVisitaIntimaActionPerformed
        // TODO add your handling code here:
        TelaPesquisaVisitasIntimaPAITerapiaOcupacional objPesqVisitaIntima = new TelaPesquisaVisitasIntimaPAITerapiaOcupacional();
    ...
    private void jBtPesquisarUnidadeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarUnidadeActionPerformed
        // TODO add your handling code here:
        TelaPesquisaUnidadePaiPsicoSocialTerapiaOcupacional objPesqUnid = new TelaPesquisaUnidadePaiPsicoSocialTerapiaOcupacional();
        TelaModuloTerapiaOcupacional.jPainelTerapia.add(objPesqUnid);
        objPesqUnid.show();
...
//            Logger.getLogger(TelaPai.class.getName()).log(Level.SEVERE, null, ex);
//        }
