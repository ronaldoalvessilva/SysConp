...
import static gestor.Visao.TelaAtendimentoGrupoPE.jCodigoTema;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_PLAN_PE extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_PLAN_PE() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PLANEJAMENTO_ATENDIMENTO_GRUPO_PE "
                    + "WHERE IdItemPlanPE='" + jCodigoTema.getText() + "' "
