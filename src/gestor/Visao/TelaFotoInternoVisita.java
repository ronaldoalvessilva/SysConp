 ...
 * @author ronaldo
 */
public class TelaFotoInternoVisita extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaEntradaSaidaVisitasInternos telafotointernovisita;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoInternoVisita(TelaEntradaSaidaVisitasInternos parent, boolean modal) {
        this.telafotointernovisita = parent;
        this.setModal(modal);
        setLocationRelativeTo(telafotointernovisita);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoInternoVisita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoInternoVisita dialog = new TelaFotoInternoVisita(telafotointernovisita, true);
