 ...
 * @author Ronaldo
 */
public class TelaAuditoriaDocumentosInternos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaDocumentosInternos() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Documentos Internos {SS} :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM DOCINTERNOS WHERE IdDoc='" + jIdLanc.getText() + "'");
            conecta.rs.first();
