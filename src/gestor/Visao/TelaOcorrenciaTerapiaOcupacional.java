...
import gestor.Controle.ControleOcorrenciasTerapiaOcupacional;
...
import static gestor.Visao.TelaModuloTerapiaOcupacional.telaOcorrenciaTO;
 ...
 * @author ronaldo
 */
public class TelaOcorrenciaTerapiaOcupacional extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    OcorrenciasPortaria objOcorr = new OcorrenciasPortaria();
    ControleOcorrenciasTerapiaOcupacional control = new ControleOcorrenciasTerapiaOcupacional();
    ...
    String nomeModuloTela = "Terapia Ocupacional:Movimentação:Ocorrências Diárias:Manutenção";
    String horaMov;
    String dataModFinal;
     ...
     */
    public TelaOcorrenciaTerapiaOcupacional() {
        initComponents();
        corCampos();
    ...
    private void initComponents() {
        ...
        jTabelaOcorrenciaPortaria.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoTO.equals("ADMINISTRADORES") || codigoUserTO == codUserAcessoTO && nomeTelaTO.equals(telaOcorrenciaTO) && codIncluirTO == 1) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaOcorrenciaTO);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoTO.equals("ADMINISTRADORES") || codigoUserTO == codUserAcessoTO && nomeTelaTO.equals(telaOcorrenciaTO) && codAlterarTO == 1) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaOcorrenciaTO);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoTO.equals("ADMINISTRADORES") || codigoUserTO == codUserAcessoTO && nomeTelaTO.equals(telaOcorrenciaTO) && codExcluirTO == 1) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            objOcorr.setStatusLanc(jStatusOcorrencia.getText());
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaOcorrenciaTO);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoTO.equals("ADMINISTRADORES") || codigoUserTO == codUserAcessoTO && nomeTelaTO.equals(telaOcorrenciaTO) && codGravarTO == 1) {
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        try {
            conecta.executaSQL("SELECT * FROM OCORRENCIAS_TO WHERE IdLanc='" + jIdOcorrencia.getText() + "'");
            conecta.rs.first();
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaOcorrenciasTO objAudiOcorre = new TelaAuditoriaOcorrenciasTO();
        TelaModuloTerapiaOcupacional.jPainelTerapia.add(objAudiOcorre);
        objAudiOcorre.show();
    ...
    private void jBtImpressaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtImpressaoActionPerformed
        ...
        try {
            conecta.abrirConexao();
            String path = "reports/TerapiaOcupacional/ListagemOcorrencias_TO.jasper";
            conecta.executaSQL("SELECT * FROM OCORRENCIAS_TO WHERE IdLanc='" + jIdOcorrencia.getText() + "'");
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            ...
            this.pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_TO");
        } else {
            jTabelaOcorrenciaPortaria.setVisible(!true);
        }
    ...
    private void jBtPesqTituloOcorrrenciaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtPesqTituloOcorrrenciaMouseClicked
        ...
        if (jPesqTituloOcorrencia.getText().equals("")) {
            ...
            jTabelaOcorrenciaPortaria.setVisible(true);
            pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_TO WHERE WHERE Titulo LIKE'" + jPesqTituloOcorrencia + "%'");
        }
    ...
    private void jTabelaOcorrenciaPortariaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaOcorrenciaPortariaMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM OCORRENCIAS_TO WHERE IdLanc ='" + IdLanc + "'");
                conecta.rs.first();
            ...
            if (jDataPesqInicial.getDate() == null) {
                ...
                if (jDataPesFinal.getDate() == null) {
                    ...
                    if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                        ...
                        jTabelaOcorrenciaPortaria.setVisible(true);
                        pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_TO WHERE DataLanc BETWEEN'" + dataInicial + "'AND '" + dataFinal + "'");
                    }
                }
            }
    ...
    public void buscarID() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM OCORRENCIAS_TO");
            conecta.rs.last();
