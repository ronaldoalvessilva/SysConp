...
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.pCODIGO_AVALIACAO_GRUPO_AVGI;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_AIGRU_EF extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_AIGRU_EF() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_EF "
                    + "WHERE IdItemAvaiEF='" + pCODIGO_AVALIACAO_GRUPO_AVGI + "' "
                    + "AND IdAtGrupoEF='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
