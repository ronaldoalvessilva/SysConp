 ...
 * @author Ronaldo
 */
public class TelaRelatorioConsumoProdutosInternoPorDataNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaRelatorioConsumoProdutosInternoPorDataNUTRI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Relatório Cons. de Produtos Internos Por Data :::...");
                ...
                if (jDataPesFinal.getDate() == null) {
                    ...
                    if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                        ...
                        try {
                            ...
                            String path = "reports/Nutricao/RelatorioProdutosConsumoInternosPorDataNUTRI.jasper";
                            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_PRODUTOS_NUTRI "
                                    + "INNER JOIN PRODUTOS_AC "
                                    + "ON ITENS_REQUISICAO_PRODUTOS_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                                    + "INNER JOIN REQUISICAO_PRODUTOS_NUTRI "
                                    + "ON ITENS_REQUISICAO_PRODUTOS_NUTRI.IdReq=REQUISICAO_PRODUTOS_NUTRI.IdReq "
                                    + "WHERE DataReq BETWEEN'" + dataInicial + "'AND'" + dataFinal + "' ORDER BY PRODUTOS_AC.DescricaoProd");
