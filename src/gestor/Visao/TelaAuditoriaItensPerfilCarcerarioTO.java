...
import static gestor.Visao.TelaPerfilCarcerarioTerapiaOcupacional.codigoPerfilCarcerario;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensPerfilCarcerarioTO extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensPerfilCarcerarioTO() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Perfil Carcerário :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PERFIL_CARCERARIO WHERE IdPerfilCar='" + codigoPerfilCarcerario + "'");
            conecta.rs.first();
