...
import static gestor.Visao.TelaEstornoDepositoSaqueAtivosInativos.jDataDeposito;
import static gestor.Visao.TelaEstornoDepositoSaqueAtivosInativos.jIdInternoEstorno;
import static gestor.Visao.TelaEstornoDepositoSaqueAtivosInativos.jNomeInternoEstorno;
import static gestor.Visao.TelaEstornoDepositoSaqueAtivosInativos.jIdRegistro;
import static gestor.Visao.TelaEstornoDepositoSaqueAtivosInativos.jSituacao;
import static gestor.Visao.TelaEstornoDepositoSaqueAtivosInativos.jValorDepositoSaque;
 ...
 * @author Ronaldo
 */
public class TelaPesqInternoEstornoSaqueInativo extends javax.swing.JInternalFrame {
    ...
    String valorDepositoTela = "";
    String registroDeposito = "";

    /**
     * Creates new form TelaPesquisaEntradaInternos
     */
    public TelaPesqInternoEstornoSaqueInativo() {
        initComponents();
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
           ...
           preencherTabelaNome("SELECT * FROM PRONTUARIOSCRC "
                    + "INNER JOIN SAQUE_INATIVOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=SAQUE_INATIVOS.IdInternoCrc "
        ...
        if (jPesqMatricula.getText().equals("")) {
            ...
            jPesqMatricula.requestFocus();
             ...
             buscarInternosMatricula("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "AND PRONTUARIOSCRC.SituacaoCrc!='" + situacaoEnt + "' "
                    + "OR MatriculaCrc LIKE'%" + jPesqNome.getText() + "%' "
                    + "AND PRONTUARIOSCRC.SituacaoCrc!='" + situacaoRet + "'");
        }
    ...
    private void jTabelaInternoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaInternoMouseClicked
        ...
        if (flag == 1) {
            ...
            registroDeposito = "" + jTabelaInterno.getValueAt(jTabelaInterno.getSelectedRow(), 2);
        }
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                        ...
                        + "AND IdSaqIna='" + registroDeposito + "'");
                conecta.rs.first();
                jIdInternoEstorno.setText(String.valueOf(conecta.rs.getInt("IdInternoCrc")));
                jNomeInternoEstorno.setText(conecta.rs.getString("NomeInternoCrc"));
                jSituacao.setText(conecta.rs.getString("SituacaoCrc"));
                jDataDeposito.setDate(conecta.rs.getDate("DataLanc"));
                jIdRegistro.setText(conecta.rs.getString("IdSaqIna"));
                valorDeposito = conecta.rs.getFloat("ValorSaque");
                DecimalFormat vd = new DecimalFormat("#,###0.00");
                String vlDeposito = vd.format(valorDeposito);
                jValorDepositoSaque.setText(vlDeposito);
                conecta.desconecta();
  ...
  // Método de pesquisa pela Descrição
    ...
    public void preencherTabelaNome(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Nome do Interno", "Registro", "Valor R$", "Data Cadastro"};
        conecta.abrirConexao();
        ...
        try {
            ...
            String vlDepositoSaque = vds.format(valorDeposito);
            valorDepositoTela = vlDepositoSaque;
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdInternoCrc"), conecta.rs.getString("NomeInternoCrc"), conecta.rs.getString("IdSaqIna"), valorDepositoTela, dataCadastro});
    ...
    public void buscarInternosMatricula(String sql) {
        ...
        try {
            ...
            do {
                ...
                String anoc = dataCadastro.substring(0, 4);
                dataCadastro = diac + "/" + mesc + "/" + anoc;
                dados.add(new Object[]{conecta.rs.getInt("IdInternoCrc"), conecta.rs.getString("NomeInternoCrc"), conecta.rs.getString("IdDepIna"), valorDepositoTela, dataCadastro});
            } while (conecta.rs.next());
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(rootPane, "Dados não encontrado, use o botão TODOS \nPara pesquisar TODOS OS REGISTROS");
        }
