...
import static gestor.Visao.TelaOficialJustica.caminhoFotoOffice;
import static gestor.Visao.TelaOficialJustica.FotoOficialJustica;
 ...
 * @author Ronaldo
 */
public class TelaWebCamPortaOffice extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String localFotoOficialExt = "";
     ...
     * @param modal
     */
    public static TelaOficialJustica telaOficial;

    //TESTADO E FUNCIONANDO NO DIA 02/12/2016 - EM VITÓRIA DA CONQUISTA
    public TelaWebCamPortaOffice(TelaOficialJustica parent, boolean modal) {
        this.telaOficial = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaOficial);
        initComponents();
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        localFotoOficialEX();
        if (localFotoOficialExt == null || localFotoOficialExt == "") {
            ...
            javax.swing.JFileChooser seletor = new javax.swing.JFileChooser(localFotoOficialExt);
            FileNameExtensionFilter tipoExtensao = new FileNameExtensionFilter("Imagem de Foto", "jpg", "bmp", "gif", "png");
            seletor.setAcceptAllFileFilterUsed(false);
            seletor.setMultiSelectionEnabled(false);
            seletor.setFileFilter(tipoExtensao);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaWebCamPortaOffice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaWebCamPortaOffice dialog = new TelaWebCamPortaOffice(telaOficial, true);
    ...
    public void localFotoOficialEX() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM PARAMETROSCRC");
            conecta.rs.first();
            localFotoOficialExt = conecta.rs.getString("LocalFotosOficialJustica");
        } catch (Exception e) {            
        }
        conecta.desconecta();
    }
