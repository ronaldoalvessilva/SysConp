 ...
 * @author Ronaldo
 */
public class TelaWebCamInternoTriagem extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String localFotoInterno = "";
     ...
     * @param modal
     */
    public static TelaProntuarioTriagem telaPTInterno;

    //TESTADO E FUNCIONANDO NO DIA 02/12/2016 - EM VITÓRIA DA CONQUISTA
    public TelaWebCamInternoTriagem(TelaProntuarioTriagem parent, boolean modal) {
        this.telaPTInterno = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaPTInterno);
        initComponents();
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:   
        localFotoInternos();
        if (localFotoInterno == null || localFotoInterno == "") {
            javax.swing.JFileChooser seletor = new javax.swing.JFileChooser();
            FileNameExtensionFilter tipoExtensao = new FileNameExtensionFilter("Imagem de Foto", "jpg", "gif", "png");
            ...
            javax.swing.JFileChooser seletor = new javax.swing.JFileChooser(localFotoInterno);
            FileNameExtensionFilter tipoExtensao = new FileNameExtensionFilter("Imagem de Foto", "jpg", "gif", "png");
            seletor.setAcceptAllFileFilterUsed(false);
            seletor.setMultiSelectionEnabled(false);
            seletor.setFileFilter(tipoExtensao);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaWebCamInternoTriagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaWebCamInternoTriagem dialog = new TelaWebCamInternoTriagem(telaPTInterno, true);
    ...
    public void localFotoInternos() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM PARAMETROSCRC");
            conecta.rs.first();
            localFotoInterno = conecta.rs.getString("LocalFotosInternos");
        } catch (Exception e) {
        }
        conecta.desconecta();
    }
