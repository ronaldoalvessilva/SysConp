...
import gestor.Dao.*;
import static gestor.Visao.TelaEventoDisciplinar.jFotoInternoTestemunha;
import static gestor.Visao.TelaEventoDisciplinar.jNomeMaeInternoTestemunha;
import static gestor.Visao.TelaEventoDisciplinar.jIdInternoTestemunha;
import static gestor.Visao.TelaEventoDisciplinar.jIdPav;
import static gestor.Visao.TelaEventoDisciplinar.jMatriculaInternoTestemunha;
import static gestor.Visao.TelaEventoDisciplinar.jNomeInternoTestemunha;
 ...
 * @author user
 */
public class TelaPesqInternosEventosTestemunha extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternosEventosTestemunha() {
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            jIdInternoTestemunha.setText(idFunc);//           
            ...
            try {
                ...
                conecta.rs.first();
                jIdInternoTestemunha.setText(String.valueOf(conecta.rs.getInt("IdInternoCrc")));
                ...
                jFotoInternoTestemunha.setIcon(v);
                jFotoInternoTestemunha.setIcon(new ImageIcon(v.getImage().getScaledInstance(jFotoInternoTestemunha.getWidth(), jFotoInternoTestemunha.getHeight(), Image.SCALE_DEFAULT)));
                conecta.desconecta();
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.buscarInternoVisitas("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "INNER JOIN PAVILHAO "
                    + "ON CELAS.IdPav=PAVILHAO.IdPav "
                    + "WHERE PAVILHAO.IdPav='" + jIdPav.getText() + "'");
        } else {
             limparTabela();
        }
...
//Preencher tabela com todos os COLABORADORES
    public void buscarInternoVisitas(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Nome Completo do Interno"};
        conecta.abrirConexao();
        try {
