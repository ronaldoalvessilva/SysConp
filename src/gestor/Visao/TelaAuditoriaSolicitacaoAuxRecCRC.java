...
import static gestor.Visao.TelaSolicitacaoAuxilioReclusaoCRC.jCodRegAux;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaSolicitacaoAuxRecCRC extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaSolicitacaoAuxRecCRC() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM SOLICITACAO_ATESTADO_RECLUSAO_CRC WHERE CodRegAux='" + jCodRegAux.getText() + "'");
            conecta.rs.first();
