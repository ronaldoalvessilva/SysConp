 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEvolucaoJuridico extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEvolucaoJuridico() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM EVOLUCAOJURIDICO WHERE IdEvo='" + jIdEvolucao.getText() + "'");
            conecta.rs.first();
