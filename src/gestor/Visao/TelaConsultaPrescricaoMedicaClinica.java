 ...
 * @author ronaldo
 */
public class TelaConsultaPrescricaoMedicaClinica extends javax.swing.JDialog {
    ...
    int idItem;
    int count = 0;
    int tipoPrescricao = 0; // 0 = MÉDICA, 1 = PSIQUIATRICA

    /**
     * Creates new form TelaConsultaEvolucaoPsicologia
     */
    public static TelaConsultaProntuarioInternoCrc telaProntuarioUnicoPrescricaoMEDC;

    public TelaConsultaPrescricaoMedicaClinica(TelaConsultaProntuarioInternoCrc parent, boolean modal) {
        this.telaProntuarioUnicoPrescricaoMEDC = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaProntuarioUnicoPrescricaoMEDC);
        initComponents();
        formatarCampos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaPrescricaoMedicaClinica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaConsultaPrescricaoMedicaClinica dialog = new TelaConsultaPrescricaoMedicaClinica(telaProntuarioUnicoPrescricaoMEDC, true);
    ...
    public void pesquisarData(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Data", "Prescrição Médica"};
        conecta.abrirConexao();
        try {
