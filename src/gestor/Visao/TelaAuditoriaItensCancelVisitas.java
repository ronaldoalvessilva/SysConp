...
import static gestor.Visao.TelaCancelamentoVisitasInterno.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensCancelVisitas extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensCancelVisitas() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_CANCELAMENTO_VISITAS_EXTERNA_ROL WHERE IdVisita='" + jIDVisita.getText() + "'AND IdItemCanExt='" + idItem + "'");
            conecta.rs.first();
