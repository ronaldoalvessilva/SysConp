...
import static gestor.Visao.TelaColaborador.jLocalNascimento;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaCidadeColaborador extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaCidadeColaborador() {
        initComponents();
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesNomeCidade.getText().isEmpty()) {
            ...
            TelaColaborador.jLocalNascimento.setText(jPesNomeCidade.getText());
            dispose();
        }
