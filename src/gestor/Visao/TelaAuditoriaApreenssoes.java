...
import static gestor.Visao.TelaEventoDisciplinar.idItemApreende;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaApreenssoes extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaApreenssoes() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Apreenssões :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM APRENSSOES WHERE IdLanc='" + jIdLanc.getText() + "'AND IdAprende='" + idItemApreende + "'");
            conecta.rs.first();
