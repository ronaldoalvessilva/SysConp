 ...
 * @author Ronaldo
 */
public class TelaPesqInternoTransferenciaValores extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoTransferenciaValores() {
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                ...
                String vlLiquido = sd.format(valorLiquido);
  ...
  // Método de pesquisa pela Descrição
    ...
    public void buscarInternosMatricula(String sql) {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"CódigoD", "Nome do Interno", "Matricula Penal", "Data Entrada", "Data Cadastro"};
        conecta.abrirConexao();
        conecta.executaSQL(sql);
        try {
            conecta.rs.first();
    ...
    public void calcularDebito() {
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM SALDOVALORES WHERE IdInternoCrc='" + jTabelaInterno.getValueAt(jTabelaInterno.getSelectedRow(), 0) + "' AND StatusMov='" + tipoMovDeb + "'");
            conecta.rs.first();
            do {
    ...
    public void calcularCredito() {
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM SALDOVALORES WHERE IdInternoCrc='" + jTabelaInterno.getValueAt(jTabelaInterno.getSelectedRow(), 0) + "' AND StatusMov='" + tipoMovCred + "'");
            conecta.rs.first();
            do {
