...
import static gestor.Visao.TelaPortaEntradaTO.codigoHistoricoEduca;
 ...
 */
public class TelaAuditoriaAdmNova_EDU extends javax.swing.JDialog {
     ...
     */
    public static TelaPortaEntradaTO pPORTA_ENTRADA_TO_EDU;

    public TelaAuditoriaAdmNova_EDU(TelaPortaEntradaTO parent, boolean modal) {
        this.pPORTA_ENTRADA_TO_EDU = parent;
        this.setModal(modal);
        setLocationRelativeTo(pPORTA_ENTRADA_TO_EDU);
        initComponents();
        auditoria();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAuditoriaAdmNova_EDU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAuditoriaAdmNova_EDU dialog = new TelaAuditoriaAdmNova_EDU(pPORTA_ENTRADA_TO_EDU, true);
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM TO_HISTORICO_EDUCACIONAL_NOVO "
                    ...
                    + "AND TO_HISTORICO_EDUCACIONAL_NOVO.IdHistoricoEduN='" + codigoHistoricoEduca + "'");
            conecta.rs.first();
