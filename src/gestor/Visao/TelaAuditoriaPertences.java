...
import static gestor.Visao.TelaPertences.jIDPertences;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaPertences extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Pertences Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PERTENCES WHERE IdPertence='" + jIDPertences.getText() + "'");
            conecta.rs.first();
