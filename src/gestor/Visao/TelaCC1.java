 ...
 * @author ronal
 */
public class TelaCC1 extends javax.swing.JDialog {
     ...
     */
    public static TelaAdmissaoSecundariaEnfermagem tcc;

    public TelaCC1(TelaAdmissaoSecundariaEnfermagem parent, boolean modal) {
        this.tcc = parent;
        this.setModal(modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCC1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaCC1 dialog = new TelaCC1(tcc, true);
