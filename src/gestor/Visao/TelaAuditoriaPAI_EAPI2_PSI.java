 ...
 * @author Ronaldo
 */
public class TelaAuditoriaPAI_EAPI2_PSI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaPAI_EAPI2_PSI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM FICHA_CADASTRO_PAI_EAPI2 WHERE IdPai='" + jCodigoPAI.getText() + "'");
            conecta.rs.first();
