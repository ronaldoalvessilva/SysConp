...
import static gestor.Visao.TelaCadastroDoencas.jIdLanc;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaDoenca extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Cadastro de Doenças :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM DOENCAS WHERE IdDoenca='" + jIdLanc.getText() + "'");
            conecta.rs.first();
