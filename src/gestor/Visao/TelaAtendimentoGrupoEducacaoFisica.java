...
import gestor.Controle.ControleAtendimentoGrupo_EDUCACAO_FISICA;
...
import static gestor.Visao.TelaModuloEducacaoFisica.botaoLiberar_EF;
...
import static gestor.Visao.TelaModuloEducacaoFisica.telaIndAtendimentoGrupoEF_AVG;
import static gestor.Visao.TelaModuloEducacaoFisica.telaIndAtendimentoGrupoEF_AVI;
import static gestor.Visao.TelaModuloEducacaoFisica.telaIndAtendimentoGrupoEF_Inte;
import static gestor.Visao.TelaModuloEducacaoFisica.telaIndAtendimentoGrupoEF_Manu;
import static gestor.Visao.TelaModuloEducacaoFisica.telaIndAtendimentoGrupoEF_Plan;
 ...
 */
public class TelaAtendimentoGrupoEducacaoFisica extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    AtividadesGrupoPsicologia objAvalia = new AtividadesGrupoPsicologia();
    ControleAtendimentoGrupo_EDUCACAO_FISICA control = new ControleAtendimentoGrupo_EDUCACAO_FISICA();
    ControleLogSistema controlLog = new ControleLogSistema();
    LogSistema objLogSys = new LogSistema();
    // Variáveis para gravar o log
    String nomeModuloTela = "Educação Física:Atendimento em Grupo:Manutenção";
    String nomeModuloTela2 = "Educação Física:Atendimento em Grupo:Planejamento";
    String nomeModuloTela3 = "Educação Física:Atendimento em Grupo:Participantes";
    String nomeModuloTela4 = "Educação Física:Atendimento em Grupo:Avaliação em Grupo";
    String nomeModuloTela5 = "Educação Física:Atendimento em Grupo:Avaliação Individual";
    //
    String statusMov;
    String horaMov;
    String dataModFinal;
     ...
     */
    public static TelaLiberacaoAtendimentoGruposEF pATENDE_GRUPO;
    public static TelaSelecaoLoteInternosAG_EF pPESQUISA_LOTE;

    public TelaAtendimentoGrupoEducacaoFisica() {
        initComponents();
        corCampos();
        formatarCampos();
    }
    ...
    public void mostrarTelaAG() {
        pATENDE_GRUPO = new TelaLiberacaoAtendimentoGruposEF(this, true);
        pATENDE_GRUPO.setVisible(true);
    }

    public void mostrarPesquisaLote() {
        pPESQUISA_LOTE = new TelaSelecaoLoteInternosAG_EF(this, true);
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jComboBoxTema, javax.swing.GroupLayout.PREFERRED_SIZE, 18, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jBtIDPesqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtIDPesqActionPerformed
        ...
        if (jIDPesq.getText().equals("")) {
            ...
            preencherTabelaAtividadeGRU("SELECT * FROM ATENDIMENTO_GRUPO_EF "
                    + "INNER JOIN PAVILHAO "
                    + "ON ATENDIMENTO_GRUPO_EF.IdPav=PAVILHAO.IdPav "
                    + "WHERE IdAtGrupoEF='" + jIDPesq.getText() + "'");
        }
    ...
    private void jBtPesquisarInternosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarInternosActionPerformed
        ...
        if (jPesqNomeInterno.getText().equals("")) {
            ...
            preencherTabelaAtividadeGRU("SELECT * FROM ATENDIMENTO_GRUPO_EF "
                    + "INNER JOIN PARTICIPANTES_ATENDIMENTO_GRUPO_EF "
                    + "ON ATENDIMENTO_GRUPO_EF.IdAtGrupoEF=PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN PAVILHAO "
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaAtividadeGRU("SELECT * FROM ATENDIMENTO_GRUPO_EF "
                    + "INNER JOIN PAVILHAO "
                    + "ON ATENDIMENTO_GRUPO_EF.IdPav=PAVILHAO.IdPav");
        } else {
    ...
    private void jTabelaAdmissaoPsicologicaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaAdmissaoPsicologicaMouseClicked
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM ATENDIMENTO_GRUPO_EF "
                        + "INNER JOIN PAVILHAO "
                        + "ON ATENDIMENTO_GRUPO_EF.IdPav=PAVILHAO.IdPav "
                        + "WHERE ATENDIMENTO_GRUPO_EF.IdAtGrupoEF='" + IdLanc + "'");
                conecta.rs.first();
                jCodigoAtend.setText(String.valueOf(conecta.rs.getInt("IdAtGrupoEF")));
            ...
            //ABA PLANEJAMENTO
            preencherTabelaPlanejamento("SELECT * FROM PLANEJAMENTO_ATENDIMENTO_GRUPO_EF "
                    + "INNER JOIN ATENDIMENTO_GRUPO_EF "
                    + "ON PLANEJAMENTO_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF=ATENDIMENTO_GRUPO_EF.IdAtGrupoEF "
                    + "WHERE PLANEJAMENTO_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF='" + IdLanc + "'");
            //ABA PARTICIPANTES
            preencherTabelaParticipantes("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_EF "
                    + "INNER JOIN ATENDIMENTO_GRUPO_EF "
                    + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF=ATENDIMENTO_GRUPO_EF.IdAtGrupoEF "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
                    + "WHERE PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF='" + IdLanc + "'");
            //ABA AVALIAÇÃO EM GRUIPO
            buscarAvaliacaoGrupo();
            //ABA AVALIAÇÃO INDIVIDUAL
            preencherTabelaAvaliacaoIndividual("SELECT * FROM AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_EF "
                    + "INNER JOIN ATENDIMENTO_GRUPO_EF "
                    + "ON AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF=ATENDIMENTO_GRUPO_EF.IdAtGrupoEF "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_EF.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
                    + "WHERE AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF='" + jCodigoAtend.getText() + "'");
        }
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_Manu) && codIncluirEF == 1) {
            acao = 1;
            bloquearTodosCampos();
            bloquearTodosBotoes();
            limparTodosCampos();
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_Manu);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_Manu) && codAlterarEF == 1) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_Manu);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_Manu) && codExcluirEF == 1) {
            objAvalia.setStatusAtendGrupo(jStatusAtend.getText());
            if (jStatusAtend.getText().equals("FINALIZADO")) {
                        ...
                        if (jCodigoAtend.getText().equals(pCODIGO_ATENDE_PLAN)
                            ...
                            if (jStatusAtend.getText().equals("FINALIZADO")) {
                                ...
                                if (resposta == JOptionPane.YES_OPTION) {
                                    ...
                                    control.excluirAtendimentoGrupoManutencaoEF(objAvalia);
                                    objLog();
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_Manu);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_Manu) && codGravarEF == 1) {
            if (jComboBoxPavilhaoGaleria.getSelectedItem().equals("Selecione...")) {
                ...
                if (acao == 1) {
                    ...
                    //
                    control.incluirAtendimentoGrupoManutencaoEF(objAvalia);
                ...
                if (acao == 2) {
                    ...
                    //
                    objAvalia.setIdAtGrupoPsi(Integer.valueOf(jCodigoAtend.getText()));
                    control.alterarAtendimentoGrupoManutencaoEF(objAvalia);
                    objLog();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    bloquearTodosBotoes();
                    bloquearTodosCampos();
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaRegistroAtendGrupo_MANU_EF objAudMa = new TelaAuditoriaRegistroAtendGrupo_MANU_EF();
        TelaModuloEducacaoFisica.jPainelEducacaoFisica.add(objAudMa);
        objAudMa.show();
    ...
    private void jBtNovoPlanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoPlanActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_Plan);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_Plan) && codIncluirEF == 1) {
            objAvalia.setStatusAtendGrupo(jStatusAtend.getText());
            if (jStatusAtend.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtAlterarPlanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarPlanActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_Plan);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_Plan) && codAlterarEF == 1) {
            objAvalia.setStatusAtendGrupo(jStatusAtend.getText());
            if (jStatusAtend.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtExcluirPlanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirPlanActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_Plan);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_Plan) && codExcluirEF == 1) {
            objAvalia.setStatusAtendGrupo(jStatusAtend.getText());
            if (jStatusAtend.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser excluído, o mesmo encontra-se FINALIZADO");
            } else {
                ...
                if (nomeUserRegistro == null ? nameUser == null : nomeUserRegistro.equals(nameUser)) {
                    ...
                    if (jStatusAtend.getText().equals("FINALIZADO")) {
                        ...
                        if (resposta == JOptionPane.YES_OPTION) {
                            ...
                            control.excluirPlanejamentoEF(objAvalia);
                            objLog2();
                            controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                            bloquearTodosCampos();
                            bloquearTodosBotoes();
                            ...
                            preencherTabelaPlanejamento("SELECT * FROM PLANEJAMENTO_ATENDIMENTO_GRUPO_EF "
                                    + "INNER JOIN ATENDIMENTO_GRUPO_EF "
                                    + "ON PLANEJAMENTO_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF=ATENDIMENTO_GRUPO_EF.IdAtGrupoEF "
                                    + "WHERE PLANEJAMENTO_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF='" + jCodigoAtend.getText() + "'");
                            JOptionPane.showMessageDialog(rootPane, "Registro excluído com sucesso.");
                        }
                    }
                } else {
    ...
    private void jBtSalvarPlanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarPlanActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_Plan);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_Plan) && codGravarEF == 1) {
            if (jComboBoxTema.getSelectedItem().equals("")) {
                ...
                if (acao == 3) {
                    ...
                    objAvalia.setDataInsert(dataModFinal);
                    objAvalia.setHorarioInsert(horaMov);
                    control.incluirPlanejamentoEF(objAvalia);
                ...
                if (acao == 4) {
                    ...
                    //
                    objAvalia.setIdItemPlan(Integer.valueOf(jCodigoTema.getText()));
                    control.alterarPlanejamentoEF(objAvalia);
                    objLog2();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    bloquearTodosCampos();
                    bloquearTodosBotoes();
    ...
    private void jBtAuditoriaPlanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaPlanActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaRegistroAtendGrupo_PLAN_EF objAudiPlan = new TelaAuditoriaRegistroAtendGrupo_PLAN_EF();
        TelaModuloEducacaoFisica.jPainelEducacaoFisica.add(objAudiPlan);
        objAudiPlan.show();
    ...
    private void jTabelaPlanejamentoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaPlanejamentoMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM PLANEJAMENTO_ATENDIMENTO_GRUPO_EF "
                        + "INNER JOIN ATENDIMENTO_GRUPO_EF "
                        + "ON PLANEJAMENTO_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF=ATENDIMENTO_GRUPO_EF.IdAtGrupoEF "
                        + "WHERE PLANEJAMENTO_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF='" + jCodigoAtend.getText() + "' "
                        + "AND PLANEJAMENTO_ATENDIMENTO_GRUPO_EF.IdItemPlanEF='" + pCODIGO_PLAN + "'");
                conecta.rs.first();
                jCodigoTema.setText(conecta.rs.getString("IdItemPlanEF"));
    ...
    private void jBtNovoParticipantesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoParticipantesActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_Inte);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_Inte) && codIncluirEF == 1) {
            objAvalia.setStatusAtendGrupo(jStatusAtend.getText());
            if (jStatusAtend.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtAlterarParticipantesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarParticipantesActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_Inte);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_Inte) && codAlterarEF == 1) {
            objAvalia.setStatusAtendGrupo(jStatusAtend.getText());
            if (jStatusAtend.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtExcluirParticipantesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirParticipantesActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_Inte);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_Inte) && codExcluirEF == 1) {
            objAvalia.setStatusAtendGrupo(jStatusAtend.getText());
            if (jStatusAtend.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser excluído, o mesmo encontra-se FINALIZADO");
            } else {
                ...
                if (nomeUserRegistro == null ? nameUser == null : nomeUserRegistro.equals(nameUser)) {
                    ...
                    if (jStatusAtend.getText().equals("FINALIZADO")) {
                        ...
                        if (resposta == JOptionPane.YES_OPTION) {
                            ...
                            control.excluirAtendimentoGrupoParticipantesEF(objAvalia);
                            objLog3();
                            controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                            bloquearTodosCampos();
                            bloquearTodosBotoes();
                            ...
                            preencherTabelaParticipantes("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_EF "
                                    ...
                                    + "INNER JOIN DADOSPENAISINTERNOS "
                                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
                                    + "WHERE PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF='" + jCodigoAtend.getText() + "'");
    ...
    private void jBtSalvarParticipantesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarParticipantesActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_Inte);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_Inte) && codGravarEF == 1) {
            if (jIdInternoGrp.getText().equals("")) {
                ...
                if (acao == 5) {
                    ...
                    objAvalia.setHorarioInsert(horaMov);
                    //
                    control.incluirAtendimentoGrupoParticipantesEF(objAvalia);
                    ...
                    preencherTabelaParticipantes("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_EF "
                            + "INNER JOIN ATENDIMENTO_GRUPO_EF "
                            + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF=ATENDIMENTO_GRUPO_EFIdAtGrupoEF "
                            + "INNER JOIN PRONTUARIOSCRC "
                            + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                            + "INNER JOIN DADOSPENAISINTERNOS "
                            + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
                ...
                if (acao == 6) {
                    ...
                    objAvalia.setHorarioInsert(horaMov);
                    objAvalia.setIdItemPart(pCODIGO_ITEM_PARTICIPANTE);
                    control.alterarAtendimentoGrupoParticipantesEF(objAvalia);
                    objLog3();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    bloquearTodosCampos();
                    bloquearTodosBotoes();
    ...
    private void jBtAuditoriaParticipantesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaParticipantesActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaRegistroAtendGrupo_PART_EF objAudi_PART = new TelaAuditoriaRegistroAtendGrupo_PART_EF();
        TelaModuloEducacaoFisica.jPainelEducacaoFisica.add(objAudi_PART);
        objAudi_PART.show();
    ...
    private void jBtPesquisarPartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarPartActionPerformed
        // TODO add your handling code here:
        TelaPesqInternoAtendimentoGrupoEF objPesqInterno = new TelaPesqInternoAtendimentoGrupoEF();
        TelaModuloEducacaoFisica.jPainelEducacaoFisica.add(objPesqInterno);
        objPesqInterno.show();
    ...
    private void jTabelaInternosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaInternosMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_EF "
                        + "INNER JOIN ATENDIMENTO_GRUPO_EF "
                        + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF=ATENDIMENTO_GRUPO_EF.IdAtGrupoEF "
                        + "INNER JOIN PRONTUARIOSCRC "
                        + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                        ...
                        + "WHERE PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdItemPartEF='" + pCODIGO_PART + "'");
                conecta.rs.first();
                pCODIGO_ITEM_PARTICIPANTE = conecta.rs.getInt("IdItemPartEF");
    ...
    private void jBtNovoAvGrupoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoAvGrupoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_AVG);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_AVG) && codIncluirEF == 1) {
            objAvalia.setStatusAtendGrupo(jStatusAtend.getText());
            if (jStatusAtend.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtAlterarAvGrupoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarAvGrupoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_AVG);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_AVG) && codAlterarEF == 1) {
            objAvalia.setStatusAtendGrupo(jStatusAtend.getText());
            if (jStatusAtend.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtExcluirAvGrupoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirAvGrupoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_AVG);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_AVG) && codExcluirEF == 1) {
            objAvalia.setStatusAtendGrupo(jStatusAtend.getText());
            if (jStatusAtend.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser excluído, o mesmo encontra-se FINALIZADO");
            } else {
                ...
                if (nomeUserRegistro == null ? nameUser == null : nomeUserRegistro.equals(nameUser)) {
                    ...
                    if (jStatusAtend.getText().equals("FINALIZADO")) {
                        ...
                        if (resposta == JOptionPane.YES_OPTION) {
                            ...
                            control.excluirAtendimentoGrupoAVGEF(objAvalia);
                            objLog4();
                            controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                            bloquearTodosCampos();
                            bloquearTodosBotoes();
    ...
    private void jBtSalvarAvGrupoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarAvGrupoActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_AVG);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_AVG) && codGravarEF == 1) {
            objAvalia.setIdAtGrupoPsi(Integer.valueOf(jCodigoAtend.getText()));
            ...
            if (acao == 7) {
                ...
                if (pCODIGO_AVALIACAO_GRUPO_AVG == objAvalia.getIdItemAvag()) {
                    ...
                    objAvalia.setHorarioInsert(horaMov);
                    //
                    control.incluirAtendimentoGrupoAVGEF(objAvalia);
                    buscarCodigoAVG();
                    objLog4();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    bloquearTodosCampos();
            ...
            if (acao == 8) {
                ...
                //
                objAvalia.setIdItemAvag(pCODIGO_AVALIACAO_GRUPO);
                control.alterarAtendimentoGrupoAVGEF(objAvalia);
                objLog4();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                bloquearTodosCampos();
                bloquearTodosBotoes();
    ...
    private void jBtAuditoriaAvGrupoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaAvGrupoActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaRegistroAtendGrupo_AGRU_EF objAudi_AG = new TelaAuditoriaRegistroAtendGrupo_AGRU_EF();
        TelaModuloEducacaoFisica.jPainelEducacaoFisica.add(objAudi_AG);
        objAudi_AG.show();
    ...
    private void jBtNovoAvIndActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoAvIndActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_AVI);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_AVI) && codIncluirEF == 1) {
            objAvalia.setStatusAtendGrupo(jStatusAtend.getText());
            if (jStatusAtend.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtAlterarAvIndActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarAvIndActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_AVI);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_AVI) && codAlterarEF == 1) {
            objAvalia.setStatusAtendGrupo(jStatusAtend.getText());
            if (jStatusAtend.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtExcluirAvIndActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirAvIndActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_AVI);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_AVI) && codExcluirEF == 1) {
            objAvalia.setStatusAtendGrupo(jStatusAtend.getText());
            if (jStatusAtend.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser excluído, o mesmo encontra-se FINALIZADO");
            } else {
                ...
                if (nomeUserRegistro == null ? nameUser == null : nomeUserRegistro.equals(nameUser)) {
                    ...
                    if (jStatusAtend.getText().equals("FINALIZADO")) {
                        ...
                        if (resposta == JOptionPane.YES_OPTION) {
                            ...
                            control.excluirAtendimentoGrupoAVGIEF(objAvalia);
                            objLog5();
                            controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                            bloquearTodosCampos();
                            bloquearTodosBotoes();
    ...
    private void jBtSalvarAvIndActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarAvIndActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaIndAtendimentoGrupoEF_AVI);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaIndAtendimentoGrupoEF_AVI) && codGravarEF == 1) {
            if (jIdInternoAI.getText().equals("")) {
                ...
                if (acao == 9) {
                    ...
                    objAvalia.setHorarioInsert(horaMov);
                    //
                    control.incluirAtendimentoGrupoAVGIEF(objAvalia);
                    buscarCodigoAVI();
                    objLog5();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    bloquearTodosCampos();
                ...
                if (acao == 10) {
                    ...
                    //
                    objAvalia.setIdItemAvai(pCODIGO_AVALIACAO_GRUPO_AVGI);
                    control.alterarAtendimentoGrupoAVGIEF(objAvalia);
                    buscarCodigoAVI();
                    objLog5();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    bloquearTodosCampos();
    ...
    private void jBtAuditoriaAvIndActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaAvIndActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaRegistroAtendGrupo_AIGRU_EF objAudi_AIG = new TelaAuditoriaRegistroAtendGrupo_AIGRU_EF();
        TelaModuloEducacaoFisica.jPainelEducacaoFisica.add(objAudi_AIG);
        objAudi_AIG.show();
    ...
    private void jBtPesqInternoAVIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqInternoAVIActionPerformed
        // TODO add your handling code here:
        TelaPesqInternoAtendimentoGrupoAVI_EF objPesqIntAVI = new TelaPesqInternoAtendimentoGrupoAVI_EF();
        TelaModuloEducacaoFisica.jPainelEducacaoFisica.add(objPesqIntAVI);
        objPesqIntAVI.show();
    ...
    private void jTabelaInternosAvIndividualMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaInternosAvIndividualMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_EF "
                        + "INNER JOIN ATENDIMENTO_GRUPO_EF "
                        + "ON AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF=ATENDIMENTO_GRUPO_EF.IdAtGrupoEF "
                        + "INNER JOIN PRONTUARIOSCRC "
                        + "ON AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_EF.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                        ...
                        + "INNER JOIN PAVILHAO "
                        + "ON CELAS.IdPav=PAVILHAO.IdPav "
                        + "WHERE AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_EF.IdItemAvaiEF='" + pCODIGO_AVI + "'");
                conecta.rs.first();
                pCODIGO_AVALIACAO_GRUPO_AVGI = conecta.rs.getInt("IdItemAvaiEF");
    ...
    private void jBtLiberarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtLiberarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(botaoLiberar_EF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(botaoLiberar_EF) && codAbrirEF == 1) {
    ...
    private void jBtImpressaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtImpressaoActionPerformed
        ...
        if (row0 == 0) {
            ...
            try {
                conecta.abrirConexao();
                String path = "reports/EducacaoFisica/RelatorioAtendimentoGrupoInternosEF.jasper";
                conecta.executaSQL("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_EF "
                        + "INNER JOIN ATENDIMENTO_GRUPO_EF "
                        + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF=ATENDIMENTO_GRUPO_EF.IdAtGrupoEF "
                        + "INNER JOIN PRONTUARIOSCRC "
                ...
                jv.setTitle("Relatório Atividades em Grupo - Educação Física");
    ...
    private void jBtLiberadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtLiberadorActionPerformed
        ...
        if (jCodigoAtend.getText().equals("")) {
            ...
            TelaLiberadorRegistroAtendGrupoEF objLibera = new TelaLiberadorRegistroAtendGrupoEF();
    ...
    private void jBtLocalizarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtLocalizarInternoActionPerformed
        ...
        if (row == 0) {
            ...
            TelaLocalizarParticipantes_EF objLocal = new TelaLocalizarParticipantes_EF();
            TelaModuloEducacaoFisica.jPainelEducacaoFisica.add(objLocal);
            objLocal.show();
        }
    ...
    public void buscarCodigoManutencao() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM ATENDIMENTO_GRUPO_EF");
            conecta.rs.last();
            jCodigoAtend.setText(conecta.rs.getString("IdAtGrupoEF"));
        } catch (Exception e) {
    ...
    public void verificarRegistros() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM PLANEJAMENTO_ATENDIMENTO_GRUPO_EF "
                    + "WHERE IdAtGrupoEF='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
            pCODIGO_ATENDE_PLAN = conecta.rs.getString("IdAtGrupoEF");
        } catch (Exception e) {
        }
        //PARTICIPANTES
        try {
            conecta.executaSQL("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_EF "
                    + "WHERE IdAtGrupoEF='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
            pCODIGO_ATENDE_PART = conecta.rs.getString("IdAtGrupoEF");
        } catch (Exception e) {
        }
        //AVALIAÇÃO EM GRUPO
        try {
            conecta.executaSQL("SELECT * FROM AVALICAO_ATENDIMENTO_GRUPO_EF "
                    + "WHERE IdAtGrupoEF='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
            pCODIGO_ATENDE_AVAG = conecta.rs.getString("IdAtGrupoEF");
        } catch (Exception e) {
        }
        //AVALIAÇÃO INDIVIDUAL
        try {
            conecta.executaSQL("SELECT * FROM AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_EF "
                    + "WHERE IdAtGrupoEF='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
            pCODIGO_ATENDE_AVAI = conecta.rs.getString("IdAtGrupoEF");
        } catch (Exception e) {
        }
        conecta.desconecta();
    }
    ...
    public void buscarCodigoAVG() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM AVALICAO_ATENDIMENTO_GRUPO_EF");
            conecta.rs.last();
            pCODIGO_AVALIACAO_GRUPO = conecta.rs.getInt("IdItemAvagEF");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(rootPane, "Não foi possível obter código do registro.");
        }
        conecta.desconecta();
    ...
    public void buscarAvaliacaoGrupo() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM AVALICAO_ATENDIMENTO_GRUPO_EF "
                    + "INNER JOIN ATENDIMENTO_GRUPO_EF "
                    + "ON AVALICAO_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF=ATENDIMENTO_GRUPO_EF.IdAtGrupoEF "
                    + "WHERE AVALICAO_ATENDIMENTO_GRUPO_EF.IdAtGrupoEF='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
            pCODIGO_AVALIACAO_GRUPO = conecta.rs.getInt("IdItemAvagEF");
    ...
    public void verificarExistenciaRegistroAVG() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM AVALICAO_ATENDIMENTO_GRUPO_EF "
                    + "WHERE IdAtGrupoEF='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
            pCODIGO_AVALIACAO_GRUPO_AVG = conecta.rs.getInt("IdAtGrupoEF");
        } catch (Exception e) {
        }
        conecta.desconecta();
    }
    ...
    public void preencherTabelaAtividadeGRU(String sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdAtGrupoEF"), dataEntrada, conecta.rs.getString("StatusAtendGrupo"), conecta.rs.getString("DescricaoPav"), conecta.rs.getString("LocalAtividade")});
            } while (conecta.rs.next());
        } catch (SQLException ex) {
    ...
    public void preencherTabelaPlanejamento(String sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdItemPlanEF"), conecta.rs.getString("HoraInicio"), conecta.rs.getString("HoraTermino"), conecta.rs.getString("Atividades"), conecta.rs.getString("Recursos")});
            } while (conecta.rs.next());
        } catch (SQLException ex) {
        }
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
    ...
    public void preencherTabelaParticipantes(String sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdItemPartEF"), conecta.rs.getInt("IdInternoCrc"), conecta.rs.getString("Cnc"), conecta.rs.getString("NomeInternoCrc"), conecta.rs.getString("Regime")});
            } while (conecta.rs.next());
        } catch (SQLException ex) {
        }
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
    ...
    public void preencherTabelaAvaliacaoIndividual(String sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdItemAvaiEF"), conecta.rs.getInt("IdInternoCrc"), conecta.rs.getString("Cnc"), conecta.rs.getString("NomeInternoCrc"), conecta.rs.getString("Regime")});
            } while (conecta.rs.next());
        } catch (SQLException ex) {
        }
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
