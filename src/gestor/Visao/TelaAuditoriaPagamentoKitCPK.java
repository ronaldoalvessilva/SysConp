 ...
 * @author Ronaldo
 */
public class TelaAuditoriaPagamentoKitCPK extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados(); 
    /**
     * Creates new form TelaAuditoriaRolInternas
     */
    public TelaAuditoriaPagamentoKitCPK() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Pagamento do Kit de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PAGAMENTO_KIT_INTERNOS WHERE IdPagto='" + jIdLanc.getText() + "'");
            conecta.rs.first();
