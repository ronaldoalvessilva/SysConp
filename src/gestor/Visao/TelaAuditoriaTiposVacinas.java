...
import static gestor.Visao.TelaTiposProcedimentos.jCodigoExame;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaTiposVacinas extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaTiposVacinas() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Tipos de Vacinas :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM PROCEDIMENTOS_ODONTOLOGICO WHERE IdProcOdonto='" + jCodigoExame.getText() + "'");
            conecta.rs.first();
