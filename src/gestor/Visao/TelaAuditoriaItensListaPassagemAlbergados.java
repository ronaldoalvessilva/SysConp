 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensListaPassagemAlbergados extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensListaPassagemAlbergados() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Lista Passagem de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_LISTA_PASSAGEM_ALBERGADOS WHERE IdAgenda='" + jIDAgenda.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
