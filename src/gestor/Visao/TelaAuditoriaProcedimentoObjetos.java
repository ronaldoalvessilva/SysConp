...
import static gestor.Visao.TelaRegistroObjetosProcedimentos.IdObjPro;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaProcedimentoObjetos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaProcedimentoObjetos() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Objetos/Procedimento :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSOBJETOSPROCEDIMENTO WHERE IdProc='" + jIdLanc.getText() + "'AND IdObjPro='" + IdObjPro + "'");
            conecta.rs.first();
