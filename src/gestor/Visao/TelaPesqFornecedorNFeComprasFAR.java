 ...
 * @author user
 */
public class TelaPesqFornecedorNFeComprasFAR extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqFornecedorNFeComprasFAR() {
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM FORNECEDORES_AC WHERE RazaoSocial='" + jPesqNomeFornecedor.getText() + "'AND Modulo='" + modulo + "'");
                conecta.rs.first();
    ...
    public void preencherTabelaLocais(String sql) {
        ...
        alinharTabelaFornecedores();
        conecta.desconecta();
    }

    public void alinharTabelaFornecedores() {
    ...
    public void limparTelaFornecedores() {
        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Código", "Status", "Nome do Fornecedor"};
        ModeloTabela modelo = new ModeloTabela(dados, Colunas);
        jTabelaFornecedores.setModel(modelo);
