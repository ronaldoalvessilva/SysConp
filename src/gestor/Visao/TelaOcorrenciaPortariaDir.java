 ...
 * @author ronaldo
 */
public class TelaOcorrenciaPortariaDir extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    OcorrenciasPortaria objOcorr = new OcorrenciasPortaria();
    ControleOcorrenciasPortaria control = new ControleOcorrenciasPortaria();
     ...
     */
    public TelaOcorrenciaPortariaDir() {
        initComponents();
        corCampos();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("OCORRÊNCIAS PORTARIA");
    ...
    private void jBtPesqCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoActionPerformed
        ...
        if (jCodigo.getText().equals("")) {
            ...
            pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_P1 WHERE IdLanc='" + jCodigo.getText() + "'");
        }
        ...
        if (jDataPesqInicial.getDate() == null) {
            ...
            if (jDataPesFinal.getDate() == null) {
                ...
                if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                    ...
                    pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_P1 WHERE DataLanc BETWEEN'" + dataInicial + "'AND '" + dataFinal + "'");
                }
            }
        }
    ...
    private void jBtPesqTituloOcorrrenciaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtPesqTituloOcorrrenciaMouseClicked
        ...
        if (jPesqTituloOcorrencia.getText().equals("")) {
            ...
            pesquisarOcorrrencias("SELECT * FROM OCORRENCIAS_P1 WHERE WHERE Titulo LIKE'" + jPesqTituloOcorrencia + "%'");
        }
