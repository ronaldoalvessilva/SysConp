...
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.jIdLocalOrigem;
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.jDescricaoLocalOrigem;
 ...
 * @author user
 */
public class TelaPesqLocalArmazenamentoENFAR extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqLocalArmazenamentoENFAR() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Locais de Armazenamento {ENF} :::...");
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqDescricaoLocal.getText().isEmpty()) {
            ...
            try {
                ...
                conecta.rs.first();
                jIdLocalOrigem.setText(String.valueOf(conecta.rs.getInt("IdLocal")));
    ...
    public void preencherTabelaProdutos(String sql) {
        ...
        alinharCamposTabelaLocais();
        conecta.desconecta();
    }

    public void alinharCamposTabelaLocais() {
