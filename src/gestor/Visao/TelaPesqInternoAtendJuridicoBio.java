...
import static gestor.Visao.TelaAtendimentoJuridico.jDataNascInternoJuri;
import static gestor.Visao.TelaAtendimentoJuridico.jNomeInternoJuridico;
import static gestor.Visao.TelaAtendimentoJuridico.jFotoInternoJuridico;
import static gestor.Visao.TelaAtendimentoJuridico.jIDInternoJuridico;
import static gestor.Visao.TelaAtendimentoJuridico.jMatriculaPenaJuridico;
import static gestor.Visao.TelaAtendimentoJuridico.jDataCondIntJuri;
 ...
 * @author Ronaldo
 */
public class TelaPesqInternoAtendJuridicoBio extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoAtendJuridicoBio() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Pesquisa de Internos {JU} :::...");
    ...
    public void procurarDepartamento() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM DEPARTAMENTOS "
                    + "WHERE NomeDepartamento='" + nomeModuloJURIDICO + "'");
            conecta.rs.first();
