 ...
 * @author ronaldo
 */
public class TelaSaqueBancario extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "Controle Valores:SaqueValores:Manutenção";
    String statusMov;
    String horaMov;
    String dataModFinal;
     ...
     */
    public static TelaReciboSaqueInterno telaReciboSaque;

    public TelaSaqueBancario() {
        super();
        initComponents();
        setResizable(false);
        formatarCampos();
    ...
    public void mostrarTelaRecibo() {
        ...
        telaReciboSaque = new TelaReciboSaqueInterno(this, true);
        telaReciboSaque.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true), "Débito", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 0, 0))); // NOI18N
        ...
        jBtPesqVisitasInternos.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jBtPesqVisitasInternos.setForeground(new java.awt.Color(0, 153, 0));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Foto do Interno", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 0, 0))); // NOI18N
        ...
        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Foto Visita", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(0, 0, 255))); // NOI18N
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        if (resposta == JOptionPane.YES_OPTION) {
            ...
            control.finalizarSaque(objSaque);
    ...
    private void jBtPesqCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoActionPerformed
        ...
        if (jIdPesqDep.getText().equals("")) {
            ...
            preencherTabelaDeposito("SELECT * FROM SAQUE "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON SAQUE.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "WHERE IdSaq='" + jIdPesqDep.getText() + "'");
        }
    ...
    private void jCheckBoxTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaDeposito("SELECT * FROM SAQUE "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON SAQUE.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc");
        } else {
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM SAQUE "
                        ...
                        + "ON SAQUE.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
                        + "WHERE IdSaq='" + jIdPesqDep.getText() + "'");
                conecta.rs.first();
                jIdLanc.setText(String.valueOf(conecta.rs.getInt("IdSaq")));
    ...
    private void jBtPesqInternoSaqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqInternoSaqueActionPerformed
        // TODO add your handling code here:
        TelaPesqInternoSaque objSaq = new TelaPesqInternoSaque();
        TelaModuloFinanceiro.jPainelFinanceiro.add(objSaq);
        objSaq.show();
    }//GEN-LAST:event_jBtPesqInternoSaqueActionPerformed

    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaSaque objAudSaqu = new TelaAuditoriaSaque();
        TelaModuloFinanceiro.jPainelFinanceiro.add(objAudSaqu);
        objAudSaqu.show();
    ...
    private void jBtPesqVisitasInternosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqVisitasInternosActionPerformed
        ...
        TelaPesqVisitasInternoRolFinanceiro objVisitasInternos = new TelaPesqVisitasInternoRolFinanceiro();
        TelaModuloFinanceiro.jPainelFinanceiro.add(objVisitasInternos);
    ...
    public void buscarId() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM SAQUE");
            conecta.rs.last();
            jIdLanc.setText(conecta.rs.getString("IdSaq"));
    ...
    public void preencherTabelaDeposito(String sql) {
        ...
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdSaq"), conecta.rs.getString("StatusLanc"), dataSaq, conecta.rs.getString("NomeInternoCrc")});
            } while (conecta.rs.next());
        } catch (SQLException ex) {
