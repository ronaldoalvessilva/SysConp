...
import static gestor.Visao.TelaControleDepositoSeguranca.jBtAlterarInterno;
import static gestor.Visao.TelaControleDepositoSeguranca.jBtBuscarInterno;
import static gestor.Visao.TelaControleDepositoSeguranca.jBtCancelarInterno;
import static gestor.Visao.TelaControleDepositoSeguranca.jBtExcluirInterno;
import static gestor.Visao.TelaControleDepositoSeguranca.jIdLanc;
import static gestor.Visao.TelaControleDepositoSeguranca.jBtSalvarInterno;
import static gestor.Visao.TelaControleDepositoSeguranca.jDataDeposito;
import static gestor.Visao.TelaControleDepositoSeguranca.jIdInterno;
import static gestor.Visao.TelaControleDepositoSeguranca.jNomeInterno;
import static gestor.Visao.TelaControleDepositoSeguranca.jValor;
 ...
 * @author user
 */
public class TelaPesqInternosDepositoControlSeguranca extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternosDepositoControlSeguranca() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa Internos Depósitos - {SE} :::...");
        ...
        jTabelaPesqInternos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome do Interno", "Valor R$", "Data Entrada"
            }
        ));
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jPesqNomeInterno.getText().equals("")) {
            ...
            buscarInternos("SELECT * FROM ITENSDEPOSITOPORTARIA "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON ITENSDEPOSITOPORTARIA.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
...
//Preencher tabela com todos os VISITANTES
    public void buscarInternos(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Nome do Interno", " Valor R$", "Data Entrada"};
        conecta.abrirConexao();
        try {
            ...
            dataEntrada = conecta.rs.getString("DataDeposito");
            String dia = dataEntrada.substring(8, 10);
            String mes = dataEntrada.substring(5, 7);
            String ano = dataEntrada.substring(0, 4);
            dataEntrada = dia + "/" + mes + "/" + ano;
            do {
                dados.add(new Object[]{conecta.rs.getInt("IdInternoCrc"), conecta.rs.getString("NomeInternoCrc"), vlDeposito, dataEntrada});
    ...
    public void alinharCamposTabelaInternos() {
        ...
        jTabelaPesqInternos.getColumnModel().getColumn(2).setCellRenderer(direita);
