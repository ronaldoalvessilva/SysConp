 ...
 */
public class TelaAuditoriaGrupoArmas extends javax.swing.JDialog {
     ...
     */
    public static TelaGrupoArmas pTELA_GRUPO_arms;

    public TelaAuditoriaGrupoArmas(TelaGrupoArmas parent, boolean modal) {
        this.pTELA_GRUPO_arms = parent;
        this.setModal(modal);
        setLocationRelativeTo(pTELA_GRUPO_arms);
        initComponents();
        auditoria();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAuditoriaGrupoArmas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAuditoriaGrupoArmas dialog = new TelaAuditoriaGrupoArmas(pTELA_GRUPO_arms, true);
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM GRUPO_ARMAS WHERE IdGrupoArm='" + jCodigoGrupo.getText() + "'");
            conecta.rs.first();
