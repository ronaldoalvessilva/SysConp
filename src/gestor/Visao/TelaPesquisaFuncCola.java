...
import static gestor.Visao.TelaColaborador.caminho;
import static gestor.Visao.TelaColaborador.jNomeCargo;
import static gestor.Visao.TelaColaborador.jNomeDepartamento;
import static gestor.Visao.TelaColaborador.jComboBoxEscolaridade;
import static gestor.Visao.TelaColaborador.jComboBoxSexo;
import static gestor.Visao.TelaColaborador.jLabel16Foto;
import static gestor.Visao.TelaColaborador.jNomeFuncionario;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaFuncCola extends javax.swing.JInternalFrame {
  ...
  //  String caminho;
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jPesNomeColaborador, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesNomeColaborador.getText().equals("")) {
            ...
            preencherTabelaNome("SELECT * FROM COLABORADOR INNER JOIN DEPARTAMENTOS ON COLABORADOR.IdDepartamento = DEPARTAMENTOS.IdDepartamento INNER JOIN CARGOS ON COLABORADOR.IdCargo=CARGOS.IdCargo WHERE NomeFunc LIKE'" + jPesNomeColaborador.getText() + "%'AND StatusFunc='" + statusFunc + "'");
        }
    ...
    public void preencherTabela() {
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM COLABORADOR INNER JOIN DEPARTAMENTOS ON COLABORADOR.IdDepartamento=DEPARTAMENTOS.IdDepartamento INNER JOIN CARGOS ON COLABORADOR.IdCargo=CARGOS.IdCargo WHERE StatusFunc='" + statusFunc + "'");
            conecta.rs.first();
            do {
