...
import static gestor.Visao.TelaAtualizarMatriculaPedagogia.jRegistro;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAtualizacaoMatricula extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAtualizacaoMatricula() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATUALIZAR_MATRICULA_INTERNO WHERE IdAtual='" + jRegistro.getText() + "'");
            conecta.rs.first();
