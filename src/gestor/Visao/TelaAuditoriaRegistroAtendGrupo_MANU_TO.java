 ...
 * @author Ronaldo
 */
public class TelaAuditoriaRegistroAtendGrupo_MANU_TO extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaRegistroAtendGrupo_MANU_TO() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ATENDIMENTO_GRUPO_TO WHERE IdAtGrupoPsiTO='" + jCodigoAtend.getText() + "'");
            conecta.rs.first();
