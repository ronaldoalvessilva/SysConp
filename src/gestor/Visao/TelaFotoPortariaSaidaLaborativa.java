 ...
 * @author ronaldo
 */
public class TelaFotoPortariaSaidaLaborativa extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaEntradaSaidaInternosPortaria telasaidalabor;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoPortariaSaidaLaborativa(TelaEntradaSaidaInternosPortaria parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoPortariaSaidaLaborativa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoPortariaSaidaLaborativa dialog = new TelaFotoPortariaSaidaLaborativa(telasaidalabor, true);
