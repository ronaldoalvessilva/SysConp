...
import static gestor.Visao.TelaGrupoProdutosNUTRI.jIdGrupo;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaGrupoProdutosNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaGrupoProdutosNUTRI() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Grupo de Produtos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM GRUPO_PRODUTOS_NUTRI WHERE IdGrupo='" + jIdGrupo.getText() + "'");
            conecta.rs.first();
