...
import static gestor.Visao.TelaAprazamentoMedicacoes.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensAprazamentoMedicacoes extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensAprazamentoMedicacoes() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Itens Aprazamento Medicamentos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_APRAZAMENTO_MEDICACAO WHERE IdLanc='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
