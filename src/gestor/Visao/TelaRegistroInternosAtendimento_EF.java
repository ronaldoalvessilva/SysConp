...
import static gestor.Visao.TelaModuloEducacaoFisica.telaRegistroAtendimentoBio_EF;
...
import static gestor.Visao.TelaModuloEducacaoFisica.telaRegistroAtendimentoInciarLeitor_EF;
 ...
 * @author ronal
 */
public class TelaRegistroInternosAtendimento_EF extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "EDUCAÇÃO FÍSICA:Registro de Atendimento de Internos:Biometria";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
     ...
     */
    public TelaRegistroInternosAtendimento_EF() {
        initComponents();
        corCampos();
        pesquisarModulo();
    }
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaRegistroAtendimentoBio_EF) && codGravarEF == 1) {
            verificarInternos();
    ...
    private void jBtIniciarLeitorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtIniciarLeitorActionPerformed
        ...
        buscarAcessoUsuario(telaRegistroAtendimentoInciarLeitor_EF);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoEF.equals("ADMINISTRADORES") || codigoUserEF == codUserAcessoEF && nomeTelaEF.equals(telaRegistroAtendimentoInciarLeitor_EF) && codIncluirEF == 1) {
            Novo();
            // Instanciar a DLL
