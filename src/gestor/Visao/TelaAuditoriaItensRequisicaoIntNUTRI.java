 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRequisicaoIntNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRequisicaoIntNUTRI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_PRODUTOS_INTERNOS_NUTRI WHERE IdReq='" + jCodReq.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
