...
import gestor.Controle.ControleItensRequisicaoMateriaisAvulsoNUTRI;
import gestor.Controle.ControleLogSistema;
import gestor.Controle.ControleRequisicaoMateririasAvulsoNUTRI;
 ...
 * @author Ronaldo
 */
public class TelaRequisicaoAvulsaNUTRI extends javax.swing.JInternalFrame {
    ...
    ControleRequisicaoMateririasAvulsoNUTRI control = new ControleRequisicaoMateririasAvulsoNUTRI();
    ControleItensRequisicaoMateriaisAvulsoNUTRI controle = new ControleItensRequisicaoMateriaisAvulsoNUTRI();
    //    
    ...
    String nomeModuloTela = "Nutrição:Requisição Avulsa de Materiais:Manutenção";
    String nomeModuloTela2 = "Nutrição:Requisição Avulsa de Materiais:Itens";
    //
    int flag;
    int acao;
     ...
     */
    public TelaRequisicaoAvulsaNUTRI() {
        initComponents();
        formatarCampos();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        jPanel32Layout.setVerticalGroup(
            jPanel32Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jtotalRegistros, javax.swing.GroupLayout.DEFAULT_SIZE, 14, Short.MAX_VALUE)
        );
    ...
    private void jBtPesqProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqProdutoActionPerformed
        // TODO add your handling code here:
        TelaPesqProdutoRequisicaoAvulsaMateriaisNUTRI objPesqProdReqMatNUTRI = new TelaPesqProdutoRequisicaoAvulsaMateriaisNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objPesqProdReqMatNUTRI);
        objPesqProdReqMatNUTRI.show();
    ...
    private void jTabelaItensRequisicaoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaItensRequisicaoMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_NUTRI "
                        + "INNER JOIN PRODUTOS_AC "
                        + "ON ITENS_REQUISICAO_AVULSA_PRODUTOS.IdProd=PRODUTOS_AC.IdProd "
                        + "INNER JOIN LOTE_PRODUTOS_AC "
                        + "ON PRODUTOS_AC.IdProd=LOTE_PRODUTOS_AC.IdProd "
                        + "WHERE ITENS_REQUISICAO_AVULSA_PRODUTOS_NUTRI.IdReq='" + jCodReq.getText() + "'AND "
                        + "PRODUTOS_AC.DescricaoProd='" + jDescricaoProduto.getText() + "'AND ITENS_REQUISICAO_AVULSA_PRODUTOS_NUTRI.IdItem='" + idItem + "'");
                conecta.rs.first();
    ...
    private void jBtPesqCodigoReqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoReqActionPerformed
        ...
        if (jCodReq.getText().equals("")) {
            ...
            pesquisarRequisicaoMateriais("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS_NUTRI "
    ...
    private void jCheckBoxTodosReqItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosReqItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            jTabelaRequisicoes.setVisible(true);
            this.pesquisarRequisicaoMateriais("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS_NUTRI "
                    + "INNER JOIN COLABORADOR "
                    + "ON REQUISICAO_AVULSA_PRODUTOS_NUTRI.IdFunc=COLABORADOR.IdFunc ");
        } else {
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS_NUTRI "
                        ...
                        + "WHERE REQUISICAO_AVULSA_PRODUTOS_NUTRI.IdReq='" + IdLanc + "'");
                conecta.rs.first();
            ...
            count = 0;
            preencherTabelaItens("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_NUTRI "
                    + "INNER JOIN REQUISICAO_AVULSA_PRODUTOS_NUTRI "
                    + "ON ITENS_REQUISICAO_AVULSA_PRODUTOS_NUTRI.IdReq=REQUISICAO_AVULSA_PRODUTOS_NUTRI.IdReq "
                    + "INNER JOIN PRODUTOS_AC "
                    + "ON ITENS_REQUISICAO_AVULSA_PRODUTOS_NUTRI.IdProd=PRODUTOS_AC.IdProd "
                    + "WHERE ITENS_REQUISICAO_AVULSA_PRODUTOS_NUTRI.IdReq='" + jCodReq.getText() + "'");
        }
    ...
    private void jBtPesqLocalArmazenamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqLocalArmazenamentoActionPerformed
        // TODO add your handling code here:
        TelaPesqLocalArmazenamentoReqAvulsaNUTRI objPesqLocalArmNUTRI = new TelaPesqLocalArmazenamentoReqAvulsaNUTRI();
    ...
    private void jBtPesqColaboradorRequisitanteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqColaboradorRequisitanteActionPerformed
        // TODO add your handling code here:
        TelaPesquisaColabordorRequisicaoAvulsaNUTRI objFuncReqNUTRI = new TelaPesquisaColabordorRequisicaoAvulsaNUTRI();
    ...
    private void jBtPesqFuncAutorizadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqFuncAutorizadorActionPerformed
        // TODO add your handling code here:
        TelaPesquisaColabordorAutRequisicaoAvulsaNUTRI objFuncReqNUTRIC = new TelaPesquisaColabordorAutRequisicaoAvulsaNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objFuncReqNUTRIC);
        objFuncReqNUTRIC.show();
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS_NUTRI WHERE IdReq='" + jCodReq.getText() + "'");
            conecta.rs.first();
            jStatusReq.setText(conecta.rs.getString("StatusReq"));
        ...
        if (jCodReq.getText().equals("")) {
            ...
            try {
                ...
                conecta.executaSQL("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS_NUTRI "
                        ...
                        + "INNER JOIN DEPARTAMENTOS "
                        + "ON COLABORADOR.IdDepartamento=COLABORADOR.IdDepartamento "
                        + "WHERE REQUISICAO_AVULSA_PRODUTOS_NUTRI.IdReq='" + jCodReq.getText() + "'");
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        if (jDataReq.getDate() == null) {
            ...
            if (acao == 1) {
                ...
                //
                control.incluirRequisicaoMaterialAvulsoNUTRI(objReqMatAvulso);
                buscarCodigo();
                //
                objLog();
            ...
            if (acao == 2) {
                ...
                control.alterarRequisicaoMaterialAvulsoNUTRI(objReqMatAvulso);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
                Salvar();
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaRequisicaoAvulsaNUTRI objAudiReqAvulsaNUTRI = new TelaAuditoriaRequisicaoAvulsaNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objAudiReqAvulsaNUTRI);
        objAudiReqAvulsaNUTRI.show();
    ...
    private void jBtExcluirItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirItemActionPerformed
        ...
        if (jStatusReq.getText().equals("FINALIZADO")) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                controle.excluirRequisicaoAvulsaMaterialNUTRI(objItensReqMatInter);
        ...
        if (jCodProduto.getText().equals("")) {
            ...
            if (acao == 3) {
                ...
                if (saldoEstoque >= objItensReqMatInter.getQtdItem()) {
                    ...
                    controle.incluirRequisicaoAvulsaMaterialNUTRI(objItensReqMatInter);
                    //
                    objLog2();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    preencherTabelaItens("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_NUTRI "
            ...
            if (acao == 4) {
                ...
                if (novoSaldoAtual >= objItensReqMatInter.getQtdItem()) {
                    ...
                    objItensReqMatInter.setIdItem(Integer.valueOf(idItem));
                    controle.alterarRequisicaoAvulsaMaterialNUTRI(objItensReqMatInter); // ALTERAR QUANTIDADE NA TABELA ITENS_REQUISICAO_PRODUTOS_INTERNOS
                    //
                    objItensReqMatInter.setQtdItem(estoqueAtual);
                    controle.alterarEstoqueMateraisNUTRI(objItensReqMatInter); // ALTERAR SALDO DE ESTOQUE NA TABELA DE LOTE_PRODUTOS_AC
                    //
                    objLog2();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    preencherTabelaItens("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_NUTRI "
    ...
    private void jBtAuditoriaItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaItemActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensRequiAvulsaNUTRI objAudiItensReqAvulsaNUTRI = new TelaAuditoriaItensRequiAvulsaNUTRI();
        TelaModuloNutricao.jPainelNutricao.add(objAudiItensReqAvulsaNUTRI);
        objAudiItensReqAvulsaNUTRI.show();
    ...
    public void Finalizar() {
        ...
        if (rows == 0) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                control.finalizarRequisicaoMaterialAvulsoNUTRI(objReqMatAvulso);
    ...
    public void verificarItensRequisitados() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_NUTRI WHERE IdReq='" + objReqMatAvulso.getIdReq() + "'");
            conecta.rs.first();
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                objReqMatAvulso.setIdReq(Integer.parseInt(jCodReq.getText()));
                control.excluirRequisicaoMaterialAvulsoNUTRI(objReqMatAvulso);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                Excluir();
