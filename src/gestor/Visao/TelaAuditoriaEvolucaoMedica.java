 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEvolucaoMedica extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEvolucaoMedica() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Evolução Médica de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM EVOLUCAOMEDICA WHERE IdLanc='" + jIdAdm.getText() + "'AND IdItem='" + jIdEvolucaoMedica .getText() + "'");
            conecta.rs.first();
