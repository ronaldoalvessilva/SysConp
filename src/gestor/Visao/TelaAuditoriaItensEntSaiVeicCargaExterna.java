 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensEntSaiVeicCargaExterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensEntSaiVeicCargaExterna() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSVEICULOCARGA WHERE Idlanc='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
