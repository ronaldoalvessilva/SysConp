...
import static gestor.Visao.TelaAtendimentoGrupoSS.jIdInternoAI;
import static gestor.Visao.TelaAtendimentoGrupoSS.jNomeInternoAVI;
import static gestor.Visao.TelaAtendimentoGrupoSS.jFotoInternoGrupo;
import static gestor.Visao.TelaAtendimentoGrupoSS.jCNCAI;
import static gestor.Visao.TelaAtendimentoGrupoSS.jCodigoAtend;
import static gestor.Visao.TelaAtendimentoGrupoSS.jNomeMaeInternoAVI;
import static gestor.Visao.TelaAtendimentoGrupoSS.jRegimeAVI;
 ...
 * @author Ronaldo
 */
public class TelaPesqInternoAtendimentoGrupoAVI_SS extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoAtendimentoGrupoAVI_SS() {
        initComponents();
    }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            preencherTabelaNome("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_SS "
    ...
    private void jBtMatriculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtMatriculaActionPerformed
        ...
        if (jPesqMatricula.getText().equals("")) {
            ...
            buscarInternosMatricula("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_SS "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_SS.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTodosInternos("SELECT * FROM PARTICIPANTES_ATENDIMENTO_GRUPO_SS "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON PARTICIPANTES_ATENDIMENTO_GRUPO_SS.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN DADOSPENAISINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=DADOSPENAISINTERNOS.IdInternoCrc "
