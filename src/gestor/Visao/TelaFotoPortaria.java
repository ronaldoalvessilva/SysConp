 ...
 * @author ronaldo
 */
public class TelaFotoPortaria extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaRegistroSaidaInternosPortaria telaregistrosaida;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoPortaria(TelaRegistroSaidaInternosPortaria parent, boolean modal) {
        this.telaregistrosaida = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaregistrosaida);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoPortaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoPortaria dialog = new TelaFotoPortaria(telaregistrosaida, true);
