...
import gestor.Controle.ControleItensReservaAcervo;
import gestor.Controle.ControleLogSistema;
import gestor.Controle.ControleReservaAcervo;
 ...
 * @author Ronaldo
 */
public class TelaReservaAcervo extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    ReservaAcervo objReserva = new ReservaAcervo();
    ControleReservaAcervo control = new ControleReservaAcervo();
    ItensReservaAcervo objItensReserva = new ItensReservaAcervo();
    ControleItensReservaAcervo controle = new ControleItensReservaAcervo();
    //
    ControleLogSistema controlLog = new ControleLogSistema();
    LogSistema objLogSys = new LogSistema();
    // Variáveis para gravar o log
    String nomeModuloTela = "Acervo:Reserva de Acervo:Manutenção";
    String nomeModuloTela2 = "Acervo:Reserva de Acervo:Produtos";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
    ...
    String caminho;
    String utilizaReserva = "Não";

    /**
     * Creates new form TelaReserva
     */
    public TelaReservaAcervo() {
        initComponents();
        formatarCampos();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jIdDoc, javax.swing.GroupLayout.PREFERRED_SIZE, 59, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabel2)
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(jStatusDoc))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel13Layout.setHorizontalGroup(
            ...
            .addComponent(FotoInternoReserva, javax.swing.GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE)
        );
        ...
        jPanel7Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jPrazoEmprestimo, jQuantidade, jSaldoAtual});
        ...
        jPanel7Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jPrazoEmprestimo, jQuantidade, jSaldoAtual});
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaReservaAcervo objAudiReser = new TelaAuditoriaReservaAcervo();
        TelaModuloPedagogia.jPainelPedagogia.add(objAudiReser);
        objAudiReser.show();
    ...
    private void jTabelaProdutosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaProdutosMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM ITENS_RESERVA_ACERVO "
                        ...
                        + "INNER JOIN LOCAL_ACERVO "
                        + "ON LIVROS_REVISTAS_JORNAIS.IdLocal=LOCAL_ACERVO.IdLocal "
                        + "WHERE TituloLivro='" + jDescricaoProduto.getText() + "' AND ITENS_RESERVA_ACERVO.IdReserva='" + jIdDoc.getText() + "'AND IdItem='" + idItem + "'");
                conecta.rs.first();
...
//        // TODO add your handling code here:
    ...
    private void jBtAuditoriaItensActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaItensActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensReservaAcervo objAudItensReser = new TelaAuditoriaItensReservaAcervo();
        TelaModuloPedagogia.jPainelPedagogia.add(objAudItensReser);
        objAudItensReser.show();
    ...
    private void jBtPesqProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqProdutoActionPerformed
        // TODO add your handling code here:
        TelaPesqLivroAcervoReserva objPesLivro = new TelaPesqLivroAcervoReserva();
        TelaModuloPedagogia.jPainelPedagogia.add(objPesLivro);
        objPesLivro.show();
    ...
    private void jBtPesqIdDocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqIdDocActionPerformed
        ...
        if (jIdPesqDoc.getText().equals("")) {
            ...
            pesquisarReservaAcervo("SELECT * FROM RESERVA_ACERVO "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON RESERVA_ACERVO.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    ...
                    + "WHERE IdReserva='" + jIdPesqDoc.getText() + "'");
        }
            ...
            if (jDataPesFinal.getDate() == null) {
                ...
                if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                    ...
                    pesquisarReservaAcervo("SELECT * FROM RESERVA_ACERVO "
                            ...
                            + "INNER JOIN PAVILHAO "
                            + "ON CELAS.IdPav=PAVILHAO.IdPav "
                            + "WHERE DataReserva BETWEEN'" + dataInicial + "'AND '" + dataFinal + "'");
                }
            }
        }
 ...
 if (jDataPesqInicial.getDate() == null) {
    ...
    private void jCheckBoxTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarReservaAcervo("SELECT * FROM RESERVA_ACERVO "
                    + "INNER JOIN PRONTUARIOSCRC "
                    + "ON RESERVA_ACERVO.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                    + "INNER JOIN LOCALINTERNOS "
                    + "ON PRONTUARIOSCRC.IdInternoCrc=LOCALINTERNOS.IdInternoCrc "
    ...
    private void jTabelaReservaAcervoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaReservaAcervoMouseClicked
        ...
        if (flag == 1) {
            ...
            conecta.abrirConexao();
            try {
                conecta.executaSQL("SELECT * FROM RESERVA_ACERVO "
                        + "INNER JOIN PRONTUARIOSCRC "
                        + "ON RESERVA_ACERVO.IdInternoCrc=PRONTUARIOSCRC.IdInternoCrc "
                        + "INNER JOIN LOCALINTERNOS "
                        + "ON PRONTUARIOSCRC.IdInternoCrc=LOCALINTERNOS.IdInternoCrc "
                        ...
                        + "INNER JOIN PAVILHAO "
                        + "ON CELAS.IdPav=PAVILHAO.IdPav "
                        + "WHERE IdReserva ='" + IdLanc + "'");
                conecta.rs.first();
                jIdDoc.setText(String.valueOf(conecta.rs.getInt("IdReserva")));
                jStatusDoc.setText(conecta.rs.getString("StatusLanc"));
                jDataDoc.setDate(conecta.rs.getDate("DataReserva"));
            ...
            preencherTabelaItens("SELECT * FROM ITENS_RESERVA_ACERVO "
                    ...
                    + "INNER JOIN LOCAL_ACERVO "
                    + "ON LIVROS_REVISTAS_JORNAIS.IdLocal=LOCAL_ACERVO.IdLocal "
                    + "WHERE ITENS_RESERVA_ACERVO.IdReserva='" + IdLanc + "'");
        }
    ...
    private void jBtPesqInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqInternoActionPerformed
        // TODO add your handling code here:
        TelaPesquisarInternoReservaAcervo objPesqInteReserva = new TelaPesquisarInternoReservaAcervo();
        TelaModuloPedagogia.jPainelPedagogia.add(objPesqInteReserva);
        objPesqInteReserva.show();
    ...
    private void jBtFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtFinalizarActionPerformed
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM RESERVA_ACERVO WHERE IdReserva='" + jIdDoc.getText() + "'");
            conecta.rs.first();
            objReserva.setStatusLanc(jStatusDoc.getText());
            if (jStatusDoc.getText().equals("FINALIZADO")) {
    ...
    public void Finalizar() {
        ...
        int resposta = JOptionPane.showConfirmDialog(this, "Deseja realmente FINALIZAR o lançamento selecionado?", "Confirmação",
                JOptionPane.YES_NO_OPTION);
        if (resposta == JOptionPane.YES_OPTION) {
            objReserva.setStatusLanc(statusEntrada);
            objReserva.setIdReserva(Integer.parseInt(jIdDoc.getText()));
            control.finalizarReservaAcervo(objReserva);
    ...
    public void buscarCodigo() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM RESERVA_ACERVO");
            conecta.rs.last();
            jIdDoc.setText(conecta.rs.getString("IdReserva"));
        } catch (Exception e) {
    ...
    public void verificarItens() {
        ...
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENS_RESERVA_ACERVO WHERE IdReserva='" + jIdDoc.getText() + "'");
            conecta.rs.first();
            codCompra = conecta.rs.getString("IdReserva");
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                objReserva.setIdReserva(Integer.parseInt(jIdDoc.getText()));
                control.excluirReservaAcervo(objReserva);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                Excluir();
    ...
    public void pesquisarReservaAcervo(String sql) {
        ...
        try {
            ...
            do {
                ...
                dataDocumeto = conecta.rs.getString("DataReserva");
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdReserva"), dataDocumeto, conecta.rs.getString("StatusLanc"), conecta.rs.getString("NomeInternoCrc"), conecta.rs.getString("Observacao")});
    ...
    public void alinharCamposTabelaReserva() {
        ...
        jTabelaReservaAcervo.getColumnModel().getColumn(2).setCellRenderer(direita);
    }
