...
import gestor.Controle.ControleAtendimentoGrupoEF;
import gestor.Controle.ControleListaInternosCelasAG_EF;
import gestor.Controle.ControleListaInternosGaleiraAG_EF;
import gestor.Controle.ControleListaInternosPavilhaoAG_EF;
import gestor.Controle.ControleListaInternosPavilhaoAG_II_EF;
...
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jBtAlterarParticipantes;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jBtAuditoriaParticipantes;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jBtCancelarParticipantes;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jBtExcluirParticipantes;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jBtNovoParticipantes;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jBtSalvarParticipantes;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jBtPesquisarPart;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jCNC;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jCela;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jCodigoAtend;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jComboBoxNivelPavilhao;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jComboBoxPavilhaoGaleria;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jDataNascimento;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jIdInternoGrp;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jNomeInternoGrp;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jNomeMae;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jPavilhao;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jRegime;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jTabelaInternos;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.jtotalRegistrosInternos;
import static gestor.Visao.TelaAtendimentoGrupoEducacaoFisica.pCODIGO_ITEM_PARTICIPANTE;
 ...
 */
public class TelaSelecaoLoteInternosAG_EF extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    AtividadesGrupoPsicologia objAvalia = new AtividadesGrupoPsicologia();
    ControleAtendimentoGrupoEF control = new ControleAtendimentoGrupoEF();
    ControleListaInternosCelasAG_EF listaPorCelas = new ControleListaInternosCelasAG_EF();
    ControleListaInternosGaleiraAG_EF listaPorGaleira = new ControleListaInternosGaleiraAG_EF();
    ControleListaInternosPavilhaoAG_EF listaPorPavilhao = new ControleListaInternosPavilhaoAG_EF();
    ControleListaInternosPavilhaoAG_II_EF listaPorPavilhao_B = new ControleListaInternosPavilhaoAG_II_EF();
     ...
     */
    public static TelaAtendimentoGrupoEducacaoFisica pATENDIMENTO_GRUPO;

    public TelaSelecaoLoteInternosAG_EF(TelaAtendimentoGrupoEducacaoFisica parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaSelecaoLoteInternosAG_EF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaSelecaoLoteInternosAG_EF dialog = new TelaSelecaoLoteInternosAG_EF(pATENDIMENTO_GRUPO, true);
            ...
            Thread t0 = new Thread() {
                public void run() {
                    ...
                    for (int i = 0; i < jTabelaInternosDestino.getRowCount(); i++) {//  
                        ...
                        //
                        control.incluirAGrupoEF(objAvalia);
