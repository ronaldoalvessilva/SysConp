...
import static gestor.Visao.TelaModuloPortariaExterna.telaEntradaSaidaVDManuP1E;
 ...
 * @author user
 */
public class TelaEntradaSaidaVisitasDiversasExterna extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "Portaria Externa:Entrada/Saida de VisitasDiversas:Manutenção";
    String nomeModuloTela2 = "Portaria Externa:Entrada/Saida de VisitasDiversas:VisitasDiversas";
    String statusMov;
    String horaMov;
    String dataModFinal;
    //
     ...
     */
    public static TelaFotoVisitaDiversasExterna telavisitafoto;

    public static TelaObservacaoVisitasPortariaExterna telaObservacaoVisitante;

    public TelaEntradaSaidaVisitasDiversasExterna() {
        super();
        initComponents();
        setResizable(false);
        corCampo();
    ...
    public void mostrarFotoVisitaDiversas() {
        telavisitafoto = new TelaFotoVisitaDiversasExterna(this, true);
        telavisitafoto.setVisible(true);
    }

    public void mostrarObservacaoVisitas() {
        telaObservacaoVisitante = new TelaObservacaoVisitasPortariaExterna(this, true);
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setTitle("...::: Entrada/Saida Visitas Diversas - {P1 - Externa} :::...");
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1E.equals("ADMINISTRADORES") || codigoUserP1E == codUserAcessoP1E && nomeTelaP1E.equals(telaEntradaSaidaVDManuP1E) && codIncluirP1E == 1) {
            acao = 1;
            Novo();
            corCampo();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaVDManuP1E);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1E.equals("ADMINISTRADORES") || codigoUserP1E == codUserAcessoP1E && nomeTelaP1E.equals(telaEntradaSaidaVDManuP1E) && codAlterarP1E == 1) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaVDManuP1E);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1E.equals("ADMINISTRADORES") || codigoUserP1E == codUserAcessoP1E && nomeTelaP1E.equals(telaEntradaSaidaVDManuP1E) && codExcluirP1E == 1) {
            objEntSaiVisitas.setStatusLanc(jStatusEntCola.getText());
            if (jStatusEntCola.getText().equals("FINALIZADO")) {
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaVDManuP1E);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1E.equals("ADMINISTRADORES") || codigoUserP1E == codUserAcessoP1E && nomeTelaP1E.equals(telaEntradaSaidaVDManuP1E) && codGravarP1E == 1) {
    ...
    private void jBtPesqFuncionarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqFuncionarioActionPerformed
        // TODO add your handling code here:        
        TelaPesqVisitasDiversasExterna objPesVisitasDiversasExt = new TelaPesqVisitasDiversasExterna();
        TelaModuloPortariaExterna.jPainelPortariaExterna.add(objPesVisitasDiversasExt);
        objPesVisitasDiversasExt.show();
    ...
    private void jBtNovaVisitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovaVisitaActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaVDVDP1E);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1E.equals("ADMINISTRADORES") || codigoUserP1E == codUserAcessoP1E && nomeTelaP1E.equals(telaEntradaSaidaVDVDP1E) && codIncluirP1E == 1) {
            objEntSaiVisitas.setStatusLanc(jStatusEntCola.getText());
            if (jStatusEntCola.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Essa entrada de visitantes não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtAlterarVisitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarVisitaActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaVDVDP1E);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1E.equals("ADMINISTRADORES") || codigoUserP1E == codUserAcessoP1E && nomeTelaP1E.equals(telaEntradaSaidaVDVDP1E) && codAlterarP1E == 1) {
            objEntSaiVisitas.setStatusLanc(jStatusEntCola.getText());
            if (jStatusEntCola.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Essa entrada de visitantes não poderá ser alterado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtExcluirVisitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirVisitaActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaVDVDP1E);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1E.equals("ADMINISTRADORES") || codigoUserP1E == codUserAcessoP1E && nomeTelaP1E.equals(telaEntradaSaidaVDVDP1E) && codExcluirP1E == 1) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            objEntSaiVisitas.setStatusLanc(jStatusEntCola.getText());
    ...
    private void jBtSalvarVisitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarVisitaActionPerformed
        // TODO add your handling code here:
        buscarAcessoUsuario(telaEntradaSaidaVDVDP1E);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoP1E.equals("ADMINISTRADORES") || codigoUserP1E == codUserAcessoP1E && nomeTelaP1E.equals(telaEntradaSaidaVDVDP1E) && codGravarP1E == 1) {
    ...
    private void jBtBuscarVisitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtBuscarVisitaActionPerformed
        // TODO add your handling code here:
        TelaPesqItensVisitasDiversasExterna objPesqItensVisitaExt = new TelaPesqItensVisitasDiversasExterna();
        TelaModuloPortariaExterna.jPainelPortariaExterna.add(objPesqItensVisitaExt);
        objPesqItensVisitaExt.show();
    ...
    private void jBtBuscarSetorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtBuscarSetorActionPerformed
        // TODO add your handling code here:
        TelaPesqDeptoVisitasExterna objDeptoVisitaExt = new TelaPesqDeptoVisitasExterna();
        TelaModuloPortariaExterna.jPainelPortariaExterna.add(objDeptoVisitaExt);
        objDeptoVisitaExt.show();
    ...
    private void jBtAudioriaManuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAudioriaManuActionPerformed
        // TODO add your handling code here:
        TelaAudEntSaiVisitasDiversasExterna objAudEntSaiVisitaDivExt = new TelaAudEntSaiVisitasDiversasExterna();
        TelaModuloPortariaExterna.jPainelPortariaExterna.add(objAudEntSaiVisitaDivExt);
        objAudEntSaiVisitaDivExt.show();
    ...
    private void jBtAuditoriaVisitasDiversasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaVisitasDiversasActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensEntSaiVisitasDiversasExterna objAudItensSaiEntVisDivExt = new TelaAuditoriaItensEntSaiVisitasDiversasExterna();
        TelaModuloPortariaExterna.jPainelPortariaExterna.add(objAudItensSaiEntVisDivExt);
        objAudItensSaiEntVisDivExt.show();
