 ...
 * @author ronal
 */
public class TelaGravarProximoKitAnualInd extends javax.swing.JDialog {
     ...
     */
    public static TelaProgramacaoKitsHigiene gravarProximoKitAnual;

    public TelaGravarProximoKitAnualInd(TelaProgramacaoKitsHigiene parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGravarProximoKitAnualInd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaGravarProximoKitAnualInd dialog = new TelaGravarProximoKitAnualInd(gravarProximoKitAnual, true);
            ...
            Thread t0 = new Thread() {
                public void run() {
                    ...
                    try {
                        ...
                        Logger.getLogger(TelaGravarProximoKitAnualInd.class.getName()).log(Level.SEVERE, null, ex);
                    }
