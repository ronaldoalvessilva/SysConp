...
import static gestor.Visao.TelaRequisicaoMateriaisCardapioNUTRI.jDescricaoProduto;
import static gestor.Visao.TelaRequisicaoMateriaisCardapioNUTRI.jCodProduto;
import static gestor.Visao.TelaRequisicaoMateriaisCardapioNUTRI.jCodigoBarras;
import static gestor.Visao.TelaRequisicaoMateriaisCardapioNUTRI.jLote;
import static gestor.Visao.TelaRequisicaoMateriaisCardapioNUTRI.jDataVctoLote;
import static gestor.Visao.TelaRequisicaoMateriaisCardapioNUTRI.jComboBoxUnidade;
import static gestor.Visao.TelaRequisicaoMateriaisCardapioNUTRI.jValorUnitarioItem;
 ...
 * @author user
 */
public class TelaPesqProdutoRequisicaoCardapioNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoRequisicaoCardapioNUTRI() {
        initComponents();
    }
        ...
        if (jPesqDescricaoProdutos.getText().isEmpty()) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM PRODUTOS_AC "
                        ...
                        + "INNER JOIN LOTE_PRODUTOS_AC "
                        + "ON PRODUTOS_AC.IdProd=LOTE_PRODUTOS_AC.IdProd "
                        + "WHERE PRODUTOS_AC.DescricaoProd='" + jPesqDescricaoProdutos.getText() + "'AND PRODUTOS_AC.StatusProd='" + statusProd + "'AND PRODUTOS_NUTRI.IdProd='" + idInt + "'AND Qtd!='" + 0 + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
                conecta.rs.first();
