...
import static gestor.Visao.TelaSolicitacaoProdutosENFAR.jDescricaoProduto;
import static gestor.Visao.TelaSolicitacaoProdutosENFAR.jCodProduto;
import static gestor.Visao.TelaSolicitacaoProdutosENFAR.jCodigoBarras;
import static gestor.Visao.TelaSolicitacaoProdutosENFAR.jComboBoxUnidade;
import static gestor.Visao.TelaSolicitacaoProdutosENFAR.jGrupoProduto;
import static gestor.Visao.TelaSolicitacaoProdutosENFAR.jValorUnitarioItem;
 ...
 * @author user
 */
public class TelaPesqProdutoSolicitacaoMateriaisENFA extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqProdutoSolicitacaoMateriaisENFA() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabelaProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Descrição Produto", "Data Vl.", "Qtde.", "Lote"
            }
        ));
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM PRODUTOS_AC "
                    ...
                    + "WHERE PRODUTOS_AC.DescricaoProd LIKE'%" + jPesqDescricaoProdutos.getText() + "%'AND PRODUTOS_AC.StatusProd='" + statusProd + "'AND Qtd!='" + 0 + "'AND PRODUTOS_AC.Modulo='" + modulo + "'");
        }
