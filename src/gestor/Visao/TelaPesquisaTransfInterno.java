...
import static gestor.Visao.TelaTransfInterno.FotoInternoCrcTransf;
import static gestor.Visao.TelaTransfInterno.jIDInterno;
import static gestor.Visao.TelaTransfInterno.jNomeInterno;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaTransfInterno extends javax.swing.JInternalFrame {
    ...
    String situacaoTra = "RETORNO A UNIDADE";
    String idInt;

    /**
     * Creates new form TelaPesquisaEntradaInternos
     */
    public TelaPesquisaTransfInterno() {
        initComponents();
    }
    ...
    private void jBtMatriculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtMatriculaActionPerformed
        ...
        if (jPesqMatricula.getText().equals("")) {
            ...
            buscarInternosMatricula("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "AND SituacaoCrc LIKE'" + situacaoCrc + "%' "
                    + "OR NomeInternoCrc LIKE'" + jPesqNome.getText() + "' "
                    + "AND SituacaoCrc LIKE'" + situacaoTra + "%'");
        }
