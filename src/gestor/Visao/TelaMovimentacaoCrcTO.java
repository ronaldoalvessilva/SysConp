 ...
 * @author user
 */
public class TelaMovimentacaoCrcTO extends javax.swing.JInternalFrame {
    ...
    private void jBtPesquisarInternoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarInternoActionPerformed
        // Pesquisar Internos
        TelaPesquisaMovInternoTO objTelaMovInt = new TelaPesquisaMovInternoTO();
        TelaModuloTerapiaOcupacional.jPainelTerapia.add(objTelaMovInt);
        objTelaMovInt.show();
