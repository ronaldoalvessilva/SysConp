...
import static gestor.Visao.TelaSolicitacaoComprasMateriaisGerencia.jIdSol;
import static gestor.Visao.TelaSolicitacaoComprasMateriaisGerencia.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensSolicitacaoComprasADM extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensSolicitacaoComprasADM() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Itens Solicitação Compras {GER} :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_SOLICITACAO_PRODUTOS_ADM WHERE IdSol='" + jIdSol.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
