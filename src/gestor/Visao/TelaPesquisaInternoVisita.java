...
import static gestor.Visao.TelaVerificacaoDocumentos.jIdInternoVisita;
import static gestor.Visao.TelaVerificacaoDocumentos.jNomeInternoVisita;
 ...
 * @author ronaldo
 */
public class TelaPesquisaInternoVisita extends javax.swing.JDialog {
    ...
    /**
     * Creates new form TelaPesquisaInternoVisita
     */
    public static TelaVerificacaoDocumentos telaVerifica;
    
    public TelaPesquisaInternoVisita(TelaVerificacaoDocumentos parent, boolean modal) {
        this.telaVerifica =  parent;
        this.setModal(modal);
        setLocationRelativeTo(telaVerifica);
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                ...
                conecta.rs.first();
                jIdInternoVisita.setText(String.valueOf(conecta.rs.getInt("IdInternoCrc")));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPesquisaInternoVisita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaPesquisaInternoVisita dialog = new TelaPesquisaInternoVisita(telaVerifica, true);
