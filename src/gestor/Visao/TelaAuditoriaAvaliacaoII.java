...
import static gestor.Visao.TelaAtendimentoTerapiaOcupacional.codigoAvaliacaoII;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAvaliacaoII extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();      
    /**
     * Creates new form TelaAuditoriaRolInternas
     */
    public TelaAuditoriaAvaliacaoII() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Avaliação II :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AVALIACAO_II WHERE IdAvaliaII='" + codigoAvaliacaoII + "'");
            conecta.rs.first();
