...
import static gestor.Visao.TelaRetornoRecaptura.jIDLanc;
import static gestor.Visao.TelaRetornoRecaptura.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRecaptura extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRecaptura() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSRECAPTURA WHERE IdRecaptura='" + jIDLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
