 ...
 * @author Ronaldo
 */
public class TelaAuditoriaDiasEstudados extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaDiasEstudados() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Dias Estudados :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM FREQUENCIA_PEDAGOGIA_EXTERNA WHERE IdFreqLab='" + jIdFrequencia.getText() + "'");
            conecta.rs.first();
