 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensListaEspera extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensListaEspera() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSLISTAESPERA WHERE IdLanc='" + jIDLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
