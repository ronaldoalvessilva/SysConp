...
import static gestor.Visao.TelaFrequenciaMensalInternosEducacao.jCodigoEmp;
 ...
 * @author user
 */
public class TelaBuscarInstituicaoEducaFrequenciaExterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaBuscarInstituicaoEducaFrequenciaExterna() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisa de Instituição Educacional {PE} :::...");
        ...
        jTabelaEmpresas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome da Instituição", "Data Cadastro"
            }
        ));
    ...
    private void jBtPesqNomeEmpresaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeEmpresaActionPerformed
        ...
        if (jPesqNomeEmpresa.getText().equals("")) {
            ...
            buscarEmpresas("SELECT * FROM INSTITUICAOESCOLAR WHERE NomeInstituicao LIKE'" + jPesqNomeEmpresa.getText() + "%' AND StatusInst='" + statusEmp + "'");
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM INSTITUICAOESCOLAR WHERE NomeInstituicao='" + jPesqNomeEmpresa.getText() + "' AND StatusInst='" + statusEmp + "'");
                conecta.rs.first();
                jCodigoEmp.setText(conecta.rs.getString("IdCod"));
                jNomeEmpresa.setText(conecta.rs.getString("NomeInstituicao")); // Coluna 1                                                                      
                conecta.desconecta();
    ...
    private void jCheckBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox1ItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.buscarEmpresas("SELECT * FROM INSTITUICAOESCOLAR WHERE StatusInst='" + statusEmp + "'");
        } else {
            limparTabela();
        }
    ...
    public void buscarEmpresas(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Nome da Instituição", "Data Cadastro"};
        conecta.abrirConexao();
        try {
            ...
            do {
                dados.add(new Object[]{conecta.rs.getInt("IdCod"), conecta.rs.getString("NomeInstituicao"), dataCadastro});
