 ...
 * @author Ronaldo
 */
public class TelaRelatorioConsumoProdutosAvulsoNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaRelatorioConsumoProdutosAvulsoNUTRI() {
        initComponents();
    }
                ...
                if (jDataPesFinal.getDate() == null) {
                    ...
                    if (jDataPesqInicial.getDate().after(jDataPesFinal.getDate())) {
                        ...
                        try {
                            ...
                            String path = "reports/Nutricao/RelatorioConsumoProdutosAvulsoNUTRI.jasper";
                            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_NUTRI "
                                    ...
                                    + "WHERE DataReq BETWEEN'" + dataInicial + "'AND'" + dataFinal + "' ORDER BY PRODUTOS_NUTRI.DescricaoProd");
