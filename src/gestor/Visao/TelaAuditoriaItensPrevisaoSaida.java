...
import static gestor.Visao.TelaPrevisaoSaidaInternos.idItem;
import static gestor.Visao.TelaPrevisaoSaidaInternos.jIdLanc;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensPrevisaoSaida extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensPrevisaoSaida() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENSPREVISAOSAIDA WHERE IdLanc='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
