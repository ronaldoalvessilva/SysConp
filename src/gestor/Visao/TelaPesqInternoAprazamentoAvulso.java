 ...
 * @author user
 */
public class TelaPesqInternoAprazamentoAvulso extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqInternoAprazamentoAvulso() {
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            jIdInternoAbra.setText(idInterno);
            ...
            try {
                ...
                conecta.rs.first();
                jIdInternoAbra.setText(conecta.rs.getString("IdInternoCrc")); //Coluna 0                
                jNomeInternoAbra.setText(conecta.rs.getString("NomeInternoCrc")); // Coluna 1                             
    ...
    private void jTabelaLocacaoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaLocacaoMouseClicked
        ...
        if (flag == 1) {
            String nomeInterno = "" + jTabelaLocacao.getValueAt(jTabelaLocacao.getSelectedRow(), 1);
            jPesqNomeInterno.setText(nomeInterno);
            idInterno = "" + jTabelaLocacao.getValueAt(jTabelaLocacao.getSelectedRow(), 0);
            jIdInternoAbra.setText(idInterno);
        }
