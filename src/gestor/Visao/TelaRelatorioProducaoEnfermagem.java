 ...
 */
public class TelaRelatorioProducaoEnfermagem extends javax.swing.JInternalFrame {
     ...
     */
    public TelaRelatorioProducaoEnfermagem() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Relatório de Produtividade Enfermagem :::...");
        ...
        if (tipoServidor == null || tipoServidor.equals("")) {
            ...
            if (jDataInicial.getDate() == null) {
                ...
                try {
                    ...
                    String path = "reports/Enfermaria/QuantitativoAtendimentoEnfermagem/RelatorioQuantitativoAtendimentoEnfermagemII.jasper";
                    conecta.executaSQL("SELECT TOP 1 * FROM EVOLUCAOENFERMAGEM "
                            ...
                            + "AND '" + dataFinal + "' "
                            + "ORDER BY EVOLUCAOENFERMAGEM.UsuarioInsert,EVOLUCAOENFERMAGEM.DataEvol");
                    ...
                    jv.setTitle("Relatório de Quantidade de Atendimento Enfermagem por Período");
