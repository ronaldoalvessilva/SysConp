...
import static gestor.Visao.TelaInstituicaoEnsino.jCodigo;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaInstEnsino extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaInstEnsino() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Instituição Escolar :::...");
        setToolTipText("");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM INSTITUICAOESCOLAR WHERE IdCod='" + jCodigo.getText() + "'");
            conecta.rs.first();
