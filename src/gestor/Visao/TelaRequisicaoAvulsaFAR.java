...
import gestor.Controle.ControleItensRequisicaoMateriaisAvulsoFAR;
import gestor.Controle.ControleLogSistema;
import gestor.Controle.ControleRequisicaoMateririasAvulsoFAR;
...
import static gestor.Visao.TelaModuloFarmacia.telaMovimentacaoRequisicaoManu_FAR;
import static gestor.Visao.TelaModuloFarmacia.telaMovimentacaoRequisicaoProd_FAR;
 ...
 * @author Ronaldo
 */
public class TelaRequisicaoAvulsaFAR extends javax.swing.JInternalFrame {
    ...
    ControleRequisicaoMateririasAvulsoFAR control = new ControleRequisicaoMateririasAvulsoFAR();
    ControleItensRequisicaoMateriaisAvulsoFAR controle = new ControleItensRequisicaoMateriaisAvulsoFAR();
    //    
    ...
    String nomeModuloTela = "Farmácia:Requisição Avulsa de Materiais Interno:Manutenção";
    String nomeModuloTela2 = "Farmácia:Requisição Avulsa de Materiais Interno:Itens";
    //
    int flag;
    int acao;
     ...
     */
    public TelaRequisicaoAvulsaFAR() {
        initComponents();
        formatarCampos();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        jMotivoSaidaProdutos = new javax.swing.JTextField();
        jBtPesquisarMotivo = new javax.swing.JButton();
        jLabel23 = new javax.swing.JLabel();
        jComboBoxProdutosAvaria = new javax.swing.JComboBox();
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Requisição Avulsa de Produtos/Medicamentos {FAR} :::...");
        setToolTipText("");
        ...
        jLabel22.setText("Motivo da Saída:");

        jMotivoSaidaProdutos.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jMotivoSaidaProdutos.setEnabled(false);

        jBtPesquisarMotivo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gestor/Imagens/Lupas_1338_05.gif"))); // NOI18N
        jBtPesquisarMotivo.setContentAreaFilled(false);
        jBtPesquisarMotivo.setEnabled(false);
        jBtPesquisarMotivo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBtPesquisarMotivoActionPerformed(evt);
            }
        });

        jLabel23.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel23.setForeground(new java.awt.Color(204, 0, 0));
        jLabel23.setText("Produtos Avariados:");

        jComboBoxProdutosAvaria.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jComboBoxProdutosAvaria.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Não", "Sim" }));
        jComboBoxProdutosAvaria.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jComboBoxProdutosAvaria.setEnabled(false);
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        .addComponent(jMotivoSaidaProdutos)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jBtPesquisarMotivo, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        .addComponent(jComboBoxProdutosAvaria, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel10Layout.setVerticalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(jBtPesquisarMotivo)
                    .addComponent(jMotivoSaidaProdutos, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel22))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel23)
                    .addComponent(jComboBoxProdutosAvaria, javax.swing.GroupLayout.PREFERRED_SIZE, 19, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel5, javax.swing.GroupLayout.PREFERRED_SIZE, 89, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jBtPesqProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqProdutoActionPerformed
        // TODO add your handling code here:
        if (jComboBoxProdutosAvaria.getSelectedItem().equals("Não")) {
            TelaPesqProdutoRequisicaoAvulsaMateriaisFAR objPesqProdReqMat = new TelaPesqProdutoRequisicaoAvulsaMateriaisFAR();
            TelaModuloFarmacia.jPainelFarmacia.add(objPesqProdReqMat);
            objPesqProdReqMat.show();
        } else if (jComboBoxProdutosAvaria.getSelectedItem().equals("Sim")) {
            TelaPesqProdutoRequisicaoAvulsaMateriaisFAR_MAVA objPesqProdReqMatAv = new TelaPesqProdutoRequisicaoAvulsaMateriaisFAR_MAVA();
            TelaModuloFarmacia.jPainelFarmacia.add(objPesqProdReqMatAv);
            objPesqProdReqMatAv.show();
        }
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR "
                        ...
                        + "ON ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR.IdProd=PRODUTOS_AC.IdProd "
                        + "INNER JOIN LOTE_PRODUTOS_AC "
                        + "ON PRODUTOS_AC.IdProd=LOTE_PRODUTOS_AC.IdProd "
                        + "WHERE ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR.IdItem='" + idItem + "'");
                conecta.rs.first();
    ...
    private void jBtPesqCodigoReqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoReqActionPerformed
        ...
        if (jCodReq.getText().equals("")) {
            ...
            pesquisarRequisicaoMateriais("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS_FAR "
    ...
    private void jCheckBoxTodosReqItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosReqItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.pesquisarRequisicaoMateriais("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS_FAR "
                    + "INNER JOIN COLABORADOR "
                    + "ON REQUISICAO_AVULSA_PRODUTOS_FAR.IdFunc=COLABORADOR.IdFunc ");
        } else {
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS_FAR "
                        ...
                        + "INNER JOIN MOTIVO_SAIDA_PRODUTOS_FAR "
                        + "ON REQUISICAO_AVULSA_PRODUTOS_FAR.IdMot=MOTIVO_SAIDA_PRODUTOS_FAR.IdMot "
                        + "WHERE REQUISICAO_AVULSA_PRODUTOS_FAR.IdReq='" + IdLanc + "'");
                conecta.rs.first();
                ...
                jComboBoxProdutosAvaria.setSelectedItem(conecta.rs.getString("ProdutosAV"));
            ...
            count = 0;
            preencherTabelaItens("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR "
                    + "INNER JOIN REQUISICAO_AVULSA_PRODUTOS_FAR "
                    + "ON ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR.IdReq=REQUISICAO_AVULSA_PRODUTOS_FAR.IdReq "
                    + "INNER JOIN PRODUTOS_AC "
                    + "ON ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR.IdProd=PRODUTOS_AC.IdProd "
                    + "WHERE ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR.IdReq='" + jCodReq.getText() + "'");
        }
    ...
    private void jBtPesqLocalArmazenamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqLocalArmazenamentoActionPerformed
        // TODO add your handling code here:
        TelaPesqLocalArmazenamentoReqAvulsaFAR objPesqLocalArm = new TelaPesqLocalArmazenamentoReqAvulsaFAR();
    ...
    private void jBtPesqColaboradorRequisitanteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqColaboradorRequisitanteActionPerformed
        // TODO add your handling code here:
        TelaPesquisaColabordorRequisicaoAvulsaFAR objFuncReq = new TelaPesquisaColabordorRequisicaoAvulsaFAR();
        TelaModuloFarmacia.jPainelFarmacia.add(objFuncReq);
        objFuncReq.show();
    ...
    private void jBtPesqFuncAutorizadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqFuncAutorizadorActionPerformed
        // TODO add your handling code here:
        TelaPesquisaColabordorAutRequisicaoAvulsaFAR objFuncReqAv = new TelaPesquisaColabordorAutRequisicaoAvulsaFAR();
        TelaModuloFarmacia.jPainelFarmacia.add(objFuncReqAv);
        objFuncReqAv.show();
        ...
        if (jCodReq.getText().equals("")) {
            ...
            try {
                ...
                conecta.executaSQL("SELECT * FROM REQUISICAO_AVULSA_PRODUTOS_FAR "
                        ...
                        + "INNER JOIN DEPARTAMENTOS "
                        + "ON COLABORADOR.IdDepartamento=COLABORADOR.IdDepartamento "
                        + "WHERE REQUISICAO_AVULSA_PRODUTOS_FAR.IdReq='" + jCodReq.getText() + "'");
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaMovimentacaoRequisicaoManu_FAR) && objCampos.getCodigoIncluir() == 1) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        ...
        pPESQUISAR_acessos.pesquisarGrupoUsuario(objCampos);
        pPESQUISAR_acessos.pesquisarTelasAcesso(objCampos);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaMovimentacaoRequisicaoManu_FAR) && objCampos.getCodigoAlterar() == 1) {
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        ...
        pPESQUISAR_acessos.pesquisarGrupoUsuario(objCampos);
        pPESQUISAR_acessos.pesquisarTelasAcesso(objCampos);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaMovimentacaoRequisicaoManu_FAR) && objCampos.getCodigoExcluir() == 1) {
            objReqMatAvulso.setStatusReq(jStatusReq.getText());
            if (jStatusReq.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser modificado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        ...
        pPESQUISAR_acessos.pesquisarGrupoUsuario(objCampos);
        pPESQUISAR_acessos.pesquisarTelasAcesso(objCampos);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaMovimentacaoRequisicaoManu_FAR) && objCampos.getCodigoGravar() == 1) {
            if (jDataReq.getDate() == null) {
            ...
            } else if (jMotivoSaidaProdutos.getText().equals("")) {
                JOptionPane.showMessageDialog(rootPane, "Informe o motivo da saida.");
            } else {
                objReqMatAvulso.setStatusReq(jStatusReq.getText());
                ...
                objReqMatAvulso.setTituloMotivo(jMotivoSaidaProdutos.getText());
                objReqMatAvulso.setProdutosAvaria((String) jComboBoxProdutosAvaria.getSelectedItem());
                ...
                if (acao == 1) {
                    ...
                    //
                    control.incluirRequisicaoMaterialAvulsoFAR(objReqMatAvulso);
                    buscarCodigo();
                    //
                    objLog();
                ...
                if (acao == 2) {
                    ...
                    control.alterarRequisicaoMaterialAvulsoFAR(objReqMatAvulso);
                    objLog();
                    controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                    JOptionPane.showMessageDialog(rootPane, "Registro gravado com sucesso.");
                    Salvar();
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaRequisicaoAvulsaFAR objAudiReqAvulsa = new TelaAuditoriaRequisicaoAvulsaFAR();
        TelaModuloFarmacia.jPainelFarmacia.add(objAudiReqAvulsa);
    ...
    private void jBtNovoItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoItemActionPerformed
        // TODO add your handling code here:
        objCampos.setNomeUsuario(nameUser);
        objCampos.setNomeTelaAcesso(telaMovimentacaoRequisicaoProd_FAR);
        pPESQUISAR_acessos.pesquisarUsuario(objCampos);
        pPESQUISAR_acessos.pesquisarGrupoUsuario(objCampos);
        pPESQUISAR_acessos.pesquisarTelasAcesso(objCampos);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaMovimentacaoRequisicaoProd_FAR) && objCampos.getCodigoIncluir() == 1) {
            objReqMatAvulso.setStatusReq(jStatusReq.getText());
            if (jStatusReq.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser modificado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtAlterarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarItemActionPerformed
        ...
        pPESQUISAR_acessos.pesquisarGrupoUsuario(objCampos);
        pPESQUISAR_acessos.pesquisarTelasAcesso(objCampos);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaMovimentacaoRequisicaoProd_FAR) && objCampos.getCodigoAlterar() == 1) {
            objReqMatAvulso.setStatusReq(jStatusReq.getText());
            if (jStatusReq.getText().equals("FINALIZADO")) {
                JOptionPane.showMessageDialog(rootPane, "Esse registro não poderá ser modificado, o mesmo encontra-se FINALIZADO");
            } else {
    ...
    private void jBtExcluirItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirItemActionPerformed
        ...
        pPESQUISAR_acessos.pesquisarGrupoUsuario(objCampos);
        pPESQUISAR_acessos.pesquisarTelasAcesso(objCampos);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaMovimentacaoRequisicaoProd_FAR) && objCampos.getCodigoExcluir() == 1) {
            ...
            if (jStatusReq.getText().equals("FINALIZADO")) {
                ...
                if (resposta == JOptionPane.YES_OPTION) {
                    if (jComboBoxProdutosAvaria.getSelectedItem().equals("Não")) {
                        ...
                        saidaPorDataVecto(objItensReqMatInter.getIdProd(), jDataSistema.getText());
                    } else if (jComboBoxProdutosAvaria.getSelectedItem().equals("Sim")) {
                        // PESQUISAR REGISTRO AVIARIADO PARA EXCLUIR
                        saidaPorDataVectoAV(objItensReqMatInter.getIdProd(), jDataSistema.getText());
                    }
                    // CONVERTER QUANTIDADE DO PRODUTO
                    try {
                    ...
                    objItensReqMatInter.setDataVenc(dataVcto);
                    // TABELA DE LOTE_PRODUTOS_AC 
                    controle.alterarEstoqueMateraisFAR(objItensReqMatInter);
                    //
                    objItensReqMatInter.setIdItem(Integer.valueOf(idItem));
                    controle.excluirRequisicaoAvulsaMaterialFAR(objItensReqMatInter);
                    //
    ...
    private void jBtSalvarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarItemActionPerformed
        ...
        pPESQUISAR_acessos.pesquisarGrupoUsuario(objCampos);
        pPESQUISAR_acessos.pesquisarTelasAcesso(objCampos);
        if (nameUser.equals("ADMINISTRADOR DO SISTEMA") || objCampos.getNomeGrupo().equals("ADMINISTRADORES") || objCampos.getCodigoUsuario() == objCampos.getCodigoUsuarioAcesso() && objCampos.getNomeTelaAcesso().equals(telaMovimentacaoRequisicaoProd_FAR) && objCampos.getCodigoGravar() == 1) {
            DecimalFormat qtdReal = new DecimalFormat("###,##00.0");
            qtdReal.setCurrency(Currency.getInstance(new Locale("pt", "BR")));
            //
            SimpleDateFormat formatoAmerica = new SimpleDateFormat("dd/MM/yyyy");
            dataVctoLote = formatoAmerica.format(jDataVctoLote.getDate().getTime());
            //
            if (jCodProduto.getText().equals("")) {
                ...
                if (acao == 3) {
                    ...
                    if (saldoEstoque >= objItensReqMatInter.getQtdItem()) {
                        ...
                        objItensReqMatInter.setLoteProduto(jLote.getText());
                        objItensReqMatInter.setQtdItem(estoqueAtual);
                        objItensReqMatInter.setDataVenc(dataVctoLote);
                        // TABELA DE LOTE_PRODUTOS_AC 
                        controle.alterarEstoqueMateraisFAR(objItensReqMatInter);
                        ...
                        controle.incluirRequisicaoAvulsaMaterialFAR(objItensReqMatInter);
                        //
                        objLog2();
                        controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                        preencherTabelaItens("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR "
                ...
                if (acao == 4) {
                    ...
                    if (novoSaldoAtual >= objItensReqMatInter.getQtdItem()) {
                        ...
                        // ALTERAR QUANTIDADE NA TABELA ITENS_REQUISICAO_PRODUTOS_INTERNOS
                        objItensReqMatInter.setIdItem(Integer.valueOf(idItem));
                        controle.alterarRequisicaoAvulsaMaterialFAR(objItensReqMatInter);
                        // ALTERAR SALDO DE ESTOQUE NA TABELA DE LOTE_PRODUTOS_AC
                        objItensReqMatInter.setQtdItem(estoqueAtual);
                        controle.alterarEstoqueMateraisFAR(objItensReqMatInter);
                        //
                        objLog2();
    ...
    private void jBtAuditoriaItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaItemActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaItensRequiAvulsaFAR objAudiItensReqAvulsaAC = new TelaAuditoriaItensRequiAvulsaFAR();
        TelaModuloFarmacia.jPainelFarmacia.add(objAudiItensReqAvulsaAC);
    ...
    private void jBtPesquisarMotivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarMotivoActionPerformed
        // TODO add your handling code here:
        TelaPesquisaMotivoSaidaFAR objMot = new TelaPesquisaMotivoSaidaFAR();
        TelaModuloFarmacia.jPainelFarmacia.add(objMot);
        objMot.show();
    }//GEN-LAST:event_jBtPesquisarMotivoActionPerformed
    ...
    private javax.swing.JButton jBtPesquisarMotivo;
    ...
    public static javax.swing.JComboBox jComboBoxProdutosAvaria;
    ...
    public static javax.swing.JTextField jMotivoSaidaProdutos;
    ...
    public void corCampos() {
        ...
        jMotivoSaidaProdutos.setBackground(Color.white);
        //
    ...
    public void Novo() {
        ...
        jComboBoxProdutosAvaria.setSelectedItem("Não");
        //
        jCodFuncReq.setText("");
        ...
        jBtPesquisarMotivo.setEnabled(true);
        jComboBoxProdutosAvaria.setEnabled(true);
    ...
    public void Finalizar() {
        ...
        if (rows == 0) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                control.finalizarRequisicaoMaterialAvulsoFAR(objReqMatAvulso);
    ...
    public void lancarHistorico() {
        ...
        for (int i = 0; i < jTabelaItensRequisicao.getRowCount(); i++) {
            ...
            SomaProdutoLote(); // SOMAR PRODUTO NA TABELA DE LOTE_ESTOQUE_AC PARA  TABELA HISTORICO_MOVIMENTACAO_ESTOQUE_FAR
    ...
    public void verificarItensRequisitados() {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_AVULSA_PRODUTOS_FAR WHERE IdReq='" + objReqMatAvulso.getIdReq() + "'");
            conecta.rs.first();
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                objReqMatAvulso.setIdReq(Integer.parseInt(jCodReq.getText()));
                control.excluirRequisicaoMaterialAvulsoFAR(objReqMatAvulso);
                objLog();
                controlLog.incluirLogSistema(objLogSys); // Grava o log da operação
                JOptionPane.showMessageDialog(rootPane, "Registro EXCLUIDO com sucesso !!!");
                Excluir();
    ...
    // PESQUISAR PRODUTO POR DATA DE VENCIMENTO PARA DAR BAIXA
    public void saidaPorDataVecto(int idProd, String DataVcto) {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM LOTE_PRODUTOS_AC "
                    + "WHERE IdProd='" + idProd + "' "
                    + "AND DataVenc>='" + DataVcto + "' "
                    + "ORDER BY DataVenc");
            conecta.rs.first();
            codProd = conecta.rs.getInt("IdProd");
            codEstoque = conecta.rs.getInt("IdItem");
    ...
    public void saidaPorDataVectoAV(int idProd, String DataVcto) {
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT * FROM LOTE_PRODUTOS_AC "
                    + "WHERE IdProd='" + idProd + "' "
