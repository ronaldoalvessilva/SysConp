...
import gestor.Controle.ControleTipoExame;
 ...
 * @author ronaldo
 */
public class TelaTiposExames extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    TipoExameMedico objTipoEx = new TipoExameMedico();
    ControleTipoExame control = new ControleTipoExame();
    //
    ControleLogSistema controlLog = new ControleLogSistema();
    LogSistema objLogSys = new LogSistema();
    // Variáveis para gravar o log
    String nomeModuloTela = "ENFERMARIA:Tipos de Exames:Manutenção";
    //
    String statusMov;
    String horaMov;
    String dataModFinal;
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(jComboBoxStatusExame, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGap(22, 22, 22))))))
        );
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        ...
        if (codigoUserENF == codUserAcessoENF && nomeTela.equals(telaTipoExamesENF) && codIncluirENF == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            acao = 1;
            Novo();
            corCampos();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        if (codigoUserENF == codUserAcessoENF && nomeTela.equals(telaTipoExamesENF) && codAlterar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
            acao = 2;
            Alterar();
            statusMov = "Alterou";
            horaMov = jHoraSistema.getText();
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        if (codigoUserENF == codUserAcessoENF && nomeTela.equals(telaTipoExamesENF) && codExcluir == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        if (codigoUserENF == codUserAcessoENF && nomeTela.equals(telaTipoExamesENF) && codGravar == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupo.equals("ADMINISTRADORES")) {
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaTiposExames objAudiExa = new TelaAuditoriaTiposExames();
        TelaModuloEnfermaria.jPainelMedico.add(objAudiExa);
        objAudiExa.show();
    ...
    private void jBtPesqNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeActionPerformed
        ...
        if (jPesqNomeExame.getText().equals("")) {
            ...
            preencherTabelaExames("SELECT * FROM TIPOS_EXAMES_MEDICO "
                    + "WHERE DescricaoExame LIKE'%" + jPesqNomeExame.getText() + "%'");
        }
    ...
    private void jCheckBoxTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaExames("SELECT * FROM TIPOS_EXAMES_MEDICO");
        } else {
            count = 0;
    ...
    private void jTabelaTiposExamesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabelaTiposExamesMouseClicked
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM TIPOS_EXAMES_MEDICO "
                        + "WHERE IdExame='" + IdLanc + "'");
                conecta.rs.first();
                jCodigoExame.setText(String.valueOf(conecta.rs.getInt("IdExame")));
                jComboBoxStatusExame.setSelectedItem(conecta.rs.getString("StatusExame"));
                jComboBoxCategoria.setSelectedItem(conecta.rs.getString("Classificacao"));
                jNomeExame.setText(conecta.rs.getString("DescricaoExame"));
    ...
    public void buscarCodigo() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM TIPOS_EXAMES_MEDICO");
            conecta.rs.last();
            jCodigoExame.setText(conecta.rs.getString("IdExame"));
        } catch (Exception e) {
    ...
    public void preencherTabelaExames(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Status", "Classificação", "Descrição do Exame"};
        conecta.abrirConexao();
        try {
            ...
            do {
                ...
                dados.add(new Object[]{conecta.rs.getInt("IdExame"), conecta.rs.getString("StatusExame"), conecta.rs.getString("Classificacao"), conecta.rs.getString("DescricaoExame")});
