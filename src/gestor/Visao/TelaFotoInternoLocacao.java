...
import static gestor.Visao.TelaConsultaLocalInternoPortaria.jIdInterno;
 ...
 * @author ronaldo
 */
public class TelaFotoInternoLocacao extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaConsultaLocalInternoPortaria telaconsultalocacao;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoInternoLocacao(TelaConsultaLocalInternoPortaria parent, boolean modal) {
        this.telaconsultalocacao = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaconsultalocacao);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoInternoLocacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoInternoLocacao dialog = new TelaFotoInternoLocacao(telaconsultalocacao, true);
