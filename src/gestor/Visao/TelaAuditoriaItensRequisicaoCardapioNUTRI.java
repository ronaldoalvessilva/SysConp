...
import static gestor.Visao.TelaRequisicaoMateriaisNUTRI.jCodReq;
import static gestor.Visao.TelaRequisicaoMateriaisNUTRI.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaItensRequisicaoCardapioNUTRI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaItensRequisicaoCardapioNUTRI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ITENS_REQUISICAO_PRODUTOS_CARDAPIO_NUTRI WHERE IdReq='" + jCodReq.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
