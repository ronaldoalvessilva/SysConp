...
import static gestor.Visao.TelaDevolucaoAcervo.jDescricaoProduto;
import static gestor.Visao.TelaDevolucaoAcervo.jIdProduto;
import static gestor.Visao.TelaDevolucaoAcervo.jCodigoBarra;
import static gestor.Visao.TelaDevolucaoAcervo.jPrazoEmprestimo;
import static gestor.Visao.TelaDevolucaoAcervo.jQtdEmprestada;
import static gestor.Visao.TelaDevolucaoAcervo.jRadBtCDrom;
import static gestor.Visao.TelaDevolucaoAcervo.jRadBtDVDRom;
import static gestor.Visao.TelaDevolucaoAcervo.jRadBtJornal;
import static gestor.Visao.TelaDevolucaoAcervo.jRadBtLivro;
import static gestor.Visao.TelaDevolucaoAcervo.jRadBtRevista;
import static gestor.Visao.TelaDevolucaoAcervo.jSaldoAtual;
 ...
 * @author user
 */
public class TelaPesqLivroAcervoEmprestimoDevolucao extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    int flag;
    String statusProd = "Ativo";
    String tipoAcervo;
    String utilizadoDevolucao = "Não";

    /**
     * Creates new form TelaPesqProdutoFarmacia
     */
    public TelaPesqLivroAcervoEmprestimoDevolucao() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Listagem de Produtos Devolução {PE} :::...");
    ...
    private void jBtPesqDescricaoProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoProdActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().equals("")) {
            ...
            preencherTabelaProdutos("SELECT * FROM LIVROS_REVISTAS_JORNAIS "
                    ...
                    + "WHERE TituloLivro LIKE'%" + jPesqDescricaoProdutos.getText() + "%'AND StatusLivro='" + statusProd + "'AND UtilizadoDevolucao='" +  utilizadoDevolucao  + "'");
        }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqDescricaoProdutos.getText().isEmpty()) {
            ...
            try {
                ...
                jQtdEmprestada.setText(conecta.rs.getString("QtdItem"));
    ...
    private void jCheckBoxPesqTodosProdItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosProdItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaProdutos("SELECT * FROM LIVROS_REVISTAS_JORNAIS "
                    ...
                    + "INNER JOIN ITENS_EMPRESTIMO_ACERVO "
                    + "ON LIVROS_REVISTAS_JORNAIS.IdLivro=ITENS_EMPRESTIMO_ACERVO.IdLivro "
                    + "WHERE StatusLocal='" + statusProd + "'AND ITENS_EMPRESTIMO_ACERVO.UtilizadoDevolucao='" + utilizadoDevolucao  + "'");
        } else {
            limparTabela();
        }
