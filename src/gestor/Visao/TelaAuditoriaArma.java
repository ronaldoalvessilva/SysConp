 ...
 */
public class TelaAuditoriaArma extends javax.swing.JDialog {
    ...
    public TelaAuditoriaArma(TelaArmas parent, boolean modal) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAuditoriaArma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAuditoriaArma dialog = new TelaAuditoriaArma(pTELA_armas, true);
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM ARMAS WHERE IdArma='" + jIdArma.getText() + "'");
            conecta.rs.first();
