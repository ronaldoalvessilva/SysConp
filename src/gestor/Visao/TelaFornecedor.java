 ...
 * @author Ronaldo
 */
public final class TelaFornecedor extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "Farmácia:Fornecedor:Manutenção";
    //
    String statusMov;
    String horaMov;
    String dataModFinal;
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Cadastro de Fornecedor  {FAR}::: ...");
        ...
        jPanel13Layout.setVerticalGroup(
            ...
            .addGroup(jPanel13Layout.createSequentialGroup()
                ...
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jBtPesqDescricao, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaFornecedorFAR objAudiFornFAR = new TelaAuditoriaFornecedorFAR();
        TelaModuloFarmacia.jPainelFarmacia.add(objAudiFornFAR);
        objAudiFornFAR.show();
    ...
    private void jCheckBoxPesqTodosFornItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxPesqTodosFornItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED && !jIdFornecedor.getText().equals("")) {
            this.preencherTabelaHistoricoProdutos("SELECT * FROM HISTORICO_COMPRA_FAR "
                    + "INNER JOIN PRODUTOS_AC "
                    + "ON HISTORICO_COMPRA_FAR.IdProd=PRODUTOS_AC.IdProd "
    ...
    private void jBtPesqDescricaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoActionPerformed
        ...
        if (jPesqProdutosCompras.getText().equals("") && !jIdFornecedor.getText().equals("")) {
            ...
            preencherTabelaHistoricoProdutos("SELECT * FROM HISTORICO_COMPRA_FAR "
                    + "INNER JOIN PRODUTOS_AC "
                    + "ON HISTORICO_COMPRA_FAR.IdProd=PRODUTOS.IdProd "
                    + "INNER JOIN NF_COMPRAS_FAR "
                    + "ON HISTORICO_COMPRA_FAR.IdNfEntrada=NF_COMPRAS_FAR.IdNfEntrada "
                    + "INNER JOIN FORNECEDORES_AC "
                    + "ON NF_COMPRAS_FAR.IdForn=FORNECEDORES_AC.IdForn "
...
// VERIFICAR SE O FORNECEDOR JÁ FOI CADASTRADO NA TABELA DE FORNECEDORES
