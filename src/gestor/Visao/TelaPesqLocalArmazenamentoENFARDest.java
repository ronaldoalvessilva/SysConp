...
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.jIdLocalDestino;
import static gestor.Visao.TelaDevolucaoMedicamentosEnfermariaFarmacia.jDescricaoLocalDestino;
 ...
 * @author user
 */
public class TelaPesqLocalArmazenamentoENFARDest extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqLocalArmazenamentoENFARDest() {
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqDescricaoLocal.getText().isEmpty()) {
            ...
            try {
                ...
                conecta.rs.first();
                jIdLocalDestino.setText(String.valueOf(conecta.rs.getInt("IdLocal")));
    ...
    public void preencherTabelaProdutos(String sql) {
        ...
        alinhaCamposTabelaLocais();
        conecta.desconecta();
    }

    public void alinhaCamposTabelaLocais() {
