...
import static gestor.Visao.TelaAtendimentoTerapiaOcupacional.codigoAvaliacaoI;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAvaliacaoI extends javax.swing.JInternalFrame {

    ConexaoBancoDados conecta = new ConexaoBancoDados();      
    /**
     * Creates new form TelaAuditoriaRolInternas
     */
    public TelaAuditoriaAvaliacaoI() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Avaliação I :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AVALIACAO_I WHERE IdAvaliaI='" + codigoAvaliacaoI + "'");
            conecta.rs.first();
