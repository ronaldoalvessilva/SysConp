...
import gestor.Dao.*;
import static gestor.Visao.TelaEntradaSaidaVisitasDiversas.FotoVisitasDiversas;
import static gestor.Visao.TelaEntradaSaidaVisitasDiversas.jBtZoonVisitaDiversas;
 ...
 * @author user
 */
public class TelaPesqVisitasDiversas extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqVisitasDiversas() {
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM VISITASDIVERSAS WHERE NomeVisita='" + nomeVisitante + "'");
                conecta.rs.first();
...
//Preencher tabela com todos os COLABORADORES
    public void buscarVisitas(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Nome do Visitante"};
        conecta.abrirConexao();
        try {
    ...
    public void alinharCcamposTabela() {
