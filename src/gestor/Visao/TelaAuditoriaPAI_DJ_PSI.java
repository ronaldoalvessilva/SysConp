 ...
 * @author Ronaldo
 */
public class TelaAuditoriaPAI_DJ_PSI extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaPAI_DJ_PSI() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM FICHA_CADASTRO_PAI_DJ WHERE IdPai='" + jCodigoPAI.getText() + "'");
            conecta.rs.first();
