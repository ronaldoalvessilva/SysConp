 ...
 * @author Ronaldo
 */
public class TelaAprovadoresOcorrenciaVisitasInternosServicoSocial extends javax.swing.JInternalFrame {
    ...
    String nomeModuloTela = "Serviço Social:Aprovadores Ocorrência Disciplinar Visitas:Manutenção";
    String statusMov;
    String horaMov;
    String dataModFinal;
    ...
    int count = 0;
    String dataEntrada;
    int modulo = 1; //SERVIÇO SOCIAL

    /**
     * Creates new form TelaAprovadoresOcorrenciaVistasInternos
     */
    public TelaAprovadoresOcorrenciaVisitasInternosServicoSocial() {
        initComponents();
        formatarCampos();
        corCampos();
    }
    ...
    private void initComponents() {
        ...
        jModuloLiberador.setDisabledTextColor(new java.awt.Color(255, 51, 51));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(204, 204, 204), 1, true), "Observação", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 51, 51))); // NOI18N
    ...
    private void jBtPesqCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqCodigoActionPerformed
        ...
        if (jCodigoPesquisa.getText().equals("")) {
            ...
            preencherTabelaAprovadores("SELECT * FROM APROVADORES_OCORRENCIA_PORTARIA "
                    + "INNER JOIN USUARIOS "
                    + "ON APROVADORES_OCORRENCIA_PORTARIA.IdUsuario=USUARIOS.IdUsuarios "
    ...
    private void jBtPesqNomeAprovadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqNomeAprovadorActionPerformed
        ...
        if (jNomeAprovadorPesquisa.getText().equals("")) {
            ...
            preencherTabelaAprovadores("SELECT * FROM APROVADORES_OCORRENCIA_PORTARIA "
                    + "INNER JOIN USUARIOS "
                    + "ON APROVADORES_OCORRENCIA_PORTARIA.IdUsuario=USUARIOS.IdUsuario "
                    + "WHERE NomeUsuario LIKE'%" + jNomeAprovadorPesquisa.getText() + "%' "
                    + "AND APROVADORES_OCORRENCIA_PORTARIA.ModDep='" + modulo + "'");
        }
    ...
    private void jBtNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNovoActionPerformed
        // TODO add your handling code here:
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaAprovadoresOcrSS) && codIncluirSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
            acao = 1;
            Novo();
            statusMov = "Incluiu";
    ...
    private void jBtAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAlterarActionPerformed
        // TODO add your handling code here:
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaAprovadoresOcrSS) && codAlterarSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
            acao = 2;
            Alterar();
            statusMov = "Alterou";
            horaMov = jHoraSistema.getText();
    ...
    private void jBtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtExcluirActionPerformed
        // TODO add your handling code here:
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaAprovadoresOcrSS) && codExcluirSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
            statusMov = "Excluiu";
            horaMov = jHoraSistema.getText();
            dataModFinal = jDataSistema.getText();
            Excluir();
    ...
    private void jBtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtSalvarActionPerformed
        // TODO add your handling code here:
        if (codigoUserSS == codUserAcessoSS && nomeTelaSS.equals(telaAprovadoresOcrSS) && codGravarSS == 1 || nameUser.equals("ADMINISTRADOR DO SISTEMA") || nomeGrupoSS.equals("ADMINISTRADORES")) {
    ...
    private void jBtPesquisarColaboradorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarColaboradorActionPerformed
        // TODO add your handling code here:
        TelaPesqColaboradorOcorrenciaVisitaSocial objPesqFunc = new TelaPesqColaboradorOcorrenciaVisitaSocial();
        TelaModuloServicoSocial.jPainelServicoSocial.add(objPesqFunc);
        objPesqFunc.show();
    }//GEN-LAST:event_jBtPesquisarColaboradorActionPerformed

    private void jBtAuditoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtAuditoriaActionPerformed
        // TODO add your handling code here:
        TelaAuditoriaAutorizadoresOcorrenciaPortariaSS objAudSS = new TelaAuditoriaAutorizadoresOcorrenciaPortariaSS();
