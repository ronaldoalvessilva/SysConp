...
import static gestor.Visao.TelaVeiculosExterna.jIDVeiculo;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaVeculosExterna extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaVeculosExterna() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM VEICULOS WHERE IdVeiculo='" + jIDVeiculo.getText() + "'");
            conecta.rs.first();
