...
import static gestor.Visao.TelaRegistroChegadaVisitasInternosPortariaExterna.jCodigoVisita;
import static gestor.Visao.TelaRegistroChegadaVisitasInternosPortariaExterna.jFotoVisita;
import static gestor.Visao.TelaRegistroChegadaVisitasInternosPortariaExterna.jGrauParentesco;
import static gestor.Visao.TelaRegistroChegadaVisitasInternosPortariaExterna.jIdInternoBio;
import static gestor.Visao.TelaRegistroChegadaVisitasInternosPortariaExterna.jIdRol;
import static gestor.Visao.TelaRegistroChegadaVisitasInternosPortariaExterna.jNomeInternoBio;
import static gestor.Visao.TelaRegistroChegadaVisitasInternosPortariaExterna.jNomeVisitante;
import static gestor.Visao.TelaRegistroChegadaVisitasInternosPortariaExterna.jPavilhao;
import static gestor.Visao.TelaRegistroChegadaVisitasInternosPortariaExterna.jRegimePenal;
 ...
 * @author Ronaldo
 */
public class TelaPesqVisitasInternoChegadaPortExt extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqVisitasInternoChegadaPortExt() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        if (jTabelaVisitas.getColumnModel().getColumnCount() > 0) {
            ...
            jTabelaVisitas.getColumnModel().getColumn(2).setMinWidth(390);
            jTabelaVisitas.getColumnModel().getColumn(2).setMaxWidth(390);
        }
    ...
    private void jBtNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtNomeActionPerformed
        ...
        if (jPesqNome.getText().equals("")) {
            ...
            pesquisarVisitasRol("SELECT * FROM ROLVISITAS "
  ...
  // Método de pesquisa pela Descrição
    ...
    public void pesquisarVisitasRol(String sql) {
        ...
        jTabelaVisitas.getColumnModel().getColumn(2).setPreferredWidth(390);
