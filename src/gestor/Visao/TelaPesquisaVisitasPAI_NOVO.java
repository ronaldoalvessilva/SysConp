...
import static gestor.Visao.TelaPAI_NOVO.jIdVisitaPAI;
import static gestor.Visao.TelaPAI_NOVO.jNomeVisitaPAI;
import static gestor.Visao.TelaPAI_NOVO.jParentescoPAI;
 ...
 * @author Ronaldo
 */
public class TelaPesquisaVisitasPAI_NOVO extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisaVisitasPAI_NOVO() {
        initComponents();
    }
    ...
    private void jBtEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtEnviarActionPerformed
        ...
        if (jPesqNome.getText().isEmpty()) {
            ...
            try {
                ...
                conecta.rs.first();
                jIdVisitaPAI.setText(String.valueOf(conecta.rs.getInt("IdVisita")));
