...
import static gestor.Visao.TelaAdmissaoEnfermagem.codigoAFP2;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAdmissaoEnfermeiraAEFP2 extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAdmissaoEnfermeiraAEFP2() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        ...
        try {            
            conecta.executaSQL("SELECT * FROM ADME_AFP2 WHERE IdLanc='" + jIdLanc.getText() + "' "
                    + "AND ADME_AFP2.IdAfp2='" + codigoAFP2 + "'");
            conecta.rs.first();
