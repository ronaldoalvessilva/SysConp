...
import static gestor.Visao.TelaFuncionarios.jCodigoDependente;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaDependentesColaborador extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaDependentesColaborador() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Dependentes ::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM DEPENDENTES WHERE IdFunc='" + jIDFunc.getText() + "'AND IdDep='" + jCodigoDependente.getText() + "'");
            conecta.rs.first();
