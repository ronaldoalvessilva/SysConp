...
import static gestor.Visao.TelaEditorasInstituicao.jIdFornecedor;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaEditoraInstituicao extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaEditoraInstituicao() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Editora/Instituição :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM EDITORAS_INSTITUICAO WHERE IdForn='" + jIdFornecedor.getText() + "'");
            conecta.rs.first();
