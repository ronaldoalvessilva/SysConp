...
import static gestor.Visao.TelaAmparoLegal.jCodigoAmparo;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaAmparoLegal extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaAmparoLegal() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Amparo Legal :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM AMPARO_LEGAL WHERE IdLanc='" + jCodigoAmparo.getText() + "'");
            conecta.rs.first();
