...
import static gestor.Visao.TelaRegimentoInternoDisciplinar.jLocalEvento;
 ...
 * @author ronaldo
 */
public class TelaPesquisarLocalEventoRegimeDisciplinar extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesquisarLocalEventoRegimeDisciplinar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("...::: Pesquisar Local Evento :::...");
    ...
    private void jBtConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtConfirmarActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                conecta.executaSQL("SELECT * FROM LOCALEVENTOS WHERE DescricaoLocal='" + jPesqDescricaoLocal.getText() + "'");
                conecta.rs.first();
    ...
    private void jBtPesqDescricaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesqDescricaoActionPerformed
        ...
        if (jPesqDescricaoLocal.getText().equals("")) {
            ...
            preencherTabelaLocal("SELECT * FROM LOCALEVENTOS WHERE DescricaoLocal LIKE'%" + jPesqDescricaoLocal.getText() + "%'AND StatusLocal='" + statusLocal + "'");
        }
    ...
    private void jCheckBoxTodosItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBoxTodosItemStateChanged
        ...
        if (evt.getStateChange() == evt.SELECTED) {
            this.preencherTabelaLocal("SELECT * FROM LOCALEVENTOS WHERE StatusLocal='" + statusLocal + "'");
        } else {
            limparTabela();
        }
