...
import static gestor.Visao.TelaVisitaSocialReligiosa.jIDVisita;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaVisitasSocialReligiosa extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaVisitasSocialReligiosa() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Visitas Religiosas :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM VISITAS_RELIGIOSA_INTERNOS WHERE IdVisitaRel='" + jIDVisita.getText() + "'");
            conecta.rs.first();
