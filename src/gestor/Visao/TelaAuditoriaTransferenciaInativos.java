...
import static gestor.Visao.TelaTransferenciaValoresInternos.jIdLanc;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaTransferenciaInativos extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaTransferenciaInativos() {
        initComponents();
        auditoria();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("...::: Auditoria Transferência de Internos :::...");
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM TRANSFERENCIA_VALORES_INATIVOS WHERE IdLanc='" + jIdLanc.getText() + "'");
            conecta.rs.first();
