 ...
 * @author ronaldo
 */
public class TelaFotoInternoRegimeDisciplinar extends javax.swing.JDialog {

    ConexaoBancoDados conecta = new ConexaoBancoDados();

    String caminhoFoto;

    public static TelaRegimentoInternoDisciplinar telaRegimeDisciplinar;

    /**
     * Creates new form TelaFotoCrc
     */
    public TelaFotoInternoRegimeDisciplinar(TelaRegimentoInternoDisciplinar parent, boolean modal) {
        this.telaRegimeDisciplinar = parent;
        this.setModal(modal);
        setLocationRelativeTo(telaRegimeDisciplinar);
        initComponents();
        buscarFotoInterno();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaFotoInternoRegimeDisciplinar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaFotoInternoRegimeDisciplinar dialog = new TelaFotoInternoRegimeDisciplinar(telaRegimeDisciplinar, true);
    ...
    public void buscarFotoInterno() {
        ...
        try {
            conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC WHERE IdInternoCrc='" + jCodigoInternoReg.getText() + "'");
            conecta.rs.first();
