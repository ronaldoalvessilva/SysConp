...
import static gestor.Visao.TelaRequisicaoAvulsaFAR.jIdLocal;
 ...
 * @author user
 */
public class TelaPesqLocalArmazenamentoReqAvulsaFAR extends javax.swing.JInternalFrame {
     ...
     */
    public TelaPesqLocalArmazenamentoReqAvulsaFAR() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabelaLocaisArmazenamento.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        jTabelaLocaisArmazenamento.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null}
            },
            new String [] {
                "Código", "Descrição do Local de Armazenamento"
            }
        ));
    ...
    public void preencherTabelaProdutos(String sql) {
        ...
        String[] Colunas = new String[]{"Código", "Descrição do Local de Armazenamento"};
        conecta.abrirConexao();
