...
import static gestor.Visao.TelaAssistenciaEducacionalExterna.idItem;
 ...
 * @author Ronaldo
 */
public class TelaAuditoriaInternosEducacao extends javax.swing.JInternalFrame {
     ...
     */
    public TelaAuditoriaInternosEducacao() {
        initComponents();
        auditoria();
    }
    ...
    public void auditoria() {
        try {
            ...
            conecta.executaSQL("SELECT * FROM INTERNOS_SAIDA_EDUCACIONAL WHERE IdEduca='" + jIdLanc.getText() + "'AND IdItem='" + idItem + "'");
            conecta.rs.first();
