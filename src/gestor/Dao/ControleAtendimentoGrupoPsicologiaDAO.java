 ...
 */
public class ControleAtendimentoGrupoPsicologiaDAO {
    ...
    public AtividadesGrupoPsicologia incluirAtendimentoGrupoManutencaoPsi(AtividadesGrupoPsicologia objAvalia) {
        ...
        try {
            PreparedStatement pst = conecta.con.prepareStatement("INSERT INTO ATENDIMENTO_GRUPO_SS (StatusAtendGrupo,DataAtend,Responsavel,IdPav,Ambiente,HoraioInicio,HorarioTermino,"
    ...
    public AtividadesGrupoPsicologia alterarAtendimentoGrupoManutencaoPsi(AtividadesGrupoPsicologia objAvalia) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE ATENDIMENTO_GRUPO_SS SET StatusAtendGrupo=?,DataAtend=?,Responsavel=?,IdPav=?,Ambiente=?,HoraioInicio=?,HorarioTermino=?,"
                    + "LocalAtividade=?,GrupoAtividade=?,Observacao=?,UsuarioUp=?,DataUp=?,HorarioUp=? WHERE IdAtGrupoSS='" + objAvalia.getIdAtGrupoPsi() + "'");
            pst.setString(1, objAvalia.getStatusAtendGrupo());
            pst.setTimestamp(2, new java.sql.Timestamp(objAvalia.getDataAtend().getTime()));
            pst.setString(3, objAvalia.getResponsavel());
            pst.setInt(4, codigoPavilhao);
    ...
    public AtividadesGrupoPsicologia excluirAtendimentoGrupoManutencaoPsi(AtividadesGrupoPsicologia objAvalia) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("DELETE FROM ATENDIMENTO_GRUPO_SS WHERE IdAtGrupoSS='" + objAvalia.getIdAtGrupoPsi() + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
    ...
    public AtividadesGrupoPsicologia incluirPlanejamentoPSI(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("INSERT INTO PLANEJAMENTO_ATENDIMENTO_GRUPO_SS (IdAtGrupoSS,Tema,HoraInicio,HoraTermino,Turno,Atividades,Recursos,"
    ...
    public AtividadesGrupoPsicologia alterarPlanejamentoPSI(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE PLANEJAMENTO_ATENDIMENTO_GRUPO_SS SET IdAtGrupoSS=?,Tema=?,HoraInicio=?,HoraTermino=?,Turno=?,Atividades=?,Recursos=?,"
                    + "UsuarioUp=?,DataUp=?,HorarioUp=? WHERE IdItemPlanSS='" + objAvalia.getIdItemPlan() + "'");
            pst.setInt(1, objAvalia.getIdAtGrupoPsi());
            pst.setString(2, objAvalia.getTema());
            pst.setString(3, objAvalia.getHoraInicio());
            pst.setString(4, objAvalia.getHoraTermino());
    ...
    public AtividadesGrupoPsicologia excluirPlanejamentoPSI(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("DELETE FROM PLANEJAMENTO_ATENDIMENTO_GRUPO_SS WHERE IdItemPlanSS='" + objAvalia.getIdItemPlan() + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Não Foi possível EXCLUIR os Dados.\nERRO: " + ex);
        }
    ...
    public AtividadesGrupoPsicologia incluirAtendimentoGrupoParticipantesPsi(AtividadesGrupoPsicologia objAvalia) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("INSERT INTO PARTICIPANTES_ATENDIMENTO_GRUPO_SS (IdAtGrupoSS,IdInternoCrc,UsuarioInsert,DataInsert,HorarioInsert) VALUES(?,?,?,?,?)");
            pst.setInt(1, objAvalia.getIdAtGrupoPsi());
    ...
    public AtividadesGrupoPsicologia alterarAtendimentoGrupoParticipantesPsi(AtividadesGrupoPsicologia objAvalia) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE PARTICIPANTES_ATENDIMENTO_GRUPO_SS SET IdAtGrupoSS=?,IdInternoCrc=?,UsuarioUp=?,DataUp=?,HorarioUp=? WHERE IdItemPartSS='" + objAvalia.getIdItemPart() + "'");
            pst.setInt(1, objAvalia.getIdAtGrupoPsi());
            pst.setInt(2, codInterno);
    ...
    public AtividadesGrupoPsicologia excluirAtendimentoGrupoParticipantesPsi(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("DELETE FROM PARTICIPANTES_ATENDIMENTO_GRUPO_SS WHERE IdItemPartSS='" + objAvalia.getIdItemPart() + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Não Foi possível EXCLUIR os Dados.\nERRO: " + ex);
        }
    ...
    public AtividadesGrupoPsicologia incluirAtendimentoGrupoAVGPsi(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("INSERT INTO AVALICAO_ATENDIMENTO_GRUPO_SS (IdAtGrupoSS,TextoAvalaiacaoGrupo,UsuarioInsert,DataInsert,HorarioInsert) VALUES(?,?,?,?,?)");
            pst.setInt(1, objAvalia.getIdAtGrupoPsi());
    ...
    public AtividadesGrupoPsicologia alterarAtendimentoGrupoAVGPsi(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE AVALICAO_ATENDIMENTO_GRUPO_SS SET IdAtGrupoSS=?,TextoAvalaiacaoGrupo=?,UsuarioUp=?,DataUp=?,HorarioUp=? WHERE IdItemAvagSS='" + objAvalia.getIdItemAvag() + "'");
            pst.setInt(1, objAvalia.getIdAtGrupoPsi());
            pst.setString(2, objAvalia.getTextoAvalaiacaoGrupo());
            pst.setString(3, objAvalia.getUsuarioUp());
            pst.setString(4, objAvalia.getDataUp());
    ...
    public AtividadesGrupoPsicologia excluirAtendimentoGrupoAVGPsi(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("DELETE FROM AVALICAO_ATENDIMENTO_GRUPO_SS WHERE IdItemAvagSS='" + objAvalia.getIdItemAvag() + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Não Foi possível EXCLUIR os Dados.\nERRO: " + ex);
        }
    ...
    public AtividadesGrupoPsicologia incluirAtendimentoGrupoAVGIPsi(AtividadesGrupoPsicologia objAvalia) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("INSERT INTO AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_SS (IdAtGrupoSS,IdInternoCrc,TextoAvalaiacaoInd,UsuarioInsert,DataInsert,HorarioInsert) VALUES(?,?,?,?,?,?)");
            pst.setInt(1, objAvalia.getIdAtGrupoPsi());
            pst.setInt(2, codInterno);
    ...
    public AtividadesGrupoPsicologia alterarAtendimentoGrupoAVGIPsi(AtividadesGrupoPsicologia objAvalia) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_SS SET IdAtGrupoSS=?,IdInternoCrc=?,TextoAvalaiacaoInd=?,UsuarioUp=?,DataUp=?,HorarioUp=? WHERE IdItemAvaiSS='" + objAvalia.getIdItemAvai() + "'");
            pst.setInt(1, objAvalia.getIdAtGrupoPsi());
            pst.setInt(2, codInterno);
            pst.setString(3, objAvalia.getTextoAvalaiacaoInd());
            pst.setString(4, objAvalia.getUsuarioInsert());
    ...
    public AtividadesGrupoPsicologia excluirAtendimentoGrupoAVGIPsi(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("DELETE FROM AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_SS WHERE IdItemAvaiSS='" + objAvalia.getIdItemAvai() + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Não Foi possível EXCLUIR os Dados.\nERRO: " + ex);
        }
