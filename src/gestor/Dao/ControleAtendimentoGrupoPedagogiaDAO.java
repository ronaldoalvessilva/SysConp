 ...
 */
public class ControleAtendimentoGrupoPedagogiaDAO {
    ...
    public AtividadesGrupoPsicologia incluirAtendimentoGrupoManutencaoPsi(AtividadesGrupoPsicologia objAvalia) {
        ...
        try {
            PreparedStatement pst = conecta.con.prepareStatement("INSERT INTO ATENDIMENTO_GRUPO_PE (StatusAtendGrupo,DataAtend,Responsavel,IdPav,Ambiente,HoraioInicio,HorarioTermino,"
    ...
    public AtividadesGrupoPsicologia alterarAtendimentoGrupoManutencaoPsi(AtividadesGrupoPsicologia objAvalia) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE ATENDIMENTO_GRUPO_PE SET StatusAtendGrupo=?,DataAtend=?,Responsavel=?,IdPav=?,Ambiente=?,HoraioInicio=?,HorarioTermino=?,"
                    + "LocalAtividade=?,GrupoAtividade=?,Observacao=?,UsuarioUp=?,DataUp=?,HorarioUp=? WHERE IdAtGrupoPE='" + objAvalia.getIdAtGrupoPsi() + "'");
            pst.setString(1, objAvalia.getStatusAtendGrupo());
            pst.setTimestamp(2, new java.sql.Timestamp(objAvalia.getDataAtend().getTime()));
            pst.setString(3, objAvalia.getResponsavel());
            pst.setInt(4, codigoPavilhao);
    ...
    public AtividadesGrupoPsicologia excluirAtendimentoGrupoManutencaoPsi(AtividadesGrupoPsicologia objAvalia) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("DELETE FROM ATENDIMENTO_GRUPO_PE WHERE IdAtGrupoPE='" + objAvalia.getIdAtGrupoPsi() + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
    ...
    public AtividadesGrupoPsicologia incluirPlanejamentoPSI(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("INSERT INTO PLANEJAMENTO_ATENDIMENTO_GRUPO_PE (IdAtGrupoPE,Tema,HoraInicio,HoraTermino,Turno,Atividades,Recursos,"
    ...
    public AtividadesGrupoPsicologia alterarPlanejamentoPSI(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE PLANEJAMENTO_ATENDIMENTO_GRUPO_PE SET IdAtGrupoPE=?,Tema=?,HoraInicio=?,HoraTermino=?,Turno=?,Atividades=?,Recursos=?,"
                    + "UsuarioUp=?,DataUp=?,HorarioUp=? WHERE IdItemPlanPE='" + objAvalia.getIdItemPlan() + "'");
            pst.setInt(1, objAvalia.getIdAtGrupoPsi());
            pst.setString(2, objAvalia.getTema());
            pst.setString(3, objAvalia.getHoraInicio());
            pst.setString(4, objAvalia.getHoraTermino());
    ...
    public AtividadesGrupoPsicologia excluirPlanejamentoPSI(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("DELETE FROM PLANEJAMENTO_ATENDIMENTO_GRUPO_PE WHERE IdItemPlanPE='" + objAvalia.getIdItemPlan() + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Não Foi possível EXCLUIR os Dados.\nERRO: " + ex);
        }
    ...
    public AtividadesGrupoPsicologia incluirAtendimentoGrupoParticipantesPsi(AtividadesGrupoPsicologia objAvalia) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("INSERT INTO PARTICIPANTES_ATENDIMENTO_GRUPO_PE (IdAtGrupoPE,IdInternoCrc,UsuarioInsert,DataInsert,HorarioInsert) VALUES(?,?,?,?,?)");
            pst.setInt(1, objAvalia.getIdAtGrupoPsi());
    ...
    public AtividadesGrupoPsicologia alterarAtendimentoGrupoParticipantesPsi(AtividadesGrupoPsicologia objAvalia) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE PARTICIPANTES_ATENDIMENTO_GRUPO_PE SET IdAtGrupoPE=?,IdInternoCrc=?,UsuarioUp=?,DataUp=?,HorarioUp=? WHERE IdItemPartPE='" + objAvalia.getIdItemPart() + "'");
            pst.setInt(1, objAvalia.getIdAtGrupoPsi());
            pst.setInt(2, codInterno);
    ...
    public AtividadesGrupoPsicologia excluirAtendimentoGrupoParticipantesPsi(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("DELETE FROM PARTICIPANTES_ATENDIMENTO_GRUPO_PE WHERE IdItemPartPE='" + objAvalia.getIdItemPart() + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Não Foi possível EXCLUIR os Dados.\nERRO: " + ex);
        }
    ...
    public AtividadesGrupoPsicologia incluirAtendimentoGrupoAVGPsi(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("INSERT INTO AVALICAO_ATENDIMENTO_GRUPO_PE (IdAtGrupoPE,TextoAvalaiacaoGrupo,UsuarioInsert,DataInsert,HorarioInsert) VALUES(?,?,?,?,?)");
            pst.setInt(1, objAvalia.getIdAtGrupoPsi());
    ...
    public AtividadesGrupoPsicologia alterarAtendimentoGrupoAVGPsi(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE AVALICAO_ATENDIMENTO_GRUPO_PE SET IdAtGrupoPE=?,TextoAvalaiacaoGrupo=?,UsuarioUp=?,DataUp=?,HorarioUp=? WHERE IdItemAvagPE='" + objAvalia.getIdItemAvag() + "'");
            pst.setInt(1, objAvalia.getIdAtGrupoPsi());
            pst.setString(2, objAvalia.getTextoAvalaiacaoGrupo());
            pst.setString(3, objAvalia.getUsuarioUp());
            pst.setString(4, objAvalia.getDataUp());
    ...
    public AtividadesGrupoPsicologia excluirAtendimentoGrupoAVGPsi(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("DELETE FROM AVALICAO_ATENDIMENTO_GRUPO_PE WHERE IdItemAvagPE='" + objAvalia.getIdItemAvag() + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Não Foi possível EXCLUIR os Dados.\nERRO: " + ex);
        }
    ...
    public AtividadesGrupoPsicologia incluirAtendimentoGrupoAVGIPsi(AtividadesGrupoPsicologia objAvalia) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("INSERT INTO AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_PE (IdAtGrupoPE,IdInternoCrc,TextoAvalaiacaoInd,UsuarioInsert,DataInsert,HorarioInsert) VALUES(?,?,?,?,?,?)");
            pst.setInt(1, objAvalia.getIdAtGrupoPsi());
            pst.setInt(2, codInterno);
    ...
    public AtividadesGrupoPsicologia alterarAtendimentoGrupoAVGIPsi(AtividadesGrupoPsicologia objAvalia) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_PE SET IdAtGrupoPE=?,IdInternoCrc=?,TextoAvalaiacaoInd=?,UsuarioUp=?,DataUp=?,HorarioUp=? WHERE IdItemAvaiPE='" + objAvalia.getIdItemAvai() + "'");
            pst.setInt(1, objAvalia.getIdAtGrupoPsi());
            pst.setInt(2, codInterno);
            pst.setString(3, objAvalia.getTextoAvalaiacaoInd());
            pst.setString(4, objAvalia.getUsuarioInsert());
    ...
    public AtividadesGrupoPsicologia excluirAtendimentoGrupoAVGIPsi(AtividadesGrupoPsicologia objAvalia) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("DELETE FROM AVALICAO_INDIVIDUAL_ATENDIMENTO_GRUPO_PE WHERE IdItemAvaiPE='" + objAvalia.getIdItemAvai() + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Não Foi possível EXCLUIR os Dados.\nERRO: " + ex);
        }
