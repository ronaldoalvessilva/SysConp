 ...
 * @author Ronaldo
 */
public class MovTecAtestadoMedicoPsiquiatrico {
    private int IdMov;
    ...
    public MovTecAtestadoMedicoPsiquiatrico(int IdMov, int IdInternoCrc, int IdAtend, String StMov, Date DataMov, String NomeOpe, String DeptoMov) {
        this.IdMov = IdMov;
    ...
    public MovTecAtestadoMedicoPsiquiatrico() {
    }
