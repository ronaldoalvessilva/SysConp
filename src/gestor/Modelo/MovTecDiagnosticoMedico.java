 ...
 * @author ronaldo
 */
public class MovTecDiagnosticoMedico {
    ...
    public MovTecDiagnosticoMedico(int IdMov, int IdInternoCrc, int IdAtend, String StMov, Date DataMov, String NomeOpe, String DeptoMov) {
        this.IdMov = IdMov;
    ...
    public MovTecDiagnosticoMedico() {
    }
