 ...
 * @author Ronaldo
 */
public class EstoqueAcervoCompras {
    ...
    public EstoqueAcervoCompras(int idEstoque, int idDocumento, Date dataLanc, String tipoMov, int idLivro, String nomeLivro, int idLocal, String descricaoLocal, float saldoEstoque, float saldoEstoqueAtual) {
