 ...
 * @author ronaldo
 */
public class ItensRetornoTransferencia {
    ...
    public ItensRetornoTransferencia(int idItem, int idInternoCrc, String nomeInterno, int idRetorno, int idRegistro, int idItemRetornoEsp, Date dataRetorno, String origemRetorno, String confirmaRetorno, Date dataNovaEntrada, String procedencia, String regime, int idUnidade, String descricaoUnidade, String usuarioInsert, String usuarioUp, String dataInsert, String dataUp, String horaInsert, String horaUp) {
        this.idItem = idItem;
    ...
    public ItensRetornoTransferencia() {
    }
