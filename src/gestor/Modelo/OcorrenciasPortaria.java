 ...
 * @author ronaldo
 */
public class OcorrenciasPortaria {
    ...
    public OcorrenciasPortaria(Integer idLanc, String statusLanc, Date dataLanc, String titulo, String textoArea, String usuarioInsert, String usuarioUp, String dataInsert, String dataUp, String horarioInsert, String horarioUp, String fonte, String Tamanho, int Btesq, int BtCen, int BtDir, int BtJus) {
        this.idLanc = idLanc;
