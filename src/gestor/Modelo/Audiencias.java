...
public class Audiencias {
    ...
    public Audiencias(int idLanc, String statusLanc, Date dataLanc, int idInternoCrc, String nomeInterno, String tipoJust, String justificativa, String usuarioInsert, String usuarioUp, String dataInsert, String dataUp, String horarioInsert, String horarioUp) {
        this.idLanc = idLanc;
    ...
    /**
     * @param tipoJust the tipoJust to set
     */
