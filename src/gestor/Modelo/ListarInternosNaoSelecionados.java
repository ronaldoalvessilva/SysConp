 ...
 * @author ronal
 */
public class ListarInternosNaoSelecionados {
    ...
    public ListarInternosNaoSelecionados() {
    }

    public ListarInternosNaoSelecionados(int idRegIntAgrupComp, int idRegistroComp, int idKit, int idInternoCrc, String nomeInternoCrc, String agrupado, int gravado, String usuarioInsert, String usuarioUp, String dataInsert, String dataUp, String horarioInsert, String horarioUp) {
