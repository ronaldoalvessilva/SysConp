 ...
 * @author user
 */
public class MovTecEvolucaoServicoSocial {
    ...
    public MovTecEvolucaoServicoSocial(int IdMov, int IdInternoCrc, int IdAtend, String StMov, Date DataMov, String NomeOpe, String DeptoMov) {
        this.IdMov = IdMov;
    ...
    public MovTecEvolucaoServicoSocial() {
    }
