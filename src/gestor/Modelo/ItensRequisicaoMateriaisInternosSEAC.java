 ...
 * @author Ronaldo
 */
public class ItensRequisicaoMateriaisInternosSEAC {
    ...
    private String utilizaRequisicao;
    ...
    public ItensRequisicaoMateriaisInternosSEAC(int idItem, int idReq, int idProd, String descricaoProduto, String codigoBarras, String loteProduto, String unidadeProd, Float qtdItem, Float valorUnitarioItem, Float valorTotalItem, String utilizaRequisicao, String usuarioInsert, String usuarioUp, String dataInsert, String dataUp, String horarioInsert, String horarioUp) {
        this.idItem = idItem;
        this.idReq = idReq;
        this.idProd = idProd;
        ...
        this.utilizaRequisicao = utilizaRequisicao;
    ...
    public ItensRequisicaoMateriaisInternosSEAC() {
    }
    ...
    /**
     * @return the utilizaRequisicao
     */
    public String getUtilizaRequisicao() {
        return utilizaRequisicao;
    }

    /**
     * @param utilizaRequisicao the utilizaRequisicao to set
     */
    public void setUtilizaRequisicao(String utilizaRequisicao) {
        this.utilizaRequisicao = utilizaRequisicao;
    }
