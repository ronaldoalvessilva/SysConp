 ...
 * @author Ronaldo
 */
public class MovTecDietaMedicaPsiquiatrica {
    private int IdMov;
    ...
    public MovTecDietaMedicaPsiquiatrica(int IdMov, int IdInternoCrc, int IdAtend, String StMov, Date DataMov, String NomeOpe, String DeptoMov) {
        this.IdMov = IdMov;
    ...
    public MovTecDietaMedicaPsiquiatrica() {
    }
