 ...
 * @author Ronaldo
 */
public class SolicitacaoExamesMedicoPsiquiatrico {

    private int idSolExame;
    private String statusSolExame;
    private Date dataSolExame;
    ...
    /**
     * @return the statusSolExame
     */
    public String getStatusSolExame() {
        return statusSolExame;
    }

    /**
     * @param statusSolExame the statusSolExame to set
     */
    public void setStatusSolExame(String statusSolExame) {
        this.statusSolExame = statusSolExame;
    }

    /**
     * @return the dataSolExame
     */
    public Date getDataSolExame() {
        return dataSolExame;
    }

    /**
     * @param dataSolExame the dataSolExame to set
     */
    public void setDataSolExame(Date dataSolExame) {
        this.dataSolExame = dataSolExame;
    }
