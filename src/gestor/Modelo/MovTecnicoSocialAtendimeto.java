 ...
 * @author user
 */
public class MovTecnicoSocialAtendimeto {
    ...
    public MovTecnicoSocialAtendimeto(int IdMov, int IdInternoCrc, int IdAtend, String StMov, Date DataMov, String NomeOpe, String DeptoMov) {
        this.IdMov = IdMov;
    ...
    public MovTecnicoSocialAtendimeto() {
    }
