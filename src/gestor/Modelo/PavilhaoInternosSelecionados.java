 ...
 * @author ronal
 */
public class PavilhaoInternosSelecionados {
    ...
    public PavilhaoInternosSelecionados() {
    }

    public PavilhaoInternosSelecionados(int idInternoCrc, String nomeInternoCrc, String cncInternoCrc, int idPav, String descricaoPav) {
