...
public class Disciplina {
    ...
    public Disciplina(int idDisc, String statusDisc, Date dataDisc, String descricao, String usuarioInsert, String usuarioUp, String usuarioDelete, String dataInsert, String dataUp, String dataDelete, String horarioInsert, String horarioUp) {
        this.idDisc = idDisc;
    ...
    /**
     * @param statusDisc the statusDisc to set
     */
     ...
     * @return the dataDisc
     */
    public Date getDataDisc() {
        return dataDisc;
    }

    /**
     * @param dataDisc the dataDisc to set
     */
    public void setDataDisc(Date dataDisc) {
        this.dataDisc = dataDisc;
    }
