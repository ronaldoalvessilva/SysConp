 ...
 * @author Ronaldo
 */
public class RequiscaoProdutosInternos {
    ...
    public RequiscaoProdutosInternos(int idReq, String statusReq, String statusReqAtend, Date dataReq, int idLocal, String nomeLocalArmazenamento, int idInternoCrc, String nomeInternoReq, String descricaoPavilhao, String descricaoCela, int requisicaoUsuario, int idItem, int idPres, int idFunc, String nomeColaboradorReq, String observacao, String usuarioInsert, String usuarioUp, String dataInsert, String dataUp, String horarioInsert, String horarioUp) {
        this.idReq = idReq;
