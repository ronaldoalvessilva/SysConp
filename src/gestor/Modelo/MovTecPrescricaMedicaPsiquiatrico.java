 ...
 * @author Ronaldo
 */
public class MovTecPrescricaMedicaPsiquiatrico {
    private int IdMov;
    ...
    public MovTecPrescricaMedicaPsiquiatrico(int IdMov, int IdInternoCrc, int IdAtend, String StMov, Date DataMov, String NomeOpe, String DeptoMov) {
        this.IdMov = IdMov;
    ...
    public MovTecPrescricaMedicaPsiquiatrico() {
    }
