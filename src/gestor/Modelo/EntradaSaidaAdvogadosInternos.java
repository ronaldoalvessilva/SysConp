 ...
 * @author user
 */
public class EntradaSaidaAdvogadosInternos {
    ...
    public EntradaSaidaAdvogadosInternos(int idLanc, Date DataLanc, int IdAdvogado, String nomeAdvogado, String StatusLanc, String ObsLanc, Date dataEntrada, String horarioEntrada, Date dataSaida, String horarioSaida, String usuarioInsert, String usuarioUp, String dataInsert, String dataUp, String horaInsert, String horaUp, String dataFechamento, String horaFechamento) {
        this.idLanc = idLanc;
    ...
    public EntradaSaidaAdvogadosInternos() {
    }
