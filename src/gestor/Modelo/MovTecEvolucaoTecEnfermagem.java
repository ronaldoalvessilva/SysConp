 ...
 * @author user
 */
public class MovTecEvolucaoTecEnfermagem {
    ...
    public MovTecEvolucaoTecEnfermagem(int IdMov, int IdInternoCrc, int IdAtend, String StMov, Date DataMov, String NomeOpe, String DeptoMov) {
        this.IdMov = IdMov;
    ...
    public MovTecEvolucaoTecEnfermagem() {
    }
