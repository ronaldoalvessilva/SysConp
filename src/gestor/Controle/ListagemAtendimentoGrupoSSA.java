...
import static gestor.Visao.TelaAberturaTotalSistema.pATEND_GRUPO_ss;
 ...
 */
public class ListagemAtendimentoGrupoSSA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoGrupoSSA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
