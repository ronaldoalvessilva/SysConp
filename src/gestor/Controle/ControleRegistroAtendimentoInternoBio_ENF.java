 ...
 * @author ronal
 */
public class ControleRegistroAtendimentoInternoBio_ENF {
    ...
    public RegistroAtendimentoInternos finalizarAtendimentoGrupoENF(RegistroAtendimentoInternos objRegAtend) {

        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE ATENDIMENTO_GRUPO_ENFERMAGEM SET StatusAtendGrupo=? WHERE IdAtGrupoEnf='" + objRegAtend.getIdAtend() + "'");
