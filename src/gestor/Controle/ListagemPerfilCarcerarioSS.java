...
import static gestor.Visao.TelaFechamentoSistema.pPERFIL_carcerario;
 ...
 */
public class ListagemPerfilCarcerarioSS {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemPerfilCarcerarioSS.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
