...
import static gestor.Visao.TelaAberturaTotalSistema.pADMISSAO_ef;
 ...
 */
public class ListagemAdmissaoEducacaoFisicaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoEducacaoFisicaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
