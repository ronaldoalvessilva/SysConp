 ...
 * @author Ronaldo
 */
public class ControleRequisicaoMateririasInternos {
    ...
    public RequiscaoProdutosInternos incluirRequisicaoMaterialInternos(RequiscaoProdutosInternos objReqMatInter) {
        ...
        try {
            PreparedStatement pst = conecta.con.prepareStatement("INSERT INTO REQUISICAO_PRODUTOS_INTERNOS (StatusReq,DataReq,IdLocal,IdReqUser,IdInternoCrc,DescricaoPavilhao,DescricaoCela,IdFunc,Observacao,UsuarioInsert,DataInsert,HorarioInsert) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)");
            ...
            pst.setInt(4, objReqMatInter.getRequisicaoUsuario());
            pst.setInt(5, codInt);
            pst.setString(6, objReqMatInter.getDescricaoPavilhao());
            pst.setString(7, objReqMatInter.getDescricaoCela());
            pst.setInt(8, codFunc);
            pst.setString(9, objReqMatInter.getObservacao());
            pst.setString(10, objReqMatInter.getUsuarioInsert());
            pst.setString(11, objReqMatInter.getDataInsert());
            pst.setString(12, objReqMatInter.getHorarioInsert());
            pst.execute();
    ...
    public RequiscaoProdutosInternos alterarRequisicaoMaterialInternos(RequiscaoProdutosInternos objReqMatInter) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE REQUISICAO_PRODUTOS_INTERNOS SET StatusReq=?,DataReq=?,IdLocal=?,IdReqUser=?,IdInternoCrc=?,DescricaoPavilhao=?,DescricaoCela=?,IdFunc=?,Observacao=?,UsuarioUp=?,DataUp=?,HorarioUp=? WHERE IdReq='" + objReqMatInter.getIdReq() + "'");
            pst.setString(1, objReqMatInter.getStatusReq());
            pst.setTimestamp(2, new java.sql.Timestamp(objReqMatInter.getDataReq().getTime()));
            pst.setInt(3, objReqMatInter.getIdLocal());
            pst.setInt(4, objReqMatInter.getRequisicaoUsuario());
            ...
            pst.setInt(8, codFunc);
            pst.setString(9, objReqMatInter.getObservacao());
            pst.setString(10, objReqMatInter.getUsuarioUp());
            pst.setString(11, objReqMatInter.getDataUp());
            pst.setString(12, objReqMatInter.getHorarioUp());
            pst.executeUpdate();
        } catch (SQLException ex) {
    ...
    public RequiscaoProdutosInternos excluirRequisicaoMaterialInternos(RequiscaoProdutosInternos objReqMatInter) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("DELETE FROM REQUISICAO_PRODUTOS_INTERNOS WHERE IdReq='" + objReqMatInter.getIdReq() + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
    ...
    public RequiscaoProdutosInternos finalizarRequisicaoMaterialInternos(RequiscaoProdutosInternos objReqMatInter) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE REQUISICAO_PRODUTOS_INTERNOS SET StatusReq=? WHERE IdReq='" + objReqMatInter.getIdReq() + "'");
            pst.setString(1, objReqMatInter.getStatusReq());
            pst.executeUpdate();
        } catch (SQLException ex) {
