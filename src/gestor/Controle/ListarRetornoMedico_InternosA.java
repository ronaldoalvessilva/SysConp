...
import static gestor.Visao.TelaAberturaTotalSistema.pRETORNO_MEDICO;
 ...
 * @author ronal
 */
public class ListarRetornoMedico_InternosA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListarRetornoMedico_InternosA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
