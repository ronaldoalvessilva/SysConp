...
import static gestor.Visao.TelaAberturaRegistroSistema.pADM_enfermagem;
 ...
 */
public class ListagemAdmissaoEnfermagemM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pADM_enfermagem = pADM_enfermagem + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAdmissaoEnfermagemM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
