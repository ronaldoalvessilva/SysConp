    ...
    public List<AtividadesMensalRealizadaUnidades> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pQUANTIDADE_TOTAL_INFECTO = pQUANTIDADE_HEPATITE_B + pQUANTIDADE_HEPATITE_C + pQUANTIDADE_HIV + pQUANTIDADE_SIFILIS + pQUANTIDADE_HPV + pQUANTIDADE_TUBERCULOSE + pQUANTIDADE_HANSEINIASE + pQUANTIDADE_ESCABIOSE + pQUANTIDADE_DST;
                pAgravoDiag.setQuantidadeAgravosTotal(pQUANTIDADE_TOTAL_INFECTO);
