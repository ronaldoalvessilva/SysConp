...
import static gestor.Visao.TelaAberturaTotalSistema.pADMISSAO_pedagogicaNova;
 ...
 */
public class ListagemAdmissaoPedagogicaNovaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoPedagogicaNovaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
