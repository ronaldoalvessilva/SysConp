...
import static gestor.Visao.TelaAberturaTotalSistema.pADM_medica;
 ...
 */
public class ListagemAdmissaoMedicaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoMedicaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
