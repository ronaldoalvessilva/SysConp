...
import static gestor.Visao.TelaAberturaRegistroSistema.pATEND_GRUPO_pedagogia;
 ...
 */
public class ListagemAtendimentoGrupoPedagogiaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pATEND_GRUPO_pedagogia = pATEND_GRUPO_pedagogia + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAtendimentoGrupoPedagogiaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
