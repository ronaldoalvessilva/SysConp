...
import static gestor.Visao.TelaAberturaRegistroSistema.pPORTA_ENTRADA_ss;
 ...
 */
public class ListagemPortaEntradaSSM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pPORTA_ENTRADA_ss = pPORTA_ENTRADA_ss + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemPortaEntradaSSM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
