...
import static gestor.Visao.TelaAberturaTotalSistema.pATENDE_JURI;
 ...
 */
public class ListagemAtendimentoJuridicoA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoJuridicoA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
