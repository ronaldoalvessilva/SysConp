...
import static gestor.Visao.TelaAberturaRegistroSistema.pOCORRENCIA_psiologica;
 ...
 */
public class ListagemOcorrenciaPsicologiaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pOCORRENCIA_psiologica = pOCORRENCIA_psiologica + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemOcorrenciaPsicologiaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
