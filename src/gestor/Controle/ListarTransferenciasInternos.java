...
import static gestor.Visao.TelaFechamentoSistema.pTOTAL_TRANSFERENCIAS;
 ...
 * @author ronal
 */
public class ListarTransferenciasInternos {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    FechamentoRegistros objFecha = new FechamentoRegistros();
    //
    String pSTATUS_TRANSFERENCIAS = "ABERTO";
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListarTransferenciasInternos.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
