 ...
 * @author ronaldo
 */
public class ControleEfetivaLoteFAR {
    ...
    public ProdutoMedicamento incluirLoteProdutoFAR(ProdutoMedicamento objProdMed) {
    ...
    public ProdutoMedicamento incluirNovoLoteProdutoFAR(ProdutoMedicamento objProdMed) {
        conecta.abrirConexao();
        try {
    ...
    public ProdutoMedicamento alterarLoteProdutoFAR(ProdutoMedicamento objProdMed) {
        conecta.abrirConexao();
        try {
