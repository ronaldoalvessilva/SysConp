...
import static gestor.Visao.TelaAberturaTotalSistema.pADM_medicaAux;
 ...
 */
public class ListagemAdmissaoMedicaComplementarA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoMedicaComplementarA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
