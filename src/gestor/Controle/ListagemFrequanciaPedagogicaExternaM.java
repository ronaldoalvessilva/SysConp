...
import static gestor.Visao.TelaAberturaRegistroSistema.pFREQUENCIA_pedagogica;
 ...
 */
public class ListagemFrequanciaPedagogicaExternaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemFrequanciaPedagogicaExternaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
