...
import static gestor.Visao.TelaAberturaRegistroSistema.pRETORNO;
 ...
 */
public class ListagemRegistroRetornoM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusRet "
                    + "FROM REGRETORNO "
                    + "WHERE StatusRet='" + pSTATUS_NOVA_ENTRADA + "' "
            ...
            while (conecta.rs.next()) {
                ...
                pNovaEntrada.setStatusRegistro(conecta.rs.getString("StatusRet"));
