...
import static gestor.Visao.TelaAberturaRegistroSistema.pENTRADAS_INTERNOS_portaria;
 ...
 */
public class ListagemEntradaInternosPortariaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pENTRADAS_INTERNOS_portaria = pENTRADAS_INTERNOS_portaria + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemEntradaInternosPortariaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
