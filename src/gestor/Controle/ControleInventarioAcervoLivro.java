 ...
 * @author ronaldo
 */
public class ControleInventarioAcervoLivro {
    ...
    public InventarioEstoque incluirInventarioAcervo(InventarioEstoque objInventEstoque) {
        buscarLocalAcervoLivro(objInventEstoque.getNomeLocalArmazenamento());
    ...
    public InventarioEstoque alterarInventarioAcervo(InventarioEstoque objInventEstoque) {
        buscarLocalAcervoLivro(objInventEstoque.getNomeLocalArmazenamento());
        conecta.abrirConexao();
        try {
    ...
    public InventarioEstoque excluirInventarioAcervo(InventarioEstoque objInventEstoque) {
        conecta.abrirConexao();
        try {
    ...
    public void buscarLocalAcervoLivro(String nomeLocal) {
        conecta.abrirConexao();
        try {
