...
import static gestor.Visao.TelaAberturaTotalSistema.pOCORRE_ef;
 ...
 */
public class ListagemOcorrenciaEFA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemOcorrenciaEFA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
