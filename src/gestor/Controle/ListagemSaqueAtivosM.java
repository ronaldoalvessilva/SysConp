...
import static gestor.Visao.TelaFechamentoSistema.pSAQUE_ativo;
 ...
 */
public class ListagemSaqueAtivosM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemSaqueAtivosM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
