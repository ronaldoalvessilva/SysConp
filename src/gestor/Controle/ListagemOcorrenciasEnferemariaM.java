...
import static gestor.Visao.TelaAberturaRegistroSistema.pOCORRENCIA_ENF;
 ...
 */
public class ListagemOcorrenciasEnferemariaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pOCORRENCIA_ENF = pOCORRENCIA_ENF + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemOcorrenciasEnferemariaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
