...
import static gestor.Visao.TelaAberturaRegistroSistema.pINTERNOS_EVADIDOS;
 ...
 */
public class ListagemEvadidosM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemEvadidosM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
