...
public class ControlePagamentoKitDecendialRealizado {
    ...
    public List<GravarInternosKitCompleto> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT * FROM KITS_DECENDIAL_INTERNOS "
                    ...
                    + "AND KITS_DECENDIAL_INTERNOS.IDREG_PROG='" + idPROG + "' "
            ...
            Logger.getLogger(ControlePagamentoKitDecendialRealizado.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
