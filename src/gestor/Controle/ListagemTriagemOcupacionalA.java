...
import static gestor.Visao.TelaAberturaTotalSistema.pTRIAGEM_to;
 ...
 */
public class ListagemTriagemOcupacionalA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemTriagemOcupacionalA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
