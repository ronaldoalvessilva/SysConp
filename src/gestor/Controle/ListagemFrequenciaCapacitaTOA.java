...
import static gestor.Visao.TelaAberturaTotalSistema.pFREQUENCIA_capa;
 ...
 */
public class ListagemFrequenciaCapacitaTOA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemFrequenciaCapacitaTOA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
