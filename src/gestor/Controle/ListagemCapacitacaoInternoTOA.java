...
import static gestor.Visao.TelaAberturaTotalSistema.pCAPACITACAO_INTERO_to;
 ...
 */
public class ListagemCapacitacaoInternoTOA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemCapacitacaoInternoTOA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
