...
import static gestor.Visao.TelaAberturaRegistroSistema.pOCORRE_ef;
 ...
 */
public class ListagemOcorrenciaEFM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pOCORRE_ef = pOCORRE_ef + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemOcorrenciaEFM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
