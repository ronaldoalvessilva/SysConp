...
import static gestor.Visao.TelaAberturaTotalSistema.pATENDIMENTO_GRUPO_psi;
 ...
 */
public class ListagemAtendimentoGrupoPsiA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoGrupoPsiA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
