...
import static gestor.Visao.TelaFechamentoSistema.pFICHA_juridica;
 ...
 */
public class ListagemFichaJuridica {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemFichaJuridica.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
