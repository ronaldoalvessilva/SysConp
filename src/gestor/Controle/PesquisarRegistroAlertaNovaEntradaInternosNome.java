...
import static gestor.Visao.TelaPesquisaAtivaDesativaAlertaNovaEntradas.jNomeInternoPesquisa;
 ...
 * @author ronal
 */
public class PesquisarRegistroAlertaNovaEntradaInternosNome {
    ...
    public List<AtivarDesativarAlertaEntradas> read() throws Exception {
        ...
        if (jComboBoxAtivarDesativar.getSelectedItem().equals("Ativar")) {
            try {
                ...
                Logger.getLogger(PesquisarRegistroAlertaNovaEntradaInternosNome.class.getName()).log(Level.SEVERE, null, ex);
            } finally {
                conecta.desconecta();
            }
    ...
    public AtivarDesativarAlertaEntradas MOSTRAR_registros(AtivarDesativarAlertaEntradas objAlertaEntrada) {
        ...
        try {
            ...
            objAlertaEntrada.setNumeroRegistro(conecta.rs.getInt("IdEntrada"));
            objAlertaEntrada.setDataEntrada(conecta.rs.getDate("DataEntrada"));
            objAlertaEntrada.setHoraEntrada(conecta.rs.getString("HorarioEntrada"));
            objAlertaEntrada.setNumeroOficio(conecta.rs.getString("NrOficio"));
            ...
            objAlertaEntrada.setConfirmaEntrada(conecta.rs.getString("UtilizadoCrc"));
        } catch (SQLException ex) {
            Logger.getLogger(PesquisarRegistroAlertaNovaEntradaInternosNome.class.getName()).log(Level.SEVERE, null, ex);
        }
        conecta.desconecta();
