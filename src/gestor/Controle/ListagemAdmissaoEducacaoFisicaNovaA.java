...
import static gestor.Visao.TelaAberturaTotalSistema.pADMISSAO_EF_nova;
 ...
 */
public class ListagemAdmissaoEducacaoFisicaNovaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoEducacaoFisicaNovaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
