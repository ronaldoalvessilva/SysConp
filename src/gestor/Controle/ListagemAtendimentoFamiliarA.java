...
import static gestor.Visao.TelaAberturaTotalSistema.pATEND_FAM_ss;
 ...
 */
public class ListagemAtendimentoFamiliarA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoFamiliarA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
