...
import static gestor.Visao.TelaFechamentoSistema.pPORTA_entrada;
 ...
 */
public class ListagemPortaEntradaPsicologia {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemPortaEntradaPsicologia.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
