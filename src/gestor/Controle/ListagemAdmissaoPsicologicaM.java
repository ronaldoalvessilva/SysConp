...
import static gestor.Visao.TelaAberturaRegistroSistema.pADMISSAO_psicologica;
 ...
 */
public class ListagemAdmissaoPsicologicaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoPsicologicaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
