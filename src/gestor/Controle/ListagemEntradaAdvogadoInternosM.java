...
import static gestor.Visao.TelaAberturaRegistroSistema.pENTRADA_ADV_INTERNOS;
 ...
 */
public class ListagemEntradaAdvogadoInternosM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pENTRADA_ADV_INTERNOS = pENTRADA_ADV_INTERNOS + 1;
            }
