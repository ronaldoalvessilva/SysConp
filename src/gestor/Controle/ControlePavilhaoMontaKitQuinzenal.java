 ...
 * @author ronal
 */
public class ControlePavilhaoMontaKitQuinzenal {
    ...
    public List<PavilhaoInternoMontaKit> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT * FROM PRONTUARIOSCRC "
                    ...
                    + "AND KITS_QUINZENAL_INTERNOS.KitPago='" + kitPago + "' "
                    + "AND KITS_QUINZENAL_INTERNOS.DataPrevisaoPro='" + dataPesquisa + "' "
                    + "AND KITS_QUINZENAL_INTERNOS.Utilizado='" + pUtilizado + "' "
            ...
            Logger.getLogger(ControlePavilhaoMontaKitQuinzenal.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
