...
import static gestor.Visao.TelaAberturaTotalSistema.pPAGO_kit;
 ...
 */
public class ListagemPagamentoKitHigieneA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemPagamentoKitHigieneA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
