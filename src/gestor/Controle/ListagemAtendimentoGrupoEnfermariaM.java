...
import static gestor.Visao.TelaAberturaRegistroSistema.pATENDIMENTO_GRUPO_ENF;
 ...
 */
public class ListagemAtendimentoGrupoEnfermariaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoGrupoEnfermariaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
