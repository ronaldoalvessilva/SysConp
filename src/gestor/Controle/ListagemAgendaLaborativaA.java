...
import static gestor.Visao.TelaAberturaTotalSistema.pAGENDA_laborativa;
 ...
 */
public class ListagemAgendaLaborativaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusLanc "
                    ...
                    + "AND DataCadastro<='" + pDATA_PESQUISA_FECHAMENTO + "'");
            ...
            Logger.getLogger(ListagemAgendaLaborativaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
