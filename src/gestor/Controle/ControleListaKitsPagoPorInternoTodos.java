...
import static gestor.Visao.TelaConsultaKitsEntregueNaoEntreguesInternosTodos.pTOTAL_produtos;
import static gestor.Visao.TelaConsultaKitsEntregueNaoEntreguesInternosTodos.jDataFinal;
...
import static gestor.Visao.TelaConsultaKitsEntregueNaoEntreguesInternosTodos.jDataInicial;
 ...
 */
public class ControleListaKitsPagoPorInternoTodos {
        ...
        if (tipoServidor == null || tipoServidor.equals("")) {
            ...
            try {
                conecta.executaSQL("SELECT "
                        + "DISTINCT PRONTUARIOSCRC.IdInternoCrc,PRONTUARIOSCRC.NomeInternoCrc, "
                        ...
                        + "WHERE ITENS_PAGAMENTO_KIT_INTERNOS.DataEntrega BETWEEN'" + pDATA_inicial + "' "
                        + "AND '" + pDATA_final + "' "
                        + "ORDER BY NomeInternoCrc,ITENS_PAGAMENTO_KIT_INTERNOS.DataEntrega,TipoKit");
                ...
                Logger.getLogger(ControleListaKitsPagoPorInternoTodos.class.getName()).log(Level.SEVERE, null, ex);
            } finally {
                conecta.desconecta();
            }
