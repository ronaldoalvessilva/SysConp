...
import static gestor.Visao.TelaAberturaTotalSistema.pENTRADA_VEICULOS_unidade;
 ...
 */
public class ListagemEntradaVeiculosUnidadeA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemEntradaVeiculosUnidadeA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
