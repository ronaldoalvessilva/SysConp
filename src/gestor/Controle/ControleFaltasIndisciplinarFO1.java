 ...
 * @author Ronaldo
 */
public class ControleFaltasIndisciplinarFO1 {
    ...
    public FaltasIndisciplinarFO1 incluirFaltasFO1(FaltasIndisciplinarFO1 objFaltas) {
        ...
        try {
            PreparedStatement pst = conecta.con.prepareStatement("INSERT INTO FALTAS_INDISCIPLINAR_INDIVIDUAL_INTERNOS (IdLanc,IdInternoCrc,Incitar,"
    ...
    public FaltasIndisciplinarFO1 alterarFaltasFO1(FaltasIndisciplinarFO1 objFaltas) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE FALTAS_INDISCIPLINAR_INDIVIDUAL_INTERNOS SET IdLanc=?,IdInternoCrc=?,"
    ...
    public FaltasIndisciplinarFO1 excluirFaltasFO1(FaltasIndisciplinarFO1 objFaltas) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("DELETE FROM FALTAS_INDISCIPLINAR_INDIVIDUAL_INTERNOS WHERE IdFaltaFO1='" + objFaltas.getIdFaltaFO1() + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
