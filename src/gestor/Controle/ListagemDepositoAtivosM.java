...
import static gestor.Visao.TelaFechamentoSistema.pDEPOSITO_ativo;
 ...
 */
public class ListagemDepositoAtivosM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
       if (tipoServidor == null || tipoServidor.equals("")) {
        ...
        try {
            ...
            Logger.getLogger(ListagemDepositoAtivosM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
