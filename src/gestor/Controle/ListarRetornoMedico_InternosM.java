...
import static gestor.Visao.TelaAberturaRegistroSistema.pRETORNO_MEDICO;
 ...
 * @author ronal
 */
public class ListarRetornoMedico_InternosM {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    FechamentoRegistros objFecha = new FechamentoRegistros();
    //
    String pSTATUS_RETORNO_MEDICO = "FINALIZADO";
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListarRetornoMedico_InternosM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
