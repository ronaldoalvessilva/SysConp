...
import static gestor.Visao.TelaFechamentoSistema.pATEND_FAMILIA_juri;
 ...
 */
public class ListagemAtendimentoFamiliarJuridico {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusAtendf "
                    ...
                    + "AND DataAtendf<='" + pDATA_PESQUISA_FECHAMENTO + "'");
            ...
            Logger.getLogger(ListagemAtendimentoFamiliarJuridico.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
