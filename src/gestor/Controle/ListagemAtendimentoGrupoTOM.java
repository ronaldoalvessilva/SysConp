...
import static gestor.Visao.TelaAberturaRegistroSistema.pATENDIMENTO_grupoTO;
 ...
 */
public class ListagemAtendimentoGrupoTOM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pATENDIMENTO_grupoTO = pATENDIMENTO_grupoTO + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAtendimentoGrupoTOM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
