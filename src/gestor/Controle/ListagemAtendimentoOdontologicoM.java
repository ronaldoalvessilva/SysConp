...
import static gestor.Visao.TelaAberturaRegistroSistema.pATEND_ODONTO;
 ...
 */
public class ListagemAtendimentoOdontologicoM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pATEND_ODONTO = pATEND_ODONTO + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAtendimentoOdontologicoM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
