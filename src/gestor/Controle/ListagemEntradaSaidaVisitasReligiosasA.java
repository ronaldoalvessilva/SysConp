...
import static gestor.Visao.TelaAberturaTotalSistema.pTOTAL_ENTRADAS_SAIDAS_VISITAS_religiosas;
 ...
 */
public class ListagemEntradaSaidaVisitasReligiosasA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemEntradaSaidaVisitasReligiosasA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
