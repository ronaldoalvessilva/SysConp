...
import static gestor.Visao.TelaAberturaTotalSistema.pATENDIMENTO_TO;
 ...
 */
public class ListagemAtendimentoTerapiaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoTerapiaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
