...
import static gestor.Visao.TelaFechamentoSistema.pATIVIDADES_COMPLEMENTARES;
 ...
 */
public class ListagemAtividadesComplementaresPeda {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtividadesComplementaresPeda.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
