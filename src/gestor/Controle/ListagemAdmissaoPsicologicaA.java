...
import static gestor.Visao.TelaAberturaTotalSistema.pADMISSAO_psicologica;
 ...
 */
public class ListagemAdmissaoPsicologicaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoPsicologicaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
