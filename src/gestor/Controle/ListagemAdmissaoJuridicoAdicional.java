...
import static gestor.Visao.TelaFechamentoSistema.pADMISSAO_JURI;
 ...
 */
public class ListagemAdmissaoJuridicoAdicional {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoJuridicoAdicional.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
