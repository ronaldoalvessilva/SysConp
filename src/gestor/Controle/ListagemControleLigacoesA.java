...
import static gestor.Visao.TelaAberturaTotalSistema.pCONTROLE_ligacoes;
 ...
 */
public class ListagemControleLigacoesA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusControl "
                    ...
                    + "AND DataControl<='" + pDATA_PESQUISA_FECHAMENTO + "'");
            ...
            Logger.getLogger(ListagemControleLigacoesA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
