...
import static gestor.Visao.TelaFechamentoSistema.pADMISSAO_ef;
 ...
 */
public class ListagemAdmissaoEducacaoFisica {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoEducacaoFisica.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
