...
import static gestor.Visao.TelaAberturaTotalSistema.pATEND_GRUPO_pedagogia;
 ...
 */
public class ListagemAtendimentoGrupoPedagogiaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoGrupoPedagogiaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
