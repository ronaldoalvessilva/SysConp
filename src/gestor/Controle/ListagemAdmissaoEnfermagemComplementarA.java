...
import static gestor.Visao.TelaAberturaTotalSistema.pADM_enfermagemAux;
 ...
 */
public class ListagemAdmissaoEnfermagemComplementarA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoEnfermagemComplementarA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
