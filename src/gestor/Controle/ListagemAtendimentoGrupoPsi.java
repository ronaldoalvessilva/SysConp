...
import static gestor.Visao.TelaFechamentoSistema.pATENDIMENTO_GRUPO_psi;
 ...
 */
public class ListagemAtendimentoGrupoPsi {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoGrupoPsi.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
