 ...
 * @author ronal
 */
public class ListagemNumerosVisitasInternoMenor {
    ...
    public List<AtividadesMensalRealizadaUnidades> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT ITENSFAMILIAR.DataEntrada "
                    + "FROM VISITASINTERNO "
                    ...
                    + "AND '" + pDATA_FINAL + "' "
                    + "AND VISITASINTERNO.Classificacao='" + pCLASSIFICACAO + "'");
            while (conecta.rs.next()) {
                ...
                pQUANTIDADE_VISITA_CRIANCA_INT = pQUANTIDADE_VISITA_CRIANCA_INT + 1;
            }
