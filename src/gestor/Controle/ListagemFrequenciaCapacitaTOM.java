...
import static gestor.Visao.TelaAberturaRegistroSistema.pFREQUENCIA_capa;
 ...
 */
public class ListagemFrequenciaCapacitaTOM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusRegistro "
                    + "FROM FREQUENCIA_CAPACITACAO_INTERNO_TO "
            ...
            while (conecta.rs.next()) {
                ...
                pFREQUENCIA_capa = pFREQUENCIA_capa + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemFrequenciaCapacitaTOM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
