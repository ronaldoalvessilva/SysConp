...
import static gestor.Visao.TelaAberturaTotalSistema.pPORTA_entrada;
 ...
 */
public class ListagemPortaEntradaPsicologiaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemPortaEntradaPsicologiaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
