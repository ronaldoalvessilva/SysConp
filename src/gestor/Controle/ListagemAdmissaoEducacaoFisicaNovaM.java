...
import static gestor.Visao.TelaAberturaRegistroSistema.pADMISSAO_EF_nova;
 ...
 */
public class ListagemAdmissaoEducacaoFisicaNovaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoEducacaoFisicaNovaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
