...
import static gestor.Visao.TelaFechamentoSistema.pATUALIZA_documento;
 ...
 */
public class ListagemAtualizacaoDocumentosInternos {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtualizacaoDocumentosInternos.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
