...
import static gestor.Visao.TelaFechamentoSistema.pADM_enfermagemAux;
 ...
 */
public class ListagemAdmissaoEnfermagemComplementar {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoEnfermagemComplementar.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
