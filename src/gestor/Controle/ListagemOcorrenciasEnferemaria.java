...
import static gestor.Visao.TelaFechamentoSistema.pOCORRENCIA_ENF;
 ...
 */
public class ListagemOcorrenciasEnferemaria {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemOcorrenciasEnferemaria.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
