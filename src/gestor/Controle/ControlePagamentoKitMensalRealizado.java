...
public class ControlePagamentoKitMensalRealizado {
    ...
    public List<GravarInternosKitCompleto> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT * FROM KITS_MENSAL_INTERNOS "
                    ...
                    + "AND KITS_MENSAL_INTERNOS.IDREG_PROG='" + idPROG + "' "
            ...
            Logger.getLogger(ControlePagamentoKitMensalRealizado.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
