...
import static gestor.Visao.TelaAberturaTotalSistema.pAVALIACAO_psicologica;
 ...
 */
public class ListagemAvaliacaoPsicologicaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAvaliacaoPsicologicaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
