 ...
 * @author ronal
 */
public class ListagemAtendimentoADMEnfermeira {
    ...
    public List<AtividadesMensalRealizadaUnidades> read() throws Exception {
        ...
        List<AtividadesMensalRealizadaUnidades> listaAtendEnfermeria = new ArrayList<AtividadesMensalRealizadaUnidades>();
        ...
        try {
            conecta.executaSQL("SELECT DataAtendimento,TipoAtendimento "
                    ...
                    + "AND '" + pDATA_FINAL + "' "
                    + "AND TipoAtendimento='" + pTIPO_ATENDIMENTO_ATE_ENFERMAGEM + "' "
            ...
            while (conecta.rs.next()) {
                AtividadesMensalRealizadaUnidades pAtivaEnf = new AtividadesMensalRealizadaUnidades();
                pAtivaEnf.setDataAtendimento(conecta.rs.getDate("DataAtendimento"));
                pAtivaEnf.setTipoAtendimento(conecta.rs.getString("TipoAtendimento"));
                listaAtendEnfermeria.add(pAtivaEnf);
                pQUANTIDADE_ATE_ENFERMAGEM = pQUANTIDADE_ATE_ENFERMAGEM + 1;
            }
            return listaAtendEnfermeria;
