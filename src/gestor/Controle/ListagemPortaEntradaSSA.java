...
import static gestor.Visao.TelaAberturaTotalSistema.pPORTA_ENTRADA_ss;
 ...
 */
public class ListagemPortaEntradaSSA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemPortaEntradaSSA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
