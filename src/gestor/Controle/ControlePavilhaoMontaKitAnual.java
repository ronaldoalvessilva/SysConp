 ...
 * @author ronal
 */
public class ControlePavilhaoMontaKitAnual {
    ...
    public List<PavilhaoInternoMontaKit> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT DISTINCT KITS_ANUAL_INTERNOS.IdInternoCrc, "
                    + "PRONTUARIOSCRC.Cnc,PRONTUARIOSCRC.NomeInternoCrc, "
                    + "KITS_ANUAL_INTERNOS.KitPago,KITS_ANUAL_INTERNOS.Utilizado, "
                    + "KITS_ANUAL_INTERNOS.DataPrevisaoPro,PAVILHAO.IdPav,PAVILHAO.DescricaoPav "
                    + "FROM PRONTUARIOSCRC "
                    ...
                    + "AND KITS_ANUAL_INTERNOS.DataPrevisaoPro='" + dataPesquisa + "' "
                    + "AND KITS_ANUAL_INTERNOS.Utilizado='" + pUtilizado + "' "
            ...
            Logger.getLogger(ControlePavilhaoMontaKitAnual.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
