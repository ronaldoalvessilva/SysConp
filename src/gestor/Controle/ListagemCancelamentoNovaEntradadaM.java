...
import static gestor.Visao.TelaAberturaRegistroSistema.pREGISTRO_CANCELADO_NE;
 ...
 */
public class ListagemCancelamentoNovaEntradadaM {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    FechamentoRegistros objFecha = new FechamentoRegistros();
    //
    String pSTATUS_REGISTRO_CANCELADO_NE = "FINALIZADO";
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pREGISTRO_CANCELADO_NE = pREGISTRO_CANCELADO_NE + 1;
            }
