...
import static gestor.Visao.TelaAberturaRegistroSistema.pOCORRE_to;
 ...
 */
public class ListagemOcorrenciaTOM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pOCORRE_to = pOCORRE_to + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemOcorrenciaTOM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
