...
import static gestor.Visao.TelaAberturaTotalSistema.pATIVIDADE_UNIDADE;
 ...
 */
public class ListagemAtividadesUnidadesA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusAtividade "
                    ...
                    + "AND DataCriacao<='" + pDATA_PESQUISA_FECHAMENTO + "'");
            ...
            Logger.getLogger(ListagemAtividadesUnidadesA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
