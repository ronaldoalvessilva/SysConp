...
import static gestor.Visao.TelaAberturaRegistroSistema.pENTRADA_oficial;
 ...
 */
public class ListagemEntradasOficialJusticaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pENTRADA_oficial = pENTRADA_oficial + 1;
            }
