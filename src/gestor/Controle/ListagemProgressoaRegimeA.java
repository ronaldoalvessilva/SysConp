...
import static gestor.Visao.TelaAberturaTotalSistema.pPROGRESSAO_REGIME;
 ...
 */
public class ListagemProgressoaRegimeA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemProgressoaRegimeA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
