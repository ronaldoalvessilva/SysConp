...
import static gestor.Visao.TelaFechamentoSistema.pATENDIMENTO_grupoTO;
 ...
 */
public class ListagemAtendimentoGrupoTO {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoGrupoTO.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
