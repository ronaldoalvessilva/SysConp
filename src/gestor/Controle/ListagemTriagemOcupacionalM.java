...
import static gestor.Visao.TelaAberturaRegistroSistema.pTRIAGEM_to;
 ...
 */
public class ListagemTriagemOcupacionalM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pTRIAGEM_to = pTRIAGEM_to + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemTriagemOcupacionalM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
