...
import static gestor.Visao.TelaAtividadesMensalUnidade.pQUANTIDADE_SAIDA_TMP;
 ...
 * @author ronal
 */
public class ListagemInternosSaidaTMP {
    ...
    String pDATA_FINAL;
    String pSAIDA_TMP = "SAIDA TEMPORARIA";
    ...
    public List<AtividadesMensalRealizadaUnidades> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT DataSaida "
                    + "FROM ITENSSAIDA "
                    + "WHERE DestinoSaida LIKE'%" + pSAIDA_TMP + "%' "
            ...
            while (conecta.rs.next()) {
                ...
                pQUANTIDADE_SAIDA_TMP = pQUANTIDADE_SAIDA_TMP + 1;
