 ...
 * @author user
 */
public class ControleMovEducacaiFisica {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    MovTecPsicologia objMovTec = new MovTecPsicologia();
    AdmissaoPsicologica objAdmPsi = new AdmissaoPsicologica();
    String nomeOpeTecnica = "Atendimento do Interno Educação Fisica - (Admissão)";
    int codInt;
    //REUTILIZADO A CLASSE DA PSICOLOGIA PARA A EDUCAÇÃO FÍSICA

    public AdmissaoPsicologica incluirMovTec(AdmissaoPsicologica objAdmPsi) {
        buscarInternoCrc(objAdmPsi.getNomeInterno(),objAdmPsi.getIdInternoCrc());
