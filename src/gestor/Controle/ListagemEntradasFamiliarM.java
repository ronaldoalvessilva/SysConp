...
import static gestor.Visao.TelaAberturaTotalSistema.pENTRADA_FAMILIAR;
 ...
 */
public class ListagemEntradasFamiliarM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pENTRADA_FAMILIAR = pENTRADA_FAMILIAR + 1;
            }
