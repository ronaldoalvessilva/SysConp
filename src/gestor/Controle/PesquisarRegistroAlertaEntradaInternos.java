 ...
 * @author ronal
 */
public class PesquisarRegistroAlertaEntradaInternos {
        ...
        if (jComboBoxAtivarDesativar.getSelectedItem().equals("Ativar")) {
            try {
                conecta.executaSQL("SELECT "
                        ...
                        + "WHERE ITENSENTRADAPORTARIA.IdLanc='" + jIdRegistro.getText() + "' "
                ...
                Logger.getLogger(PesquisarRegistroAlertaEntradaInternos.class.getName()).log(Level.SEVERE, null, ex);
            } finally {
                conecta.desconecta();
            }
            ...
            try {
                conecta.executaSQL("SELECT "
                        ...
                        + "FROM ITENSENTRADAPORTARIA "
                        + "WHERE ITENSENTRADAPORTARIA.IdLanc='" + jIdRegistro.getText() + "' "
                        + "AND ITENSENTRADAPORTARIA.ConfirmaEntrada='" + pCONFIRMACAO_negada + "'");
                while (conecta.rs.next()) {
                    AtivarDesativarAlertaEntradas pREGISTRO_p1 = new AtivarDesativarAlertaEntradas();
                    pREGISTRO_p1.setIdItem(conecta.rs.getInt("IdItem"));
                    pREGISTRO_p1.setNumeroRegistro(conecta.rs.getInt("IdLanc"));
