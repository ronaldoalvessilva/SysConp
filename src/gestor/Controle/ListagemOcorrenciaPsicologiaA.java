...
import static gestor.Visao.TelaAberturaTotalSistema.pOCORRENCIA_psiologica;
 ...
 */
public class ListagemOcorrenciaPsicologiaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemOcorrenciaPsicologiaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
