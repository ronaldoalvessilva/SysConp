...
import static gestor.Visao.TelaAberturaTotalSistema.pDEPOSITO_inativo;
 ...
 */
public class ListagemDepositoInativoA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pDEPOSITO_inativo = pDEPOSITO_inativo + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemDepositoInativoA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
