...
import static gestor.Visao.TelaFechamentoSistema.pREQUISICAO_far;
 ...
 */
public class ListagemRequisicaoFARM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusReq "
                    + "FROM REQUISICAO_AVULSA_PRODUTOS_FAR "
            ...
            while (conecta.rs.next()) {
                ...
                pREQUISICAO_far = pREQUISICAO_far + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemRequisicaoFARM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
