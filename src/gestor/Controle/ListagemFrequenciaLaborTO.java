...
import static gestor.Visao.TelaFechamentoSistema.pFREQUENCIA_labora;
 ...
 */
public class ListagemFrequenciaLaborTO {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemFrequenciaLaborTO.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
