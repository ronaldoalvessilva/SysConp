...
import static gestor.Visao.TelaAberturaTotalSistema.pPERFIL_carcerario;
 ...
 */
public class ListagemPerfilCarcerarioSSA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusPerfil "
                    ...
                    + "AND DataPerfil<='" + pDATA_PESQUISA_FECHAMENTO + "'");
            ...
            Logger.getLogger(ListagemPerfilCarcerarioSSA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
