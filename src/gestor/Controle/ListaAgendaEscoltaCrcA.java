...
import static gestor.Visao.TelaAberturaTotalSistema.pAGENDA_ESCOLTA;
 ...
 */
public class ListaAgendaEscoltaCrcA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListaAgendaEscoltaCrcA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
