...
import static gestor.Visao.TelaFechamentoSistema.pAVALIACAO_MED_PSI;
 ...
 */
public class ListagemAvaliacaoMedicaPsiquiatrica {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAvaliacaoMedicaPsiquiatrica.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
