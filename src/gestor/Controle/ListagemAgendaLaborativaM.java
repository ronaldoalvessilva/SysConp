...
import static gestor.Visao.TelaAberturaRegistroSistema.pAGENDA_laborativa;
 ...
 */
public class ListagemAgendaLaborativaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pAGENDA_laborativa = pAGENDA_laborativa + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAgendaLaborativaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
