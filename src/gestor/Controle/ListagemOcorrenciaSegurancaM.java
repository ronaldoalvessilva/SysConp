...
import static gestor.Visao.TelaAberturaRegistroSistema.pOCORRE_seguranca;
 ...
 */
public class ListagemOcorrenciaSegurancaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pOCORRE_seguranca = pOCORRE_seguranca + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemOcorrenciaSegurancaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
