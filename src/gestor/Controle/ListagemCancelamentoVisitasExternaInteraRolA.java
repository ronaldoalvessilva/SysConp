...
import static gestor.Visao.TelaAberturaTotalSistema.pCANCELA_visitas;
 ...
 */
public class ListagemCancelamentoVisitasExternaInteraRolA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusCan "
                    ...
                    + "AND DataCan<='" + pDATA_PESQUISA_FECHAMENTO + "'");
            ...
            Logger.getLogger(ListagemCancelamentoVisitasExternaInteraRolA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
