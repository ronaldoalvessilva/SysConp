...
import static gestor.Visao.TelaFechamentoSistema.pOCORRE_seguranca;
 ...
 */
public class ListagemOcorrenciaSeguranca {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemOcorrenciaSeguranca.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
