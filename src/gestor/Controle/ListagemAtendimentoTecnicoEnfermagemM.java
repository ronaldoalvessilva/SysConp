...
import static gestor.Visao.TelaAberturaRegistroSistema.pATENDIMENTO_TEC_ENFERMAGEM;
 ...
 */
public class ListagemAtendimentoTecnicoEnfermagemM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pATENDIMENTO_TEC_ENFERMAGEM = pATENDIMENTO_TEC_ENFERMAGEM + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAtendimentoTecnicoEnfermagemM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
