...
import static gestor.Visao.TelaFechamentoSistema.pESTORNO_valores;
 ...
 */
public class ListagemEstornoValoresM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemEstornoValoresM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
