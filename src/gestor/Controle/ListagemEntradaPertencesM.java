...
import static gestor.Visao.TelaAberturaRegistroSistema.pENTRADA_PERTENCES;
 ...
 */
public class ListagemEntradaPertencesM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        pENTRADA_PERTENCES = 0;
        List<FechamentoRegistros> listaTodasNovaEntrada = new ArrayList<FechamentoRegistros>();
        conecta.abrirConexao();
        try {
            conecta.executaSQL("SELECT SituacaoEnt "
                    + "FROM ENTRADAPERTENCES "
                    + "WHERE SituacaoEnt='" + pSTATUS_NOVA_ENTRADA + "' "
            ...
            while (conecta.rs.next()) {
                ...
                pNovaEntrada.setStatusRegistro(conecta.rs.getString("SituacaoEnt"));
                listaTodasNovaEntrada.add(pNovaEntrada);
                pENTRADA_PERTENCES = pENTRADA_PERTENCES + 1;
            }
