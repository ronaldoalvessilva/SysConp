...
import static gestor.Visao.TelaPrevisaoKitHigiene.jNomeInternoPesq;
 ...
 */
public class ControleKitDecendialNomeInterno {
    ...
    public List<GravarInternosKitCompleto> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ControleKitDecendialNomeInterno.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
