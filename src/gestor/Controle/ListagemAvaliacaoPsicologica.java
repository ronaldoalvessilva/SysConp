...
import static gestor.Visao.TelaFechamentoSistema.pAVALIACAO_psicologica;
 ...
 */
public class ListagemAvaliacaoPsicologica {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAvaliacaoPsicologica.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
