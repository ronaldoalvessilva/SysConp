 ...
 */
public class ControlePesquisaKitInternoManualCancelamento {
    ...
    public List<ProdutoInternosKitLote> read() throws Exception {
        ...
        try {
           conecta.executaSQL("SELECT DISTINCT ITENS_PRODUTOS_AGRUPADOS_KIT_COMPLETO_INCOMPLETO.IdProd, "
                   ...
                   + "PRODUTOS_KITS_HIGIENE_INTERNO.QuantItem,ITENS_PRODUTOS_AGRUPADOS_KIT_COMPLETO_INCOMPLETO.QuantProd "
