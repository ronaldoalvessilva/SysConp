...
import static gestor.Visao.TelaAberturaTotalSistema.pRECAPTURA;
import static gestor.Visao.TelaAberturaTotalSistema.pREGISTRO_CANCELADOS;
 ...
 */
public class ListagemRegistrosCanceladosA {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    FechamentoRegistros objFecha = new FechamentoRegistros();
    //
    String pSTATUS_REGISTRO_CANCELADO = "FINALIZADO";
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pREGISTRO_CANCELADOS = pREGISTRO_CANCELADOS + 1;
            }
