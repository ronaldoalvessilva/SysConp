...
import static gestor.Visao.TelaFechamentoSistema.pDEPOSITO_inativo;
 ...
 */
public class ListagemDepositoInativoM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
       if (tipoServidor == null || tipoServidor.equals("")) {
        ...
        try {
            ...
            Logger.getLogger(ListagemDepositoInativoM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
