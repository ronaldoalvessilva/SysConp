...
import static gestor.Visao.TelaAberturaTotalSistema.pOCORRE_seguranca;
 ...
 */
public class ListagemOcorrenciaSegurancaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemOcorrenciaSegurancaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
