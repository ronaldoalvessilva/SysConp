...
import static gestor.Visao.TelaFechamentoSistema.pOCORRENCIA_psiologica;
 ...
 */
public class ListagemOcorrenciaPsicologia {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemOcorrenciaPsicologia.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
