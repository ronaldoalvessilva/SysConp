...
import static gestor.Visao.TelaFechamentoSistema.pINVENTARIO_far;
 ...
 */
public class ListagemInventarioFARM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusLanc "
                    ...
                    + "AND DataInicio BETWEEN'" + pDATA_PESQUISA_FECHAMENTO + "' "
            ...
            while (conecta.rs.next()) {
                ...
                pINVENTARIO_far = pINVENTARIO_far + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemInventarioFARM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
