 ...
 * @author ronaldo
 */
public class ControleLocalArmazenamentoNUTRI {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    LocalArmazenamento objLocalMaster = new LocalArmazenamento();

    public LocalArmazenamento incluirLocalMasterNUTRI(LocalArmazenamento objLocalMaster) {
    ...
    public LocalArmazenamento alterarLocalMasterNUTRI(LocalArmazenamento objLocalMaster) {
        conecta.abrirConexao();
        try {
    ...
    public LocalArmazenamento excluirLocalMasterNUTRI(LocalArmazenamento objLocalMaster) {
        conecta.abrirConexao();
        try {
