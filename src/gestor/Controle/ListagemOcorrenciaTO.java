...
import static gestor.Visao.TelaFechamentoSistema.pOCORRE_to;
 ...
 */
public class ListagemOcorrenciaTO {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemOcorrenciaTO .class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
