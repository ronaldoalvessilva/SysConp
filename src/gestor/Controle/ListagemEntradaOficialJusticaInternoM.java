...
import static gestor.Visao.TelaAberturaRegistroSistema.pENTRADA_OFJI;
 ...
 */
public class ListagemEntradaOficialJusticaInternoM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusLanc "
                    + "FROM ENTRADAS_OFICIAL_JUSTICA_INTERNOS "
