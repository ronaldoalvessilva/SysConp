...
import static gestor.Visao.TelaAberturaTotalSistema.pAPRAZAMENTO;
 ...
 */
public class ListagemAprazamentoMedicacaoA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAprazamentoMedicacaoA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
