...
import static gestor.Visao.TelaFechamentoSistema.pCONTROLE_ligacoes;
 ...
 */
public class ListagemControleLigacoes {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemControleLigacoes.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
