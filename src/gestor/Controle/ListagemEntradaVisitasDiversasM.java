...
import static gestor.Visao.TelaAberturaRegistroSistema.pENTRADA_VISITAS_diversas;
 ...
 */
public class ListagemEntradaVisitasDiversasM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pENTRADA_VISITAS_diversas = pENTRADA_VISITAS_diversas + 1;
            }
