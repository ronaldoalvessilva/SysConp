...
import static gestor.Visao.TelaAberturaTotalSistema.pREQUISICAO_interno;
 ...
 */
public class ListagemRequisicaoProdutosInternoA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemRequisicaoProdutosInternoA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
