...
import static gestor.Visao.TelaAberturaTotalSistema.pMOVIMENTO_populcao;
 ...
 */
public class ListagemMovimentoPopulcaoA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusPop "
                    ...
                    + "AND DataPopMov<='" + pDATA_PESQUISA_FECHAMENTO + "'");
            ...
            Logger.getLogger(ListagemMovimentoPopulcaoA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
