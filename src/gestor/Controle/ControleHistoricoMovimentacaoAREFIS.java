 ...
 * @author Ronaldo
 */
public class ControleHistoricoMovimentacaoAREFIS {
    ...
    public HistoricoMovimentacaoEstoque excluirHistoricoProdutoAC(HistoricoMovimentacaoEstoque objHistMovAC) {
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("DELETE FROM HISTORICO_MOVIMENTACAO_ESTOQUE_AE WHERE IdProd='" + objHistMovAC.getIdProd() + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
