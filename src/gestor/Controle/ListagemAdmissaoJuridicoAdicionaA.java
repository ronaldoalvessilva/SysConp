...
import static gestor.Visao.TelaAberturaTotalSistema.pADMISSAO_JURI;
 ...
 */
public class ListagemAdmissaoJuridicoAdicionaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoJuridicoAdicionaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
