...
import static gestor.Visao.TelaAtividadesMensalUnidade.pQUANTIDADE_ATE_PSICOLOGIA;
import static gestor.Visao.TelaAtividadesMensalUnidade.pTIPO_ATENDIMENTO_ATE_PSICOLOGICO;
import static gestor.Visao.TelaAtividadesMensalUnidade.pTIPO_ATENDIMENTO_EVO_PSICOLOGICO;
import static gestor.Visao.TelaAtividadesMensalUnidade.pTIPO_ATENDIMENTO_GRUPO_PSICOLOGICO;
 ...
 * @author ronal
 */
public class ListagemAtendimentoADMPsicologico {
    ...
    public List<AtividadesMensalRealizadaUnidades> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT DataAtendimento,TipoAtendimento "
                    ...
                    + "AND '" + pDATA_FINAL + "' "
                    + "AND TipoAtendimento='" + pTIPO_ATENDIMENTO_ATE_PSICOLOGICO + "' "
                    + "OR CONVERT(DATE, DataAtendimento) BETWEEN'" + pDATA_INICIAL + "' "
                    + "AND '" + pDATA_FINAL + "' "
                    + "AND TipoAtendimento='" + pTIPO_ATENDIMENTO_EVO_PSICOLOGICO + "' "
                    + "OR CONVERT(DATE, DataAtendimento) BETWEEN'" + pDATA_INICIAL + "' "
                    + "AND '" + pDATA_FINAL + "' "
                    + "AND TipoAtendimento='" + pTIPO_ATENDIMENTO_GRUPO_PSICOLOGICO + "' ");
            while (conecta.rs.next()) {
                ...
                pQUANTIDADE_ATE_PSICOLOGIA = pQUANTIDADE_ATE_PSICOLOGIA + 1;
            }
