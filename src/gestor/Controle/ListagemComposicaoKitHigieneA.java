...
import static gestor.Visao.TelaAberturaTotalSistema.pCOMPOSICAO;
 ...
 */
public class ListagemComposicaoKitHigieneA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusComp "
                    ...
                    + "AND DataComp<='" + pDATA_PESQUISA_FECHAMENTO + "'");
            ...
            Logger.getLogger(ListagemComposicaoKitHigieneA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
