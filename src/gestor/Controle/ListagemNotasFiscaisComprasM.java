...
import static gestor.Visao.TelaAberturaRegistroSistema.pNFC;
 ...
 */
public class ListagemNotasFiscaisComprasM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemNotasFiscaisComprasM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
