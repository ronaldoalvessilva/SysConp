...
import static gestor.Visao.TelaAberturaTotalSistema.pAVALIACAO_MED_PSI;
 ...
 */
public class ListagemAvaliacaoMedicaPsiquiatricaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusAval "
                    ...
                    + "AND DataAval<='" + pDATA_PESQUISA_FECHAMENTO + "'");
            ...
            Logger.getLogger(ListagemAvaliacaoMedicaPsiquiatricaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
