...
import static gestor.Visao.TelaFechamentoSistema.pADM_medica;
 ...
 */
public class ListagemAdmissaoMedica {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoMedica.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
