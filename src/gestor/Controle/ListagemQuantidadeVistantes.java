...
import static gestor.Visao.TelaAtividadesMensalUnidade.pQUANTIDADE_VISITAS;
 ...
 * @author ronal
 */
public class ListagemQuantidadeVistantes {
    ...
    public List<AtividadesMensalRealizadaUnidades> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT ITENSFAMILIAR.IdVisita, "
            ...
            while (conecta.rs.next()) {
                ...
                pQUANTIDADE_VISITAS = pQUANTIDADE_VISITAS + 1;
            }
