...
import static gestor.Visao.TelaAberturaTotalSistema.pATEND_social;
 ...
 */
public class ListagemAtendimentoSocialA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoSocialA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
