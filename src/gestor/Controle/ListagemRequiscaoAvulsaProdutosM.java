...
import static gestor.Visao.TelaAberturaRegistroSistema.pREQUISICAO_avulsa;
 ...
 */
public class ListagemRequiscaoAvulsaProdutosM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pREQUISICAO_avulsa = pREQUISICAO_avulsa + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemRequiscaoAvulsaProdutosM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
