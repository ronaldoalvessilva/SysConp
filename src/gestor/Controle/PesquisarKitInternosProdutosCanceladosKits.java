 ...
 * @author ronal
 */
public class PesquisarKitInternosProdutosCanceladosKits {
    ...
    public CancelamentoPagamentoKitHigiene PESQUISAR_INTERNO_KIT_selecionado(CancelamentoPagamentoKitHigiene objCancelaKit) {
        ...
        try {
            ...
            objCancelaKit.setDescricaoCela(conecta.rs.getString("EndCelaPav"));
            // Capturando foto
