...
import static gestor.Visao.TelaFechamentoSistema.pAPRAZAMENTO;
 ...
 */
public class ListagemAprazamentoMedicacao {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAprazamentoMedicacao.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
