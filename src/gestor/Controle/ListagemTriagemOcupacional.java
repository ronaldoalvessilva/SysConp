...
import static gestor.Visao.TelaFechamentoSistema.pTRIAGEM_to;
 ...
 */
public class ListagemTriagemOcupacional {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemTriagemOcupacional.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
