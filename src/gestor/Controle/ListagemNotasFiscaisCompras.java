...
import static gestor.Visao.TelaFechamentoSistema.pNFC;
 ...
 */
public class ListagemNotasFiscaisCompras {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemNotasFiscaisCompras.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
