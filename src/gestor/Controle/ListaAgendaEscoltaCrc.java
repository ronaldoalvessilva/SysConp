...
import static gestor.Visao.TelaFechamentoSistema.pAGENDA_ESCOLTA;
 ...
 */
public class ListaAgendaEscoltaCrc {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    FechamentoRegistros objFecha = new FechamentoRegistros();
    //
    String pSTATUS_AGENDA_ESCOLTA = "ABERTO";
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusAgenda "
                    ...
                    + "AND DataAgenda<='" + pDATA_PESQUISA_FECHAMENTO + "'");
            ...
            Logger.getLogger(ListaAgendaEscoltaCrc.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
