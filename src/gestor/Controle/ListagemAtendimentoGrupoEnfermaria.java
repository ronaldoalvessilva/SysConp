...
import static gestor.Visao.TelaFechamentoSistema.pATENDIMENTO_GRUPO_ENF;
 ...
 */
public class ListagemAtendimentoGrupoEnfermaria {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoGrupoEnfermaria.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
