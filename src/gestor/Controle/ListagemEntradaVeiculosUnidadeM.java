...
import static gestor.Visao.TelaAberturaRegistroSistema.pENTRADA_VEICULOS_unidade;
 ...
 */
public class ListagemEntradaVeiculosUnidadeM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pENTRADA_VEICULOS_unidade = pENTRADA_VEICULOS_unidade + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemEntradaVeiculosUnidadeM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
