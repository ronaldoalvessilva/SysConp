...
import static gestor.Visao.TelaFechamentoSistema.pOCR_ODONTO;
 ...
 */
public class ListagemOcorrenciasOdontologica {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemOcorrenciasOdontologica.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
