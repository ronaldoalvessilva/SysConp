...
import static gestor.Visao.TelaAberturaRegistroSistema.pADM_enfermagemAux;
 ...
 */
public class ListagemAdmissaoEnfermagemComplementarM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pADM_enfermagemAux = pADM_enfermagemAux + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAdmissaoEnfermagemComplementarM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
