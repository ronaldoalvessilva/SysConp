...
import static gestor.Visao.TelaFechamentoSistema.pATENDIMENTO_TEC_ENFERMAGEM;
 ...
 */
public class ListagemAtendimentoTecnicoEnfermagem {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoTecnicoEnfermagem.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
