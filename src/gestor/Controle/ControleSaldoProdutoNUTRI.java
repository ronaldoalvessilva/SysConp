 ...
 * @author ronaldo
 */
public class ControleSaldoProdutoNUTRI {

    ConexaoBancoDados conecta = new ConexaoBancoDados();
    ProdutoMedicamento objProdMed = new ProdutoMedicamento();
    int codLocal;
    public ProdutoMedicamento incluirEstoqueProdutoNUTRI(ProdutoMedicamento objProdMed) {
        buscarLocalArmazenamentoNUTRI(objProdMed.getNomeLocal());
    ...
    public ProdutoMedicamento alterarEstoqueProdutoNUTRI(ProdutoMedicamento objProdMed) {
        buscarLocalArmazenamentoNUTRI(objProdMed.getNomeLocal());
        conecta.abrirConexao();
        try {
    ...
    public ProdutoMedicamento excluirEstoqueProdutoNUTRI(ProdutoMedicamento objProdMed) {
        conecta.abrirConexao();
        try {
     ...
     public void buscarLocalArmazenamentoNUTRI(String nome) {
        conecta.abrirConexao();
        try {
