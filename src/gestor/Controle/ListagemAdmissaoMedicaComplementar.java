...
import static gestor.Visao.TelaFechamentoSistema.pADM_medicaAux;
 ...
 */
public class ListagemAdmissaoMedicaComplementar {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoMedicaComplementar.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
