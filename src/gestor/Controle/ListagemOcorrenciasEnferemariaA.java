...
import static gestor.Visao.TelaAberturaTotalSistema.pOCORRENCIA_ENF;
 ...
 */
public class ListagemOcorrenciasEnferemariaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemOcorrenciasEnferemariaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
