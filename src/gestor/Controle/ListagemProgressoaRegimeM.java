...
import static gestor.Visao.TelaAberturaRegistroSistema.pPROGRESSAO_REGIME;
 ...
 */
public class ListagemProgressoaRegimeM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pPROGRESSAO_REGIME = pPROGRESSAO_REGIME + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemProgressoaRegimeM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
