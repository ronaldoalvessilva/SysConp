...
import static gestor.Visao.TelaFechamentoSistema.pCAPACITACAO_INTERO_to;
 ...
 */
public class ListagemCapacitacaoInternoTO {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemCapacitacaoInternoTO.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
