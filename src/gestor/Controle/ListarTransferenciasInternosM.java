...
import static gestor.Visao.TelaAberturaRegistroSistema.pTOTAL_TRANSFERENCIAS;
 ...
 * @author ronal
 */
public class ListarTransferenciasInternosM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusTran "
                    ...
                    + "AND DataLancTransf BETWEEN'" + pDATA_PESQUISA_FECHAMENTO + "' "
            ...
            Logger.getLogger(ListarTransferenciasInternosM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
