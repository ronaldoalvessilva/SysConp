...
import static gestor.Visao.TelaSelecaoLoteInternosAG_EF.jComboBoxCelas;
 ...
 */
public class ControleListaInternosCelasAG_EF {
    ...
    public List<PavilhaoInternoMontaKit> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ControleListaInternosCelasAG_EF.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
