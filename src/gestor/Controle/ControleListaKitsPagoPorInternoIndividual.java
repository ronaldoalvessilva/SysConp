...
import static gestor.Visao.TelaConsultaKitsEntregueNaoEntreguesInternos.jComboBoxKitPagoNaoPago;
 ...
 */
public class ControleListaKitsPagoPorInternoIndividual {
        ...
        if (tipoServidor == null || tipoServidor.equals("")) {
            ...
            try {
                conecta.executaSQL("SELECT "
                        ...
                        + "AND '" + pDATA_final + "' "
                        + "AND TipoKit='" + jComboBoxKitPagoNaoPago.getSelectedItem() + "' "
                ...
                Logger.getLogger(ControleListaKitsPagoPorInternoIndividual.class.getName()).log(Level.SEVERE, null, ex);
            } finally {
                conecta.desconecta();
            }
