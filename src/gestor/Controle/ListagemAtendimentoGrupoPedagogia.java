...
import static gestor.Visao.TelaFechamentoSistema.pATEND_GRUPO_pedagogia;
 ...
 */
public class ListagemAtendimentoGrupoPedagogia {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoGrupoPedagogia.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
