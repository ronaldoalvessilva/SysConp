...
import static gestor.Visao.TelaAberturaTotalSistema.pOCORRE_to;
 ...
 */
public class ListagemOcorrenciaTOA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemOcorrenciaTOA .class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
