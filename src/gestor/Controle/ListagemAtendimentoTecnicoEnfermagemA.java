...
import static gestor.Visao.TelaAberturaTotalSistema.pATENDIMENTO_TEC_ENFERMAGEM;
 ...
 */
public class ListagemAtendimentoTecnicoEnfermagemA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoTecnicoEnfermagemA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
