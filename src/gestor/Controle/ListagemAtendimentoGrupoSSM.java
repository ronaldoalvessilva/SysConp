...
import static gestor.Visao.TelaAberturaRegistroSistema.pATEND_GRUPO_ss;
 ...
 */
public class ListagemAtendimentoGrupoSSM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoGrupoSSM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
