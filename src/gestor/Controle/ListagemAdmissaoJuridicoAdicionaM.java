...
import static gestor.Visao.TelaAberturaRegistroSistema.pADMISSAO_JURI;
 ...
 */
public class ListagemAdmissaoJuridicoAdicionaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusLanc "
                    + "FROM ADMISSAO_JURIDICO_ADICIONAL "
            ...
            while (conecta.rs.next()) {
                ...
                pADMISSAO_JURI = pADMISSAO_JURI + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAdmissaoJuridicoAdicionaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
