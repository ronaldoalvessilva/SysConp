 ...
 * @author ronaldo
 */
public class ControleEvadidosIndividual {
    ...
    public EvadidoIndividual incluirEvadidoInd(EvadidoIndividual objEvadidoInd) {

        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("INSERT INTO EVADIDOSIND (StatusLanc,TipoOp,DataLanc,TipoEvasao,IdInternoCrc,NrDocSaida,Observacao,UsuarioInsert,DataInsert,HorarioInsert,IdSaida,DataSaida) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)");
    ...
    public EvadidoIndividual alterarEvadidoInd(EvadidoIndividual objEvadidoInd) {

        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE EVADIDOSIND SET StatusLanc=?,TipoOp=?,DataLanc=?,TipoEvasao=?,IdInternoCrc=?,NrDocSaida=?,Observacao=?,UsuarioUp=?,DataUp=?,HorarioUp=?,IdSaida=?,DataSaida=? WHERE IdInternoCrc='" + objEvadidoInd.getIdInternoCrc() + "'AND IdLanc='" + objEvadidoInd.getIdLanc() + "'");
            pst.setString(1, objEvadidoInd.getStatusLanc());
            pst.setString(2, objEvadidoInd.getTipoOperacao());
    ...
    public EvadidoIndividual excluirEvadidoInd(EvadidoIndividual objEvadidoInd) {

        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("DELETE FROM EVADIDOSIND WHERE IdInternoCrc='" + objEvadidoInd.getIdInternoCrc() + "'AND IdLanc='" + objEvadidoInd.getIdLanc() + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
    ...
    public EvadidoIndividual finalizarEvadidoInd(EvadidoIndividual objEvadidoInd) {

        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE EVADIDOSIND SET StatusLanc=? WHERE IdInternoCrc='" + objEvadidoInd.getIdInternoCrc() + "'AND IdLanc='" + objEvadidoInd.getIdLanc() + "'");
            pst.setString(1, objEvadidoInd.getStatusLanc());
            pst.executeUpdate();
        } catch (SQLException ex) {
...
//---------------------------------------------------------------- SAIDA LABORATIVA EVASÃO ------------------------
    ...
    public ItensEntradaSaidaLaborInterno incluirEvasaoInterno(ItensEntradaSaidaLaborInterno objItenLabor) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE ITENSLABORINTERNO SET Evadido=? WHERE IdInternoCrc='" + objItenLabor.getIdInternoCrc() + "'AND IdLanc='" + objItenLabor.getIdLanc() + "'");
    ...
    public ItensSaidaInterno alterarEvasaoInternoSaidaTmp(ItensSaidaInterno objItemSaida) {

        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE ITENSSAIDA SET Evadido=?,ConfirmaEvasao=? WHERE IdInternoCrc='" + objItemSaida.getIdInternoSaida() + "'AND DocumentoSaida='" + objItemSaida.getDocumento() + "'");
    ...
    public ItensEntradaSaidaLaborInterno incluirEvasaoEducacionalInternoPortaria(ItensEntradaSaidaLaborInterno objItenLabor) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE INTERNOS_ENTRADA_SAIDA_EDUCACAO SET Observacao=?,Evadido=? WHERE IdInternoCrc='" + objItenLabor.getIdInternoCrc() + "'AND HorarioEntrada='" + objItenLabor.getHorarioEntrada() + "'");
            pst.setString(1, objItenLabor.getInternoEvadido());
    ...
    public ItensEntradaSaidaLaborInterno incluirEvasaoEducacionalInternoPedagogia(ItensEntradaSaidaLaborInterno objItenLabor) {
        ...
        conecta.abrirConexao();
        try {
            PreparedStatement pst = conecta.con.prepareStatement("UPDATE INTERNOS_SAIDA_EDUCACIONAL SET Evadido=? WHERE IdInternoCrc='" + objItenLabor.getIdInternoCrc() + "'");
            pst.setString(1, objItenLabor.getInternoEvadido());
            pst.executeUpdate();
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Não Foi possivel ALTERAR Evasão do Interno\nERRO: " + ex);
