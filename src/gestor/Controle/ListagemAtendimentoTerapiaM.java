...
import static gestor.Visao.TelaAberturaRegistroSistema.pATENDIMENTO_TO;
 ...
 */
public class ListagemAtendimentoTerapiaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pATENDIMENTO_TO = pATENDIMENTO_TO + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAtendimentoTerapiaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
