...
import static gestor.Visao.TelaFechamentoSistema.pFREQUENCIA_capa;
 ...
 */
public class ListagemFrequenciaCapacitaTO {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemFrequenciaCapacitaTO.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
