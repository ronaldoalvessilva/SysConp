...
import static gestor.Visao.TelaAberturaRegistroSistema.pPORTA_entrada;
 ...
 */
public class ListagemPortaEntradaPsicologiaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pPORTA_entrada = pPORTA_entrada + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemPortaEntradaPsicologiaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
