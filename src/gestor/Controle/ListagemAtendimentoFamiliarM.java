...
import static gestor.Visao.TelaAberturaRegistroSistema.pATEND_FAM_ss;
 ...
 */
public class ListagemAtendimentoFamiliarM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pATEND_FAM_ss = pATEND_FAM_ss + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAtendimentoFamiliarM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
