...
import static gestor.Visao.TelaAtividadesMensalUnidade.pQUANTIDADE_APARELHO_CELULAR;
 ...
 * @author ronal
 */
public class ListagemQuantidadeAparelhoCeluar {
    ...
    public List<AtividadesMensalRealizadaUnidades> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT PROCEDIMENTOS.DataLanc, "
                    ...
                    + "AND '" + pDATA_FINAL + "'"
                    + "AND OBJETOSPROCEDIMENTOS.DescricaoObjeto='" + pTIPO_APARELHO + "'");
