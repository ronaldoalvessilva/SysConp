...
import static gestor.Visao.TelaAtividadesMensalUnidade.pQUANTIDADE_PROGRESSAO;
 ...
 * @author ronal
 */
public class ListagemInternosProgressao {
    ...
    public List<AtividadesMensalRealizadaUnidades> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT DataSaida "
                    + "FROM ITENSSAIDA "
                    + "WHERE DestinoSaida LIKE'%" + pPROGRESSAO + "%' "
            ...
            while (conecta.rs.next()) {
                ...
                pQUANTIDADE_PROGRESSAO = pQUANTIDADE_PROGRESSAO + 1;
