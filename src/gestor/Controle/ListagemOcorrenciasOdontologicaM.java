...
import static gestor.Visao.TelaAberturaRegistroSistema.pOCR_ODONTO;
 ...
 */
public class ListagemOcorrenciasOdontologicaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pOCR_ODONTO = pOCR_ODONTO + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemOcorrenciasOdontologicaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
