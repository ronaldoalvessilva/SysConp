...
import static gestor.Visao.TelaFechamentoSistema.pATENDE_JURI;
 ...
 */
public class ListagemAtendimentoJuridico {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoJuridico.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
