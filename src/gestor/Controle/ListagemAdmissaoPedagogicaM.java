...
import static gestor.Visao.TelaAberturaRegistroSistema.pADMISSAO_pedagogica;
 ...
 */
public class ListagemAdmissaoPedagogicaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoPedagogicaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
