...
import static gestor.Visao.TelaAberturaRegistroSistema.pATENDIMENTO_GRUPO_psi;
 ...
 */
public class ListagemAtendimentoGrupoPsiM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusAtendGrupo "
                    + "FROM ATENDIMENTO_GRUPO_PSICOLOGIA "
            ...
            while (conecta.rs.next()) {
                ...
                pATENDIMENTO_GRUPO_psi = pATENDIMENTO_GRUPO_psi + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAtendimentoGrupoPsiM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
