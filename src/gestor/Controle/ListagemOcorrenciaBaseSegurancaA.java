...
import static gestor.Visao.TelaAberturaTotalSistema.pOCR_seg;
 ...
 */
public class ListagemOcorrenciaBaseSegurancaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemOcorrenciaBaseSegurancaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
