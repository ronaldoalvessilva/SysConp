...
public class ControlePagamentoKitAnualRealizado {
    ...
    public List<GravarInternosKitCompleto> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT * FROM KITS_ANUAL_INTERNOS "
                    ...
                    + "AND KITS_ANUAL_INTERNOS.IDREG_PROG='" + idPROG + "' "
            ...
            Logger.getLogger(ControlePagamentoKitAnualRealizado.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
