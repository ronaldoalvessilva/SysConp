...
import static gestor.Visao.TelaAberturaTotalSistema.pATEND_ODONTO;
 ...
 */
public class ListagemAtendimentoOdontologicoA {
...
ConexaoBancoDados conecta = new ConexaoBancoDados();
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoOdontologicoA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
