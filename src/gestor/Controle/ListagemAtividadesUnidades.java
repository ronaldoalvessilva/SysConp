...
import static gestor.Visao.TelaFechamentoSistema.pATIVIDADE_UNIDADE;
 ...
 */
public class ListagemAtividadesUnidades {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtividadesUnidades.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
