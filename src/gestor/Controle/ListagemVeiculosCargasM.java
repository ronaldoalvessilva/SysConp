...
import static gestor.Visao.TelaAberturaRegistroSistema.pENTRADA_VEICULOS_carga;
 ...
 */
public class ListagemVeiculosCargasM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pNovaEntrada.setStatusRegistro(conecta.rs.getString("StatusEnt"));
                listaTodasNovaEntrada.add(pNovaEntrada);
                pENTRADA_VEICULOS_carga = pENTRADA_VEICULOS_carga + 1;
            }
