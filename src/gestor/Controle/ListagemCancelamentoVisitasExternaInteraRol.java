...
import static gestor.Visao.TelaFechamentoSistema.pCANCELA_visitas;
 ...
 */
public class ListagemCancelamentoVisitasExternaInteraRol {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemCancelamentoVisitasExternaInteraRol.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
