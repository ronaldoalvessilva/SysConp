...
import static gestor.Visao.TelaAberturaTotalSistema.pADM_enfermagem;
 ...
 */
public class ListagemAdmissaoEnfermagemA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoEnfermagemA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
