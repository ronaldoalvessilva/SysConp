...
import static gestor.Visao.TelaFechamentoSistema.pPORTA_ENTRADA_ss;
 ...
 */
public class ListagemPortaEntradaSS {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemPortaEntradaSS.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
