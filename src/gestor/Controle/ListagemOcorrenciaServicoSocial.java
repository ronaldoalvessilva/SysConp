...
import static gestor.Visao.TelaFechamentoSistema.pOCORRENCIAS_servico;
 ...
 */
public class ListagemOcorrenciaServicoSocial {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemOcorrenciaServicoSocial.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
