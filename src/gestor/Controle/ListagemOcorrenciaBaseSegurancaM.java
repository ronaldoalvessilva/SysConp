...
import static gestor.Visao.TelaAberturaRegistroSistema.pOCR_seg;
 ...
 */
public class ListagemOcorrenciaBaseSegurancaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusLanc "
                    + "FROM OCORRENCIAS_BASE_SEGURANCA "
            ...
            Logger.getLogger(ListagemOcorrenciaBaseSegurancaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
