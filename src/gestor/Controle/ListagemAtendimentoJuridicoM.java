...
import static gestor.Visao.TelaAberturaRegistroSistema.pATENDE_JURI;
 ...
 */
public class ListagemAtendimentoJuridicoM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pATENDE_JURI = pATENDE_JURI + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAtendimentoJuridicoM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
