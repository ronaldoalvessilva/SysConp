 ...
 * @author user
 */
public class ControleMovInternosObito {
    ...
    String nomeOpeObito = "Óbito - Saída Laborativa";
    String nomeOpeObitoSaidaTmp = "Óbito - Saída Temporária";
    String nomeOpeObitoSaidaEduca = "Óbito - Saída Educação";
    String nomeOpeObitoMedico = "Óbito - Saída Médico";
    String nomeOpeObitoAudiencia = "Óbito - Saída Audiência";
    ...
    public EvadidoIndividual incluirMovEvasaoSaidaTmp(EvadidoIndividual objEvadidoInd) {
        ...
        try {
            ...
            pst.setInt(1, objEvadidoInd.getIdInternoCrc());
            pst.setInt(2, objEvadidoInd.getIdLanc());
            pst.setString(3, nomeOpeObitoSaidaTmp);
            pst.setTimestamp(4, new java.sql.Timestamp(objEvadidoInd.getDataLanc().getTime()));
            pst.setString(5, objEvadidoInd.getTipoOperacao());
            pst.executeUpdate();
        } catch (SQLException ex) {
    ...
    public EvadidoIndividual incluirMovEvasaoSaidaEduca(EvadidoIndividual objEvadidoInd) {
        ...
        try {
            ...
            pst.setInt(1, objEvadidoInd.getIdInternoCrc());
            pst.setInt(2, objEvadidoInd.getIdLanc());
            pst.setString(3, nomeOpeObitoSaidaEduca);
            pst.setTimestamp(4, new java.sql.Timestamp(objEvadidoInd.getDataLanc().getTime()));
            pst.setString(5, objEvadidoInd.getTipoOperacao());
            pst.executeUpdate();
        } catch (SQLException ex) {
    ...
    public EvadidoIndividual incluirMovEvasaoSaidaMedico(EvadidoIndividual objEvadidoInd) {
        ...
        try {
            ...
            pst.setInt(1, objEvadidoInd.getIdInternoCrc());
            pst.setInt(2, objEvadidoInd.getIdLanc());
            pst.setString(3, nomeOpeObitoMedico);
            pst.setTimestamp(4, new java.sql.Timestamp(objEvadidoInd.getDataLanc().getTime()));
            pst.setString(5, objEvadidoInd.getTipoOperacao());
            pst.executeUpdate();
        } catch (SQLException ex) {
    ...
    public EvadidoIndividual alterarMovEvasaoSaidaAudiencia(EvadidoIndividual objEvadidoInd) {
