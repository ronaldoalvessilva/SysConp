...
import static gestor.Visao.TelaAberturaTotalSistema.pATUALIZA_documento;
 ...
 */
public class ListagemAtualizacaoDocumentosInternosA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtualizacaoDocumentosInternosA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
