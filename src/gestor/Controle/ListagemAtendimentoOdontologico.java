...
import static gestor.Visao.TelaFechamentoSistema.pATEND_ODONTO;
 ...
 */
public class ListagemAtendimentoOdontologico {
...
ConexaoBancoDados conecta = new ConexaoBancoDados();
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoOdontologico.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
