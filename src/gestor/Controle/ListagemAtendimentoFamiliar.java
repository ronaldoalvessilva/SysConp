...
import static gestor.Visao.TelaFechamentoSistema.pATEND_FAM_ss;
 ...
 */
public class ListagemAtendimentoFamiliar {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoFamiliar.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
