...
import static gestor.Visao.TelaAberturaTotalSistema.pENTRADA_advogado;
 ...
 */
public class ListagemEntradaAdvogadosA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pENTRADA_advogado = pENTRADA_advogado + 1;
            }
