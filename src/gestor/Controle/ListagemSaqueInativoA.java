...
import static gestor.Visao.TelaFechamentoSistema.pSAQUE_inativo;
 ...
 */
public class ListagemSaqueInativoA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pSAQUE_inativo = pSAQUE_inativo + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemSaqueInativoA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
