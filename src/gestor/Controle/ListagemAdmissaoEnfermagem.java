...
import static gestor.Visao.TelaFechamentoSistema.pADM_enfermagem;
 ...
 */
public class ListagemAdmissaoEnfermagem {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoEnfermagem.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
