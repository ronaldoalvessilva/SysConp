...
import static gestor.Visao.TelaAberturaRegistroSistema.pAPRAZAMENTO;
 ...
 */
public class ListagemAprazamentoMedicacaoM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pAPRAZAMENTO = pAPRAZAMENTO + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAprazamentoMedicacaoM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
