...
import static gestor.Visao.TelaFechamentoSistema.pADM_terapia;
 ...
 */
public class ListagemAdmissaoTerapia {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoTerapia.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
