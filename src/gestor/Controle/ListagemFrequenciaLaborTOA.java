...
import static gestor.Visao.TelaAberturaTotalSistema.pFREQUENCIA_labora;
 ...
 */
public class ListagemFrequenciaLaborTOA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemFrequenciaLaborTOA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
