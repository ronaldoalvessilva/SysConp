...
import static gestor.Visao.TelaAberturaRegistroSistema.pAVALIACAO_psicologica;
 ...
 */
public class ListagemAvaliacaoPsicologicaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pAVALIACAO_psicologica = pAVALIACAO_psicologica + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAvaliacaoPsicologicaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
