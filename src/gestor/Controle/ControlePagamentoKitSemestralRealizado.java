...
public class ControlePagamentoKitSemestralRealizado {
    ...
    public List<GravarInternosKitCompleto> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT * FROM KITS_SEMESTRAL_INTERNOS "
                    ...
                    + "AND KITS_SEMESTRAL_INTERNOS.IDREG_PROG='" + idPROG + "' "
            ...
            Logger.getLogger(ControlePagamentoKitSemestralRealizado.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
