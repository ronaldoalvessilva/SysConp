...
import static gestor.Visao.TelaAberturaRegistroSistema.pADMISSAO_pedagogicaNova;
 ...
 */
public class ListagemAdmissaoPedagogicaNovaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pADMISSAO_pedagogicaNova = pADMISSAO_pedagogicaNova + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAdmissaoPedagogicaNovaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
