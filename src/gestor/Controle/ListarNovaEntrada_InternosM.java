...
import static gestor.Visao.TelaAberturaRegistroSistema.pNOVA_ENTRADA;
 ...
 * @author ronal
 */
public class ListarNovaEntrada_InternosM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pNOVA_ENTRADA = pNOVA_ENTRADA + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListarNovaEntrada_InternosM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
