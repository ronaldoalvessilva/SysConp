...
import static gestor.Visao.TelaFechamentoSistema.pATENDIMENTO_TO;
 ...
 */
public class ListagemAtendimentoTerapia {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAtendimentoTerapia.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
