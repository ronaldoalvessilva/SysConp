...
import static gestor.Visao.TelaPesquisaAtivaDesativaAlertaRetornos.jNomeInternoPesquisa;
 ...
 * @author ronal
 */
public class PesquisarRegistroAlertaRetornosInternosNome {
    ...
    public List<AtivarDesativarAlertaEntradas> read() throws Exception {
        ...
        if (jComboBoxAtivarDesativar.getSelectedItem().equals("Ativar")) {
            try {
                ...
                Logger.getLogger(PesquisarRegistroAlertaRetornosInternosNome.class.getName()).log(Level.SEVERE, null, ex);
            } finally {
                conecta.desconecta();
            }
    ...
    public AtivarDesativarAlertaEntradas MOSTRAR_registros(AtivarDesativarAlertaEntradas objAlertaEntrada) {
        ...
        try {
            ...
            conecta.rs.first();
            objAlertaEntrada.setIdItem(conecta.rs.getInt("IdRetorno"));
            objAlertaEntrada.setNumeroRegistro(conecta.rs.getInt("IdRetorno"));
            objAlertaEntrada.setDataEntrada(conecta.rs.getDate("DataRetorno"));
            objAlertaEntrada.setHoraEntrada(conecta.rs.getString("HorarioRetorno"));
            objAlertaEntrada.setNumeroOficio(conecta.rs.getString("DocumentoRetorno"));
            ...
            objAlertaEntrada.setOrigemInterno(conecta.rs.getString("OrigemRetorno"));
            objAlertaEntrada.setConfirmaEntrada(conecta.rs.getString("RetCrc"));
        } catch (SQLException ex) {
            Logger.getLogger(PesquisarRegistroAlertaRetornosInternosNome.class.getName()).log(Level.SEVERE, null, ex);
        }
        conecta.desconecta();
