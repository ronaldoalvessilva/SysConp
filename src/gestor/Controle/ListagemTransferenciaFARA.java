...
import static gestor.Visao.TelaFechamentoSistema.pTRANSFERENCIAS_far;
 ...
 */
public class ListagemTransferenciaFARA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pTRANSFERENCIAS_far = pTRANSFERENCIAS_far + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemTransferenciaFARA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
