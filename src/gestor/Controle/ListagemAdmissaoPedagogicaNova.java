...
import static gestor.Visao.TelaFechamentoSistema.pADMISSAO_pedagogicaNova;
 ...
 */
public class ListagemAdmissaoPedagogicaNova {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAdmissaoPedagogicaNova.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
