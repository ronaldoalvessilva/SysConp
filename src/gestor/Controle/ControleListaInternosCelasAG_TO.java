...
import static gestor.Visao.TelaSelecaoLoteInternosAG_TO.jComboBoxCelas;
import static gestor.Visao.TelaSelecaoLoteInternosAG_TO.qtdInternos;
 ...
 */
public class ControleListaInternosCelasAG_TO {
    ...
    public List<PavilhaoInternoMontaKit> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ControleListaInternosCelasAG_TO.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
