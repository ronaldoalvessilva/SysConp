...
import static gestor.Visao.TelaAberturaRegistroSistema.pADM_terapia;
 ...
 */
public class ListagemAdmissaoTerapiaM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            while (conecta.rs.next()) {
                ...
                pADM_terapia = pADM_terapia + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAdmissaoTerapiaM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
