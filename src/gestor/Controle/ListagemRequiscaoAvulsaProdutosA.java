...
import static gestor.Visao.TelaAberturaTotalSistema.pREQUISICAO_avulsa;
 ...
 */
public class ListagemRequiscaoAvulsaProdutosA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemRequiscaoAvulsaProdutosA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
