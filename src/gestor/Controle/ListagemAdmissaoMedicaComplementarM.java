...
import static gestor.Visao.TelaAberturaRegistroSistema.pADM_medicaAux;
 ...
 */
public class ListagemAdmissaoMedicaComplementarM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            conecta.executaSQL("SELECT StatusLanc "
                    + "FROM ADMISSAO_MEDICA_ADICIONAL "
            ...
            while (conecta.rs.next()) {
                ...
                pADM_medicaAux = pADM_medicaAux + 1;
            }
            return listaTodasNovaEntrada;
        } catch (SQLException ex) {
            Logger.getLogger(ListagemAdmissaoMedicaComplementarM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
