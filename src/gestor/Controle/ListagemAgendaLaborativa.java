...
import static gestor.Visao.TelaFechamentoSistema.pAGENDA_laborativa;
 ...
 */
public class ListagemAgendaLaborativa {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemAgendaLaborativa.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
