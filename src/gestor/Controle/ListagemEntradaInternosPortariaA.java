...
import static gestor.Visao.TelaAberturaTotalSistema.pENTRADAS_INTERNOS_portaria;
 ...
 */
public class ListagemEntradaInternosPortariaA {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListagemEntradaInternosPortariaA.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
