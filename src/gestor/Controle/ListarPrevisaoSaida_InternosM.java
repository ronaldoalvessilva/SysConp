...
import static gestor.Visao.TelaAberturaRegistroSistema.pPREVISAO_SAIDA;
 ...
 * @author ronal
 */
public class ListarPrevisaoSaida_InternosM {
    ...
    public List<FechamentoRegistros> read() throws Exception {
        ...
        try {
            ...
            Logger.getLogger(ListarPrevisaoSaida_InternosM.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            conecta.desconecta();
        }
        return null;
