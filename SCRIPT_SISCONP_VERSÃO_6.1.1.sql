...
-- ADMISSÃO E EVOLUÇÃO EDUCAÇÃO FISICA

IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('ADMISSAO_EDUCACAO_FISICA'))
	CREATE TABLE ADMISSAO_EDUCACAO_FISICA
	(
	IdRegistroEF INT IDENTITY (1,1) PRIMARY KEY NOT NULL,
	...
	FrequenciaSemanal VARCHAR(100) NULL,
	NivelCondicionamento VARCHAR(30) NULL,
...
IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('EVOLUCAO_EDUCACAO_FISICA'))
	CREATE TABLE EVOLUCAO_EDUCACAO_FISICA
	(
	IdItem INT IDENTITY (1,1) PRIMARY KEY NOT NULL,	 
	DataEvolucaoEF DATETIME NULL,
	IdRegistroEF INT FOREIGN KEY REFERENCES ADMISSAO_EDUCACAO_FISICA(IdRegistroEF) NOT NULL,
	IdInternoCrc INT FOREIGN KEY REFERENCES PRONTUARIOSCRC(IdInternoCrc) NOT NULL,	
...
-- NOVA ADMISSÃO EDUCAÇÃO FÍSCA

IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('ADMISSAO_EDUCACAO_FISICA_NOVA'))
	CREATE TABLE ADMISSAO_EDUCACAO_FISICA_NOVA
	(
	IdRegistroEF_NOVA INT IDENTITY (1,1) PRIMARY KEY NOT NULL,
	StatusEF VARCHAR(20) NULL,
	DataRegistroEF DATETIME NULL,
	IdRegistroEF INT FOREIGN KEY REFERENCES ADMISSAO_EDUCACAO_FISICA(IdRegistroEF) NOT NULL,
	IdInternoCrc INT FOREIGN KEY REFERENCES PRONTUARIOSCRC(IdInternoCrc) NOT NULL,
...
-- BIOMETRIA NA ADMISSÃO DA EDUCAÇÃO FÍSICA

IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PARAMETROSCRC') AND NAME = 'BiometriaEF')
           ALTER TABLE PARAMETROSCRC ADD BiometriaEF VARCHAR(3) NULL

UPDATE PARAMETROSCRC SET BiometriaEF='Sim' 

-- CADASTRAR DEPARTAMENTO COMO EDUCACAO FISICA
--INSERT INTO MODULOS(NomeModulo,Permissao,UsuarioInsert) VALUES('EDUCACAO FISICA','Sim','ADMINISTRADOR DO SISTEMA')

-- TABELA DE POPILAÇÃO DE ALIMENTAÇÃO - RABBIT
...
-- PRIMEIRO INSERT NA TABELA ENTRADAS_SAIDAS_POPULCAO_INTERNOS PARA DA PARTIDA NA POPULAÇÃO DE ALIMENTAÇÃO
-- NAS UNIDADES

--INSERT INTO ENTRADAS_SAIDAS_POPULACAO_INTERNOS (IdDocumento,DataMovimento,HorarioMovimento,TipoOperacao,Quantidade,Populacao,UsuarioInsert,DataInsert,HorarioInsert) VALUES(1,'04/06/2020','10:54','População Inicial',620,620,'ADMINISTRADOR DO SISTEMA','04/06/2020','10:56')