...
IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('ATENDIMENTOTERAPIA'))
	CREATE TABLE ATENDIMENTOTERAPIA
	(
	IdLanc INT IDENTITY (1,1) PRIMARY KEY NOT NULL,
	StatusLanc VARCHAR(20) NULL,
	DataLanc DATETIME NULL,
	IdInternoCrc INT FOREIGN KEY REFERENCES PRONTUARIOSCRC(IdInternoCrc) NOT NULL,
	-- DESEMPENHO OCUPACIONAL - AspectoFisico MUDOU PARA ObsDesempenhoOcupacional
	-- InteresseCurso MUDOU PARA Dominancia		
	...
	-- DADOS CLINICOS - HistoricoProfissional MUDOU ObsDadosClinicos
	-- DesejaTrabalhar MUDOU PARA  Hipertensao
	...
	-- ALTERAÇÕES PSICOLOGICAS - Encaminhamentos MUDOU ObsAlteracoesPsicologicas
	...
	-- Cursos MUDOU PARA ObsTriagemSPA
	...
	-- Aptidao MUDOU PARA ObsEstiloVida
...
-- TABELA DE EVOLUÇÃO ATENDIMENTO

IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('EVOLUCAOTERAPIA'))
	CREATE TABLE EVOLUCAOTERAPIA
	(
	IdEvo INT IDENTITY (1,1) PRIMARY KEY NOT NULL,
...
IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('AVALIACAO_I'))
	CREATE TABLE AVALIACAO_I
	(
	IdAvaliaI INT IDENTITY (1,1) PRIMARY KEY NOT NULL,
	IdLanc INT FOREIGN KEY REFERENCES ATENDIMENTOTERAPIA(IdLanc) NOT NULL,
	IdInternoCrc INT FOREIGN KEY REFERENCES PRONTUARIOSCRC(IdInternoCrc) NOT NULL,
...
IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('AVALIACAO_II'))
	CREATE TABLE AVALIACAO_II
	(
	IdAvaliaII INT IDENTITY (1,1) PRIMARY KEY NOT NULL,
	IdLanc INT FOREIGN KEY REFERENCES ATENDIMENTOTERAPIA(IdLanc) NOT NULL,
	IdInternoCrc INT FOREIGN KEY REFERENCES PRONTUARIOSCRC(IdInternoCrc) NOT NULL,
...
IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('TO_HISTORICO_EDUCACIONAL'))
	CREATE TABLE TO_HISTORICO_EDUCACIONAL
	(
	IdHistoricoEdu INT IDENTITY (1,1) PRIMARY KEY NOT NULL,
	IdLanc INT FOREIGN KEY REFERENCES ATENDIMENTOTERAPIA(IdLanc) NOT NULL,
	IdInternoCrc INT FOREIGN KEY REFERENCES PRONTUARIOSCRC(IdInternoCrc) NOT NULL,
...
IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('ITENS_CURSOS_TO_HISTORICO_EDUCACIONAL'))
	CREATE TABLE ITENS_CURSOS_TO_HISTORICO_EDUCACIONAL
	(
	IdItem INT IDENTITY (1,1) PRIMARY KEY NOT NULL,	
	IdLanc INT FOREIGN KEY REFERENCES ATENDIMENTOTERAPIA(IdLanc) NOT NULL,
	IdCurso INT FOREIGN KEY REFERENCES CURSOS(IdCurso) NOT NULL,
	IdHistoricoEdu INT FOREIGN KEY REFERENCES TO_HISTORICO_EDUCACIONAL(IdHistoricoEdu) NOT NULL,
	PrioridadeCurso INT NULL,
	)

-- HISTORICO PROFISSIONAL

IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('TO_HISTORICO_PROFISSIONAL'))
	CREATE TABLE TO_HISTORICO_PROFISSIONAL
	(
	IdHistoricoLab INT IDENTITY (1,1) PRIMARY KEY NOT NULL,
	IdLanc INT FOREIGN KEY REFERENCES ATENDIMENTOTERAPIA(IdLanc) NOT NULL,
	IdInternoCrc INT FOREIGN KEY REFERENCES PRONTUARIOSCRC(IdInternoCrc) NOT NULL,
...
IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('ITENS_PROFISSAO_TO_HISTORICO_PROFISSIONAL'))
	CREATE TABLE ITENS_PROFISSAO_TO_HISTORICO_PROFISSIONAL
	(
	IdItem INT IDENTITY (1,1) PRIMARY KEY NOT NULL,	
	IdLanc INT FOREIGN KEY REFERENCES ATENDIMENTOTERAPIA(IdLanc) NOT NULL,
	IdCodigoProf INT FOREIGN KEY REFERENCES PROFISSAO(IdCodigoProf) NOT NULL,
	IdHistoricoLab INT FOREIGN KEY REFERENCES TO_HISTORICO_PROFISSIONAL(IdHistoricoLab) NOT NULL,
	InteresseLabor INT NULL,
	)