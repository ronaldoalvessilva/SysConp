...
-- CAMPOS NOVIS DO PAGAMENTO DE KIT DE HIGIENE


IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'Id_REG_inicial')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD Id_REG_inicial INT NULL 

IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'Id_REG_decendial')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD Id_REG_decendial INT NULL 

IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'Id_REG_quinzenal')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD Id_REG_quinzenal INT NULL 

IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'Id_REG_mensal')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD Id_REG_mensal INT NULL 

IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'Id_REG_semestral')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD Id_REG_semestral INT NULL 

IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'Id_REG_anual')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD Id_REG_anual INT NULL 


IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'ID_BT_Kit_inicial')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD ID_BT_Kit_inicial INT NULL 
IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'ID_BT_Kit_decendial')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD ID_BT_Kit_decendial INT NULL 
IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'ID_BT_Kit_quinzenal')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD ID_BT_Kit_quinzenal INT NULL 
IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'ID_BT_Kit_mensal')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD ID_BT_Kit_mensal INT NULL 
IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'ID_BT_Kit_semestral')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD ID_BT_Kit_semestral INT NULL 
IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'ID_BT_Kit_anual')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD ID_BT_Kit_anual INT NULL 



IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'ID_KIT_inicial')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD ID_KIT_inicial INT NULL 
IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'ID_KIT_decendial')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD ID_KIT_decendial INT NULL 
IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'ID_KIT_quinzenal')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD ID_KIT_quinzenal INT NULL 
IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'ID_KIT_mensal')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD ID_KIT_mensal INT NULL 
IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'ID_KIT_semestral')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD ID_KIT_semestral INT NULL 
IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PAGAMENTO_KIT_INTERNOS') AND NAME = 'ID_KIT_anual')
          ALTER TABLE PAGAMENTO_KIT_INTERNOS ADD ID_KIT_anual INT NULL 


-- PRONTUARIO DE INTERNOS NO CRC E NA TRIAGEM

IF NOT EXISTS(SELECT 1 FROM SYSCOLUMNS WHERE ID = OBJECT_ID('PRONTUARIOSCRC') AND NAME = 'UfRG')
          ALTER TABLE PRONTUARIOSCRC ADD UfRG VARCHAR(3) NULL 



IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('CHAVE_LIBERACAO'))
	CREATE TABLE CHAVE_LIBERACAO
	(
	...
	CHAVE01_LIBERACAO VARCHAR(MAX) NULL,	
	CHAVE02_LIBERACAO VARCHAR(MAX) NULL,	
	CHAVE03_LIBERACAO VARCHAR(MAX) NULL,	
	UsuarioInsert VARCHAR(50) NULL,
	UsuarioUp VARCHAR(50) NULL,
	DataInsert VARCHAR(20) NULL,
	DataUp VARCHAR(20) NULL,
...
--SCRIPT ACIMA, FOI RODADO EM TODOS OS BANCOS DE DADOS DE PRODUÇÃO DAS UNIDADES EM 17/02/2021
