...
IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('SALDO_ESTOQUE_AE'))
	CREATE TABLE SALDO_ESTOQUE_AE
	(
	IdItem INT IDENTITY(1,1) PRIMARY KEY NOT NULL,	
	IdProd INT NOT NULL,
	IdLocal INT FOREIGN KEY REFERENCES LOCAL_ARMAZENAMENTO_ARMAS_EPI(IdLocal) NOT NULL,
...
IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('LOTE_PRODUTOS_AE'))
	CREATE TABLE LOTE_PRODUTOS_AE
	(
	IdItem INT IDENTITY(1,1) PRIMARY KEY NOT NULL,	
	IdProd INT NOT NULL,
	IdLanc INT NOT NULL,
...
IF NOT EXISTS (SELECT NULL FROM SYSOBJECTS WHERE ID = OBJECT_ID('HISTORICO_MOVIMENTACAO_ESTOQUE_AE'))
	CREATE TABLE HISTORICO_MOVIMENTACAO_ESTOQUE_AE
	(
	IdHistorico INT IDENTITY(1,1) PRIMARY KEY NOT NULL,	
	IdProd INT NOT NULL,
	IdLocal INT FOREIGN KEY REFERENCES LOCAL_ARMAZENAMENTO_ARMAS_EPI(IdLocal) NOT NULL,
